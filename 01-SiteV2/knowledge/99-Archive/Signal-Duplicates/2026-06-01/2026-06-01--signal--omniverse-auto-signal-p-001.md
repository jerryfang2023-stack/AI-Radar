...
# Omniverse 融资，押注模型部署和算力调用

## 信号底稿

谁：Omniverse。

做了什么：Omniverse 宣布融资，材料把资金用途指向模型部署和算力调用。

证据是什么：来源为 https://blogs.nvidia.com/blog/category/robotics，对应本地证据 R-001，材料已保留全文、哈希和出处。
