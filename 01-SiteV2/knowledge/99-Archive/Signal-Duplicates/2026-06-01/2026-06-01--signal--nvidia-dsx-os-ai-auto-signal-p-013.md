...
type: signal_card
signal_type: case
title: "NVIDIA 发布 DSX OS，管理 AI 工厂集群运行"
date: 2026-06-01
status: published
...
event: "NVIDIA DSX OS 把 AI 工厂里的算力、网络、供电、散热和多租户软件管理放进同一套运行系统。"
...
signal_owner: "NVIDIA DSX OS"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "NVIDIA 发布 DSX OS，管理 AI 工厂集群运行"
  eventLine: "NVIDIA DSX OS 把 AI 工厂里的算力、网络、供电、散热和多租户软件管理放进同一套运行系统。"
...
# NVIDIA 发布 DSX OS，管理 AI 工厂集群运行

## 信号底稿

谁：NVIDIA DSX OS。

做了什么：NVIDIA DSX OS 把 AI 工厂里的算力、网络、供电、散热和多租户软件管理放进同一套运行系统。
...
NVIDIA DSX OS 把 AI 工厂里的算力、网络、供电、散热和多租户软件管理放进同一套运行系统。
