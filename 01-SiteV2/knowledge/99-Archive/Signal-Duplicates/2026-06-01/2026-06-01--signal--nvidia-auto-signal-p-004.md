...
# NVIDIA 部署 AI 到地产开发和建筑设计流程

## 信号底稿

谁：NVIDIA。

做了什么：NVIDIA 把 AI 放进地产开发和建筑设计流程，材料显示它已经对应到具体任务或客户环境。

证据是什么：来源为 https://blogs.nvidia.com/blog/factory-operations-fox-blueprint-ai-brain，对应本地证据 R-004，材料已保留全文、哈希和出处。
