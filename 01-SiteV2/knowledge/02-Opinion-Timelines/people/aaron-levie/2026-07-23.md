...
### 2026-07-23 - Anthropic经济学主管发表了一篇精彩文章。他们发现，人工智能对就业的负面影响低于预期，这一点在数据中反复得到印证。原因在于，至少到目前为止，AI在大多数情况下仍需人类操作才能创造价值。多数工作无法完全由AI自动化，只能替代其中的某些任务。而当你将特定任务自动化时，反而能从这
...
> Anthropic经济学主管发表了一篇精彩文章。他们发现，人工智能对就业的负面影响低于预期，这一点在数据中反复得到印证。原因在于，至少到目前为止，AI在大多数情况下仍需人类操作才能创造价值。多数工作无法完全由AI自动化，只能替代其中的某些任务。而当你将特定任务自动化时，反而能从这些岗位中获得更多产出，从而在许多情况下提升（或至少维持）了需求。"迄今为止，AI既偏向技能型人才，又能增强劳动力。它补充了领域专业知识，依赖人类参与来指导和评估最复杂的工作，并奖励精通AI技术的人。模型能力虽在快速提升，但始终存在顽固的参差不齐。要填补这种参差不齐的前沿领域中的空白，就需要专家监督来驾驭能力极强的AI系统，并在其出现失误时进行补救。"我推测，我们将在许多关键工作领域持续观察到这一现象。这在软件工程领域已明显显现——软件产出正在成倍增长，而这一切仍需要开发者来管理智能体的工作。如今各行各业都需要软件工程师，各种规模的公司都能启动过去难以实施的软件项目。但在智能体能够加速工作产出的世界里，许多其他工作领域的需求仍将保持强劲。杰文斯悖论依然成立。
