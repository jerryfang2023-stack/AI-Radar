...
原始来源标题显示：Trase 获得 ARCH Venture Partners 领投的 1.07 亿美元种子轮融资。

## 原文要点

- Trase宣布完成1.07亿美元种子轮融资，用于继续建设its agentic operating system for 受监管行业。
- Trase是一家全栈 AI 公司，提供面向高风险环境的 agentic operating system 和 AI Agent。
- 原文称，该平台面向受监管行业设计，强调安全、治理、主权、可审计性和可预测性。
