...
formal_tags:
  ...
  scenario: []
  customer: []
  evidence: ["evidence-pricing-cost", "evidence-customer-metric", "evidence-funding"]
...
Mowito 获得 300 万美元 种子前轮融资。

## 原文要点

- 原文称传统机器人系统依赖刚性手写程序，设置耗时且在零件或流程变化后容易失效，Mowito 用可从单次演示学习的模型降低重配成本。

## 价值描述

Mowito 机器人已在一家财富 500 强汽车公司的生产线运行，并服务一家大型电子合同制造商，用于汽车关键部件生产。
