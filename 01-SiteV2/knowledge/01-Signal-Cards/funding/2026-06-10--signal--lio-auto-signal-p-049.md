...
formal_tags:
  ...
  scenario: ["scenario-bidding-response", "scenario-construction-real-estate"]
...
frontend:
  displayTitle: "Lio Technologies Raises $30m Series A to Bring Agentic AI to Enterprise Procurement | HELIAD Hightlights"
  sourceLinks:
...
Lio 的融资信号可用于观察资本是否继续流向 地产和建筑设计工作流。
