...
signal_owner: "如何使用 NVIDIA Alpamayo 在仿真反馈链路中后训练自动驾驶模型"
...
# 如何使用 NVIDIA Alpamayo 在仿真反馈链路中后训练自动驾驶模型 部署 AI 到模型部署和算力调用

## 信号底稿

谁：如何使用 NVIDIA Alpamayo 在仿真反馈链路中后训练自动驾驶模型。

做了什么：如何使用 NVIDIA Alpamayo 在仿真反馈链路中后训练自动驾驶模型 把 AI 放进模型部署和算力调用，材料显示它已经对应到具体任务或客户环境。

证据是什么：来源为 https://developer.nvidia.com/blog/how-to-post-train-autonomous-vehicle-models-in-closed-loop-with-nvidia-alpamayo，对应本地证据 R-007，材料已保留全文、哈希和出处。
