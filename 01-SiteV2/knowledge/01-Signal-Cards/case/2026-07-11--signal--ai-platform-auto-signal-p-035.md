...
type: signal_card
signal_type: case
title: "持久执行的新编程模型--Vercel"
date: 2026-07-11
status: published
source_title: "A new programming model for durable execution - Vercel"
...
primary_raw:
  raw_ref: R-035
  raw_archive: "01-SiteV2/content/01-raw/originals/2026-07-11/r-035-a-new-programming-model-for-durable-execution-vercel.md"
  raw_json: "01-SiteV2/content/01-raw/originals/2026-07-11/r-035-a-new-programming-model-for-durable-execution-vercel.json"
...
opportunity_signals:
  ...
  source_excerpt: "原文称，Today, Vercel Workflows is generally available."
  missing_fields: ["adoption_evidence", "delivery_model"]

signal_owner: "AI platform"

frontend:
  displayTitle: "持久执行的新编程模型--Vercel"
  sourceLinks:
...
原始来源标题显示：持久执行的新编程模型--Vercel。

## 原文要点

- 原文称，Today, Vercel Workflows is generally available.
