...
opportunity_signals:
  ...
  source_excerpt: "We’ll design, build, and launch it in days."
  missing_fields: ["product_form", "delivery_model"]

event: "Foundey 把 AI 用进销售和收入团队流程。"
...
signal_owner: "Foundey"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "Foundey"
  eventLine: "Foundey 把 AI 用进销售和收入团队流程。"
...
做了什么：Foundey 把 AI 用进销售和收入团队流程。

证据是什么：来源为 https://foundey.com/，对应本地证据 R-019，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

Foundey 把 AI 用进销售和收入团队流程。
