...
signal_owner: "NVIDIA Vera CPU 为AI工厂的智能体工作负载设立新标准"
...
# NVIDIA Vera CPU 为AI工厂的智能体工作负载设立新标准 部署 AI 到模型部署和算力调用

## 信号底稿

谁：NVIDIA Vera CPU 为AI工厂的智能体工作负载设立新标准。

做了什么：NVIDIA Vera CPU 为AI工厂的智能体工作负载设立新标准 把 AI 放进模型部署和算力调用，材料显示它已经对应到具体任务或客户环境。

证据是什么：来源为 https://developer.nvidia.com/blog/nvidia-vera-cpu-sets-a-new-standard-for-agentic-workloads-in-ai-factories，对应本地证据 R-012，材料已保留全文、哈希和出处。
