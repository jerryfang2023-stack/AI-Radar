...
opportunity_signals:
  ...
  source_excerpt: "Beyond LLMs 把 AI 用进模型部署和算力调用 Beyond LLMs: Why Scalable Enterprise AI Adoption Depends on ..."
...
signal_owner: "Beyond LLMs"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "超越大语言模型：为何可扩展的企业AI应用取决于……"
...
# 超越大语言模型：为何可扩展的企业AI应用取决于……

## 信号底稿

谁：Beyond LLMs。

做了什么：Beyond LLMs 把 AI 用进模型部署和算力调用。

证据是什么：来源为 https://huggingface.co/blog/ibm-research/agent-logic-and-scalable-ai-adoption，对应本地证据 R-011，材料已保留全文、哈希和出处。
