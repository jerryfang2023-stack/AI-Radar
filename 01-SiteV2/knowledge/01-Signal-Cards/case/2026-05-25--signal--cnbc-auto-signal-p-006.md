...
opportunity_signals:
  ...
  source_excerpt: "Cheap AI could derail OpenAI and Anthropic IPOs Cheap AI could derail OpenAI and Anthropic IPOs 2026-05-20T19:15:00Z / query=model release inference cost reduction enterprise adoption / intent=find_market_trend / path=a..."
  missing_fields: ["specific_task", "product_form", "adoption_evidence", "delivery_model"]

event: "Cnbc 把 AI 用进地产开发和建筑设计流程。"
...
frontend:
  displayTitle: "Cheap AI could derail OpenAI and Anthropic IPOs"
  eventLine: "Cnbc 把 AI 用进地产开发和建筑设计流程。"
...
做了什么：Cnbc 把 AI 用进地产开发和建筑设计流程。

证据是什么：来源为 https://www.cnbc.com/2026/05/20/cheap-ai-could-derail-openai-and-anthropics-ipos.html，对应本地证据 R-006，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

Cnbc 把 AI 用进地产开发和建筑设计流程。
