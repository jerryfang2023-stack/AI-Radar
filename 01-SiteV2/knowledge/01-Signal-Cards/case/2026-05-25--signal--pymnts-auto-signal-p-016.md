...
frontend:
  displayTitle: "PYMNTS | Better.com's AI Agent Resolved 35% of Mortgage Calls Al…"
  eventLine: "PYMNTS 把 AI 用进销售和收入团队流程。"
  ...
  sourceLinks:
    - "https://www.pymnts.com/artificial-intelligence-2/2026/better-coms-ai-agent-resolved-35-of-mortgage-calls-alone/"
---
...
做了什么：PYMNTS 把 AI 用进销售和收入团队流程。

证据是什么：来源为 https://www.pymnts.com/artificial-intelligence-2/2026/better-coms-ai-agent-resolved-35-of-mortgage-calls-alone/，对应本地证据 R-017，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

PYMNTS 把 AI 用进销售和收入团队流程。
