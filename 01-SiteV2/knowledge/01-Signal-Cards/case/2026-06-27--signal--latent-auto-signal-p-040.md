...
type: signal_card
signal_type: case
title: "首个机械可解释性前沿实验室——Goodfire AI 的 Myra Deng 与 Mark Bissell"
date: 2026-06-27
status: published
...
frontend:
  displayTitle: "首个机械可解释性前沿实验室——Goodfire AI 的 Myra Deng 与 Mark Bissell"
  sourceLinks:
    - "https://www.latent.space/p/goodfire"
---

# 首个机械可解释性前沿实验室——Goodfire AI 的 Myra Deng 与 Mark Bissell

## 新闻事实

来源材料显示，Latent 的融资或资金流向涉及地产开发和建筑设计流程；原文同时出现 $150M、$1.25B 等数字。

## 原文要点

- 来源材料显示，Latent 的融资或资金流向涉及地产开发和建筑设计流程；原文同时出现 $150M、$1 等数字。
- 来源材料显示，Latent 的AI 商业动作涉及地产开发和建筑设计流程。
