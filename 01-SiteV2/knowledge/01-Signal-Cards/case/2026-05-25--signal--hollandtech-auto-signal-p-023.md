...
opportunity_signals:
  ...
  source_excerpt: "They open Claude, or ChatGPT, or Copilot — doesn’t matter which — and ask it what they should build."
  missing_fields: ["adoption_evidence", "delivery_model"]

event: "Hollandtech 把 AI 用进地产开发和建筑设计流程。"
...
signal_owner: "Hollandtech"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "克劳德不是你的架构师。别再让他假装是了"
  eventLine: "Hollandtech 把 AI 用进地产开发和建筑设计流程。"
...
做了什么：Hollandtech 把 AI 用进地产开发和建筑设计流程。

证据是什么：来源为 https://www.hollandtech.net/claude-is-not-your-architect，对应本地证据 R-024，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

Hollandtech 把 AI 用进地产开发和建筑设计流程。
