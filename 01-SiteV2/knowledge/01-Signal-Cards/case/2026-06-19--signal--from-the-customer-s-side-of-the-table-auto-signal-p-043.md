...
frontend:
  displayTitle: "从客户角度看：前部署工程师的实际工作内容"
  sourceLinks:
    - "https://www.ellamind.com/blog/forward-deployed-engineer"
---

# 从客户角度看：前部署工程师的实际工作内容
...
From the Customer's Side of the Table 的案例信号可用于观察 AI 是否已经进入 销售和收入团队流程，以及后续是否出现客户、流程或结果指标。
