...
type: signal_card
signal_type: case
title: "Multi-Agent AI Sales Crew Case Study: 4.2× SQL Conversion Lift, $14.2M Pipeline on CrewAI + Claude 3.5 + Salesforce | DreamzTech"
date: 2026-05-25
status: published
...
primary_raw:
  ...
  full_text_hash: "1613c6625ed0607f"
  source_level: B
...
opportunity_signals:
  ...
  adoption_evidence: ["case_study", "partnership_announcement"]
  source_evidence_type: ["funding_news", "first_party_case"]
  evidence_basis: "raw_source_text"
  source_excerpt: "Multi-Agent AI Sales Crew Case Study: 4.2× SQL Conversion Lift, $14.2M Pipeline on CrewAI + Claude 3.5 + Salesforce | DreamzTech Multi-Agent AI Sales Crew Case Study: 4.2× SQL Conversion Lift, $14.2M Pipeline on CrewAI ..."
  missing_fields: ["delivery_model"]

event: "Multi 把 AI 用进销售和收入团队流程。"
...
frontend:
  displayTitle: "Multi-Agent AI Sales Crew Case Study: 4.2× SQL Conversion Lift, $14.2M Pipeline on CrewAI + Claude 3.5 + Salesforce | DreamzTech"
  eventLine: "Multi 把 AI 用进销售和收入团队流程。"
  ...
  sourceLinks:
    - "https://www.dreamztech.com/multi-agent-ai-sales-automation-case-study/"
---

# Multi-Agent AI Sales Crew Case Study: 4.2× SQL Conversion Lift, $14.2M Pipeline on CrewAI + Claude 3.5 + Salesforce | DreamzTech

## 信号底稿

谁：Multi。

做了什么：Multi 把 AI 用进销售和收入团队流程。

证据是什么：来源为 https://www.dreamztech.com/multi-agent-ai-sales-automation-case-study/，对应本地证据 R-004，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

Multi 把 AI 用进销售和收入团队流程。
