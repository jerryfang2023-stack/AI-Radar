...
opportunity_signals:
  ...
  source_excerpt: "Introducing Claude Opus 4.8 \\ Anthropic 发布 AI 能力，指向模型部署和算力调用 Introducing Claude Opus 4.8 \\ Anthropic Introducing Claude Opus 4.8 \\ Anthropic # Introducing Claude Opus 4.8 We’re upgrading Claude Opus to a new version: Cl..."
...
signal_owner: "Introducing Claude Opus 4.8 \ Anthropic"
...
# Introducing Claude Opus 4.8 \ Anthropic 发布 AI 能力，指向模型部署和算力调用

## 信号底稿

谁：Introducing Claude Opus 4.8 \ Anthropic。

做了什么：Introducing Claude Opus 4.8 \ Anthropic 发布新的 AI 能力，面向模型部署和算力调用。

证据是什么：来源为 https://www.anthropic.com/news/claude-opus-4-8?ct=13057，对应本地证据 R-010，材料已保留全文、哈希和出处。
