...
opportunity_signals:
  ...
  source_excerpt: "kritird/Cortex-Agent-Framework kritird/Cortex-Agent-Framework | | | | | 8 cloud LLM providers + local | Anthropic, OpenAI, Gemini, Grok, Mistral, DeepSeek, AWS Bedrock, Azure AI — plus local Ollama / LM Studio / vLLM wi..."
  missing_fields: ["adoption_evidence"]

event: "kritird/Cortex 发布新的 AI 能力，面向模型部署和算力调用。"
...
signal_owner: "kritird/Cortex"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "kritird/Cortex-Agent-Framework"
  eventLine: "kritird/Cortex 发布新的 AI 能力，面向模型部署和算力调用。"
  ...
  sourceLinks:
    - "https://github.com/kritird/cortex-agent-framework"
---
...
做了什么：kritird/Cortex 发布新的 AI 能力，面向模型部署和算力调用。

证据是什么：来源为 https://github.com/kritird/cortex-agent-framework，对应本地证据 R-013，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

kritird/Cortex 发布新的 AI 能力，面向模型部署和算力调用。
