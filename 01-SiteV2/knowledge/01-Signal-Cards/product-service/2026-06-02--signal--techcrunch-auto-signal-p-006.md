...
title: "AWS将于下周推出AI代理市场，Anthropic作为合作伙伴 | TechCrunch"
date: 2026-06-02
status: published
...
opportunity_signals:
  ...
  source_excerpt: "AWS 将推出 Agent Marketplace，Anthropic 成为合作方 AWS is launching an AI agent marketplace next week with Anthropic as a partner | TechCrunch Amazon Web Services (AWS) is launching an AI agent marketplace next week and Anthropi..."
...
frontend:
  displayTitle: "AWS将于下周推出AI代理市场，Anthropic作为合作伙伴 | TechCrunch"
...
# AWS将于下周推出AI代理市场，Anthropic作为合作伙伴 | TechCrunch

## 信号底稿

谁：Techcrunch。

做了什么：Techcrunch 发布新的 AI 能力，面向销售和收入团队流程。

证据是什么：来源为 https://techcrunch.com/2025/07/10/aws-is-launching-an-ai-agent-marketplace-next-week-with-anthropic-as-a-partner/，对应本地证据 R-008，材料已保留全文、哈希和出处。
