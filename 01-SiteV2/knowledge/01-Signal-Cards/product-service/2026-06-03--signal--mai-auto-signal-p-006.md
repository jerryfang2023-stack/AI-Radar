...
opportunity_signals:
  ...
  source_excerpt: "微软推出 MAI-Thinking-1 模型 微软推出 MAI-Thinking-1 模型 微软通过其AI官方网站 microsoft.ai 发布了新模型 \"MAI-Thinking-1\"。该消息随链接一同发布，并出现在相关技术社区中。"
...
做了什么：微软推出 MAI 发布新的 AI 能力，面向模型部署和算力调用。

证据是什么：来源为 https://microsoft.ai/news/introducing-mai-thinking-1，对应本地证据 R-007，材料已保留全文、哈希和出处。
