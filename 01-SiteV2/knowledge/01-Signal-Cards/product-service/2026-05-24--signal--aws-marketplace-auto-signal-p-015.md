...
opportunity_signals:
  ...
  source_excerpt: "AWS Marketplace 发布 AI 能力，指向地产开发和建筑设计流程 AWS Partner Guide to AI Agents and Tools in AWS Marketplace As organizations implement these agents to automate specific business processes; from medical research to intelligent en..."
...
# AWS Marketplace 发布 AI 能力，指向地产开发和建筑设计流程

## 信号底稿

谁：AWS Marketplace。

做了什么：AWS Marketplace 发布新的 AI 能力，面向地产开发和建筑设计流程。

证据是什么：来源为 https://aws.amazon.com/blogs/apn/aws-partner-guide-to-ai-agents-and-tools-in-aws-marketplace/，对应本地证据 R-015，材料已保留全文、哈希和出处。
