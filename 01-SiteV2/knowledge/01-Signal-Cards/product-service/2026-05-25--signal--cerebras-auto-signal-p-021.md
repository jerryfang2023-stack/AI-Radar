...
opportunity_signals:
  ...
  source_excerpt: "Cerebras Brings Kimi K2.6 Inference to Enterprises Cerebras Brings Kimi K2.6 Inference to Enterprises Cerebras Brings Kimi K2.6 Inference to Enterprises Cerebras Brings Trillion Parameter Inference to Enterprises with K..."
  missing_fields: ["product_form", "adoption_evidence", "delivery_model"]

event: "Cerebras 发布新的 AI 能力，面向销售和收入团队流程。"
...
signal_owner: "Cerebras"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "Cerebras Brings Kimi K2.6 Inference to Enterprises"
  eventLine: "Cerebras 发布新的 AI 能力，面向销售和收入团队流程。"
...
做了什么：Cerebras 发布新的 AI 能力，面向销售和收入团队流程。

证据是什么：来源为 https://www.cerebras.ai/blog/cerebras-kimi-k2-Enterprise，对应本地证据 R-022，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

Cerebras 发布新的 AI 能力，面向销售和收入团队流程。
