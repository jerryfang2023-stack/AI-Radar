...
# Ultra 发布面向模型部署和算力调用的 AI 能力

## 信号底稿

谁：Ultra。

做了什么：Ultra 发布新的 AI 能力，材料显示它面向模型部署和算力调用。

证据是什么：来源为 https://www.theverge.com/tech/940584/microsoft-surface-laptop-ultra-nvidia-rtx-spark-pictures，对应本地证据 R-014，材料已保留全文、哈希和出处。
