...
original_url: "https://www.marktechpost.com/2026/05/23/build-a-superclaude-framework-workflow-with-commands-agents-modes-and-session-memory"
canonical_url: "https://www.marktechpost.com/2026/05/23/build-a-superclaude-framework-workflow-with-commands-agents-modes-and-session-memory"
...
search_path_label: ""
author: ""
published_at: "2026-05-23T19:05:33.000Z"
collected_at: 2026-05-24T04:09:10.444Z
language: mixed
full_text_hash: 4f38a460cc215d1f
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-24/r-001-构建基于superclaude框架的工作流-融合命令-代理-模式与会话记忆.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-24/r-001-构建基于superclaude框架的工作流-融合命令-代理-模式与会话记忆.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":60000,"paragraph_count":543,"sentence_count":61,"boilerplate_hits":2,"symbol_ratio":0.0059,"method":"article"}
has_full_text: true
...
discovery_record: {"discovery_title":"构建基于SuperClaude框架的工作流：融合命令、代理、模式与会话记忆","discovery_summary":"一篇技术教程详细介绍了如何构建一个高级工作流系统。该系统以SuperClaude框架为核心，作为一层结构化中间件部署在Anthropic API之上。教程核心内容围绕如何整合命令解析、智能代理调度、多种操作模式切换以及跨会话的上下文记忆能力，从而打造出一个功能更全面、上下文连贯性更强的AI应用工作流。文章旨在指导开发者利用这些组件，提升基于大型语言模型构建的应用的复杂任务处理与交互体验。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/05/23/build-a-superclaude-framework-workflow-with-commands-agents-modes-and-session-memory","discovered_at":"2026-05-24T04:04:36.067Z","rank_on_page":50,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 6cad3fbf279b9a89
content_hash: bdebcc74ad364b59
semantic_hash: e0e2b1c5521e1eb6
duplicate_of: ""
first_seen_at: "2026-05-23T19:05:33.000Z"
last_seen_at: 2026-05-24T04:09:10.444Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta"],"products":["Agents","agents","claude","Claude","agent","Agent","MCP","Gemini"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["0.40","0","1","4","5","8","1800","2"],"quotes":[", pkg], check=True)\nfor mod, pkg in [(","anthropic>=0.40.0",")]:\ntry:\n__import__(mod)\nexcept ImportError:\nprint(f","/content/SuperClaude_Framework","📥 Cloning SuperClaude Framework …"]}
...
title_zh: "构建基于SuperClaude框架的工作流：融合命令、代理、模式与会话记忆"
...
Sana Hassan
LogLLM: Leveraging Large Language Models for Enhanced Log-Based Anom
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":60000,"paragraph_count":543,"sentence_count":61,"boilerplate_hits":2,"symbol_ratio":0.0059,"method":"article"}
...
2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Editors Pick Agentic AI AI Agents Software Engineering Staff Tutorials In this tutorial, we build an advanced workflow using the SuperClaude Framework as a structured layer on top of the Anthropic API.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We clone the framework, discover its commands, agents, and modes, and create a Python bridge that dynamically loads the relevant Markdown behavior files into the system prompt before each model call.

4. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   Through practical examples, we explore brainstorming, frontend implementation, security analysis, business strategy, deep research planning, token-efficient responses, and a chained multi-step development workflow with session save and load support.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We also learn how these reusable framework assets make our prompts more consistent, role-aware, and suitable for complex AI-assisted software development tasks.

6. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Copy Code Copied Use a different Browser import subprocess, sys, os, json, textwrap, getpass, time from pathlib import Path def _pip(pkg): subprocess.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta
- products: Agents, agents, claude, Claude, agent, Agent, MCP, Gemini
- people: 暂无公开信息
...
- numbers: 0.40, 0, 1, 4, 5, 8, 1800, 2
- quotes: , pkg], check=True)
for mod, pkg in [( / anthropic>=0.40.0 / )]:
try:
__import__(mod)
except ImportError:
...
- company_actions: We clone the framework, discover its commands, agents, and modes, and create a Python bridge that dynamically loads the relevant Markdown behavior files into the system prompt before each model call. / We also learn how these reusable framework assets make our prompts more consistent, role-aware, and suitable for complex AI-assisted software development tasks.
- case_details: 一篇技术教程详细介绍了如何构建一个高级工作流系统。该系统以SuperClaude框架为核心，作为一层结构化中间件部署在Anthropic API之上。教程核心内容围绕如何整合命令解析、智能代理调度、多种操作模式切换以及跨会话的上下文记忆能力，从而打造出一个功能更全面、上下文连贯性更强的AI应用工作流。文章旨在指导开发者利用这些组件，提升基于大型语言模型构建的应用的复杂任务处理与交互体验。
- workflow_changes: Editors Pick Agentic AI AI Agents Software Engineering Staff Tutorials In this tutorial, we build an advanced workflow using the SuperClaude Framework as a structured layer on top of the Anthropic API. / Copy Code Copied Use a different Browser import subprocess, sys, os, json, textwrap, getpass, time from pathlib import Path def _pip(pkg): subprocess.
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: Through practical examples, we explore brainstorming, frontend implementation, security analysis, business strategy, deep research planning, token-efficient responses, and a chained multi-step development workflow with session save and load support.
