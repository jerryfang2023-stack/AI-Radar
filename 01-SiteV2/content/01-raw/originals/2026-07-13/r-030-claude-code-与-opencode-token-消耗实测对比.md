...
raw_id: R-030
title: "Claude Code 与 OpenCode token 消耗实测对比"
title_zh: "Claude Code 与 OpenCode token 消耗实测对比"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://systima.ai/blog/claude-code-vs-opencode-token-overhead"
canonical_url: "https://systima.ai/blog/claude-code-vs-opencode-token-overhead"
...
search_path_label: ""
author: ""
published_at: "2026-07-12T19:27:07.004Z"
collected_at: 2026-07-13T07:40:18.879Z
language: mixed
full_text_hash: 1619ca0cc22f053d
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-030-claude-code-与-opencode-token-消耗实测对比.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-030-claude-code-与-opencode-token-消耗实测对比.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Claude Code 与 OpenCode token 消耗实测对比","discovery_summary":"一项实测显示，在相同模型、机器和任务下，Claude Code 在读取用户提示前会发送约 3.3 万个 token（系统提示、工具架构和注入脚手架），而 OpenCode 仅发送约 7 千个。Claude Code 的缓存效率更低，同一任务中写入的缓存 token 最高可达 OpenCode 的 54 倍。生产仓库中 72KB 的指令文件每次请求额外增加约 2 万个 token，五个 MCP 服务器再增加 5 千至 7 千个。实际工作配置首次请求时，token 消耗已达 7.5 万至 8.5 万个。不过在多步骤任务中，Claude Code 的总 token 消耗低于 OpenCode，因其将工具调用批量合并为更少的请求。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://systima.ai/blog/claude-code-vs-opencode-token-overhead","discovered_at":"2026-07-13T07:30:42.895Z","rank_on_page":113,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 398431a5f118d841
content_hash: cba1a414553311fe
semantic_hash: 284fe0d11adff0db
duplicate_of: ""
first_seen_at: "2026-07-12T19:27:07.004Z"
last_seen_at: 2026-07-13T07:40:18.879Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）"],"products":["Claude","MCP","AGENTS","CLAUDE","agent","claude","mcp","agents"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理"],"business_actions":[],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["3.3 万","7","54 倍","72","2 万","5","7.5 万","8.5 万"],"quotes":["what does my agent actually send","Reply with exactly: OK"," and OpenCode with ","You are OpenCode, the best coding agent on the planet"]}
...
fact_extraction_completed_at: 2026-07-13T07:40:18.879Z
...
Two of the findings are independent of quality, though. Re-writing a
...
No breaks detected
Hash chain integrity: VALID This is the same mechanism the library provides for EU AI Act Article 12 logging; structured records, integrity you can hand to a third party, and reconstruction of exactly what was sent and returned.
...
Claude Code OpenCode tokens prompt caching cache writes agent harness MCP subagents benchmarks
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":21430,"paragraph_count":130,"sentence_count":209,"boilerplate_hits":0,"symbol_ratio":0.0009,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   一项实测显示，在相同模型、机器和任务下，Claude Code 在读取用户提示前会发送约 3.3 万个 token（系统提示、工具架构和注入脚手架），而 OpenCode 仅发送约 7 千个。Claude Code 的缓存效率更低，同一任务中写入的缓存 token 最高可达 OpenCode 的 54 倍。生产仓库中 72KB 的指令文件每次请求额外增加约 2 万个 token，五个 MCP 服务器再增加 5 千至 7 千个。实际工作配置首次请求时，token 消耗已达 7.5 万至 8.5 万个。不过在多步骤任务中，Claude Code 的总 token 消耗低于 OpenCode，因其将工具调用批量合并为更少的请求。
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   That first test was on Sonnet 4.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Re-running on Claude Fable 5 narrowed the gap to about 3.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）
- products: Claude, MCP, AGENTS, CLAUDE, agent, claude, mcp, agents
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 3.3 万, 7, 54 倍, 72, 2 万, 5, 7.5 万, 8.5 万
- quotes: what does my agent actually send / Reply with exactly: OK /  and OpenCode with  / You are OpenCode, the best coding agent on the planet

## evidence_seed

- company_actions: We put Claude Code and OpenCode on the same model, the same machine, and the same tasks, then examined everything sent and received. / Claude Code is far hungrier: When we asked both harnesses for a one-line reply, Claude Code used roughly 33,000 tokens of system prompt, tool schemas, and injected scaffolding before the prompt even arrived. / OpenCode used about 7,000.
- case_details: 暂无公开信息
