...
original_url: "https://www.interconnects.ai/p/frontier-post-training-recipe-review"
canonical_url: "https://interconnects.ai/p/frontier-post-training-recipe-review"
...
collected_at: 2026-07-13T07:15:27.192Z
language: mixed
full_text_hash: 127bff1bc27699e9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-057-frontier-post-training-recipe-review-with-finbarr-timbers.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-057-frontier-post-training-recipe-review-with-finbarr-timbers.json"
html_snapshot_path: ""
screenshot_path: ""
...
business_elements: {"companies":["Interconnects (Nathan Lambert)","Apple"],"products":["agent","ChatGPT"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["18","39","1","0","00","56","35","16"],"quotes":["Interview","Interview","We are so back"]}
...
fact_extraction_completed_at: 2026-07-13T07:15:27.192Z
theme: uncategorized
...
00:10:48 Finbarr Timbers: Well, I think
...
2. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Interconnects Frontier post-training recipe review with Finbarr Timbers 39 1× 0:00 Current time: 0:00 / Total time: -56:35 -56:35 Audio playback is not supported on your browser.

3. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   Frontier post-training recipe review with Finbarr Timbers "Interview" #18 Nathan Lambert Jun 16, 2026 39 Share Transcript As I’ve been recapping fundamentals of post-training to wrap up my RLHF / Post-training book I knew I needed to get Finbarr Timbers back on the podcast to talk about the state of play.
...
4. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Over the last few months we’ve had many discussions on what we’d need to do to take an Olmo-style recipe to the frontier, supported by Finbarr’s extensive reading of recent model technical reports.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   To prepare for this, I put together a summary slide deck on the key post-training recipes historically — the path from InstructGPT to today — and today — the key open frontier models.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   This deck is summarized below as the technical summary, but we do spend 20-35 minutes on it in the podcast, so watching on YouTube is likely the best experience for this one.

## business_elements

- companies: Interconnects (Nathan Lambert), Apple
...
- numbers: 18, 39, 1, 0, 00, 56, 35, 16
- quotes: Interview / Interview / We are so back

## evidence_seed

- company_actions: To prepare for this, I put together a summary slide deck on the key post-training recipes historically — the path from InstructGPT to today — and today — the key open frontier models. / This deck is summarized below as the technical summary, but we do spend 20-35 minutes on it in the podcast, so watching on YouTube is likely the best experience for this one.
- case_details: 暂无公开信息
- workflow_changes: Interconnects Frontier post-training recipe review with Finbarr Timbers 39 1× 0:00 Current time: 0:00 / Total time: -56:35 -56:35 Audio playback is not supported on your browser. / Over the last few months we’ve had many discussions on what we’d need to do to take an Olmo-style recipe to the frontier, supported by Finbarr’s extensive reading of recent model technical reports.
