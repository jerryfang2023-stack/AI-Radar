...
title_zh: "腾讯混元发布Hy3模型：295B参数MoE架构，Agent向LLM定位，已集成微信服务10亿+用户"
...
author: ""
published_at: ""
collected_at: 2026-07-13T08:51:53.172Z
language: mixed
full_text_hash: 15188bdc426bede9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-098-腾讯混元发布hy3模型-295b参数moe架构-agent向llm定位-已集成微信服务10亿-用户.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-098-腾讯混元发布hy3模型-295b参数moe架构-agent向llm定位-已集成微信服务10亿-用户.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"腾讯混元发布Hy3模型：295B参数MoE架构，Agent向LLM定位，已集成微信服务10亿+用户","discovery_summary":"腾讯混元团队发布Hy3模型，采用295B总参数、21B激活参数的MoE架构，推理效率可打平参数规模2-5倍的旗舰模型。Hy3定位为Agent向LLM，从preview到正式版基于50多个真实业务反馈迭代，内部WorkBuddy任务成功率从72%提升至90%，耗时降低34%，幻觉和常识错误持续下降。实测显示其在coding、办公、复杂任务规划方面表现突出，纯视觉能力为短板。Hy3已集成至微信服务10亿+用户，视频演示包括生成HTML网页、Agent网页和10页PPT，模型具备自检和主动说明不足的能力。","source_name":"X：阿易 AI Notes (@AYi_AInotes)","origin_url":"","discovered_at":"2026-07-13T08:42:55.256Z","rank_on_page":1,"discovery_status":"discovered"}
...
content_hash: 15188bdc426bede9
semantic_hash: 3534f052eaab27d6
duplicate_of: ""
first_seen_at: "2026-07-13T08:51:53.172Z"
last_seen_at: 2026-07-13T08:51:53.172Z
...
business_elements: {"companies":["X","阿易 AI Notes (@AYi_AInotes)"],"products":["Agent"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["合同审阅 / 法律研究","部署 / 集成交付"],"business_actions":["发布 / 推出"],"affected_departments":[],"numbers":["3","295B","10亿","21B","2","5倍","50","72%"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-13T08:51:53.172Z
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=medium
   实测显示其在coding、办公、复杂任务规划方面表现突出，纯视觉能力为短板。
...
5. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=medium
   Hy3已集成至微信服务10亿+用户，视频演示包括生成HTML网页、Agent网页和10页PPT，模型具备自检和主动说明不足的能力。
...
- numbers: 3, 295B, 10亿, 21B, 2, 5倍, 50, 72%
- quotes: 暂无公开信息

## evidence_seed

- company_actions: 实测显示其在coding、办公、复杂任务规划方面表现突出，纯视觉能力为短板。
- case_details: 暂无公开信息
