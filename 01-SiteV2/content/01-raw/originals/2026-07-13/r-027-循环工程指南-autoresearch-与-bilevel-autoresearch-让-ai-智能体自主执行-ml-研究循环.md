...
raw_id: R-027
title: "循环工程指南：autoresearch 与 Bilevel Autoresearch 让 AI 智能体自主执行 ML 研究循环"
title_zh: "循环工程指南：autoresearch 与 Bilevel Autoresearch 让 AI 智能体自主执行 ML 研究循环"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://www.marktechpost.com/2026/07/12/guide-to-loop-engineering"
canonical_url: "https://marktechpost.com/2026/07/12/guide-to-loop-engineering"
...
search_path_label: ""
author: ""
published_at: "2026-07-12T20:07:02.000Z"
collected_at: 2026-07-13T08:26:47.290Z
language: mixed
full_text_hash: 503347ee5a8e6e9a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-027-循环工程指南-autoresearch-与-bilevel-autoresearch-让-ai-智能体自主执行-ml-研究循环.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-027-循环工程指南-autoresearch-与-bilevel-autoresearch-让-ai-智能体自主执行-ml-研究循环.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":8103,"paragraph_count":71,"sentence_count":105,"boilerplate_hits":0,"symbol_ratio":0.0035,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8103
fetch_error: ""
...
discovery_record: {"discovery_title":"循环工程指南：autoresearch 与 Bilevel Autoresearch 让 AI 智能体自主执行 ML 研究循环","discovery_summary":"循环工程（Loop Engineering）是一种替代传统手动交互的 AI 使用模式，通过循环机制让 AI 智能体自主完成机器学习研究。该指南基于 Andrej Karpathy 的 autoresearch 代码库和 Bilevel Autoresearch 论文两个已验证成果，框架参考了 @0xCodila 的撰文。autoresearch 实现研究任务的自动迭代，Bilevel Autoresearch 则引入双层优化结构，使智能体能在更高层次上自主设计并执行研究循环，从而减少人工干预，提升 ML 研究的自动化程度。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/12/guide-to-loop-engineering","discovered_at":"2026-07-13T08:19:14.663Z","rank_on_page":123,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 98a71f15ac70358b
content_hash: 503347ee5a8e6e9a
semantic_hash: cf1b3bdbc4c9cc13
duplicate_of: ""
first_seen_at: "2026-07-12T20:07:02.000Z"
last_seen_at: 2026-07-13T08:26:47.290Z
...
business_elements: {"companies":["MarkTechPost（RSS）","GitHub","Meta"],"products":["agent","agents","Claude","Codex"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["0x","2015","7","2026","630","90","000","12"],"quotes":["the Karpathy Loop."]}
...
fact_extraction_completed_at: 2026-07-13T08:26:47.290Z
theme: developer-ecosystem-signal
keyword_group: developer-ecosystem-signal
copyright_note: local research archive only
---

# 循环工程指南：autoresearch 与 Bilevel Autoresearch 让 AI 智能体自主执行 ML 研究循环
...
Next, researchers asked a sharper question. If autoresearch is research, can you autoresearch autoresearch? The research paper B ilevel Autoresearch: Meta-Autoresearching Itself answers yes.
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":8103,"paragraph_count":71,"sentence_count":105,"boilerplate_hits":0,"symbol_ratio":0.0035,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   循环工程（Loop Engineering）是一种替代传统手动交互的 AI 使用模式，通过循环机制让 AI 智能体自主完成机器学习研究。该指南基于 Andrej Karpathy 的 autoresearch 代码库和 Bilevel Autoresearch 论文两个已验证成果，框架参考了 @0xCodila 的撰文。autoresearch 实现研究任务的自动迭代，Bilevel Autoresearch 则引入双层优化结构，使智能体能在更高层次上自主设计并执行研究循环，从而减少人工干预，提升 ML 研究的自动化程度。

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Technology AI Shorts Applications Language Model Large Language Model Machine Learning New Releases Staff Most people still use AI like a 2015 search box.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   You type, you read, you type again.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   A newer pattern replaces that manual back-and-forth with a loop.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   This guide explains loop engineering using two verified artifacts.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The sources are Andrej Karpathy’s autoresearch repository and the Bilevel Autoresearch paper .
...
- numbers: 0x, 2015, 7, 2026, 630, 90, 000, 12
- quotes: the Karpathy Loop.

## evidence_seed

- company_actions: Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Technology AI Shorts Applications Language Model Large Language Model Machine Learning New Releases Staff Most people still use AI like a 2015 search box. / You type, you read, you type again. / A newer pattern replaces that manual back-and-forth with a loop.
- case_details: 暂无公开信息
