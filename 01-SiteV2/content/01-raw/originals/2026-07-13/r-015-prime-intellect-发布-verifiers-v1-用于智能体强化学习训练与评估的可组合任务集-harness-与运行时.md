...
search_path_label: ""
author: ""
published_at: "2026-07-13T07:40:18.000Z"
collected_at: 2026-07-13T08:26:47.186Z
language: mixed
full_text_hash: 59b79b4b078b2f0f
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-015-prime-intellect-发布-verifiers-v1-用于智能体强化学习训练与评估的可组合任务集-harness-与运行时.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-015-prime-intellect-发布-verifiers-v1-用于智能体强化学习训练与评估的可组合任务集-harness-与运行时.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":45298,"paragraph_count":381,"sentence_count":82,"boilerplate_hits":2,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
...
discovery_record: {"discovery_title":"Prime Intellect 发布 Verifiers v1：用于智能体强化学习训练与评估的可组合任务集、Harness 与运行时","discovery_summary":"Prime Intellect 推出 verifiers 0.2.0 版本，并在新命名空间 verifiers.v1 下重构核心架构。v1 将环境拆分为三个可组合部分：taskset（定义数据、工具与评分）、harness（执行任务并生成 rollout）和 runtime（运行 rollout）。verifiers 管理的拦截服务器代理 harness 与推理服务器之间的请求，实时记录轨迹，并支持重写工具响应以缓解训练中的奖励攻击。线性消息图轨迹取代了 v0 的二次方提示-补全对，支持长程训练。v1 支持 OpenAI Chat Completions、OpenAI Responses 和 Anthropic Messages 三种协议方言，Harbor 数据集及 Codex、Terminus 2 等 harness 可直接使用。在内部测试中，verifiers 在相同任务上匹配了 Harbor 的性能。GLM-4.5-Air 在 ScaleSWE 上训练两天，在 SWE-Bench-Verified 上评估，展示了稳定的智能体训练效果。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/13/prime-intellect-releases-verifiers-v1","discovered_at":"2026-07-13T08:19:14.633Z","rank_on_page":14,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: c134c00e5c1c6803
content_hash: b9328b1fc4989bcf
semantic_hash: 2be466a3f966799f
duplicate_of: ""
first_seen_at: "2026-07-13T07:40:18.000Z"
last_seen_at: 2026-07-13T08:26:47.186Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Codex","agents","agent","codex","GPT-5","Cursor","Agents","Claude","Agent","MCP"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["1","0.2","0","2","4.5","1 b","32","3"],"quotes":["What is {i} + {i}?","AdditionTaskset","nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B","primeintellect/terminal-bench-2","\nversion = "]}
...
fact_extraction_completed_at: 2026-07-13T08:26:47.186Z
...
Michal Sutter
A Coding Guide to Implement Adva
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":45298,"paragraph_count":381,"sentence_count":82,"boilerplate_hits":2,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Editors Pick Agentic AI Technology AI Shorts Artificial Intelligence New Releases Software Engineering Staff Tech News Prime Intellect launched verifiers 0.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It previews a rewritten core, shipped under the new verifiers.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Modern evaluations now run coding agents with tools, compaction, and subagents.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Accordingly, v1 rebuilds environments to run these agentic workloads at scale.
...
- products: Codex, agents, agent, codex, GPT-5, Cursor, Agents, Claude, Agent, MCP
- people: 暂无公开信息
...
- numbers: 1, 0.2, 0, 2, 4.5, 1 b, 32, 3
- quotes: What is {i} + {i}? / AdditionTaskset / nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B / primeintellect/terminal-bench-2 / 
version = 

## evidence_seed

- company_actions: Prime Intellect 推出 verifiers 0.2.0 版本，并在新命名空间 verifiers.v1 下重构核心架构。v1 将环境拆分为三个可组合部分：taskset（定义数据、工具与评分）、harness（执行任务并生成 rollout）和 runtime（运行 rollout）。verifiers 管理的拦截服务器代理 harness 与推理服务器之间的请求，实时记录轨迹，并支持重写工具响应以缓解训练中的奖励攻击。线性消息图轨迹取代了 v0 的二次方提示-补全对，支持长程训练。v1 支持 OpenAI Chat Completions、OpenAI Responses 和 Anthropic Messages 三种协议方言，Harbor 数据集及 Codex、Terminus 2 等 harness 可直接使用。在内部测试中，verifiers 在相同任务上匹配了 Harbor 的性能。GLM-4.5-Air 在 ScaleSWE 上训练两天，在 SWE-Bench-Verified 上评估，展示了稳定的智能体训练效果。 / Editors Pick Agentic AI Technology AI Shorts Artificial Intelligence New Releases Software Engineering Staff Tech News Prime Intellect launched verifiers 0. / It previews a rewritten core, shipped under the new verifiers.
- case_details: 暂无公开信息
