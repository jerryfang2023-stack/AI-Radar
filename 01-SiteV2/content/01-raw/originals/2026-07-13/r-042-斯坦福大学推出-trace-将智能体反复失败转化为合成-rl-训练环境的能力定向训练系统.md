...
search_path_label: ""
author: ""
published_at: "2026-07-13T08:45:12.000Z"
collected_at: 2026-07-13T10:23:56.923Z
language: mixed
full_text_hash: 0a16693e67ba1400
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-042-斯坦福大学推出-trace-将智能体反复失败转化为合成-rl-训练环境的能力定向训练系统.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-042-斯坦福大学推出-trace-将智能体反复失败转化为合成-rl-训练环境的能力定向训练系统.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":8116,"paragraph_count":80,"sentence_count":90,"boilerplate_hits":0,"symbol_ratio":0.0034,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8116
fetch_error: ""
...
discovery_record: {"discovery_title":"斯坦福大学推出 TRACE：将智能体反复失败转化为合成 RL 训练环境的能力定向训练系统","discovery_summary":"斯坦福大学研究人员提出 TRACE，一种能力定向的智能体训练系统。该系统从智能体自身的运行轨迹中诊断出反复出现的失败模式，针对每种能力合成一个可验证的训练环境，为每种能力训练一个 LoRA 适配器，并在专家之间路由模型 token。TRACE 在 τ2-Bench 上提升了 15.3 个点，在 SWE-bench Verified 上达到 73.2% 的 Pass@1。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/13/stanford-researchers-introduce-trace","discovered_at":"2026-07-13T10:15:08.623Z","rank_on_page":26,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 06c84601d1b6c96b
content_hash: 0a16693e67ba1400
semantic_hash: fbdbc2871fb7b89b
duplicate_of: ""
first_seen_at: "2026-07-13T08:45:12.000Z"
last_seen_at: 2026-07-13T10:23:56.923Z
...
business_elements: {"companies":["MarkTechPost（RSS）","GitHub"],"products":["agents","agent","Agent","GPT-5","Codex","Claude"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["2","15.3","73.2%","1","0.20","0.10","3","4"],"quotes":["Qwen/Qwen3-30B-A3B-Instruct-2507","structured_data_reasoning"," --master-port=29501 -m train \\\n--game "," --model "]}
...
fact_extraction_completed_at: 2026-07-13T10:23:56.923Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":8116,"paragraph_count":80,"sentence_count":90,"boilerplate_hits":0,"symbol_ratio":0.0034,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   斯坦福大学研究人员提出 TRACE，一种能力定向的智能体训练系统。该系统从智能体自身的运行轨迹中诊断出反复出现的失败模式，针对每种能力合成一个可验证的训练环境，为每种能力训练一个 LoRA 适配器，并在专家之间路由模型 token。TRACE 在 τ2-Bench 上提升了 15.3 个点，在 SWE-bench Verified 上达到 73.2% 的 Pass@1。

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Tech News AI Paper Summary Technology AI Shorts Applications Language Model Large Language Model Machine Learning New Releases Staff Agentic LLMs often fail the same way, again and again.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   A Stanford research team traced this to missing, reusable capabilities.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Their system, TRACE , diagnoses those gaps and trains for them directly.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   TRACE stands for T urning R ecurrent A gent failures into C apability-targeted training E nvironments.

6. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   It was released open-source under an MIT license.

## business_elements

- companies: MarkTechPost（RSS）, GitHub
- products: agents, agent, Agent, GPT-5, Codex, Claude
- people: 暂无公开信息
- industries: 开发者工具
- roles: CIO / IT 负责人
- workflows: 权限 / 安全治理
...
- numbers: 2, 15.3, 73.2%, 1, 0.20, 0.10, 3, 4
- quotes: Qwen/Qwen3-30B-A3B-Instruct-2507 / structured_data_reasoning /  --master-port=29501 -m train \
--game  /  --model 
