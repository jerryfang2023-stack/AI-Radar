...
raw_id: R-051
title: "PaulDuvall/ai-development-patterns: A comprehensive ... - GitHub"
title_zh: ""
title_translation_status: needs_ingestion_translation
title_translation_method: title_translation_generator_failed
original_url: "https://github.com/paulDuvall/ai-development-patterns"
canonical_url: "https://github.com/paulDuvall/ai-development-patterns"
...
author: ""
published_at: ""
collected_at: 2026-07-13T08:51:52.897Z
language: mixed
full_text_hash: 963f7255278cae3b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-051-paulduvall-ai-development-patterns-a-comprehensive-github.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-13/r-051-paulduvall-ai-development-patterns-a-comprehensive-github.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":60000,"paragraph_count":852,"sentence_count":177,"boilerplate_hits":3,"symbol_ratio":0.0109,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
...
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"963f7255278cae3b","missing":[]}
...
url_hash: 5cb8190c161e2456
content_hash: 424abe341132d3b2
semantic_hash: b17e616d2d6f2b59
duplicate_of: ""
first_seen_at: "2026-07-13T08:51:52.897Z"
last_seen_at: 2026-07-13T08:51:52.897Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Google","GitHub"],"products":["agents","codex","AGENTS","CLAUDE","agent","Claude","Codex","Agent","Agents"],"people":[],"industries":["医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["49","608\nm","401","8","5b","2","5","3"],"quotes":["https://github.com/PaulDuvall/ai-development-patterns#agent-readiness","https://github.com/PaulDuvall/ai-development-patterns#codified-rules","https://github.com/PaulDuvall/ai-development-patterns#security-sandbox","https://github.com/PaulDuvall/ai-development-patterns#developer-lifecycle","https://github.com/PaulDuvall/ai-development-patterns#tool-integration"]}
evidence_seed: {"company_actions":["# Repository: PaulDuvall/ai-development-patterns A comprehensive collection of AI development patterns for building software with AI assistance, organized by implementation maturity and development lifecycle phases. Includes Foundation, Development, and Operations patterns with practical examples a.... / query=AI implementation startup funding enterprise workflow / intent=find_startups / path=developer_ecosystem","PaulDuvall ai-development-patterns Public Notifications You must be signed in to change notification settings Fork 49 Star 608 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 401 Commits 401 Commits .","agents/ skills/ evaluate-pattern-adoption ."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: ["证据对象不可用：疑似索引页、目录页、薄文本或非可用证据对象","疑似官网首页、产品目录或导航页，只能索引留存","没有具体客户或真实企业案例"]
key_excerpts: [{"type":"funding","text":"# Repository: PaulDuvall/ai-development-patterns A comprehensive collection of AI development patterns for building software with AI assistance, organized by implementation maturity and development lifecycle phases. Includes Foundation, Development, and Operations patterns with practical examples a.... / query=AI implementation startup funding enterprise workflow / intent=find_startups / path=developer_ecosystem","supports":["signal_card_candidate","relationship_graph_input","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"company_action","text":"PaulDuvall ai-development-patterns Public Notifications You must be signed in to change notification settings Fork 49 Star 608 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 401 Commits 401 Commits .","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"agents/ skills/ evaluate-pattern-adoption .","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"github assets assets docs docs examples examples experiments experiments scripts scripts tests tests verification verification .","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"python-version AGENTS.","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"medium","confidence":"high"}]
fact_extraction_status: extracted_at_raw_ingestion
fact_extraction_method: structured_key_excerpts_and_business_elements
fact_extraction_completed_at: 2026-07-13T08:51:52.897Z
theme: capital-market-signal
keyword_group: developer-ecosystem-signal
copyright_note: local research archive only
---

# PaulDuvall/ai-development-patterns: A comprehensive ... - GitHub
...
Execution
Regulates
Codified Rules / Centralized Rules
Feedforward
Conventions
...
Principle
What the loop must have
Catalog patterns that satisfy it
No executable done-check, no loop
An observable goal, acceptance criteria written first, and cheap reversal
Spec-Driven Development , Planned Implementation , Agent Observability ; reversible failure via Parallel Agents worktrees
The test arbitrates, not the model
Tight scope, an independent verifier, and checks wired to fire on every change
Atomic Decomposition , Adversarial Evaluator , Test Promotion , Agent Hooks , Autonomous Acceptance
Verification reach sets the autonomy ceiling
Hard bounds, state in git, and human-owned edges
Bounded Autonomy , Agent Memory , Long-Running Orchestration , Centralized Rules , Handoff Protocols
The Bounded Autonomy pattern supplies the control layer that caps turns, spend, and time, detects stalls and divergence, and captures an in-loop diagnostic trail.
Two principles from the source are worth stating directly:
...
The detailed, tool-specific field checklist for gating, scoping, and bounding loops lives at Loop Engineering Checklist .
Source : Synthesis of the "verification reach sets the autonomy ceiling" idea with field practice for running autonomous coding loops; see the companion Loop Engineering Checklist for the operational form. Conceptually complementary to the Harness Engineering Lens above, which addresses the quality of the controls this lens treats as the autonomy-setting constraint.
Lifecycle Lens
Most of this catalog reads like a menu: pick the patterns you need. The Lifecycle Lens instead orders them along one feature's path from problem to production, so you can see which pattern does the work at each stage and where the handoffs happen. Like the Harness Engineering Lens and Loop Engineering Lens , this is a lens over the catalog, not a pattern to adopt. The adoptable discipline — run the stages in order, don't skip ahead to code — lives in the Developer Lifecycle pattern; this lens is the map of which patterns carry each stage.
Stage
What it produces
Catalog patterns
1. Problem definition
A scoped problem statement and a readiness check
Agent Readiness
2-3. Plan & requirements
Architecture, tasks, and API specs
Planned Implementation , Issue Generation
4-5. Specifications & tests
Acceptance criteria written before any code
Spec-Driven Development
6. Implementation
Working code in small, verifiable increments
Atomic Decomposition , Incremental Generation
7. Testing & review
Test results, security scan, independent review
Agent Observability , Adversarial Evaluator
8. Deployment
A shipped change
Custom Commands , Agent Hooks
9. Monitoring & correction
Runtime signals and human-approved fixes
Agent Observability , Drift Remediation , Error Resolution
Read top to bottom it is a feedforward chain: each stage's output is the next stage's input. The catalog's three categories ( Foundation -> Development -> Operations ) are the same arc at coarser grain; this lens is the per-feature zoom of it.
Source : The nine-stage workflow from the Developer Lifecycle pattern, generalized into a mapping over the catalog. See examples/developer-lifecycle/ for a runnable end-to-end implementation.
...
Foundation
Foundation
Team readiness and basic AI integration infrastructure
Agent Readiness
Beginner
Foundation
Foundation
Evaluate codebase and team readiness for AI integration
None
Codified Rules
Beginner
Foundation
...
Foundation
Workflow
Take one feature from problem to production through a staged, plan-first discipline
Codified Rules , Security Sandbox
Tool Integration
Intermediate
Foundation
Foundation
Connect AI systems to external data, APIs, and tools
Security Sandbox , Developer Lifecycle
Issue Generation
Intermediate
Foundation
Foundation
Generate deployable work items sized under one AI-assisted hour, with acceptance criteria and dependencies
Agent Readiness
Development
Development
Daily coding workflows and tactical controls
Spec-Driven Development
Intermediate
Development
Development
Guide code generation with executable specifications and acceptance criteria
Developer Lifecycle
Planned Implementation
Beginner
Development
Development
Interview, constrain, and plan before writing code
None
Incremental Generation
Beginner
Development
Development
Build complex features through small, deployable iterations
Planned Implementation
Agent Memory
Intermediate
Development
Development
Preserve useful context and decisions across sessions
Codified Rules
Agent Hooks
Intermediate
Development
Development
Run commands and policy checks at assistant lifecycle hooks
Codified Rules , Security Sandbox
Custom Commands
Intermediate
Development
Development
Encode repeatable domain workflows in assistant commands
Agent Hooks , Spec-Driven Development
Progressive Disclosure
Intermediate
Development
Development
Load only the task-specific rules needed for the current work
Codified Rules , Agent Memory
Atomic Decomposition
Intermediate
Development
Development
Split complex work into independently implementable agent tasks
Incremental Generation
Guided Refactoring
Intermediate
Development
Development
Improve code against measurable quality rules while preserving behavior
Codified Rules
Agent Observability
Intermediate
Development
Development
Capture traces, tool events, evaluations, and runtime context for diagnosis and improvement
Developer Lifecycle
Image Spec
Interme
...
Development
Development
Translate screenshots and design mockups into UI code with visual feedback
Spec-Driven Development , Incremental Generation
Adversarial Evaluator
Intermediate
Development
Development
Separate generation from independent adversarial evaluation
Incremental Generation
Parallel Agents
Advanced
Development
Development
Run agents concurrently on isolated tasks or environments
Atomic Decomposition
Error Resolution
Intermediate
Development
Development
Diagnose failures and apply proposed fixes only after human review and deterministic validation
Developer Lifecycle , Agent Observability
Model Routing
Advanced
Development
Development
Match task requirements to model capability, context, latency, and cost
Tool Integration
Code Research
Intermediate
Development
Workflow
Answer technical questions with isolated executable experiments
Agent Memory , Tool Integration
Bounded Autonomy
Advanced
Development
Workflow
Bound agent loops by turns, spend, time, stalls, and verification reach
Parallel Agents , Agent Observability
Security & Compliance
Operations
Policy, evidence, and organization-wide controls
Policy Generation
Advanced
Operations
Operations
Generate validated Cedar, Rego, OPA, or Gatekeeper policy-as-code
Security Sandbox
Evidence Automation
Advanced
Operations
Operations
Continuously collect dated, audit-ready control evidence
Policy Generation , Agent Observability
Centralized Rules
Advanced
Operations
Operations
Synchronize organization-wide AI instructions from a central source
Codified Rules , Progressive Disclosure
Deployment Automation
Operations
Infrastructure correction and controlled change
Drift Remediation
Advanced
Operations
Operations
Detect declared-state drift and generate reviewable corrective patches
Agent Observability , Bounded Autonomy
Monitoring & Maintenance
Operations
Reliability experiments and maintainability forecasting
Debt Forecasting
Intermediate
Operations
Operations
Forecast maintenance burden from code and repository trends
Guided Refactoring , Tool Integration
Guided Chaos
Advanced
Operations
Operations
Generate hypothesis-driven chaos experiments with explicit safety controls
Agent Observability , Bounded Autonomy
...
Issue Generation (<1 hour with AI assistance): Small, deployable work items for continuous flow and rapid feedback
Atomic Decomposition (1-2 hours): Ultra-small tasks for parallel agent execution without conflicts
Incremental Generation (Daily cycles): Deployment-focused iterations that may contain multiple work items
...
Use Incremental Generation when prioritizing rapid market feedback over task granularity
Pattern Differentiation :
Issue Generation : Creates small, deployable work items (<1 hour with AI assistance) for human team workflows
Atomic Decomposition : Creates ultra-small tasks (1-2 hours) for parallel AI agents
Incremental Generation : Creates deployment cycles (daily) focused on user feedback
...
Agent Readiness - Evaluate current state
...
Incremental Generation - Start with simple iterations
...
Evidence Automation - Continuous, audit-ready control evidence
Centralized Rules - Organization-wide AI standards
Debt Forecasting - Proactive maintenance
Project Type Recommendations
MVP/Startup Projects :
Primary : Incremental Generation , Planned Implementation
...
Secondary : Spec-Driven Development , Evidence Automation
Essential : All foundation patterns before development patterns
Research/Experimental Projects :
Primary : Code Research , Adversarial Evaluator
Secondary : Agent Memory , Model Routing
Focus : Learning and exploration over production readiness
High-Scale Production :
Primary : Parallel Agents , Agent Observability
Secondary : Guided Chaos , Incident Automation
Critical : All security and monitoring patterns
Team Size Considerations
Solo Teams :
Focus on Incremental Generation and Adversarial Evaluator
Add Agent Observability for debugging
...
Use Pipeline Synthesis for safe delivery workflows
On-Premise Systems :
Focus on Security Sandbox with network isolation
Implement Agent Memory for institutional knowledge
Use Debt Forecasting for maintenance planning
Microservices Architecture :
Parallel Agents for service coordination
Agent Observability across service boundaries
Agent Hooks for deterministic cross-service policy checks
Monolithic Applications :
Incremental Generation for gradual modernization
...
Source : Factory.ai, " Agent Readiness "; Kodus, " agent-readiness "; Guillaume Moigneu, " Making coding agents reliable ", February 17, 2026
...
Related Patterns : Agent Readiness , Agent Memory , Progressive Disclosure , Agent Hooks , Custom Commands , Centralized Rules
See also : Harness Engineering Lens
Source : " AGENTS.md " open format specification (OpenAI, Google Jules, Cursor, Factory); Cursor, " Rules " documentation
...
└── rules.md
Complete Example: See examples/codified-rules/ for:
...
Related Patterns : Policy Generation , Codified Rules , Agent Hooks
Source : Anthropic, " sandbox-runtime "; Anthropic, " Sandboxing " (Claude Code documentation)
...
Complete Example: See examples/security-sandbox/ for:
...
Google Jules : Google's coding agent with secure development environments
...
Related Patterns : Codified Rules , Security Sandbox , Planned Implementation , Spec-Driven Development , Atomic Decomposition , Agent Observability
See also : Lifecycle Lens
Source : GitHub, " Spec Kit "; AWS DevOps & Developer Productivity Blog, " AI-Driven Development Life Cycle: Reimagining Software Engineering ", July 31, 2025
This pattern is the per-feature discipline: plan before you generate, and stop retrying a failing approach after a few tries instead of looping on it. For how each stage maps onto the rest of the catalog, see the Lifecycle Lens .
...
Loading
Complete Example: See examples/developer-lifecycle/ for full 9-stage workflow scripts, detailed prompts for each stage, enhanced implementation techniques ( Five-Try Rule , markdown iteration, function decomposition), and integration with CI/CD pipelines.
...
Related Patterns : Security Sandbox , Developer Lifecycle , Agent Observability
Source : Anthropic, " Introducing the Model Context Protocol ", November 25, 2024; Model Context Protocol, " modelcontextprotocol/servers " reference servers
...
Complete Example: See examples/tool-integration/ for:
...
Related Patterns : Agent Readiness , Spec-Driven Development
Source : GitHub Docs, " Using GitHub Copilot to create issues "; Eyal Toledano, " Task Master "
...
Complete Example: See examples/issue-generation/ for detailed AI prompts, epic breakdown workflows, CI integration patterns, and traceability implementations. For AI-first workflows, see Beads guide - a git-native issue tracker with CLI access and persistent agent memory.
...
Related Patterns : Developer Lifecycle , Tool Integration , Custom Commands , Image Spec , Testing Orchestration , Agent Observability
See also : Harness Engineering Lens
Source : GitHub, " Spec Kit "; Birgitta Böckeler, " Understanding Spec-Driven-Development: Kiro, spec-kit, and Tessl ", October 15, 2025
...
Complete Example: See examples/spec-driven-development/ for:
...
Related Patterns : Spec-Driven Development , Incremental Generation , Model Routing
...
Complete Example: See examples/image-spec/ for prompt templates and a repeatable screenshot-to-code iteration loop.
...
Related Patterns : Developer Lifecycle , Spec-Driven Development , Incremental Generation , Adversarial Evaluator
See also : Harness Engineering Lens
Source : Cursor, " Plan Mode " documentation; Anthropic, " Claude Code best practices "
...
Complete Example: See examples/planned-implementation/ for:
...
Source : GitHub Docs, " Prompt engineering for GitHub Copilot Chat "; Harper Reed, " My LLM codegen workflow atm ", February 16, 2025
...
Related Patterns : Planned Implementation , Incremental Generation , Spec-Driven Development , Autonomous Acceptance
See also : Harness Engineering Lens
Core Principle: Separate the Producer from the Judge
Borrowed from GANs (Generative Adversarial Networks): two networks compete — one generates, one judges — and that adversarial tension forces quality up. The same dynamic applies to multi-agent syste
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   # Repository: PaulDuvall/ai-development-patterns A comprehensive collection of AI development patterns for building software with AI assistance, organized by implementation maturity and development lifecycle phases. Includes Foundation, Development, and Operations patterns with practical examples a.... / query=AI implementation startup funding enterprise workflow / intent=find_startups / path=developer_ecosystem
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   PaulDuvall ai-development-patterns Public Notifications You must be signed in to change notification settings Fork 49 Star 608 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 401 Commits 401 Commits .

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   agents/ skills/ evaluate-pattern-adoption .

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   github assets assets docs docs examples examples experiments experiments scripts scripts tests tests verification verification .

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   python-version AGENTS.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Google, GitHub
- products: agents, codex, AGENTS, CLAUDE, agent, Claude, Codex, Agent, Agents
- people: 暂无公开信息
...
- numbers: 49, 608
m, 401, 8, 5b, 2, 5, 3
- quotes: https://github.com/PaulDuvall/ai-development-patterns#agent-readiness / https://github.com/PaulDuvall/ai-development-patterns#codified-rules / https://github.com/PaulDuvall/ai-development-patterns#security-sandbox / https://github.com/PaulDuvall/ai-development-patterns#developer-lifecycle / https://github.com/PaulDuvall/ai-development-patterns#tool-integration

## evidence_seed

- company_actions: # Repository: PaulDuvall/ai-development-patterns A comprehensive collection of AI development patterns for building software with AI assistance, organized by implementation maturity and development lifecycle phases. Includes Foundation, Development, and Operations patterns with practical examples a.... / query=AI implementation startup funding enterprise workflow / intent=find_startups / path=developer_ecosystem / PaulDuvall ai-development-patterns Public Notifications You must be signed in to change notification settings Fork 49 Star 608 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 401 Commits 401 Commits . / agents/ skills/ evaluate-pattern-adoption .
- case_details: 暂无公开信息
