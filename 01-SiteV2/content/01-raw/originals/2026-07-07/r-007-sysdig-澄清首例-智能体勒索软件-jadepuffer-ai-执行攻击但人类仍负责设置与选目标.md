...
title_zh: "Sysdig 澄清首例\"智能体勒索软件\"JadePuffer：AI 执行攻击但人类仍负责设置与选目标"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://techcrunch.com/2026/07/06/the-first-ai-run-ransomware-attack-still-needed-a-human"
canonical_url: "https://techcrunch.com/2026/07/06/the-first-ai-run-ransomware-attack-still-needed-a-human"
...
search_path_label: ""
author: ""
published_at: "2026-07-06T23:56:14.000Z"
collected_at: 2026-07-07T02:46:59.227Z
language: mixed
full_text_hash: eff71e9cce91f49c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-07/r-007-sysdig-澄清首例-智能体勒索软件-jadepuffer-ai-执行攻击但人类仍负责设置与选目标.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-07/r-007-sysdig-澄清首例-智能体勒索软件-jadepuffer-ai-执行攻击但人类仍负责设置与选目标.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":5827,"paragraph_count":29,"sentence_count":33,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 5827
fetch_error: ""
...
discovery_record: {"discovery_title":"Sysdig 澄清首例\"智能体勒索软件\"JadePuffer：AI 执行攻击但人类仍负责设置与选目标","discovery_summary":"云安全公司 Sysdig 记录了首例\"智能体勒索软件\"攻击 JadePuffer，AI 智能体独立完成入侵、窃取凭证、横向移动、加密超 1，300 条配置记录并撰写赎金信，还能在 31 秒内修复失败登录并以自然语言注释解释推理过程。但 Sysdig 高级威胁研究总监 Michael Clark 澄清，人类仍负责设置攻击基础设施、选择受害目标、提供通过此前入侵获取的数据库凭证。Sysdig 未能识别驱动该智能体的具体模型；AI 智能体在攻击中窃取了 OpenAI、Anthropic、DeepSeek 和 Gemini 的 API 密钥，Clark 表示这些密钥属于\"战利品\"而非驱动模型。微软研究员 Geoff McDonald 推测模型为移除安全训练的开源权重模型。","source_name":"TechCrunch：AI（RSS）","origin_url":"https://techcrunch.com/2026/07/06/the-first-ai-run-ransomware-attack-still-needed-a-human","discovered_at":"2026-07-07T02:33:49.133Z","rank_on_page":51,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: d2a43a06dd380fa7
content_hash: eff71e9cce91f49c
semantic_hash: d663e0693d450015
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-07-06T23:56:14.000Z"
last_seen_at: 2026-07-07T02:46:59.227Z
...
business_elements: {"companies":["TechCrunch","AI（RSS）","OpenAI","Anthropic","Microsoft","Amazon"],"products":["Gemini","ChatGPT","agent","agents"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["权限 / 安全治理"],"business_actions":["融资 / 投资"],"affected_departments":["IT / 安全","法务"],"numbers":["1","300","31","4","56","6","2026","90"],"quotes":["JadePuffer：AI 执行攻击但人类仍负责设置与选目标\n云安全公司 Sysdig 记录了首例","agentic ransomware.","without any human oversight,","no human at the keyboard.","multiple models were used in the attack,"]}
...
fact_extraction_completed_at: 2026-07-07T02:46:59.227Z
...
2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Image Credits: ChatGPT for TechCrunch / Security The ‘first’ AI-run ransomware attack still needed a human Connie Loizos 4:56 PM PDT · July 6, 2026 Last week, researchers at cloud security firm Sysdig said they’d documented the first known case of “agentic ransomware.
...
- companies: TechCrunch, AI（RSS）, OpenAI, Anthropic, Microsoft, Amazon
- products: Gemini, ChatGPT, agent, agents
- people: 暂无公开信息
...
- numbers: 1, 300, 31, 4, 56, 6, 2026, 90
- quotes: JadePuffer：AI 执行攻击但人类仍负责设置与选目标
云安全公司 Sysdig 记录了首例 / agentic ransomware. / without any human oversight, / no human at the keyboard. / multiple models were used in the attack,

## evidence_seed

- company_actions: ” It was an extortion operation, dubbed JadePuffer, in which an AI agent — not a human — handled the technical execution of a real-world cyberattack from start to finish. / The agent broke into a vulnerable server, stole credentials, moved through the target’s network, encrypted files, and even wrote its own ransom note, adapting to obstacles along the way like a human hacker would. / Coverage of the funding described it as run “without any human oversight,” with “no human at the keyboard.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人
- risks_or_constraints: Image Credits: ChatGPT for TechCrunch / Security The ‘first’ AI-run ransomware attack still needed a human Connie Loizos 4:56 PM PDT · July 6, 2026 Last week, researchers at cloud security firm Sysdig said they’d documented the first known case of “agentic ransomware.
