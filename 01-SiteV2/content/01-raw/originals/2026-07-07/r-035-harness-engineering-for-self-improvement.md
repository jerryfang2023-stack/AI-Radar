...
canonical_url: "https://lilianweng.github.io/posts/2026-07-04-harness"
...
author: ""
published_at: ""
collected_at: 2026-07-07T02:46:59.662Z
language: mixed
full_text_hash: 24668c04dcf67bc4
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-07/r-035-harness-engineering-for-self-improvement.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-07/r-035-harness-engineering-for-self-improvement.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":41657,"paragraph_count":252,"sentence_count":394,"boilerplate_hits":1,"symbol_ratio":0.0067,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 41657
fetch_error: ""
...
url_hash: 2c589c3624db6218
content_hash: 87170a0f4ca13407
semantic_hash: 562fc24f9e7c1226
duplicate_of: ""
first_seen_at: "2026-07-07T02:46:59.662Z"
last_seen_at: 2026-07-07T02:46:59.662Z
...
business_elements: {"companies":["Lilian Weng's Blog (OpenAI)","OpenAI","Anthropic","GitHub","Meta","Cursor"],"products":["agent","Agent","Claude","Codex","agents","codex","Cursor","MCP"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全"],"numbers":["34","1965","7","2008","1","2","3","2024"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-07T02:46:59.662Z
theme: uncategorized
...
The workflow graph also emphasizes the model analyzing its own trajectories and failure cases and then iterating on its progress through an &ldquo;agent runtime&rdquo; rather than a static prompt template.
Pattern 2: File System as Persistent Memory #
...
$$
Meta-Harness ( Lee et al. 2026 ) moves another level deeper: the optimized object is the code that determines and optimizes what information should be stored, retrieved, and presented to the model. &ldquo;Meta-&rdquo; in its name means it is a harness for optimizing harnesses.
...
The Autodata agent ( Kulikov et al. 2026 ) is designed to work as a data scientist for generating training and evaluation data. The main agent manages a challenger that proposes problems, a weak solver , a strong solver , and a verifier/judge , aiming to synthesize data at the &ldquo;just right&rdquo; level of difficulty, meaning that the strong solver succeeds but the weak solver fails.
...
The design space for workflow is enormous , and naturally we can think of workflow design as a search problem, and therefore we should be able to find good solutions by algorithms rather than only manually craft them. Following this direction, Automated Design of Agentic Systems (ADAS; Hu et al. 2025 ) formulates agent design itself as an optimization problem, &ldquo;meta-agent search&rdquo; where a meta-agent proposes new designs of agentic workflows.
...
Evolutionary Search #
Evolutionary search is an optimization method inspired by natural selection (see my old post on evolutionary algorithm ). It evolves a population of solutions by mutating them and only keeping those with high &ldquo;fitness&rdquo; in the crowd. Evolutionary search comes in handy when (1) the search space is extensive or weirdly shaped; and (2) it is hard to optimize directly with gradients but easy to evaluate solutions. Harness search seems to be a good fit here.
...
Over-optimism : the model declares success despite noisy or failed experiments, similarly observed as &ldquo;p-hacking and eureka-ing&rdquo; pattern by Bubeck et al. (2025) where models can introduce &ldquo;numerical duct tape&rdquo; and declare victory when signals are still noise.
...
Many challenges listed above need human&rsquo;s feedback and steering. After all, we are building the technology for better future of humanity, not other way around.
Citation #
Please cite this work as:
Weng, Lilian. &ldquo;Harness Engineering for Self-Improvement&rdquo;. Lil&rsquo;Log (Jul 2026). https://lilianweng.github.io/posts/2026-07-04-harness/
...
References #
[1] Good, I. J. &ldquo;Speculations Concerning the First Ultraintelligent Machine.&rdquo; Advances in Computers , 6:31&ndash;88, 1965.
[2] Yudkowsky, Eliezer. &ldquo;Recursive Self-Improvement.&rdquo; LessWrong, 2008.
[3] Choi, et al. &ldquo;Anchored Self-Play for Code Repair.&rdquo; ICML 2026.
[4] Zhao, et al. &ldquo;Absolute Zero: Reinforced Self-play Reasoning with Zero Data.&rdquo; arXiv preprint arXiv:2505.03335, 2025.
[5] Yuan, et al. &ldquo;Self-Rewarding Language Models.&rdquo; arXiv preprint arXiv:2401.10020, 2024.
[6] Chen, et al. &ldquo;Self-Play Fine-Tuning Converts Weak Language Models to Strong Language Models.&rdquo; ICML 2024.
[7] Zhang, et al. &ldquo;Agentic Context Engineering: Evolving Contexts for Self-Improving Language Models.&rdquo; ICLR 2026.
[8] Ye, et al. &ldquo;Meta Context Engineering via Agentic Skill Evolution.&rdquo; arXiv preprint arXiv:2601.21557, 2026.
[9] Lee, et al. &ldquo;Meta-Harness: End-to-End Optimization of Model Harnesses.&rdquo; arXiv preprint arXiv:2603.28052, 2026.
[10] Lu, et al. &ldquo;Towards end-to-end automation of AI research.&rdquo; Nature , 651:914&ndash;919, 2026.
[11] Meng, et al. &ldquo;ScientistOne: Towards Human-Level Autonomous Research via Chain-of-Evidence.&rdquo; arXiv preprint arXiv:2605.26340, 2026.
[12] Kulikov, et al. &ldquo;Autodata: An agentic data scientist to create high quality synthetic data.&rdquo; arXiv preprint arXiv:2606.25996, 2026.
[13] Hu, Lu, and Clune. &ldquo;Automated Design of Agentic Systems.&rdquo; ICLR 2025.
[14] Madaan, et al. &ldquo;Self-Refine: Iterative Refinement with Self-Feedback.&rdquo; NeurIPS 2023.
[15] Zhang, et al. &ldquo;AFlow: Automating Agentic Workflow Generation.&rdquo; ICLR 2025.
[16] Zelikman, et al. &ldquo;Self-Taught Optimizer (STOP): Recursively Self-Improving Code Generation.&rdquo; COLM 2024.
[17] Zhang, et al. &ldquo;Self-Harness: Harnesses That Improve Themselves.&rdquo; arXiv preprint arXiv:2606.09498, 2026.
[18] Fernando, et al. &ldquo;Promptbreeder: Self-Referential Self-Improvement Via Prompt Evolution.&rdquo; arXiv preprint arXiv:2309.16797, 2023.
[19] Agrawal, A. et al. &ldquo;GEPA: Reflective Prompt Evolution Can Outperform Reinforcement Learning.&rdquo; arXiv preprint arXiv:2507.19457, 2025.
[20] Novikov, et al. &ldquo;AlphaEvolve: A coding agent for scientific and algorithmic discovery.&rdquo; arXiv preprint arXiv:2506.13131, 2025.
[21] Lange, Imajuku, and Cetin. &ldquo;ShinkaEvolve: Towards Open-Ended And Sample-Efficient Program Evolution.&rdquo; arXiv preprint arXiv:2509.19349, 2025.
[22] Wang, et al. &ldquo;ThetaEvolve: Test-time Learning on Open Problems.&rdquo; arXiv preprint arXiv:2511.23473, 2025.
[23] Zhang, et al. &ldquo;Darwin Gödel Machine: Open-Ended Evolution of Self-Improving Agents.&rdquo; arXiv preprint arXiv:2505.22954, 2025.
[24] Zhang, et al. &ldquo;Hyperagents.&rdquo; arXiv preprint arXiv:2603.19461, 2026.
[25] Yuksekgonul, et al. &ldquo;Learning to Discover at Test Time.&rdquo; arXiv preprint arXiv:2601.16175, 2026.
[26] Riaz, et al. &ldquo;Epistemic Uncertainty for Test-Time Discovery.&rdquo; arXiv preprint arXiv:2605.11328, 2026.
[27] Hebbar, et al. &ldquo;SIA: Self Improving AI with Harness & Weight Updates.&rdquo; arXiv preprint arXiv:2605.27276, 2026.
[28] Trehan and Chopra. &ldquo;Why LLMs Aren&rsquo;t Scientists Yet: Lessons from Four Autonomous Research Attempts.&rdquo; arXiv preprint arXiv:2601.03315, 2026.
[29] Bubeck, et al. &ldquo;Early science acceleration experiments with GPT-5.&rdquo; arXiv preprint arXiv:2511.16072, 2025.
[30] Starace, et al. &ldquo;PaperBench: Evaluating AI&rsquo;s Ability to Replicate AI Research.&rdquo; ICML 2025.
[31] Wijk, et al. &ldquo;RE-Bench: Evaluating frontier AI R&D capabilities of language model agents against human experts.&rdquo; ICML 2025.
[32] Chan, et al. &ldquo;MLE-bench: Evaluating Machine Learning Agents on Machine Learning Engineering.&rdquo; arXiv preprint arXiv:2410.07095, 2024.
[33] Chen, et al. &ldquo;ScienceAgentBench: Toward Rigorous Assessment of Language Agents for Data-Driven Scientific Discovery.&rdquo; ICLR 2025.
[34] Siegel, et al. &ldquo;CORE-Bench: Fostering the Credibility of Published Research Through a Computational Reproducibility Agent Benchmark.&rdquo; TMLR 2024.
[35] Ouyang, et al. &ldquo;KernelBench: Can LLMs Write Efficient GPU Kernels?&rdquo; arXiv preprint arXiv:2502.10517, 2025.
...
1. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   &lt;p&gt;The concept of &lt;strong&gt;recursive self-improvement (RSI)&lt;/strong&gt; dates back to &lt;a href=&#34;https://philpapers.org/rec/GOOSCT&#34;&gt;I. J. Good (1965)&lt;/a&gt;, where he defined an &amp;ldquo;ultraintelligent machine&amp;rdquo; as a system that can surpass humans in all intellectual activities and design better machines to improve itself. &lt;a href=&#34;https://www.lesswrong.com/posts/JBadX7rwdcRFzGuju/recursive-self-improvement&#34;&gt;Yudkowsky (2008)&lt;/a&gt; used

2. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Table of Contents Harness Design Patterns Pattern 1: Workflow Automation Pattern 2: File System as Persistent Memory Pattern 3: Sub-agent and Backend Jobs Case study: Coding Agent Harness Harness Layer vs Core Intelligence?
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Harness Optimization Context Engineering Workflow Design Self-Improving Harness Evolutionary Search Joint Optimization with Model Weights Future Challenges Citation Appendix: Some useful benchmarks References The concept of recursive self-improvement (RSI) dates back to I.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Good (1965) , where he defined an &ldquo;ultraintelligent machine&rdquo; as a system that can surpass humans in all intellectual activities and design better machines to improve itself.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Yudkowsky (2008) used the phrase &ldquo;recursive self-improvement&rdquo; for a specific feedback loop: an AI uses its current intelligence to improve the cognitive machinery that produces its intelligence.

6. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   This feedback loop in modern AI may indicate the model rewriting its own weights directly, or more broadly the model improves the training pipeline and the deployment system , which in turn enables a better successor model with improved performance across economically valuable tasks.

## business_elements

- companies: Lilian Weng's Blog (OpenAI), OpenAI, Anthropic, GitHub, Meta, Cursor
- products: agent, Agent, Claude, Codex, agents, codex, Cursor, MCP
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 34, 1965, 7, 2008, 1, 2, 3, 2024
- quotes: 暂无公开信息

## evidence_seed

- company_actions: &lt;p&gt;The concept of &lt;strong&gt;recursive self-improvement (RSI)&lt;/strong&gt; dates back to &lt;a href=&#34;https://philpapers.org/rec/GOOSCT&#34;&gt;I. J. Good (1965)&lt;/a&gt;, where he defined an &amp;ldquo;ultraintelligent machine&amp;rdquo; as a system that can surpass humans in all intellectual activities and design better machines to improve itself. &lt;a href=&#34;https://www.lesswrong.com/posts/JBadX7rwdcRFzGuju/recursive-self-improvement&#34;&gt;Yudkowsky (2008)&lt;/a&gt; used / Good (1965) , where he defined an &ldquo;ultraintelligent machine&rdquo; as a system that can surpass humans in all intellectual activities and design better machines to improve itself. / Yudkowsky (2008) used the phrase &ldquo;recursive self-improvement&rdquo; for a specific feedback loop: an AI uses its current intelligence to improve the cognitive machinery that produces its intelligence.
...
- workflow_changes: Harness Optimization Context Engineering Workflow Design Self-Improving Harness Evolutionary Search Joint Optimization with Model Weights Future Challenges Citation Appendix: Some useful benchmarks References The concept of recursive self-improvement (RSI) dates back to I.
