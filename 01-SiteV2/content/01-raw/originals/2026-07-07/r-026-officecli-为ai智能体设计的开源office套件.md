...
title_zh: "OfficeCLI：为AI智能体设计的开源Office套件"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://github.com/iOfficeAI/OfficeCLI"
canonical_url: "https://github.com/iOfficeAI/OfficeCLI"
...
search_path_label: ""
author: ""
published_at: "2026-07-06T23:03:34.910Z"
collected_at: 2026-07-07T02:46:59.505Z
language: mixed
full_text_hash: cf55d0b055ab1f83
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-07/r-026-officecli-为ai智能体设计的开源office套件.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-07/r-026-officecli-为ai智能体设计的开源office套件.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":79,"text_length":29401,"paragraph_count":321,"sentence_count":139,"boilerplate_hits":6,"symbol_ratio":0.0099,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 29401
fetch_error: ""
...
discovery_record: {"discovery_title":"OfficeCLI：为AI智能体设计的开源Office套件","discovery_summary":"OfficeCLI是全球首个专为AI智能体设计的开源Office套件，以单二进制文件运行，无需安装Office或任何依赖。它内置HTML渲染引擎，可将.docx/.xlsx/.pptx转换为HTML或PNG，形成\"渲染→查看→修复\"的视觉闭环，使AI代理能自主创建、读取和修改Word、Excel、PowerPoint文档。支持公式、图表、条件格式、RTL布局、修订追踪、表格、数据透视表等复杂功能。提供CLI命令和基于自然语言的桌面应用AionUi，并可一键安装到Claude Code、Cursor、Windsurf、GitHub Copilot等AI编码工具中。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://github.com/iOfficeAI/OfficeCLI","discovered_at":"2026-07-07T02:33:49.142Z","rank_on_page":62,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 3ac15a787d97b127
content_hash: fed4f9db66dd2639
semantic_hash: 7ec011e3cd340ec6
duplicate_of: ""
first_seen_at: "2026-07-06T23:03:34.910Z"
last_seen_at: 2026-07-07T02:46:59.505Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Microsoft","GitHub","Apple","Cursor"],"products":["Claude","Cursor","Copilot","agents","agent","Agents","Agent","MCP","mcp","claude"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["637","8.8","5","571","1","30","2","3"],"quotes":["渲染→查看→修复"," Hello, World! "," Q4 Report "," Revenue grew 25% "," /slide[1]/shape[1] "]}
...
fact_extraction_completed_at: 2026-07-07T02:46:59.505Z
...
2cm , 1in , 72pt , 96px , 914400
Colors
Hex, named, RGB, theme
#FF0000 , FF0000 , red , rgb(255,0,0) , accent1
Font sizes
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":79,"text_length":29401,"paragraph_count":321,"sentence_count":139,"boilerplate_hits":6,"symbol_ratio":0.0099,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   iOfficeAI OfficeCLI Public Notifications You must be signed in to change notification settings Fork 637 Star 8.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   8k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 5,571 Commits 5,571 Commits .
...
- companies: Hacker News 热门（buzzing.cc 中文翻译）, Microsoft, GitHub, Apple, Cursor
- products: Claude, Cursor, Copilot, agents, agent, Agents, Agent, MCP, mcp, claude
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 637, 8.8, 5, 571, 1, 30, 2, 3
- quotes: 渲染→查看→修复 /  Hello, World!  /  Q4 Report  /  Revenue grew 25%  /  /slide[1]/shape[1] 

## evidence_seed

- company_actions: There was an error while loading. / Please reload this page . / iOfficeAI OfficeCLI Public Notifications You must be signed in to change notification settings Fork 637 Star 8.
- case_details: 暂无公开信息
