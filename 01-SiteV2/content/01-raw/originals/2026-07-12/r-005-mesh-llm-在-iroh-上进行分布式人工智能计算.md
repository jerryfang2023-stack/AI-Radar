...
canonical_url: "https://iroh.computer/blog/mesh-llm"
...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-12/r-005-mesh-llm-在-iroh-上进行分布式人工智能计算.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":5762,"paragraph_count":41,"sentence_count":55,"boilerplate_hits":1,"symbol_ratio":0.0012,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 5762
fetch_error: ""
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","OpenAI"],"products":["agents","MCP","agent"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["40","5 亿","235B","18 M","9337","1","0","15"],"quotes":["pay more.","which models do you host?","route to a peer","stream activations to the next pipeline stage","talk to localhost,"]}
...
- numbers: 40, 5 亿, 235B, 18 M, 9337, 1, 0, 15
- quotes: pay more. / which models do you host? / route to a peer / stream activations to the next pipeline stage / talk to localhost,

## evidence_seed

- company_actions: When people picture running a large language model, they picture a data center. / Racks of GPUs that belong to someone else, a metered API, and a bill that grows every month you succeed. / For a lot of teams that is a bad trade.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。
- affected_roles: 暂无公开信息
- risks_or_constraints: You send your prompts off to a black box and hope the price, the model, and the privacy policy all stay the way they were when you signed up.
