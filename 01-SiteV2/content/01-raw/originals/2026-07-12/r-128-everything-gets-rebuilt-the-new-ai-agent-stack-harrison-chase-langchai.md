...
original_url: "https://podcasters.spotify.com/pod/show/firstmark/episodes/Everything-Gets-Rebuilt-The-New-AI-Agent-Stack--Harrison-Chase--LangChain-e3gapv9"
canonical_url: "https://podcasters.spotify.com/pod/show/firstmark/episodes/Everything-Gets-Rebuilt-The-New-AI-Agent-Stack--Harrison-Chase--LangChain-e3gapv9"
...
author: ""
published_at: ""
collected_at: 2026-07-12T09:56:07.620Z
language: mixed
full_text_hash: c9603923a1b2b0fc
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-12/r-128-everything-gets-rebuilt-the-new-ai-agent-stack-harrison-chase-langchai.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-12/r-128-everything-gets-rebuilt-the-new-ai-agent-stack-harrison-chase-langchai.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 8f6795e25944a3d2
content_hash: c9603923a1b2b0fc
semantic_hash: 587c106c5cfde24c
duplicate_of: ""
first_seen_at: "2026-07-12T09:56:07.620Z"
last_seen_at: 2026-07-12T09:56:07.620Z
...
guanlan_scores: {"importance_type":"supporting_signal","importance_score":2,"importance_reason":"supporting commercial context only","supporting_signals":["enterprise_ai_transformation_lens","commercial_or_risk_context"],"novelty":3,"evidence_strength":3,"case_richness":2,"trend_relevance":2,"guanlan_relevance":2,"emerging_signal_score":2}
business_elements: {"companies":["The MAD Podcast (Matt Turck)"],"products":["Agent","agents"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["权限 / 安全治理"],"business_actions":[],"affected_departments":["IT / 安全"],"numbers":[],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-12T09:56:07.620Z
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=medium
   As agents evolve from simple prompt-based systems into software that can plan, use tools, write code, manage files, and remember things over time, the real frontier is shifting from the model itself to the stack around the model.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=medium
   In this conversation, we go deep on harnesses, subagents, filesystems, sandboxes, observability, memory, and the new infrastructure required to mak

## business_elements

- companies: The MAD Podcast (Matt Turck)
...
- company_actions: Harrison Chase, co-founder and CEO of LangChain, joins the MAD Podcast to explain why everything in AI is getting rebuilt. As agents evolve from simple prompt-based systems into software that can plan, use tools, write code, manage files, and remember things over time, the real frontier is shifting from the model itself to the stack around the model. In this conversation, we go deep on harnesses, subagents, filesystems, sandboxes, observability, memory, and the new infrastructure required to mak / Harrison Chase, co-founder and CEO of LangChain, joins the MAD Podcast to explain why everything in AI is getting rebuilt. / As agents evolve from simple prompt-based systems into software that can plan, use tools, write code, manage files, and remember things over time, the real frontier is shifting from the model itself to the stack around the model.
- case_details: 暂无公开信息
