...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-12/r-003-openai-gpt-5-6-sol-ultra-一小时证明-50-年图论猜想.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":62,"text_length":2864,"paragraph_count":34,"sentence_count":20,"boilerplate_hits":3,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
has_full_text: true
content_length: 2864
fetch_error: ""
...
business_elements: {"companies":["IT之家（RSS）","OpenAI"],"products":["GPT-5","Agents"],"people":[],"industries":[],"roles":[],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","定价 / 计费变化"],"affected_departments":["IT / 安全"],"numbers":["5.6","50","1970","64","8","1","5","10"],"quotes":["昨天，我们正式向所有用户开放 GPT-5.6 Sol Ultra。今天，我们分享一个消息：它利用 64 个子智能体（subagents），在不到一小时内证明了已有 50 年历史的循环双覆盖猜想。","这是一个非常漂亮的证明。","人类数学家通常会尝试一种自然的方法，如果失败了，很可能就会放弃；而 AI 不会因此气馁，会继续不断尝试各种细微变化。"]}
...
仅用一小时，OpenAI GPT-5.6 Sol Ultra 证明了一个已有 50 年历史的数学猜想 - IT之家
首页
IT圈
最会买
设置
...
下载IT之家APP，签到赚金币兑豪礼
相关文章
关键词： GPT5.6 Sol Ultra ， OpenAI ， AI
...
- fetch_status: fetched-readable-text-body-visible-text
- extraction_quality: high
- diagnostics: {"readability_score":62,"text_length":2864,"paragraph_count":34,"sentence_count":20,"boilerplate_hits":3,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
...
3. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   6 Sol Ultra 证明了一个已有 50 年历史的数学猜想 - IT之家 首页 IT圈 最会买 设置 日夜间 随系统 浅色 深色 主题色 黑色 投稿 订阅 RSS订阅 收藏IT之家 软媒应用 App客户端 要知App 软媒魔方 业界 手机 电脑 测评 视频 AI 苹果 iPhone 鸿蒙 软件 智车 数码 学院 游戏 直播 5G 微软 Win10 Win11 专题 搜索 首页 > 智能时代 > 人工智能 仅用一小时，OpenAI GPT-5.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   6 Sol Ultra 证明了一个已有 50 年历史的数学猜想 2026/7/12 8:44:43 来源： IT之家 作者： 远洋 责编： 远洋 评论： 感谢IT之家网友 Nuc_F 的线索投递！
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   IT之家 7 月 12 日消息，OpenAI 于 7 月 10 日宣布，旗下 GPT-5.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   6 Sol Ultra 模型在不到 1 小时内，成功生成了“循环双覆盖猜想”（Cycle Double Cover Conjecture）的完整证明。
...
- numbers: 5.6, 50, 1970, 64, 8, 1, 5, 10
- quotes: 昨天，我们正式向所有用户开放 GPT-5.6 Sol Ultra。今天，我们分享一个消息：它利用 64 个子智能体（subagents），在不到一小时内证明了已有 50 年历史的循环双覆盖猜想。 / 这是一个非常漂亮的证明。 / 人类数学家通常会尝试一种自然的方法，如果失败了，很可能就会放弃；而 AI 不会因此气馁，会继续不断尝试各种细微变化。

## evidence_seed

- company_actions: 仅用一小时，OpenAI GPT-5. / 6 Sol Ultra 证明了一个已有 50 年历史的数学猜想 2026/7/12 8:44:43 来源： IT之家 作者： 远洋 责编： 远洋 评论： 感谢IT之家网友 Nuc_F 的线索投递！ / IT之家 7 月 12 日消息，OpenAI 于 7 月 10 日宣布，旗下 GPT-5.
- case_details: 6 Sol Ultra 证明了一个已有 50 年历史的数学猜想 - IT之家 首页 IT圈 最会买 设置 日夜间 随系统 浅色 深色 主题色 黑色 投稿 订阅 RSS订阅 收藏IT之家 软媒应用 App客户端 要知App 软媒魔方 业界 手机 电脑 测评 视频 AI 苹果 iPhone 鸿蒙 软件 智车 数码 学院 游戏 直播 5G 微软 Win10 Win11 专题 搜索 首页 > 智能时代 > 人工智能 仅用一小时，OpenAI GPT-5.
