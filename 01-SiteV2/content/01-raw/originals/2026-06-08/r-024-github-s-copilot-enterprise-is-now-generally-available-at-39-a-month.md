...
raw_id: R-024
title: "GitHub's Copilot Enterprise is now generally available at $39 a month"
original_url: "https://techcrunch.com/2024/02/27/githubs-copilot-enterprise-hits-general-availability/"
canonical_url: "https://techcrunch.com/2024/02/27/githubs-copilot-enterprise-hits-general-availability"
...
author: ""
published_at: ""
collected_at: 2026-06-08T00:36:48.972Z
language: mixed
full_text_hash: ae7e18c3e440a8f1
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-08/r-024-github-s-copilot-enterprise-is-now-generally-available-at-39-a-month.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-08/r-024-github-s-copilot-enterprise-is-now-generally-available-at-39-a-month.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":6776,"paragraph_count":29,"sentence_count":33,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 6776
fetch_error: ""
...
url_hash: 6621eb8f741577a3
content_hash: ae7e18c3e440a8f1
semantic_hash: c7ee644aba1266cc
duplicate_of: ""
first_seen_at: "2026-06-08T00:36:48.972Z"
last_seen_at: 2026-06-08T00:36:48.972Z
...
business_elements: {"companies":["keyword search","Anysearch","Anthropic","Google","Microsoft","GitHub","Meta","Amazon"],"products":["Copilot","agent","agents"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["$39","8","00","27","2024","3.5","4","2012"],"quotes":["We let companies pick a set of repositories in their GitHub organization and then fine-tune the model on those repositories,","more than half a dozens times"]}
...
Topics
AI , code completion , Enterprise , Enterprise AI , GitHub , GitHub Copilot
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":6776,"paragraph_count":29,"sentence_count":33,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   The highlight here is the ability to reference an organization’s internal code and knowledge base.

5. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Copilot is now also integrated with Microsoft’s Bing search engine (currently in beta) and soon, users will also be able to fine-tune Copilot’s models based on a team’s existing codebase as well.
...
- companies: keyword search, Anysearch, Anthropic, Google, Microsoft, GitHub, Meta, Amazon
...
- numbers: $39, 8, 00, 27, 2024, 3.5, 4, 2012
- quotes: We let companies pick a set of repositories in their GitHub organization and then fine-tune the model on those repositories, / more than half a dozens times

## evidence_seed

- company_actions: The highlight here is the ability to reference an organization’s internal code and knowledge base.
- case_details: Copilot Enterprise includes all of the features of the existing Business plan, including IP indemnity, but extends this with a number of crucial features for larger teams. / Copilot is now also integrated with Microsoft’s Bing search engine (currently in beta) and soon, users will also be able to fine-tune Copilot’s models based on a team’s existing codebase as well. / With that, new developers on a team can, for example, ask Copilot how to deploy a container image to the cloud and get an answer that is specific to the process in their organization.
