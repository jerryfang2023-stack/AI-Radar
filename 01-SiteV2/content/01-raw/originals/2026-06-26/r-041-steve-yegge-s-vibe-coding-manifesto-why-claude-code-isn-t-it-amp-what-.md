...
original_url: "https://www.latent.space/p/steve-yegges-vibe-coding-manifesto"
canonical_url: "https://latent.space/p/steve-yegges-vibe-coding-manifesto"
...
author: ""
published_at: ""
collected_at: 2026-06-26T07:13:34.482Z
language: mixed
full_text_hash: 9a356f6e76004fd0
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-26/r-041-steve-yegge-s-vibe-coding-manifesto-why-claude-code-isn-t-it-amp-what-.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-26/r-041-steve-yegge-s-vibe-coding-manifesto-why-claude-code-isn-t-it-amp-what-.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7146,"paragraph_count":51,"sentence_count":17,"boilerplate_hits":0,"symbol_ratio":0.0003,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 7146
fetch_error: ""
...
url_hash: 1abc57c76b99bb91
content_hash: 9a356f6e76004fd0
semantic_hash: bfe0c3b5c26bf172
duplicate_of: ""
first_seen_at: "2026-06-26T07:13:34.482Z"
last_seen_at: 2026-06-26T07:13:34.482Z
...
business_elements: {"companies":["Latent Space","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Amazon","Apple","Cursor"],"products":["Claude","agent","agents","Cursor","MCP","Agents","Agent","Gemini"],"people":[],"industries":["制造 / 工业","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究"],"business_actions":[],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["1","0","00","37","24","26","2025","2024"],"quotes":["factory farming","factory farming","one engineer per repo","hot hand","factory farming of code"]}
...
1×
0:00
Current time: 0:00 / Total time: -37:24
-37:24
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7146,"paragraph_count":51,"sentence_count":17,"boilerplate_hits":0,"symbol_ratio":0.0003,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Latent Space: The AI Engineer Podcast Steve Yegge's Vibe Coding Manifesto: Why Claude Code Isn't It & What Comes After the IDE 1× 0:00 Current time: 0:00 / Total time: -37:24 -37:24 Audio playback is not supported on your browser.
...
4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   After stints at SourceGraph and building Beads (a purely vibe-coded issue tracker with tens of thousands of users), Steve co-authored The Vibe Coding Book and is now building VC (VibeCoder) , an agent orchestration dashboard designed to move developers from writing code to managing fleets of AI agents that coordinate, parallelize, and ship features while you sleep.

5. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   We sat down with Steve at AI Engineer Summit to dig into why Claude Code, Cursor, and the entire 2024 stack are already obsolete , what it actually takes to trust an agent after 2,000 hours of practice (hint: they will delete your production database if you anthropomorphize them), why the real skill is no longer writing code but orchestrating agents like a NASCAR pit crew, how merging has become the new wall that every 10x-productive team is hitting (and why one company’s solution is literally “one engineer per rep

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We discuss: Why Claude Code, Cursor, and agentic coding tools are already last year’s tech —and what comes next: agent orchestration dashboards where you manage fleets, not write lines The 2,000-hour rule : why it takes a full year of daily use before you can predict what an LLM will do, and why trust = predictability, not capability Steve’s hot take : if you’re still using an IDE to develop code by January 1st, 2025, you’re a bad engineer—because the abstraction layer has moved from models to full-stack agents The

## business_elements

- companies: Latent Space, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Amazon, Apple, Cursor
- products: Claude, agent, agents, Cursor, MCP, Agents, Agent, Gemini
- people: 暂无公开信息
...
- numbers: 1, 0, 00, 37, 24, 26, 2025, 2024
- quotes: factory farming / factory farming / one engineer per repo / hot hand / factory farming of code

## evidence_seed

- company_actions: After stints at SourceGraph and building Beads (a purely vibe-coded issue tracker with tens of thousands of users), Steve co-authored The Vibe Coding Book and is now building VC (VibeCoder) , an agent orchestration dashboard designed to move developers from writing code to managing fleets of AI agents that coordinate, parallelize, and ship features while you sleep. / We discuss: Why Claude Code, Cursor, and agentic coding tools are already last year’s tech —and what comes next: agent orchestration dashboards where you manage fleets, not write lines The 2,000-hour rule : why it takes a full year of daily use before you can predict what an LLM will do, and why trust = predictability, not capability Steve’s hot take : if you’re still using an IDE to develop code by January 1st, 2025, you’re a bad engineer—because the abstraction layer has moved from models to full-stack agents The
- case_details: 暂无公开信息
- workflow_changes: Latent Space: The AI Engineer Podcast Steve Yegge's Vibe Coding Manifesto: Why Claude Code Isn't It & What Comes After the IDE 1× 0:00 Current time: 0:00 / Total time: -37:24 -37:24 Audio playback is not supported on your browser.
