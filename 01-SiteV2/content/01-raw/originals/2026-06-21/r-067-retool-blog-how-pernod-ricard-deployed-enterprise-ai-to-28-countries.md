...
raw_id: R-067
title: "Retool Blog | How Pernod Ricard Deployed Enterprise AI to 28 Countries"
original_url: "https://retool.com/blog/pernod-ricard-enterprise-ai-deployment"
canonical_url: "https://retool.com/blog/pernod-ricard-enterprise-ai-deployment"
...
author: ""
published_at: ""
collected_at: 2026-06-21T03:09:49.387Z
language: mixed
full_text_hash: 025c0888227af2b8
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-21/r-067-retool-blog-how-pernod-ricard-deployed-enterprise-ai-to-28-countries.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-21/r-067-retool-blog-how-pernod-ricard-deployed-enterprise-ai-to-28-countries.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7967,"paragraph_count":42,"sentence_count":44,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
has_full_text: true
content_length: 7967
fetch_error: ""
...
url_hash: f4b829632a9448ee
content_hash: 025c0888227af2b8
semantic_hash: 204ffbb746053e19
duplicate_of: ""
first_seen_at: "2026-06-21T03:09:49.387Z"
last_seen_at: 2026-06-21T03:09:49.387Z
...
business_elements: {"companies":["keyword search","Anysearch"],"products":[],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["28","20","15","2026","01","40","02","03"],"quotes":["It’s just doing clustering based on those 40 dimensions,","We only select things that can scale and will get a significant return on investment,","For a lot of projects, if you have a good ROI of a few millions or dozens of millions of euros, you will find the data.","This is the first time I had people actually going to the union to say, ‘I want the tool,’ instead of fighting against it.","You need to get the cloud working, you need to be able to extract data from the systems,"]}
...
title_zh: "Retool 博客 | 保乐力加如何在 28 个国家部署企业级 AI"
title_translation_status: "translated"
title_translation_method: "source_title_translation_db"
title_translation_model: "not_applicable"
---

# Retool Blog | How Pernod Ricard Deployed Enterprise AI to 28 Countries
...
Table of contents
01
Inside D-Star: the 40-input model that replaced fixed sales schedules
02
Why the team skipped the proof-of-concept stage
03
The governance layer that cleared IT’s objections upfront
04
The UI investment that lifted adoption to 85%
...
Read Pernod Ricard’s full AI adoption story.
light Reader
Rebecca Dodd
Technical Content Writer
Rebecca is a technical content writer specializing in content for developers and engineering teams. She has written extensively for developer tool companies including Sourcegraph and GitLab, and brings a researcher's rigor to making complex systems understandable.
May 15, 2026 Copy Link
Related Articles
The build vs. buy shift: how vibe coding and shadow IT have reshaped enterprise software
Kelsey McKeon
9 things we learned at Retool Summit 2025
Kelsey McKeon
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7967,"paragraph_count":42,"sentence_count":44,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   [Pierre-Yves Calloc’h](https://www.linkedin.com/in/calloch/) spent 20 years at Pernod Ricard—the company behind some of the world’s biggest alcohol brands—first as managing director, then CIO, and CDO. When he turned his attention to the company’s first AI projects, he treated governance as a design... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=industry_landing

2. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   How Pierre-Yves Calloc’h kept AI governed at Pernod Ricard Rebecca Dodd Technical Content Writer May 15, 2026 Copy Link Table of contents 01 Inside D-Star: the 40-input model that replaced fixed sales schedules 02 Why the team skipped the proof-of-concept stage 03 The governance layer that cleared IT’s objections upfront 04 The UI investment that lifted adoption to 85% Pierre-Yves Calloc’h spent 20 years at Pernod Ricard—the company behind some of the world’s biggest alcohol brands—first as managing director, then 

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   When he turned his attention to the company’s first AI projects, he treated governance as a design constraint from day one: something to be solved for rather than negotiated around after the fact.

4. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   The D-Star program he led was deployed to the sales force in 28 countries, with 85% adoption and $15M in annual ROI in the US alone.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Most enterprise AI programs never get that far.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   AI adoption committees get hung up on the choice of model or AI coding assistant, or initial exploration gets bogged down in pulling together scattered data .
...
- numbers: 28, 20, 15, 2026, 01, 40, 02, 03
- quotes: It’s just doing clustering based on those 40 dimensions, / We only select things that can scale and will get a significant return on investment, / For a lot of projects, if you have a good ROI of a few millions or dozens of millions of euros, you will find the data. / This is the first time I had people actually going to the union to say, ‘I want the tool,’ instead of fighting against it. / You need to get the cloud working, you need to be able to extract data from the systems,

## evidence_seed

- company_actions: When he turned his attention to the company’s first AI projects, he treated governance as a design constraint from day one: something to be solved for rather than negotiated around after the fact. / Most enterprise AI programs never get that far. / AI adoption committees get hung up on the choice of model or AI coding assistant, or initial exploration gets bogged down in pulling together scattered data .
- case_details: [Pierre-Yves Calloc’h](https://www.linkedin.com/in/calloch/) spent 20 years at Pernod Ricard—the company behind some of the world’s biggest alcohol brands—first as managing director, then CIO, and CDO. When he turned his attention to the company’s first AI projects, he treated governance as a design... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=industry_landing
