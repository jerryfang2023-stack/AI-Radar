...
original_url: "https://www.latent.space/p/state-of-rlreasoning-imoioi-gold"
canonical_url: "https://latent.space/p/state-of-rlreasoning-imoioi-gold"
...
author: ""
published_at: ""
collected_at: 2026-06-21T03:09:49.076Z
language: mixed
full_text_hash: d8e5fd2bfbed681b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-21/r-026-state-of-rl-reasoning-imo-ioi-gold-openai-o3-gpt-5-and-cursor-composer.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-21/r-026-state-of-rl-reasoning-imo-ioi-gold-openai-o3-gpt-5-and-cursor-composer.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":6885,"paragraph_count":48,"sentence_count":15,"boilerplate_hits":0,"symbol_ratio":0.001,"method":"article"}
has_full_text: true
content_length: 6885
fetch_error: ""
...
url_hash: 105443507fade27f
content_hash: d8e5fd2bfbed681b
semantic_hash: 6ef01a648c66c203
duplicate_of: ""
first_seen_at: "2026-06-21T03:09:49.076Z"
last_seen_at: 2026-06-21T03:09:49.076Z
...
business_elements: {"companies":["Latent Space","OpenAI","Anthropic","Microsoft","GitHub","Meta","Apple","Cursor"],"products":["GPT-5","Cursor","cursor","Agent","Codex","Agents","Gemini"],"people":[],"industries":["开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["权限 / 安全治理","部署 / 集成交付"],"business_actions":["部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["3","5","2017","4","1","2025","300","2022 b"],"quotes":["If you told me we’d achieve IOI Gold in 2022, I’d assume we could all go on vacation—AI solved, no point working anymore. But life is still the same.","surprisingly accurate reasoning traces"]}
...
1×
0:00
Current time: 0:00 / Total time: -45:12
-45:12
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":6885,"paragraph_count":48,"sentence_count":15,"boilerplate_hits":0,"symbol_ratio":0.001,"method":"article"}
...
2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Latent Space: The AI Engineer Podcast [State of RL/Reasoning] IMO/IOI Gold, OpenAI o3/GPT-5, and Cursor Composer — Ashvin Nair, Cursor 1× 0:00 Current time: 0:00 / Total time: -45:12 -45:12 Audio playback is not supported on your browser.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   [State of RL/Reasoning] IMO/IOI Gold, OpenAI o3/GPT-5, and Cursor Composer — Ashvin Nair, Cursor Dec 30, 2025 Share Transcript From Berkeley robotics and OpenAI’s 2017 Dota-era internship to shipping RL breakthroughs on GPT-4o, o1, and o3, and now leading model development at Cursor , Ashvin Nair has done it all.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We caught up with Ashvin at NeurIPS 2025 to dig into the inside story of OpenAI’s reasoning team (spoiler: it went from a dozen people to 300+), why IOI Gold felt reachable in 2022 but somehow didn’t change the world when o1 actually achieved it, how RL doesn’t generalize beyond the training distribution (and why that means you need to bring economically useful tasks into distribution by co-designing products and models), the deeper lessons from the RL research era (2017–2022) and why most of it didn’t pan out beca

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We discuss: Ashvin’s path: Berkeley robotics PhD → OpenAI 2017 intern (Dota era) → o1/o3 reasoning team → Cursor ML lead in three months Why robotics people are the most grounded at NeurIPS (they work with the real world) and simulation people are the most unhinged (Lex Fridman’s take) The IOI Gold paradox : “If you told me we’d achieve IOI Gold in 2022, I’d assume we could all go on vacation—AI solved, no point working anymore.
...
- companies: Latent Space, OpenAI, Anthropic, Microsoft, GitHub, Meta, Apple, Cursor
- products: GPT-5, Cursor, cursor, Agent, Codex, Agents, Gemini
- people: 暂无公开信息
- industries: 开发者工具
- roles: 开发者 / 工程团队
...
- numbers: 3, 5, 2017, 4, 1, 2025, 300, 2022 b
- quotes: If you told me we’d achieve IOI Gold in 2022, I’d assume we could all go on vacation—AI solved, no point working anymore. But life is still the same. / surprisingly accurate reasoning traces

## evidence_seed

- company_actions: From Berkeley robotics and OpenAI’s 2017 Dota-era internship to shipping RL breakthroughs on GPT-4o, o1, and o3, and now leading model development at Cursor, Ashvin Nair has done it all. We caught up with Ashvin at NeurIPS 2025 to dig into the inside story of OpenAI’s reasoning team (spoiler: it went from a dozen people to 300+), why IOI Gold felt reachable in 2022 but somehow didn’t change the world when o1 actually achieved it, how RL doesn’t generalize beyond the training distribution (and wh / [State of RL/Reasoning] IMO/IOI Gold, OpenAI o3/GPT-5, and Cursor Composer — Ashvin Nair, Cursor Dec 30, 2025 Share Transcript From Berkeley robotics and OpenAI’s 2017 Dota-era internship to shipping RL breakthroughs on GPT-4o, o1, and o3, and now leading model development at Cursor , Ashvin Nair has done it all. / We caught up with Ashvin at NeurIPS 2025 to dig into the inside story of OpenAI’s reasoning team (spoiler: it went from a dozen people to 300+), why IOI Gold felt reachable in 2022 but somehow didn’t change the world when o1 actually achieved it, how RL doesn’t generalize beyond the training distribution (and why that means you need to bring economically useful tasks into distribution by co-designing products and models), the deeper lessons from the RL research era (2017–2022) and why most of it didn’t pan out beca
- case_details: 暂无公开信息
- workflow_changes: Latent Space: The AI Engineer Podcast [State of RL/Reasoning] IMO/IOI Gold, OpenAI o3/GPT-5, and Cursor Composer — Ashvin Nair, Cursor 1× 0:00 Current time: 0:00 / Total time: -45:12 -45:12 Audio playback is not supported on your browser.
