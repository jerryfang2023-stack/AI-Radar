...
original_url: "https://lilianweng.github.io/posts/2023-01-10-inference-optimization/"
canonical_url: "https://lilianweng.github.io/posts/2023-01-10-inference-optimization"
...
author: ""
published_at: ""
collected_at: 2026-06-21T03:09:49.288Z
language: mixed
full_text_hash: 2080189662ef5579
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-21/r-056-large-transformer-model-inference-optimization.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-21/r-056-large-transformer-model-inference-optimization.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":44568,"paragraph_count":242,"sentence_count":386,"boilerplate_hits":0,"symbol_ratio":0.0112,"method":"main"}
has_full_text: true
content_length: 44568
fetch_error: ""
...
url_hash: 5b11892bb9eb8b65
content_hash: 2af47a2305769371
semantic_hash: 7582172ac1da5a2e
duplicate_of: ""
first_seen_at: "2026-06-21T03:09:49.288Z"
last_seen_at: 2026-06-21T03:09:49.288Z
...
guanlan_scores: {"importance_type":"important_technical_trend","importance_score":5,"importance_reason":"technical trend or capability shift; rubric=5 major/platform/industry-shaping","supporting_signals":["adoption_context"],"novelty":2,"evidence_strength":4,"case_richness":4,"trend_relevance":5,"guanlan_relevance":4,"emerging_signal_score":3}
business_elements: {"companies":["Lilian Weng's Blog (OpenAI)"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["计费 / 预算管理"],"business_actions":[],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["34","2023","01","24","2022","512","2048","3"],"quotes":[]}
...
Naively quantizing the entire weight matrix in one layer (&ldquo;per-tensor&rdquo; or &ldquo;per-layer&rdquo; quantization) is easiest to implement but does not lead to good granularity of quantization.
...
$$
The smoothing factor can be easily fused into previous layers&rsquo; parameters offline. A hyperparameter $\alpha$ controls how much we migrate the quantization difficulty from activations to weights: $\mathbf{s} = \max (\vert \mathbf{X}_j \vert)^\alpha / \max( \vert \mathbf{W}_j \vert )^{1-\alpha}$. The paper found that $\alpha=0.5$ is a sweet spot for many LLMs in the experiments. For models with more significant outliers in activation, $\alpha$ can be adjusted to be larger.
Quantization-aware training (QAT) #
...
Unstructured pruning is allowed to drop any weight or connection, so it does not retain the original network architecture. Unstructured pruning often does not work well with modern hardware and doesn&rsquo;t lead to actual inference speedup.
...
To sparsify a dense neural network to follow a N:M structured sparsity pattern, Nvidia (2020) suggested using the three-step routine workflow for training a pruned network: train &ndash;> prune to satisfy 2:4 sparsity &ndash;> retrain.
...
To enforce N:M structured sparsity, let&rsquo;s split the columns of one matrix into multiple slides of $M$ columns (named &ldquo;stripe&rdquo;) and we can easily observe that both the order of columns within each stripe and the order of stripes have no effect on the N:M sparsity restriction.
...
Mixture-of-Experts #
Mixture-of-experts (MoE) models depend on a collection of &ldquo;expert&rdquo; networks and each example only activates a subset of networks to get predictions. The idea originated back to the 1990s ( Jacobs et al. 1991 ) and is strongly related to ensemble methods. For details on how to incorporate MoE module into transformer, please check my previous post on large model training techniques and a survey paper on MoE by Fedus et al. 2022 .
...
How image patches are discarded according to priority scores when $C Riquelme et al. 2021 )
...
Shazeer (2019) proposed multi-query attention which has the keys and values shared across different attention &ldquo;heads&rdquo;, greatly reducing the size of these tensors and the memory cost.
...
References #
[1] Bondarenko et al. &ldquo;Understanding and overcoming the challenges of efficient transformer quantization&rdquo; ACL 2021.
[2] Dettmers et al. &ldquo;LLM.int8(): 8-bit Matrix Multiplication for Transformers at Scale&rdquo; NeuriPS 2022
[3] Zadeh et al. &ldquo;Gobo: Quantizing attention-based NLP models for low latency and energy efficient inference.&rdquo; MICRO 2020
...
[7] Xiao & Lin &ldquo;SmoothQuant: Accelerated sparse neural training: A provable and efficient method to find N:M transposable masks.&rdquo; arXiv preprint arXiv:2211.10438 (2022). | code
[8] Pool & Yu. &ldquo;Channel Permutations for N:M Sparsity.&rdquo; NeuriPS 2021. | code
[9] Zhou & Ma, et al. &ldquo;Learning N:M fine-grained structured sparse neural networks from scratch.&rdquo; arXiv preprint arXiv:2102.04010 (2021).
[10] Jayakumar et al. &ldquo;Top-KAST: Top-K Always Sparse Training.&rdquo; NeuriPS 2020.
[11] Nvidia. &ldquo;Nvidia A100 tensor core GPU architecture.&rdquo; 2020.
[12] Gale, Elsen & Hooker &ldquo;The State of Sparsity in Deep Neural Networks.&rdquo; arXiv preprint arXiv:1902.09574 (2019).
[13] Zhu & Gupta. &ldquo;To Prune, or Not to Prune: Exploring the Efficacy of Pruning for Model Compression.&rdquo; arXiv preprint arXiv:1710.01878 (2017).
[14] Renda et al. &ldquo;Comparing rewinding and fine-tuning in neural network pruning.&rdquo; arXiv preprint arXiv:2003.02389 (2020).
[15] Zhou & Ma, et al. &ldquo;Learning N:M fine-grained structured sparse neural networks from scratch.&rdquo; arXiv preprint arXiv:2102.04010 (2021).
[16] Pool & Yu. &ldquo;Channel Permutations for N:M Sparsity.&rdquo; NeuriPS 2021. | code
[17] Jaszczur et al. &ldquo;Sparse is Enough in Scaling Transformers.&rdquo; NeuriPS 2021.
[18] Mishra et al. &ldquo;An Survey of Neural Network Compression.&rdquo; arXiv preprint arXiv:1710.09282 (2017).
[19] Fedus et al. &ldquo;A Review of Sparse Expert Models in Deep Learning.&rdquo; arXiv preprint arXiv:2209.01667 (2022)..
[20] Riquelme et al. &ldquo;Scaling vision with sparse mixture of experts.&rdquo; NeuriPS 2021.
[21] Kudugunta et al. &ldquo;Beyond Distillation: Task-level Mixture-of-Experts for Efficient Inference.&rdquo; arXiv preprint arXiv:2110.03742 (2021).
[22] Rajbhandari et al. &ldquo;DeepSpeed-MoE: Advancing mixture-of-experts inference and training to power next-generation ai scale.&rdquo; arXiv preprint arXiv:2201.05596 (2022).
[23] Kossmann et al. &ldquo;Optimizing mixture of experts using dynamic recompilations.&rdquo; arXiv preprint arXiv:2205.01848 (2022).
[24] Hwang et al. &ldquo;Tutel: Adaptive mixture-of-experts at scale.&rdquo; arXiv preprint arXiv:2206.03382 (2022). | code
[25] Noam Shazeer. &ldquo;Fast Transformer Decoding: One Write-Head is All You Need.&rdquo; arXiv preprint arXiv:1911.02150 (2019).
[26] Tay et al. &ldquo;Efficient Transformers: A Survey.&rdquo; ACM Computing Surveys 55.6 (2022): 1-28.
[27] Pope et al. &ldquo;Efficiently Scaling Transformer Inference.&rdquo; arXiv preprint arXiv:2211.05102 (2022).
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":44568,"paragraph_count":242,"sentence_count":386,"boilerplate_hits":0,"symbol_ratio":0.0112,"method":"main"}
...
4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   ] Large transformer models are mainstream nowadays, creating SoTA results for a variety of tasks.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   They are powerful but very expensive to train and use.
...
- numbers: 34, 2023, 01, 24, 2022, 512, 2048, 3
- quotes: 暂无公开信息

## evidence_seed

- company_actions: &lt;p&gt;&lt;span class=&#34;update&#34;&gt;[Updated on 2023-01-24: add a small section on &lt;a href=&#34;#distillation&#34;&gt;Distillation&lt;/a&gt;.]&lt;/span&gt;&lt;br/&gt;&lt;/p&gt; &lt;p&gt;Large transformer models are mainstream nowadays, creating SoTA results for a variety of tasks. They are powerful but very expensive to train and use. The extremely high inference cost, in both time and memory, is a big bottleneck for adopting a powerful transformer for solving real-world tasks at scal / Table of Contents Methods Overview Distillation Quantization Challenges for Transformer Quantization Post-training quantization (PTQ) Mixed-precision quantization Quantization at fine-grained granularity Second order information for quantization Outlier smoothing Quantization-aware training (QAT) Pruning How to prune? / Sparsity N:M Sparsity via Pruning Sparsified Transformer Mixture-of-Experts Routing Strategy Improvement Kernel Improvement Architectural Optimization Sparse Attention Patterns Recurrence Memory Saving Designs Adaptive Attention Citation References [Updated on 2023-01-24: add a small section on Distillation .
- case_details: 暂无公开信息
