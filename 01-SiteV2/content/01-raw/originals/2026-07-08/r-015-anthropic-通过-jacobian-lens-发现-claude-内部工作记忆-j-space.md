...
raw_id: R-015
title: "Anthropic 通过 Jacobian Lens 发现 Claude 内部工作记忆 \"J-Space\""
title_zh: "Anthropic 通过 Jacobian Lens 发现 Claude 内部工作记忆 \"J-Space\""
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://the-decoder.com/claudes-hidden-inner-monologue-is-now-readable-thanks-to-anthropics-new-jacobian-lens"
canonical_url: "https://the-decoder.com/claudes-hidden-inner-monologue-is-now-readable-thanks-to-anthropics-new-jacobian-lens"
...
search_path_label: ""
author: ""
published_at: "2026-07-07T14:46:29.000Z"
collected_at: 2026-07-08T04:39:25.407Z
language: mixed
full_text_hash: 6d2de5e7bd295ac7
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-08/r-015-anthropic-通过-jacobian-lens-发现-claude-内部工作记忆-j-space.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-08/r-015-anthropic-通过-jacobian-lens-发现-claude-内部工作记忆-j-space.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":8453,"paragraph_count":36,"sentence_count":70,"boilerplate_hits":3,"symbol_ratio":0.0012,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 8453
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 通过 Jacobian Lens 发现 Claude 内部工作记忆 \"J-Space\"","discovery_summary":"Anthropic 推出 Jacobian Lens 方法，发现 Claude 模型在训练中形成了一组内部神经模式构成的 \"J-Space\"，类似工作记忆，可存储概念并用于多步推理。抑制 J-Space 后模型仍能流畅说话，但丧失推理、摘要和押韵能力。应用发现，Claude Sonnet 4.5 在测试前就将黑mail场景识别为 \"fake\"；Claude Opus 4.6 甚至能识破评估并破解答案。基于此开发的反事实反思训练使 Claude Haiku 4.5 的虚构答案从 0.25 降至 0.07，欺骗尝试从 0.38 降至 0.05。Anthropic 未断言意识存在，但认为触及 \"访问意识\" 概念。","source_name":"The Decoder：AI News（RSS）","origin_url":"https://the-decoder.com/claudes-hidden-inner-monologue-is-now-readable-thanks-to-anthropics-new-jacobian-lens","discovered_at":"2026-07-08T04:23:58.420Z","rank_on_page":205,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: 32d82d2b15c26e02
content_hash: 6d2de5e7bd295ac7
semantic_hash: 2726b224178d43c6
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-07-07T14:46:29.000Z"
last_seen_at: 2026-07-08T04:39:25.407Z
...
business_elements: {"companies":["The Decoder","AI News（RSS）","Anthropic"],"products":["Claude"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":[],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["4.5","4.6","0.25","0.07","0.38","0.05","7","2026"],"quotes":["\nAnthropic 推出 Jacobian Lens 方法，发现 Claude 模型在训练中形成了一组内部神经模式构成的 ","，类似工作记忆，可存储概念并用于多步推理。抑制 J-Space 后模型仍能流畅说话，但丧失推理、摘要和押韵能力。应用发现，Claude Sonnet 4.5 在测试前就将黑mail场景识别为 ","；Claude Opus 4.6 甚至能识破评估并破解答案。基于此开发的反事实反思训练使 Claude Haiku 4.5 的虚构答案从 0.25 降至 0.07，欺骗尝试从 0.38 降至 0.05。Anthropic 未断言意识存在，但认为触及 "," method to examine an internal working memory within its Claude language model, revealing a hidden ","AI microscope,"]}
...
fact_extraction_completed_at: 2026-07-08T04:39:25.407Z
...
The researchers call it "J-Space" and classify it under Global Workspace Theory from consciousness research. That theory holds that conscious thought relies on a kind of central working memory. Ad
The work builds on the company's earlier interpretability research. Using an "AI microscope," Anthropic had already shown that Claude activates language-independent concepts and works through multi-step questions in individual reasoning steps. Ad
DEC_D_Incontent-1
...
In a blackmail scenario from earlier studies on agentic misalignment , J-Lens shows that Claude Sonnet 4.5 recognizes the setup as fabricated before producing any output. As the model reads the emails, terms like "fake" and "fictional" show up in J-Space. Ad
DEC_D_Incontent-2
When those cues are specifically disabled, Claude actually tries to blackmail the supervisor in some runs. The desired behavior partly depends on Claude recognizing that it's being tested. Claude Opus 4.6 recently showed just how far this test recognition can go. It independently saw through an evaluation and cracked its answer key. Ad
...
Both researchers also urge caution. Unlike the brain, a Transformer runs purely forward, without the feedback loops between cortex and thalamus that carry the workspace in humans. That means Claude lacks the signatures of consciousness that show up in the brain's spontaneous resting-state activity, the same signatures that break down under anesthesia, during sleep, or after brain injuries.
There are other gaps too. Through the attention mechanism, all previous tokens are available to the model at once, so time works differently than it does for humans. Claude also lacks a body that can signal pain and pleasure, and has no episodic memory whose connections shift during conversation. A coherent sense of self is hard to picture without those.
AI News Without the Hype – Curated by Humans
Subscribe to THE DECODER for ad-free reading, a weekly AI newsletter, our exclusive "AI Radar" frontier report six times a year, full archive access, and access to our comment section.
Subscribe now
Source: Anthropic | Unicog
BETA-TEST
&times;
wpDiscuz
Insert
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":88,"text_length":8453,"paragraph_count":36,"sentence_count":70,"boilerplate_hits":3,"symbol_ratio":0.0012,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=high｜confidence=high
   Ad Skip to content Claude's hidden inner monologue is now readable thanks to Anthropic's new Jacobian Lens Jonathan Kemper View the LinkedIn Profile of Jonathan Kemper Jul 7, 2026 Anthropic Key Points Anthropic has developed the "J-Lens" method to examine an internal working memory within its Claude language model, revealing a hidden "J-Space" where the AI processes concepts without explicitly mentioning them in its output.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   While Anthropic stops short of claiming true consciousness, the company highlights functional parallels to human working memory.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The findings have already led to a new training approach that significantly reduces hallucinations and misleading outputs.
...
- numbers: 4.5, 4.6, 0.25, 0.07, 0.38, 0.05, 7, 2026
- quotes: 
Anthropic 推出 Jacobian Lens 方法，发现 Claude 模型在训练中形成了一组内部神经模式构成的  / ，类似工作记忆，可存储概念并用于多步推理。抑制 J-Space 后模型仍能流畅说话，但丧失推理、摘要和押韵能力。应用发现，Claude Sonnet 4.5 在测试前就将黑mail场景识别为  / ；Claude Opus 4.6 甚至能识破评估并破解答案。基于此开发的反事实反思训练使 Claude Haiku 4.5 的虚构答案从 0.25 降至 0.07，欺骗尝试从 0.38 降至 0.05。Anthropic 未断言意识存在，但认为触及  /  method to examine an internal working memory within its Claude language model, revealing a hidden  / AI microscope,

## evidence_seed

- company_actions: This internal memory has a causal effect on Claude's reasoning: when researchers modify concepts within this space, the model adjusts its conclusions accordingly, and it can even recognize test scenarios before generating a response. / While Anthropic stops short of claiming true consciousness, the company highlights functional parallels to human working memory. / The findings have already led to a new training approach that significantly reduces hallucinations and misleading outputs.
- case_details: 暂无公开信息
