...
search_path_label: ""
author: ""
published_at: "2026-07-07T04:35:09.000Z"
collected_at: 2026-07-08T04:39:25.415Z
language: mixed
full_text_hash: 536fa981ec920b8c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-08/r-016-openai-发布-gpt-realtime-2-1-和-gpt-realtime-2-1-mini-低延迟语音模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-08/r-016-openai-发布-gpt-realtime-2-1-和-gpt-realtime-2-1-mini-低延迟语音模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":47751,"paragraph_count":412,"sentence_count":129,"boilerplate_hits":2,"symbol_ratio":0.0015,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 47751
fetch_error: ""
...
discovery_record: {"discovery_title":"OpenAI 发布 gpt-realtime-2.1 和 gpt-realtime-2.1-mini 低延迟语音模型","discovery_summary":"OpenAI 推出两款新型 Realtime 模型：gpt-realtime-2.1 和 gpt-realtime-2.1-mini。mini 版是专注于实时语音交互的迷你推理模型，支持工具调用和可配置推理力度（minimal 到 xhigh），定价与上代 gpt-realtime-mini 相同。2.1 版改进了字母数字识别、静音噪声处理和中断行为，支持语音到语音及指令遵循。两类模型均通过 Realtime API 提供，p95 延迟因缓存改进至少降低 25%。缓存输入 token 价格大幅优惠：mini 版缓存音频输入 $0.30/1M，非缓存 $10.00/1M；音频输出 mini 版 $20.00/1M，2.1 版 $64.00/1M。推理能力使模型可在工具调用前说出前置话语，保持多步对话连贯性。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/06/openai-gpt-realtime-2-1-mini-reasoning-realtime-api","discovered_at":"2026-07-08T04:23:58.453Z","rank_on_page":312,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: ad788f26396ef79e
content_hash: 9798660e4c175cd3
semantic_hash: 7fc0ced6a4255724
duplicate_of: ""
first_seen_at: "2026-07-07T04:35:09.000Z"
last_seen_at: 2026-07-08T04:39:25.415Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["agent","agents","Agents","Claude","Agent","GPT-5","MCP","Cursor","Gemini","Codex"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["2.1","95","25%","$0.30","1M","$10.00","$20.00","$64.00"],"quotes":["https://api.openai.com/v1/realtime/client_secrets",",\nheaders: {\nAuthorization: `Bearer ${process.env.OPENAI_API_KEY}`,\n","application/json","realtime","gpt-realtime-2.1-mini"]}
...
fact_extraction_completed_at: 2026-07-08T04:39:25.415Z
...
Michal Sutter
A Comprehensive Implementation Guide to ModelScope for Model Search, Inference, Fine-Tuning, Evalu
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":47751,"paragraph_count":412,"sentence_count":129,"boilerplate_hits":2,"symbol_ratio":0.0015,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   OpenAI 推出两款新型 Realtime 模型：gpt-realtime-2.1 和 gpt-realtime-2.1-mini。mini 版是专注于实时语音交互的迷你推理模型，支持工具调用和可配置推理力度（minimal 到 xhigh），定价与上代 gpt-realtime-mini 相同。2.1 版改进了字母数字识别、静音噪声处理和中断行为，支持语音到语音及指令遵循。两类模型均通过 Realtime API 提供，p95 延迟因缓存改进至少降低 25%。缓存输入 token 价格大幅优惠：mini 版缓存音频输入 $0.30/1M，非缓存 $10.00/1M；音频输出 mini 版 $20.00/1M，2.1 版 $64.00/1M。推理能力使模型可在工具调用前说出前置话语，保持多步对话连贯性。

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Editors Pick Agentic AI Technology AI Shorts Artificial Intelligence Applications Language Model Audio Language Model Large Language Model Machine Learning New Releases Software Engineering Staff Tech News TTS Voice AI OpenAI has released two new Realtime models in its API.
...
- numbers: 2.1, 95, 25%, $0.30, 1M, $10.00, $20.00, $64.00
- quotes: https://api.openai.com/v1/realtime/client_secrets / ,
headers: {
Authorization: `Bearer ${process.env.OPENAI_API_KEY}`,
 / application/json / realtime / gpt-realtime-2.1-mini
...
- company_actions: Editors Pick Agentic AI Technology AI Shorts Artificial Intelligence Applications Language Model Audio Language Model Large Language Model Machine Learning New Releases Software Engineering Staff Tech News TTS Voice AI OpenAI has released two new Realtime models in its API. / They are named gpt-realtime-2. / 1 and gpt-realtime-2.
- case_details: 暂无公开信息
