...
raw_id: R-045
title: "用 GPT-5.6、Claude、Gemini 和 Grok \"绘制\"《蒙娜丽莎》--AI 图像生成能力实测"
title_zh: "用 GPT-5.6、Claude、Gemini 和 Grok \"绘制\"《蒙娜丽莎》--AI 图像生成能力实测"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.tryai.dev/blog/ai-drawing-arena-colored-pencils-claude-gpt-grok"
canonical_url: "https://tryai.dev/blog/ai-drawing-arena-colored-pencils-claude-gpt-grok"
...
collected_at: 2026-07-23T03:51:21.944Z
language: mixed
full_text_hash: 83d24dbed34890a9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-23/r-045-用-gpt-5-6-claude-gemini-和-grok-绘制-蒙娜丽莎-ai-图像生成能力实测.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-23/r-045-用-gpt-5-6-claude-gemini-和-grok-绘制-蒙娜丽莎-ai-图像生成能力实测.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":9970,"paragraph_count":74,"sentence_count":79,"boilerplate_hits":0,"symbol_ratio":0.0018,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 9970
fetch_error: ""
...
discovery_record: {"discovery_title":"用 GPT-5.6、Claude、Gemini 和 Grok \"绘制\"《蒙娜丽莎》--AI 图像生成能力实测","discovery_summary":"开发者使用 GPT-5.6、Claude、Gemini 和 Grok 分别尝试\"绘制\"《蒙娜丽莎》，对比各模型的图像生成效果。测试展示了不同 AI 在艺术风格还原、细节处理上的差异，GPT-5.6 在构图准确性上表现突出，而 Claude 和 Gemini 各有侧重。该实验为评估多模态模型的视觉创作能力提供了直观参考。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://www.tryai.dev/blog/ai-drawing-arena-colored-pencils-claude-gpt-grok","discovered_at":"2026-07-23T03:43:25.392Z","rank_on_page":358,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: d4d93cf9ebc648c3
content_hash: 83d24dbed34890a9
semantic_hash: 698de3280c8b9a6d
duplicate_of: ""
first_seen_at: "2026-07-21T00:00:00.000Z"
last_seen_at: 2026-07-23T03:51:21.944Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","GitHub"],"products":["GPT-5","Claude","Gemini"],"people":[],"industries":["开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":[],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["5.6","5","4.5","3.6","28","3","0","1"],"quotes":["《蒙娜丽莎》--AI 图像生成能力实测\n开发者使用 GPT-5.6、Claude、Gemini 和 Grok 分别尝试","An elderly fisherman's weathered face, warm late-afternoon sun, deep wrinkles and stubble","A beautiful sunset over a calm ocean, orange-to-violet sky, silhouetted horizon","A single red rose in a glass vase against a dark background, dramatic Rembrandt lighting","A tabby cat curled asleep on a windowsill in afternoon sun"]}
...
fact_extraction_completed_at: 2026-07-23T03:51:21.944Z
...
Model Drawings ↕ Avg steps ↕ Avg time ↕ Total tokens ↕ Est. token cost ↕ Avg self-reviews ↕ Total draw calls ↕
...
Model Target ↕ Steps ↕ Time ↕ Self-reviews ↕ Final SSIM ↕ Best SSIM ↕ Final RMSE ↕
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9970,"paragraph_count":74,"sentence_count":79,"boilerplate_hits":0,"symbol_ratio":0.0018,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   All posts We built a drawing arena: hand a model a blank white canvas and a set of colored-pencil tools, then get out of the way.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   We ran four vision models, GPT-5.
...
- numbers: 5.6, 5, 4.5, 3.6, 28, 3, 0, 1
- quotes: 《蒙娜丽莎》--AI 图像生成能力实测
开发者使用 GPT-5.6、Claude、Gemini 和 Grok 分别尝试 / An elderly fisherman's weathered face, warm late-afternoon sun, deep wrinkles and stubble / A beautiful sunset over a calm ocean, orange-to-violet sky, silhouetted horizon / A single red rose in a glass vase against a dark background, dramatic Rembrandt lighting / A tabby cat curled asleep on a windowsill in afternoon sun

## evidence_seed

- company_actions: 开发者使用 GPT-5.6、Claude、Gemini 和 Grok 分别尝试"绘制"《蒙娜丽莎》，对比各模型的图像生成效果。测试展示了不同 AI 在艺术风格还原、细节处理上的差异，GPT-5.6 在构图准确性上表现突出，而 Claude 和 Gemini 各有侧重。该实验为评估多模态模型的视觉创作能力提供了直观参考。 / All posts We built a drawing arena: hand a model a blank white canvas and a set of colored-pencil tools, then get out of the way. / The model sets a color, tip width, and pressure, lays down batches of strokes, smudges to blend, erases, and calls view_canvas to see its own work and decide what to fix.
- case_details: 暂无公开信息
