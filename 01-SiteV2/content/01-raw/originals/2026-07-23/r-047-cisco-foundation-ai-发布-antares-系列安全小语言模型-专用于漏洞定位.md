...
raw_id: R-047
title: "Cisco Foundation AI 发布 Antares 系列安全小语言模型，专用于漏洞定位"
title_zh: "Cisco Foundation AI 发布 Antares 系列安全小语言模型，专用于漏洞定位"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.marktechpost.com/2026/07/21/cisco-foundation-ai-releases-antares-350m-and-1b-open-weight-models-that-localize-known-vulnerabilities-inside-real-codebases"
canonical_url: "https://marktechpost.com/2026/07/21/cisco-foundation-ai-releases-antares-350m-and-1b-open-weight-models-that-localize-known-vulnerabilities-inside-real-codebases"
...
search_path_label: ""
author: ""
published_at: "2026-07-22T06:27:02.000Z"
collected_at: 2026-07-23T03:51:21.956Z
language: mixed
full_text_hash: ce0ee7003abbf430
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-23/r-047-cisco-foundation-ai-发布-antares-系列安全小语言模型-专用于漏洞定位.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-23/r-047-cisco-foundation-ai-发布-antares-系列安全小语言模型-专用于漏洞定位.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":6997,"paragraph_count":49,"sentence_count":70,"boilerplate_hits":0,"symbol_ratio":0.0009,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 6997
fetch_error: ""
...
discovery_record: {"discovery_title":"Cisco Foundation AI 发布 Antares 系列安全小语言模型，专用于漏洞定位","discovery_summary":"Cisco Foundation AI 发布 Antares 系列安全小语言模型，专用于在代码库中定位已知漏洞。Antares-1B 在 VLoc Bench 上达到 0.209 File F1，超过 753B 参数的 GLM-5.2（0.186）。Antares-350M 和 Antares-1B 以 Apache 2.0 许可证开源。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/21/cisco-foundation-ai-releases-antares-350m-and-1b-open-weight-models-that-localize-known-vulnerabilities-inside-real-codebases","discovered_at":"2026-07-23T03:43:25.388Z","rank_on_page":341,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 382bb3fa23256025
content_hash: ce0ee7003abbf430
semantic_hash: 12921674c1caf85f
duplicate_of: ""
first_seen_at: "2026-07-22T06:27:02.000Z"
last_seen_at: 2026-07-23T03:51:21.956Z
...
business_elements: {"companies":["MarkTechPost（RSS）","GitHub","Meta","Cursor","Mistral"],"products":["GPT-5","Agent","Gemini","Cursor","Claude"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["1B","0.209","1","753B","5.2","0.186","350M","2.0"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-23T03:51:21.956Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":6997,"paragraph_count":49,"sentence_count":70,"boilerplate_hits":0,"symbol_ratio":0.0009,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The task is vulnerability localization.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Given a vulnerability description and a repository, find the files containing the flaw.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Two models are open-weight and available now on Hugging Face, Antares-350M and Antares-1B .
...
- companies: MarkTechPost（RSS）, GitHub, Meta, Cursor, Mistral
- products: GPT-5, Agent, Gemini, Cursor, Claude
- people: 暂无公开信息
...
- numbers: 1B, 0.209, 1, 753B, 5.2, 0.186, 350M, 2.0
- quotes: 暂无公开信息

## evidence_seed

- company_actions: The task is vulnerability localization. / Given a vulnerability description and a repository, find the files containing the flaw. / Two models are open-weight and available now on Hugging Face, Antares-350M and Antares-1B .
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: Cisco Foundation AI 发布 Antares 系列安全小语言模型，专用于在代码库中定位已知漏洞。Antares-1B 在 VLoc Bench 上达到 0.209 File F1，超过 753B 参数的 GLM-5.2（0.186）。Antares-350M 和 Antares-1B 以 Apache 2.0 许可证开源。 / Technology AI Shorts Artificial Intelligence Applications Editors Pick Language Model Large Language Model Machine Learning New Releases Open Source Security Software Engineering Staff Tech News Cisco Foundation AI has released Antares , a family of security small language models (SLMs) built for one narrow security task.
