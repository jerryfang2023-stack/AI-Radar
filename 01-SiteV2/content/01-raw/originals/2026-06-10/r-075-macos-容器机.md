...
canonical_url: "https://github.com/apple/container/blob/main/docs/container-machine.md"
...
search_path_label: ""
author: ""
published_at: "2026-06-10T01:45:59.378Z"
collected_at: 2026-06-10T02:25:37.654Z
language: mixed
full_text_hash: 73055c440dfe51f4
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-10/r-075-macos-容器机.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-10/r-075-macos-容器机.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5235,"paragraph_count":67,"sentence_count":32,"boilerplate_hits":0,"symbol_ratio":0.0034,"method":"main"}
has_full_text: true
content_length: 5235
fetch_error: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"73055c440dfe51f4","missing":[]}
...
discovery_record: {"discovery_title":"macOS 容器机","discovery_summary":"macOS容器机项目在GitHub上公开，获得102个Hacker News热度积分。该项目为macOS提供容器化运行环境，具体实现细节及功能尚未在本次发布中详细披露。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://github.com/apple/container/blob/main/docs/container-machine.md","discovered_at":"2026-06-10T02:18:55.937Z","rank_on_page":33,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: ce06dcdbb7372ccd
content_hash: 73055c440dfe51f4
semantic_hash: 76bb7935d7a664d0
duplicate_of: ""
first_seen_at: "2026-06-10T01:45:59.378Z"
last_seen_at: 2026-06-10T02:25:37.654Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","GitHub","Apple"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","部署 / 集成交付"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["102","784","27.2","120","85","5.06","4 m","8"],"quotes":["I built it","I am inspecting it"]}
evidence_seed: {"company_actions":["macOS容器机项目在GitHub上公开，获得102个Hacker News热度积分。该项目为macOS提供容器化运行环境，具体实现细节及功能尚未在本次发布中详细披露。","apple container Public Notifications You must be signed in to change notification settings Fork 784 Star 27.","2k Files Expand file tree main / container-machine."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"product_update","text":"macOS容器机项目在GitHub上公开，获得102个Hacker News热度积分。该项目为macOS提供容器化运行环境，具体实现细节及功能尚未在本次发布中详细披露。","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"},{"type":"company_action","text":"apple container Public Notifications You must be signed in to change notification settings Fork 784 Star 27.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"2k Files Expand file tree main / container-machine.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"md Copy path Blame More file actions Blame More file actions Latest commit History History History 120 lines (85 loc) · 5.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"06 KB main / container-machine.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"md Top File metadata and controls Preview Code Blame 120 lines (85 loc) · 5.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"}]
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5235,"paragraph_count":67,"sentence_count":32,"boilerplate_hits":0,"symbol_ratio":0.0034,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   apple container Public Notifications You must be signed in to change notification settings Fork 784 Star 27.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2k Files Expand file tree main / container-machine.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   md Copy path Blame More file actions Blame More file actions Latest commit History History History 120 lines (85 loc) · 5.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   06 KB main / container-machine.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   md Top File metadata and controls Preview Code Blame 120 lines (85 loc) · 5.
...
- numbers: 102, 784, 27.2, 120, 85, 5.06, 4 m, 8
- quotes: I built it / I am inspecting it

## evidence_seed

- company_actions: macOS容器机项目在GitHub上公开，获得102个Hacker News热度积分。该项目为macOS提供容器化运行环境，具体实现细节及功能尚未在本次发布中详细披露。 / apple container Public Notifications You must be signed in to change notification settings Fork 784 Star 27. / 2k Files Expand file tree main / container-machine.
- case_details: 暂无公开信息
