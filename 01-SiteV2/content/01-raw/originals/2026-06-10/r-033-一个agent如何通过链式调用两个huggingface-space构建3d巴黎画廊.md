...
canonical_url: "https://huggingface.co/blog/mishig/spaces-agents-md"
...
collected_at: 2026-06-10T02:25:37.491Z
language: mixed
full_text_hash: 83d9b8e1cd1ee2fc
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-10/r-033-一个agent如何通过链式调用两个huggingface-space构建3d巴黎画廊.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-10/r-033-一个agent如何通过链式调用两个huggingface-space构建3d巴黎画廊.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":6141,"paragraph_count":95,"sentence_count":53,"boilerplate_hits":0,"symbol_ratio":0.0031,"method":"main"}
has_full_text: true
content_length: 6141
fetch_error: ""
...
discovery_record: {"discovery_title":"一个Agent如何通过链式调用两个HuggingFace Space构建3D巴黎画廊","discovery_summary":"一个编码Agent调用HuggingFace上的两个Space，从零构建了展示巴黎地标3D高斯散点图的交互式画廊。Agent先用ideogram-ai/ideogram4生成每个纪念碑的黑色背景图像，再通过VAST-AI/TripoSplat从单张图像重建3D高斯散点（.ply），自动完成坐标系校正、取景、压缩为.ksplat（体积缩小约3倍），并构建基于Three.js的滚动切换、拖拽旋转查看器，最终部署为静态Space。整个过程无需客户端库，每个Space通过`agents.md`暴露可调用API。","source_name":"Hugging Face：Blog（RSS）","origin_url":"https://huggingface.co/blog/mishig/spaces-agents-md","discovered_at":"2026-06-10T02:18:56.000Z","rank_on_page":360,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 459b888b75db1d6d
content_hash: 83d9b8e1cd1ee2fc
semantic_hash: 40d27205c0a15f78
duplicate_of: ""
first_seen_at: "2026-06-09T10:46:19.000Z"
last_seen_at: 2026-06-10T02:25:37.491Z
...
business_elements: {"companies":["Hugging Face","Blog（RSS）"],"products":["Agent","agents","agent","Agents","Claude"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["3","4","3倍","9","2026","12","6\nM","2"],"quotes":["param_name","files=@file.ext","specimen","make it zoomed out,","replace the\nobelisk with something better for splatting,"]}
...
Upvote 12
+6
Mishig Davaadorj mishig Follow
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":6141,"paragraph_count":95,"sentence_count":53,"boilerplate_hits":0,"symbol_ratio":0.0031,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Back to Articles How an Agent Built a 3D Paris Gallery by Chaining Two Hugging Face Spaces Community Article Published June 9, 2026 Upvote 12 +6 Mishig Davaadorj mishig Follow An agent built a 3D Paris gallery from two Hugging Face Spaces.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   I asked a coding agent to build a beautiful website showcasing the monuments of Paris as 3D Gaussian splats.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   I never opened an image generator.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   I never touched a 3D reconstruction tool.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The agent produced every asset (the images and the 3D splats) by calling two Hugging Face Spaces directly, then wired them into a cinematic viewer.
...
- numbers: 3, 4, 3倍, 9, 2026, 12, 6
M, 2
- quotes: param_name / files=@file.ext / specimen / make it zoomed out, / replace the
obelisk with something better for splatting,

## evidence_seed

- company_actions: Back to Articles How an Agent Built a 3D Paris Gallery by Chaining Two Hugging Face Spaces Community Article Published June 9, 2026 Upvote 12 +6 Mishig Davaadorj mishig Follow An agent built a 3D Paris gallery from two Hugging Face Spaces. / I asked a coding agent to build a beautiful website showcasing the monuments of Paris as 3D Gaussian splats. / I never opened an image generator.
- case_details: 暂无公开信息
