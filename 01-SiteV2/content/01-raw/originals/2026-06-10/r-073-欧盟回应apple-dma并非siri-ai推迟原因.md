...
raw_id: R-073
title: "欧盟回应Apple：DMA并非Siri AI推迟原因"
original_url: "https://www.theverge.com/ai-artificial-intelligence/947051/apple-europe-dma-siri-ai"
canonical_url: "https://theverge.com/ai-artificial-intelligence/947051/apple-europe-dma-siri-ai"
...
search_path_label: ""
author: ""
published_at: "2026-06-09T17:13:14.000Z"
collected_at: 2026-06-10T02:25:37.645Z
language: mixed
full_text_hash: f8b9395bc052f55e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-10/r-073-欧盟回应apple-dma并非siri-ai推迟原因.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-10/r-073-欧盟回应apple-dma并非siri-ai推迟原因.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":14581,"paragraph_count":36,"sentence_count":86,"boilerplate_hits":0,"symbol_ratio":0,"method":"json-ld"}
has_full_text: true
content_length: 14581
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"f8b9395bc052f55e","missing":[]}
...
discovery_record: {"discovery_title":"欧盟回应Apple：DMA并非Siri AI推迟原因","discovery_summary":"Apple将Siri AI在欧洲的上线延迟归咎于欧盟数字市场法案（DMA），欧盟方面则明确回应称DMA并未阻止其发布。","source_name":"The Verge：订阅版科技（RSS）","origin_url":"https://www.theverge.com/ai-artificial-intelligence/947051/apple-europe-dma-siri-ai","discovered_at":"2026-06-10T02:18:55.976Z","rank_on_page":225,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 4cc831ab66e2a648
content_hash: f8b9395bc052f55e
semantic_hash: 9504952b653a6f03
duplicate_of: ""
first_seen_at: "2026-06-09T17:13:14.000Z"
last_seen_at: 2026-06-10T02:25:37.645Z
...
business_elements: {"companies":["The Verge","订阅版科技（RSS）","OpenAI","Anthropic","Google","Apple"],"products":["Agent","agents"],"people":[],"industries":["法律 / 法务"],"roles":["开发者 / 工程团队"],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["18 m","2026","27","9"],"quotes":["gradually rolling","there is currently no timeline for Siri AI’s availability in the EU on iOS and iPadOS.","Let me also be super clear: Apple strongly supports interoperability,","unfettered access","would be irresponsible,"]}
evidence_seed: {"company_actions":["Apple将Siri AI在欧洲的上线延迟归咎于欧盟数字市场法案（DMA），欧盟方面则明确回应称DMA并未阻止其发布。","Apple wants Europe to blink Apple blames DMA for delaying Siri AI in Europe.","The EU says nothing is stopping Apple from launching it."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"product_update","text":"Apple将Siri AI在欧洲的上线延迟归咎于欧盟数字市场法案（DMA），欧盟方面则明确回应称DMA并未阻止其发布。","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Apple wants Europe to blink Apple blames DMA for delaying Siri AI in Europe.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"product_update","text":"The EU says nothing is stopping Apple from launching it.","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"},{"type":"company_action","text":"It took a few years, but Apple finally made its AI look useful.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Now millions of iPhone users in Europe are being told they won’t be getting Siri AI anytime soon, if ever — and Apple wants them to blame the EU.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"product_update","text":"Apple says its new AI-powered Siri will not launch on iPhones and iPads in the European Union because of the Digital Markets Act, the bloc’s competition law designed to stop powerful tech companies from acting as gatekeepers over their platforms to shut out rivals.","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"}]
theme: mature-commercial-signal
keyword_group: mature-commercial-signal
copyright_note: local research archive only
---

# 欧盟回应Apple：DMA并非Siri AI推迟原因
...
- fetch_status: fetched-readable-text-json-ld
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":14581,"paragraph_count":36,"sentence_count":86,"boilerplate_hits":0,"symbol_ratio":0,"method":"json-ld"}
...
1. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Apple将Siri AI在欧洲的上线延迟归咎于欧盟数字市场法案（DMA），欧盟方面则明确回应称DMA并未阻止其发布。

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Apple wants Europe to blink Apple blames DMA for delaying Siri AI in Europe.

3. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   The EU says nothing is stopping Apple from launching it.
...
6. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Apple says its new AI-powered Siri will not launch on iPhones and iPads in the European Union because of the Digital Markets Act, the bloc’s competition law designed to stop powerful tech companies from acting as gatekeepers over their platforms to shut out rivals.

## business_elements

- companies: The Verge, 订阅版科技（RSS）, OpenAI, Anthropic, Google, Apple
...
- numbers: 18 m, 2026, 27, 9
- quotes: gradually rolling / there is currently no timeline for Siri AI’s availability in the EU on iOS and iPadOS. / Let me also be super clear: Apple strongly supports interoperability, / unfettered access / would be irresponsible,

## evidence_seed

- company_actions: Apple将Siri AI在欧洲的上线延迟归咎于欧盟数字市场法案（DMA），欧盟方面则明确回应称DMA并未阻止其发布。 / Apple wants Europe to blink Apple blames DMA for delaying Siri AI in Europe. / The EU says nothing is stopping Apple from launching it.
- case_details: 暂无公开信息
