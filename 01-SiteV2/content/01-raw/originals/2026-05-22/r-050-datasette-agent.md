...
author: ""
published_at: ""
collected_at: 2026-05-22T05:10:29.319Z
language: mixed
full_text_hash: 8eac1eaf2ccb82a5
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-22/r-050-datasette-agent.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-22/r-050-datasette-agent.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Datasette Agent","discovery_summary":"Datasette Agent是Datasette推出的首个可扩展AI助手，为用户提供对话式界面以查询数据，并支持通过插件生成图表。该工具基于其LLM Python库构建，是LLM与Datasette整合的重要成果。目前提供图表生成、AI图像创建和沙箱代码执行等官方插件。它既可运行于Gemini 3.1 Flash-Lite等云端模型，也支持通过LM Studio连接本地开源模型，具备可靠的工具调用与查询能力。","source_name":"Simon Willison 博客","origin_url":"","discovered_at":"2026-05-22T04:57:59.815Z","rank_on_page":9,"discovery_status":"discovered"}
...
content_hash: 8eac1eaf2ccb82a5
semantic_hash: 64af35fe6ecefe53
duplicate_of: ""
first_seen_at: "2026-05-22T05:10:29.319Z"
last_seen_at: 2026-05-22T05:10:29.319Z
...
business_elements: {"companies":["Simon Willison 博客"],"products":["Agent","Gemini"],"people":[],"industries":[],"roles":[],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["3.1"],"quotes":[]}
...
- company_actions: Datasette Agent是Datasette推出的首个可扩展AI助手，为用户提供对话式界面以查询数据，并支持通过插件生成图表。该工具基于其LLM Python库构建，是LLM与Datasette整合的重要成果。目前提供图表生成、AI图像创建和沙箱代码执行等官方插件。它既可运行于Gemini 3.1 Flash-Lite等云端模型，也支持通过LM Studio连接本地开源模型，具备可靠的工具调用与查询能力。 / Datasette Agent是Datasette推出的首个可扩展AI助手，为用户提供对话式界面以查询数据，并支持通过插件生成图表。 / 该工具基于其LLM Python库构建，是LLM与Datasette整合的重要成果。
- case_details: 暂无公开信息
