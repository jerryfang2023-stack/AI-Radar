...
collected_at: 2026-07-14T01:56:51.519Z
language: mixed
full_text_hash: d1fc136237a1d8e6
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-14/r-036-cloudflare-推出-precursor-通过持续客户端信号检测-ai-智能体行为.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-14/r-036-cloudflare-推出-precursor-通过持续客户端信号检测-ai-智能体行为.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":9529,"paragraph_count":40,"sentence_count":80,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 9529
fetch_error: ""
...
discovery_record: {"discovery_title":"Cloudflare 推出 Precursor：通过持续客户端信号检测 AI 智能体行为","discovery_summary":"Cloudflare 发布 Precursor，一款用于机器人管理的新型持续行为验证引擎。它通过将用户会话级别的行为转化为机器人检测信号，能够更精确地识别高级自动化行为，同时减少对合法用户的干扰。Precursor 可全程追踪人类与 AI 智能体在完整用户旅程中的实际交互方式，提升检测精度并降低误报率。","source_name":"Cloudflare Blog","origin_url":"https://blog.cloudflare.com/introducing-precursor","discovered_at":"2026-07-14T01:48:14.404Z","rank_on_page":163,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 13dc5104dc60aec8
content_hash: d1fc136237a1d8e6
semantic_hash: 082ae7f7e069cffb
duplicate_of: ""
first_seen_at: "2026-07-13T13:00:00.000Z"
last_seen_at: 2026-07-14T01:56:51.519Z
...
business_elements: {"companies":["Cloudflare Blog"],"products":[],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2026","07","13\nM","5 m","1 trillion","20%","3 billion","1"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-14T01:56:51.519Z
...
Bot Management Security Turnstile JavaScript AI Precursor Product News
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9529,"paragraph_count":40,"sentence_count":80,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Introducing Precursor: detecting agentic behavior with continuous client-side signals 2026-07-13 Marina Elmore Benedikt Wolters 5 min read Bot mitigation is an adversarial game: attackers adapt, defenders respond, and the cycle continues.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   At Cloudflare, we stay ahead by combining visibility across our global network with signals from the client-side environment.
...
5. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   On the client side, we’ve pushed detection deeper with Cloudflare Turnstile , which has evolved from a CAPTCHA replacement to a risk-based managed challenge that adapts the amount of friction needed to verify the user is authentic.
...
- numbers: 2026, 07, 13
M, 5 m, 1 trillion, 20%, 3 billion, 1
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Cloudflare 发布 Precursor，一款用于机器人管理的新型持续行为验证引擎。它通过将用户会话级别的行为转化为机器人检测信号，能够更精确地识别高级自动化行为，同时减少对合法用户的干扰。Precursor 可全程追踪人类与 AI 智能体在完整用户旅程中的实际交互方式，提升检测精度并降低误报率。 / Introducing Precursor: detecting agentic behavior with continuous client-side signals 2026-07-13 Marina Elmore Benedikt Wolters 5 min read Bot mitigation is an adversarial game: attackers adapt, defenders respond, and the cycle continues. / At Cloudflare, we stay ahead by combining visibility across our global network with signals from the client-side environment.
- case_details: 暂无公开信息
...
- risks_or_constraints: On the client side, we’ve pushed detection deeper with Cloudflare Turnstile , which has evolved from a CAPTCHA replacement to a risk-based managed challenge that adapts the amount of friction needed to verify the user is authentic.
