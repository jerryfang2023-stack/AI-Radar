...
collected_at: 2026-07-14T01:56:51.532Z
language: mixed
full_text_hash: d88046cabf174f3c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-14/r-038-cloudflare-9月15日起默认屏蔽ai智能体爬虫-三类爬虫控制开关上线.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-14/r-038-cloudflare-9月15日起默认屏蔽ai智能体爬虫-三类爬虫控制开关上线.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":76,"text_length":8689,"paragraph_count":54,"sentence_count":63,"boilerplate_hits":7,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 8689
fetch_error: ""
...
discovery_record: {"discovery_title":"Cloudflare 9月15日起默认屏蔽AI智能体爬虫，三类爬虫控制开关上线","discovery_summary":"Cloudflare于7月1日上线三类爬虫控制开关（Search、Agent、Training），覆盖所有客户。9月15日起，在展示广告的页面上，Training和Agent类爬虫将被默认屏蔽，Search类保持允许。新默认值适用于新接入域名、现有客户的新站点及所有免费版客户。Agent类包括ChatGPT的fetch爬虫和浏览器驱动型智能体。屏蔽在网络层生效，而非robots.txt建议。CEO Matthew Prince表示此举旨在推动混合用途爬虫分离搜索、智能体使用和训练。Ceramic.ai和You.com已开始按使用量向出版商付费。","source_name":"Artificial Intelligence News（RSS）","origin_url":"https://www.artificialintelligence-news.com/news/ai-agent-crawlers-cloudflare-rules","discovered_at":"2026-07-14T01:48:14.410Z","rank_on_page":187,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 988157836a1f9763
content_hash: d88046cabf174f3c
semantic_hash: ba0292b903eb4222
duplicate_of: ""
first_seen_at: "2026-07-13T00:00:00.000Z"
last_seen_at: 2026-07-14T01:56:51.532Z
...
business_elements: {"companies":["Artificial Intelligence News（RSS）","Google","AWS"],"products":["Agent","ChatGPT","agent","agents"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","制造 / 工业","开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["9","15","7","1","13","2026","403","10"],"quotes":["encourage mixed-use crawlers to separate search from agent use and training"]}
...
fact_extraction_completed_at: 2026-07-14T01:56:51.532Z
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":76,"text_length":8689,"paragraph_count":54,"sentence_count":63,"boilerplate_hits":7,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Cloudflare于7月1日上线三类爬虫控制开关（Search、Agent、Training），覆盖所有客户。9月15日起，在展示广告的页面上，Training和Agent类爬虫将被默认屏蔽，Search类保持允许。新默认值适用于新接入域名、现有客户的新站点及所有免费版客户。Agent类包括ChatGPT的fetch爬虫和浏览器驱动型智能体。屏蔽在网络层生效，而非robots.txt建议。CEO Matthew Prince表示此举旨在推动混合用途爬虫分离搜索、智能体使用和训练。Ceramic.ai和You.com已开始按使用量向出版商付费。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Skip to content AI in Action AI agent crawlers now need permission.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Here’s how to get it Dashveenjit Kaur July 13, 2026 Share this story: Tags: agentic ai AI agent crawlers Cloudflare content licensing Matthew Prince publishers web crawlers Categories: AI Business Strategy AI in Action Artificial Intelligence Inside AI AI agent crawlers, the bots that fetch pages in real time on behalf of a person waiting for an answer, will be blocked by default on a slice of the web from September 15 onwards.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The more useful part is what it asks of everyone building agents, and what it offers them in return.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Cloudflare has replaced its single block-AI-bots switch with three categories.

## business_elements

- companies: Artificial Intelligence News（RSS）, Google, AWS
...
- numbers: 9, 15, 7, 1, 13, 2026, 403, 10
- quotes: encourage mixed-use crawlers to separate search from agent use and training

## evidence_seed

- company_actions: Skip to content AI in Action AI agent crawlers now need permission. / Here’s how to get it Dashveenjit Kaur July 13, 2026 Share this story: Tags: agentic ai AI agent crawlers Cloudflare content licensing Matthew Prince publishers web crawlers Categories: AI Business Strategy AI in Action Artificial Intelligence Inside AI AI agent crawlers, the bots that fetch pages in real time on behalf of a person waiting for an answer, will be blocked by default on a slice of the web from September 15 onwards. / Cloudflare announced the change on July 1, and most of the coverage since then has focused on Google.
- case_details: Cloudflare于7月1日上线三类爬虫控制开关（Search、Agent、Training），覆盖所有客户。9月15日起，在展示广告的页面上，Training和Agent类爬虫将被默认屏蔽，Search类保持允许。新默认值适用于新接入域名、现有客户的新站点及所有免费版客户。Agent类包括ChatGPT的fetch爬虫和浏览器驱动型智能体。屏蔽在网络层生效，而非robots.txt建议。CEO Matthew Prince表示此举旨在推动混合用途爬虫分离搜索、智能体使用和训练。Ceramic.ai和You.com已开始按使用量向出版商付费。
