...
canonical_url: "https://claude.com/blog/building-effective-human-agent-teams"
...
search_path_label: ""
author: ""
published_at: "2026-06-24T18:35:00.940Z"
collected_at: 2026-06-25T03:26:00.315Z
language: mixed
full_text_hash: 128c298bed5b6f30
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-25/r-007-anthropic-推出-claude-tag-构建人机协作团队.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-25/r-007-anthropic-推出-claude-tag-构建人机协作团队.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":15209,"paragraph_count":70,"sentence_count":105,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 15209
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 推出 Claude Tag，构建人机协作团队","discovery_summary":"Anthropic 推出 Claude Tag，支持多用户与同一 AI 智能体在同一工作空间协作。智能体具备持久记忆、独立于人类的凭证及广泛信息访问权限。经验：工作公开化并给予智能体广泛上下文，通过工作区级安全边界让信息对人和 AI 均可用；为每位成员（含 AI）分配明确角色与相应工具。用户可通过 @Claude 私信进行敏感交互，对话保持私密。该方法已在 Slack 等团队协作工具中实践，旨在使人类与智能体高效协作完成共享目标。","source_name":"Claude：Blog（网页）","origin_url":"https://claude.com/blog/building-effective-human-agent-teams","discovered_at":"2026-06-25T03:03:30.127Z","rank_on_page":123,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f702671dce84d2a9
content_hash: 128c298bed5b6f30
semantic_hash: 9b6815ff9dc4ddee
duplicate_of: ""
first_seen_at: "2026-06-24T18:35:00.940Z"
last_seen_at: 2026-06-25T03:26:00.315Z
...
business_elements: {"companies":["Claude","Blog（网页）","Anthropic"],"products":["Claude","agent","agents","Agents","MCP"],"people":[],"industries":["医疗","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["1","2","3","4","500 b","0","5"],"quotes":["single-player","Multiplayer agents","make product onboarding more helpful","Doer-Verifier","verifier"]}
...
title_zh: "Anthropic 推出 Claude Tag，构建人机协作团队"
...
Claude agents share the day-to-day maintenance of a codebase, triaging feedback, planning, writing code, reviewing changes, and reporting status. Each owns a clear task and works on its own schedule; people set the goals and review output. An engineering team at Anthropic started creating rosters to help codify human and agent roles because it made driving their work much easier and more concrete. Some things that clicked for them early on:
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":15209,"paragraph_count":70,"sentence_count":105,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
- products: Claude, agent, agents, Agents, MCP
- people: 暂无公开信息
- industries: 医疗, 开发者工具
...
- numbers: 1, 2, 3, 4, 500 b, 0, 5
- quotes: single-player / Multiplayer agents / make product onboarding more helpful / Doer-Verifier / verifier

## evidence_seed

- company_actions: Working with AI used to mean one person interfacing with a single chat window. / Over time, AI has become increasingly capable at handling complex, long-running work, like coding, research, and financial analysis. / This is changing with the release of tools like Claude Tag .
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: Anthropic 推出 Claude Tag，支持多用户与同一 AI 智能体在同一工作空间协作。智能体具备持久记忆、独立于人类的凭证及广泛信息访问权限。经验：工作公开化并给予智能体广泛上下文，通过工作区级安全边界让信息对人和 AI 均可用；为每位成员（含 AI）分配明确角色与相应工具。用户可通过 @Claude 私信进行敏感交互，对话保持私密。该方法已在 Slack 等团队协作工具中实践，旨在使人类与智能体高效协作完成共享目标。
