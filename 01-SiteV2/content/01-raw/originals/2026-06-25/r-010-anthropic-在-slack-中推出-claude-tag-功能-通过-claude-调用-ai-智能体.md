...
raw_id: R-010
title: "Anthropic 在 Slack 中推出 Claude Tag 功能，通过 @Claude 调用 AI 智能体"
original_url: "https://www.artificialintelligence-news.com/news/anthropic-slack-workplace-ai-agents"
canonical_url: "https://artificialintelligence-news.com/news/anthropic-slack-workplace-ai-agents"
...
collected_at: 2026-06-25T03:26:00.329Z
language: mixed
full_text_hash: 3707cb31e904d8dd
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-25/r-010-anthropic-在-slack-中推出-claude-tag-功能-通过-claude-调用-ai-智能体.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-25/r-010-anthropic-在-slack-中推出-claude-tag-功能-通过-claude-调用-ai-智能体.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":79,"text_length":9673,"paragraph_count":57,"sentence_count":57,"boilerplate_hits":6,"symbol_ratio":0.0009,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 9673
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 在 Slack 中推出 Claude Tag 功能，通过 @Claude 调用 AI 智能体","discovery_summary":"Anthropic 面向 Enterprise 和 Team 用户发布 Claude Tag 功能 beta 版。用户可在 Slack 共享频道中通过 @Claude 直接调用 AI 模型，将其引入活跃群组线程。频道内任何成员均可委派任务或审查内容，打破了传统独立聊天框的交互模式。","source_name":"Artificial Intelligence News（RSS）","origin_url":"https://www.artificialintelligence-news.com/news/anthropic-slack-workplace-ai-agents","discovered_at":"2026-06-25T03:03:30.168Z","rank_on_page":267,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 3ce8ff76656a32c2
content_hash: 3707cb31e904d8dd
semantic_hash: d1fa49f44ed41e6e
duplicate_of: ""
first_seen_at: "2026-06-24T09:00:00.000Z"
last_seen_at: 2026-06-25T03:26:00.329Z
...
business_elements: {"companies":["Artificial Intelligence News（RSS）","OpenAI","Anthropic","Google","Salesforce"],"products":["Claude","agents","agent","ChatGPT","Codex"],"people":[],"industries":["金融 / 保险","制造 / 工业","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["24","2026","$65 billion","$965 billion","$852 billion","1","34.4%","32.3%"],"quotes":["Instead of a private back-and-forth, Claude Tag shows up in the open,","The form factor of being able to tag it the same way that you would a coworker is really powerful,"]}
...
title_zh: "Anthropic 在 Slack 中推出 Claude Tag 功能，通过 @Claude 调用 AI 智能体"
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":79,"text_length":9673,"paragraph_count":57,"sentence_count":57,"boilerplate_hits":6,"symbol_ratio":0.0009,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Skip to content Artificial Intelligence Anthropic drops ‘workplace AI agents’ directly inside Slack Dashveenjit Kaur June 24, 2026 Share this story: Tags: anthropic Claude Tag enterprise AI IT governance salesforce Slack workflow automation workplace AI agents Categories: AI in Action Artificial Intelligence Featured News Human-AI Relationships Inside AI Workforce & HR AI World of Work Anthropic launched a beta version of its Claude Tag feature for Enterprise and Team tiers, shifting its chat model into shared Slac

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Moving away from traditional isolated chat boxes, users pull the artificial intelligence model into active group threads by typing @Claude.

4. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   The integration allows any team member in the channel to delegate a task, review the model’s outputs, and pick up the discussion thread from a previous point.

5. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   This structural shift follows a US$65 billion Series H funding round that brought Anthropic’s post-money valuation to US$965 billion, positioned above rival OpenAI’s US$852 billion mark.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Following a confidential S-1 filing for an initial public offering, market competition for business software placement remains tight.

## business_elements

- companies: Artificial Intelligence News（RSS）, OpenAI, Anthropic, Google, Salesforce
- products: Claude, agents, agent, ChatGPT, Codex
- people: 暂无公开信息
...
- numbers: 24, 2026, $65 billion, $965 billion, $852 billion, 1, 34.4%, 32.3%
- quotes: Instead of a private back-and-forth, Claude Tag shows up in the open, / The form factor of being able to tag it the same way that you would a coworker is really powerful,

## evidence_seed

- company_actions: Anthropic 面向 Enterprise 和 Team 用户发布 Claude Tag 功能 beta 版。用户可在 Slack 共享频道中通过 @Claude 直接调用 AI 模型，将其引入活跃群组线程。频道内任何成员均可委派任务或审查内容，打破了传统独立聊天框的交互模式。 / Moving away from traditional isolated chat boxes, users pull the artificial intelligence model into active group threads by typing @Claude. / The integration allows any team member in the channel to delegate a task, review the model’s outputs, and pick up the discussion thread from a previous point.
- case_details: 暂无公开信息
- workflow_changes: Skip to content Artificial Intelligence Anthropic drops ‘workplace AI agents’ directly inside Slack Dashveenjit Kaur June 24, 2026 Share this story: Tags: anthropic Claude Tag enterprise AI IT governance salesforce Slack workflow automation workplace AI agents Categories: AI in Action Artificial Intelligence Featured News Human-AI Relationships Inside AI Workforce & HR AI World of Work Anthropic launched a beta version of its Claude Tag feature for Enterprise and Team tiers, shifting its chat model into shared Slac
