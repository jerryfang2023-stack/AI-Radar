...
raw_id: R-092
title: "形式验证的 3D CSG 网格求交：信任 93 行规格说明而非 1000 行 AI 代码"
title_zh: "形式验证的 3D CSG 网格求交：信任 93 行规格说明而非 1000 行 AI 代码"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://github.com/schildep/verified-3d-mesh-intersection"
canonical_url: "https://github.com/schildep/verified-3d-mesh-intersection"
...
search_path_label: ""
author: ""
published_at: "2026-07-28T19:54:00.499Z"
collected_at: 2026-07-29T04:43:49.626Z
language: mixed
full_text_hash: 5472d83bb5746d89
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-29/r-092-形式验证的-3d-csg-网格求交-信任-93-行规格说明而非-1000-行-ai-代码.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-29/r-092-形式验证的-3d-csg-网格求交-信任-93-行规格说明而非-1000-行-ai-代码.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":21911,"paragraph_count":103,"sentence_count":148,"boilerplate_hits":2,"symbol_ratio":0.0018,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 21911
fetch_error: ""
...
discovery_record: {"discovery_title":"形式验证的 3D CSG 网格求交：信任 93 行规格说明而非 1000 行 AI 代码","discovery_summary":"首个经形式验证的 3D 构造实体几何（CSG）网格求交实现，在 Lean 4 中完成，针对 93 行形式规格说明进行验证。人类审核者只需阅读规格说明并运行 Lean 检查器，即可认证内核正确性，无需审查 AI 自主编写的 1000+ 行实现代码和 60000+ 行证明。该实现优先保证正确性而非性能，计算两个 7 万三角形的斯坦福兔子网格求交需 24 秒，输出网格保证水密、无自交等良构性质。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://github.com/schildep/verified-3d-mesh-intersection","discovered_at":"2026-07-29T04:35:06.300Z","rank_on_page":136,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 167f0086e4a5aace
content_hash: a048f326e39d4143
semantic_hash: 01f3a214086e2e12
duplicate_of: ""
first_seen_at: "2026-07-28T19:54:00.499Z"
last_seen_at: 2026-07-29T04:43:49.626Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Apple"],"products":["claude","mcp","CLAUDE","agent","agents","Claude"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["合同审阅 / 法律研究"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["3","93","1000","4","60000","7 万","24","69\nm"],"quotes":[", i.e. a volume in 3D space: the set of all points not on the surface but "," the mesh. (","Geometric modelling based on simplicial chains,","well-formed mesh"," $( xcrun --show-sdk-path ) "]}
...
fact_extraction_completed_at: 2026-07-29T04:43:49.626Z
...
lean-toolchain (currently leanprover/lean4:v4.15.0 ) to simplify
...
In the following example exact rotation of the cube with holes leads to a solid whose surface is non-manifold. (See the
...
About
Formally verified 3D mesh intersection - trust 93 lines of spec, not 1000+ lines of AI-written code
schildep.github.io/verified-3d-mesh-intersection/
Topics
computational-geometry constructive-solid-geometry formal-methods formal-verification lean4 mesh-processing verified-software
Resources
Readme
MIT license
Activity
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":21911,"paragraph_count":103,"sentence_count":148,"boilerplate_hits":2,"symbol_ratio":0.0018,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   schildep verified-3d-mesh-intersection Public Notifications You must be signed in to change notification settings Fork Star 69 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 1 Commit 1 Commit .

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   claude CSG CSG docs docs readme-assets readme-assets scripts scripts web web .
...
- products: claude, mcp, CLAUDE, agent, agents, Claude
- people: 暂无公开信息
- industries: 开发者工具
- roles: 暂无公开信息
- workflows: 合同审阅 / 法律研究
...
- numbers: 3, 93, 1000, 4, 60000, 7 万, 24, 69
m
- quotes: , i.e. a volume in 3D space: the set of all points not on the surface but  /  the mesh. ( / Geometric modelling based on simplicial chains, / well-formed mesh /  $( xcrun --show-sdk-path ) 

## evidence_seed

- company_actions: schildep verified-3d-mesh-intersection Public Notifications You must be signed in to change notification settings Fork Star 69 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 1 Commit 1 Commit . / claude CSG CSG docs docs readme-assets readme-assets scripts scripts web web . / md LICENSE LICENSE README.
- case_details: 暂无公开信息
