...
title_zh: "Microsoft 发布 MAI-Cyber-1-Flash：5B 活跃参数的网络安全模型，驱动 MDASH 在 CyberGym 上达到 95.95%"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.marktechpost.com/2026/07/28/microsoft-ai-releases-mai-cyber-1-flash-a-5b-active-parameter-cyber-model-that-pushes-mdash-to-95-95-on-cybergym"
canonical_url: "https://marktechpost.com/2026/07/28/microsoft-ai-releases-mai-cyber-1-flash-a-5b-active-parameter-cyber-model-that-pushes-mdash-to-95-95-on-cybergym"
...
search_path_label: ""
author: ""
published_at: "2026-07-28T08:33:30.000Z"
collected_at: 2026-07-29T04:43:07.083Z
language: mixed
full_text_hash: 44dbc56c1012beea
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-29/r-013-microsoft-发布-mai-cyber-1-flash-5b-活跃参数的网络安全模型-驱动-mdash-在-cybergym-上达到-.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-29/r-013-microsoft-发布-mai-cyber-1-flash-5b-活跃参数的网络安全模型-驱动-mdash-在-cybergym-上达到-.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":4767,"paragraph_count":29,"sentence_count":33,"boilerplate_hits":0,"symbol_ratio":0.0004,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 4767
fetch_error: ""
...
discovery_record: {"discovery_title":"Microsoft 发布 MAI-Cyber-1-Flash：5B 活跃参数的网络安全模型，驱动 MDASH 在 CyberGym 上达到 95.95%","discovery_summary":"Microsoft 发布 MAI-Cyber-1-Flash，一款 137B 总参数（5B 活跃参数）、256k 上下文窗口的稀疏 MoE 网络安全模型，是 MAI-Code-1-Flash 的微调版本。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/28/microsoft-ai-releases-mai-cyber-1-flash-a-5b-active-parameter-cyber-model-that-pushes-mdash-to-95-95-on-cybergym","discovered_at":"2026-07-29T04:35:06.337Z","rank_on_page":287,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: a5220c6c8c96680a
content_hash: 44dbc56c1012beea
semantic_hash: ee4c5bf324712072
duplicate_of: ""
first_seen_at: "2026-07-28T08:33:30.000Z"
last_seen_at: 2026-07-29T04:43:07.083Z
...
business_elements: {"companies":["MarkTechPost（RSS）","Anthropic","Microsoft","GitHub"],"products":["Copilot","GPT-5","agents","codex"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["1","5B","95.95%","137B","256","507","188","5.4"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-29T04:43:07.083Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":4767,"paragraph_count":29,"sentence_count":33,"boilerplate_hits":0,"symbol_ratio":0.0004,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Technology AI Shorts Artificial Intelligence Applications Editors Pick New Releases Tech News Python Security Software Engineering Staff Microsoft AI has released MAI-Cyber-1-Flash , its first model built specifically for cyber defense.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The model does not ship as a standalone endpoint.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It runs inside MDASH , Microsoft’s multi-model agentic scanning harness.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   MAI-Cyber-1-Flash MAI-Cyber-1-Flash is a transformer with self-attention and sparse Mixture-of-Experts layers.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It carries 137B total parameters with 5B active , and a 256k context length .

## business_elements

- companies: MarkTechPost（RSS）, Anthropic, Microsoft, GitHub
- products: Copilot, GPT-5, agents, codex
- people: 暂无公开信息
...
- numbers: 1, 5B, 95.95%, 137B, 256, 507, 188, 5.4
- quotes: 暂无公开信息

## evidence_seed

- company_actions: The model does not ship as a standalone endpoint. / It runs inside MDASH , Microsoft’s multi-model agentic scanning harness. / MAI-Cyber-1-Flash MAI-Cyber-1-Flash is a transformer with self-attention and sparse Mixture-of-Experts layers.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: 开发者 / 工程团队
- risks_or_constraints: Microsoft 发布 MAI-Cyber-1-Flash，一款 137B 总参数（5B 活跃参数）、256k 上下文窗口的稀疏 MoE 网络安全模型，是 MAI-Code-1-Flash 的微调版本。 / Technology AI Shorts Artificial Intelligence Applications Editors Pick New Releases Tech News Python Security Software Engineering Staff Microsoft AI has released MAI-Cyber-1-Flash , its first model built specifically for cyber defense.
