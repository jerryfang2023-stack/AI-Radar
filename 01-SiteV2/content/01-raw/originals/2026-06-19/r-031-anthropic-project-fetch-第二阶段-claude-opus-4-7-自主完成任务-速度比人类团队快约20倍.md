...
canonical_url: "https://anthropic.com/research/project-fetch-phase-two"
...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-031-anthropic-project-fetch-第二阶段-claude-opus-4-7-自主完成任务-速度比人类团队快约20倍.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":9095,"paragraph_count":34,"sentence_count":69,"boilerplate_hits":2,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 9095
fetch_error: ""
...
url_hash: 4f18c8a01f9a4bf5
content_hash: 46a1a52b89b05e2b
...
business_elements: {"companies":["Anthropic","Research（发表成果 · 网页）"],"products":["Claude","agents"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["4.7","20倍","2024","8","4.1","37倍","10倍","18"],"quotes":["fetching"]}
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":9095,"paragraph_count":34,"sentence_count":69,"boilerplate_hits":2,"symbol_ratio":0,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Project Fetch: Phase two \ Anthropic Frontier Red Team Project Fetch: Phase two Jun 18, 2026 Michael Ilie, C.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Daniel Freeman, and Kevin K.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Troy In August 2025, we ran an experiment to see how much Claude could help Anthropic employees—who were not robotics experts—perform sophisticated (and amusing) tasks with an off-the-shelf robotic quadruped (henceforth, a robodog).

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We called this Project Fetch.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We found that access to our state-of-the-art model at the time (Claude Opus 4.
...
- numbers: 4.7, 20倍, 2024, 8, 4.1, 37倍, 10倍, 18
- quotes: fetching

## evidence_seed

- company_actions: Project Fetch: Phase two \ Anthropic Frontier Red Team Project Fetch: Phase two Jun 18, 2026 Michael Ilie, C. / Daniel Freeman, and Kevin K. / Troy In August 2025, we ran an experiment to see how much Claude could help Anthropic employees—who were not robotics experts—perform sophisticated (and amusing) tasks with an off-the-shelf robotic quadruped (henceforth, a robodog).
- case_details: 暂无公开信息
