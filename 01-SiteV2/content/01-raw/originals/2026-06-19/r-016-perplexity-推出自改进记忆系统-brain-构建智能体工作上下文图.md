...
original_url: "https://www.marktechpost.com/2026/06/18/perplexity-launches-brain"
canonical_url: "https://marktechpost.com/2026/06/18/perplexity-launches-brain"
...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-016-perplexity-推出自改进记忆系统-brain-构建智能体工作上下文图.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":7462,"paragraph_count":78,"sentence_count":93,"boilerplate_hits":3,"symbol_ratio":0.0039,"method":"article"}
has_full_text: true
content_length: 7462
fetch_error: ""
...
url_hash: d251f1d474c99fc9
content_hash: f9e19beccc17073e
...
business_elements: {"companies":["MarkTechPost（RSS）","GitHub","Perplexity"],"products":["Agents","agent","agents"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","合作 / 联盟","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["25%","16%","13%","1","2","150"],"quotes":["correction"," if lesson else ","\nbrain = ContextGraph()\n# Day 1: no memory yet, so the task needs review\nlesson = brain.retrieve(",")\nprint(",", agent_execute("]}
...
title_zh: "Perplexity 推出自改进记忆系统 Brain，构建智能体工作上下文图"
...
Check out the Project page and Technical details . Also, feel free to follow us on Twitter and don’t forget to join our 150k+ML SubReddit and Subscribe to our Newsletter . Wait! are you on telegram? now you can join us on telegram as well.
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":88,"text_length":7462,"paragraph_count":78,"sentence_count":93,"boilerplate_hits":3,"symbol_ratio":0.0039,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Editors Pick Agentic AI AI Agents Artificial Intelligence AI Infrastructure Technology AI Shorts Applications For Devs New Releases Staff Tech News Most AI memory remembers the user.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   It stores your preferences, your tastes, and your role.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Perplexity is taking a different path.

5. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Today, Perplexity launched Brain , a self-improving memory system for its agent product, Computer .

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Brain does not focus on remembering you.

## business_elements

- companies: MarkTechPost（RSS）, GitHub, Perplexity
...
- numbers: 25%, 16%, 13%, 1, 2, 150
- quotes: correction /  if lesson else  / 
brain = ContextGraph()
# Day 1: no memory yet, so the task needs review
lesson = brain.retrieve( / )
print( / , agent_execute(
...
- company_actions: Editors Pick Agentic AI AI Agents Artificial Intelligence AI Infrastructure Technology AI Shorts Applications For Devs New Releases Staff Tech News Most AI memory remembers the user. / It stores your preferences, your tastes, and your role. / Perplexity is taking a different path.
- case_details: 暂无公开信息
