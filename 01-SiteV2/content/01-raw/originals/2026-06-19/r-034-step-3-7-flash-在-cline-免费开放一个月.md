...
raw_id: R-034
title: "Step 3.7 Flash 在 Cline 免费开放一个月"
original_url: "https://x.com/StepFun_ai/status/2067593425470509427"
canonical_url: "https://x.com/StepFun_ai/status/2067593425470509427"
...
extractor_diagnostics: {"readability_score":71,"text_length":2553,"paragraph_count":13,"sentence_count":6,"boilerplate_hits":1,"symbol_ratio":0.0278,"method":"main"}
has_full_text: true
content_length: 2553
fetch_error: ""
...
# Step 3.7 Flash 在 Cline 免费开放一个月
...
StepFun
@StepFun_ai
Excited to partner with @ cline to bring Step 3.7 Flash to more coding agent builders.
Step 3.7 Flash is now free in Cline for the next month — capable, fast, and reliable for agentic coding workflows.
Try it in Cline:
/model → Step 3.7 Flash
Big thanks to the Cline team.
Cline
@cline
Jun 17
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":71,"text_length":2553,"paragraph_count":13,"sentence_count":6,"boilerplate_hits":1,"symbol_ratio":0.0278,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Post Log in Sign up Post StepFun @StepFun_ai Excited to partner with @ cline to bring Step 3.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   7 Flash to more coding agent builders.

4. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   7 Flash is now free in Cline for the next month — capable, fast, and reliable for agentic coding workflows.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Try it in Cline: /model → Step 3.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   7 Flash Big thanks to the Cline team.
...
- company_actions: 阶跃星辰宣布与 Cline 合作，Step 3.7 Flash 未来一个月在 Cline 免费使用。该模型在 SWE Bench 上击败 Gemini 和 DeepSeek flash 模型，性能接近前沿水平。支持开源权重、256k 上下文窗口，速度快且稳定。用户可通过 Cline 中 `/model` 命令选择 Step 3.7 Flash。 / Post Log in Sign up Post StepFun @StepFun_ai Excited to partner with @ cline to bring Step 3. / 7 Flash to more coding agent builders.
- case_details: 暂无公开信息
- workflow_changes: 7 Flash is now free in Cline for the next month — capable, fast, and reliable for agentic coding workflows.
