...
raw_id: R-073
title: "AA-Briefcase 基准发布：评估模型长期知识工作智能体能力"
original_url: "https://x.com/ArtificialAnlys/status/2067744637155226101"
canonical_url: "https://x.com/ArtificialAnlys/status/2067744637155226101"
...
search_path_label: ""
author: ""
published_at: "2026-06-18T23:01:52.000Z"
collected_at: 2026-06-19T07:43:57.741Z
language: mixed
full_text_hash: 3675d93abc717b46
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-073-aa-briefcase-基准发布-评估模型长期知识工作智能体能力.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-073-aa-briefcase-基准发布-评估模型长期知识工作智能体能力.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":5869,"paragraph_count":20,"sentence_count":15,"boilerplate_hits":1,"symbol_ratio":0.0124,"method":"main"}
has_full_text: true
content_length: 5869
fetch_error: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"3675d93abc717b46","missing":[]}
...
discovery_record: {"discovery_title":"AA-Briefcase 基准发布：评估模型长期知识工作智能体能力","discovery_summary":"Artificial Analysis 推出新基准 AA-Briefcase，用于评估模型在长期知识工作项目中的智能体能力。基准包含 4 个私有场景（每项目需处理 25000+ Slack 消息、3500+ 邮件等碎片化上下文）及一个公开演示场景。评测结果：Claude Fable 5 以 Elo 1587 领先，其次为 Claude Opus 4.8（1356）、Opus 4.7 及智谱 GLM 5.2（max，1266）。成本方面，Claude Fable 5 平均每任务 $31，Opus 4.8 为 $10.40，GPT-5.5 （xhigh） 为 $3.68，GLM 5.2 （max） 为 $2.40，DeepSeek V4 Flash （max） 仅约 $0.04。所有模型中仅 3% 的任务满足全部标准，31/91 个任务无模型得分超 50%，显示真实世界复杂性仍是挑战。最佳性价比为开源权重模型 GLM-5.2 （max） 和 DeepSeek V4 Pro （max）。","source_name":"X：Artificial Analysis (@ArtificialAnlys)","origin_url":"https://x.com/ArtificialAnlys/status/2067744637155226101","discovered_at":"2026-06-19T07:39:27.748Z","rank_on_page":93,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: d7a4896b04fea833
content_hash: 3675d93abc717b46
semantic_hash: 4ca9aa59f3c66c3d
duplicate_of: ""
first_seen_at: "2026-06-18T23:01:52.000Z"
last_seen_at: 2026-06-19T07:43:57.741Z
...
business_elements: {"companies":["X","Artificial Analysis (@ArtificialAnlys)","Anthropic","Google"],"products":["Claude","GPT-5"],"people":[],"industries":[],"roles":[],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["4","25000","3500","5","1587","4.8","1356","4.7"],"quotes":[]}
evidence_seed: {"company_actions":["Post Log in Sign up Post Artificial Analysis @ArtificialAnlys Announcing AA-Briefcase, the benchmark for the next era of agentic knowledge work AA-Briefcase is our new benchmark for testing models on long-horizon knowledge work tasks in complex projects built by industry experts.","Models are evaluated on multi-week projects, each with many linked tasks and thousands of input source files.","We evaluated Claude Fable 5 from @ AnthropicAI before it became unavailable, and it currently leads with an Elo score of 1587, followed by Claude Opus 4."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":[],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"number","text":"Artificial Analysis 推出新基准 AA-Briefcase，用于评估模型在长期知识工作项目中的智能体能力。基准包含 4 个私有场景（每项目需处理 25000+ Slack 消息、3500+ 邮件等碎片化上下文）及一个公开演示场景。评测结果：Claude Fable 5 以 Elo 1587 领先，其次为 Claude Opus 4.8（1356）、Opus 4.7 及智谱 GLM 5.2（max，1266）。成本方面，Claude Fable 5 平均每任务 $31，Opus 4.8 为 $10.40，GPT-5.5 （xhigh） 为 $3.68，GLM 5.2 （max） 为 $2.40，DeepSeek V4 Flash （max） 仅约 $0.04。所有模型中仅 3% 的任务满足全部标准，31/91 个任务无模型得分超 50%，显示真实世界复杂性仍是挑战。最佳性价比为开源权重模型 GLM-5.2 （max） 和 DeepSeek V4 Pro （max）。","supports":["daily_observation","heatmap","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Post Log in Sign up Post Artificial Analysis @ArtificialAnlys Announcing AA-Briefcase, the benchmark for the next era of agentic knowledge work AA-Briefcase is our new benchmark for testing models on long-horizon knowledge work tasks in complex projects built by industry experts.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Models are evaluated on multi-week projects, each with many linked tasks and thousands of input source files.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"We evaluated Claude Fable 5 from @ AnthropicAI before it became unavailable, and it currently leads with an Elo score of 1587, followed by Claude Opus 4.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"8 (max, 1356), Opus 4.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"product_update","text":"7, and the recently-released GLM 5.","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"}]
...
11:01 PM · Jun 18, 2026 99K Views
...
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 5 4 7 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 547
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 1 7 2 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 172
Read 35 replies
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":5869,"paragraph_count":20,"sentence_count":15,"boilerplate_hits":1,"symbol_ratio":0.0124,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Post Log in Sign up Post Artificial Analysis @ArtificialAnlys Announcing AA-Briefcase, the benchmark for the next era of agentic knowledge work AA-Briefcase is our new benchmark for testing models on long-horizon knowledge work tasks in complex projects built by industry experts.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Models are evaluated on multi-week projects, each with many linked tasks and thousands of input source files.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We evaluated Claude Fable 5 from @ AnthropicAI before it became unavailable, and it currently leads with an Elo score of 1587, followed by Claude Opus 4.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   8 (max, 1356), Opus 4.

6. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   7, and the recently-released GLM 5.

## business_elements

- companies: X, Artificial Analysis (@ArtificialAnlys), Anthropic, Google
...
- numbers: 4, 25000, 3500, 5, 1587, 4.8, 1356, 4.7
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Post Log in Sign up Post Artificial Analysis @ArtificialAnlys Announcing AA-Briefcase, the benchmark for the next era of agentic knowledge work AA-Briefcase is our new benchmark for testing models on long-horizon knowledge work tasks in complex projects built by industry experts. / Models are evaluated on multi-week projects, each with many linked tasks and thousands of input source files. / We evaluated Claude Fable 5 from @ AnthropicAI before it became unavailable, and it currently leads with an Elo score of 1587, followed by Claude Opus 4.
- case_details: 暂无公开信息
