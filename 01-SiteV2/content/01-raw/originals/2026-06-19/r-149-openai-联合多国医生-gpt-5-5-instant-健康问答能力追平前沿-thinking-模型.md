...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-149-openai-联合多国医生-gpt-5-5-instant-健康问答能力追平前沿-thinking-模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
business_elements: {"companies":["X","Greg Brockman (@gdb)","OpenAI"],"products":["GPT-5","ChatGPT"],"people":[],"industries":["医疗"],"roles":[],"workflows":[],"business_actions":["合作 / 联盟"],"affected_departments":[],"numbers":["5.5","60","49","26","2.3 亿"],"quotes":[]}
...
- numbers: 5.5, 60, 49, 26, 2.3 亿
- quotes: 暂无公开信息

## evidence_seed

- company_actions: OpenAI 与全球 60 个国家、49 种语言、26 个专科的数百名医生合作，通过医生主导的评估大幅提升了 GPT-5. / 5 Instant 在健康相关问题的智能水平，现已能与公司前沿 Thinking 模型（推理模型）相当。 / 由于面向所有 ChatGPT 免费用户开放，这些改进可惠及更多人。
- case_details: 暂无公开信息
