...
raw_id: R-051
title: "Amazon Bedrock AgentCore harness is now generally available: Go from idea to production-grade agent in minutes | Artificial Intelligence"
...
canonical_url: "https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-agentcore-harness-is-now-generally-available-go-from-idea-to-production-grade-agent-in-minutes"
...
author: ""
published_at: ""
collected_at: 2026-06-19T07:43:57.602Z
language: mixed
full_text_hash: 3010a08cfaac1902
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-051-amazon-bedrock-agentcore-harness-is-now-generally-available-go-from-id.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-19/r-051-amazon-bedrock-agentcore-harness-is-now-generally-available-go-from-id.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":26555,"paragraph_count":166,"sentence_count":186,"boilerplate_hits":0,"symbol_ratio":0.0045,"method":"content-container"}
has_full_text: true
content_length: 26555
fetch_error: ""
...
url_hash: 26a7bc5aae6d9bea
content_hash: ee4396fb0929d74b
semantic_hash: 7b972f64cce4bbf2
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-06-19T07:43:57.602Z"
last_seen_at: 2026-06-19T07:43:57.602Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","GitHub","Meta","Amazon","AWS","Mistral"],"products":["agent","agents","Agents","Codex","Claude","MCP","GPT-5","gemini","Gemini","mcp"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["5.5","5.4","30","3","2","3 b","5","4"],"quotes":["agentcore_browser","agentcore_code_interpreter","remote_mcp","remoteMcp","https://mcp.X_tool/mcp"]}
...
Step Functions integration. A harness invocation is now a first-class state in AWS Step Functions . In Workflow St
...
tools : agentcore_browser , plus a Gateway target that exposes Web Search on AgentCore.
skills : a git source pointing at anthropics/skills for the document-skills bundle.
...
Call CreateHarness with environmentArtifact pointing at that image, plus a Gateway target wired to GitHub (or your internal GitLab or Bitbucket equivalent) so the agent can interact with branches, PRs, and reviews.
...
Harness vs Runtime
CreateHarness API – InvokeHarness API
About the authors
Resources
Getting Started
What's New
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":26555,"paragraph_count":166,"sentence_count":186,"boilerplate_hits":0,"symbol_ratio":0.0045,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Skip to Main Content Artificial Intelligence Amazon Bedrock AgentCore harness is now generally available: Go from idea to production-grade agent in minutes A year ago, Simon Willison wrote one of the cleanest definitions of an agent that has stuck around: An LLM agent runs tools in a loop to achieve a goal.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   That definition stuck because it describes what every production agent actually does.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Kiro, Amazon Q Developer, Quick Agents, Codex, Claude Code: under the hood, they all run the same shape.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The agent loop is the common denominator.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   But the loop was never the hard part.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Anthropic, Google, GitHub, Meta, Amazon, AWS, Mistral
- products: agent, agents, Agents, Codex, Claude, MCP, GPT-5, gemini, Gemini, mcp
- people: 暂无公开信息
...
- numbers: 5.5, 5.4, 30, 3, 2, 3 b, 5, 4
- quotes: agentcore_browser / agentcore_code_interpreter / remote_mcp / remoteMcp / https://mcp.X_tool/mcp

## evidence_seed

- company_actions: Skip to Main Content Artificial Intelligence Amazon Bedrock AgentCore harness is now generally available: Go from idea to production-grade agent in minutes A year ago, Simon Willison wrote one of the cleanest definitions of an agent that has stuck around: An LLM agent runs tools in a loop to achieve a goal. / That definition stuck because it describes what every production agent actually does. / Kiro, Amazon Q Developer, Quick Agents, Codex, Claude Code: under the hood, they all run the same shape.
- case_details: When we launched the AgentCore harness in preview in April, we made a bet: the AgentCore primitives (Runtime, Memory, Gateway, Browser, Identity, Observability) already give teams everything they need to run agents in production; what they shouldn’t have to do is wire them up by hand every time. The... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=official_original
