...
raw_id: R-023
title: "Google AI 发布 DiffusionGemma：基于文本扩散的 26B MoE 开源模型，生成速度最高提升 4 倍"
original_url: "https://www.marktechpost.com/2026/06/10/google-ai-releases-diffusiongemma-a-26b-moe-open-model-using-text-diffusion-for-up-to-4x-faster-generation"
canonical_url: "https://marktechpost.com/2026/06/10/google-ai-releases-diffusiongemma-a-26b-moe-open-model-using-text-diffusion-for-up-to-4x-faster-generation"
...
search_path_label: ""
author: ""
published_at: "2026-06-10T18:50:51.000Z"
collected_at: 2026-06-11T01:29:52.718Z
language: mixed
full_text_hash: 1e5c95cae50269c3
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-11/r-023-google-ai-发布-diffusiongemma-基于文本扩散的-26b-moe-开源模型-生成速度最高提升-4-倍.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-11/r-023-google-ai-发布-diffusiongemma-基于文本扩散的-26b-moe-开源模型-生成速度最高提升-4-倍.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":11984,"paragraph_count":117,"sentence_count":144,"boilerplate_hits":2,"symbol_ratio":0.0002,"method":"article"}
has_full_text: true
content_length: 11984
fetch_error: ""
...
discovery_record: {"discovery_title":"Google AI 发布 DiffusionGemma：基于文本扩散的 26B MoE 开源模型，生成速度最高提升 4 倍","discovery_summary":"Google DeepMind 发布实验性开源模型 DiffusionGemma，参数量 26B，采用混合专家（MoE）架构，通过文本扩散（text diffusion）技术实现在 GPU 上最高 4 倍生成速度提升。模型权重已开放。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/10/google-ai-releases-diffusiongemma-a-26b-moe-open-model-using-text-diffusion-for-up-to-4x-faster-generation","discovered_at":"2026-06-11T01:23:43.687Z","rank_on_page":103,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 165bba0eb81fbebc
content_hash: 1e5c95cae50269c3
semantic_hash: c7d4d41b12687a96
duplicate_of: ""
first_seen_at: "2026-06-10T18:50:51.000Z"
last_seen_at: 2026-06-11T01:29:52.718Z
...
business_elements: {"companies":["MarkTechPost（RSS）","Google","GitHub","Nvidia"],"products":[],"people":[],"industries":["开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["26B","4 倍","2.0","4x","3.8B","4 b","4B","256"],"quotes":[]}
...
Interactive &middot; Illustrative
Watch DiffusionGemma Decode in Parallel
This is a conceptual animation of the denoising process &mdash; not live model output. The real model resolves a 256-token canvas, finalizing ~15–20 tokens per forward pass.
Diffusion (parallel)
...
Press Run to start.
Mark tech post
Practitioner-first AI/ML coverage &mdash; deep dives, model releases, and research, decoded for builders.
Use Cases
...
Open Model &middot; Apache 2.0
DiffusionGemma: A Visual Guide
Google DeepMind's 26B open text diffusion model &mdash; what it is and how it works.
...
Multimodal input &mdash; text, image, and video &mdash; generating text output.
...
1 The canvas: the model starts with random placeholder tokens.
2 Iterative refinement: it locks in confident tokens, using them as context.
3 Final polish: the text converges into the output.
...
In-line editing and code infilling &mdash; suited to non-linear text.
Long-context analysis, OCR, and document parsing.
Code generation, tool calling, and agentic workflows.
Constrained generation &mdash; Sudoku rose 0% to 80% after fine-tuning.
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":11984,"paragraph_count":117,"sentence_count":144,"boilerplate_hits":2,"symbol_ratio":0.0002,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Artificial Intelligence AI Infrastructure Technology AI Shorts Applications Editors Pick Language Model Large Language Model Machine Learning New Releases Open Source Software Engineering Staff Tech News Uncategorized Google AI team including the Google DeepMind researchers have just released DiffusionGemma, an experimental open model for text generation.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   It uses text diffusion instead of standard autoregressive decoding.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The model ships under a permissive Apache 2.

5. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Google positions it for devs and researchers exploring speed-critical, interactive local workflows.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Examples include in-line editing, rapid iteration, and generating non-linear text structures.
...
- numbers: 26B, 4 倍, 2.0, 4x, 3.8B, 4 b, 4B, 256
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Artificial Intelligence AI Infrastructure Technology AI Shorts Applications Editors Pick Language Model Large Language Model Machine Learning New Releases Open Source Software Engineering Staff Tech News Uncategorized Google AI team including the Google DeepMind researchers have just released DiffusionGemma, an experimental open model for text generation. / It uses text diffusion instead of standard autoregressive decoding. / The model ships under a permissive Apache 2.
- case_details: 暂无公开信息
- workflow_changes: Google positions it for devs and researchers exploring speed-critical, interactive local workflows.
