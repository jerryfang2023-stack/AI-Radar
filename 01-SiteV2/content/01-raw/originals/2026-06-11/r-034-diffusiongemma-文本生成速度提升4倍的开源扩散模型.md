...
canonical_url: "https://deepmind.google/blog/diffusiongemma-4x-faster-text-generation"
...
search_path_label: ""
author: ""
published_at: "2026-06-10T16:24:11.000Z"
collected_at: 2026-06-11T01:29:52.757Z
language: mixed
full_text_hash: d51edc526eff5520
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-11/r-034-diffusiongemma-文本生成速度提升4倍的开源扩散模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-11/r-034-diffusiongemma-文本生成速度提升4倍的开源扩散模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7904,"paragraph_count":39,"sentence_count":48,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
has_full_text: true
content_length: 7904
fetch_error: ""
...
business_elements: {"companies":["Google DeepMind","Blog（RSS）","Google","Nvidia","Apple"],"products":["Gemini","Agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["4倍","256","26B","3.8B","18","100","1000","5090"],"quotes":["keystroke."]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7904,"paragraph_count":39,"sentence_count":48,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
...
2. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   DiffusionGemma: 4x faster text generation Jun 10, 2026 Share x.

3. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   com Facebook LinkedIn Mail Copy link Our newest open experimental model delivers up to 4x faster inference on dedicated GPUs and opens the door to exploring speed-critical, interactive local workflows.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Brendan O'Donoghue Research Scientist Sebastian Flennerhag Research Scientist Share x.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   com Facebook LinkedIn Mail Copy link Today, we’re introducing DiffusionGemma, an experimental open model that explores text diffusion, an exceptionally fast approach to text generation.

6. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Released under an Apache 2.

## business_elements

- companies: Google DeepMind, Blog（RSS）, Google, Nvidia, Apple
...
- company_actions: Brendan O'Donoghue Research Scientist Sebastian Flennerhag Research Scientist Share x. / com Facebook LinkedIn Mail Copy link Today, we’re introducing DiffusionGemma, an experimental open model that explores text diffusion, an exceptionally fast approach to text generation. / Released under an Apache 2.
- case_details: 暂无公开信息
