...
original_url: "https://techcrunch.com/2026/05/20/sam-altman-makes-mic-drop-offer-to-every-y-combinator-startup/"
canonical_url: "https://techcrunch.com/2026/05/20/sam-altman-makes-mic-drop-offer-to-every-y-combinator-startup"
...
author: ""
published_at: ""
collected_at: 2026-06-11T01:29:53.008Z
language: mixed
full_text_hash: d7c19f0228a4d017
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-11/r-131-sam-altman-makes-mic-drop-offer-to-every-y-combinator-startup.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-11/r-131-sam-altman-makes-mic-drop-offer-to-every-y-combinator-startup.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5873,"paragraph_count":40,"sentence_count":43,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 5873
fetch_error: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"d7c19f0228a4d017","missing":[]}
...
url_hash: 232a41db8799e619
content_hash: d7c19f0228a4d017
semantic_hash: 18757edcf23eb0f9
duplicate_of: ""
first_seen_at: "2026-06-11T01:29:53.008Z"
last_seen_at: 2026-06-11T01:29:53.008Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","Microsoft","Apple"],"products":["Claude"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","合作 / 联盟","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["7%","$500","000","2","23","20","2026","$2 million"],"quotes":["mic drop moment.","uncapped SAFE,","it will convert in the next priced round, which is typically the Series A,"]}
evidence_seed: {"company_actions":["Y Combinator already takes a 7% stake for a $500,000 cash investment in its standard deal. In exchange, startups get access to YC's powerful ... / query=YC AI startup funding vertical AI / intent=find_market_trend / path=a_media_gdelt","Image Credits: Kyle Grillot/Bloomberg / Getty Images Venture Sam Altman makes ‘mic drop’ offer to every Y Combinator startup Julie Bort 2:23 PM PDT · May 20, 2026 During a Y Combinator event on Tuesday night, Sam Altman had what YC partner Tyler Bosmeny called a “mic drop moment.","In other words, he promised that OpenAI would invest in the whole class, not with cash but with an allotment of AI tokens that startups can use to build their products."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"funding","text":"Y Combinator already takes a 7% stake for a $500,000 cash investment in its standard deal. In exchange, startups get access to YC's powerful ... / query=YC AI startup funding vertical AI / intent=find_market_trend / path=a_media_gdelt","supports":["daily_observation","heatmap","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Image Credits: Kyle Grillot/Bloomberg / Getty Images Venture Sam Altman makes ‘mic drop’ offer to every Y Combinator startup Julie Bort 2:23 PM PDT · May 20, 2026 During a Y Combinator event on Tuesday night, Sam Altman had what YC partner Tyler Bosmeny called a “mic drop moment.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"number","text":"” Altman offered $2 million worth of OpenAI tokens to every startup in the current class in exchange for equity in the startup.","supports":["daily_observation","heatmap","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"In other words, he promised that OpenAI would invest in the whole class, not with cash but with an allotment of AI tokens that startups can use to build their products.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"i am excited to see what will happen with tokenmaxxing startups, both for how they work internally and the products they can build.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"number","text":"openai offered to invest $2M in tokens into every startup in the current yc batch.","supports":["daily_observation","heatmap","case","trend"],"importance":"high","confidence":"high"}]
...
&mdash; Sam Altman (@sama) May 20, 2026
...
Topics
OpenAI , sam altman , Startups , Venture , Y Combinator
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5873,"paragraph_count":40,"sentence_count":43,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
1. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   Y Combinator already takes a 7% stake for a $500,000 cash investment in its standard deal. In exchange, startups get access to YC's powerful ... / query=YC AI startup funding vertical AI / intent=find_market_trend / path=a_media_gdelt

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Image Credits: Kyle Grillot/Bloomberg / Getty Images Venture Sam Altman makes ‘mic drop’ offer to every Y Combinator startup Julie Bort 2:23 PM PDT · May 20, 2026 During a Y Combinator event on Tuesday night, Sam Altman had what YC partner Tyler Bosmeny called a “mic drop moment.
...
- numbers: 7%, $500, 000, 2, 23, 20, 2026, $2 million
- quotes: mic drop moment. / uncapped SAFE, / it will convert in the next priced round, which is typically the Series A,
