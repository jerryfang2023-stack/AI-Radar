...
original_url: "https://www.marktechpost.com/2026/06/08/google-research-adds-agentic-rag-to-gemini-enterprise-agent-platform-with-a-sufficient-context-agent-for-multi-hop-queries"
canonical_url: "https://marktechpost.com/2026/06/08/google-research-adds-agentic-rag-to-gemini-enterprise-agent-platform-with-a-sufficient-context-agent-for-multi-hop-queries"
...
search_path_label: ""
author: ""
published_at: "2026-06-08T08:25:51.000Z"
collected_at: 2026-06-09T02:33:36.378Z
language: mixed
full_text_hash: 3346751e321d1d28
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-09/r-005-google-research-为-gemini-enterprise-agent-platform-引入-agentic-rag-与-su.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-09/r-005-google-research-为-gemini-enterprise-agent-platform-引入-agentic-rag-与-su.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":42633,"paragraph_count":340,"sentence_count":106,"boilerplate_hits":2,"symbol_ratio":0.0002,"method":"article"}
has_full_text: true
content_length: 42633
fetch_error: ""
...
discovery_record: {"discovery_title":"Google Research 为 Gemini Enterprise Agent Platform 引入 Agentic RAG 与 Sufficient Context Agent 支持多跳查询","discovery_summary":"Google Research 在 Gemini Enterprise Agent Platform 中推出一个 Agentic RAG 框架。该框架中的 Sufficient Context Agent 会持续重新搜索，直到多跳、多源查询拥有足够的 grounding 来生成回答。相比标准 RAG，该框架将事实准确性最高提升 34%。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/08/google-research-adds-agentic-rag-to-gemini-enterprise-agent-platform-with-a-sufficient-context-agent-for-multi-hop-queries","discovered_at":"2026-06-09T02:25:44.727Z","rank_on_page":380,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 35649cfa0d7a432d
content_hash: ab7f8beb8aae8061
semantic_hash: 79ba459f310aa6c4
duplicate_of: ""
first_seen_at: "2026-06-08T08:25:51.000Z"
last_seen_at: 2026-06-09T02:33:36.378Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Gemini","Agent","agent","agents","Agents","Claude","Cursor","Codex","GPT-5","MCP"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["34%","1","2","3","4","5","8","499b"],"quotes":["What are the specs of the server used in Project X?","not found.","I don’t have enough information.","insufficient context."]}
...
📜→ https://t.co/A8l499bLrj pic.twitter.com/5fZT49j8TL
&mdash; Google Research (@GoogleResearch) June 5, 2026
The benchmark case
...
Michal Sutter
Google AI Just Released Nano-Banana 2: The New AI Model Featuring Advanced Subject Consistency and Sub-Seco
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":42633,"paragraph_count":340,"sentence_count":106,"boilerplate_hits":2,"symbol_ratio":0.0002,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Editors Pick Agentic AI Technology Artificial Intelligence New Releases RAG Google Research team has introduced a new agentic RAG framework.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   It is built into the Gemini Enterprise Agent Platform.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   It powers a feature called Cross-Corpus Retrieval, now in public preview.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The target is a known failure mode in enterprise search.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Standard single-step RAG was not built for multi-source, multi-hop queries.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Nvidia, Cursor, Perplexity
- products: Gemini, Agent, agent, agents, Agents, Claude, Cursor, Codex, GPT-5, MCP
- people: 暂无公开信息
...
- numbers: 34%, 1, 2, 3, 4, 5, 8, 499b
- quotes: What are the specs of the server used in Project X? / not found. / I don’t have enough information. / insufficient context.

## evidence_seed

- company_actions: Editors Pick Agentic AI Technology Artificial Intelligence New Releases RAG Google Research team has introduced a new agentic RAG framework. / It is built into the Gemini Enterprise Agent Platform. / It powers a feature called Cross-Corpus Retrieval, now in public preview.
- case_details: 暂无公开信息
