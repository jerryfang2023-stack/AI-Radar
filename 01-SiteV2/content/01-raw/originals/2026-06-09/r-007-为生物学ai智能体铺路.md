...
canonical_url: "https://anthropic.com/research/agents-in-biology"
...
search_path_label: ""
author: ""
published_at: "2026-06-08T17:46:10.323Z"
collected_at: 2026-06-09T02:33:36.390Z
language: mixed
full_text_hash: 502ca2869859cb5e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-09/r-007-为生物学ai智能体铺路.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-09/r-007-为生物学ai智能体铺路.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":23286,"paragraph_count":58,"sentence_count":145,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"content-container"}
has_full_text: true
content_length: 23286
fetch_error: ""
...
discovery_record: {"discovery_title":"为生物学AI智能体铺路","discovery_summary":"一项实验让Claude、Biomni、Edison Analysis、GPT等科研智能体从病毒学数据库NCBI Virus中检索序列数据，即使最强模型也无法稳定达到可靠数据集构建所需的准确率。加入确定性检索层gget virus后，准确率接近100%。研究指出，当前生物学数据基础设施存在碎片化、格式特殊、接口不统一等问题，导致AI智能体难以像在软件领域那样高效工作。确定性检索工具是实现可靠智能体工作流的关键，生物学数据库需为智能体作为规模化用户而设计。","source_name":"Anthropic：Research（发表成果 · 网页）","origin_url":"https://www.anthropic.com/research/agents-in-biology","discovered_at":"2026-06-09T02:25:44.699Z","rank_on_page":225,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: b18380cc4244e351
content_hash: 9e52feb88c903ec5
semantic_hash: 8e38139c397fe43c
duplicate_of: ""
first_seen_at: "2026-06-08T17:46:10.323Z"
last_seen_at: 2026-06-09T02:33:36.390Z
...
business_elements: {"companies":["Anthropic","Research（发表成果 · 网页）","GitHub"],"products":["Claude","agents","agent","GPT-5","Agents"],"people":[],"industries":["金融 / 保险","医疗","开发者工具"],"roles":[],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全"],"numbers":["100%","8","2026","1","2","3","14","13 b"],"quotes":["The code was the easiest part! Most of the work was in the browser, clicking things.","go to this URL, click on this dropdown.","the right answer"]}
...
When we gave the agents access to gget virus , accuracy rose above 90% for all agents, peaking at 99.7% for GPT-5.5. Run-to-run variability was largely eliminated, and the performance gap between models narrowed dramatically. In other words, adding a deterministic retrieval layer made model choice much less important . This is especially consequ
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":23286,"paragraph_count":58,"sentence_count":145,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Paving the way for agents in biology \ Anthropic Science Paving the way for agents in biology Jun 8, 2026 Written by Laura Luebbert.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Based on research by Ferdous Nasri, Sarah Gurev, Patrick Varilly, Krithik Ramesh, Nuala A.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   O’Leary, Jonah Cool, Bernhard Y.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Renard, Pardis Sabeti, and Laura Luebbert.

6. **opinion**｜supports=daily_observation, heatmap, viewpoint｜importance=high｜confidence=high
   In this post, Laura Luebbert argues that we need to make biological data infrastructure more agent-friendly.

## business_elements

- companies: Anthropic, Research（发表成果 · 网页）, GitHub
- products: Claude, agents, agent, GPT-5, Agents
- people: 暂无公开信息
...
- numbers: 100%, 8, 2026, 1, 2, 3, 14, 13 b
- quotes: The code was the easiest part! Most of the work was in the browser, clicking things. / go to this URL, click on this dropdown. / the right answer

## evidence_seed

- company_actions: Paving the way for agents in biology \ Anthropic Science Paving the way for agents in biology Jun 8, 2026 Written by Laura Luebbert. / Based on research by Ferdous Nasri, Sarah Gurev, Patrick Varilly, Krithik Ramesh, Nuala A. / O’Leary, Jonah Cool, Bernhard Y.
- case_details: 暂无公开信息
