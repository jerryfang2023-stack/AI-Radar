...
canonical_url: "https://anthropic.com/research/making-claude-a-chemist"
...
search_path_label: ""
author: ""
published_at: "2026-06-05T19:33:26.491Z"
collected_at: 2026-06-06T05:51:12.968Z
language: mixed
full_text_hash: bed607075f766b81
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-005-anthropic-让claude成为化学家.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-005-anthropic-让claude成为化学家.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":15746,"paragraph_count":48,"sentence_count":107,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"content-container"}
has_full_text: true
content_length: 15746
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic：让Claude成为化学家","discovery_summary":"Anthropic与顶尖化学家合作，提升Claude在化学领域的实用性。首个白皮书测试Claude在NMR谱图分析上的表现：在20个化合物上，对比Claude Opus 4.7、Opus 4.6、Sonnet 4.6与ChemDraw、MestReNova的正向预测（从结构预测谱图）和反向结构解析（从实验谱图推断结构）能力。所有化合物选自模型训练截止日期后发布的ChemRxiv预印本，以避免选择偏差。","source_name":"Anthropic：Research（发表成果 · 网页）","origin_url":"https://www.anthropic.com/research/making-claude-a-chemist","discovered_at":"2026-06-06T05:39:58.359Z","rank_on_page":130,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: a84b69a41d8d13e8
content_hash: bed607075f766b81
semantic_hash: da017fa0fb0ed43a
duplicate_of: ""
first_seen_at: "2026-06-05T19:33:26.491Z"
last_seen_at: 2026-06-06T05:51:12.968Z
...
business_elements: {"companies":["Anthropic","Research（发表成果 · 网页）"],"products":["Claude","agents","agent"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["20","4.7","4.6","5","2026","1","290 million","15"],"quotes":[]}
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":15746,"paragraph_count":48,"sentence_count":107,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Making Claude a chemist \ Anthropic Science Making Claude a chemist Jun 5, 2026 Summary: We’re working with world-class synthetic, computational, and analytical chemists to make Claude better at chemistry.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   In this post, we share our first work as part of this effort, in which Anthropic chemist, David Kamber, examines how Claude performs on a chemist’s most common analytical input, an NMR spectrum.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   When working with molecules, chemists move between hand-drawn structures on a whiteboard, instrument readouts, database query strings, and the technical notations of patents and publications.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Each of these representations encodes the same underlying chemistry, but each demands a different kind of fluency.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   A sketch of caffeine, for example, allows a chemist to spot its resemblance to adenosine, the body’s drowsiness signal, and predict that it keeps us alert by blocking the receptor.
...
- numbers: 20, 4.7, 4.6, 5, 2026, 1, 290 million, 15
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Anthropic与顶尖化学家合作，提升Claude在化学领域的实用性。首个白皮书测试Claude在NMR谱图分析上的表现：在20个化合物上，对比Claude Opus 4.7、Opus 4.6、Sonnet 4.6与ChemDraw、MestReNova的正向预测（从结构预测谱图）和反向结构解析（从实验谱图推断结构）能力。所有化合物选自模型训练截止日期后发布的ChemRxiv预印本，以避免选择偏差。 / Making Claude a chemist \ Anthropic Science Making Claude a chemist Jun 5, 2026 Summary: We’re working with world-class synthetic, computational, and analytical chemists to make Claude better at chemistry. / In this post, we share our first work as part of this effort, in which Anthropic chemist, David Kamber, examines how Claude performs on a chemist’s most common analytical input, an NMR spectrum.
- case_details: 暂无公开信息
