...
canonical_url: "https://huggingface.co/blog/huggingface/state-of-os-hf-spring-2026"
...
author: ""
published_at: ""
collected_at: 2026-06-06T05:51:13.025Z
language: mixed
full_text_hash: 1fbc4251370cf8cf
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-020-state-of-open-source-on-hugging-face-spring-2026.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-020-state-of-open-source-on-hugging-face-spring-2026.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":19250,"paragraph_count":91,"sentence_count":136,"boilerplate_hits":0,"symbol_ratio":0.0017,"method":"main"}
has_full_text: true
content_length: 19250
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"1fbc4251370cf8cf","missing":[]}
...
url_hash: c52b08d09cf89e2c
content_hash: 0955531965344cf6
semantic_hash: a147d070098b3b69
duplicate_of: ""
first_seen_at: "2026-06-06T05:51:13.025Z"
last_seen_at: 2026-06-06T05:51:13.025Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Google","GitHub","Meta","Nvidia","Cursor"],"products":["Cursor"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["2026","17","91","85","2025","16","13 million","2 million"],"quotes":["Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem","Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem","DeepSeek Moment","public money, public code","The Brief and Wondrous Life of Open Models"]}
evidence_seed: {"company_actions":["This post examines how the open source AI landscape has shifted across competition, geography, technical trends, and emerging communities ... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=developer_ecosystem","Back to Articles State of Open Source on Hugging Face: Spring 2026 Team Article Published March 17, 2026 Upvote 91 +85 Avijit Ghosh evijit Follow huggingface Lucie-Aimée Kaffee frimelle Follow huggingface Yacine Jernite yjernite Follow huggingface Irene Solaiman irenesolaiman Follow huggingface This post examines how the open source AI landscape has shifted across competition, geography, technical trends, and emerging communities over the past year.","We primarily examine community activity on Hugging Face across many types of metrics to give a holistic view of the ecosystem."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"product_update","text":"This post examines how the open source AI landscape has shifted across competition, geography, technical trends, and emerging communities ... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=developer_ecosystem","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Back to Articles State of Open Source on Hugging Face: Spring 2026 Team Article Published March 17, 2026 Upvote 91 +85 Avijit Ghosh evijit Follow huggingface Lucie-Aimée Kaffee frimelle Follow huggingface Yacine Jernite yjernite Follow huggingface Irene Solaiman irenesolaiman Follow huggingface This post examines how the open source AI landscape has shifted across competition, geography, technical trends, and emerging communities over the past year.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"We primarily examine community activity on Hugging Face across many types of metrics to give a holistic view of the ecosystem.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"This post builds on an earlier analysis conducted mid-2025, available here , which examined what the Hugging Face Community is building.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"We recommend reading additional perspectives on the open source ecosystem in and outside of Hugging Face from the Data Provenance Initiative , Interconnects , OpenRouter and a16z , and MIT and the Linux Foundation .","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"As the Hugging Face ecosystem is distributed, analyses are a combination of Hugging Face and community members' work, each of which is appropriately credited.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"}]
...
The growth of sub-communities in robotics and science suggests that open source AI is expanding beyond language and image generation into the physical and experimental domains.
...
PaperVerse Explorer
😻
Research Paper Stats on Hugging Face
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":19250,"paragraph_count":91,"sentence_count":136,"boilerplate_hits":0,"symbol_ratio":0.0017,"method":"main"}
...
1. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   This post examines how the open source AI landscape has shifted across competition, geography, technical trends, and emerging communities ... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=developer_ecosystem

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Back to Articles State of Open Source on Hugging Face: Spring 2026 Team Article Published March 17, 2026 Upvote 91 +85 Avijit Ghosh evijit Follow huggingface Lucie-Aimée Kaffee frimelle Follow huggingface Yacine Jernite yjernite Follow huggingface Irene Solaiman irenesolaiman Follow huggingface This post examines how the open source AI landscape has shifted across competition, geography, technical trends, and emerging communities over the past year.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We primarily examine community activity on Hugging Face across many types of metrics to give a holistic view of the ecosystem.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   This post builds on an earlier analysis conducted mid-2025, available here , which examined what the Hugging Face Community is building.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We recommend reading additional perspectives on the open source ecosystem in and outside of Hugging Face from the Data Provenance Initiative , Interconnects , OpenRouter and a16z , and MIT and the Linux Foundation .
...
- companies: keyword search, Anysearch, OpenAI, Google, GitHub, Meta, Nvidia, Cursor
- products: Cursor
- people: 暂无公开信息
...
- numbers: 2026, 17, 91, 85, 2025, 16, 13 million, 2 million
- quotes: Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem / Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem / DeepSeek Moment / public money, public code / The Brief and Wondrous Life of Open Models
