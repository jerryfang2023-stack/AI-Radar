...
original_url: "https://github.blog/news-insights/product-news/github-copilot-app-the-agent-native-desktop-experience/"
canonical_url: "https://github.blog/news-insights/product-news/github-copilot-app-the-agent-native-desktop-experience"
...
author: ""
published_at: ""
collected_at: 2026-06-07T04:07:12.335Z
language: mixed
full_text_hash: 5ebd5462c7f87d52
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-012-github-copilot-app-the-agent-native-desktop-experience-the-github-blog.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-012-github-copilot-app-the-agent-native-desktop-experience-the-github-blog.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":9852,"paragraph_count":44,"sentence_count":92,"boilerplate_hits":0,"symbol_ratio":0.0003,"method":"content-container"}
has_full_text: true
content_length: 9852
fetch_error: ""
...
url_hash: 2c0fce60ab472910
content_hash: 5ebd5462c7f87d52
semantic_hash: fb387490cd63c4b0
duplicate_of: ""
first_seen_at: "2026-06-07T04:07:12.335Z"
last_seen_at: 2026-06-07T04:07:12.335Z
...
business_elements: {"companies":["keyword search","Anysearch","Microsoft","GitHub"],"products":["Copilot","agent","agents","Agent","Agents","MCP"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2","2026","8 m","1.4 billion","2 billion"],"quotes":[]}
...
8 minutes
Share:
While the agentic shift has made development faster, it&rsquo;s also led to disjointed workflows, more context switching, and too much time spent reviewing agent-generated code.
If agents are going to be a durable part of how software gets built, they need a real place in the developer workflow. Yet most developer tools were not designed for directing multiple agents in parallel. Context scatters across windows. You lose track of what&rsquo;s running. Code lands in pull requests without a clear trail of what the agent tried, what it validated, or where human judgment is needed.
...
GitHub is building that system for the agentic frontier, and that&rsquo;s what we&rsquo;re showing today at Microsoft Build.
...
Today, we&rsquo;re also introducing canvases in the GitHub Copilot app . Canvases are bidirectional work surfaces for humans and agents. A canvas might show a plan, pull request, browser session, terminal, deployment, dashboard, or workflow state. Agents update the canvas as they work, and developers can edit, reorder, approve, or redirect that work on the same surface.
...
Cloud and local sandboxes for GitHub Copilot give agents a bounded place to act. Choose where Copilot runs&mdash;on your local machine or in the cloud&mdash;and begin unlocking agent-driven workflows while prioritizing security and enterprise policy enforcement, and without local resource constraints.
...
Copilot code review now offers medium tier review , which routes pull requests to a higher-reasoning model for better precision and recall. Admins can set guidelines for individual repositories to &ldquo;low&rdquo; or &ldquo;medium.&rdquo; This lets you assign lighter, cost-efficient models for low-risk code and save more robust model use for repos with higher impact.
...
And if you&rsquo;re working on Azure DevOps, you can now use Copilot code review natively . Get the same one-click review, inline comments, and committable fix suggestions you expect, and admins can enable code review on whichever repos they want.
...
Engineering doesn&rsquo;t end with writing code. It includes filing the issue, kicking off the discussion, and replying to reviewers. Copilot cloud agent can now handle every one of those steps.
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9852,"paragraph_count":44,"sentence_count":92,"boilerplate_hits":0,"symbol_ratio":0.0003,"method":"content-container"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   GitHub Copilot app: The agent-native desktop experience - The GitHub Blog | Get started with the GitHub Copilot app today using your existing Copilot Pro, Pro+, Business, or Enterprise plan. Learn more > | | --- | GitHub is building that system for the agentic frontier, and that’s what we’re showi..... / query=open-source AI agent GitHub enterprise adoption / intent=find_customer_case / path=official_original

2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Mario Rodriguez · @mariorod June 2, 2026 8 minutes Share: While the agentic shift has made development faster, it&rsquo;s also led to disjointed workflows, more context switching, and too much time spent reviewing agent-generated code.
...
6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   You lose track of what&rsquo;s running.

## business_elements

- companies: keyword search, Anysearch, Microsoft, GitHub
- products: Copilot, agent, agents, Agent, Agents, MCP
- people: 暂无公开信息
...
- numbers: 2, 2026, 8 m, 1.4 billion, 2 billion
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Yet most developer tools were not designed for directing multiple agents in parallel. / Context scatters across windows. / You lose track of what&rsquo;s running.
- case_details: GitHub Copilot app: The agent-native desktop experience - The GitHub Blog | Get started with the GitHub Copilot app today using your existing Copilot Pro, Pro+, Business, or Enterprise plan. Learn more > | | --- | GitHub is building that system for the agentic frontier, and that’s what we’re showi..... / query=open-source AI agent GitHub enterprise adoption / intent=find_customer_case / path=official_original
- workflow_changes: Mario Rodriguez · @mariorod June 2, 2026 8 minutes Share: While the agentic shift has made development faster, it&rsquo;s also led to disjointed workflows, more context switching, and too much time spent reviewing agent-generated code. / If agents are going to be a durable part of how software gets built, they need a real place in the developer workflow.
