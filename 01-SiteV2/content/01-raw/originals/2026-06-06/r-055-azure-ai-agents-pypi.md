...
raw_id: R-055
title: "azure-ai-agents - PyPI"
original_url: "https://pypi.org/project/azure-ai-agents/"
canonical_url: "https://pypi.org/project/azure-ai-agents"
...
author: ""
published_at: ""
collected_at: 2026-06-07T04:07:12.790Z
language: mixed
full_text_hash: 0706b4e656344048
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-055-azure-ai-agents-pypi.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-055-azure-ai-agents-pypi.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":46291,"paragraph_count":636,"sentence_count":446,"boilerplate_hits":1,"symbol_ratio":0.0269,"method":"main"}
has_full_text: true
content_length: 46291
fetch_error: ""
...
url_hash: b610367358f80687
content_hash: 33a281c62b38251e
semantic_hash: 75cfdd1d6f4350ae
duplicate_of: ""
first_seen_at: "2026-06-07T04:07:12.790Z"
last_seen_at: 2026-06-07T04:07:12.790Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Microsoft","GitHub","Meta"],"products":["agents","Agents","Agent","agent","AGENTS","AGENT"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["1.1","0","5","2025\nM","3.9","3","3.10","3.11"],"quotes":["azure-ai-agents","Project details","Access Control (IAM)","Your Subscription ID or Name","PROJECT_ENDPOINT"]}
...
For examples of automatic function calls in action, refer to sample_agents_auto_function_call.py or sample_agents_auto_function_call_async.py .
If you prefer to manage function execution manually, refer to sample_agents_stream_eventhandler_with_functions.py or
sample_agents_functions.py .
...
return
Important: Both input and output payloads mu
...
Place the following style message manually into the input queue ( input ):
"location": "Seattle",
"CorrelationId": "42"
...
As you can see, this SDK parses the events and produces various event types similar to OpenAI agents. In your use case, you might not be interested in handling all these types and may decide to parse the events on your own. To achieve this, please refer to override base event handler .
...
Platform
any
azure_ai_agents-1.1.0-py3-none-any.whl
(191.1 kB
view details )
Uploaded
Aug 5, 2025
Python 3
File details
Details for the file azure_ai_agents-1.1.0.tar.gz .
File metadata
Download URL: azure_ai_agents-1.1.0.tar.gz
Upload date:
Aug 5, 2025
Size: 303.7 kB
Tags: Source
...
File hashes
Hashes for azure_ai_agents-1.1.0.tar.gz
Algorithm
Hash digest
SHA256
eb9d7226282d03206c3fab3f3ee0a2fc71e0ad38e52d2f4f19a92c56ed951aea
Copy
MD5
a4a4c8bd818ec095e1ab16ca4f6496c3
Copy
BLAKE2b-256
3998bbe2e9e5b0a934be1930545025bf7018ebc4cc33b10134cc3314d6487076
Copy
See more details on using hashes here.
File details
Details for the file azure_ai_agents-1.1.0-py3-none-any.whl .
File metadata
Download URL: azure_ai_agents-1.1.0-py3-none-any.whl
Upload date:
Aug 5, 2025
Size: 191.1 kB
Tags: Python 3
...
Uploaded via: RestSharp/106.13.0.0
File hashes
Hashes for azure_ai_agents-1.1.0-py3-none-any.whl
Algorithm
Hash digest
SHA256
f660bb0d564aeb88e33140ebc1e4700d2e36e2e12ee60c3346915d702a9310a9
Copy
MD5
89f409e540e81210dbe491b10573c6b3
Copy
BLAKE2b-256
e63143750555bf20d3d2d7589fcd775c96ce7c96e58e208b81c1ed6d4bad6c5f
Copy
See more details on using hashes here.
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":46291,"paragraph_count":636,"sentence_count":446,"boilerplate_hits":1,"symbol_ratio":0.0269,"method":"main"}
...
1. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   The Azure AI Agents Service enables the building of Agents for a wide range of generative AI use cases. Note: While this package can be used independently, we ... / query=AI Agent funding enterprise customers / intent=find_startups / path=developer_ecosystem
...
3. **product_update**｜supports=daily_observation, heatmap, change｜importance=medium｜confidence=high
   0 pip install azure-ai-agents Copy PIP instructions Latest release Released: Aug 5, 2025 Microsoft Corporation Azure AI Agents Client Library for Python Navigation Verified details These details have been verified by PyPI Maintainers azure-sdk microsoft Unverified details These details have not been verified by PyPI Project links Homepage Meta License: MIT License (MIT License) Author: Microsoft Corporation Tags azure azure sdk Requires: Python >=3.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   9 Classifiers Development Status 5 - Production/Stable License OSI Approved :: MIT License Programming Language Python Python :: 3 Python :: 3 :: Only Python :: 3.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   12 Report project as malware Project description Azure AI Agents client library for Python Use the AI Agents client library to: Develop Agents using the Azure AI Agents Service , leveraging an extensive ecosystem of models, tools, and capabilities from OpenAI, Microsoft, and other LLM providers.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   The Azure AI Agents Service enables the building of Agents for a wide range of generative AI use cases.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Microsoft, GitHub, Meta
- products: agents, Agents, Agent, agent, AGENTS, AGENT
- people: 暂无公开信息
...
- numbers: 1.1, 0, 5, 2025
M, 3.9, 3, 3.10, 3.11
- quotes: azure-ai-agents / Project details / Access Control (IAM) / Your Subscription ID or Name / PROJECT_ENDPOINT

## evidence_seed

- company_actions: The Azure AI Agents Service enables the building of Agents for a wide range of generative AI use cases. Note: While this package can be used independently, we ... / query=AI Agent funding enterprise customers / intent=find_startups / path=developer_ecosystem / azure-ai-agents 1. / 0 pip install azure-ai-agents Copy PIP instructions Latest release Released: Aug 5, 2025 Microsoft Corporation Azure AI Agents Client Library for Python Navigation Verified details These details have been verified by PyPI Maintainers azure-sdk microsoft Unverified details These details have not been verified by PyPI Project links Homepage Meta License: MIT License (MIT License) Author: Microsoft Corporation Tags azure azure sdk Requires: Python >=3.
- case_details: 暂无公开信息
