...
original_url: "https://this.weekinsecurity.com/meta-confirms-thousands-of-instagram-accounts-were-hacked-by-abusing-its-ai-chatbot"
canonical_url: "https://this.weekinsecurity.com/meta-confirms-thousands-of-instagram-accounts-were-hacked-by-abusing-its-ai-chatbot"
...
search_path_label: ""
author: ""
published_at: "2026-06-06T20:43:43.980Z"
collected_at: 2026-06-07T04:07:12.451Z
language: mixed
full_text_hash: 92fdbdcd22d60860
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-022-meta证实-数千个instagram账户因其ai聊天机器人遭滥用而被黑客入侵.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-022-meta证实-数千个instagram账户因其ai聊天机器人遭滥用而被黑客入侵.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":79,"text_length":5544,"paragraph_count":32,"sentence_count":39,"boilerplate_hits":6,"symbol_ratio":0.0011,"method":"main"}
has_full_text: true
content_length: 5544
fetch_error: ""
...
discovery_record: {"discovery_title":"Meta证实，数千个Instagram账户因其AI聊天机器人遭滥用而被黑客入侵","discovery_summary":"Meta官方确认，有攻击者通过滥用其AI聊天机器人，入侵了数千个Instagram账户。该消息由this.weekinsecurity.com报道，于当日02：35发布，并在Hacker News上获得120个点赞。Meta的AI聊天机器人此次遭到滥用，导致大量用户账户被黑。目前尚无更多细节披露。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://this.weekinsecurity.com/meta-confirms-thousands-of-instagram-accounts-were-hacked-by-abusing-its-ai-chatbot","discovered_at":"2026-06-07T03:57:17.665Z","rank_on_page":75,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 0c91df883ad3ee89
content_hash: 92fdbdcd22d60860
semantic_hash: 37ab0d4b762b8900
duplicate_of: ""
first_seen_at: "2026-06-06T20:43:43.980Z"
last_seen_at: 2026-06-07T04:07:12.451Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Meta"],"products":[],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["02","35","120","404 M","20","225","30","$10"],"quotes":["a vulnerability in an AI-assisted account recovery system for Instagram,","perform password resets on Instagram user accounts."," said Meta in its breach notice.\n","instructed impacted users to reset their passwords and re-authenticate through secure, verified channels."]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":79,"text_length":5544,"paragraph_count":32,"sentence_count":39,"boilerplate_hits":6,"symbol_ratio":0.0011,"method":"main"}
...
3. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   In a new data breach notification letter , seen by this week in security , Meta has revealed for the first time how many people had their accounts hijacked as part of the long-running hacking campaign, which was discovered earlier this week and first reported by 404 Media ($) and TechCrunch ($) .
...
- numbers: 02, 35, 120, 404 M, 20, 225, 30, $10
- quotes: a vulnerability in an AI-assisted account recovery system for Instagram, / perform password resets on Instagram user accounts. /  said Meta in its breach notice.
 / instructed impacted users to reset their passwords and re-authenticate through secure, verified channels.

## evidence_seed

- company_actions: Meta is notifying thousands of people whose Instagram accounts were hijacked during the months-long abuse of the company's AI chatbot, which hackers repeatedly tricked into taking control of a person's account. / The number of affected accounts gives some clarity as to how widespread this hacking campaign was, and for how long it operated. / According to the data breach notice filed with Maine's attorney general's office late on Friday, Meta notified at least 20,225 people that their accounts had been compromised, including 30 people in Maine.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人
- risks_or_constraints: Meta官方确认，有攻击者通过滥用其AI聊天机器人，入侵了数千个Instagram账户。该消息由this.weekinsecurity.com报道，于当日02：35发布，并在Hacker News上获得120个点赞。Meta的AI聊天机器人此次遭到滥用，导致大量用户账户被黑。目前尚无更多细节披露。
