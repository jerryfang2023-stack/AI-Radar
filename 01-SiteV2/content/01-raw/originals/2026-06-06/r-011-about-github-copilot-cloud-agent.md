...
original_url: "https://docs.github.com/en/copilot/concepts/agents/cloud-agent/about-cloud-agent"
canonical_url: "https://docs.github.com/en/copilot/concepts/agents/cloud-agent/about-cloud-agent"
...
author: ""
published_at: ""
collected_at: 2026-06-07T04:07:12.322Z
language: mixed
full_text_hash: 858550ad52e39624
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-011-about-github-copilot-cloud-agent.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-011-about-github-copilot-cloud-agent.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":13392,"paragraph_count":84,"sentence_count":116,"boilerplate_hits":2,"symbol_ratio":0,"method":"main"}
has_full_text: true
...
url_hash: ebc17186b3d44851
content_hash: 858550ad52e39624
semantic_hash: f5faa05a51b92672
duplicate_of: ""
first_seen_at: "2026-06-07T04:07:12.322Z"
last_seen_at: 2026-06-07T04:07:12.322Z
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":13392,"paragraph_count":84,"sentence_count":116,"boilerplate_hits":2,"symbol_ratio":0,"method":"main"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   # About GitHub Copilot cloud agent Enterprise administrators and organization owners can use Copilot usage metrics to analyze pull request outcomes for pull requests created by Copilot cloud agent. The Copilot usage metrics APIs include pull request lifecycle metrics such as: - The total number o... / query=open-source AI agent GitHub enterprise adoption / intent=find_customer_case / path=official_original

2. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   About GitHub Copilot cloud agent Copilot can research a repository, create an implementation plan, and make code changes on a branch.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   You can review the diff, iterate, and create a pull request when you're ready.
...
- products: Copilot, agent, agents, copilot, MCP, Agents
- people: 暂无公开信息
...
- numbers: 59 m
- quotes: agent mode / nice to have

## evidence_seed

- company_actions: You can review the diff, iterate, and create a pull request when you're ready. / Who can use this feature? / The agent is available in all repositories stored on GitHub, except repositories owned by managed user accounts and where it has been explicitly disabled.
- case_details: # About GitHub Copilot cloud agent Enterprise administrators and organization owners can use Copilot usage metrics to analyze pull request outcomes for pull requests created by Copilot cloud agent. The Copilot usage metrics APIs include pull request lifecycle metrics such as: - The total number o... / query=open-source AI agent GitHub enterprise adoption / intent=find_customer_case / path=official_original / About GitHub Copilot cloud agent Copilot can research a repository, create an implementation plan, and make code changes on a branch. / Copilot cloud agent is available for all paid Copilot plans.
