...
original_url: "https://claude.com/blog/how-anthropic-uses-claude-gtm-engineering"
...
search_path_label: ""
author: ""
published_at: "2026-06-05T18:33:33.089Z"
collected_at: 2026-06-06T05:51:12.989Z
language: mixed
full_text_hash: 4f0233d56556e042
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-009-anthropic销售人员用claude-code重建团队工作流.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-06/r-009-anthropic销售人员用claude-code重建团队工作流.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":9056,"paragraph_count":44,"sentence_count":70,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 9056
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic销售人员用Claude Code重建团队工作流","discovery_summary":"加入Anthropic前从未写过代码的销售成员Jared Sires，利用Claude Code为销售团队开发自动化工具。他创建了内嵌于Gmail的CLAFTS（Claude Drafts），通过Claude API根据客户邮件草拟回复，每天节省2-3小时。该系统基于约4，300行代码（几乎全由Claude Code编写），从Google Drive和Anthropic公开文档提取上下文，并通过网络搜索获取最新产品信息。他还开发了CLAFTS Tones功能，通过模式匹配模仿不同人际关系下写作风格。这些工具已打包为Claude Cowork插件供整个销售团队使用。","source_name":"Claude：Blog（网页）","origin_url":"https://claude.com/blog/how-anthropic-uses-claude-gtm-engineering","discovered_at":"2026-06-06T05:39:58.362Z","rank_on_page":146,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 8fd159d69f024199
content_hash: 4f0233d56556e042
semantic_hash: b8b02ef2e79eb9a6
duplicate_of: ""
first_seen_at: "2026-06-05T18:33:33.089Z"
last_seen_at: 2026-06-06T05:51:12.989Z
...
business_elements: {"companies":["Claude","Blog（网页）","Anthropic","Google","Salesforce"],"products":["Claude","MCP","agent","Agent"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":["发布 / 推出","定价 / 计费变化"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["2","3","4","300","2024","600","700","10"],"quotes":["It was almost impossible to manage my inbox,","And doing outbound on top of that, you don’t really know where to focus.","the most empowering thing I’ve ever experienced.","Having to relay technical documentation to customers is pretty hard, especially here at Anthropic when your products evolve so quickly,","Each day Claude would give me a brief on who I needed to focus on based on how much they were using,"]}
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9056,"paragraph_count":44,"sentence_count":70,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Before joining Anthropic in 2024, Jared Sires had never written a line of code.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   He was a startup account executive.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   As is often the case at fast-growing companies, Jared’s book quickly grew to 600 or 700 accounts.

5. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   With 10 to 15 customer calls a day and an expanding account list, Jared found himself at his desk, answering customer emails until 9 or 10 p.

6. **quote**｜supports=daily_observation, heatmap, viewpoint｜importance=high｜confidence=high
   "It was almost impossible to manage my inbox," he says.

## business_elements

- companies: Claude, Blog（网页）, Anthropic, Google, Salesforce
- products: Claude, MCP, agent, Agent
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 2, 3, 4, 300, 2024, 600, 700, 10
- quotes: It was almost impossible to manage my inbox, / And doing outbound on top of that, you don’t really know where to focus. / the most empowering thing I’ve ever experienced. / Having to relay technical documentation to customers is pretty hard, especially here at Anthropic when your products evolve so quickly, / Each day Claude would give me a brief on who I needed to focus on based on how much they were using,

## evidence_seed

- company_actions: Before joining Anthropic in 2024, Jared Sires had never written a line of code. / He was a startup account executive. / As is often the case at fast-growing companies, Jared’s book quickly grew to 600 or 700 accounts.
- case_details: 加入Anthropic前从未写过代码的销售成员Jared Sires，利用Claude Code为销售团队开发自动化工具。他创建了内嵌于Gmail的CLAFTS（Claude Drafts），通过Claude API根据客户邮件草拟回复，每天节省2-3小时。该系统基于约4，300行代码（几乎全由Claude Code编写），从Google Drive和Anthropic公开文档提取上下文，并通过网络搜索获取最新产品信息。他还开发了CLAFTS Tones功能，通过模式匹配模仿不同人际关系下写作风格。这些工具已打包为Claude Cowork插件供整个销售团队使用。 / With 10 to 15 customer calls a day and an expanding account list, Jared found himself at his desk, answering customer emails until 9 or 10 p.
