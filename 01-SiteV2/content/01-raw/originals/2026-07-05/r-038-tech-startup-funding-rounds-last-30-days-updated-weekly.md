...
author: ""
published_at: ""
collected_at: 2026-07-05T04:56:15.333Z
language: mixed
full_text_hash: 1a90455983195430
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-038-tech-startup-funding-rounds-last-30-days-updated-weekly.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-038-tech-startup-funding-rounds-last-30-days-updated-weekly.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":33861,"paragraph_count":104,"sentence_count":285,"boilerplate_hits":2,"symbol_ratio":0.0031,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 33861
fetch_error: ""
...
url_hash: a100e6c437fa350a
content_hash: fb9e562a980960bf
semantic_hash: dabca7d3cd9a6fac
duplicate_of: ""
first_seen_at: "2026-07-05T04:56:15.333Z"
last_seen_at: 2026-07-05T04:56:15.333Z
update_detected: false
raw_status: pooled
usable_for: {"viewpoint":true,"case":true,"business_change":false,"relationship_graph_input":true,"trend_candidate_context":true,"signal_card_candidate":true,"emerging_pool":true,"user_feedback_pool":false,"watchlist":true}
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","GitHub","Meta","Nvidia","Cursor"],"products":["agents","Claude","Agents","agent","Cursor","Copilot","Codex"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","制造 / 工业","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["30","2026","$480M","$350M","$3B","$150M","$800M","$130M"],"quotes":["human-centric","vibe-coding","full-stack","Constitutional AI","at scale reliability,"]}
...
fact_extraction_completed_at: 2026-07-05T04:56:15.333Z
...
Sygaldry Technologies | raised $105 million in Series A funding. Investors not yet fully disclosed. A developer of quantum-accelerated AI server infrastruct
...
June 2026 Raises
Anthropic | raised $65 billion in a Series H funding round at a $965 billion valuation. Co-led by Altimeter Capital, Dragoneer, Greenoaks, Sequoia Capital, Capital Group, Coatue, and D1 Capital Partners. An AI research and deployment company behind the Claude LLM suite, securing institutional and strategic capital in anticipation of its upcoming initial public offering (IPO).
Ramp | raised $750 million in funding, reaching a $4.4 billion valuation. A financial technology platform offering corporate cards, expense management, and spend automation tools that help businesses reduce costs and streamline financial operations.
DeepSeek | raised $7.4 billion in its first-ever external funding round, reaching a valuation exceeding $50 billion. A prominent Chinese artificial intelligence startup specializing in hyper-efficient frontier large language models, utilizing the massive capital injection to scale its compute cluster infrastructure and directly rival Western AI giants on its own terms.
Fika Jobs | raised $4M in Pre-Seed funding. Led by Luminar Ventures, with participation from Alliance VC and King co-founders Sebastian Knutsson and Riccardo Zacconi. A Stockholm-based video-first hiring platform where AI interview agents (powered by Gemini) conduct ~10-minute interviews and turn responses into shareable video profiles, replacing resumes with a TikTok-style candidate discovery system for employers.
Twenty | raised $100M in Series B at a $1B valuation. Led by Accel, with participation from Friends & Family Capital, Point72 Ventures, and Caffeinated Capital. An Arlington, VA software platform building AI-enabled offensive cyber operations for the U.S. military and intelligence community. An autonomous tactical operating system that maps, targets, and exploits adversary networks at machine speed. Total funding now $138M.
Odyssey | raised $310M in Series B at a $1.45B valuation. Led by Natural Capital, with participation from Amazon, AMD Ventures, GV, EQT, and In-Q-Tel. A Palo Alto AI software lab building general-purpose "world models" — foundation models that simulate physical environments with real-world physics for robotics, gaming, and science applications. AWS is now its preferred cloud partner. Total funding $337M.
Probably | raised $9M in Seed funding from Andreessen Horowitz. Founded by Peter Elias, the company builds a deterministic validation layer that catches and rejects AI hallucinations before they reach users, targeting 99.99% accuracy. Its first product is a data science agent that runs on smaller models by tightly constraining context, with every output backed by citations and an audit trail.
Engram | raised $98M at a $600M valuation. Led by General Catalyst, Kleiner Perkins, and Sequoia Capital, with participation from Factory, Modern, Amplify Partners, Neo, and angels including Andrej Karpathy and Pieter Abbeel. A San Francisco software startup building a "learned memory" layer for enterprise AI. It trains models to internalize organization-specific context, cutting token usage by up to 100x. Already partnered with Microsoft, Notion, and Harvey, with just 13 employees.
Runlayer | raised $30M in Series A. Led by Felicis, with participation from Khosla Ventures, bringing total funding to $42M. A New York enterprise AI governance platform that gives employees a sanctioned way to delegate work to AI agents while giving IT/security teams a single control plane for permissions, cost, and shadow AI detection. Customers include Instacart, Gusto, Decagon, and Opendoor.
Cyera | raised $600M in Series G at a $12B valuation. Led by Evolution Equity Partners, with participation from Cyberstarts, Temasek, Accel, AT&T Ventures, Blackstone, Coatue, and Spark Capital. A New York cybersecurity software platform building the "trust layer" for enterprise AI. Discovers and classifies enterprise data and governs what AI systems and agents can see and act on. ARR has tripled three years running; total funding now exceeds $2.3B.
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":33861,"paragraph_count":104,"sentence_count":285,"boilerplate_hits":2,"symbol_ratio":0.0031,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   Every week, we're rounding up the latest funding moves in tech startups, the big bets, the fast risers, and the stealthy rounds flying under the radar. / query=vertical AI startup funding enterprise agents announced 2026 / intent=find_startups / path=capital_startup
...
2. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   January 2026 Raises Humans& | $480M Seed Round In one of the largest seed rounds in history, alumni from Anthropic, xAI, and Google have secured nearly half a billion dollars.

3. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   Their mission: building "human-centric" AI systems designed for seamless collaboration between humans and machines.
...
4. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   Parloa | $350M Raise ($3B Valuation) The voice automation powerhouse has tripled its valuation in just eight months.

5. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Parloa is now the definitive unicorn for enterprise-scale AI customer service, proving that voice-based AI is the next frontier for CX.
...
6. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   Inferact | $150M Seed ($800M Valuation) The team behind the open-source inference engine vLLM is officially commercializing.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Anthropic, Google, GitHub, Meta, Nvidia, Cursor
- products: agents, Claude, Agents, agent, Cursor, Copilot, Codex
- people: 暂无公开信息
...
- numbers: 30, 2026, $480M, $350M, $3B, $150M, $800M, $130M
- quotes: human-centric / vibe-coding / full-stack / Constitutional AI / at scale reliability,

## evidence_seed

- company_actions: Every week, we're rounding up the latest funding moves in tech startups, the big bets, the fast risers, and the stealthy rounds flying under the radar. / query=vertical AI startup funding enterprise agents announced 2026 / intent=find_startups / path=capital_startup / January 2026 Raises Humans& | $480M Seed Round In one of the largest seed rounds in history, alumni from Anthropic, xAI, and Google have secured nearly half a billion dollars. / Parloa | $350M Raise ($3B Valuation) The voice automation powerhouse has tripled its valuation in just eight months.
- case_details: Parloa is now the definitive unicorn for enterprise-scale AI customer service, proving that voice-based AI is the next frontier for CX.
