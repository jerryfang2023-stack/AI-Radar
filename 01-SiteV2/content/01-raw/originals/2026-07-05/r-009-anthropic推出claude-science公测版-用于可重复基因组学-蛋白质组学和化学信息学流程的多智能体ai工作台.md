...
search_path_label: ""
author: ""
published_at: "2026-07-04T16:21:21.000Z"
collected_at: 2026-07-05T04:56:15.138Z
language: mixed
full_text_hash: 8c5d30d321fff0c2
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-009-anthropic推出claude-science公测版-用于可重复基因组学-蛋白质组学和化学信息学流程的多智能体ai工作台.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-009-anthropic推出claude-science公测版-用于可重复基因组学-蛋白质组学和化学信息学流程的多智能体ai工作台.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":46476,"paragraph_count":380,"sentence_count":132,"boilerplate_hits":2,"symbol_ratio":0.0005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 46476
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic推出Claude Science公测版：用于可重复基因组学、蛋白质组学和化学信息学流程的多智能体AI工作台","discovery_summary":"本周Anthropic推出Claude Science公测版，一款基于现有Claude模型的多智能体AI工作台。通用协调智能体可调用60余个预配置技能和连接器，覆盖基因组学、单细胞、蛋白质组学、结构生物学及化学信息学。用户通过自然语言驱动，系统自动拆分任务、调用专业智能体，并配备审查智能体逐步骤验证引用、数字和图表一致性。所有产出附带完整可审计生成记录。支持本地（macOS/Linux）及远程SSH/HPC环境运行，计算可按需扩展至数百GPU；大型敏感数据无需离开实验室基础设施。该工作台集成NVIDIA BioNeMo工具包，原生调用Evo 2、Boltz-2和OpenFold3。公测用户已用于单细胞RNA测序分析、CRISPR筛选及蛋白质结构预测等场景；UCSF团队借此将germline分析流程时间缩短至原先的十分之一。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/04/anthropic-launches-claude-science-beta","discovered_at":"2026-07-05T04:46:18.995Z","rank_on_page":71,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 9c6efaabad659615
content_hash: f41b0a8ee72aa966
semantic_hash: 158a7591ff11b625
duplicate_of: ""
first_seen_at: "2026-07-04T16:21:21.000Z"
last_seen_at: 2026-07-05T04:56:15.138Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Claude","agent","Agent","agents","MCP","mcp","Agents","GPT-5","Cursor","Gemini"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["60","2","3","20","10","100","1","150"],"quotes":["mcpServers","@lab/eln-mcp-server","ELN_API_KEY","REPLACE_ME"]}
...
fact_extraction_completed_at: 2026-07-05T04:56:15.138Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":46476,"paragraph_count":380,"sentence_count":132,"boilerplate_hits":2,"symbol_ratio":0.0005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   本周Anthropic推出Claude Science公测版，一款基于现有Claude模型的多智能体AI工作台。通用协调智能体可调用60余个预配置技能和连接器，覆盖基因组学、单细胞、蛋白质组学、结构生物学及化学信息学。用户通过自然语言驱动，系统自动拆分任务、调用专业智能体，并配备审查智能体逐步骤验证引用、数字和图表一致性。所有产出附带完整可审计生成记录。支持本地（macOS/Linux）及远程SSH/HPC环境运行，计算可按需扩展至数百GPU；大型敏感数据无需离开实验室基础设施。该工作台集成NVIDIA BioNeMo工具包，原生调用Evo 2、Boltz-2和OpenFold3。公测用户已用于单细胞RNA测序分析、CRISPR筛选及蛋白质结构预测等场景；UCSF团队借此将germline分析流程时间缩短至原先的十分之一。

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Editors Pick Agentic AI Artificial Intelligence Applications Technology Language Model Software Engineering Staff Tech News This week, Anthropic released Claude Science .
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It is an app for scientists, available in beta.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It runs on Anthropic’s existing Claude models, not a new model.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The app targets researchers who juggle databases, notebooks, and cluster terminals.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It runs multi-step research and records how each result was made.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Nvidia, Cursor, Perplexity
- products: Claude, agent, Agent, agents, MCP, mcp, Agents, GPT-5, Cursor, Gemini
- people: 暂无公开信息
...
- numbers: 60, 2, 3, 20, 10, 100, 1, 150
- quotes: mcpServers / @lab/eln-mcp-server / ELN_API_KEY / REPLACE_ME

## evidence_seed

- company_actions: Editors Pick Agentic AI Artificial Intelligence Applications Technology Language Model Software Engineering Staff Tech News This week, Anthropic released Claude Science . / It is an app for scientists, available in beta. / It runs on Anthropic’s existing Claude models, not a new model.
- case_details: 暂无公开信息
- workflow_changes: 本周Anthropic推出Claude Science公测版，一款基于现有Claude模型的多智能体AI工作台。通用协调智能体可调用60余个预配置技能和连接器，覆盖基因组学、单细胞、蛋白质组学、结构生物学及化学信息学。用户通过自然语言驱动，系统自动拆分任务、调用专业智能体，并配备审查智能体逐步骤验证引用、数字和图表一致性。所有产出附带完整可审计生成记录。支持本地（macOS/Linux）及远程SSH/HPC环境运行，计算可按需扩展至数百GPU；大型敏感数据无需离开实验室基础设施。该工作台集成NVIDIA BioNeMo工具包，原生调用Evo 2、Boltz-2和OpenFold3。公测用户已用于单细胞RNA测序分析、CRISPR筛选及蛋白质结构预测等场景；UCSF团队借此将germline分析流程时间缩短至原先的十分之一。
