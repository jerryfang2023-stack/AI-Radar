...
search_path_label: ""
author: ""
published_at: "2026-07-05T02:31:14.000Z"
collected_at: 2026-07-05T04:56:15.265Z
language: mixed
full_text_hash: abb85823100fced7
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-028-qwen前技术负责人lin-混合思考模式冲突-转向智能体思考.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-028-qwen前技术负责人lin-混合思考模式冲突-转向智能体思考.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Qwen前技术负责人Lin：混合思考模式冲突，转向智能体思考","discovery_summary":"Qwen前技术负责人Junyang Lin在演讲和独立研究文章中回顾Qwen系列，指出混合思考模式（thinking mode与instruct mode）在训练中互相冲突，导致模型行为退化。Qwen3采用四阶段后训练（长CoT冷启动、推理RL、思考模式融合）尝试融合，但后续2507版仍分离了Instruct和Thinking变体。Lin认为下一时代是智能体思考（agentic thinking）：模型需决定何时停止思考、调用工具、根据环境反馈修正计划。Qwen3参数范围0.6B-235B，上下文32K/128K，支持119种语言和方言，Apache 2.0许可。Lin总结方向为\"训练模型转向训练智能体\"。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/04/qwens-former-lead-on-what-hybrid-thinking-got-wrong-and-why-he-now-backs-agents","discovered_at":"2026-07-05T04:46:18.979Z","rank_on_page":14,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 5fa81e378611dd58
content_hash: cbc3dfcac47ce875
semantic_hash: b31056e3b9cb7bbd
duplicate_of: ""
first_seen_at: "2026-07-05T02:31:14.000Z"
last_seen_at: 2026-07-05T04:56:15.265Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Nvidia","Cursor","Perplexity"],"products":["Agents","Agent","agents","Gemini","Claude","agent","GPT-5","MCP","Cursor","Codex"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["3","2507","0.6B","235B","32","128","119","2.0"],"quotes":["训练模型转向训练智能体","Training models -> training agents.","Future work","training models -> training agents.","thinking mode fusion"]}
...
fact_extraction_completed_at: 2026-07-05T04:56:15.265Z
...
Michal Sutter
OpenAI Scales Trusted Access for Cyber Defense With GPT-5.4-Cyber: a Fine-Tuned Model Built for Verified Se
...
1. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=high｜confidence=high
   Qwen前技术负责人Junyang Lin在演讲和独立研究文章中回顾Qwen系列，指出混合思考模式（thinking mode与instruct mode）在训练中互相冲突，导致模型行为退化。Qwen3采用四阶段后训练（长CoT冷启动、推理RL、思考模式融合）尝试融合，但后续2507版仍分离了Instruct和Thinking变体。Lin认为下一时代是智能体思考（agentic thinking）：模型需决定何时停止思考、调用工具、根据环境反馈修正计划。Qwen3参数范围0.6B-235B，上下文32K/128K，支持119种语言和方言，Apache 2.0许可。Lin总结方向为"训练模型转向训练智能体"。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Editors Pick Agentic AI AI Agents Staff Junyang Lin was the technical lead of Alibaba’s Qwen project.

3. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   He announced he was stepping down on March 3, 2026 .
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   He now lists himself as an independent researcher on his personal site.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   In a talk titled ‘ Qwen: Towards a Generalist Model / Agent, ‘ he walks through the Qwen family.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It ends on a single line: “Training models -> training agents.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Nvidia, Cursor, Perplexity
- products: Agents, Agent, agents, Gemini, Claude, agent, GPT-5, MCP, Cursor, Codex
- people: 暂无公开信息
...
- numbers: 3, 2507, 0.6B, 235B, 32, 128, 119, 2.0
- quotes: 训练模型转向训练智能体 / Training models -> training agents. / Future work / training models -> training agents. / thinking mode fusion

## evidence_seed

- company_actions: Editors Pick Agentic AI AI Agents Staff Junyang Lin was the technical lead of Alibaba’s Qwen project. / He announced he was stepping down on March 3, 2026 . / He now lists himself as an independent researcher on his personal site.
- case_details: 暂无公开信息
