...
raw_id: R-001
title: "结构化PDF到JSON：2026年开源提取模型指南"
title_zh: "结构化PDF到JSON：2026年开源提取模型指南"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://www.marktechpost.com/2026/07/04/structured-pdf-to-json-a-guide-to-open-source-extraction-models-in-2026"
canonical_url: "https://marktechpost.com/2026/07/04/structured-pdf-to-json-a-guide-to-open-source-extraction-models-in-2026"
...
search_path_label: ""
author: ""
published_at: "2026-07-05T03:02:08.000Z"
collected_at: 2026-07-05T04:56:15.092Z
language: mixed
full_text_hash: 040193158abe1d1e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-001-结构化pdf到json-2026年开源提取模型指南.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-001-结构化pdf到json-2026年开源提取模型指南.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"结构化PDF到JSON：2026年开源提取模型指南","discovery_summary":"开源文档提取分为schema驱动的字段提取和文档结构解析两类。Datalab lift（9B视觉模型，基于Qwen 3.5）在225文档基准上达90.2%字段准确率、9.5秒中位延迟，代码Apache-2.0，权重使用修改版OpenRAIL-M。NuMind推出NuExtract 3（4B视觉语言模型），支持结构化提取和内容提取，通过vLLM提供OpenAI兼容API。IBM Docling（MIT许可）可解析PDF/DOCX/PPTX/HTML等，集成LangChain、LlamaIndex。Granite-Docling-258M在A100上约0.35秒/页（Apache-2.0）。OpenDataLab MinerU改用MinerU开源许可（基于Apache 2.0），支持复杂布局解析。Datalab Marker管道支持PDF/图片/PPTX/DOCX等转Markdown/JSON。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/04/structured-pdf-to-json-a-guide-to-open-source-extraction-models-in-2026","discovered_at":"2026-07-05T04:46:18.978Z","rank_on_page":11,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: d809a8951c0c00d2
content_hash: 9710789f33face70
semantic_hash: fbc242c244674800
duplicate_of: ""
first_seen_at: "2026-07-05T03:02:08.000Z"
last_seen_at: 2026-07-05T04:56:15.092Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","Nvidia","Cursor","Perplexity"],"products":["agents","Gemini","MCP","Agents","Claude","Agent","GPT-5","Cursor","Codex"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["2026","9B","3.5","225","90.2%","9.5","2.0","3"],"quotes":["document.pdf","schema.json","MinerU Open Source License,","contexts optical compression,","PDF to JSON"]}
...
fact_extraction_completed_at: 2026-07-05T04:56:15.092Z
...
Michal Sutter
OpenAI Scales Trusted Access for Cyber Defense With GPT-5.4-Cyber: a Fine-Tuned Mod
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":49296,"paragraph_count":388,"sentence_count":136,"boilerplate_hits":0,"symbol_ratio":0.0004,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Technology Artificial Intelligence Editors Pick Language Model OCR Open Source Software Engineering Staff Top Most enterprise data still sits inside PDFs, scans, and slide decks.
...
- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, Nvidia, Cursor, Perplexity
- products: agents, Gemini, MCP, Agents, Claude, Agent, GPT-5, Cursor, Codex
- people: 暂无公开信息
...
- numbers: 2026, 9B, 3.5, 225, 90.2%, 9.5, 2.0, 3
- quotes: document.pdf / schema.json / MinerU Open Source License, / contexts optical compression, / PDF to JSON

## evidence_seed

- company_actions: Technology Artificial Intelligence Editors Pick Language Model OCR Open Source Software Engineering Staff Top Most enterprise data still sits inside PDFs, scans, and slide decks. / Large language models and agents cannot use that data until it becomes structured JSON. / Open-source document extraction has become the standard way to do that conversion on your own hardware.
- case_details: 暂无公开信息
