...
original_url: "https://lilianweng.github.io/posts/2018-12-27-object-recognition-part-4/"
canonical_url: "https://lilianweng.github.io/posts/2018-12-27-object-recognition-part-4"
...
author: ""
published_at: ""
collected_at: 2026-07-05T02:07:33.242Z
language: mixed
full_text_hash: 619a646c025dde65
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-089-object-detection-part-4-fast-detection-models.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-089-object-detection-part-4-fast-detection-models.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":51863,"paragraph_count":162,"sentence_count":428,"boilerplate_hits":0,"symbol_ratio":0.0235,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"json-ld"}
has_full_text: true
content_length: 51863
fetch_error: ""
...
url_hash: db8f779b6d6306d4
content_hash: 571ad69bcca78379
semantic_hash: d9bd2da0b40ee1db
duplicate_of: ""
first_seen_at: "2026-07-05T02:07:33.242Z"
last_seen_at: 2026-07-05T02:07:33.242Z
...
guanlan_scores: {"importance_type":"important_product_or_service","importance_score":5,"importance_reason":"new product or service; rubric=5 major/platform/industry-shaping","supporting_signals":["adoption_context"],"novelty":2,"evidence_strength":4,"case_richness":5,"trend_relevance":4,"guanlan_relevance":5,"emerging_signal_score":3}
business_elements: {"companies":["Lilian Weng's Blog (OpenAI)","GitHub"],"products":[],"people":[],"industries":[],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究"],"business_actions":[],"affected_departments":["IT / 安全"],"numbers":["4","34","2017","12","31","3","1","2"],"quotes":["You Only Look Once","responsible","responsible","responsible","responsible"]}
...
fact_extraction_completed_at: 2026-07-05T02:07:33.242Z
theme: uncategorized
...
$$ \begin{aligned} b_x &= \sigma(t_x) + c_x\\ b_y &= \sigma(t_y) + c_y\\ b_w &= p_w e^{t_w}\\ b_h &= p_h e^{t_h}\\ \text{Pr}(\text{object}) &\cdot \text{IoU}(b, \text{object}) = \sigma(t_o) \end{aligned} $$ YOLOv2 bounding box location prediction. (Image source: original paper) 6. Add fine-grained features: YOLOv2 adds a passthrough layer to bring fine-grained features from an earlier layer to the last output layer. The mechanism of this passthrough layer is similar to identity mappings in ResNet to extract higher-dimensional features from previous layers. This leads to 1% performance increase.
...
The WordTree hierarchy merges labels from COCO and ImageNet. Blue nodes are COCO labels and red nodes are ImageNet labels. (Image source: original paper) To predict the probability of a class node, we can follow the path from the node to the root:
...
The illustration of the featurized image pyramid module. (Replot based on figure 3 in FPN paper) Two pathways connect conv layers:
...
The RetinaNet model architecture uses a FPN backbone on top of ResNet. (Image source: the FPN paper) YOLOv3 YOLOv3 is created by applying a bunch of design tricks on YOLOv2. The changes are inspired by recent advances in the object detection world.
...
The comparison of various fast object detection models on speed and mAP performance. (Image source: focal loss paper with additional labels from the YOLOv3 paper.) Cited as:
...
- fetch_status: fetched-readable-text-json-ld
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":51863,"paragraph_count":162,"sentence_count":428,"boilerplate_hits":0,"symbol_ratio":0.0235,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"json-ld"}
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   &lt;!-- Part 4 of the &#34;Object Detection for Dummies&#34; series focuses on one-stage models for fast detection, including SSD, RetinaNet, and models in the YOLO family. These models skip the explicit region proposal stage but apply the detection directly on dense sampled areas. --&gt; &lt;p&gt;In &lt;a href=&#34;https://lilianweng.github.io/posts/2017-12-31-object-recognition-part-3/&#34;&gt;Part 3&lt;/a&gt;, we have reviewed models in the R-CNN family. All of them are region-based object de
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Object Detection Part 4: Fast Detection Models In Part 3, we have reviewed models in the R-CNN family.

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   All of them are region-based object detection algorithms.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   They can achieve high accuracy but could be too slow for certain applications such as autonomous driving.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   In Part 3, we have reviewed models in the R-CNN family.
...
- numbers: 4, 34, 2017, 12, 31, 3, 1, 2
- quotes: You Only Look Once / responsible / responsible / responsible / responsible

## evidence_seed

- company_actions: &lt;!-- Part 4 of the &#34;Object Detection for Dummies&#34; series focuses on one-stage models for fast detection, including SSD, RetinaNet, and models in the YOLO family. These models skip the explicit region proposal stage but apply the detection directly on dense sampled areas. --&gt; &lt;p&gt;In &lt;a href=&#34;https://lilianweng.github.io/posts/2017-12-31-object-recognition-part-3/&#34;&gt;Part 3&lt;/a&gt;, we have reviewed models in the R-CNN family. All of them are region-based object de / Object Detection Part 4: Fast Detection Models In Part 3, we have reviewed models in the R-CNN family. / All of them are region-based object detection algorithms.
- case_details: 暂无公开信息
