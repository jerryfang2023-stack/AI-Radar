...
raw_id: R-020
title: "Claude Agent SDK Credits in 2026: What Changes June 15 for ..."
title_zh: ""
title_translation_status: needs_ingestion_translation
title_translation_method: missing_translation_db_entry
original_url: "https://www.totalum.app/blog/claude-agent-sdk-credits-2026"
canonical_url: "https://totalum.app/blog/claude-agent-sdk-credits-2026"
...
author: ""
published_at: ""
collected_at: 2026-07-05T02:07:32.789Z
language: mixed
full_text_hash: 6de98037f1f89983
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-020-claude-agent-sdk-credits-in-2026-what-changes-june-15-for.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-05/r-020-claude-agent-sdk-credits-in-2026-what-changes-june-15-for.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":18190,"paragraph_count":102,"sentence_count":163,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 18190
fetch_error: ""
...
url_hash: f8468c71157f16eb
content_hash: c27a34179849daa3
semantic_hash: 6912e39e2d55ea4c
duplicate_of: ""
first_seen_at: "2026-07-05T02:07:32.789Z"
last_seen_at: 2026-07-05T02:07:32.789Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","GitHub","Cursor"],"products":["Claude","Agent","agent","claude","agents","Agents","MCP","GPT-5","Codex","codex"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["2026","15","16","5","23","$20","5x","$100"],"quotes":["usage credits","messages","very high","$20 of API tokens","Anthropic API at list price"]}
...
fact_extraction_completed_at: 2026-07-05T02:07:32.789Z
theme: targeted-pool-gap-refill
keyword_group: targeted-pool-gap-refill
copyright_note: local research archive only
---

# Claude Agent SDK Credits in 2026: What Changes June 15 for ...
...
Update June 16, 2026 : Anthropic paused the Claude Agent SDK credits program the day it was supposed to ship. The mechanics below are still the announced plan, but the effective date is on hold and there is no replacement program announced yet. See the linked breakdown for what is actually live today.
The original Agent SDK credit changes were paused on June 15, 2026, but a different Anthropic plan-pricing event moved forward as planned: read Claude Fable 5 usage credits required from June 23, 2026 for the live transition and how builders are responding.
Quick Answer
From June 15, 2026, the Claude Agent SDK and claude -p no longer draw from your Claude plan's usage limits. Anthropic's official help-center article confirms the date and scope.
Each paid plan gets a one-time opt-in monthly Agent SDK credit: Pro $20, Max 5x $100, Max 20x $200, Team Standard $20, Team Premium $100, Enterprise usage-based $20 or seat-based Premium $200 .
...
claude -p , the non-interactive headless mode of Claude Code, often used in scripts and CI.
Claude Code GitHub Actions (PR reviews, scheduled jobs, comment triggers).
...
Worth noting on June 13, 2026: the Agent SDK credit pool is unaffected by the Claude Fable 5 suspension that Anthropic announced June 12 after a US government export control directive. Your Agent SDK credit draws against whichever Claude model you call, so the right move is to point your Agent SDK code at Claude Opus 4.8 or Sonnet 4.6 until Fable 5 is restored. The capability-matched fallback table is in the suspension guide.
...
Claude Code in the terminal or IDE when you are typing prompts and the model is replying to you, with no -p flag.
Claude Cowork , the shared workspace.
...
What it buys at API rates (illustrative)
Pro ($20/mo)
$20
≈ 1.3M input + output tokens on Opus 4.8, ≈ 5M on Sonnet 4.6, ≈ 25M on Haiku 4.5
Max 5x ($100/mo)
$100
≈ 6.5M on Opus, ≈ 25M on Sonnet, ≈ 130M on Haiku
Max 20x ($200/mo)
$200
≈ 13M on Opus, ≈ 50M on Sonnet, ≈ 260M on Haiku
Team Standard
$20 per seat
Same as Pro per seat
Team Premium
$100 per seat
Same as Max 5x per seat
Enterprise (usage-based)
$20 per seat
Same as Pro per seat
Enterprise (seat-based Premium)
$200 per seat
Same as Max 20x per seat
...
Audit every place that calls Claude headlessly. Grep your repo for claude -p , any Agent SDK imports, and GitHub Actions workflows that invoke Claude. Note the model used in each.
Migrate routine tasks to cheaper models. Triage, routing, classification, and small refactors that ran on Opus by default should move to Haiku 4.5 or Sonnet 4.6. The Agent SDK credit will stretch 5x to 20x further.
...
June 17, 2026 update: the Agent SDK credit market changed shape
The credit-pool plan covered on this page was paused on June 15 and the credit-pool math has not resumed. In its place, a credible alternative shipped on June 16: GLM 5.2 on the Vercel AI Gateway , with a 1M-token context window, MIT-licensed open weights, and a $10 to $80 per month flat Coding Plan. If your budget assumed the original Anthropic credit pools and they never returned, GLM 5.2 is now the most realistic Claude Code alternative for daily agent use.
Update June 18, 2026: an open-weight alternative just shipped with benchmarks to back it
The originally announced Claude Agent SDK credits program (covered in this article) was paused on June 15. Two days later, on June 17, Z.ai dropped MIT-licensed weights for GLM 5.2 on HuggingFace and published the benchmark scorecard they had withheld at launch. GLM 5.2 leads SWE-bench Pro at 62.1, ahead of GPT-5.5 at 58.6, with 81.0 on Terminal-Bench 2.1 and 76.8 on MCP-Atlas. The Agent SDK credits market has effectively been reshaped by an open-weight model that is competitive on the benchmarks buyers actually trust. Full breakdown in our GLM 5.2 benchmarks and open weights writeup .
FAQ
...
Related posts
AI Coding Agents Claude Code vs Codex in 2026: The Honest Verdict for Developers Shipping Production Code
...
AI Coding Agents Cursor vs Claude Code in 2026: The Honest Verdict for Builders Who Ship
...
AI Coding Agents Claude Agent SDK in 2026: What It Is, When To Use It, and How To Ship It With Totalum
Claude Agent SDK guide for 2026: what it is, when to use it vs claude.ai/MCP/raw API
...
Cursor vs Claude Code in 2026: honest comparison of the AI-native IDE and terminal coding agent. Pricing, token cost, where each wins, when to use both.
AI Coding Agents Claude Agent SDK in 2026: What It Is, When To Use It, and How To Ship It With Totalum
Claude Agent SDK guide for 2026: what it is, when to use it vs claude.ai/MCP/raw API, the June 15 metering change, and how to ship apps with Totalum.
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":18190,"paragraph_count":102,"sentence_count":163,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   On June 15, 2026, the Claude Agent SDK credits system goes live. Anthropic is splitting programmatic Claude usage away from your Pro, Max, Team, ... / query=AI coding agent API SDK release enterprise product update 2026 / intent=find_original_source / path=official_original
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   On June 15, 2026, the Claude Agent SDK credits system goes live.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Anthropic is splitting programmatic Claude usage away from your Pro, Max, Team, or Enterprise subscription limits and putting it on a separate monthly credit pool, billed at Anthropic API rates once you opt in.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   ai and Claude Code in the terminal is unaffected.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Anthropic, GitHub, Cursor
- products: Claude, Agent, agent, claude, agents, Agents, MCP, GPT-5, Codex, codex
- people: 暂无公开信息
...
- numbers: 2026, 15, 16, 5, 23, $20, 5x, $100
- quotes: usage credits / messages / very high / $20 of API tokens / Anthropic API at list price

## evidence_seed

- company_actions: On June 15, 2026, the Claude Agent SDK credits system goes live. Anthropic is splitting programmatic Claude usage away from your Pro, Max, Team, ... / query=AI coding agent API SDK release enterprise product update 2026 / intent=find_original_source / path=official_original / On June 15, 2026, the Claude Agent SDK credits system goes live. / Anthropic is splitting programmatic Claude usage away from your Pro, Max, Team, or Enterprise subscription limits and putting it on a separate monthly credit pool, billed at Anthropic API rates once you opt in.
- case_details: 暂无公开信息
