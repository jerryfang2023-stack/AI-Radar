...
author: ""
published_at: ""
collected_at: 2026-07-03T01:59:31.600Z
language: mixed
full_text_hash: a867978cf0633f3a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-03/r-119-借用夜晚-将闲置推理gpu回收用于研究.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-03/r-119-借用夜晚-将闲置推理gpu回收用于研究.json"
html_snapshot_path: ""
screenshot_path: ""
...
content_hash: a867978cf0633f3a
semantic_hash: 1be844817bc75ae3
duplicate_of: ""
first_seen_at: "2026-07-03T01:59:31.600Z"
last_seen_at: 2026-07-03T01:59:31.600Z
...
business_elements: {"companies":["Runway","News（网页）"],"products":[],"people":[],"industries":["法律 / 法务"],"roles":[],"workflows":[],"business_actions":[],"affected_departments":["IT / 安全","法务"],"numbers":["9","8","30","12","20","60","85%","90%"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-03T01:59:31.600Z
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=medium
   生产流量在北美工作日上午 9 点 ET 达峰，晚 8 点 ET 跌至不足一半。
...
5. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=medium
   利用排队论（Erlang‑C、Little's Law）确定目标利用率，避免接近 85% 后的队列发散（90% 利用率下等待时间约为服务时间的 10 倍）。
...
- company_actions: Runway 开发了名为 deckard 的容量控制器，在生产推理集群与研究集群间动态重分配 GPU。 / 生产流量在北美工作日上午 9 点 ET 达峰，晚 8 点 ET 跌至不足一半。 / 控制器基于预计算的时间窗口（如工作日 8:30–12:30 ET 高峰子窗口）提前扩容和回收，每次集群间转移耗时 20–60 分钟。
- case_details: 暂无公开信息
