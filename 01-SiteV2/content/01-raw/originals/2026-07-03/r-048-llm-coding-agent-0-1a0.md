...
canonical_url: "https://simonwillison.net/2026/Jul/2/llm-coding-agent"
...
search_path_label: ""
author: ""
published_at: "2026-07-02T19:33:12.000Z"
collected_at: 2026-07-03T01:59:31.313Z
language: mixed
full_text_hash: fd5e92e258ea45fb
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-03/r-048-llm-coding-agent-0-1a0.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-03/r-048-llm-coding-agent-0-1a0.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":90,"text_length":3502,"paragraph_count":42,"sentence_count":26,"boilerplate_hits":0,"symbol_ratio":0.0131,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 3502
fetch_error: ""
...
url_hash: 4d3291c25d56323b
content_hash: fd5e92e258ea45fb
semantic_hash: 4471d50e586afdee
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-07-02T19:33:12.000Z"
last_seen_at: 2026-07-03T01:59:31.313Z
...
business_elements: {"companies":["Simon Willison's Blog","OpenAI","GitHub"],"products":["agent","Claude","gpt-5","GPT-5"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":[],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["0.1","0","5","246","5.5","120","600","200"],"quotes":["https://github.com/simonw/llm-coding-agent/releases/tag/0.1a0","https://llm.datasette.io/"," --allow "," .\nIt also presents a Python API based around a CodingAgent(model=",", approve=True).run("]}
...
fact_extraction_completed_at: 2026-07-03T01:59:31.313Z
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":90,"text_length":3502,"paragraph_count":42,"sentence_count":26,"boilerplate_hits":0,"symbol_ratio":0.0131,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   &lt;p&gt;&lt;strong&gt;Release:&lt;/strong&gt; &lt;a href="https://github.com/simonw/llm-coding-agent/releases/tag/0.1a0"&gt;llm-coding-agent 0.1a0&lt;/a&gt;&lt;/p&gt; &lt;p&gt;Another Fable 5 experiment. Now that my &lt;a href="https://llm.datasette.io/"&gt;LLM library&lt;/a&gt; has evolved into more of an agent framework it's time to see what a simple coding agent would look like built on it.&lt;/p&gt; &lt;p&gt;I started a &lt;a href="https://github.com/simonw/llm-coding-agent/tree/246
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Another Fable 5 experiment.

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Now that my LLM library has evolved into more of an agent framework it's time to see what a simple coding agent would look like built on it.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   I started a new Python library using my python-lib-template-repository GitHub template repository, then ran these two prompts (here's the Claude Code for web transcript ): Write a spec.
...
5. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   md for this project - it will depend on the latest “llm” alpha from PyPI and implement a Claude code style coding agent complete with tools for reading and editing files and executing commands Then: Commit the spec, then build it using red/green TDD in a series of sensible commits (each with passing tests and updated docs) - occasionally manually test it using the OpenAI API key in your environment Here's the spec , the resulting README file , and the sequence of commits .
...
6. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=medium｜confidence=high
   I've shipped a slop-alpha to PyPI, so you can run the new agent like this: uvx --prerelease=allow --with llm-coding-agent llm code It's pretty good for a first attempt!

## business_elements

- companies: Simon Willison's Blog, OpenAI, GitHub
- products: agent, Claude, gpt-5, GPT-5
- people: 暂无公开信息
- industries: 开发者工具
- roles: CIO / IT 负责人
- workflows: 暂无公开信息
...
- numbers: 0.1, 0, 5, 246, 5.5, 120, 600, 200
- quotes: https://github.com/simonw/llm-coding-agent/releases/tag/0.1a0 / https://llm.datasette.io/ /  --allow  /  .
It also presents a Python API based around a CodingAgent(model= / , approve=True).run(

## evidence_seed

- company_actions: Another Fable 5 experiment. / Now that my LLM library has evolved into more of an agent framework it's time to see what a simple coding agent would look like built on it. / I started a new Python library using my python-lib-template-repository GitHub template repository, then ran these two prompts (here's the Claude Code for web transcript ): Write a spec.
- case_details: 暂无公开信息
