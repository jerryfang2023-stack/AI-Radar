...
raw_id: R-018
title: "General Analysis raises $10M to build the security arsenal for the agentic era | General Analysis"
title_zh: "General Analysis 融资1000万美元，打造代理时代的安全武器库"
title_translation_status: "translated"
title_translation_method: "source_title_translation_db"
original_url: "https://generalanalysis.com/blog/general-analysis-raises-10m"
canonical_url: "https://generalanalysis.com/blog/general-analysis-raises-10m"
...
author: ""
published_at: ""
collected_at: 2026-07-03T01:59:31.120Z
language: mixed
full_text_hash: 5a32f9e5387762db
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-03/r-018-general-analysis-raises-10m-to-build-the-security-arsenal-for-the-agen.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-03/r-018-general-analysis-raises-10m-to-build-the-security-arsenal-for-the-agen.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5484,"paragraph_count":18,"sentence_count":37,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 5484
fetch_error: ""
...
url_hash: b776a7ca7de1ed97
content_hash: 5a32f9e5387762db
semantic_hash: d699c401bbb221f4
duplicate_of: ""
first_seen_at: "2026-07-03T01:59:31.120Z"
last_seen_at: 2026-07-03T01:59:31.120Z
...
business_elements: {"companies":["keyword search","Anysearch","Nvidia"],"products":["Agent","agent","agents","Agents","MCP"],"people":[],"industries":["开发者工具","企业服务"],"roles":[],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["$10M","645"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-03T01:59:31.120Z
...
# General Analysis raises $10M to build the security arsenal for the agentic era | General Analysis
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5484,"paragraph_count":18,"sentence_count":37,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   General Analysis raises $10M to build the security arsenal for the agentic era | General Analysis Loading page... ## Agent security is an empirical problem Software is interpretable, deterministic, and faithful to its instructions. If software misbehaves, there is a precise explanation lying with... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=capital_startup

2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Agent security is an empirical problem Software is interpretable, deterministic, and faithful to its instructions.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   If software misbehaves, there is a precise explanation lying within the code: a bug that can be patched.

4. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Thanks to these properties, the conversation around software security often begins and ends with architectural constraints and the principle of least privilege.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   But these strengths are also software's biggest limitation.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   AI agents are designed to automate what software cannot: work where the space of possible inputs, actions, and outcomes is too vast and complex to be succinctly described in code.
...
- company_actions: General Analysis raises $10M to build the security arsenal for the agentic era | General Analysis Loading page... ## Agent security is an empirical problem Software is interpretable, deterministic, and faithful to its instructions. If software misbehaves, there is a precise explanation lying with... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=capital_startup / If software misbehaves, there is a precise explanation lying within the code: a bug that can be patched. / But these strengths are also software's biggest limitation.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。
- affected_roles: 暂无公开信息
- risks_or_constraints: Agent security is an empirical problem Software is interpretable, deterministic, and faithful to its instructions. / Thanks to these properties, the conversation around software security often begins and ends with architectural constraints and the principle of least privilege.
