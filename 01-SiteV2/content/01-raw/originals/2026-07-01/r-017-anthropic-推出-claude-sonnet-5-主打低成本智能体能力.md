...
raw_id: R-017
title: "Anthropic 推出 Claude Sonnet 5，主打低成本智能体能力"
original_url: "https://techcrunch.com/2026/06/30/anthropic-launches-claude-sonnet-5-as-a-cheaper-way-to-run-agents"
canonical_url: "https://techcrunch.com/2026/06/30/anthropic-launches-claude-sonnet-5-as-a-cheaper-way-to-run-agents"
...
search_path_label: ""
author: ""
published_at: "2026-06-30T18:00:00.000Z"
collected_at: 2026-07-01T02:33:05.102Z
language: mixed
full_text_hash: 1e31ca9ef2fb6c8c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-017-anthropic-推出-claude-sonnet-5-主打低成本智能体能力.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-017-anthropic-推出-claude-sonnet-5-主打低成本智能体能力.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Anthropic 推出 Claude Sonnet 5，主打低成本智能体能力","discovery_summary":"Anthropic 发布 Claude Sonnet 5，这是其中端模型的最新版本，具备制定计划、使用浏览器和终端等工具并自主运行的能力。其性能接近 Opus 4.8，但成本更低：即日起至 8 月 31 日，输入每百万 tokens $2，输出每百万 tokens $10，之后分别涨至 $3 和 $10。在智能体编程基准上得分为 63.2%（Opus 4.8 为 69.2%，Sonnet 4.6 为 58.1%），在知识工作基准上略超 Opus 4.8。安全方面，不当行为、幻觉和谄媚率低于 Sonnet 4.6，且更善于拒绝恶意请求和提示词注入攻击。","source_name":"TechCrunch：AI（RSS）","origin_url":"https://techcrunch.com/2026/06/30/anthropic-launches-claude-sonnet-5-as-a-cheaper-way-to-run-agents","discovered_at":"2026-07-01T02:17:38.702Z","rank_on_page":170,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: 7d9d43a1010328b7
content_hash: 1e31ca9ef2fb6c8c
semantic_hash: 5f0f4dbbdf4c6b63
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-06-30T18:00:00.000Z"
last_seen_at: 2026-07-01T02:33:05.102Z
...
business_elements: {"companies":["TechCrunch","AI（RSS）","OpenAI","Anthropic","Google","Salesforce"],"products":["Claude","agents","GPT-5","Gemini"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["5","4.8","8","31","$2","$10","$3","63.2%"],"quotes":["Between Sonnet 5 and Opus 4.8, users can adjust the effort level to find the right balance of cost and performance.","checks its own output without explicitly being asked.","We handed Claude Sonnet 5 a two-part job — update Salesforce account tiers, send a launch announcement to enterprise contacts — and it finished end to end,","That used to stall halfway. For day-to-day automation, it’s a no-brainer. ","undesirable behaviors"]}
...
title_zh: "Anthropic 推出 Claude Sonnet 5，主打低成本智能体能力"
...
Topics
AI , AI agents , Anthropic , Claude , sonnet 5
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5810,"paragraph_count":34,"sentence_count":34,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Image Credits: Samuel Boivin / NurPhoto / Getty Images AI Anthropic launches Claude Sonnet 5 as a cheaper way to run agents Rebecca Bellan 11:00 AM PDT · June 30, 2026 As shipping agentic capabilities becomes table stakes among foundation model companies, Anthropic is releasing Claude Sonnet 5, a more powerful and agentic version of the lab’s midsize model.
...
- companies: TechCrunch, AI（RSS）, OpenAI, Anthropic, Google, Salesforce
- products: Claude, agents, GPT-5, Gemini
- people: 暂无公开信息
...
- numbers: 5, 4.8, 8, 31, $2, $10, $3, 63.2%
- quotes: Between Sonnet 5 and Opus 4.8, users can adjust the effort level to find the right balance of cost and performance. / checks its own output without explicitly being asked. / We handed Claude Sonnet 5 a two-part job — update Salesforce account tiers, send a launch announcement to enterprise contacts — and it finished end to end, / That used to stall halfway. For day-to-day automation, it’s a no-brainer.  / undesirable behaviors

## evidence_seed

- company_actions: Image Credits: Samuel Boivin / NurPhoto / Getty Images AI Anthropic launches Claude Sonnet 5 as a cheaper way to run agents Rebecca Bellan 11:00 AM PDT · June 30, 2026 As shipping agentic capabilities becomes table stakes among foundation model companies, Anthropic is releasing Claude Sonnet 5, a more powerful and agentic version of the lab’s midsize model. / That framing mirrors what OpenAI and Google have said about their own recent releases. / 6 Sol was launched in preview last week, and it is also the firm’s most agentic model yet, allowing users to split work across subagents for longer autonomous tasks.
- case_details: 暂无公开信息
