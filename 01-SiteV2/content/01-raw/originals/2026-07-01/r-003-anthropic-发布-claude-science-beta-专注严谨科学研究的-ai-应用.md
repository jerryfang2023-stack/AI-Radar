...
raw_id: R-003
title: "Anthropic 发布 Claude Science beta：专注严谨科学研究的 AI 应用"
original_url: "https://claude.com/product/claude-science"
canonical_url: "https://claude.com/product/claude-science"
...
search_path_label: ""
author: ""
published_at: "2026-06-30T18:34:55.498Z"
collected_at: 2026-07-01T02:33:05.023Z
language: mixed
full_text_hash: 3a380792de32de75
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-003-anthropic-发布-claude-science-beta-专注严谨科学研究的-ai-应用.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-003-anthropic-发布-claude-science-beta-专注严谨科学研究的-ai-应用.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":12568,"paragraph_count":101,"sentence_count":94,"boilerplate_hits":0,"symbol_ratio":0.0005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
...
discovery_record: {"discovery_title":"Anthropic 发布 Claude Science beta：专注严谨科学研究的 AI 应用","discovery_summary":"Anthropic 推出 Claude Science beta，专为科学研究设计。可运行分析、搜索数据库，追踪从数据处理到发表的每一步。内置科学渲染器原生查看蛋白质、结构、分子及 PDF，每个结果附带原始代码、环境和对话，确保完全可复现。后台审查器自动标记错误引用、不可追溯数字及代码不匹配的图表。支持自然语言标注修改图表。管理计算环境，可在笔记本、Linux 机器、HPC 集群或 GPU 上按需扩展。持久化 Python 和 R 内核，变量和数据框内存驻留。预配置基因组学、单细胞、蛋白质组学、结构生物学、化学信息学等领域，可查询 60+ 科学数据库。支持将流程保存为可复用技能或连接实验室工具。当前提供 macOS 和 Linux 版本。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://claude.com/product/claude-science","discovered_at":"2026-07-01T02:17:38.697Z","rank_on_page":150,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 48271a3e301679fb
content_hash: 3a380792de32de75
semantic_hash: 5959a38af9927ef8
duplicate_of: ""
first_seen_at: "2026-06-30T18:34:55.498Z"
last_seen_at: 2026-07-01T02:33:05.023Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Anthropic","Nvidia"],"products":["Claude","agent","MCP","Agent"],"people":[],"industries":["医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["60","002","84","105","003","3","2","500"],"quotes":["Claude Science is, without exaggeration, the most impressive AI-integrated scientific computing environment I have encountered."]}
...
Explore connectors
Explore connectors Explore connectors
Claude Science
[ 004]
FAQs
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":12568,"paragraph_count":101,"sentence_count":94,"boilerplate_hits":0,"symbol_ratio":0.0005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Claude Science beta Your research partner for rigorous science The Claude Science app runs analyses, searches databases, and traces every step from data wrangling to publication, so you can spend time on science.
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Download for macOS Download for macOS Download for macOS Download for macOS Download for macOS Download for macOS Download for Linux Download for Linux Download for Linux Download now Contact sales Contact sales Contact sales Play video Play video Claude science [ 002 ] Built for scientific research Rich scientific artifacts, fully reproducible View proteins, structures, and molecules natively, with every result reproducible and traced to its code.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Attachments Document 84kb TXT Document 105 lines TXT Every artifact ships with its history Figures, tables, and notebooks include the exact code, environment, and conversation that produced them, so they can be reproduced, edited, or defended months later.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Built-in scientific renderers Inspect proteins, alignments, genomic tracks, chemical structures, and PDFs in their native form, with no extra installation required.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）, Anthropic, Nvidia
- products: Claude, agent, MCP, Agent
- people: 暂无公开信息
...
- numbers: 60, 002, 84, 105, 003, 3, 2, 500
- quotes: Claude Science is, without exaggeration, the most impressive AI-integrated scientific computing environment I have encountered.

## evidence_seed

- company_actions: Claude Science beta Your research partner for rigorous science The Claude Science app runs analyses, searches databases, and traces every step from data wrangling to publication, so you can spend time on science. / Prompt Can you tell me . / Attachments Document 84kb TXT Document 105 lines TXT Every artifact ships with its history Figures, tables, and notebooks include the exact code, environment, and conversation that produced them, so they can be reproduced, edited, or defended months later.
- case_details: 暂无公开信息
- workflow_changes: Anthropic 推出 Claude Science beta，专为科学研究设计。可运行分析、搜索数据库，追踪从数据处理到发表的每一步。内置科学渲染器原生查看蛋白质、结构、分子及 PDF，每个结果附带原始代码、环境和对话，确保完全可复现。后台审查器自动标记错误引用、不可追溯数字及代码不匹配的图表。支持自然语言标注修改图表。管理计算环境，可在笔记本、Linux 机器、HPC 集群或 GPU 上按需扩展。持久化 Python 和 R 内核，变量和数据框内存驻留。预配置基因组学、单细胞、蛋白质组学、结构生物学、化学信息学等领域，可查询 60+ 科学数据库。支持将流程保存为可复用技能或连接实验室工具。当前提供 macOS 和 Linux 版本。 / Download for macOS Download for macOS Download for macOS Download for macOS Download for macOS Download for macOS Download for Linux Download for Linux Download for Linux Download now Contact sales Contact sales Contact sales Play video Play video Claude science [ 002 ] Built for scientific research Rich scientific artifacts, fully reproducible View proteins, structures, and molecules natively, with every result reproducible and traced to its code.
