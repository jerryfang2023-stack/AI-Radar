...
original_url: "https://developers.googleblog.com/announcing-adk-go-20"
canonical_url: "https://developers.googleblog.com/announcing-adk-go-20"
...
collected_at: 2026-07-01T02:33:05.071Z
language: mixed
full_text_hash: 5c2631ed4a604247
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-013-adk-go-2-0-发布-构建可靠的多智能体应用-新增基于图的工作流引擎-人工参与循环与动态编排.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-013-adk-go-2-0-发布-构建可靠的多智能体应用-新增基于图的工作流引擎-人工参与循环与动态编排.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":11981,"paragraph_count":99,"sentence_count":83,"boilerplate_hits":0,"symbol_ratio":0.0038,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 11981
fetch_error: ""
...
discovery_record: {"discovery_title":"ADK Go 2.0 发布：构建可靠的多智能体应用，新增基于图的工作流引擎、人工参与循环与动态编排","discovery_summary":"Agent Development Kit （ADK） for Go 2.0 发布，引入了一类基于图的工作流引擎，用于组合复杂多智能体应用。新版本内置人工参与循环（HITL）编排、使用纯 Go 代码的动态执行、以及指数退避重试等自动弹性特性。统一执行模型后，单智能体应用与复杂图均运行在同一运行时上，简化了遥测与状态持久化。","source_name":"Google Developers Blog（RSS）","origin_url":"https://developers.googleblog.com/announcing-adk-go-20","discovered_at":"2026-07-01T02:17:38.705Z","rank_on_page":181,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 7087e847127e89ca
content_hash: 5c2631ed4a604247
semantic_hash: 9a6b5ffc31dfbe82
duplicate_of: ""
first_seen_at: "2026-06-30T17:17:40.302Z"
last_seen_at: 2026-07-01T02:33:05.071Z
...
business_elements: {"companies":["Google Developers Blog（RSS）","Google"],"products":["Agent","agent","agents"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":[],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["2.0","30","2026","1.0","2","$200","5","1"],"quotes":["google.golang.org/adk/v2/workflow",", upperFn, cfg)\nsuffix := workflow.NewFunctionNode(",", suffixFn, cfg)\nedges := workflow.Chain(workflow.Start, upper, suffix)\nwf, _ := workflowagent.New(workflowagent.Config{\nName: ","classify","progress"]}
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":11981,"paragraph_count":99,"sentence_count":83,"boilerplate_hits":0,"symbol_ratio":0.0038,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Build reliable multi-agent applications with ADK Go 2.
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Discover our new graph-based workflow engine, built-in human-in-the-loop, and dynamic orchestration JUNE 30, 2026 Toni Klopfenstein Developer Relations Engineer ADK Developer Relations Sampath Kumar Maddula Developer Programs Engineer Share Facebook Twitter LinkedIn Mail ADK for Go 2.
...
4. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   0: build agent workflows as a graph Building real-world agent applications is rarely as simple as sending a single prompt.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Expressing that complex orchestration as ad-hoc control flow gets brittle fast.
...
- numbers: 2.0, 30, 2026, 1.0, 2, $200, 5, 1
- quotes: google.golang.org/adk/v2/workflow / , upperFn, cfg)
suffix := workflow.NewFunctionNode( / , suffixFn, cfg)
edges := workflow.Chain(workflow.Start, upper, suffix)
wf, _ := workflowagent.New(workflowagent.Config{
Name:  / classify / progress
...
- company_actions: Agent Development Kit （ADK） for Go 2.0 发布，引入了一类基于图的工作流引擎，用于组合复杂多智能体应用。新版本内置人工参与循环（HITL）编排、使用纯 Go 代码的动态执行、以及指数退避重试等自动弹性特性。统一执行模型后，单智能体应用与复杂图均运行在同一运行时上，简化了遥测与状态持久化。 / Build reliable multi-agent applications with ADK Go 2. / Production agents must classify, branch, fan out, ask a human to approve something, retry on failure, and loop until done.
- case_details: 暂无公开信息
- workflow_changes: Discover our new graph-based workflow engine, built-in human-in-the-loop, and dynamic orchestration JUNE 30, 2026 Toni Klopfenstein Developer Relations Engineer ADK Developer Relations Sampath Kumar Maddula Developer Programs Engineer Share Facebook Twitter LinkedIn Mail ADK for Go 2. / 0: build agent workflows as a graph Building real-world agent applications is rarely as simple as sending a single prompt.
