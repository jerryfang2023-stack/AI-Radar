...
raw_id: R-022
title: "Meta AI 发布 Brain2Qwerty v2：非侵入式 MEG 脑到文本解码管线"
original_url: "https://www.marktechpost.com/2026/06/30/meta-ai-releases-brain2qwerty-v2-a-non-invasive-meg-brain-to-text-pipeline-decoding-typed-sentences-at-61-word-accuracy"
canonical_url: "https://marktechpost.com/2026/06/30/meta-ai-releases-brain2qwerty-v2-a-non-invasive-meg-brain-to-text-pipeline-decoding-typed-sentences-at-61-word-accuracy"
...
search_path_label: ""
author: ""
published_at: "2026-06-30T08:13:41.000Z"
collected_at: 2026-07-01T02:33:05.136Z
language: mixed
full_text_hash: 1944fd7dec88b09d
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-022-meta-ai-发布-brain2qwerty-v2-非侵入式-meg-脑到文本解码管线.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-01/r-022-meta-ai-发布-brain2qwerty-v2-非侵入式-meg-脑到文本解码管线.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":8828,"paragraph_count":99,"sentence_count":90,"boilerplate_hits":2,"symbol_ratio":0.0058,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8828
fetch_error: ""
...
discovery_record: {"discovery_title":"Meta AI 发布 Brain2Qwerty v2：非侵入式 MEG 脑到文本解码管线","discovery_summary":"Meta AI 近日发布 Brain2Qwerty v2，一种基于非侵入式脑磁图（MEG）信号的实时脑到文本解码管线，无需植入或手术。系统在 9 名志愿者约 22，000 句打字数据上训练（每人 10 小时），平均词准确率 61%（WER 39%），最高参与者达 78%，超过半数句子错误不超过一个词。管线由卷积编码器、Transformer 和字符级语言模型组成，并微调大语言模型提取语义表征，用 AI 智能体自动化改进解码流程但最终配置由人工选定。Meta 同时以 CC BY-NC 4.0 协议开源 v1 和 v2 训练代码。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/30/meta-ai-releases-brain2qwerty-v2-a-non-invasive-meg-brain-to-text-pipeline-decoding-typed-sentences-at-61-word-accuracy","discovered_at":"2026-07-01T02:17:38.738Z","rank_on_page":317,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 55823f5125c7995a
content_hash: 1944fd7dec88b09d
semantic_hash: ec15bbd455414039
duplicate_of: ""
first_seen_at: "2026-06-30T08:13:41.000Z"
last_seen_at: 2026-07-01T02:33:05.136Z
...
business_elements: {"companies":["MarkTechPost（RSS）","GitHub","Meta"],"products":["agents"],"people":[],"industries":["医疗","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["2","9","22","000","10","61%","39%","78%"],"quotes":["Illustrative: convolutional encoder -> transformer -> char-level head.\nReflects the components Meta describes, not the official implementation."]}
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":8828,"paragraph_count":99,"sentence_count":90,"boilerplate_hits":2,"symbol_ratio":0.0058,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Tech News AI Paper Summary Technology AI Shorts Artificial Intelligence Applications Editors Pick Machine Learning New Releases Staff Meta AI just introduced Brain2Qwerty v2 .
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It decodes natural sentences from non-invasive brain recordings in real time.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The system reads magnetoencephalography (MEG) signals while a person types.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It reconstructs what they typed, with no implant and no surgery.

6. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   This is the follow-up to Brain2Qwerty v1, released in February 2025.

## business_elements

- companies: MarkTechPost（RSS）, GitHub, Meta
- products: agents
- people: 暂无公开信息
- industries: 医疗, 开发者工具
...
- numbers: 2, 9, 22, 000, 10, 61%, 39%, 78%
- quotes: Illustrative: convolutional encoder -> transformer -> char-level head.
Reflects the components Meta describes, not the official implementation.

## evidence_seed

- company_actions: Tech News AI Paper Summary Technology AI Shorts Artificial Intelligence Applications Editors Pick Machine Learning New Releases Staff Meta AI just introduced Brain2Qwerty v2 . / It decodes natural sentences from non-invasive brain recordings in real time. / The system reads magnetoencephalography (MEG) signals while a person types.
- case_details: 暂无公开信息
