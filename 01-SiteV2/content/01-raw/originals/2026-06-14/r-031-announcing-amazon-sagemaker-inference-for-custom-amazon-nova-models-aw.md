...
raw_id: R-031
title: "Announcing Amazon SageMaker Inference for custom Amazon Nova models | AWS News Blog"
original_url: "https://aws.amazon.com/blogs/aws/announcing-amazon-sagemaker-inference-for-custom-amazon-nova-models/"
canonical_url: "https://aws.amazon.com/blogs/aws/announcing-amazon-sagemaker-inference-for-custom-amazon-nova-models"
...
author: ""
published_at: ""
collected_at: 2026-06-14T08:10:00.646Z
language: mixed
full_text_hash: 6ae3620c18722544
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-14/r-031-announcing-amazon-sagemaker-inference-for-custom-amazon-nova-models-aw.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-14/r-031-announcing-amazon-sagemaker-inference-for-custom-amazon-nova-models-aw.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":8439,"paragraph_count":90,"sentence_count":34,"boilerplate_hits":1,"symbol_ratio":0.0146,"method":"content-container"}
has_full_text: true
content_length: 8439
fetch_error: ""
...
url_hash: 36ee025eb883f7c0
content_hash: 6ae3620c18722544
semantic_hash: 8be736feec7288ed
duplicate_of: ""
first_seen_at: "2026-06-14T08:10:00.646Z"
last_seen_at: 2026-06-14T08:10:00.646Z
...
business_elements: {"companies":["keyword search","Anysearch","Amazon","AWS"],"products":[],"people":[],"industries":["开发者工具","企业服务"],"roles":[],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2025","2","5","6","5.12x","5.24x","5.48x","6.12x"],"quotes":["Model created successfully!","Endpoint configuration created successfully!","Endpoint creation initiated successfully!","messages","Compare our Q4 2025 actual spend against budget across all departments and highlight variances exceeding 10%"]}
...
title_zh: "宣布推出适用于自定义Amazon Nova模型的Amazon SageMaker推理功能"
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":8439,"paragraph_count":90,"sentence_count":34,"boilerplate_hits":1,"symbol_ratio":0.0146,"method":"content-container"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Since we launched Amazon Nova customization in Amazon SageMaker AI at AWS NY Summit 2025, customers have been asking for the same capabilities with Amazon Nova as they do when they customize open weights models in Amazon SageMaker Inference. They also wanted have more control and flexibility in cust... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=official_original

2. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Skip to Main Content AWS News Blog Announcing Amazon SageMaker Inference for custom Amazon Nova models Since we launched Amazon Nova customization in Amazon SageMaker AI at AWS NY Summit 2025, customers have been asking for the same capabilities with Amazon Nova as they do when they customize open weights models in Amazon SageMaker Inference .

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   They also wanted have more control and flexibility in custom model inference over instance types, auto-scaling policies, context length, and concurrency settings that production workloads demand.

4. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Today, we’re announcing the general availability of custom Nova model support in Amazon SageMaker Inference, a production-grade, configurable, and cost-efficient managed inference service to deploy and scale full-rank customized Nova models.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   You can now experience an end-to-end customization journey to train Nova Micro, Nova Lite, and Nova 2 Lite models with reasoning capabilities using Amazon SageMaker Training Jobs or Amazon HyperPod and seamlessly deploy them with managed inference infrastructure of Amazon SageMaker AI.
...
- numbers: 2025, 2, 5, 6, 5.12x, 5.24x, 5.48x, 6.12x
- quotes: Model created successfully! / Endpoint configuration created successfully! / Endpoint creation initiated successfully! / messages / Compare our Q4 2025 actual spend against budget across all departments and highlight variances exceeding 10%

## evidence_seed

- company_actions: They also wanted have more control and flexibility in custom model inference over instance types, auto-scaling policies, context length, and concurrency settings that production workloads demand. / You can now experience an end-to-end customization journey to train Nova Micro, Nova Lite, and Nova 2 Lite models with reasoning capabilities using Amazon SageMaker Training Jobs or Amazon HyperPod and seamlessly deploy them with managed inference infrastructure of Amazon SageMaker AI. / With Amazon SageMaker Inference for custom Nova models, you can reduce inference cost through optimized GPU utilization using Amazon Elastic Compute Cloud (Amazon EC2) G5 and G6 instances over P5 instances , auto-scaling based on 5-minute usage patterns, and configurable inference parameters.
- case_details: Since we launched Amazon Nova customization in Amazon SageMaker AI at AWS NY Summit 2025, customers have been asking for the same capabilities with Amazon Nova as they do when they customize open weights models in Amazon SageMaker Inference. They also wanted have more control and flexibility in cust... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=official_original / Skip to Main Content AWS News Blog Announcing Amazon SageMaker Inference for custom Amazon Nova models Since we launched Amazon Nova customization in Amazon SageMaker AI at AWS NY Summit 2025, customers have been asking for the same capabilities with Amazon Nova as they do when they customize open weights models in Amazon SageMaker Inference .
- workflow_changes: Today, we’re announcing the general availability of custom Nova model support in Amazon SageMaker Inference, a production-grade, configurable, and cost-efficient managed inference service to deploy and scale full-rank customized Nova models.
