...
original_url: "https://github.com/DanMcInerney/architect-loop"
canonical_url: "https://github.com/DanMcInerney/architect-loop"
...
search_path_label: ""
author: ""
published_at: "2026-06-13T16:46:05.572Z"
collected_at: 2026-06-14T08:10:00.827Z
language: mixed
full_text_hash: 0564a9379423b448
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-14/r-098-architect-减少80-的fable-token-fable负责协调-审核-codex负责构建.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-14/r-098-architect-减少80-的fable-token-fable负责协调-审核-codex负责构建.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":7147,"paragraph_count":105,"sentence_count":57,"boilerplate_hits":2,"symbol_ratio":0.0013,"method":"main"}
has_full_text: true
content_length: 7147
fetch_error: ""
...
discovery_record: {"discovery_title":"/architect：减少80%的Fable token，Fable负责协调/审核，Codex负责构建","discovery_summary":"/architect项目将Fable token减少80%，由Fable进行协调和审核，Codex负责构建任务。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://github.com/DanMcInerney/architect-loop","discovered_at":"2026-06-14T08:01:48.522Z","rank_on_page":104,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: bdb38be66a0a8bce
content_hash: 0564a9379423b448
semantic_hash: 3fb3b4dad300a9b5
duplicate_of: ""
first_seen_at: "2026-06-13T16:46:05.572Z"
last_seen_at: 2026-06-14T08:10:00.827Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","OpenAI","GitHub"],"products":["Codex","Claude","GPT-5","codex","ChatGPT","agent","agents"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["80%","24","335\nm","23","1","5.5","30","0.133"],"quotes":[]}
...
What it is
DESIGN.md
The design document — 12 enforced rules, failure-mode table, cited sources
skills/architect/SKILL.md
The architect role: hard rules + procedure
skills/architect/dispatch.md
Verified codex exec commands, builder block, worktree fan-out, stall triage
skills/architect/research.md
Slice-scale inline fact-check fan-out
skills/architect/HANDOFF.template.md
The repo-memory file
skills/architect-research/SKILL.md
Research orchestration: scout → design → fan out → verify → write
skills/architect-research/lanes.md
Scout block + source-class tactics library with verified endpoints
tests/validate_skills.py
Repo sanity checks (frontmatter limits, links, fences)
FAQ
...
Origin
The original idea came from this X post by @jumperz
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":7147,"paragraph_count":105,"sentence_count":57,"boilerplate_hits":2,"symbol_ratio":0.0013,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   DanMcInerney architect-loop Public Notifications You must be signed in to change notification settings Fork 24 Star 335 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 23 Commits 23 Commits assets assets skills skills tests tests .
...
4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   sh View all files Repository files navigation architect-loop Claude Fable handles planning and review; GPT-5.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   5 Codex handles implementation and research.

6. **product_update**｜supports=daily_observation, heatmap, change｜importance=medium｜confidence=high
   Two Claude Code skills wire that split into a repo-centered loop: specs and gates are written first, Codex works in fresh contexts, and Fable reviews the evidence before anything is integrated.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）, OpenAI, GitHub
- products: Codex, Claude, GPT-5, codex, ChatGPT, agent, agents
- people: 暂无公开信息
- industries: 开发者工具
- roles: 暂无公开信息
...
- company_actions: DanMcInerney architect-loop Public Notifications You must be signed in to change notification settings Fork 24 Star 335 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 23 Commits 23 Commits assets assets skills skills tests tests . / md LICENSE LICENSE README. / sh View all files Repository files navigation architect-loop Claude Fable handles planning and review; GPT-5.
- case_details: 暂无公开信息
