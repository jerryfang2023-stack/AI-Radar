...
raw_id: R-107
title: "微软 SkillOpt 仅凭一个训练好的 Markdown 文件即可提升 GPT-5.5 性能"
original_url: "https://the-decoder.com/microsofts-skillopt-boosts-gpt-5-5-by-using-nothing-but-a-trained-markdown-file"
canonical_url: "https://the-decoder.com/microsofts-skillopt-boosts-gpt-5-5-by-using-nothing-but-a-trained-markdown-file"
...
search_path_label: ""
author: ""
published_at: "2026-06-13T12:20:39.000Z"
collected_at: 2026-06-14T04:27:51.580Z
language: mixed
full_text_hash: d8431214b262160c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-14/r-107-微软-skillopt-仅凭一个训练好的-markdown-文件即可提升-gpt-5-5-性能.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-14/r-107-微软-skillopt-仅凭一个训练好的-markdown-文件即可提升-gpt-5-5-性能.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":16043,"paragraph_count":66,"sentence_count":130,"boilerplate_hits":0,"symbol_ratio":0.0034,"method":"json-ld"}
has_full_text: true
content_length: 16043
fetch_error: ""
...
discovery_record: {"discovery_title":"微软 SkillOpt 仅凭一个训练好的 Markdown 文件即可提升 GPT-5.5 性能","discovery_summary":"微软与三所中国大学联合开发了 SkillOpt 方法，利用传统模型训练原理优化 AI 智能体的指令文档。仅需一个简单的 Markdown 文件，即可让 GPT-5.5 在程序化任务上提升约 23 分，且该文件能够跨模型和跨 Agent 环境（如 Codex 和 Claude Code）迁移。","source_name":"The Decoder：AI News（RSS）","origin_url":"https://the-decoder.com/microsofts-skillopt-boosts-gpt-5-5-by-using-nothing-but-a-trained-markdown-file","discovered_at":"2026-06-14T04:21:16.534Z","rank_on_page":143,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: 648733ca80964de2
content_hash: d8431214b262160c
semantic_hash: 8547655370063171
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-06-13T12:20:39.000Z"
last_seen_at: 2026-06-14T04:27:51.580Z
...
business_elements: {"companies":["The Decoder","AI News（RSS）","Anthropic","Microsoft","Meta"],"products":["GPT-5","Agent","Codex","Claude","agents","agent"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":[],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["部署 / 上线"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["5.5","23","5.5 b","20","56642","1800","56643","300"],"quotes":["attachment_56642","aligncenter","attachment_56643","aligncenter","attachment_56641"]}
...
[caption id="attachment_56642" align="aligncenter" width="1800"] SkillOpt trains the skill document like model weights, only keeping changes that measurably pay off. | Image: Yang et al.[/caption]
...
[caption id="attachment_56641" align="aligncenter" width="1800"] Across training rounds, the method typically picks skills that also perform well on unseen test data. | Image: Yang et al.[/caption]
...
- fetch_status: fetched-readable-text-json-ld
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":16043,"paragraph_count":66,"sentence_count":130,"boilerplate_hits":0,"symbol_ratio":0.0034,"method":"json-ld"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Microsoft's SkillOpt boosts GPT-5.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   5 by using nothing but a trained Markdown file Microsoft's SkillOpt boosts GPT-5.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   5 by using nothing but a trained Markdown file Microsoft and three Chinese universities have developed SkillOpt, a method that optimizes instruction documents for AI agents using principles from traditional model training.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   A simple Markdown file is enough to boost GPT-5.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   5 by about 23 points on procedural tasks, and the same file transfers across models and agent environments like Codex and Claude Code.

## business_elements

- companies: The Decoder, AI News（RSS）, Anthropic, Microsoft, Meta
- products: GPT-5, Agent, Codex, Claude, agents, agent
- people: 暂无公开信息
...
- numbers: 5.5, 23, 5.5 b, 20, 56642, 1800, 56643, 300
- quotes: attachment_56642 / aligncenter / attachment_56643 / aligncenter / attachment_56641

## evidence_seed

- company_actions: 微软与三所中国大学联合开发了 SkillOpt 方法，利用传统模型训练原理优化 AI 智能体的指令文档。仅需一个简单的 Markdown 文件，即可让 GPT-5.5 在程序化任务上提升约 23 分，且该文件能够跨模型和跨 Agent 环境（如 Codex 和 Claude Code）迁移。 / Microsoft's SkillOpt boosts GPT-5. / 5 by using nothing but a trained Markdown file Microsoft's SkillOpt boosts GPT-5.
- case_details: 暂无公开信息
