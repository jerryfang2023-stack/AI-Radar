...
original_url: "https://huggingface.co/blog/ibm-research/cuga-apps"
canonical_url: "https://huggingface.co/blog/ibm-research/cuga-apps"
...
search_path_label: ""
author: ""
published_at: "2026-06-23T12:51:55.000Z"
collected_at: 2026-06-24T01:53:52.356Z
language: mixed
full_text_hash: e1ba1616fcd69227
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-008-ibm-开源-cuga-轻量级智能体框架-提供二十余个单文件示例应用.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-008-ibm-开源-cuga-轻量级智能体框架-提供二十余个单文件示例应用.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":19660,"paragraph_count":96,"sentence_count":147,"boilerplate_hits":0,"symbol_ratio":0.0044,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 19660
fetch_error: ""
...
discovery_record: {"discovery_title":"IBM 开源 CUGA：轻量级智能体框架，提供二十余个单文件示例应用","discovery_summary":"IBM 开源了 CUGA（Configurable Generalist Agent），一个处理规划、执行循环、工具调用和状态管理的轻量级智能体框架。开发者只需提供工具列表和提示词即可构建 CugaAgent。内置计划-执行-反思循环，在 AppWorld（2025年7月-2026年2月）和 WebArena（2025年2月-9月）基准上排名第一。支持 Fast / Balanced / Accurate 三种推理模式，代码执行可在本地、Docker 或 E2B 沙箱中运行。可互换工具支持 OpenAPI、MCP 和 LangChain 函数，通过环境变量一键切换 OpenAI、watsonx、Ollama 等提供商。随框架发布二十余个单文件示例应用，涵盖电影推荐、IBM Cloud 架构顾问等场景，每个应用仅需一个 FastAPI 文件。","source_name":"Hugging Face：Blog（RSS）","origin_url":"https://huggingface.co/blog/ibm-research/cuga-apps","discovered_at":"2026-06-24T01:47:16.538Z","rank_on_page":205,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 0b690c5df303dfe7
content_hash: bf491f21111b7678
semantic_hash: 0734e64a31256707
duplicate_of: ""
first_seen_at: "2026-06-23T12:51:55.000Z"
last_seen_at: 2026-06-24T01:53:52.356Z
...
business_elements: {"companies":["Hugging Face","Blog（RSS）","OpenAI","Anthropic","GitHub"],"products":["Agent","MCP","agent","agents"],"people":[],"industries":["金融 / 保险","制造 / 工业","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["2025","7","2026","2","9","2B","23","27"],"quotes":["LLM_PROVIDER","LLM_MODEL","Search the IBM Cloud Global Catalog for real IBM Cloud services.\nAlways call this before recommending services to verify they exist.","\n... # hits the catalog API, returns JSON\nfrom _mcp_bridge import load_tools\nweb_tools = load_tools([ ","don't make things up"]}
...
Upvote 27
+21
Anupama Murthi anupamamurthi Follow
ibm-research
Hamid Adebayo harmedox Follow
ibm-research
Sami Marreed samimarreed Follow
ibm-research
Praveen praveenv Follow
ibm-research
Asaf Adi AsafAdi Follow
ibm-research
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":19660,"paragraph_count":96,"sentence_count":147,"boilerplate_hits":0,"symbol_ratio":0.0044,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Back to Articles a]:hidden"> Build real agentic apps using CUGA: two dozen working examples on a lightweight harness Enterprise Article Published June 23, 2026 Upvote 27 +21 Anupama Murthi anupamamurthi Follow ibm-research Hamid Adebayo harmedox Follow ibm-research Sami Marreed samimarreed Follow ibm-research Praveen praveenv Follow ibm-research Asaf Adi AsafAdi Follow ibm-research TL;DR — Building an agent is mostly plumbing: tools, state, guardrails, scaling from one agent to many.
...
5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Read one end to end here, then see how the same agent runs sovereign and governed in production without a rewrite.
...
- companies: Hugging Face, Blog（RSS）, OpenAI, Anthropic, GitHub
- products: Agent, MCP, agent, agents
- people: 暂无公开信息
...
- numbers: 2025, 7, 2026, 2, 9, 2B, 23, 27
- quotes: LLM_PROVIDER / LLM_MODEL / Search the IBM Cloud Global Catalog for real IBM Cloud services.
Always call this before recommending services to verify they exist. / 
... # hits the catalog API, returns JSON
from _mcp_bridge import load_tools
web_tools = load_tools([  / don't make things up
...
- company_actions: IBM 开源了 CUGA（Configurable Generalist Agent），一个处理规划、执行循环、工具调用和状态管理的轻量级智能体框架。开发者只需提供工具列表和提示词即可构建 CugaAgent。内置计划-执行-反思循环，在 AppWorld（2025年7月-2026年2月）和 WebArena（2025年2月-9月）基准上排名第一。支持 Fast / Balanced / Accurate 三种推理模式，代码执行可在本地、Docker 或 E2B 沙箱中运行。可互换工具支持 OpenAPI、MCP 和 LangChain 函数，通过环境变量一键切换 OpenAI、watsonx、Ollama 等提供商。随框架发布二十余个单文件示例应用，涵盖电影推荐、IBM Cloud 架构顾问等场景，每个应用仅需一个 FastAPI 文件。 / Back to Articles a]:hidden"> Build real agentic apps using CUGA: two dozen working examples on a lightweight harness Enterprise Article Published June 23, 2026 Upvote 27 +21 Anupama Murthi anupamamurthi Follow ibm-research Hamid Adebayo harmedox Follow ibm-research Sami Marreed samimarreed Follow ibm-research Praveen praveenv Follow ibm-research Asaf Adi AsafAdi Follow ibm-research TL;DR — Building an agent is mostly plumbing: tools, state, guardrails, scaling from one agent to many. / CUGA (pip install cuga), short for Configurable Generalist Agent, the Agent Harness for the Enterprise from IBM handles that, so you write just a tool list and a prompt.
- case_details: 暂无公开信息
