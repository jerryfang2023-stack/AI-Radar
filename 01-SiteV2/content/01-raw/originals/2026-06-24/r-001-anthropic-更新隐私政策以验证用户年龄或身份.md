...
raw_id: R-001
title: "Anthropic 更新隐私政策以验证用户年龄或身份"
original_url: "https://www.anthropic.com/legal/privacy"
canonical_url: "https://anthropic.com/legal/privacy"
...
search_path_label: ""
author: ""
published_at: "2026-06-23T20:44:19.947Z"
collected_at: 2026-06-24T01:53:52.320Z
language: mixed
full_text_hash: 2dc1ffc70b927a8b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-001-anthropic-更新隐私政策以验证用户年龄或身份.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-001-anthropic-更新隐私政策以验证用户年龄或身份.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":72,"text_length":38211,"paragraph_count":196,"sentence_count":216,"boilerplate_hits":36,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 38211
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 更新隐私政策以验证用户年龄或身份","discovery_summary":"Anthropic 于2026年6月8日发布更新版隐私政策，7月8日生效。新政策允许在特定情况下要求用户验证年龄或身份，收集的数据包括政府签发的身份证件图像、面部图像、面部几何模板（可能被视为生物识别数据）及验证结果。此外还收集身份与联系信息、支付信息、用户与Claude交互的输入输出内容、反馈（含整段对话）、研究参与数据、通信内容，以及设备类型、操作系统、IP地址、使用记录、日志等技术信息。该政策适用于Claude.ai及Anthropic其他产品服务。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://www.anthropic.com/legal/privacy","discovered_at":"2026-06-24T01:47:16.507Z","rank_on_page":80,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 1052e72d4edc7a9f
content_hash: 84cc6e6c6eeff59a
semantic_hash: 03eb18e8d1734b08
duplicate_of: ""
first_seen_at: "2026-06-23T20:44:19.947Z"
last_seen_at: 2026-06-24T01:53:52.320Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Anthropic"],"products":["Claude","agent"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["2026","6","8","7","4","1","12345","2"],"quotes":["Services","Rights and Choices","USER12345","Feedback"," Technical Information "]}
...
title_zh: "Anthropic 更新隐私政策以验证用户年龄或身份"
title_translation_status: "not_required"
title_translation_method: "source_title"
title_translation_model: "not_applicable"
---

# Anthropic 更新隐私政策以验证用户年龄或身份
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":72,"text_length":38211,"paragraph_count":196,"sentence_count":216,"boilerplate_hits":36,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   Anthropic 于2026年6月8日发布更新版隐私政策，7月8日生效。新政策允许在特定情况下要求用户验证年龄或身份，收集的数据包括政府签发的身份证件图像、面部图像、面部几何模板（可能被视为生物识别数据）及验证结果。此外还收集身份与联系信息、支付信息、用户与Claude交互的输入输出内容、反馈（含整段对话）、研究参与数据、通信内容，以及设备类型、操作系统、IP地址、使用记录、日志等技术信息。该政策适用于Claude.ai及Anthropic其他产品服务。

2. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   Privacy Policy \ Anthropic This policy was published on June 8, 2026 with an effective date of July 8, 2026.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Anthropic is an AI safety and research company working to build reliable, interpretable, and steerable AI systems.

4. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   This Privacy Policy explains how we collect, use, disclose, and process your personal data when you use our website, Claude.

5. **quote**｜supports=daily_observation, heatmap, viewpoint｜importance=high｜confidence=high
   ai, or other Anthropic products and services (the “Services”).
...
- numbers: 2026, 6, 8, 7, 4, 1, 12345, 2
- quotes: Services / Rights and Choices / USER12345 / Feedback /  Technical Information 

## evidence_seed

- company_actions: Anthropic is an AI safety and research company working to build reliable, interpretable, and steerable AI systems.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 法务 / 律师
- risks_or_constraints: Anthropic 于2026年6月8日发布更新版隐私政策，7月8日生效。新政策允许在特定情况下要求用户验证年龄或身份，收集的数据包括政府签发的身份证件图像、面部图像、面部几何模板（可能被视为生物识别数据）及验证结果。此外还收集身份与联系信息、支付信息、用户与Claude交互的输入输出内容、反馈（含整段对话）、研究参与数据、通信内容，以及设备类型、操作系统、IP地址、使用记录、日志等技术信息。该政策适用于Claude.ai及Anthropic其他产品服务。 / Privacy Policy \ Anthropic This policy was published on June 8, 2026 with an effective date of July 8, 2026. / This Privacy Policy explains how we collect, use, disclose, and process your personal data when you use our website, Claude.
