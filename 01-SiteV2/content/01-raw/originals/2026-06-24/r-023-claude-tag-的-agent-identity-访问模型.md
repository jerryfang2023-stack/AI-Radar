...
original_url: "https://claude.com/blog/agent-identity-access-model"
canonical_url: "https://claude.com/blog/agent-identity-access-model"
...
search_path_label: ""
author: ""
published_at: "2026-06-23T17:14:28.633Z"
collected_at: 2026-06-24T01:53:52.435Z
language: mixed
full_text_hash: a5ca091138fe9d92
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-023-claude-tag-的-agent-identity-访问模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-023-claude-tag-的-agent-identity-访问模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":8273,"paragraph_count":36,"sentence_count":59,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 8273
fetch_error: ""
...
discovery_record: {"discovery_title":"Claude Tag 的 Agent Identity 访问模型","discovery_summary":"Claude Tag 推出 agent identity（智能体身份）访问模型，让 Claude 在共享频道中以独立身份工作，而非模拟某个用户。管理员在工作区级配置连接器、仓库访问、技能插件和固定指令等权限，每个频道可覆盖继承的基线设置。私有频道拥有独立身份，记忆和访问不跨频道流转；公共频道共享工作区级身份。该模型为自主多玩家 AI 场景设计，允许频道成员通过 Claude 访问已授权工具和数据，同时通过按身份撤销简化权限管理。","source_name":"Claude：Blog（网页）","origin_url":"https://claude.com/blog/agent-identity-access-model","discovered_at":"2026-06-24T01:47:16.517Z","rank_on_page":118,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: b2b9e204c1ece0d2
content_hash: a5ca091138fe9d92
semantic_hash: 9320863f07c383f9
duplicate_of: ""
first_seen_at: "2026-06-23T17:14:28.633Z"
last_seen_at: 2026-06-24T01:53:52.435Z
...
business_elements: {"companies":["Claude","Blog（网页）","Anthropic","Google","GitHub"],"products":["Claude","Agent","agent","Agents","agents","claude"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","法务"],"numbers":["0","5"],"quotes":["single player","multiplayer","act as the user","what can this user do?","what can this agent do in this compartment?"]}
...
title_zh: "Claude Tag 的 Agent Identity 访问模型"
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":8273,"paragraph_count":36,"sentence_count":59,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
- companies: Claude, Blog（网页）, Anthropic, Google, GitHub
- products: Claude, Agent, agent, Agents, agents, claude
- people: 暂无公开信息
...
- numbers: 0, 5
- quotes: single player / multiplayer / act as the user / what can this user do? / what can this agent do in this compartment?

## evidence_seed

- company_actions: Claude Tag 推出 agent identity（智能体身份）访问模型，让 Claude 在共享频道中以独立身份工作，而非模拟某个用户。管理员在工作区级配置连接器、仓库访问、技能插件和固定指令等权限，每个频道可覆盖继承的基线设置。私有频道拥有独立身份，记忆和访问不跨频道流转；公共频道共享工作区级身份。该模型为自主多玩家 AI 场景设计，允许频道成员通过 Claude 访问已授权工具和数据，同时通过按身份撤销简化权限管理。 / For an AI agent to do its best work on a human-agent team, it needs access to the same tools, documents, and context humans have. / To make multiplayer experiences work, Claude needs its own accounts for those tools, set up by an admin and tied to the workspace.
- case_details: 暂无公开信息
