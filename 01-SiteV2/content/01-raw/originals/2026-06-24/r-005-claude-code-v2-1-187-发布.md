...
original_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.187"
canonical_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.187"
...
search_path_label: ""
author: ""
published_at: "2026-06-23T21:03:48.000Z"
collected_at: 2026-06-24T01:53:52.345Z
language: mixed
full_text_hash: 1de0f18ca566022b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-005-claude-code-v2-1-187-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-24/r-005-claude-code-v2-1-187-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":77,"text_length":3029,"paragraph_count":27,"sentence_count":8,"boilerplate_hits":2,"symbol_ratio":0.0036,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 3029
fetch_error: ""
...
discovery_record: {"discovery_title":"Claude Code v2.1.187 发布","discovery_summary":"Claude Code v2.1.187 新增 `sandbox.credentials` 设置，可阻止沙箱化命令读取凭证和秘密环境变量；模型选择器及相关参数现已支持组织配置的模型限制，选中受限模型时显示\"受组织设置限制\"提示。全屏模式下选择菜单支持鼠标点击。修复多项问题：`--resume` 在 `-p` 无模型回合时失败、`--json-schema` 和工作流智能体结构化输出循环、远程 MCP 工具调用 5 分钟无响应后阻塞、Remote 会话启动延迟约 2.7 秒、韩文/中日韩文本粘贴乱码、子智能体深度追踪不准确、被杀智能体工作树注册残留未清理等。","source_name":"Claude Code：GitHub Releases（RSS）","origin_url":"https://github.com/anthropics/claude-code/releases/tag/v2.1.187","discovered_at":"2026-06-24T01:47:16.507Z","rank_on_page":79,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 0d10a691ebcb0e61
content_hash: 1de0f18ca566022b
semantic_hash: 6c14b68db563ab46
duplicate_of: ""
first_seen_at: "2026-06-23T21:03:48.000Z"
last_seen_at: 2026-06-24T01:53:52.345Z
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）","GitHub"],"products":["Claude","MCP","claude","agent","agents"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["2.1","187","5","2.7","21.7","134","23","21"],"quotes":["restricted by your organization's settings","No conversation found","finished"," instead of "]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":77,"text_length":3029,"paragraph_count":27,"sentence_count":8,"boilerplate_hits":2,"symbol_ratio":0.0036,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   187 Latest Latest Compare Choose a tag to compare Sorry, something went wrong.
...
- numbers: 2.1, 187, 5, 2.7, 21.7, 134, 23, 21
- quotes: restricted by your organization's settings / No conversation found / finished /  instead of 

## evidence_seed

- company_actions: Claude Code v2.1.187 新增 `sandbox.credentials` 设置，可阻止沙箱化命令读取凭证和秘密环境变量；模型选择器及相关参数现已支持组织配置的模型限制，选中受限模型时显示"受组织设置限制"提示。全屏模式下选择菜单支持鼠标点击。修复多项问题：`--resume` 在 `-p` 无模型回合时失败、`--json-schema` 和工作流智能体结构化输出循环、远程 MCP 工具调用 5 分钟无响应后阻塞、Remote 会话启动延迟约 2.7 秒、韩文/中日韩文本粘贴乱码、子智能体深度追踪不准确、被杀智能体工作树注册残留未清理等。 / anthropics claude-code Public Notifications You must be signed in to change notification settings Fork 21. / 187 Latest Latest Compare Choose a tag to compare Sorry, something went wrong.
- case_details: 暂无公开信息
