...
raw_id: R-027
title: "Inflect-Micro-v2 发布：仅 936 万参数实现完整语音模型"
title_zh: "Inflect-Micro-v2 发布：仅 936 万参数实现完整语音模型"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://huggingface.co/owensong/Inflect-Micro-v2"
...
search_path_label: ""
author: ""
published_at: "2026-07-26T07:38:53.861Z"
collected_at: 2026-07-27T03:16:46.081Z
language: mixed
full_text_hash: f929622c7ecdf25d
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-27/r-027-inflect-micro-v2-发布-仅-936-万参数实现完整语音模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-27/r-027-inflect-micro-v2-发布-仅-936-万参数实现完整语音模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":15130,"paragraph_count":175,"sentence_count":111,"boilerplate_hits":0,"symbol_ratio":0.0026,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
...
discovery_record: {"discovery_title":"Inflect-Micro-v2 发布：仅 936 万参数实现完整语音模型","discovery_summary":"Inflect-Micro-v2 以仅 936 万个参数实现了完整的语音模型功能。该模型在 HuggingFace 上发布，参数规模远小于主流语音模型，展示了极低参数量下仍能保持语音生成能力的可行性。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://huggingface.co/owensong/Inflect-Micro-v2","discovered_at":"2026-07-27T03:05:56.419Z","rank_on_page":104,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 9376267761d9a376
content_hash: f929622c7ecdf25d
semantic_hash: 70b4d06b47cf4fc4
duplicate_of: ""
first_seen_at: "2026-07-26T07:38:53.861Z"
last_seen_at: 2026-07-27T03:16:46.081Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）"],"products":[],"people":[],"industries":["法律 / 法务","医疗","开发者工具"],"roles":["CIO / IT 负责人","法务 / 律师"],"workflows":["合同审阅 / 法律研究","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["2","936 万","10M","3","9","356","513","37.53 M"],"quotes":[" , device= "," )\ntts.save(\n","sample.wav","owensong/Inflect-Micro-v2"," )\nsample_rate, waveform = tts.synthesize( "]}
...
fact_extraction_completed_at: 2026-07-27T03:16:46.081Z
...
Architecture
Evaluation
Controls and long text
Choose Micro or Nano
Data and adaptation
Run locally
Exports and quantization
Adapt a voice or language
Training and export workflow
Package map
Evaluation and raw protocol
Limitations
Deployment guide
Listen
...
UTMOS22 ↑
Two-ASR semantic WER ↓
Complete FP32 weights ↓
4-thread CPU throughput ↑
66.2%
4.395
3.99%
37.53 MB
...
5.51%
2.87%
Supertonic 3 · M2 · 3-step
3.03%
6.04%
3.22%
Supertonic 3 · M2 · 8-step
2.05%
3.56%
8.08%
...
Strongest Inflect v2 quality
24 kHz waveform decoder
Included
Included
...
Local runtime
Long-text handling
CPU and CUDA inference through the same Python API and CLI.
Punctuation-aware segmentation with controlled pauses and edge fades.
Repeatable output
Auditable evaluation
Fixed seeds reproduce the same latent sample on the same runtime stack.
Frozen prompts, raw ASR hypotheses, intervals, hashes, and per-system reports are included.
...
96
Encoder layers / heads
3 / 2
Feed-forward channels
768
Flow coupling blocks
Initial decoder channels
320
Upsample rates
8, 8, 2, 2
Training segment
...
seed
integer
Repeats the same stochastic sample on the same runtime stack.
...
Community server: discord.gg/CVJYedvzvp
...
Model tree for owensong/Inflect-Micro-v2
Quantizations
3 models
Spaces using owensong/Inflect-Micro-v2 3
Collection including owensong/Inflect-Micro-v2
Complete local text-to-waveform speech models at 3.96M and 9.36M parameters, with official PyTorch and ONNX Runtime releases. • 5 items • Updated about 19 hours ago • 6
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":15130,"paragraph_count":175,"sentence_count":111,"boilerplate_hits":0,"symbol_ratio":0.0026,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Inflect-Micro-v2 以仅 936 万个参数实现了完整的语音模型功能。该模型在 HuggingFace 上发布，参数规模远小于主流语音模型，展示了极低参数量下仍能保持语音生成能力的可行性。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Inflect-Micro-v2 Complete local text-to-waveform speech synthesis under 10M parameters.
...
5. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   If this release finds a real audience, I would like to continue the project with a broader v3, which might include things like more langauges, voices, and stability improvements.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   If the model is useful to you, leaving a like on Hugging Face genuinely helps more people discover it.
...
- numbers: 2, 936 万, 10M, 3, 9, 356, 513, 37.53 M
- quotes:  , device=  /  )
tts.save(
 / sample.wav / owensong/Inflect-Micro-v2 /  )
sample_rate, waveform = tts.synthesize( 
...
- company_actions: Inflect-Micro-v2 Complete local text-to-waveform speech synthesis under 10M parameters. / Fixed-voice English TTS with deterministic seeds, long-text handling, and CPU or CUDA inference. / A note from Owen I built and funded Inflect v2 independently.
- case_details: 暂无公开信息
