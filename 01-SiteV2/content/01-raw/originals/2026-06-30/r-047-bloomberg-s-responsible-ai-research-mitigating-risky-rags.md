...
raw_id: R-047
title: "Bloomberg's Responsible AI Research: Mitigating Risky RAGs ..."
original_url: "https://www.bloomberg.com/company/stories/bloomberg-responsible-ai-research-mitigating-risky-rags-genai-in-finance/"
canonical_url: "https://bloomberg.com/company/stories/bloomberg-responsible-ai-research-mitigating-risky-rags-genai-in-finance"
...
author: ""
published_at: ""
collected_at: 2026-06-30T02:26:24.769Z
language: mixed
full_text_hash: f8cec7cd6b98e407
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-30/r-047-bloomberg-s-responsible-ai-research-mitigating-risky-rags.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-30/r-047-bloomberg-s-responsible-ai-research-mitigating-risky-rags.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":10930,"paragraph_count":43,"sentence_count":53,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 10930
fetch_error: ""
...
url_hash: 74acaeecabb38480
content_hash: f8cec7cd6b98e407
semantic_hash: 6356ec4b4fbd6d66
duplicate_of: ""
first_seen_at: "2026-06-30T02:26:24.769Z"
last_seen_at: 2026-06-30T02:26:24.769Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","Meta"],"products":["Claude","agents"],"people":[],"industries":["法律 / 法务","金融 / 保险"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["合同审阅 / 法律研究"],"business_actions":["合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["28","2025","11","3.5","3","8B","7B","4"],"quotes":[" RAG LLMs are Not Safer: A Safety Analysis of Retrieval-Augmented Generation for Large Language Models ,","From customer support agents to question-answering systems, the average Internet user interacts with RAG-based systems daily.","This doesn’t mean organizations should abandon RAG-based systems, because there is real value in using this technique,","Instead, AI practitioners need to be thoughtful about how to use RAG responsibly, and what guardrails are in place to ensure outputs are appropriate.","There’s a potential mismatch between firms that want to use these technologies, but may have some resistance from their compliance and legal departments,"]}
...
# Bloomberg's Responsible AI Research: Mitigating Risky RAGs ...
...
Responsible AI research papers expose risks in deploying GenAI systems
...
This figure illustrates the safety of LLMs in non-RAG vs. RAG settings. Most LLMs in the RAG setting exhibit a significantly higher percentage of unsafe responses. (Figure 2, RAG LLMs are Not Safer: A Safety Analysis of Retrieval-Augmented Generation for Large Language Models , arXiv, 2025.)
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":10930,"paragraph_count":43,"sentence_count":53,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Bloomberg's new Responsible AI research has far-reaching implications for users of RAG-based GenAI systems and the adoption of AI in the finance ...

2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   Tech At Bloomberg Share Bloomberg’s Responsible AI Research: Mitigating Risky RAGs & GenAI in Finance April 28, 2025 As financial services firms race to adopt and deploy AI solutions, the pressure is on to build systems that are not just powerful but also safe, transparent, and trustworthy.

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   At Bloomberg, those have been guiding principles since the company was founded, and our researchers across the company’s AI Engineering group, Data AI group, and CTO Office continue to publish findings that help move others in the same direction.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Two new papers from the company’s AI researchers have major implications for how organizations deploy GenAI, particularly in a highly-regulated domain like finance.
...
5. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=medium｜confidence=high
   One reveals that retrieval augmented generation (RAG), a commonly used technique that integrates context from external data sources in an effort to enhance the accuracy of large language models (LLMs), can actually make models less reliable and safe.

6. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   The other paper posits that existing guardrail systems and general purpose AI risk taxonomies don’t account for the unique needs of real-world GenAI systems in financial services, and introduces a taxonomy specifically tailored to this domain.
...
- numbers: 28, 2025, 11, 3.5, 3, 8B, 7B, 4
- quotes:  RAG LLMs are Not Safer: A Safety Analysis of Retrieval-Augmented Generation for Large Language Models , / From customer support agents to question-answering systems, the average Internet user interacts with RAG-based systems daily. / This doesn’t mean organizations should abandon RAG-based systems, because there is real value in using this technique, / Instead, AI practitioners need to be thoughtful about how to use RAG responsibly, and what guardrails are in place to ensure outputs are appropriate. / There’s a potential mismatch between firms that want to use these technologies, but may have some resistance from their compliance and legal departments,

## evidence_seed

- company_actions: Bloomberg's new Responsible AI research has far-reaching implications for users of RAG-based GenAI systems and the adoption of AI in the finance ... / At Bloomberg, those have been guiding principles since the company was founded, and our researchers across the company’s AI Engineering group, Data AI group, and CTO Office continue to publish findings that help move others in the same direction. / Two new papers from the company’s AI researchers have major implications for how organizations deploy GenAI, particularly in a highly-regulated domain like finance.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队, 法务 / 律师, 销售 / 客服
- risks_or_constraints: Tech At Bloomberg Share Bloomberg’s Responsible AI Research: Mitigating Risky RAGs & GenAI in Finance April 28, 2025 As financial services firms race to adopt and deploy AI solutions, the pressure is on to build systems that are not just powerful but also safe, transparent, and trustworthy. / The other paper posits that existing guardrail systems and general purpose AI risk taxonomies don’t account for the unique needs of real-world GenAI systems in financial services, and introduces a taxonomy specifically tailored to this domain.
