...
original_url: "https://lilianweng.github.io/posts/2017-08-01-interpretation/"
canonical_url: "https://lilianweng.github.io/posts/2017-08-01-interpretation"
...
author: ""
published_at: ""
collected_at: 2026-06-22T03:38:47.120Z
language: mixed
full_text_hash: 721be9e4106e610c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-22/r-018-how-to-explain-the-prediction-of-a-machine-learning-model.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-22/r-018-how-to-explain-the-prediction-of-a-machine-learning-model.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":24554,"paragraph_count":128,"sentence_count":192,"boilerplate_hits":1,"symbol_ratio":0.013,"method":"main"}
has_full_text: true
...
url_hash: 80c47c062cc28dbc
content_hash: c991f0b0bc26c99e
semantic_hash: c0601846b8f0ee19
duplicate_of: ""
first_seen_at: "2026-06-22T03:38:47.120Z"
last_seen_at: 2026-06-22T03:38:47.120Z
...
business_elements: {"companies":["Lilian Weng's Blog (OpenAI)"],"products":[],"people":[],"industries":["法律 / 法务","医疗"],"roles":["CIO / IT 负责人","法务 / 律师"],"workflows":["合同审阅 / 法律研究"],"business_actions":[],"affected_departments":["IT / 安全","法务"],"numbers":["2017","2016","0","1 x","1","2 x","2","2015"],"quotes":[]}
...
Naive Bayes #
Naive Bayes is named as &ldquo;Naive&rdquo; because it works on a very simplified assumption that features are independent of each other and each contributes to the output independently.
...
Feature Selection #
Essentially all the classic feature selection methods ( Yang and Pedersen, 1997 ; Guyon and Elisseeff, 2003 ) can be considered as ways to explain a model globally. Feature selection methods decompose the contribution of multiple features so that we can explain the overall model output by individual fe
...
Explainable Artificial Intelligence #
I borrow the name of this section from the DARPA project &ldquo;Explainable Artificial Intelligence&rdquo; . This Explainable AI (XAI) program aims to develop more interpretable models and to enable human to understand, appropriately trust, and effectively manage the emerging generation of artificially intelligent techniques.
...
References #
[1] Zachary C. Lipton. &ldquo;The mythos of model interpretability.&rdquo; arXiv preprint arXiv:1606.03490 (2016).
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":24554,"paragraph_count":128,"sentence_count":192,"boilerplate_hits":1,"symbol_ratio":0.013,"method":"main"}
...
1. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   &lt;!-- This post reviews some research in model interpretability, covering two aspects: (i) interpretable models with model-specific interpretation methods and (ii) approaches of explaining black-box models. I included an open discussion on explainable artificial intelligence at the end. --&gt; &lt;p&gt;The machine learning models have started penetrating into critical areas like health care, justice systems, and financial industry. Thus to figure out how the models make the decisions and make

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Table of Contents Interpretable Models Regression Naive Bayes Decision Tree/Decision Lists Random Forests Interpreting Black-Box Models Prediction Decomposition Local Gradient Explanation Vector LIME (Local Interpretable Model-Agnostic Explanations) Feature Selection BETA (Black Box Explanation through Transparent Approximations) Explainable Artificial Intelligence References The machine learning models have started penetrating into critical areas like health care, justice systems, and financial industry.

3. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   Thus to figure out how the models make the decisions and make sure the decisioning process is aligned with the ethnic requirements or legal regulations becomes a necessity.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Meanwhile, the rapid growth of deep learning models pushes the requirement of interpreting complicated models further.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   People are eager to apply the power of AI fully on key aspects of everyday life.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   However, it is hard to do so without enough trust in the models or an efficient procedure to explain unintended behavior, especially considering that the deep neural networks are born as black-boxes .
...
- numbers: 2017, 2016, 0, 1 x, 1, 2 x, 2, 2015
- quotes: 暂无公开信息

## evidence_seed

- company_actions: &lt;!-- This post reviews some research in model interpretability, covering two aspects: (i) interpretable models with model-specific interpretation methods and (ii) approaches of explaining black-box models. I included an open discussion on explainable artificial intelligence at the end. --&gt; &lt;p&gt;The machine learning models have started penetrating into critical areas like health care, justice systems, and financial industry. Thus to figure out how the models make the decisions and make / Table of Contents Interpretable Models Regression Naive Bayes Decision Tree/Decision Lists Random Forests Interpreting Black-Box Models Prediction Decomposition Local Gradient Explanation Vector LIME (Local Interpretable Model-Agnostic Explanations) Feature Selection BETA (Black Box Explanation through Transparent Approximations) Explainable Artificial Intelligence References The machine learning models have started penetrating into critical areas like health care, justice systems, and financial industry. / Meanwhile, the rapid growth of deep learning models pushes the requirement of interpreting complicated models further.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 法务 / 律师
- risks_or_constraints: Thus to figure out how the models make the decisions and make sure the decisioning process is aligned with the ethnic requirements or legal regulations becomes a necessity.
