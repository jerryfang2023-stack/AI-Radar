...
canonical_url: "https://cloud.google.com/blog/products/ai-machine-learning/introducing-gemini-enterprise-agent-platform"
...
author: ""
published_at: ""
collected_at: 2026-06-22T06:23:06.409Z
language: mixed
full_text_hash: e967a946c5a7b30a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-22/r-083-introducing-gemini-enterprise-agent-platform-google-cloud-blog.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-22/r-083-introducing-gemini-enterprise-agent-platform-google-cloud-blog.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 3728f8bff806edab
content_hash: e967a946c5a7b30a
semantic_hash: 760eee427b525e4b
duplicate_of: ""
first_seen_at: "2026-06-22T06:23:06.409Z"
last_seen_at: 2026-06-22T06:23:06.409Z
...
business_elements: {"companies":["keyword search","Anysearch","Google"],"products":["Gemini","Agent","agents","agent"],"people":[],"industries":["企业服务"],"roles":[],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全"],"numbers":[],"quotes":[]}
...
title_zh: "Google Cloud 发布 Gemini Enterprise Agent 平台"
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=medium
   What’s new: Today, we’re launching Gemini Enterprise Agent Platform— our new, comprehensive platform to build, scale, govern, and optimize agents.

3. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=medium
   It’s the evolution of Vertex AI, bringing the model selection, model building, and agent building capabilities that customers love, together with new fea.
...
- products: Gemini, Agent, agents, agent
- people: 暂无公开信息
- industries: 企业服务
- roles: 暂无公开信息
- workflows: 部署 / 集成交付
...
- company_actions: What’s new: Today, we’re launching Gemini Enterprise Agent Platform— our new, comprehensive platform to build, scale, govern, and optimize agents.
- case_details: What’s new: Today, we’re launching Gemini Enterprise Agent Platform— our new, comprehensive platform to build, scale, govern, and optimize agents. It’s the evolution of Vertex AI, bringing the model selection, model building, and agent building capabilities that customers love, together with new fea... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=official_original / It’s the evolution of Vertex AI, bringing the model selection, model building, and agent building capabilities that customers love, together with new fea. / / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=official_original
