...
author: ""
published_at: ""
collected_at: 2026-07-09T03:05:45.044Z
language: mixed
full_text_hash: e6e07ff6120bb77d
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-09/r-044-how-zo-computer-improved-ai-reliability-20x-on-vercel-vercel.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-09/r-044-how-zo-computer-improved-ai-reliability-20x-on-vercel-vercel.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7698,"paragraph_count":46,"sentence_count":71,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 7698
fetch_error: ""
...
url_hash: 00f5e0842294baed
content_hash: e6e07ff6120bb77d
semantic_hash: 404fd7665ed6866c
duplicate_of: ""
first_seen_at: "2026-07-09T03:05:45.044Z"
last_seen_at: 2026-07-09T03:05:45.044Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic"],"products":["agent","agents"],"people":[],"industries":["金融 / 保险","医疗","开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["20x","17","2026","7.5%","0.34%","99.93%","98%","99"],"quotes":["Cloud is one of the best computing models of all time, and consumers have zero direct access because it's so complicated,","Now, with AI, it's finally possible for all of us to have cloud computers.","Now I don’t worry about it,","because with Vercel, the infrastructure just works."]}
...
fact_extraction_completed_at: 2026-07-09T03:05:45.044Z
...
Copy link to heading Zo Computer on Vercel
...
Copy link to heading Death by a thousand adapters
...
Rob Cheung co-founder and CEO @ Zo Computer
Copy link to heading AI SDK + AI Gateway: two layers, one integration
...
“ Moving to the gateway is just so ergonomic. We get references to model names, and then rely on you to do the correct implementations and handle the edge cases. Moving to the gateway is just so ergonomic. We get references to model names, and then rely on you to do the correct implementations and handle the edge cases. ”
...
Copy link to heading 20x improvement in reliability
...
“ 131 seconds to wait for something is just terrible. Now we can get 99% of our requests in under 80, which is huge. 131 seconds to wait for something is just terrible. Now we can get 99% of our requests in under 80, which is huge. ”
Rob Cheung co-founder and CEO @ Zo Computer
...
Copy link to heading Scaling to a million personal cloud owners
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7698,"paragraph_count":46,"sentence_count":71,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   # How Zo Computer improved AI reliability 20x on Vercel Published: April 17, 2026 | Authors: Eric Dodds | Category: Customer stories --- ### Zo Computer on Vercel - 20x reduction in retry rate (7.5% → 0.34%) - 99.93% chat success rate (up from 98%) - P99 latency cut 38% (131s → 81s) - New models... / query=AI platform case study production rollout customer 2026 / intent=find_original_source / path=official_original
...
2. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Copy link to heading Zo Computer on Vercel 20x reduction in retry rate (7.
...
3. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   93% chat success rate (up from 98%) P99 latency cut 38% (131s → 81s) New models added in less than 1 minute Every company has servers that store data, run services, and do work around the clock.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Rob Cheung, co-founder of Zo Computer, is closing that gap.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Zo is a personal AI cloud: your own servers and data that power an always-on agent.
...
- numbers: 20x, 17, 2026, 7.5%, 0.34%, 99.93%, 98%, 99
- quotes: Cloud is one of the best computing models of all time, and consumers have zero direct access because it's so complicated, / Now, with AI, it's finally possible for all of us to have cloud computers. / Now I don’t worry about it, / because with Vercel, the infrastructure just works.

## evidence_seed

- company_actions: Consumers just have apps. / Rob Cheung, co-founder of Zo Computer, is closing that gap. / Zo is a personal AI cloud: your own servers and data that power an always-on agent.
- case_details: 暂无公开信息
