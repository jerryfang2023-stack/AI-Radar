...
author: ""
published_at: ""
collected_at: 2026-07-09T03:05:45.082Z
language: mixed
full_text_hash: ef16d6dc49311f20
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-09/r-052-gemini-enterprise-agent-platform-release-notes-google-cloud-documentat.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-09/r-052-gemini-enterprise-agent-platform-release-notes-google-cloud-documentat.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":28926,"paragraph_count":436,"sentence_count":198,"boilerplate_hits":3,"symbol_ratio":0.0022,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 28926
fetch_error: ""
...
url_hash: 70b2939c948cb8cf
content_hash: 5c62c39012255edc
semantic_hash: 9628624359e16d0d
duplicate_of: ""
first_seen_at: "2026-07-09T03:05:45.082Z"
last_seen_at: 2026-07-09T03:05:45.082Z
...
business_elements: {"companies":["keyword search","Anysearch","Anthropic","Google"],"products":["Gemini","Agent","agent","gemini","Claude","agents","MCP","Agents"],"people":[],"industries":["金融 / 保险","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["2026","08","2\nM","2 m","2","1","06","01"],"quotes":["Enable logging of prompt inputs and response outputs"]}
...
fact_extraction_completed_at: 2026-07-09T03:05:45.082Z
...
This page documents production updates to Gemini Enterprise Agent Platform.
...
Semantic Governance Policies (SGP) and the SGP engine are now available in Preview . SGP provides an intelligent security and compliance layer that evaluates an AI agent's proposed tool calls against user intent and organizational business rules at runtime.
...
Gemini Enterprise Agent Platform Service Level Agreement (SLA) ,
...
Known limitations:
Access Transparency and Access Approval: Access Transparency logs, which provide visibility into when Google personnel access your content, and Access Approval controls aren't available for Agent Registry configurations.
Data Residency: If you configure the resource location constraint in your organization policy, Agent Registry enforces the constraint when you register a resource. However, detective controls for data residency compliance reporting are limited.
...
Supported locations for agents . Note that
...
See About reinforcement learning fine-tuning
for more information.
June 09, 2026
Feature
...
Additional Agent Platform sandbox
...
Preview . For more,
see Supported locations for agents in Agent Platform .
May 14, 2026
Feature
...
The image_size parameter for Gemini 3.1 Flash Image Preview now accepts
...
Model Garden
Vertex AI Models as a Service (MaaS)
MaaS
(Gemini/Veo) on Vertex AI
(Gemini/Veo) on Agent Platform
(Claude/Llama/DeepSeek/etc.) on Vertex AI
(Claude/Llama/DeepSeek/etc.), available on Agent Platform
Pre-trained APIs on Vertex AI
Pre-trained APIs on Agent Platform
(Provisioned Throughput/Pay-as-you-go/etc.) on Vertex AI
(Provisioned Throughput/Pay-as-you-go/etc.) on Agent Platform
Gemini Live API on Vertex AI
Gemini Live API on Agent Platform
Vertex AI Search
Agent Search
Vertex AI Search for Industry
Agent Search for Industry
Vertex AI Search for Commerce
Agent Search for Commerce
...
Grounding with Google [...] in Vertex AI
Grounding with Google [...] in Agent Platform
Grounding with Google [...] in Vertex AI Search
Grounding with Google [...] in Agent Search
Grounding with Google [...] in Vertex AI Studio
Grounding with Google [...] in Agent Studio
Vertex AI Training
Agent Platform Managed Training
...
Reinforcement Learning from Human Feedback (RLHF)/Reinforcement Learning (RL) on Vertex AI
Reinforcement Learning on Agent Platform
Vertex AI Neural Architecture Search
Neural Architecture Search on Agent Platform
Vertex AI Prediction/Vertex AI Inference
Agent Platform Inference
Vertex AI Vision
Agent Platform Vision
Vertex AI Batch Inference
Agent Platform Batch Inference
Vertex AI Online Inference
Agent Platform Online Inference
Vertex AI Endpoints
Agent Platform Endpoints
Vertex AI Forecasting/Forecasting with AutoML
...
Agent Platform Colab Enterprise
Vertex AI Workbench
...
Gen AI evals
Vertex AI AutoML (Vision/Video/Tables)
Agent Platform AutoML
Data Labeling on Vertex AI
Data Labeling
Vertex AI on GDC
Agent Platform on GDC
...
Audio track extraction (Gemini Embedding 2 only): The audio_track_extraction feature does not work. For more information, see Issue #504505771 .
Send feedback
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":88,"text_length":28926,"paragraph_count":436,"sentence_count":198,"boilerplate_hits":3,"symbol_ratio":0.0022,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Home Documentation AI and ML Gemini Enterprise Agent Platform Send feedback Gemini Enterprise Agent Platform release notes Stay organized with collections Save and categorize content based on your preferences.
...
6. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   July 08, 2026 Feature Memory Bank support for Gemini Embedding 2 Memory Bank supports the gemini-embedding-2 model for similarity search configurations.

## business_elements

- companies: keyword search, Anysearch, Anthropic, Google
- products: Gemini, Agent, agent, gemini, Claude, agents, MCP, Agents
- people: 暂无公开信息
...
- numbers: 2026, 08, 2
M, 2 m, 2, 1, 06, 01
- quotes: Enable logging of prompt inputs and response outputs

## evidence_seed

- company_actions: Home Documentation AI and ML Gemini Enterprise Agent Platform Send feedback Gemini Enterprise Agent Platform release notes Stay organized with collections Save and categorize content based on your preferences. / This page documents production updates to Gemini Enterprise Agent Platform. / Check this page for announcements about new or updated features, bug fixes, known issues, and deprecated functionality.
- case_details: 暂无公开信息
- workflow_changes: Gemini Enterprise Agent Platform release notes | Google Cloud Documentation # Gemini Enterprise Agent Platform release notes Stay organized with collections Save and categorize content based on your preferences. This page documents production updates to Gemini Enterprise Agent Platform. Check this..... / query=AI agent product launch enterprise workflow platform announced 2026 / intent=find_original_source / path=official_original / July 08, 2026 Feature Memory Bank support for Gemini Embedding 2 Memory Bank supports the gemini-embedding-2 model for similarity search configurations.
