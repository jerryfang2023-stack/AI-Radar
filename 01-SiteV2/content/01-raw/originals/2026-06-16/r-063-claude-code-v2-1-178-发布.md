...
original_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.178"
canonical_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.178"
...
search_path_label: ""
author: ""
published_at: "2026-06-15T21:35:55.000Z"
collected_at: 2026-06-16T03:08:05.012Z
language: mixed
full_text_hash: 7fd9e33884490a66
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-16/r-063-claude-code-v2-1-178-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-16/r-063-claude-code-v2-1-178-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":3800,"paragraph_count":28,"sentence_count":10,"boilerplate_hits":1,"symbol_ratio":0.0066,"method":"main"}
has_full_text: true
content_length: 3800
fetch_error: ""
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）","GitHub"],"products":["Claude","agent","claude","Agent","agents","MCP"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["2.1","178","21.5","133","15","21","35","64"],"quotes":["run a workflow","workflow:","/rc failed","not yet enabled"]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":3800,"paragraph_count":28,"sentence_count":10,"boilerplate_hits":1,"symbol_ratio":0.0066,"method":"main"}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   178 Latest Latest Compare Choose a tag to compare Sorry, something went wrong.
...
- products: Claude, agent, claude, Agent, agents, MCP
- people: 暂无公开信息
- industries: 开发者工具
- roles: CIO / IT 负责人
...
- numbers: 2.1, 178, 21.5, 133, 15, 21, 35, 64
- quotes: run a workflow / workflow: / /rc failed / not yet enabled

## evidence_seed

- company_actions: anthropics claude-code Public Notifications You must be signed in to change notification settings Fork 21. / 178 Latest Latest Compare Choose a tag to compare Sorry, something went wrong. / Filter Loading Sorry, something went wrong.
- case_details: 本次更新新增 `Tool（param：value）` 语法用于权限规则匹配工具输入参数；嵌套 `skills` 目录中的技能自动加载，名称冲突时以 `<dir>：<name>` 形式保留；嵌套 `agent`、`workflow`、`output-style` 冲突时取最近目录。改进自动模式下子 agent 生成前的分类器评估；`/doctor` 采用扁平树布局；工作流提示词高亮为紫色闪烁，仅触发显式短语；`/bug` 提交前需填写描述。修复了 CLI 继承过期 WebSocket/OAuth 文件描述符导致的崩溃、Chrome 中 OAuth token 账号不匹配导致连接失败、子 agent 转录显示工具结果、后台恢复不从头重启、compaction 未使用 `--fallback-model` 等问题。
