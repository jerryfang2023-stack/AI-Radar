...
raw_id: R-016
title: "How Benchmark Picks AI Winners | Chetan Puttagunta - GTMnow"
title_zh: ""
title_translation_status: needs_ingestion_translation
title_translation_method: missing_translation_db_entry
original_url: "https://gtmnow.com/benchmark-ai-startup-investing-chetan-puttagunta/"
canonical_url: "https://gtmnow.com/benchmark-ai-startup-investing-chetan-puttagunta"
...
author: ""
published_at: ""
collected_at: 2026-07-04T01:56:59.617Z
language: mixed
full_text_hash: 3bfa86c2e6ee13fa
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-016-how-benchmark-picks-ai-winners-chetan-puttagunta-gtmnow.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-016-how-benchmark-picks-ai-winners-chetan-puttagunta-gtmnow.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":76,"text_length":60000,"paragraph_count":214,"sentence_count":533,"boilerplate_hits":7,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"3bfa86c2e6ee13fa","missing":[]}
...
url_hash: 9e369a8d7e3841b0
content_hash: dd5d11641c9996df
semantic_hash: 1122df760f1723ea
duplicate_of: ""
first_seen_at: "2026-07-04T01:56:59.617Z"
last_seen_at: 2026-07-04T01:56:59.617Z
...
business_elements: {"companies":["keyword search","Anysearch","Anthropic","Apple","ServiceNow","Cursor"],"products":["cursor"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["180","30","$1M","24","2026","$5.6B","$100M","18 m"],"quotes":["trusted vendor","legal engineers"]}
evidence_seed: {"company_actions":["VC: How Benchmark Invests & What to Know on GTM | Chetan Puttagunta (GP) Sophie Buonassisi June 24, 2026 Podcasts Listen on YouTube // Apple // Spotify You can also watch/listen to the entire episode on X .","Benchmark’s General Partner Chetan Puttagunta joins GTMnow to give founders/operators an inside view to how they invest and think about go-to-market."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","销售 / 客服"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"number","text":"Benchmark GP Chetan Puttagunta on how AI startups pick winners, compress 180-day sales cycles to 30 days, and why the first $1M is harder ... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=capital_startup","supports":["signal_card_candidate","relationship_graph_input","case","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"company_action","text":"VC: How Benchmark Invests & What to Know on GTM | Chetan Puttagunta (GP) Sophie Buonassisi June 24, 2026 Podcasts Listen on YouTube // Apple // Spotify You can also watch/listen to the entire episode on X .","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"Benchmark’s General Partner Chetan Puttagunta joins GTMnow to give founders/operators an inside view to how they invest and think about go-to-market.","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"medium","confidence":"high"},{"type":"number","text":"He breaks down the $5.","supports":["signal_card_candidate","relationship_graph_input","case","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"number","text":"6B legal AI company that grew from $1M to $100M ARR in 18 months (despite a competitor already raising at $3B before they launched), Benchmark’s first-ever $2B growth fund, and tips on scaling in the AI era.","supports":["signal_card_candidate","relationship_graph_input","case","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"number","text":"Discussed in this episode Why the first $1M now takes longer than the next $99M in the AI era How top AI startups compress a 180 day sales cycle into 30 days The “trusted vendor” playbook for breaking incumbent distribution advantages Why Legora embedded inside a law firm for a year before launching How a magical demo plus a tightly scoped pilot collapses six month deals Why value is moving from the product build to the service and outcome What Benchmark actually looks for: technical insight that creates demand pul","supports":["signal_card_candidate","relationship_graph_input","case","trend_candidate_context"],"importance":"high","confidence":"high"}]
fact_extraction_status: extracted_at_raw_ingestion
fact_extraction_method: structured_key_excerpts_and_business_elements
fact_extraction_completed_at: 2026-07-04T01:56:59.617Z
theme: early-direction-signal
keyword_group: early-direction-signal
copyright_note: local research archive only
---

# How Benchmark Picks AI Winners | Chetan Puttagunta - GTMnow
...
Benchmark’s General Partner Chetan Puttagunta joins GTMnow to give founders/operators an inside view to how they invest and think about go-to-market.
...
GTMnow is a business and tech media company. Build, scale and invest with the best minds in tech.
...
09:40 – 09:59
Paul Irving: And then to your point, you always talk to our founders about this, which I think is such an important call out of don’t just say let’s start a trial or POC. Be very clear about what the goals are, what success looks like, wha
...
52:46 – 53:17
Chetan Puttagunta: And it’s part of the risk curve that where we invest, which is that not everything is going to just rocket to $100 million like money goes in. 18 months later,
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":76,"text_length":60000,"paragraph_count":214,"sentence_count":533,"boilerplate_hits":7,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Benchmark GP Chetan Puttagunta on how AI startups pick winners, compress 180-day sales cycles to 30 days, and why the first $1M is harder ... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=capital_startup
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   VC: How Benchmark Invests & What to Know on GTM | Chetan Puttagunta (GP) Sophie Buonassisi June 24, 2026 Podcasts Listen on YouTube // Apple // Spotify You can also watch/listen to the entire episode on X .
...
5. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   6B legal AI company that grew from $1M to $100M ARR in 18 months (despite a competitor already raising at $3B before they launched), Benchmark’s first-ever $2B growth fund, and tips on scaling in the AI era.
...
6. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Discussed in this episode Why the first $1M now takes longer than the next $99M in the AI era How top AI startups compress a 180 day sales cycle into 30 days The “trusted vendor” playbook for breaking incumbent distribution advantages Why Legora embedded inside a law firm for a year before launching How a magical demo plus a tightly scoped pilot collapses six month deals Why value is moving from the product build to the service and outcome What Benchmark actually looks for: technical insight that creates demand pul

## business_elements

- companies: keyword search, Anysearch, Anthropic, Apple, ServiceNow, Cursor
- products: cursor
- people: 暂无公开信息
...
- numbers: 180, 30, $1M, 24, 2026, $5.6B, $100M, 18 m
- quotes: trusted vendor / legal engineers

## evidence_seed

- company_actions: VC: How Benchmark Invests & What to Know on GTM | Chetan Puttagunta (GP) Sophie Buonassisi June 24, 2026 Podcasts Listen on YouTube // Apple // Spotify You can also watch/listen to the entire episode on X . / Benchmark’s General Partner Chetan Puttagunta joins GTMnow to give founders/operators an inside view to how they invest and think about go-to-market.
- case_details: 暂无公开信息
