...
search_path_label: ""
author: ""
published_at: "2026-07-03T03:24:23.000Z"
collected_at: 2026-07-04T04:50:50.097Z
language: mixed
full_text_hash: 2e7fbf4bbb7df9a4
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-015-interfaze-开源-diffusion-gemma-asr-small-基于-diffusiongemma-并行去噪解码器的多语言扩散.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-015-interfaze-开源-diffusion-gemma-asr-small-基于-diffusiongemma-并行去噪解码器的多语言扩散.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":46276,"paragraph_count":392,"sentence_count":132,"boilerplate_hits":2,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 46276
fetch_error: ""
...
discovery_record: {"discovery_title":"Interfaze 开源 diffusion-gemma-asr-small，基于 DiffusionGemma 并行去噪解码器的多语言扩散 ASR 模型","discovery_summary":"Interfaze 开源了 diffusion-gemma-asr-small，据称是首个开源多语言扩散 ASR 模型。该模型使用 DiffusionGemma 的离散扩散解码器（26B MoE 骨干，4B 激活参数，128 专家 top-8 路由）进行非自回归语音转文本。仅训练约 42M 参数适配器，冻结 backbone；采用 frozen whisper-small 编码器提取 1500 帧 768 维特征，经可训练投影器（约 19M 参数）压缩为 188 个 2816 维音频 token 注入提示槽，解码器双向并行去噪约 16 步。单适配器支持六种语言。在 LibriSpeech test-clean 上 WER 6.6%，优于同类扩散模型 Whisfusion（8.3%），但落后自回归 Whisper。去噪步数从 8 增至 48 仅提升约 0.1 个 WER 点，8 步时达 14.9 倍实时速度。适配器以 Apache-2.0 开源，DiffusionGemma 和 whisper-small 需单独加载。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/02/interfaze-ships-diffusion-gemma-asr-small-an-open-source-diffusion-asr-model-transcribing-six-languages-via-diffusiongemmas-parallel-denoising-decoder","discovered_at":"2026-07-04T03:11:32.695Z","rank_on_page":231,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: bb9acb9b930baa6f
content_hash: 86e83d1a5a10955f
semantic_hash: c90fe61de1c10c20
duplicate_of: ""
first_seen_at: "2026-07-03T03:24:23.000Z"
last_seen_at: 2026-07-04T04:50:50.097Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Claude","GPT-5","Agent","Agents","MCP","Cursor","Gemini","Codex"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["26B","4B","128","8","42M","1500","768","19M"],"quotes":["audio tokens","transformers @ git+https://github.com/huggingface/transformers.git","interfaze-ai/diffusion-gemma-asr-small","{repo}/diffusion_asr_small.pt",")\nwav, sr = sf.read("]}
...
fact_extraction_completed_at: 2026-07-04T04:50:50.097Z
...
Michal Sutter
Meta Releases TRIBE v2: A Brain Encoding Model That Predicts fMRI Respons
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":46276,"paragraph_count":392,"sentence_count":132,"boilerplate_hits":2,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Technology Artificial Intelligence Language Model Audio Language Model Editors Pick New Releases Open Source TTS Voice AI Interfaze, a young YC’s startup, has open-sourced a new speech recognition model.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It is called diffusion-gemma-asr-small .
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The model transcribes audio through a diffusion decoder, not an autoregressive one.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It is described as the first multilingual audio diffusion ASR model.
...
- numbers: 26B, 4B, 128, 8, 42M, 1500, 768, 19M
- quotes: audio tokens / transformers @ git+https://github.com/huggingface/transformers.git / interfaze-ai/diffusion-gemma-asr-small / {repo}/diffusion_asr_small.pt / )
wav, sr = sf.read(

## evidence_seed

- company_actions: Technology Artificial Intelligence Language Model Audio Language Model Editors Pick New Releases Open Source TTS Voice AI Interfaze, a young YC’s startup, has open-sourced a new speech recognition model. / It is called diffusion-gemma-asr-small . / The model transcribes audio through a diffusion decoder, not an autoregressive one.
- case_details: 暂无公开信息
