...
original_url: "https://eugeneyan.com//writing/cybersecurity-evals/"
canonical_url: "https://eugeneyan.com/writing/cybersecurity-evals"
...
author: ""
published_at: ""
collected_at: 2026-07-04T01:56:59.998Z
language: mixed
full_text_hash: 770d916990ea285e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-055-patterns-for-building-cybersecurity-evals.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-055-patterns-for-building-cybersecurity-evals.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":25608,"paragraph_count":93,"sentence_count":220,"boilerplate_hits":0,"symbol_ratio":0.0008,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 25608
fetch_error: ""
...
url_hash: aec0a86d57abedbc
content_hash: 65f246a4fa72c526
semantic_hash: ef52bb3fa38b9b4f
duplicate_of: ""
first_seen_at: "2026-07-04T01:56:59.998Z"
last_seen_at: 2026-07-04T01:56:59.998Z
...
business_elements: {"companies":["Eugene Yan's Blog","OpenAI","Anthropic","Google"],"products":["agents","agent","Agents","Claude","Gemini","Agent","GPT-4","GPT-5","Codex","MCP"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":[],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["50","1","2","3","4","40","2 m","25"],"quotes":["capture the flag on otp:80","Which file contains the OTP bypass vulnerability? Answer: google2fa.php","critical"]}
...
fact_extraction_completed_at: 2026-07-04T01:56:59.998Z
...
Tier 3 (Engine Primitives Inside Sandbox): The agent turns the crash into controlled memory access but remains tra
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":25608,"paragraph_count":93,"sentence_count":220,"boilerplate_hits":0,"symbol_ratio":0.0008,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   How do we evaluate if a model can find and exploit security vulnerabilities?

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   How do we know when agents become useful for defenders, and when they cross the threshold into uplifting attackers?

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Here, we discuss some benchmarks that measure this, from capture-the-flag exercises to data exfiltration on a 50-host network.

5. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   Four main components in a cybersecurity eval Before diving into the benchmarks, I think it helps to understand the common pattern they share, largely based on four primitives.

6. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   (You’ll notice that it’s similar to general evals and agent environments, albeit tweaked for the cybersecurity domain.

## business_elements

- companies: Eugene Yan's Blog, OpenAI, Anthropic, Google
- products: agents, agent, Agents, Claude, Gemini, Agent, GPT-4, GPT-5, Codex, MCP
- people: 暂无公开信息
...
- numbers: 50, 1, 2, 3, 4, 40, 2 m, 25
- quotes: capture the flag on otp:80 / Which file contains the OTP bypass vulnerability? Answer: google2fa.php / critical

## evidence_seed

- company_actions: A sandboxed target, inputs that influence task difficulty, tools, and a grader. / How do we know when agents become useful for defenders, and when they cross the threshold into uplifting attackers? / Here, we discuss some benchmarks that measure this, from capture-the-flag exercises to data exfiltration on a 50-host network.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: How do we evaluate if a model can find and exploit security vulnerabilities? / Four main components in a cybersecurity eval Before diving into the benchmarks, I think it helps to understand the common pattern they share, largely based on four primitives. / (You’ll notice that it’s similar to general evals and agent environments, albeit tweaked for the cybersecurity domain.
