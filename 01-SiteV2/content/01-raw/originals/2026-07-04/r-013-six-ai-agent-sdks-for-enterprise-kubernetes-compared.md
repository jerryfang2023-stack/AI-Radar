...
author: ""
published_at: ""
collected_at: 2026-07-04T04:35:47.620Z
language: mixed
full_text_hash: a96fc658fd315419
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-013-six-ai-agent-sdks-for-enterprise-kubernetes-compared.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-013-six-ai-agent-sdks-for-enterprise-kubernetes-compared.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 174ddc6dde36f5fe
content_hash: a96fc658fd315419
semantic_hash: e7e690d8da486daf
duplicate_of: ""
first_seen_at: "2026-07-04T04:35:47.620Z"
last_seen_at: 2026-07-04T04:35:47.620Z
...
business_elements: {"companies":["Tigera Blog (Calico","AI Security)","OpenAI","Anthropic","Google","Microsoft","Amazon","Mistral"],"products":["agent","agents","Claude","Gemini","Agent","Agents"],"people":[],"industries":["金融 / 保险","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["8217","8220","8221","20","2026","2","2.0","100"],"quotes":["which agent SDK should we standardize on for our Kubernetes clusters?","build an agent in 20 lines","this workflow is genuinely complicated and has to survive restarts,","researcher"," can work with almost any generative AI model ,"]}
...
fact_extraction_completed_at: 2026-07-04T04:35:47.620Z
...
Python, JS/TS
MIT
Durable checkpointed state, pause/resume/rewind, model-agnostic
Operationally heavy (Postgres + Redis), commercial platform tier, steeper mental model
Complex, long-running workflows that must survive restarts
CrewAI
Python
MIT
Fastest to ship, lowest learning curve, model-agnostic, K8s-native via KAgent
Less fine-grained step control, the role abstraction can over-decide
Rapid multi-agent collaboration, prototype to production
Google ADK
Python, TS, Go, Java, Kotlin
Apache 2.0
Native A2A, hierarchical delegation, broad language support, works with almost any model via LiteLLM
Gemini-first defaults, branding implies GCP lock-in
Multi-framework systems betting on agent-to-agent interop
Microsoft Agent Framework
Python, .NET (C#)
MIT
Creative plus deterministic orchestration, first-party connectors including Ollama, reached 1.0
Youngest of the group, hosted agent service is Azure-only
C#/.NET teams needing both orchestration styles
OpenAI Agents SDK
Python, JS/TS
MIT
Cleanest developer experience, small API, runs local models via OpenAI-compatible endpoints (LiteLLM/Any-LLM as beta options)
OpenAI is the default and best-supported path; broad provider routing is beta
Teams who want speed, lean on OpenAI, but want an escape hatch
Anthropic Claude Agent SDK
Python, TS
MIT code; use under Anthropic Commercial ToS
Claude Code engine as a library, ships Docker and K8s manifests
Claude-only (no non-Anthropic or local models), stateful subprocess hosting model
Claude-centric teams comfortable routing via Bedrock or Gemini Enterprise
...
1. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   There&#8217;s a question we hear constantly from platform and engineering leaders right now, &#8220;which agent SDK should we standardize on for our Kubernetes clusters?&#8221; The honest answer is that the question is slightly wrong, and... The post Six AI agent SDKs for enterprise Kubernetes, compared appeared first on Tigera – Creator of Calico. ]]>
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   ” The honest answer is that the question is slightly wrong, and the rest of this post explains why.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   But it’s a fair question, so let’s compare the contenders first.

5. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=high｜confidence=high
   If you’re an enterprise running on-premise or in your own VPC, the SDK you pick has to do two things most of the “build an agent in 20 lines” tutorials skip over.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It has to run in a container you control, and it has to talk to a model you can host yourself.

## business_elements

- companies: Tigera Blog (Calico, AI Security), OpenAI, Anthropic, Google, Microsoft, Amazon, Mistral
- products: agent, agents, Claude, Gemini, Agent, Agents
- people: 暂无公开信息
...
- numbers: 8217, 8220, 8221, 20, 2026, 2, 2.0, 100
- quotes: which agent SDK should we standardize on for our Kubernetes clusters? / build an agent in 20 lines / this workflow is genuinely complicated and has to survive restarts, / researcher /  can work with almost any generative AI model ,

## evidence_seed

- company_actions: There&#8217;s a question we hear constantly from platform and engineering leaders right now, &#8220;which agent SDK should we standardize on for our Kubernetes clusters?&#8221; The honest answer is that the question is slightly wrong, and... The post Six AI agent SDKs for enterprise Kubernetes, compared appeared first on Tigera – Creator of Calico. ]]> / There’s a question we hear constantly from platform and engineering leaders right now, “which agent SDK should we standardize on for our Kubernetes clusters? / ” The honest answer is that the question is slightly wrong, and the rest of this post explains why.
- case_details: 暂无公开信息
