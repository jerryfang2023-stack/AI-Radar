...
raw_id: R-021
title: "Meet WebBrain：开源本地优先的AI浏览器智能体"
title_zh: "Meet WebBrain：开源本地优先的AI浏览器智能体"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://www.marktechpost.com/2026/07/02/meet-webbrain-an-open-source-local-first-ai-browser-agent-that-reads-pages-and-automates-tasks-in-chrome-and-firefox"
canonical_url: "https://marktechpost.com/2026/07/02/meet-webbrain-an-open-source-local-first-ai-browser-agent-that-reads-pages-and-automates-tasks-in-chrome-and-firefox"
...
search_path_label: ""
author: ""
published_at: "2026-07-03T05:55:47.000Z"
collected_at: 2026-07-04T04:50:50.167Z
language: mixed
full_text_hash: e6b0a02309741664
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-021-meet-webbrain-开源本地优先的ai浏览器智能体.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-021-meet-webbrain-开源本地优先的ai浏览器智能体.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":7165,"paragraph_count":64,"sentence_count":89,"boilerplate_hits":2,"symbol_ratio":0.0015,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 7165
fetch_error: ""
...
discovery_record: {"discovery_title":"Meet WebBrain：开源本地优先的AI浏览器智能体","discovery_summary":"WebBrain是一个免费、开源的浏览器智能体，基于MIT协议，支持Chrome和Firefox。它提供Ask（只读）和Act（通过Chrome DevTools Protocol执行点击、输入等操作）两种模式。本地模型下数据不出设备，也可通过API接入OpenAI、Anthropic Claude、Gemini、DeepSeek、Grok等云端模型。内置WebBrain Cloud服务每月5美元。安全设计包括权限提示和UI优先的修改规则，并支持llama.cpp、Ollama等本地部署方案。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/02/meet-webbrain-an-open-source-local-first-ai-browser-agent-that-reads-pages-and-automates-tasks-in-chrome-and-firefox","discovered_at":"2026-07-04T03:11:32.691Z","rank_on_page":212,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 096938f83dbddfce
content_hash: e6b0a02309741664
semantic_hash: da49da0dee44086d
duplicate_of: ""
first_seen_at: "2026-07-03T05:55:47.000Z"
last_seen_at: 2026-07-04T04:50:50.167Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","GitHub","Nvidia","Mistral"],"products":["Claude","Gemini","Agents","agent","agents"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["5美元","3","2","0.15","0.3","0","$20","$5"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-04T04:50:50.167Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":7165,"paragraph_count":64,"sentence_count":89,"boilerplate_hits":2,"symbol_ratio":0.0015,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   WebBrain是一个免费、开源的浏览器智能体，基于MIT协议，支持Chrome和Firefox。它提供Ask（只读）和Act（通过Chrome DevTools Protocol执行点击、输入等操作）两种模式。本地模型下数据不出设备，也可通过API接入OpenAI、Anthropic Claude、Gemini、DeepSeek、Grok等云端模型。内置WebBrain Cloud服务每月5美元。安全设计包括权限提示和UI优先的修改规则，并支持llama.cpp、Ollama等本地部署方案。

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Editors Pick Agentic AI AI Agents Technology AI Shorts Artificial Intelligence Applications Large Language Model Machine Learning New Releases Open Source Promote Software Engineering Sponsored Staff Tech News Uncategorized WebBrain is a free, open-source browser agent for Chrome and Firefox.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It reads pages, extracts data, and automates multi-step tasks.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Unlike most browser AI plugins, it can also run entirely on a local model.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It is built by Emre Sokullu and licensed under MIT.
...
- companies: MarkTechPost（RSS）, OpenAI, Anthropic, GitHub, Nvidia, Mistral
- products: Claude, Gemini, Agents, agent, agents
- people: 暂无公开信息
...
- numbers: 5美元, 3, 2, 0.15, 0.3, 0, $20, $5
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Editors Pick Agentic AI AI Agents Technology AI Shorts Artificial Intelligence Applications Large Language Model Machine Learning New Releases Open Source Promote Software Engineering Sponsored Staff Tech News Uncategorized WebBrain is a free, open-source browser agent for Chrome and Firefox. / It reads pages, extracts data, and automates multi-step tasks. / Unlike most browser AI plugins, it can also run entirely on a local model.
- case_details: 暂无公开信息
