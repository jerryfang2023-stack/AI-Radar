...
original_url: "https://www.tigera.io/blog/multi-layer-policy-for-securing-ai-agents/"
canonical_url: "https://tigera.io/blog/multi-layer-policy-for-securing-ai-agents"
...
author: ""
published_at: ""
collected_at: 2026-07-04T04:35:48.269Z
language: mixed
full_text_hash: 94f9a192f3b481c8
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-080-multi-layer-policy-for-securing-ai-agents.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-080-multi-layer-policy-for-securing-ai-agents.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7518,"paragraph_count":45,"sentence_count":57,"boilerplate_hits":0,"symbol_ratio":0.0036,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 7518
fetch_error: ""
...
url_hash: 64f87ef20a0a1b81
content_hash: 94f9a192f3b481c8
semantic_hash: cb7f78d2a214c30e
duplicate_of: ""
first_seen_at: "2026-07-04T04:35:48.269Z"
last_seen_at: 2026-07-04T04:35:48.269Z
...
business_elements: {"companies":["Tigera Blog (Calico","AI Security)"],"products":["Agents","agents","Agent","agent","MCP"],"people":[],"industries":["金融 / 保险","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["7","3"],"quotes":["finance-agents","invokeTool","finance-readonly","data-analyst","readFile"]}
...
fact_extraction_completed_at: 2026-07-04T04:35:48.269Z
...
Best Practices AI Agent Security
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7518,"paragraph_count":45,"sentence_count":57,"boilerplate_hits":0,"symbol_ratio":0.0036,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   As part of our work at Tigera building products that create secure runtime environments for enterprise agents at scale in the real world, one small part of this puzzle I think about a lot is... The post Multi-Layer Policy for Securing AI Agents appeared first on Tigera – Creator of Calico. ]]>
...
3. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   The more companies we talk to trying to lock down and secure these platforms at runtime, the more I believe AI Agent security needs policy in multiple places, not just one (e.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   , not just at the gateway layer), and ideally expressed in the same policy language.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   At the L7 gateway layer, every agent call is observable: who is calling, what they are calling, what attributes both sides carry, what the requested action is.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   This is where you decide whether an agent should be permitted to talk to a particular MCP server, invoke a particular tool, delegate to another agent, or call a particular LLM.
...
- numbers: 7, 3
- quotes: finance-agents / invokeTool / finance-readonly / data-analyst / readFile

## evidence_seed

- company_actions: As part of our work at Tigera building products that create secure runtime environments for enterprise agents at scale in the real world, one small part of this puzzle I think about a lot is... The post Multi-Layer Policy for Securing AI Agents appeared first on Tigera – Creator of Calico. ]]> / As part of our work at Tigera building products that create secure runtime environments for enterprise agents at scale in the real world, one small part of this puzzle I think about a lot is policy, and runtime enforcement of policy, and how to create a comprehensive secure runtime, configured from one place. / , not just at the gateway layer), and ideally expressed in the same policy language.
- case_details: 暂无公开信息
...
- risks_or_constraints: The more companies we talk to trying to lock down and secure these platforms at runtime, the more I believe AI Agent security needs policy in multiple places, not just one (e.
