...
original_url: "https://eugeneyan.com//writing/semantic-ids/"
canonical_url: "https://eugeneyan.com/writing/semantic-ids"
...
author: ""
published_at: ""
collected_at: 2026-07-04T04:50:50.451Z
language: mixed
full_text_hash: 58c421829083e8b9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-060-training-an-llm-recsys-hybrid-for-steerable-recs-with-semantic-ids.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-060-training-an-llm-recsys-hybrid-for-steerable-recs-with-semantic-ids.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":85,"text_length":32120,"paragraph_count":205,"sentence_count":272,"boilerplate_hits":0,"symbol_ratio":0.0269,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
has_full_text: true
content_length: 32120
fetch_error: ""
...
url_hash: 30e1c9474e706785
content_hash: e01c4f05a2208c75
semantic_hash: a0ac901ff5a2019f
duplicate_of: ""
first_seen_at: "2026-07-04T04:50:50.451Z"
last_seen_at: 2026-07-04T04:50:50.451Z
...
business_elements: {"companies":["Eugene Yan's Blog","Amazon"],"products":["Gemini"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":[],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["23 m","0","1","2","173","324","764","768"],"quotes":["bilingual","animal and cute","Animal Crossing: New Leaf","DISNEY INFINITY Starter Pack 3DS","Nintendogs + Cats: Golden Retriever and New Friends"]}
...
fact_extraction_completed_at: 2026-07-04T04:50:50.451Z
theme: uncategorized
...
hidden_states = self . forward ( input_ids ) # [B, T,
...
🩷
or Search
&laquo; Evaluating Long-Context Question & Answer Systems
Advice for New Principal Tech ICs (i.e., Notes to Myself) &raquo;
...
- fetch_status: fetched-readable-text-body-visible-text
- extraction_quality: high
- diagnostics: {"readability_score":85,"text_length":32120,"paragraph_count":205,"sentence_count":272,"boilerplate_hits":0,"symbol_ratio":0.0269,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Training an LLM-RecSys Hybrid for Steerable Recs with Semantic IDs eugeneyan Start Here Writing Speaking Prototyping About Training an LLM-RecSys Hybrid for Steerable Recs with Semantic IDs llm recsys learning 🛠 🩷 · 23 min read I got nerdsniped when I first heard about Semantic IDs.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   I wondered, could we train an LLM-recommender hybrid on the rich behavioral data that makes today’s recommender systems so effective?
...
6. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   The result is a language model that can converse in both English and item IDs, not with retrieval or other tools, but as a single, “bilingual” model where items (i.
...
- numbers: 23 m, 0, 1, 2, 173, 324, 764, 768
- quotes: bilingual / animal and cute / Animal Crossing: New Leaf / DISNEY INFINITY Starter Pack 3DS / Nintendogs + Cats: Golden Retriever and New Friends

## evidence_seed

- company_actions: An LLM that can converse in English &amp; item IDs, and make recommendations w/o retrieval or tools. / Training an LLM-RecSys Hybrid for Steerable Recs with Semantic IDs eugeneyan Start Here Writing Speaking Prototyping About Training an LLM-RecSys Hybrid for Steerable Recs with Semantic IDs llm recsys learning 🛠 🩷 · 23 min read I got nerdsniped when I first heard about Semantic IDs. / The idea is simple: Instead of using random hash IDs for videos or songs or products, we can use semantically meaningful tokens that an LLM can natively understand.
- case_details: 暂无公开信息
