...
original_url: "https://eugeneyan.com//writing/synthetic/"
canonical_url: "https://eugeneyan.com/writing/synthetic"
...
author: ""
published_at: ""
collected_at: 2026-07-04T04:35:48.237Z
language: mixed
full_text_hash: fd606f4a0483184c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-075-how-to-generate-and-use-synthetic-data-for-finetuning.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-075-how-to-generate-and-use-synthetic-data-for-finetuning.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":4779,"paragraph_count":38,"sentence_count":30,"boilerplate_hits":1,"symbol_ratio":0.0048,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 4779
fetch_error: ""
...
url_hash: 588c094f444f8e1d
content_hash: fd606f4a0483184c
semantic_hash: e919e021477f5367
duplicate_of: ""
first_seen_at: "2026-07-04T04:35:48.237Z"
last_seen_at: 2026-07-04T04:35:48.237Z
...
business_elements: {"companies":["Eugene Yan's Blog","Google"],"products":["ChatGPT"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["法务 / 律师"],"workflows":["合同审阅 / 法律研究"],"business_actions":[],"affected_departments":["IT / 安全","法务"],"numbers":["1","1.5","2","7B","2022","3","175","0"],"quotes":["seed_task_0","breakfast_suggestion","instruction","Is there anything I can eat for a breakfast that doesn't include eggs,\nyet includes protein, and has roughly 700-1000 calories?","instances"]}
...
fact_extraction_completed_at: 2026-07-04T04:35:48.237Z
...
Preference-tuning
Distillation
TinyStories , Phi-1 (textbooks) , Phi-1.5
Unnatural Instructions , Alpaca , Alpagaus , Vicuna , Orca , Orca2 , WizardLM
Code : WizardCoder , MagicCoder , WaveCoder , Phi-1 (exercises)
Starling-7B ,
Self-improvement
AlphaGeometry , WRAP
Self-Instruct , SPIN , Instruction Backtranslation , $\text {ReST}^{EM}$ , CAI (SFT)
SteerLM , Self-Rewarding , CAI (RL)
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   It is increasingly viable to use synthetic data for pretraining, instruction-tuning, and preference-tuning.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Relative to human annotation, it’s faster and cheaper to generate task-specific synthetic data.
...
6. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=medium｜confidence=high
   Finally, synthetic data sidesteps privacy and copyright concerns by avoiding reliance on user data or possibly copyrighted content.

## business_elements

- companies: Eugene Yan's Blog, Google
- products: ChatGPT
- people: 暂无公开信息
...
- numbers: 1, 1.5, 2, 7B, 2022, 3, 175, 0
- quotes: seed_task_0 / breakfast_suggestion / instruction / Is there anything I can eat for a breakfast that doesn't include eggs,
yet includes protein, and has roughly 700-1000 calories? / instances

## evidence_seed

- company_actions: Overcoming the bottleneck of human annotations in instruction-tuning, preference-tuning, and pretraining. / It is increasingly viable to use synthetic data for pretraining, instruction-tuning, and preference-tuning. / Synthetic data refers to data generated via a model or simulated environment, instead of naturally occurring on the internet or annotated by humans.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。
- affected_roles: 法务 / 律师
- risks_or_constraints: Finally, synthetic data sidesteps privacy and copyright concerns by avoiding reliance on user data or possibly copyrighted content.
