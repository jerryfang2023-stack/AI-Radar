...
raw_id: R-017
title: "Microsoft AI Technologies Reference"
title_zh: ""
title_translation_status: needs_ingestion_translation
title_translation_method: missing_translation_db_entry
original_url: "https://microsoft.github.io/Microsoft-AI-Decision-Framework/docs/technologies.html"
canonical_url: "https://microsoft.github.io/Microsoft-AI-Decision-Framework/docs/technologies.html"
...
author: ""
published_at: ""
collected_at: 2026-07-04T04:35:47.645Z
language: mixed
full_text_hash: f41063c9e2fec8cd
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-017-microsoft-ai-technologies-reference.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-04/r-017-microsoft-ai-technologies-reference.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 9f6a35898bbb04e6
content_hash: 896db190bdc1bc29
semantic_hash: d4e5863a7a2826cf
duplicate_of: ""
first_seen_at: "2026-07-04T04:35:47.645Z"
last_seen_at: 2026-07-04T04:35:47.645Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","Microsoft","GitHub","Amazon"],"products":["agent","Agents","Copilot","Agent","agents","GPT-5","Claude","MCP","GPT-4"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["2026","365","2025","12","01","07","03","25"],"quotes":["Agent Mode","Allow ungrounded responses"]}
...
fact_extraction_completed_at: 2026-07-04T04:35:47.645Z
...
Table of contents
Microsoft AI Technologies Reference Table of contents Core AI Platforms
...
AI Builder {: .tech-heading } Data & Analytics Platforms {: .no_toc }
Microsoft Fabric {: .tech-heading } Local and Edge AI {: .no_toc }
Foundry Local {: .tech-heading }
Foundry Local on Azure Local (Preview) {: .tech-heading }
Windows AI APIs and Windows ML {: .tech-heading }
Microsoft Execution Containers (MXC) (Early Preview) {: .tech-heading } Developer Tools {: .no_toc }
...
Microsoft Agent Framework {: .tech-heading } Agent Runtime Alternatives (Preview) {: .no_toc }
Technology Selection Quick Guide
Network Isolation Decision Matrix
Identity & Permissions Architecture {: .tech-heading } Implementation Approach {: .no_toc }
...
Sources:
Microsoft 365 Copilot release notes - Oct 28, 2025 (Retrieved: 2026-03-25)
Microsoft 365 Copilot release notes - Aug 19, 2025 (Retrieved: 2026-03-25)
Microsoft 365 Copilot release notes - Aug 5, 2025 (Retrieved: 2026-03-25)
Microsoft 365 Copilot release notes - Jul 8, 2025 (Retrieved: 2026-03-25)
Agents for Microsoft 365 Copilot (Retrieved: 2026-01-07)
Extend Microsoft 365 Copilot with agents (Retrieved: 2025-12-15)
Data, privacy, and security considerations for extending Microsoft 365 Copilot (Retrieved: 2025-09-05)
Wave 3: Powering Frontier Transformation (Published: 2026-03-09)
Copilot Cowork announcement (Published: 2026-03-09)
Microsoft 365 Copilot release notes - Mar 24, 2026 (Retrieved: 2026-03-25)
Word, Excel, and PowerPoint Agents (Frontier) {: .tech-heading }
...
Sources:
Get started with Word, Excel, and PowerPoint Agents (Frontier) (Retrieved: 2026-03-30)
Frequently asked questions about Word, Excel, and PowerPoint Agents: Responsible AI FAQ (Retrieved: 2026-03-30)
Manage Microsoft 365 Copilot scenarios in the Microsoft 365 admin center (Retrieved: 2026-03-16)
Overview of Microsoft Agent 365 (Retrieved: 2025-12-15)
Microsoft Scout (Experimental) {: .tech-heading }
...
Sources:
Introducing Microsoft Scout: your always-on personal agent (Published: 2026-06-02)
Microsoft Scout setup instructions (Retrieved: 2026-06-11)
Copilot Studio
Description: Low-code and pro-code authoring environment for building declarative and custom engine agents with governance, analytics, and multi-channel delivery. Available as a standalone web app and inside Microsoft Teams. Official Docs: Copilot Studio Documentation Implementation Guide: aka.ms/CopilotStudioImplementationGuide
Key Features:
...
Grounding controls: “Allow ungrounded responses” toggle, Tenant Graph semantic search (requires M365 Copilot license), and content moderation at three levels (agent, topic, prompt). ( Knowledge sources - Updated: 2026-04-03)
...
Orchestration modes: Generative orchestration (default) handles multi-intent planning; makers can switch to Classic NLU/Classic NLU+ for deterministic topic routing or connect Azure AI Language (CLU) for advanced entity extraction w
...
Work IQ MCP integration (Preview): Add Work IQ MCP tools (Mail, Calendar, Teams, SharePoint, OneDrive) directly from the Tools tab to give agents real-time organizational context - the same intelligence layer that powers M365 Copilot. Requires M365 Copilot license. ( Work IQ MCP in Copilot Studio - Updated: 2026-03-11)
Custom MCP server authoring (Preview → Apr GA): Create or clone governed MCP servers that combine connector actions, tools from other MCPs, and custom APIs. Servers are reusable across Microsoft Copilot, VS Code, GitHub, Claude, and other agents. DLP policies and access controls apply at server and tool level. ( Custom MCP servers - Updated: 2026-03-18)
...
Sources:
What’s new in Copilot Studio (Updated: 2026-03-06)
Microsoft 365 Copilot release notes - Aug 5, 2025 (Retrieved: 2026-03-25)
Use up to 1000 files per agent for SharePoint and OneDrive uploads (GA: 2025-10-06)
Group files with instructions to guide agent answers (GA: 2025-10-01)
Publish agents to WhatsApp (GA: 2025-09-08)
Upgrade to Copilot Studio unified authoring (Retrieved: 2025-05-21)
VNet data gateway overview (Retrieved: 2026-01-06)
Natural language understanding (NLU) overview (Updated: 2025-07-07)
Create and edit topics in Copilot Studio (Updated: 2025-11-11)
Computer Use (GA) (Updated: 2026-04-03)
Work IQ MCP in Copilot Studio (Preview) (Updated: 2026-03-11)
Custom MCP servers (Updated: 2026-03-18)
VS Code extension for Copilot Studio (GA: 2026-01-01)
Copilot Studio Kit (Retrieved: 2026-03-25)
Power Apps Plan Designer
...
Assistants API sunsets August 26, 2026: Migrate to the Foundry Agents Service (Responses API). A migration tool is available. Threads → Conversations, Runs → Responses, Assistants → Agents (new). Key differences: MCP is GA in new agents (was Preview), Azure Functions not available (use MCP or Logic Apps), Connected Agents replaced by Workflow + A2A. (Migrate from classic portal - Retrieved: 2026-03-30)
...
Sources:
What’s new in Azure OpenAI in Microsoft Foundry Models (Updated: 2026-02-27)
What’s new in Azure OpenAI in Microsoft Foundry Models (Updated: 2026-02-27)
What’s new in Azure OpenAI in Microsoft Foundry Models (Updated: 2026-02-27)
What’s new in model router in Microsoft Foundry Models? (Updated: 2026-03-24)
Foundry models sold directly by Azure (Retrieved: 2025-11-13)
What is Microsoft Foundry (Azure)? (Retrieved: 2026-03-13)
How to configure a private link for Microsoft Foundry (Azure) (Retrieved: 2026-01-06)
Create a secure Microsoft Foundry (Azure) hub and project with a managed virtual network (Retrieved: 2025-12-23)
New Microsoft Foundry portal GA overview (Retrieved: 2026-03-19)
How to configure network isolation for Microsoft Foundry (Retrieved: 2026-03-19)
Configure managed virtual network for Microsoft Foundry projects (Retrieved: 2026-03-19)
Voice Live overview (Retrieved: 2026-03-19)
Voice Agent with Foundry Agent Service quickstart (Retrieved: 2026-03-19)
Foundry Agent Service {: .tech-heading }
Description: Managed PaaS for agent orchestration, skills management, and runtime infrastructure within Microsoft Foundry (Azure) . Supports connected agents (multi-agent systems), 15+ built-in tools, full RBAC + VNet + BYO storage. GA with continuous feature additions. The next-gen service is built on the OpenAI Responses API, making it wire-compatible with OpenAI’s agentic protocol. (Formerly Azure AI Agent Service ). Official Docs: Foundry Agent Service Status: GA (May 2025; next-gen on Responses API: March 2026)
Key Features:
...
Sources:
What’s new in Microsoft Foundry (Updated: 2026-03-23)
Foundry Agent Service overview
Agent Tool Catalog
Transparency Note for Azure Agent Service
Virtual Networks for Foundry
Azure Cosmos DB integration with Azure AI Agents Service
Foundry Agent Service GA announcement (Published: 2026-03-16)
Agent 365 {: .tech-heading }
...
Sources:
Overview of Microsoft Agent 365 (Retrieved: 2026-03-13)
Microsoft Agent 365 SDK (Retrieved: 2026-01-09)
Agent 365 CLI (Retrieved: 2026-01-13)
What is Microsoft Entra Agent ID? (Updated: 2026-03-25)
Agent identities in Microsoft Entra Agent ID (Retrieved: 2025-11-04)
Manage Microsoft 365 Copilot scenarios in the Microsoft 365 admin center (Retrieved: 2026-03-16)
Foundry Control Plane {: .tech-heading }
...
Sources:
Foundry Control Plane overview (Updated: 2026-02-27)
AI security: what’s new (Nov 2025) (Updated: 2025-05-19)
Azure AI Search {: .tech-heading }
...
Sources:
What’s new in Azure AI Search (Updated: 2026-03-13)
What’s new in Azure AI Search (Sep 2025) (Updated: 2026-03-13)
Optimize costs for Azure AI Search Serverless (Public Preview) (Updated: 2026-06)
Foundry IQ {: .tech-heading }
...
Sources:
Foundry IQ overview (Retrieved: 2026-03-19)
Foundry IQ FAQ (Retrieved: 2026-03-19)
Connect Foundry IQ to Foundry Agent Service (Retrieved: 2026-03-19)
Work IQ (Preview) {: .tech-heading }
Description: Work IQ is the intelligence layer that powers Microsoft 365 Copilot, and now your agents can use the same engine. It applies an extensive, continuously updated understanding of how your organization works to deliver personalized search, advanced reasoning, and semantic understanding grounded in real-time M365 signals. When you connect an agent to Work IQ, you’re not adding a data connector; you’re giving it the same contextual brain that Copilot uses to understand your emails, meetings, documents, chats, and business systems. Official Docs: Work IQ MCP overview Status: Preview (Work IQ MCP tools and the Work IQ API are Preview as of June 2026; requires M365 Copilot license)
Key Features:
...
Work IQ CLI: Command-line interface and MCP server that bridges AI coding assistants (GitHub Copilot, VS Code, Claude Code) and M365 data. Query emails, meetings, documents, and Teams messages from the terminal. In MC
...
1. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=medium｜confidence=high
   Microsoft AI Technologies Reference. This section provides a comprehensive overview of Microsoft's AI technology stack, from end-user productivity tools to ... / query=AI coding agent API SDK release enterprise product update 2026 / intent=find_original_source / path=official_original
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Microsoft AI Technologies Reference This section provides a comprehensive overview of Microsoft’s AI technology stack, from end-user productivity tools to infrastructure services.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Problem-first reminder: Start with the business outcome and scenario, then pick the simplest technology that satisfies it.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Use Scenarios to anchor real problems and the Decision Framework to gate technology choices.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Table of contents Microsoft AI Technologies Reference Table of contents Core AI Platforms Word, Excel, and PowerPoint Agents (Frontier) {: .

## business_elements

- companies: keyword search, Anysearch, OpenAI, Anthropic, Google, Microsoft, GitHub, Amazon
- products: agent, Agents, Copilot, Agent, agents, GPT-5, Claude, MCP, GPT-4
- people: 暂无公开信息
...
- numbers: 2026, 365, 2025, 12, 01, 07, 03, 25
- quotes: Agent Mode / Allow ungrounded responses

## evidence_seed

- company_actions: Microsoft AI Technologies Reference. This section provides a comprehensive overview of Microsoft's AI technology stack, from end-user productivity tools to ... / query=AI coding agent API SDK release enterprise product update 2026 / intent=find_original_source / path=official_original / Microsoft AI Technologies Reference This section provides a comprehensive overview of Microsoft’s AI technology stack, from end-user productivity tools to infrastructure services. / Problem-first reminder: Start with the business outcome and scenario, then pick the simplest technology that satisfies it.
- case_details: 暂无公开信息
- workflow_changes: Use this page as a reference after you’ve narrowed the decision: it’s optimized for confirming capabilities, boundaries, and status (GA/Preview) rather than teaching the selection process.
