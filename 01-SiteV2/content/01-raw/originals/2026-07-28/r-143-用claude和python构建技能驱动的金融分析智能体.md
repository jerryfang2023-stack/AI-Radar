...
author: ""
published_at: ""
collected_at: 2026-07-28T05:40:18.596Z
language: mixed
full_text_hash: d3f211c014c656a9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-28/r-143-用claude和python构建技能驱动的金融分析智能体.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-28/r-143-用claude和python构建技能驱动的金融分析智能体.json"
html_snapshot_path: ""
screenshot_path: ""
...
content_hash: d3f211c014c656a9
semantic_hash: 2ff9c971ea710701
duplicate_of: ""
first_seen_at: "2026-07-28T05:40:18.596Z"
last_seen_at: 2026-07-28T05:40:18.596Z
...
business_elements: {"companies":["MarkTechPost（RSS）","Anthropic"],"products":["Claude"],"people":[],"industries":["金融 / 保险"],"roles":[],"workflows":[],"business_actions":[],"affected_departments":[],"numbers":[],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-28T05:40:18.596Z
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=medium
   md文件构建可搜索技能注册表，并创建可复用SkillAgent，将金融分析剧本注入Anthropic Messages API，支持迭代工具调用循环。
...
- company_actions: 本教程基于Anthropic的financial-services仓库，用纯Python复现其技能驱动架构。通过解析SKILL.md文件构建可搜索技能注册表，并创建可复用SkillAgent，将金融分析剧本注入Anthropic Messages API，支持迭代工具调用循环。 / 本教程基于Anthropic的financial-services仓库，用纯Python复现其技能驱动架构。 / md文件构建可搜索技能注册表，并创建可复用SkillAgent，将金融分析剧本注入Anthropic Messages API，支持迭代工具调用循环。
- case_details: 暂无公开信息
