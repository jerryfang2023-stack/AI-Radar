...
title_zh: "Anthropic 联合 Andon Labs 发布 Drone-Bench，评估 AI 模型自主操控无人机执行定位追踪任务的能力"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.anthropic.com/research/project-pilot"
canonical_url: "https://anthropic.com/research/project-pilot"
...
collected_at: 2026-07-25T02:25:19.846Z
language: mixed
full_text_hash: bc06e663779afa8b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-25/r-012-anthropic-联合-andon-labs-发布-drone-bench-评估-ai-模型自主操控无人机执行定位追踪任务的能力.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-25/r-012-anthropic-联合-andon-labs-发布-drone-bench-评估-ai-模型自主操控无人机执行定位追踪任务的能力.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":13686,"paragraph_count":49,"sentence_count":90,"boilerplate_hits":3,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 13686
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 联合 Andon Labs 发布 Drone-Bench，评估 AI 模型自主操控无人机执行定位追踪任务的能力","discovery_summary":"Anthropic 与 Andon Labs 合作推出 Drone-Bench，用于测试 AI 模型自主操控四旋翼无人机在室内环境中定位并追踪指定人员的能力。该基准将任务分解为 3D 地图重建、定位、导航、目标检测与跟随五个子任务，并通过软件复现实现快速评估。实验表明，该任务链的难度足以区分不同智能水平的模型，并揭示 AI 在物理世界操控能力上的进步轨迹。","source_name":"Anthropic：Research（发表成果 · 网页）","origin_url":"https://www.anthropic.com/research/project-pilot","discovered_at":"2026-07-25T02:16:33.192Z","rank_on_page":194,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 238cc7cbaf246003
content_hash: bc06e663779afa8b
semantic_hash: 709fceddd2e50192
duplicate_of: ""
first_seen_at: "2026-07-24T00:00:00.000Z"
last_seen_at: 2026-07-25T02:25:19.846Z
...
business_elements: {"companies":["Anthropic","Research（发表成果 · 网页）"],"products":["agents","Claude","Gemini","GPT-5"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["3","24","2026","1","2","15 m","4","2.5"],"quotes":["dual-use","Reconstruct"]}
...
fact_extraction_completed_at: 2026-07-25T02:25:19.846Z
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":88,"text_length":13686,"paragraph_count":49,"sentence_count":90,"boilerplate_hits":3,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
3. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   \ Anthropic Frontier Red Team Project Pilot: Can AI control a drone?
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Jul 24, 2026 Anthropic and Andon Labs Several of our research projects over the last year have looked at how frontier models interact with the physical world.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   In Project Vend , AI models ran a small shop; Project Fetch was an early look at robots as the intermediary between digital models and physical objects.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   As we recently noted in Project Fetch: Phase two , we’re already seeing improvements in model capability such that their ability to use off-the-shelf robots is on track to approach the ease with which coding agents use software tools.

## business_elements

- companies: Anthropic, Research（发表成果 · 网页）
- products: agents, Claude, Gemini, GPT-5
- people: 暂无公开信息
...
- numbers: 3, 24, 2026, 1, 2, 15 m, 4, 2.5
- quotes: dual-use / Reconstruct

## evidence_seed

- company_actions: Anthropic 与 Andon Labs 合作推出 Drone-Bench，用于测试 AI 模型自主操控四旋翼无人机在室内环境中定位并追踪指定人员的能力。该基准将任务分解为 3D 地图重建、定位、导航、目标检测与跟随五个子任务，并通过软件复现实现快速评估。实验表明，该任务链的难度足以区分不同智能水平的模型，并揭示 AI 在物理世界操控能力上的进步轨迹。 / Jul 24, 2026 Anthropic and Andon Labs Several of our research projects over the last year have looked at how frontier models interact with the physical world. / In Project Vend , AI models ran a small shop; Project Fetch was an early look at robots as the intermediary between digital models and physical objects.
- case_details: Project Pilot: Can AI models fly drones? / \ Anthropic Frontier Red Team Project Pilot: Can AI control a drone?
