...
raw_id: R-019
title: "AMD launches Helios AI rack on open Ethernet networking, stacks gigawatt deals with Anthropic, OpenAI and Microsoft"
title_zh: "AMD 推出基于开放以太网网络的 Helios AI 机架，与 Anthropic、OpenAI 和微软达成千兆瓦级交易"
title_translation_status: translated
title_translation_method: deepseek_title_translation
title_translation_model: deepseek-v4-flash
original_url: "https://www.fierce-network.com/cloud/amds-helios-bets-ai-networking-open-ethernet"
canonical_url: "https://fierce-network.com/cloud/amds-helios-bets-ai-networking-open-ethernet"
...
collected_at: 2026-07-25T02:25:23.719Z
language: mixed
full_text_hash: b0199e8c670ff0a0
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-25/r-019-amd-launches-helios-ai-rack-on-open-ethernet-networking-stacks-gigawat.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-25/r-019-amd-launches-helios-ai-rack-on-open-ethernet-networking-stacks-gigawat.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":9368,"paragraph_count":36,"sentence_count":49,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 9368
fetch_error: ""
...
url_hash: 5a2049b6dcae7f75
content_hash: b0199e8c670ff0a0
semantic_hash: a2bb0cd8fdca8438
duplicate_of: ""
first_seen_at: "2026-07-23T00:00:00.000Z"
last_seen_at: 2026-07-25T02:25:23.719Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","Microsoft","Meta","Amazon","Nvidia","Deloitte","Cursor"],"products":["agents","Claude","Codex","Cursor","Gemini"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队","销售 / 客服"],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2026","72","23","3","05","30%","455X","72 M"],"quotes":["At AI scale, networking is becoming as crucial as GPUs, CPUs, memory and storage to deliver continuous performance,","virtual pods","eventual winner","More and more purchasing decisions are made inferencing first,","I used to talk to our customers about CUDA a fair bit. I have almost zero conversations with our customers about CUDA at this point in time,"]}
...
fact_extraction_completed_at: 2026-07-25T02:25:23.719Z
...
The 2026 Fierce Network Innovation Awards are Now Open for Submissions. Enter Today
Cloud
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9368,"paragraph_count":36,"sentence_count":49,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   AMD launches Helios AI rack on open Ethernet networking, stacks gigawatt deals with Anthropic, OpenAI and Microsoft The 2026 Fierce Network Innovation Awards are Now Open for Submissions. Enter Today # AMD's Helios bets AI networking on open Ethernet - AMD launches Helios, a 72-GPU rack built on ... / query=AI server product launch enterprise inference / intent=find_original_source / path=ai_hardware_original
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The 2026 Fierce Network Innovation Awards are Now Open for Submissions.
...
3. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Enter Today Cloud AMD's Helios bets AI networking on open Ethernet By Mitch Wagner Jul 23, 2026 3:05pm AMD artificial intelligence (AI) data center Ethernet AMD launches Helios, a 72-GPU rack built on UALink over Ethernet, Pensando DPUs and AI NICs rather than proprietary interconnects Anthropic, OpenAI and Meta commit to gigawatt-scale Helios deployments; Microsoft and Oracle sign on AMD claims 30% more tokens per dollar than Nvidia's Rubin NVL72, though key networking performance figures come from AMD simulations
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Every fabric in the rack, from the front-end network to the GPU-to-GPU interconnect, runs on Ethernet and open standards rather than the proprietary links that dominate today's AI clusters.
...
5. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Helios connects 72 MI455X GPUs into a single scale-up domain with 31 TB of unified HBM4 memory, 2.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   9 exaflops of peak FP4 compute and 260 TB/s of scale-up bandwidth, alongside AMD's 6th Gen EPYC "Venice" CPUs and Pensando networking silicon.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Anthropic, Google, Microsoft, Meta, Amazon, Nvidia, Deloitte, Cursor
- products: agents, Claude, Codex, Cursor, Gemini
- people: 暂无公开信息
...
- numbers: 2026, 72, 23, 3, 05, 30%, 455X, 72 M
- quotes: At AI scale, networking is becoming as crucial as GPUs, CPUs, memory and storage to deliver continuous performance, / virtual pods / eventual winner / More and more purchasing decisions are made inferencing first, / I used to talk to our customers about CUDA a fair bit. I have almost zero conversations with our customers about CUDA at this point in time,

## evidence_seed

- company_actions: AMD launches Helios AI rack on open Ethernet networking, stacks gigawatt deals with Anthropic, OpenAI and Microsoft The 2026 Fierce Network Innovation Awards are Now Open for Submissions. Enter Today # AMD's Helios bets AI networking on open Ethernet - AMD launches Helios, a 72-GPU rack built on ... / query=AI server product launch enterprise inference / intent=find_original_source / path=ai_hardware_original / The 2026 Fierce Network Innovation Awards are Now Open for Submissions. / Every fabric in the rack, from the front-end network to the GPU-to-GPU interconnect, runs on Ethernet and open standards rather than the proprietary links that dominate today's AI clusters.
- case_details: 暂无公开信息
