...
language: mixed
full_text_hash: 144168fcdc915f57
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-25/r-149-claude-code-v2-1-219-发布-新增-claude-opus-5-支持-1m-上下文与嵌套子智能体.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-25/r-149-claude-code-v2-1-219-发布-新增-claude-opus-5-支持-1m-上下文与嵌套子智能体.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Claude Code v2.1.219 发布：新增 Claude Opus 5，支持 1M 上下文与嵌套子智能体","discovery_summary":"Claude Code v2.1.219 新增 Claude Opus 5 作为默认 Opus 模型，支持 1M 上下文窗口，快速模式定价为 $10/$50 每百万 token。","source_name":"Claude Code：GitHub Releases（RSS）","origin_url":"","discovered_at":"2026-07-25T02:16:30.077Z","rank_on_page":9,"discovery_status":"discovered"}
...
content_hash: 144168fcdc915f57
semantic_hash: 382e405e969cbecf
duplicate_of: ""
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）"],"products":["Claude"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":[],"business_actions":["发布 / 推出","定价 / 计费变化"],"affected_departments":[],"numbers":["2.1","219","5","1M","$10","$50"],"quotes":[]}
...
2. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=medium
   219 新增 Claude Opus 5 作为默认 Opus 模型，支持 1M 上下文窗口，快速模式定价为 $10/$50 每百万 token。
