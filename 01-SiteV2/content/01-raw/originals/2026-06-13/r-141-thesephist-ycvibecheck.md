...
raw_id: R-141
title: "thesephist/ycvibecheck"
original_url: "https://github.com/thesephist/ycvibecheck"
canonical_url: "https://github.com/thesephist/ycvibecheck"
...
author: ""
published_at: ""
collected_at: 2026-06-13T05:32:37.490Z
language: mixed
full_text_hash: 4edfa6a25b3d96a2
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-13/r-141-thesephist-ycvibecheck.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-13/r-141-thesephist-ycvibecheck.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":7492,"paragraph_count":37,"sentence_count":48,"boilerplate_hits":2,"symbol_ratio":0.0021,"method":"main"}
has_full_text: true
content_length: 7492
fetch_error: ""
...
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"4edfa6a25b3d96a2","missing":[]}
...
url_hash: e99584178625b86c
content_hash: 4edfa6a25b3d96a2
semantic_hash: d3f48ecb1341abcf
duplicate_of: ""
first_seen_at: "2026-06-13T05:32:37.490Z"
last_seen_at: 2026-06-13T05:32:37.490Z
...
guanlan_scores: {"importance_type":"important_technical_trend","importance_score":5,"importance_reason":"technical trend or capability shift; rubric=5 major/platform/industry-shaping","supporting_signals":[],"novelty":3,"evidence_strength":4,"case_richness":4,"trend_relevance":5,"guanlan_relevance":4,"emerging_signal_score":5}
business_elements: {"companies":["keyword search","Anysearch"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":[],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全"],"numbers":["3","000","66\nm","32","2","66","69.4%","19.9%"],"quotes":["climate change","high-resolution commercial satellite imagery","embedding","neighbors"," will bring up companies with the subwords "]}
evidence_seed: {"company_actions":["Semantic search across every YC company ever. Vibe check your idea? **YC Vibe Check** uses _semantic similarity_ to search Y Combinator's entire portfolio of over 3,000 companies by descriptions of ideas or verticals rather than keywords or categories, which lets you search for something super broa.... / query=YC AI startup funding vertical AI / intent=find_startups / path=developer_ecosystem","thesephist ycvibecheck Public Notifications You must be signed in to change notification settings Fork Star 66 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 32 Commits 32 Commits data data lib lib server server src src static static .","gitignore LICENSE LICENSE Makefile Makefile README."],"case_details":[],"workflow_changes":[],"before_after_clues":[],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: ["证据对象不可用：疑似索引页、目录页、薄文本或非可用证据对象","疑似官网首页、产品目录或导航页，只能索引留存","没有具体客户或真实企业案例","没有变化前后流程线索"]
key_excerpts: [{"type":"funding","text":"Semantic search across every YC company ever. Vibe check your idea? **YC Vibe Check** uses _semantic similarity_ to search Y Combinator's entire portfolio of over 3,000 companies by descriptions of ideas or verticals rather than keywords or categories, which lets you search for something super broa.... / query=YC AI startup funding vertical AI / intent=find_startups / path=developer_ecosystem","supports":["daily_observation","heatmap","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"thesephist ycvibecheck Public Notifications You must be signed in to change notification settings Fork Star 66 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 32 Commits 32 Commits data data lib lib server server src src static static .","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"gitignore LICENSE LICENSE Makefile Makefile README.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"py refresh_yc_data.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"sh refresh_yc_data.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"service ycvibecheck.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
theme: capital-market-signal
keyword_group: developer-ecosystem-signal
copyright_note: local research archive only
---

# thesephist/ycvibecheck
...
Ensure the yc_company_scraper project has an updated data/yc_essential_data.json in their repository. If this is updated, everything is pretty simple. If not, we need to figure out how to run the scraper and update the JSON first before moving forward.
Download the JSON from that repository to data/yc.json in the YC Vibe Check repository.
Run server/generate.py , which will generate semantic embeddings for every company from its long_description , or one_liner if the long description is blank.
...
Development
Like many of my projects, YC Vibe Check is built and managed with Oak . There's a short Makefile that wraps common oak commands:
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":7492,"paragraph_count":37,"sentence_count":48,"boilerplate_hits":2,"symbol_ratio":0.0021,"method":"main"}
...
1. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   Semantic search across every YC company ever. Vibe check your idea? **YC Vibe Check** uses _semantic similarity_ to search Y Combinator's entire portfolio of over 3,000 companies by descriptions of ideas or verticals rather than keywords or categories, which lets you search for something super broa.... / query=YC AI startup funding vertical AI / intent=find_startups / path=developer_ecosystem

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   thesephist ycvibecheck Public Notifications You must be signed in to change notification settings Fork Star 66 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 32 Commits 32 Commits data data lib lib server server src src static static .
...
- numbers: 3, 000, 66
m, 32, 2, 66, 69.4%, 19.9%
- quotes: climate change / high-resolution commercial satellite imagery / embedding / neighbors /  will bring up companies with the subwords 

## evidence_seed

- company_actions: Semantic search across every YC company ever. Vibe check your idea? **YC Vibe Check** uses _semantic similarity_ to search Y Combinator's entire portfolio of over 3,000 companies by descriptions of ideas or verticals rather than keywords or categories, which lets you search for something super broa.... / query=YC AI startup funding vertical AI / intent=find_startups / path=developer_ecosystem / thesephist ycvibecheck Public Notifications You must be signed in to change notification settings Fork Star 66 main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 32 Commits 32 Commits data data lib lib server server src src static static . / gitignore LICENSE LICENSE Makefile Makefile README.
- case_details: 暂无公开信息
