...
original_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.176"
canonical_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.176"
...
search_path_label: ""
author: ""
published_at: "2026-06-12T21:53:27.000Z"
collected_at: 2026-06-13T05:32:37.162Z
language: mixed
full_text_hash: 182bf43ba5fdae2b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-13/r-020-claude-code-v2-1-176-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-13/r-020-claude-code-v2-1-176-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":76,"text_length":3193,"paragraph_count":28,"sentence_count":8,"boilerplate_hits":3,"symbol_ratio":0.0022,"method":"main"}
has_full_text: true
content_length: 3193
fetch_error: ""
...
discovery_record: {"discovery_title":"Claude Code v2.1.176 发布","discovery_summary":"Claude Code v2.1.176 更新：会话标题现按对话语言生成；新增 footerLinksRegexes 设置支持正则匹配页脚行链接徽章；优化 Bedrock 凭证缓存。修复多项问题：环境变量不可再绕过 availableModels 限制；/fast 切换至白名单外模型时拒绝；auto 模式退化为可用 Opus 模型；修正路径 hook 条件匹配；修复 Linux 沙箱内符号链接启动问题；修复 tmux 内 SSH 剪贴板问题；修复 Remote Control 多项连接问题。","source_name":"Claude Code：GitHub Releases（RSS）","origin_url":"https://github.com/anthropics/claude-code/releases/tag/v2.1.176","discovered_at":"2026-06-13T05:25:16.549Z","rank_on_page":110,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: b7c0be7755975b74
content_hash: 182bf43ba5fdae2b
semantic_hash: 28ead700a1e64420
duplicate_of: ""
first_seen_at: "2026-06-12T21:53:27.000Z"
last_seen_at: 2026-06-13T05:32:37.162Z
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）","Cursor"],"products":["Claude","claude","agents","agent","cursor"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["2.1","176","21.4","132","12","21","53","9"],"quotes":["Could not resolve authentication method"]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":76,"text_length":3193,"paragraph_count":28,"sentence_count":8,"boilerplate_hits":3,"symbol_ratio":0.0022,"method":"main"}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   176 Compare Choose a tag to compare Sorry, something went wrong.
...
- companies: Claude Code, GitHub Releases（RSS）, Cursor
...
- numbers: 2.1, 176, 21.4, 132, 12, 21, 53, 9
- quotes: Could not resolve authentication method

## evidence_seed

- company_actions: Claude Code v2.1.176 更新：会话标题现按对话语言生成；新增 footerLinksRegexes 设置支持正则匹配页脚行链接徽章；优化 Bedrock 凭证缓存。修复多项问题：环境变量不可再绕过 availableModels 限制；/fast 切换至白名单外模型时拒绝；auto 模式退化为可用 Opus 模型；修正路径 hook 条件匹配；修复 Linux 沙箱内符号链接启动问题；修复 tmux 内 SSH 剪贴板问题；修复 Remote Control 多项连接问题。 / anthropics claude-code Public Notifications You must be signed in to change notification settings Fork 21. / 176 Compare Choose a tag to compare Sorry, something went wrong.
- case_details: 暂无公开信息
