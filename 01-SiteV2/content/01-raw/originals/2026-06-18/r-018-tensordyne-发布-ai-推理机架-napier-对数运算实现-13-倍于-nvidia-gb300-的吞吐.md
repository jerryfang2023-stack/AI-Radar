...
raw_id: R-018
title: "TensorDyne 发布 AI 推理机架 Napier，对数运算实现 13 倍于 NVIDIA GB300 的吞吐"
original_url: "https://x.com/rohanpaul_ai/status/2067289374983954836"
canonical_url: "https://x.com/rohanpaul_ai/status/2067289374983954836"
...
collected_at: 2026-06-18T03:06:52.824Z
language: mixed
full_text_hash: a32e3da63d1ae1b7
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-018-tensordyne-发布-ai-推理机架-napier-对数运算实现-13-倍于-nvidia-gb300-的吞吐.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-018-tensordyne-发布-ai-推理机架-napier-对数运算实现-13-倍于-nvidia-gb300-的吞吐.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":86,"text_length":3412,"paragraph_count":15,"sentence_count":12,"boilerplate_hits":1,"symbol_ratio":0.0202,"method":"main"}
has_full_text: true
content_length: 3412
fetch_error: ""
...
business_elements: {"companies":["X","Rohan Paul (@rohanpaul_ai)","Nvidia"],"products":[],"people":[],"industries":[],"roles":[],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["13 倍","300","1","363","000","210","72","27"],"quotes":[]}
...
What makes this a big deal is that Tensordyne is the math level.
...
🧵 1.
Paid partnership
4:52 PM · Jun 17, 2026 3.1K Views
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":86,"text_length":3412,"paragraph_count":15,"sentence_count":12,"boilerplate_hits":1,"symbol_ratio":0.0202,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Post Log in Sign up Post Rohan Paul @rohanpaul_ai Quite a massive inferencing rack breakthrough from @ TensordyneInc .
...
- numbers: 13 倍, 300, 1, 363, 000, 210, 72, 27
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Post Log in Sign up Post Rohan Paul @rohanpaul_ai Quite a massive inferencing rack breakthrough from @ TensordyneInc . / What makes this a big deal is that Tensordyne is the math level. / AI chips spend huge amounts of energy moving and multiplying numbers.
- case_details: 暂无公开信息
