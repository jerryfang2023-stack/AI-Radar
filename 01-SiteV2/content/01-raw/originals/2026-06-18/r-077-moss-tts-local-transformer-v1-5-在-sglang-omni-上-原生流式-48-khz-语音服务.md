...
canonical_url: "https://lmsys.org/blog/2026-06-17-moss-tts-local-v15"
...
search_path_label: ""
author: ""
published_at: "2026-06-18T05:56:08.548Z"
collected_at: 2026-06-18T06:02:59.499Z
language: mixed
full_text_hash: 5c29e3ca12a1d9df
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-077-moss-tts-local-transformer-v1-5-在-sglang-omni-上-原生流式-48-khz-语音服务.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-077-moss-tts-local-transformer-v1-5-在-sglang-omni-上-原生流式-48-khz-语音服务.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":15130,"paragraph_count":100,"sentence_count":102,"boilerplate_hits":0,"symbol_ratio":0.0008,"method":"main"}
has_full_text: true
content_length: 15130
fetch_error: ""
...
discovery_record: {"discovery_title":"MOSS-TTS-Local-Transformer-v1.5 在 SGLang-Omni 上：原生流式 48 kHz 语音服务","discovery_summary":"MOSS-TTS-Local-Transformer-v1.5 是一款开源 TTS 模型，支持 48 kHz 立体声、零样本声音克隆、最长 10 分钟长文本合成、时长控制及 31 种语言。其核心采用 Qwen3-4B 骨干与约 2B 参数的 MOSS-Audio-Tokenizer-v2 音频编解码器，通过 12 个 RVQ 码本运行。SGLang-Omni 以三阶段流水线部署该模型。在 Seed-TTS-Eval 上词错误率 5.10%、语音相似度 69.23%，CV3-Eval 上 WER 7.48%、SIM 61.59%，MiniMax Multilingual 上 WER 6.37%、SIM 75.31%，X Voice 上 WER 20.48%、SIM 63.00%。","source_name":"LMSYS：Blog（Chatbot Arena 团队）","origin_url":"https://www.lmsys.org/blog/2026-06-17-moss-tts-local-v15","discovered_at":"2026-06-18T05:58:08.829Z","rank_on_page":30,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 9028beff30cce6c9
content_hash: 5c29e3ca12a1d9df
semantic_hash: 3e7ee1a21a80e116
duplicate_of: ""
first_seen_at: "2026-06-18T05:56:08.548Z"
last_seen_at: 2026-06-18T06:02:59.499Z
...
business_elements: {"companies":["LMSYS","Blog（Chatbot Arena 团队）","OpenAI","GitHub"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["1.5","48","10","31","3","4B","2B","2"],"quotes":[]}
...
MOSI, OpenMOSS Team & SGLang-Omni Team June 17, 2026
...
Serving MOSS with SGLang-Omni
Detailed instructions are available in the SGLang-Omni MOSS-TTS-Local cookbook .
Install and Serve
...
Model serving baseline MOSS Local model, pipeline, and API support Establishes the three-stage serving path #728
Reference encoding Batched encoding, content-addressed LRU cache, and single-flight deduplication Avoids repeated codec encoder work for reused speakers #748 , #778 , #788
AR engine Decode-state pool, frame CUDA Graph support, and GPU-native row hash Keeps decode state at stable GPU addresses and removes per-frame host hashing #745
AR engine Frame launch-state pooling and async decode plumbing Reduces launch preparation overhead and fixes decode-step ownership issues #759 , #758
AR engine Compiled seeded sampler Fuses the hot sampling path while preserving deterministic per-request sampling #773
Vocoder Stateful streaming session, stream slots, and coalesced chunk scheduling Enables frame-level audio streaming with request isolation #753
Vocoder Stateful vocoder CUDA Graph Speeds up short streaming decode steps #798
Cross-stage Explicit colocated memory budgeting Prevents codec and AR memory pressure from interfering with each other #810
Reference Audio Encoding
...
Documentation: SGLang-Omni docs
MOSS-TTS-Local cookbook: MOSS-TTS-Local in SGLang-Omni
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":15130,"paragraph_count":100,"sentence_count":102,"boilerplate_hits":0,"symbol_ratio":0.0008,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   ‹ Back to Blog ‹ Back to Blog Contents The MOSS-TTS-Local-Transformer-v1.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   5 Model Why MOSS Needs a Multi-Stage Serving Runtime Serving MOSS with SGLang-Omni Install and Serve Optimizing MOSS End-to-End Reference Audio Encoding AR Engine Streaming Vocoder Memory Budgeting Performance Roadmap Join Us Acknowledgments Learn More MOSS-TTS Local Transformer v1.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   5 on SGLang-Omni: Serving Native-Streaming 48 kHz Speech MOSI, OpenMOSS Team & SGLang-Omni Team June 17, 2026 Today we are announcing end-to-end serving for MOSS-TTS-Local-Transformer-v1.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   5 on SGLang-Omni , together with MOSI and the OpenMOSS Team .

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   MOSS-TTS-Local-Transformer-v1.

## business_elements

- companies: LMSYS, Blog（Chatbot Arena 团队）, OpenAI, GitHub
- products: 暂无公开信息
- people: 暂无公开信息
- industries: 开发者工具
- roles: CIO / IT 负责人
...
- numbers: 1.5, 48, 10, 31, 3, 4B, 2B, 2
- quotes: 暂无公开信息

## evidence_seed

- company_actions: MOSS-TTS-Local-Transformer-v1.5 是一款开源 TTS 模型，支持 48 kHz 立体声、零样本声音克隆、最长 10 分钟长文本合成、时长控制及 31 种语言。其核心采用 Qwen3-4B 骨干与约 2B 参数的 MOSS-Audio-Tokenizer-v2 音频编解码器，通过 12 个 RVQ 码本运行。SGLang-Omni 以三阶段流水线部署该模型。在 Seed-TTS-Eval 上词错误率 5.10%、语音相似度 69.23%，CV3-Eval 上 WER 7.48%、SIM 61.59%，MiniMax Multilingual 上 WER 6.37%、SIM 75.31%，X Voice 上 WER 20.48%、SIM 63.00%。 / ‹ Back to Blog ‹ Back to Blog Contents The MOSS-TTS-Local-Transformer-v1. / 5 Model Why MOSS Needs a Multi-Stage Serving Runtime Serving MOSS with SGLang-Omni Install and Serve Optimizing MOSS End-to-End Reference Audio Encoding AR Engine Streaming Vocoder Memory Budgeting Performance Roadmap Join Us Acknowledgments Learn More MOSS-TTS Local Transformer v1.
- case_details: 暂无公开信息
