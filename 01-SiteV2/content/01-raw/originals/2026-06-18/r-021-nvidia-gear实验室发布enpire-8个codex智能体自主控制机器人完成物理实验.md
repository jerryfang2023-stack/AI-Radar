...
canonical_url: "https://x.com/DrJimFan/status/2067283904986517866"
...
search_path_label: ""
author: ""
published_at: "2026-06-17T16:31:05.000Z"
collected_at: 2026-06-18T06:02:59.187Z
language: mixed
full_text_hash: 4c2694c5c8c069ec
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-021-nvidia-gear实验室发布enpire-8个codex智能体自主控制机器人完成物理实验.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-021-nvidia-gear实验室发布enpire-8个codex智能体自主控制机器人完成物理实验.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":4643,"paragraph_count":24,"sentence_count":26,"boilerplate_hits":1,"symbol_ratio":0.0155,"method":"main"}
has_full_text: true
content_length: 4643
fetch_error: ""
...
discovery_record: {"discovery_title":"NVIDIA GEAR实验室发布ENPIRE：8个Codex智能体自主控制机器人完成物理实验","discovery_summary":"NVIDIA GEAR实验室推出ENPIRE系统，首次实现物理世界自主研究。系统让8个Codex智能体控制8台机器人，配备GPU和token预算。安全方面采用硬运动极限切断和扭矩受限夹爪两层硬件保障，支持通宵无人运行。奖励函数通过视觉分类器离线固定并冻结，防止智能体作弊。实时监测机器人利用率（MRU）、token利用率（MTU）和GPU利用率，以Tokens-to-Success和Time-to-Success评估效率。ENPIRE自主完成扎带、整理细针、安装GPU等高精度任务，发现8机器人并行探索显著更快。系统将开源。","source_name":"X：Jim Fan (@DrJimFan)","origin_url":"https://x.com/DrJimFan/status/2067283904986517866","discovered_at":"2026-06-18T05:58:08.874Z","rank_on_page":218,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f679500a530ae0dd
content_hash: 4c2694c5c8c069ec
semantic_hash: 57203601ecf19016
duplicate_of: ""
first_seen_at: "2026-06-17T16:31:05.000Z"
last_seen_at: 2026-06-18T06:02:59.187Z
...
business_elements: {"companies":["X","Jim Fan (@DrJimFan)","Nvidia"],"products":["Codex","agent","Agent","agents"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["8","1","2","3","00","16","4","31"],"quotes":["robots of loving grace"]}
...
Jim Fan
@DrJimFan
I made Physical AutoResearch sound simple (conceptually), but it took a village to pull off and lots of design thinking into the robot /loopcraft. The hardest part is everything we need to setup *before* pressing Enter. Here's a behind-the-scene tour:
1. Safety harness
Letting overnight means safety has to be more than a hint in the system prompt. ENPIRE hardwires it in 2 layers: (1) hard kinematic limit that trips an immediate task failure and auto-resets as soon as a robot leaves its safety envelope, and (2) a torque-limited compliant gripper so a bad contact or misaligned insertion ends in a safe stall, instead of crushing the robot or the object at hand.
...
00:00
4:31 PM · Jun 17, 2026 61.1K Views
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":4643,"paragraph_count":24,"sentence_count":26,"boilerplate_hits":1,"symbol_ratio":0.0155,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Post Log in Sign up Post Jim Fan @DrJimFan I made Physical AutoResearch sound simple (conceptually), but it took a village to pull off and lots of design thinking into the robot /loopcraft.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The hardest part is everything we need to setup *before* pressing Enter.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Here's a behind-the-scene tour: 1.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Safety harness Letting overnight means safety has to be more than a hint in the system prompt.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   ENPIRE hardwires it in 2 layers: (1) hard kinematic limit that trips an immediate task failure and auto-resets as soon as a robot leaves its safety envelope, and (2) a torque-limited compliant gripper so a bad contact or misaligned insertion ends in a safe stall, instead of crushing the robot or the object at hand.

## business_elements

- companies: X, Jim Fan (@DrJimFan), Nvidia
- products: Codex, agent, Agent, agents
- people: 暂无公开信息
- industries: 开发者工具
- roles: 暂无公开信息
...
- numbers: 8, 1, 2, 3, 00, 16, 4, 31
- quotes: robots of loving grace

## evidence_seed

- company_actions: Post Log in Sign up Post Jim Fan @DrJimFan I made Physical AutoResearch sound simple (conceptually), but it took a village to pull off and lots of design thinking into the robot /loopcraft. / The hardest part is everything we need to setup *before* pressing Enter. / Here's a behind-the-scene tour: 1.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: 暂无公开信息
- risks_or_constraints: NVIDIA GEAR实验室推出ENPIRE系统，首次实现物理世界自主研究。系统让8个Codex智能体控制8台机器人，配备GPU和token预算。安全方面采用硬运动极限切断和扭矩受限夹爪两层硬件保障，支持通宵无人运行。奖励函数通过视觉分类器离线固定并冻结，防止智能体作弊。实时监测机器人利用率（MRU）、token利用率（MTU）和GPU利用率，以Tokens-to-Success和Time-to-Success评估效率。ENPIRE自主完成扎带、整理细针、安装GPU等高精度任务，发现8机器人并行探索显著更快。系统将开源。
