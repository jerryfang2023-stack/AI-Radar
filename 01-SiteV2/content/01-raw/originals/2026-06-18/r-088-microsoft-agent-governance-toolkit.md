...
author: ""
published_at: ""
collected_at: 2026-06-18T03:06:53.235Z
language: mixed
full_text_hash: 69dfdc3a9823c698
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-088-microsoft-agent-governance-toolkit.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-088-microsoft-agent-governance-toolkit.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":19047,"paragraph_count":275,"sentence_count":102,"boilerplate_hits":2,"symbol_ratio":0.0071,"method":"main"}
has_full_text: true
content_length: 19047
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"69dfdc3a9823c698","missing":[]}
...
url_hash: 699cb8262327828f
content_hash: 1959899584d4bf2f
semantic_hash: 1d9ce51186658266
duplicate_of: ""
first_seen_at: "2026-06-18T03:06:53.235Z"
last_seen_at: 2026-06-18T03:06:53.235Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Google","Microsoft","GitHub","Meta","AWS"],"products":["agent","Agent","agents","claude","copilot","AGENTS","Claude","MCP","mcp","Copilot"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["10","620","4.4","2","107","1","3","01"],"quotes":["an agent did it","please follow the rules","it is unclear if there are fool-proof methods of prevention for prompt injection.","mitigations do not eliminate risk entirely","unlikely."]}
evidence_seed: {"company_actions":["AI Agent Governance Toolkit — Policy enforcement, zero-trust identity, execution sandboxing, and reliability engineering for autonomous AI agents. Covers 10/10 OWASP Agentic Top 10. Policy enforcement, identity, sandboxing, and SRE for autonomous AI agents. One `pip install`, any framework. is opt..... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=developer_ecosystem","microsoft agent-governance-toolkit Public Notifications You must be signed in to change notification settings Fork 620 Star 4.","4k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 2,107 Commits 2,107 Commits ."],"case_details":["github action action agent-governance-antigravity-cli agent-governance-antigravity-cli agent-governance-claude-code agent-governance-claude-code agent-governance-copilot-cli agent-governance-copilot-cli agent-governance-dotnet agent-governance-dotnet agent-governance-golang agent-governance-golang agent-governance-opencode agent-governance-opencode agent-governance-python agent-governance-python agent-governance-rust agent-governance-rust agent-governance-typescript agent-governance-typescript benchmarks/ prompt-in"],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: []
key_excerpts: [{"type":"company_action","text":"AI Agent Governance Toolkit — Policy enforcement, zero-trust identity, execution sandboxing, and reliability engineering for autonomous AI agents. Covers 10/10 OWASP Agentic Top 10. Policy enforcement, identity, sandboxing, and SRE for autonomous AI agents. One `pip install`, any framework. is opt..... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=developer_ecosystem","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"microsoft agent-governance-toolkit Public Notifications You must be signed in to change notification settings Fork 620 Star 4.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"4k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 2,107 Commits 2,107 Commits .","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"case_detail","text":"github action action agent-governance-antigravity-cli agent-governance-antigravity-cli agent-governance-claude-code agent-governance-claude-code agent-governance-copilot-cli agent-governance-copilot-cli agent-governance-dotnet agent-governance-dotnet agent-governance-golang agent-governance-golang agent-governance-opencode agent-governance-opencode agent-governance-python agent-governance-python agent-governance-rust agent-governance-rust agent-governance-typescript agent-governance-typescript benchmarks/ prompt-in","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"company_action","text":"cspell-repo-terms.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
...
Agent Hypervisor
Execution audit, delta engine, commitment anchoring, command denylist enforcement
...
Stateless intervention-point policy runtime, verdicts, transform, fail-closed
--
...
AARM Extended
All R1–R9 requirements satisfied; verified Jun 14, 2026
ATF
All five elements mapped: Agent Mesh (identity), Agent OS (policy), Agent Compliance (governance), Agent Runtime (sandboxing), Agent SRE (incident response)
Security
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":19047,"paragraph_count":275,"sentence_count":102,"boilerplate_hits":2,"symbol_ratio":0.0071,"method":"main"}
...
1. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   AI Agent Governance Toolkit — Policy enforcement, zero-trust identity, execution sandboxing, and reliability engineering for autonomous AI agents. Covers 10/10 OWASP Agentic Top 10. Policy enforcement, identity, sandboxing, and SRE for autonomous AI agents. One `pip install`, any framework. is opt..... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=developer_ecosystem

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   microsoft agent-governance-toolkit Public Notifications You must be signed in to change notification settings Fork 620 Star 4.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   4k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 2,107 Commits 2,107 Commits .

4. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   github action action agent-governance-antigravity-cli agent-governance-antigravity-cli agent-governance-claude-code agent-governance-claude-code agent-governance-copilot-cli agent-governance-copilot-cli agent-governance-dotnet agent-governance-dotnet agent-governance-golang agent-governance-golang agent-governance-opencode agent-governance-opencode agent-governance-python agent-governance-python agent-governance-rust agent-governance-rust agent-governance-typescript agent-governance-typescript benchmarks/ prompt-in
...
- companies: keyword search, Anysearch, OpenAI, Google, Microsoft, GitHub, Meta, AWS
- products: agent, Agent, agents, claude, copilot, AGENTS, Claude, MCP, mcp, Copilot
- people: 暂无公开信息
...
- numbers: 10, 620, 4.4, 2, 107, 1, 3, 01
- quotes: an agent did it / please follow the rules / it is unclear if there are fool-proof methods of prevention for prompt injection. / mitigations do not eliminate risk entirely / unlikely.

## evidence_seed

- company_actions: AI Agent Governance Toolkit — Policy enforcement, zero-trust identity, execution sandboxing, and reliability engineering for autonomous AI agents. Covers 10/10 OWASP Agentic Top 10. Policy enforcement, identity, sandboxing, and SRE for autonomous AI agents. One `pip install`, any framework. is opt..... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=developer_ecosystem / microsoft agent-governance-toolkit Public Notifications You must be signed in to change notification settings Fork 620 Star 4. / 4k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 2,107 Commits 2,107 Commits .
- case_details: github action action agent-governance-antigravity-cli agent-governance-antigravity-cli agent-governance-claude-code agent-governance-claude-code agent-governance-copilot-cli agent-governance-copilot-cli agent-governance-dotnet agent-governance-dotnet agent-governance-golang agent-governance-golang agent-governance-opencode agent-governance-opencode agent-governance-python agent-governance-python agent-governance-rust agent-governance-rust agent-governance-typescript agent-governance-typescript benchmarks/ prompt-in
