...
raw_id: R-074
title: "AI evals are becoming the new compute bottleneck - Hugging Face"
original_url: "https://huggingface.co/blog/evaleval/eval-costs-bottleneck"
canonical_url: "https://huggingface.co/blog/evaleval/eval-costs-bottleneck"
...
author: ""
published_at: ""
collected_at: 2026-06-18T06:41:09.136Z
language: mixed
full_text_hash: 83fd9121400e316e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-074-ai-evals-are-becoming-the-new-compute-bottleneck-hugging-face.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-074-ai-evals-are-becoming-the-new-compute-bottleneck-hugging-face.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":31036,"paragraph_count":124,"sentence_count":301,"boilerplate_hits":2,"symbol_ratio":0.0042,"method":"main"}
has_full_text: true
content_length: 31036
fetch_error: ""
...
url_hash: 565ca109c9e02f51
content_hash: e167ca596d9d551c
semantic_hash: 728c5c6249b3206a
duplicate_of: ""
first_seen_at: "2026-06-18T06:41:09.136Z"
last_seen_at: 2026-06-18T06:41:09.136Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI"],"products":["Agent","agent","agents","Claude","Gemini","GPT-5","Agents"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["$40","000","21","730","9 m","9 b","$2","829 b"],"quotes":["can consume as many as 1,000 GPU hours.","may even surpass those of pretraining when evaluating checkpoints.","the model","a 9× difference in cost despite just a two-percentage-point difference in accuracy.","accuracy-optimal configurations cost 4.4 to 10.8× more than Pareto-efficient alternatives"]}
...
evaleval
Yifan Mai yifanmai Follow
evaleval
Georgia Channing cgeorgiaw Follow
evaleval
Leshem Choshen borgr Follow
evaleval
...
All figures normalized to USD per single evaluation. GPU compute converted at $2.50/H100-hour, $1.50/A10-hour; API and grading costs included where applicable. Pythia ("eval can exceed pretraining"), PDEBench (per-architecture cost depends on the selected training protocol and hardware), and NAS-Bench-101's 100 TP
...
June 11, 2026
Community
I'm the solo founder of TAB Platform (tabverified.ai), an independent AI agent verification platform. We run 340+ benchmarks across 59 models from 5 providers at $0.03 per text test case. Pay-as-you-go credits, no subscription.</p>\n<p>A few of your findings match what we've been measuring for 13 months:<br>The 33x cost spread on scaffold choice lines up with our data. We tested Claude Opus with two different harness configurations on the same benchmark, same model, same test. 42% with one harness, 78% with another. We have 101 harness configurations measuring exactly this variable.</p>\n<p>Your reliability point is critical. We built a Benchmark Calibration Suite with 10 synthetic agents and 5 adversarial gaming agents that runs daily (135/135 checks) specifically because single-run numbers aren't trustworthy. We also found 20-point variance on GPT-4o across 4 identical runs.</p>\n<p>The conclusion that \"whoever can pay for evaluation gets to write the leaderboard\" is the reason TAB exists. Independent evaluation shouldn't require a frontier lab's compute budget.</p>\n<p>Would be interested in comparing notes if any of you are open to it.<br>Rod Miller<br>tabverified.ai<br><a href=\"mailto:rod@tabverified.ai\" rel=\"nofollow\">rod@tabverified.ai</a></p>\n","updatedAt":"2026-04-30T14:41:15.712Z","author":{"_id":"68f167830b3cfdcfdb0e859f","avatarUrl":"/avatars/ac97a41fb005defda90ebb514da2b03d.svg","fullname":"Rod Miller","name":"RodTAB","type":"user","isPro":false,"isHf":false,"isHfAdmin":false,"isMod":false,"isUserFollowing":false}},"numEdits":0,"identifiedLanguage":{"language":"en","probability":0.9072970151901245},"editors":["RodTAB"],"editorAvatarUrls":["/avatars/ac97a41fb005defda90ebb514da2b03d.svg"],"reactions":[{"reaction":"❤️","users":["evijit","udayl","kshitijthakkar"],"count":3}],"isReport":false}},{"id":"69f9ee55ba9fb4af35c66f7b","createdAt":"2026-05-05T13:19:17.000Z","type":"comment","data":{"edited":true,"hidden":true,"hiddenBy":"","latest":{"raw":"This comment has been hidden","html":"This comment has been hidden","updatedAt":"2026-05-06T08:38:09.566Z"},"numEdits":0,"editors":[],"editorAvatarUrls":[],"reactions":[]},"replies":[{"id":"69f9f5125ce36a7bac8bdd06","author":{"_id":"68f167830b3cfdcfdb0e859f","avatarUrl":"/avatars/ac97a41fb005defda90ebb514da2b03d.svg","fullname":"Rod Miller","name":"RodTAB","type":"user","isPro":false,"isHf":false,"isHfAdmin":false,"isMod":false,"isUserFollowing":false},"createdAt":"2026-05-05T13:48:02.000Z","type":"comment","data":{"edited":false,"hidden":false,"latest":{"raw":"I run an independent AI agent verification platform. Just benchmarked 11 frontier models on hallucination for under $5 total. Two runs each, maximum spread was 4 points. Evaluation doesn't have to cost thousands. tabverified.ai","html":"<p>I run an independent AI agent verification platform. Just benchmarked 11 frontier models on hallucination for under $5 total. Two runs each, maximum spread was 4 points. Evaluation doesn't have to cost thousands. tabverified.ai</p>\n","updatedAt":"2026-05-05T13:48:02.323Z","author":{"_id":"68f167830b3cfdcfdb0e859f","avatarUrl":"/avatars/ac97a41fb005defda90ebb514da2b03d.svg","fullname":"Rod Miller","name":"RodTAB","type":"user","isPro":false,"isHf":false,"isHfAdmin":false,"isMod":false,"isUserFollowing":false}},"numEdits":0,"identifiedLanguage":{"language":"en","probability":0.9385527968406677},"editors":["RodTAB"],"editorAvatarUrls":["/avatars/ac97a41fb005defda90ebb514da2b03d.svg"],"reactions":[],"isReport":false,"parentCommentId":"69f9ee55ba9fb4af35c66f7b"}}]}],"status":"open","isReport":false,"pinned":false,"locked":false,"collection":"community_blogs"},"contextAuthors":["evijit","yifanmai","cgeorgiaw","borgr"],"primaryEmailConfirmed":false,"discussionRole":0,"acceptLanguages":["en","zh"],"withThread":true,"cardDisplay":false,"repoDiscussionsLocked":false,"hideComments":true}">
RodTAB
Apr 30
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":31036,"paragraph_count":124,"sentence_count":301,"boilerplate_hits":2,"symbol_ratio":0.0042,"method":"main"}
...
1. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   Summary. AI evaluation has crossed a who can do it. The Holistic Agent Leaderboard (HAL) recently spent about $40,000 to run 21,730 agent outs across 9 models and 9 benchmarks. A single GAIA run on a frontier model can cost $2,829 before caching. Exgentic's $22,000 sweep across agent configuration..... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=developer_ecosystem

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Back to Articles a]:hidden"> AI evals are becoming the new compute bottleneck Community Article Published April 29, 2026 Upvote 29 +23 Avijit Ghosh evijit Follow evaleval Yifan Mai yifanmai Follow evaleval Georgia Channing cgeorgiaw Follow evaleval Leshem Choshen borgr Follow evaleval Summary.
...
- products: Agent, agent, agents, Claude, Gemini, GPT-5, Agents
- people: 暂无公开信息
...
- numbers: $40, 000, 21, 730, 9 m, 9 b, $2, 829 b
- quotes: can consume as many as 1,000 GPU hours. / may even surpass those of pretraining when evaluating checkpoints. / the model / a 9× difference in cost despite just a two-percentage-point difference in accuracy. / accuracy-optimal configurations cost 4.4 to 10.8× more than Pareto-efficient alternatives

## evidence_seed

- company_actions: Back to Articles a]:hidden"> AI evals are becoming the new compute bottleneck Community Article Published April 29, 2026 Upvote 29 +23 Avijit Ghosh evijit Follow evaleval Yifan Mai yifanmai Follow evaleval Georgia Channing cgeorgiaw Follow evaleval Leshem Choshen borgr Follow evaleval Summary. / AI evaluation has crossed a cost threshold that changes who can do it.
- case_details: 暂无公开信息
