...
original_url: "https://developers.googleblog.com/announcing-the-agentic-resource-discovery-specification"
canonical_url: "https://developers.googleblog.com/announcing-the-agentic-resource-discovery-specification"
...
search_path_label: ""
author: ""
published_at: "2026-06-17T16:08:36.794Z"
collected_at: 2026-06-18T06:41:08.860Z
language: mixed
full_text_hash: 072513618d6078f0
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-023-谷歌发布agentic-resource-discovery-ard-开放规范.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-023-谷歌发布agentic-resource-discovery-ard-开放规范.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":6913,"paragraph_count":37,"sentence_count":48,"boilerplate_hits":1,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 6913
fetch_error: ""
...
discovery_record: {"discovery_title":"谷歌发布Agentic Resource Discovery（ARD）开放规范","discovery_summary":"Agentic Resource Discovery（ARD）是一项开放规范，用于在Web上发布、发现和验证AI工具、技能与智能体。它基于两个原语：组织在其自有域名下托管catalog描述可用能力，registry作为搜索引擎索引catalog并响应发现请求。ARD支持加密验证，使客户端与端点连接前确认发布者身份，然后直接通过原生协议调用能力。Google Cloud的Gemini Enterprise Agent Platform通过Agent Registry提供企业级支持，包括URN命名、出站策略、工具固定和基于Agent Identity的信任验证。该规范现已发布，开发者可通过托管`ai-catalog.json`文件使其服务可发现。","source_name":"Google Developers Blog（RSS）","origin_url":"https://developers.googleblog.com/announcing-the-agentic-resource-discovery-specification","discovered_at":"2026-06-18T06:35:55.951Z","rank_on_page":233,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 7070fd9785093d8d
content_hash: 072513618d6078f0
semantic_hash: 0c99c9ccce81ba3f
duplicate_of: ""
first_seen_at: "2026-06-17T16:08:36.794Z"
last_seen_at: 2026-06-18T06:41:08.860Z
...
business_elements: {"companies":["Google Developers Blog（RSS）","Google","GitHub"],"products":["Gemini","Agent","agents","Agents","agent","MCP"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["17","2026","2","2.0","16","2026\nM"],"quotes":[]}
...
title_zh: "谷歌发布Agentic Resource Discovery（ARD）开放规范"
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":6913,"paragraph_count":37,"sentence_count":48,"boilerplate_hits":1,"symbol_ratio":0,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Announcing the Agentic Resource Discovery specification JUNE 17, 2026 Junjie Bu Senior Staff Software Engineer Srinivas Krishnan Distinguished Software Engineer Share Facebook Twitter LinkedIn Mail An open specification for finding and verifying tools, skills, and agents across the web.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Agents are becoming participants in a much larger ecosystem.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   They increasingly rely on tools, skills, and other agents distributed across teams, organizations, and platforms.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   For this ecosystem to scale, agents need reliable answers to three questions: Where does the right capability live?
...
- numbers: 17, 2026, 2, 2.0, 16, 2026
M
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Announcing the Agentic Resource Discovery specification JUNE 17, 2026 Junjie Bu Senior Staff Software Engineer Srinivas Krishnan Distinguished Software Engineer Share Facebook Twitter LinkedIn Mail An open specification for finding and verifying tools, skills, and agents across the web. / Agents are becoming participants in a much larger ecosystem. / They increasingly rely on tools, skills, and other agents distributed across teams, organizations, and platforms.
- case_details: Agentic Resource Discovery（ARD）是一项开放规范，用于在Web上发布、发现和验证AI工具、技能与智能体。它基于两个原语：组织在其自有域名下托管catalog描述可用能力，registry作为搜索引擎索引catalog并响应发现请求。ARD支持加密验证，使客户端与端点连接前确认发布者身份，然后直接通过原生协议调用能力。Google Cloud的Gemini Enterprise Agent Platform通过Agent Registry提供企业级支持，包括URN命名、出站策略、工具固定和基于Agent Identity的信任验证。该规范现已发布，开发者可通过托管`ai-catalog.json`文件使其服务可发现。
