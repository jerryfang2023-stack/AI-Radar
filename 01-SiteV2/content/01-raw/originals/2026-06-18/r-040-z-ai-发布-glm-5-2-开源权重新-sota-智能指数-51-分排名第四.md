...
raw_id: R-040
title: "Z ai 发布 GLM-5.2：开源权重新 SOTA，智能指数 51 分排名第四"
original_url: "https://x.com/testingcatalog/status/2067143261848842670"
canonical_url: "https://x.com/testingcatalog/status/2067143261848842670"
...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-040-z-ai-发布-glm-5-2-开源权重新-sota-智能指数-51-分排名第四.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":64,"text_length":2626,"paragraph_count":10,"sentence_count":3,"boilerplate_hits":1,"symbol_ratio":0.027,"method":"main"}
has_full_text: true
content_length: 2626
fetch_error: ""
...
url_hash: 5153386441a2d3b4
content_hash: ac21f9bed1756f1e
...
business_elements: {"companies":["X","Testing Catalog (@testingcatalog)"],"products":["Claude"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["5.2","51","5.1","744B","40B","4.1","11","16%"],"quotes":[]}
...
@ Zai_org ’s GLM-5.2 is the same size as GLM-5.1 (744B total / 40B active parameters) but scores 11 Show more
7:12 AM · Jun 17, 2026 21.8K Views
...
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 3 7 2 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 372
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":64,"text_length":2626,"paragraph_count":10,"sentence_count":3,"boilerplate_hits":1,"symbol_ratio":0.027,"method":"main"}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 by @ Zai_org scored 51 point on Artificial Analysis Intelligence Index and got placed on the 4th spot!

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 a new SOTA open-weight model.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Besides that, GLM-5.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 got ranked second on Frontend Code Arena, after currently unavailable Claude Fable 5.
...
- numbers: 5.2, 51, 5.1, 744B, 40B, 4.1, 11, 16%
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Post Log in Sign up Post 🚨 AI News | TestingCatalog @testingcatalog ZAI 🔥: GLM-5. / 2 by @ Zai_org scored 51 point on Artificial Analysis Intelligence Index and got placed on the 4th spot! / 2 a new SOTA open-weight model.
- case_details: 暂无公开信息
