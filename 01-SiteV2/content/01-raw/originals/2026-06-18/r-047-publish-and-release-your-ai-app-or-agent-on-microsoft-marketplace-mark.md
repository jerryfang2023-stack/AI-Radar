...
raw_id: R-047
title: "Publish and release your AI app or agent on Microsoft Marketplace - Marketplace publisher | Microsoft Learn"
original_url: "https://learn.microsoft.com/en-us/partner-center/marketplace-offers/artificial-intelligence-app-agent-publish-release"
canonical_url: "https://learn.microsoft.com/en-us/partner-center/marketplace-offers/artificial-intelligence-app-agent-publish-release"
...
author: ""
published_at: ""
collected_at: 2026-06-18T06:02:59.305Z
language: mixed
full_text_hash: a491908dbcf8d15e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-047-publish-and-release-your-ai-app-or-agent-on-microsoft-marketplace-mark.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-047-publish-and-release-your-ai-app-or-agent-on-microsoft-marketplace-mark.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":28308,"paragraph_count":209,"sentence_count":189,"boilerplate_hits":2,"symbol_ratio":0.0002,"method":"content-container"}
has_full_text: true
content_length: 28308
fetch_error: ""
...
url_hash: 4940288861f11737
content_hash: d3ca20a575a8cf53
semantic_hash: 33f1a116eaa6306b
duplicate_of: ""
first_seen_at: "2026-06-18T06:02:59.305Z"
last_seen_at: 2026-06-18T06:02:59.305Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Microsoft"],"products":["agent","Copilot","agents","Agents"],"people":[],"industries":["医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","采购负责人"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算","采购","销售 / 客服"],"numbers":["365","2","27001","$500","0 m"],"quotes":["AI Apps and Agents","Machine Learning","AI Apps and Agents","Machine Learning","Always On"]}
...
# Publish and release your AI app or agent on Microsoft Marketplace - Marketplace publisher | Microsoft Learn
...
SaaS based Azure agents : require that you activate your customer's subscriptions after they have purchased the offer from marketplace, and stand up an endpoint for Microsoft to send customers usage lifecycle information. For more information on how to configure your SaaS product, refer to Technical configuration for SaaS offers
Container based Azure agents : require a technical package stored in an Azure blob for customers to access. For more information on how to configure your container product, refer to Preparing your Azure container technical asset .
Microsoft 365 and Copilot agents : require a technical manifest that defines how customers can activate the agent that is integrated with their Microsoft 365 experience. For more information on creating a Microsoft 365 agent, refer to Creating an Office add-in manifest .
...
Microsoft 365 and Copilot program lets you publish agents for Microsoft 365 and Copilot. For details, refer to Enrolling in the Microsoft 365 and Copilot program .
Microsoft Marketplace program enables you to publish Azure agents and monetize Microsoft 365 agents through linked SaaS offers. For more, refer to Enrolling in the Marketplace program .
Explore this choosing your Marketplace offer community post about how Marketplace offer types map to different AI app and agent delivery models.
Choose the type of Microsoft 365 Copilot agent that works best for your scenario.
Create your Marketplace listing
This section covers how to create a listing so customers can easily find your AI agent:
Listing Details : include an offer name, description and a summary for your agent.
Categories : Choose categories and subcategories that best fit with the value proposition of your agent.
Microsoft provides two AI-focused categories - "AI Apps and Agents" and "Machine Learning" - to help customers find your agent. Selecting the right category ensures your offer reaches the right audience.
Tip
...
SaaS-based agent can be monetized as entitlement based (per-user or flat rate), usage based, or a combination of both. For guidance on pricing your SaaS agent, refer to Monetize a SaaS product .
...
Submission
When your offer is configured, it's ready to be published on the marketplace. For details on publishing states and the certification process your offer refer to, How to review and publish an offer.
...
Explore our end-to-end community post series on building, publishing, and selling AI apps and agents on Microsoft Marketplace.
Choose the type of Microsoft 365 Copilot agent that works best for your scenario.
Introduction
...
Automation via infrastructure as
...
Watch now
Next steps
Learn about the best offer option for your app or agent in the article Publishing guidance
Learn about Implementation requirements for AI app and agent offers
Understand concepts presented in Certification
Explore our end-to-end community post series on building, publishing, and selling AI apps and agents on Microsoft Marketplace
Feedback
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":28308,"paragraph_count":209,"sentence_count":189,"boilerplate_hits":2,"symbol_ratio":0.0002,"method":"content-container"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   To publish an offer through Partner Center, you must enroll in the Microsoft AI Cloud Partner program. Depending on the agent type you intend to publish, you’ll also need to join either the Microsoft 365 and Copilot program, the Commercial marketplace program, or both. Successfully publishing an AI.... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=procurement_marketplace

2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Publish and release your AI app or agent on Microsoft Marketplace - Marketplace publisher | Microsoft Learn Table of contents Exit editor mode Ask Learn Ask Learn Reading mode Table of contents Read in English Add Add to plan Edit Copy Markdown Print Note Access to this page requires authorization.
...
6. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Publish and release your AI app or agent Feedback Summarize this article for me This article presents information that will help guide your team through the critical steps for preparing, publishing, and releasing your AI app or agent solution.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Microsoft
- products: agent, Copilot, agents, Agents
- people: 暂无公开信息
...
- numbers: 365, 2, 27001, $500, 0 m
- quotes: AI Apps and Agents / Machine Learning / AI Apps and Agents / Machine Learning / Always On

## evidence_seed

- company_actions: Publish and release your AI app or agent on Microsoft Marketplace - Marketplace publisher | Microsoft Learn Table of contents Exit editor mode Ask Learn Ask Learn Reading mode Table of contents Read in English Add Add to plan Edit Copy Markdown Print Note Access to this page requires authorization. / You can try signing in or changing directories . / Access to this page requires authorization.
- case_details: To publish an offer through Partner Center, you must enroll in the Microsoft AI Cloud Partner program. Depending on the agent type you intend to publish, you’ll also need to join either the Microsoft 365 and Copilot program, the Commercial marketplace program, or both. Successfully publishing an AI.... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=procurement_marketplace
