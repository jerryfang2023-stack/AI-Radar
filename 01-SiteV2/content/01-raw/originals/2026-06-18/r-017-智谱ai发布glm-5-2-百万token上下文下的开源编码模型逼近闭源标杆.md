...
raw_id: R-017
title: "智谱AI发布GLM-5.2，百万token上下文下的开源编码模型逼近闭源标杆"
original_url: "https://the-decoder.com/zhipu-ais-glm-5-2-closes-in-on-closed-source-leaders-in-coding-marathons"
canonical_url: "https://the-decoder.com/zhipu-ais-glm-5-2-closes-in-on-closed-source-leaders-in-coding-marathons"
...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-017-智谱ai发布glm-5-2-百万token上下文下的开源编码模型逼近闭源标杆.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":16639,"paragraph_count":74,"sentence_count":144,"boilerplate_hits":0,"symbol_ratio":0.0065,"method":"json-ld"}
has_full_text: true
content_length: 16639
fetch_error: ""
...
url_hash: 70e2fd6ffa9d936c
content_hash: 0939ca3fe0229aa4
...
business_elements: {"companies":["The Decoder","AI News（RSS）","OpenAI","Anthropic","GitHub"],"products":["Claude","GPT-5","agent","Gemini","MCP","agents"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["5.2","74.4%","4.8","5.5","4.7","2.1","81","5.1"],"quotes":["A 1M context is easy to claim, but much harder to keep reliable under real engineering pressure,","attachment_57432","aligncenter","attachment_57433","aligncenter"]}
...
title_zh: "智谱AI发布GLM-5.2，百万token上下文下的开源编码模型逼近闭源标杆"
...
[caption id="attachment_57432" align="aligncenter" width="1800"] On long-horizon tasks, GLM-5.2 usually lands just behind Opus 4.8 but remains the strongest open model. | Image: Zhipu AI[/caption]
...
[caption id="attachment_57433" align="aligncenter" width="1800"] On standard coding tasks, GLM-5.2 pulls clearly ahead of its predecessor GLM-5.1. | Image: Zhipu AI[/caption]
...
[caption id="attachment_57434" align="aligncenter" width="1800"] The "High" effort level already extracts nearly full performance. "Max" costs far more tokens for barely any extra points. | Image: Zhipu AI[/caption]
...
[caption id="attachment_36718" align="alignnone" width="2560"] The top chart ranks AI models by their Artificial Analysis Intelligence Index, an aggregate of several benchmarks. The bottom chart plots intelligence index against cost per task to identify the most cost-effective top models. | Image: Artificial Analysis[/caption]
...
[caption id="attachment_57435" align="aligncenter" width="1800"] With IndexShare, multiple layers share the same indexer, saving compute on long contexts. | Image: Zhipu AI[/caption]
...
[caption id="attachment_57437" align="aligncenter" width="1800"] The longer the context, the more clearly GLM-5.2 outpaces its predecessor in throughput. | Image: Zhipu AI[/caption]
...
- fetch_status: fetched-readable-text-json-ld
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":16639,"paragraph_count":74,"sentence_count":144,"boilerplate_hits":0,"symbol_ratio":0.0065,"method":"json-ld"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 closes in on closed-source leaders in coding marathons Zhipu AI's GLM-5.

3. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   2 closes in on closed-source leaders in coding marathons Chinese AI lab Zhipu AI releases GLM-5.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 with a stable 1-million-token context under the MIT license.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   On FrontierSWE, a benchmark for hours-long coding tasks, the open-source model trails Anthropic's Claude Opus 4.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   8 by just one percentage point.

## business_elements

- companies: The Decoder, AI News（RSS）, OpenAI, Anthropic, GitHub
- products: Claude, GPT-5, agent, Gemini, MCP, agents
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 5.2, 74.4%, 4.8, 5.5, 4.7, 2.1, 81, 5.1
- quotes: A 1M context is easy to claim, but much harder to keep reliable under real engineering pressure, / attachment_57432 / aligncenter / attachment_57433 / aligncenter

## evidence_seed

- company_actions: 2 closes in on closed-source leaders in coding marathons Zhipu AI's GLM-5. / 2 closes in on closed-source leaders in coding marathons Chinese AI lab Zhipu AI releases GLM-5. / 2 with a stable 1-million-token context under the MIT license.
- case_details: 暂无公开信息
