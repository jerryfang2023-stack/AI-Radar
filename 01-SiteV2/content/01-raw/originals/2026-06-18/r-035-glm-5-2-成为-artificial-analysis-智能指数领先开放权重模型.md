...
raw_id: R-035
title: "GLM-5.2 成为 Artificial Analysis 智能指数领先开放权重模型"
...
canonical_url: "https://artificialanalysis.ai/articles/glm-5-2-is-the-new-leading-open-weights-model-on-the-artificial-analysis-intelligence-index"
...
collected_at: 2026-06-18T03:06:52.897Z
language: mixed
full_text_hash: ee640bacfd28d0ae
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-035-glm-5-2-成为-artificial-analysis-智能指数领先开放权重模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-035-glm-5-2-成为-artificial-analysis-智能指数领先开放权重模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":4467,"paragraph_count":25,"sentence_count":17,"boilerplate_hits":0,"symbol_ratio":0.0002,"method":"main"}
has_full_text: true
content_length: 4467
fetch_error: ""
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Anthropic"],"products":["GPT-5","agent","Claude"],"people":[],"industries":["金融 / 保险","开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["5.2","4.1","51","3","44","4","2.6","43"],"quotes":[]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":4467,"paragraph_count":25,"sentence_count":17,"boilerplate_hits":0,"symbol_ratio":0.0002,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Artificial Analysis All articles June 17, 2026 GLM-5.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 is the new leading open weights model on the Artificial Analysis Intelligence Index Z ai’s GLM-5.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 is the new leading open weights model on the Artificial Analysis Intelligence Index scoring 51 and it sits on the Pareto frontier of Intelligence vs Cost per Task GLM-5.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 is the same size as GLM-5.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   1 (744B total / 40B active parameters) but scores 11 points higher on the Intelligence Index v4.
...
- numbers: 5.2, 4.1, 51, 3, 44, 4, 2.6, 43
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Artificial Analysis All articles June 17, 2026 GLM-5. / 2 is the new leading open weights model on the Artificial Analysis Intelligence Index Z ai’s GLM-5. / 2 is the new leading open weights model on the Artificial Analysis Intelligence Index scoring 51 and it sits on the Pareto frontier of Intelligence vs Cost per Task GLM-5.
- case_details: 暂无公开信息
