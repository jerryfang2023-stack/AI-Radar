...
collected_at: 2026-06-18T03:06:52.904Z
language: mixed
full_text_hash: e9bea9a3dcedc6e4
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-037-glm-5-2-发布-aai-指数-51-分-开源权重模型新标杆.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-037-glm-5-2-发布-aai-指数-51-分-开源权重模型新标杆.json"
html_snapshot_path: ""
screenshot_path: ""
...
6:41 AM · Jun 17, 2026 272.8K Views
...
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 2 2 7 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 227
