...
author: ""
published_at: ""
collected_at: 2026-06-18T03:06:53.381Z
language: mixed
full_text_hash: c150a4c45171a149
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-155-lifescibench-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-155-lifescibench-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
duplicate_of: ""
first_seen_at: "2026-06-18T03:06:53.381Z"
last_seen_at: 2026-06-18T03:06:53.381Z
...
business_elements: {"companies":["OpenAI","官网动态（RSS · 排除企业","客户案例）"],"products":[],"people":[],"industries":[],"roles":[],"workflows":[],"business_actions":["发布 / 推出"],"affected_departments":[],"numbers":["2026","6","173","750","25","19","020","79%"],"quotes":[]}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=medium
   每项任务配有约 25 条细化评分标准（共 19,020 条），评估模型的科学正确性与实用价值。

4. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=medium
   79% 的任务需多步推理，53% 要求解读图表、PDF 等附件数据，旨在衡量 AI 在复杂、不确定的研究任务中的实际能力，而非仅回答结构化问题。
...
- numbers: 2026, 6, 173, 750, 25, 19, 020, 79%
- quotes: 暂无公开信息

## evidence_seed

- company_actions: 2026 年 6 月，OpenAI 联合 173 位博士级生命科学家发布 LifeSciBench 评测基准，涵盖 750 个真实研究任务，覆盖证据处理、分析、设计优化等七个工作流及七个生物领域。 / 每项任务配有约 25 条细化评分标准（共 19,020 条），评估模型的科学正确性与实用价值。
- case_details: 暂无公开信息
