...
author: ""
published_at: ""
collected_at: 2026-06-18T06:41:09.407Z
language: mixed
full_text_hash: 76ddf6b002f6a696
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-177-strands-robots-sdk-用单一智能体打通-hugging-face-hub-到物理机器人.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-177-strands-robots-sdk-用单一智能体打通-hugging-face-hub-到物理机器人.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Strands Robots SDK：用单一智能体打通 Hugging Face Hub 到物理机器人","discovery_summary":"AWS（Apache 2.0）开源的 Strands Robots SDK 将 LeRobot 栈封装为 AgentTools，构建统一智能体。默认用 MuJoCo 模拟（无需硬件），mode=\"real\" 切换至真实机器人。可记录演示数据为 LeRobotDataset 并推送 Hugging Face Hub，运行 GR00T 或 LerobotLocal 策略推理，经 Zenoh mesh 广播命令到多台机器人。模拟与硬件代码完全一致，只需改一个关键字参数。示例可在笔记本（Python 3.12+，Linux/macOS）无硬件、无 GPU 运行。","source_name":"Hugging Face：Blog（RSS）","origin_url":"","discovered_at":"2026-06-18T06:35:54.498Z","rank_on_page":10,"discovery_status":"discovered"}
...
content_hash: 76ddf6b002f6a696
semantic_hash: bc512e587990f88a
duplicate_of: ""
first_seen_at: "2026-06-18T06:41:09.407Z"
last_seen_at: 2026-06-18T06:41:09.407Z
...
business_elements: {"companies":["Hugging Face","Blog（RSS）","AWS"],"products":[],"people":[],"industries":[],"roles":[],"workflows":[],"business_actions":[],"affected_departments":[],"numbers":["2.0","00","3.12"],"quotes":[]}
...
- company_actions: AWS（Apache 2.0）开源的 Strands Robots SDK 将 LeRobot 栈封装为 AgentTools，构建统一智能体。默认用 MuJoCo 模拟（无需硬件），mode="real" 切换至真实机器人。可记录演示数据为 LeRobotDataset 并推送 Hugging Face Hub，运行 GR00T 或 LerobotLocal 策略推理，经 Zenoh mesh 广播命令到多台机器人。模拟与硬件代码完全一致，只需改一个关键字参数。示例可在笔记本（Python 3.12+，Linux/macOS）无硬件、无 GPU 运行。 / 0）开源的 Strands Robots SDK 将 LeRobot 栈封装为 AgentTools，构建统一智能体。 / 默认用 MuJoCo 模拟（无需硬件），mode="real" 切换至真实机器人。
- case_details: 暂无公开信息
