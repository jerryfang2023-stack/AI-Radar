...
collected_at: 2026-06-18T03:06:52.797Z
language: mixed
full_text_hash: 1d9bda13b7bdf0e2
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-011-anthropic风波最大赢家-开源-glm-5-2发布正当时.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-011-anthropic风波最大赢家-开源-glm-5-2发布正当时.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":81,"text_length":3079,"paragraph_count":10,"sentence_count":9,"boilerplate_hits":1,"symbol_ratio":0.0221,"method":"main"}
has_full_text: true
content_length: 3079
fetch_error: ""
...
business_elements: {"companies":["X","Kim (@kimmonismus)","Anthropic"],"products":[],"people":[],"industries":["企业服务"],"roles":[],"workflows":[],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全"],"numbers":["5.2","8","36","17","2026","19.7","1","0.25"],"quotes":[]}
...
8:36 PM · Jun 17, 2026 19.7K Views
...
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 3 7 1 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 371
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":81,"text_length":3079,"paragraph_count":10,"sentence_count":9,"boilerplate_hits":1,"symbol_ratio":0.0221,"method":"main"}
...
- numbers: 5.2, 8, 36, 17, 2026, 19.7, 1, 0.25
- quotes: 暂无公开信息
