...
raw_id: R-086
title: "Introduction to AI agents: Foundations for enterprise development"
original_url: "https://aws.amazon.com/marketplace/build-learn/ai-agent-learning-series/introduction-to-ai-agents"
canonical_url: "https://aws.amazon.com/marketplace/build-learn/ai-agent-learning-series/introduction-to-ai-agents"
...
author: ""
published_at: ""
collected_at: 2026-06-18T03:06:53.215Z
language: mixed
full_text_hash: ac298f8d16246389
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-086-introduction-to-ai-agents-foundations-for-enterprise-development.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-086-introduction-to-ai-agents-foundations-for-enterprise-development.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":20617,"paragraph_count":171,"sentence_count":135,"boilerplate_hits":1,"symbol_ratio":0.0224,"method":"main"}
has_full_text: true
content_length: 20617
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"ac298f8d16246389","missing":[]}
...
url_hash: 3fe9bd1d8f8949df
content_hash: db2a82b390b27669
semantic_hash: 6fc40d5d3e1659e7
duplicate_of: ""
first_seen_at: "2026-06-18T03:06:53.215Z"
last_seen_at: 2026-06-18T03:06:53.215Z
...
business_elements: {"companies":["keyword search","Anysearch","Anthropic","Google","Amazon","AWS"],"products":["agents","agent","Agents","MCP","Agent","Claude","claude"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队","采购负责人"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","采购","销售 / 客服"],"numbers":["4","6","2","5","3","8","12","14"],"quotes":["AI winters.","San Francisco","conditions","Partly Cloudy","humidity"]}
evidence_seed: {"company_actions":["AWS Marketplace Explore by use case Technical resources Popular tools AWS Marketplace Top tools and patterns Building agentic systems Introduction to AI agents A clear, practical overview of AI agents: How they relate to foundation models, access tools and data, automate workflows, and deliver measurable business value Watch the workshop Explore the full series Overview 🎓 Technical workshop 📖 Read the guide 🛠️ Tools Technical workshop: Introduction to AI agents Join AWS experts for a hands-on workshop featuring ","Real demos, real code, ship faster.","Explore AI tools Page topics A brief history of artificial intelligence Large language models From AI that responds to agents that act Agentic systems How agents fit in the real world of business Getting started guide A brief history of artificial intelligence Artificial intelligence has evolved over several decades, moving through cycles of optimism and so-called “AI winters."],"case_details":["Get started Featured AI tools in AWS Marketplace Build with foundation models, deployment platforms, and AI infrastructure—all available through your AWS account."],"workflow_changes":["Learn what AI agents are and how they create business value. This foundational module covers agent architecture, tool access, workflow automation, ... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=procurement_marketplace","Watch the workshop Introduction to AI agents Set foundation for agent adoption and indentify use cases where agents reduce latency, automate workflow, or improve decision accuracy."],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["开发者 / 工程团队","采购负责人"],"risks_or_constraints":[]}
missing_information: []
key_excerpts: [{"type":"workflow_change","text":"Learn what AI agents are and how they create business value. This foundational module covers agent architecture, tool access, workflow automation, ... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=procurement_marketplace","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"funding","text":"AWS Marketplace Explore by use case Technical resources Popular tools AWS Marketplace Top tools and patterns Building agentic systems Introduction to AI agents A clear, practical overview of AI agents: How they relate to foundation models, access tools and data, automate workflows, and deliver measurable business value Watch the workshop Explore the full series Overview 🎓 Technical workshop 📖 Read the guide 🛠️ Tools Technical workshop: Introduction to AI agents Join AWS experts for a hands-on workshop featuring ","supports":["daily_observation","heatmap","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Real demos, real code, ship faster.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"workflow_change","text":"Watch the workshop Introduction to AI agents Set foundation for agent adoption and indentify use cases where agents reduce latency, automate workflow, or improve decision accuracy.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"case_detail","text":"Get started Featured AI tools in AWS Marketplace Build with foundation models, deployment platforms, and AI infrastructure—all available through your AWS account.","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Explore AI tools Page topics A brief history of artificial intelligence Large language models From AI that responds to agents that act Agentic systems How agents fit in the real world of business Getting started guide A brief history of artificial intelligence Artificial intelligence has evolved over several decades, moving through cycles of optimism and so-called “AI winters.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
theme: technical-iteration-signal
keyword_group: technical-iteration-signal
copyright_note: local research archive only
---

# Introduction to AI agents: Foundations for enterprise development
...
No sales cycle—start building right away
...
Get notified when new modules go live →
Loading
Loading
Loading
Loading
...
Learn more
Free trial
Find top tools and patterns
Discover technical resources and AWS-integrated partner tools that help you launch, test, and scale with speed
Learn more
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":20617,"paragraph_count":171,"sentence_count":135,"boilerplate_hits":1,"symbol_ratio":0.0224,"method":"main"}
...
1. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Learn what AI agents are and how they create business value. This foundational module covers agent architecture, tool access, workflow automation, ... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=procurement_marketplace

2. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   AWS Marketplace Explore by use case Technical resources Popular tools AWS Marketplace Top tools and patterns Building agentic systems Introduction to AI agents A clear, practical overview of AI agents: How they relate to foundation models, access tools and data, automate workflows, and deliver measurable business value Watch the workshop Explore the full series Overview 🎓 Technical workshop 📖 Read the guide 🛠️ Tools Technical workshop: Introduction to AI agents Join AWS experts for a hands-on workshop featuring 

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Real demos, real code, ship faster.

4. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Watch the workshop Introduction to AI agents Set foundation for agent adoption and indentify use cases where agents reduce latency, automate workflow, or improve decision accuracy.

5. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Get started Featured AI tools in AWS Marketplace Build with foundation models, deployment platforms, and AI infrastructure—all available through your AWS account.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Explore AI tools Page topics A brief history of artificial intelligence Large language models From AI that responds to agents that act Agentic systems How agents fit in the real world of business Getting started guide A brief history of artificial intelligence Artificial intelligence has evolved over several decades, moving through cycles of optimism and so-called “AI winters.

## business_elements

- companies: keyword search, Anysearch, Anthropic, Google, Amazon, AWS
- products: agents, agent, Agents, MCP, Agent, Claude, claude
- people: 暂无公开信息
...
- numbers: 4, 6, 2, 5, 3, 8, 12, 14
- quotes: AI winters. / San Francisco / conditions / Partly Cloudy / humidity

## evidence_seed

- company_actions: AWS Marketplace Explore by use case Technical resources Popular tools AWS Marketplace Top tools and patterns Building agentic systems Introduction to AI agents A clear, practical overview of AI agents: How they relate to foundation models, access tools and data, automate workflows, and deliver measurable business value Watch the workshop Explore the full series Overview 🎓 Technical workshop 📖 Read the guide 🛠️ Tools Technical workshop: Introduction to AI agents Join AWS experts for a hands-on workshop featuring  / Real demos, real code, ship faster. / Explore AI tools Page topics A brief history of artificial intelligence Large language models From AI that responds to agents that act Agentic systems How agents fit in the real world of business Getting started guide A brief history of artificial intelligence Artificial intelligence has evolved over several decades, moving through cycles of optimism and so-called “AI winters.
- case_details: Get started Featured AI tools in AWS Marketplace Build with foundation models, deployment platforms, and AI infrastructure—all available through your AWS account.
- workflow_changes: Learn what AI agents are and how they create business value. This foundational module covers agent architecture, tool access, workflow automation, ... / query=agent governance evals production rollout enterprise AI / intent=find_original_source / path=procurement_marketplace / Watch the workshop Introduction to AI agents Set foundation for agent adoption and indentify use cases where agents reduce latency, automate workflow, or improve decision accuracy.
