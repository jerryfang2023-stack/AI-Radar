...
author: ""
published_at: ""
collected_at: 2026-06-18T06:41:09.394Z
language: mixed
full_text_hash: 0d925903d8e2ead1
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-168-molmomotion-语言引导的3d运动预测模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-168-molmomotion-语言引导的3d运动预测模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"MolmoMotion：语言引导的3D运动预测模型","discovery_summary":"MolmoMotion基于Molmo 2骨干网络，输入视频帧、物体上的3D点标记及文字动作指令（如“移动并旋转桌上放水果的木碗”），预测未来数秒内这些点的3D轨迹。提供两个变体：自回归的MolmoMotion-AR逐步预测坐标，流匹配的MolmoMotion-FM通过连续空间变换处理多可能性运动。同时发布MolmoMotion-1M数据集（含116万视频的3D点轨迹及动作描述）和PointMotionBench基准测试（2700个人工验证视频片段）。模型权重、数据集和基准测试均已开源。","source_name":"Hugging Face：Blog（RSS）","origin_url":"","discovered_at":"2026-06-18T06:35:54.492Z","rank_on_page":1,"discovery_status":"discovered"}
...
content_hash: 0d925903d8e2ead1
semantic_hash: 1363d269d8206616
duplicate_of: ""
first_seen_at: "2026-06-18T06:41:09.394Z"
last_seen_at: 2026-06-18T06:41:09.394Z
...
business_elements: {"companies":["Hugging Face","Blog（RSS）"],"products":[],"people":[],"industries":[],"roles":[],"workflows":[],"business_actions":["发布 / 推出"],"affected_departments":[],"numbers":["3","2","1M","116万","2700"],"quotes":["移动并旋转桌上放水果的木碗","移动并旋转桌上放水果的木碗"]}
...
4. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=medium
   同时发布MolmoMotion-1M数据集（含116万视频的3D点轨迹及动作描述）和PointMotionBench基准测试（2700个人工验证视频片段）。
...
- numbers: 3, 2, 1M, 116万, 2700
- quotes: 移动并旋转桌上放水果的木碗 / 移动并旋转桌上放水果的木碗

## evidence_seed

- company_actions: 提供两个变体：自回归的MolmoMotion-AR逐步预测坐标，流匹配的MolmoMotion-FM通过连续空间变换处理多可能性运动。 / 模型权重、数据集和基准测试均已开源。
- case_details: 暂无公开信息
