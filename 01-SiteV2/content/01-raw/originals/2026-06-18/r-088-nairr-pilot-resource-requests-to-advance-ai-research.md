...
raw_id: R-088
title: "NAIRR Pilot Resource Requests to Advance AI Research"
original_url: "https://nairrpilot.org/opportunities/allocations"
canonical_url: "https://nairrpilot.org/opportunities/allocations"
...
author: ""
published_at: ""
collected_at: 2026-06-18T06:41:09.216Z
language: mixed
full_text_hash: d453fc35a5e2fe7a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-088-nairr-pilot-resource-requests-to-advance-ai-research.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-088-nairr-pilot-resource-requests-to-advance-ai-research.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7861,"paragraph_count":46,"sentence_count":49,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 7861
fetch_error: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"d453fc35a5e2fe7a","missing":[]}
...
url_hash: f497834d8c092a99
content_hash: d453fc35a5e2fe7a
semantic_hash: a1178d035d3b82de
duplicate_of: ""
first_seen_at: "2026-06-18T06:41:09.216Z"
last_seen_at: 2026-06-18T06:41:09.216Z
...
business_elements: {"companies":["keyword search","Anysearch"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["合作 / 联盟","融资 / 投资"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["6","2024","12","2","3","1 m","6 m","15"],"quotes":[]}
evidence_seed: {"company_actions":["Projects will be awarded for twelve (12) months duration."],"case_details":["The Databricks NAIRR Pilot partnership will provide Databricks resources for academic research projects that rely on collecting, managing, sharing, and ... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=developer_ecosystem","Skip to main content Home / Opportunities / Research Resources NAIRR Pilot Resource Requests to Advance AI Research Questions about this call or need help with allocation?","Submit a ticket In the NAIRR Pilot, the US National Science Foundation (NSF), the US Department of Energy (DOE), and numerous private and non-profit sector partners are providing an opportunity for the research community to request access to a set of computing, model, platform and educational resources for projects related to advancing AI research."],"workflow_changes":["Eligibility This call is open to meritorious proposals by US-based researchers and educators from US-based institutions including academic institutions (including graduate students with a support letter from a faculty advisor), non-profits, federal agencies or federally funded R&D centers, state, local, or tribal agencies, startups and small businesses with federal grants."],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: []
key_excerpts: [{"type":"case_detail","text":"The Databricks NAIRR Pilot partnership will provide Databricks resources for academic research projects that rely on collecting, managing, sharing, and ... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=developer_ecosystem","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"case_detail","text":"Skip to main content Home / Opportunities / Research Resources NAIRR Pilot Resource Requests to Advance AI Research Questions about this call or need help with allocation?","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"case_detail","text":"Submit a ticket In the NAIRR Pilot, the US National Science Foundation (NSF), the US Department of Energy (DOE), and numerous private and non-profit sector partners are providing an opportunity for the research community to request access to a set of computing, model, platform and educational resources for projects related to advancing AI research.","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"case_detail","text":"This call for proposals will be open from May 6, 2024, until the end of the NAIRR Pilot program or until all resources have been committed to projects.","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Projects will be awarded for twelve (12) months duration.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"workflow_change","text":"Eligibility This call is open to meritorious proposals by US-based researchers and educators from US-based institutions including academic institutions (including graduate students with a support letter from a faculty advisor), non-profits, federal agencies or federally funded R&D centers, state, local, or tribal agencies, startups and small businesses with federal grants.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"}]
theme: early-direction-signal
keyword_group: early-direction-signal
copyright_note: local research archive only
title_zh: "NAIRR 试点资源请求推动 AI 研究进展"
...
Note that the email address you provide must be your institutional email. Requests providing personal email addresses such as &ldquo;.gmail.com&rdquo; addresses will not be considered.
Focus Areas
This call for allocation requests encompasses projects covering any of the following cross-cutting focus areas:
...
NAIRR Pilot projects are intended to be completed within twelve (12) months. Projects with longer-term timelines should complete a support request to be referred to existing proposal and allocation opportunities.
...
Project PIs are expected to provide brief (2&ndash;3 paragraphs) project updates 1 month and 6 months into the project, and a final report (three pages) upon project completion.
...
All supported projects not making full use of their allocations in a timely manner may be subject to reductions in their allocations in accordance with the NAIRR Pilot Allocation Management Policy
Instructions for NAIRR Pilot Project allocation awardees: Guidance on reporting for your project
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7861,"paragraph_count":46,"sentence_count":49,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   The Databricks NAIRR Pilot partnership will provide Databricks resources for academic research projects that rely on collecting, managing, sharing, and ... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=developer_ecosystem

2. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Skip to main content Home / Opportunities / Research Resources NAIRR Pilot Resource Requests to Advance AI Research Questions about this call or need help with allocation?

3. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Submit a ticket In the NAIRR Pilot, the US National Science Foundation (NSF), the US Department of Energy (DOE), and numerous private and non-profit sector partners are providing an opportunity for the research community to request access to a set of computing, model, platform and educational resources for projects related to advancing AI research.

4. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   This call for proposals will be open from May 6, 2024, until the end of the NAIRR Pilot program or until all resources have been committed to projects.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Projects will be awarded for twelve (12) months duration.

6. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Eligibility This call is open to meritorious proposals by US-based researchers and educators from US-based institutions including academic institutions (including graduate students with a support letter from a faculty advisor), non-profits, federal agencies or federally funded R&D centers, state, local, or tribal agencies, startups and small businesses with federal grants.
...
- numbers: 6, 2024, 12, 2, 3, 1 m, 6 m, 15
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Projects will be awarded for twelve (12) months duration.
- case_details: The Databricks NAIRR Pilot partnership will provide Databricks resources for academic research projects that rely on collecting, managing, sharing, and ... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=developer_ecosystem / Skip to main content Home / Opportunities / Research Resources NAIRR Pilot Resource Requests to Advance AI Research Questions about this call or need help with allocation? / Submit a ticket In the NAIRR Pilot, the US National Science Foundation (NSF), the US Department of Energy (DOE), and numerous private and non-profit sector partners are providing an opportunity for the research community to request access to a set of computing, model, platform and educational resources for projects related to advancing AI research.
- workflow_changes: Eligibility This call is open to meritorious proposals by US-based researchers and educators from US-based institutions including academic institutions (including graduate students with a support letter from a faculty advisor), non-profits, federal agencies or federally funded R&D centers, state, local, or tribal agencies, startups and small businesses with federal grants.
