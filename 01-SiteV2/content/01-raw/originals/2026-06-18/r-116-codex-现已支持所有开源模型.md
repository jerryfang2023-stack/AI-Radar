...
raw_id: R-116
title: "Codex 现已支持所有开源模型"
original_url: "https://x.com/thsottiaux/status/2067181377028538431"
canonical_url: "https://x.com/thsottiaux/status/2067181377028538431"
...
collected_at: 2026-06-18T06:41:09.300Z
language: mixed
full_text_hash: ecce7db2287b92e8
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-116-codex-现已支持所有开源模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-116-codex-现已支持所有开源模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"ecce7db2287b92e8","missing":[]}
...
discovery_record: {"discovery_title":"Codex 现已支持所有开源模型","discovery_summary":"提醒一下，你可以使用 Codex App、CLI 和 SDK 搭配任何开源模型，不仅仅限于 OpenAI 模型。","source_name":"X：Tibo (@thsottiaux)","origin_url":"https://x.com/thsottiaux/status/2067181377028538431","discovered_at":"2026-06-18T06:35:55.971Z","rank_on_page":328,"discovery_status":"discovered"}
...
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 6 0 9 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 609
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 6 . 1 K :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 6.1K
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 3 . 3 K :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 3.3K
Read 430 replies
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=medium
   Post Log in Sign up Post Tibo @thsottiaux Reminder that you can use the Codex App, CLI and SDK with any open source model, not just with OpenAI models.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=medium
   Advanced Configuration – Codex | OpenAI Developers From developers.
...
- company_actions: 提醒一下，你可以使用 Codex App、CLI 和 SDK 搭配任何开源模型，不仅仅限于 OpenAI 模型。 / Post Log in Sign up Post Tibo @thsottiaux Reminder that you can use the Codex App, CLI and SDK with any open source model, not just with OpenAI models. / Advanced Configuration – Codex | OpenAI Developers From developers.
- case_details: 暂无公开信息
