...
raw_id: R-023
title: "OpenAI 发布 LifeSciBench 生命科学基准测试"
original_url: "https://x.com/OpenAI/status/2067346916929937827"
canonical_url: "https://x.com/OpenAI/status/2067346916929937827"
...
collected_at: 2026-06-18T03:06:52.842Z
language: mixed
full_text_hash: 8757bbe89a691f40
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-023-openai-发布-lifescibench-生命科学基准测试.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-023-openai-发布-lifescibench-生命科学基准测试.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":54,"text_length":2701,"paragraph_count":11,"sentence_count":4,"boilerplate_hits":2,"symbol_ratio":0.0252,"method":"body-visible-text"}
has_full_text: true
content_length: 2701
fetch_error: ""
...
OpenAI on X: "Introducing LifeSciBench, a benchmark for measuring and improving how well AI supports real-world life science research.
Developed with 173 scientists from biotechnology and pharmaceutical research, LifeSciBench includes 750 expert-authored tasks across seven biological research https://t.co/JDkKWcnL9F" / X
Post
Log in Sign up
Post
OpenAI
...
8:41 PM · Jun 17, 2026 312.3K Views
...
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 1 8 3 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 183
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 1 . 9 K :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 1.9K
:host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.number,.digit{padding:round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) 0}.symbol{white-space:pre} 4 6 4 :where(number-flow-react){line-height:1}number-flow-react > span{font-kerning:none;display:inline-block;padding:calc(round(nearest, calc(var(--number-flow-mask-height, 0.25em) / 2), 1px) * 2) 0} 464
Read 141 replies
...
- fetch_status: fetched-readable-text-body-visible-text
- extraction_quality: high
- diagnostics: {"readability_score":54,"text_length":2701,"paragraph_count":11,"sentence_count":4,"boilerplate_hits":2,"symbol_ratio":0.0252,"method":"body-visible-text"}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Developed with 173 scientists from biotechnology and pharmaceutical research, LifeSciBench includes 750 expert-authored tasks across seven biological research https://t.
...
5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Developed with 173 scientists from biotechnology and pharmaceutical research, LifeSciBench includes 750 expert-authored tasks across seven biological research o/JTk0wXHFrT 8:41 PM · Jun 17, 2026 312.
...
- numbers: 173, 750, 9, 0, 8, 41, 17, 2026
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Developed with 173 scientists from biotechnology and pharmaceutical research, LifeSciBench includes 750 expert-authored tasks across seven biological research https://t. / Developed with 173 scientists from biotechnology and pharmaceutical research, LifeSciBench includes 750 expert-authored tasks across seven biological research o/JTk0wXHFrT 8:41 PM · Jun 17, 2026 312. / 3K Views :host{display:inline-block;direction:ltr;white-space:nowrap;line-height:1}span{display:inline-block}:host([data-will-change]) span{will-change:transform}.
- case_details: 暂无公开信息
