...
raw_id: R-007
title: "Anthropic 加入 Frontier 碳去除联盟，成首家 AI 初创成员"
...
canonical_url: "https://techcrunch.com/2026/06/17/anthropic-becomes-first-ai-startup-to-join-the-frontier-carbon-removal-coalition"
...
collected_at: 2026-06-18T03:06:52.781Z
language: mixed
full_text_hash: bf7e2f415dce9df1
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-007-anthropic-加入-frontier-碳去除联盟-成首家-ai-初创成员.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-007-anthropic-加入-frontier-碳去除联盟-成首家-ai-初创成员.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5951,"paragraph_count":31,"sentence_count":40,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 5951
fetch_error: ""
...
business_elements: {"companies":["TechCrunch","AI（RSS）","Anthropic","Google","Microsoft","Meta","Amazon","Cursor"],"products":["Cursor"],"people":[],"industries":[],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究"],"business_actions":["发布 / 推出","合作 / 联盟","融资 / 投资"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["9.15 亿","18 亿","7 亿","50","180 万","2","8","10"],"quotes":["all of the above","show a path to government subsidy/support,"]}
...
Topics
AI , Anthropic , carbon removal , Climate , frontier
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5951,"paragraph_count":31,"sentence_count":40,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
1. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   Anthropic 加入由 Stripe、Google、Shopify 等创立的碳去除集体 Frontier，并贡献 9.15 亿美元新资金，使 Frontier 总承诺额达 18 亿美元。Frontier 已签约近 7 亿美元，覆盖 50 多个项目，累计去除 180 万吨碳。未来 Frontier 将转向更严格审查，减少项目数量，聚焦每年可去除十亿吨 CO2 的项目，新合同期限 8 至 10 年。这是 Anthropic 首笔气候相关交易，此前该公司尚未发布可持续发展报告。

2. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   Image Credits: Samuel Boivin/NurPhoto / Getty Images Climate Anthropic becomes first AI startup to join the Frontier carbon removal coalition Tim De Chant 11:30 AM PDT · June 17, 2026 Anthropic is joining Frontier, the carbon removal collective, contributing to a new $915 million tranche of funding and marking its arrival as the first AI startup to join the group.

3. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   The new funding nearly doubles pledges to Frontier , bringing the total to $1.

4. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   So far, Frontier has contracted nearly $700 million across more than 50 projects to remove 1.

5. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   8 million tons of carbon.
...
- companies: TechCrunch, AI（RSS）, Anthropic, Google, Microsoft, Meta, Amazon, Cursor
- products: Cursor
- people: 暂无公开信息
- industries: 暂无公开信息
- roles: 开发者 / 工程团队
...
- numbers: 9.15 亿, 18 亿, 7 亿, 50, 180 万, 2, 8, 10
- quotes: all of the above / show a path to government subsidy/support,

## evidence_seed

- company_actions: Image Credits: Samuel Boivin/NurPhoto / Getty Images Climate Anthropic becomes first AI startup to join the Frontier carbon removal coalition Tim De Chant 11:30 AM PDT · June 17, 2026 Anthropic is joining Frontier, the carbon removal collective, contributing to a new $915 million tranche of funding and marking its arrival as the first AI startup to join the group. / The new funding nearly doubles pledges to Frontier , bringing the total to $1. / Companies that have pledged money to Frontier typically use the company’s carbon removal credits to reduce their publicly listed carbon footprints.
- case_details: 暂无公开信息
