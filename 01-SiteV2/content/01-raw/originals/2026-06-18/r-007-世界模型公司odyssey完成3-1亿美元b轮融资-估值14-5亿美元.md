...
canonical_url: "https://techcrunch.com/2026/06/17/world-model-maker-odyssey-nabs-1-45b-valuation-backed-by-amazon-and-other-big-names"
...
extractor_diagnostics: {"readability_score":78,"text_length":2894,"paragraph_count":18,"sentence_count":19,"boilerplate_hits":2,"symbol_ratio":0,"method":"main"}
has_full_text: true
content_length: 2894
fetch_error: ""
...
business_elements: {"companies":["TechCrunch","AI（RSS）","Anthropic","Google","Amazon","AWS","Nvidia","Cursor"],"products":["Cursor","agents"],"people":[],"industries":[],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":[],"business_actions":["融资 / 投资"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["3.1亿","14.5亿","2023","3.37亿","10","43","17","2026"],"quotes":[]}
...
Topics
AI , Fundraising , In Brief , odyssey , Startups , TC , world models
June 18
Los Angeles
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":78,"text_length":2894,"paragraph_count":18,"sentence_count":19,"boilerplate_hits":2,"symbol_ratio":0,"method":"main"}
...
2. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   In Brief Posted: 10:43 AM PDT · June 17, 2026 Image Credits: Odyssey Julie Bort World model maker Odyssey nabs $1.
...
4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   45B valuation led by Natural Capital, with Amazon, AMD Ventures, GV, and others participating.
...
- companies: TechCrunch, AI（RSS）, Anthropic, Google, Amazon, AWS, Nvidia, Cursor
...
- numbers: 3.1亿, 14.5亿, 2023, 3.37亿, 10, 43, 17, 2026
- quotes: 暂无公开信息

## evidence_seed

- company_actions: 由自动驾驶领域连续创业者Oliver Cameron（CEO）和Jeff Hawke（CTO）联合创立的世界模型AI公司Odyssey完成3.1亿美元B轮融资，估值14.5亿美元。本轮由Natural Capital领投，Amazon、AMD Ventures、GV等跟投。Odyssey成立于2023年，其世界模型通过人员背负相机采集物理世界数据并模拟真实物理效果。公司提供面向游戏制作和机器人等场景的多款世界模型，以从文本提示生成交互视频而知名。AWS成为首选云服务商，模型将针对AWS Trainium芯片优化。天使投资者包括Jeff Dean、Elad Gil等，累计融资3.37亿美元。 / 45B valuation backed by Amazon and other big names Odyssey, a world model AI startup founded by self-driving vehicle pioneers CEO Oliver Cameron and CTO Jeff Hawke, has raised a $310 million Series B round at a $1. / 45B valuation led by Natural Capital, with Amazon, AMD Ventures, GV, and others participating.
- case_details: 暂无公开信息
