...
raw_id: R-035
title: "Soniox v5 Real-Time 发布：低延迟流式语音转文本模型"
original_url: "https://x.com/ArtificialAnlys/status/2067257887815295291"
canonical_url: "https://x.com/ArtificialAnlys/status/2067257887815295291"
...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-035-soniox-v5-real-time-发布-低延迟流式语音转文本模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":84,"text_length":3933,"paragraph_count":14,"sentence_count":5,"boilerplate_hits":1,"symbol_ratio":0.0178,"method":"main"}
has_full_text: true
content_length: 3933
fetch_error: ""
...
url_hash: 7cc884951fbe1533
content_hash: 857ef286aa06225c
...
business_elements: {"companies":["X","Artificial Analysis (@ArtificialAnlys)"],"products":[],"people":[],"industries":[],"roles":[],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["5","4.5%","0.05","7.4%","0.02","3","6.7%","0.06"],"quotes":[]}
...
Soniox v5 Real-Time is @ soniox_ai 's latest streaming Speech to Text (STT) model, joining non-streaming model released last week. On AA-WER Streaming it occupies the middle of the Pareto frontier: faster than the most accurate models (Cartesia Ink-2, ElevenLabs Scribe v2 Realtime) and more accurate than the fastest (Deepgram Flux, Nova-3), while at a lower price than all of them.
...
2:47 PM · Jun 17, 2026 7.4K Views
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":84,"text_length":3933,"paragraph_count":14,"sentence_count":5,"boilerplate_hits":1,"symbol_ratio":0.0178,"method":"main"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Post Log in Sign up Post Artificial Analysis @ArtificialAnlys Soniox has released Soniox v5 Real-Time: a low latency streaming Speech to Text model on the Pareto frontier for accuracy and latency, at the lowest price of any proprietary model tested Soniox v5 Real-Time is @ soniox_ai 's latest streaming Speech to Text (STT) model, joining non-streaming model released last week.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   On AA-WER Streaming it occupies the middle of the Pareto frontier: faster than the most accurate models (Cartesia Ink-2, ElevenLabs Scribe v2 Realtime) and more accurate than the fastest (Deepgram Flux, Nova-3), while at a lower price than all of them.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   AA-WER Streaming Overview AA-WER Streaming reports WER and latency as a pair, measured from Silero VAD-detected end of speech on the same ~8 hours of audio as our non-streaming STT benchmark, AA-WER v2.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   We report both at two points: First Final (first final-denoted transcript, best for accuracy) and First Partial (first transcript-bearing event, best for when speed matters most).

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Key takeaways ➤ First Final Transcription: Soniox v5 Real-Time achieves a 4.
...
- numbers: 5, 4.5%, 0.05, 7.4%, 0.02, 3, 6.7%, 0.06
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Post Log in Sign up Post Artificial Analysis @ArtificialAnlys Soniox has released Soniox v5 Real-Time: a low latency streaming Speech to Text model on the Pareto frontier for accuracy and latency, at the lowest price of any proprietary model tested Soniox v5 Real-Time is @ soniox_ai 's latest streaming Speech to Text (STT) model, joining non-streaming model released last week. / On AA-WER Streaming it occupies the middle of the Pareto frontier: faster than the most accurate models (Cartesia Ink-2, ElevenLabs Scribe v2 Realtime) and more accurate than the fastest (Deepgram Flux, Nova-3), while at a lower price than all of them. / AA-WER Streaming Overview AA-WER Streaming reports WER and latency as a pair, measured from Silero VAD-detected end of speech on the same ~8 hours of audio as our non-streaming STT benchmark, AA-WER v2.
- case_details: 暂无公开信息
