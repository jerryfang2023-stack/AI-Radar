...
raw_id: R-017
title: "Z.ai 发布 GLM 5.2 等 AI 行业动态"
original_url: "https://x.com/rohanpaul_ai/status/2067369141116555485"
canonical_url: "https://x.com/rohanpaul_ai/status/2067369141116555485"
...
collected_at: 2026-06-18T03:06:52.822Z
language: mixed
full_text_hash: c7271eede1ec39bf
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-017-z-ai-发布-glm-5-2-等-ai-行业动态.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-18/r-017-z-ai-发布-glm-5-2-等-ai-行业动态.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":72,"text_length":2898,"paragraph_count":13,"sentence_count":6,"boilerplate_hits":2,"symbol_ratio":0.0238,"method":"main"}
has_full_text: true
content_length: 2898
fetch_error: ""
...
business_elements: {"companies":["X","Rohan Paul (@rohanpaul_ai)","OpenAI","Anthropic","Google","Nvidia"],"products":["Codex","agents"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["5.2","1M","72","300","13 倍","300%","30%","26B"],"quotes":[]}
...
🔗 rohan-paul.com/p/zai-releases…
🗞️ Z .ai releases GLM 5.2 model: 1M context window with MIT-licensed open weights, long-horizon coding agents
🗞️ Tensordyne Announces Breakthrough Inference System - 13x the rack throughput of NVIDIA’s study. Code volume surges by 300%, but output increases by only 30%: The AI dividend meets an awkward reality
...
10:09 PM · Jun 17, 2026 1.3K Views
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":72,"text_length":2898,"paragraph_count":13,"sentence_count":6,"boilerplate_hits":2,"symbol_ratio":0.0238,"method":"main"}
...
5. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   2 model: 1M context window with MIT-licensed open weights, long-horizon coding agents 🗞️ Tensordyne Announces Breakthrough Inference System - 13x the rack throughput of NVIDIA’s study.

6. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   Code volume surges by 300%, but output increases by only 30%: The AI dividend meets an awkward reality 🗞️ Google released DiffusionGemma, an open experimental 26B MoE, activates only 3.

## business_elements

- companies: X, Rohan Paul (@rohanpaul_ai), OpenAI, Anthropic, Google, Nvidia
...
- numbers: 5.2, 1M, 72, 300, 13 倍, 300%, 30%, 26B
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Post Log in Sign up Post Rohan Paul @rohanpaul_ai Today’s edition of my newsletter just went out. / com/p/zai-releases… 🗞️ Z . / ai releases GLM 5.
- case_details: 暂无公开信息
