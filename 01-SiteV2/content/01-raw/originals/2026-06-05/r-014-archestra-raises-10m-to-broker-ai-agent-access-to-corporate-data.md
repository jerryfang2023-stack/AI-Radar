...
raw_id: R-014
title: "Archestra raises $10M to broker AI agent access to corporate data"
original_url: "https://siliconangle.com/2026/06/02/archestra-raises-10m-broker-ai-agent-access-corporate-data/"
canonical_url: "https://siliconangle.com/2026/06/02/archestra-raises-10m-broker-ai-agent-access-corporate-data"
...
author: ""
published_at: ""
collected_at: 2026-06-05T00:46:23.081Z
language: mixed
full_text_hash: 37249690c82d8e0a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-05/r-014-archestra-raises-10m-to-broker-ai-agent-access-to-corporate-data.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-05/r-014-archestra-raises-10m-to-broker-ai-agent-access-to-corporate-data.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":6613,"paragraph_count":39,"sentence_count":41,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
has_full_text: true
content_length: 6613
fetch_error: ""
...
url_hash: cce803ff63341fd3
content_hash: 37249690c82d8e0a
semantic_hash: 43c850473ce530bb
duplicate_of: ""
first_seen_at: "2026-06-05T00:46:23.081Z"
last_seen_at: 2026-06-05T00:46:23.081Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Google","Microsoft","GitHub","Salesforce"],"products":["agent","agents","Claude","ChatGPT","Gemini","MCP","Copilot"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","采购负责人","销售 / 客服"],"workflows":["计费 / 预算管理","权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","采购","销售 / 客服"],"numbers":["$10M","08","00","02","2026","$10 million","500","95"],"quotes":["Until now, AI teams had to choose between harshly restricting AI agents and building truly agentic systems, thereby exposing the business to enormous risks,"]}
...
Space propulsion startup Impulse Space closes $500M investment
EMERGING TECH - BY MARIA DEUTSCHER . 1 MIN AGO
JupiterOne launches Continuous Controls Monitoring to test security controls against live asset data
SECURITY - BY DUNCAN RILEY . 3 HOURS AGO
MazeBolt launches RADAR VectorAI to test enterprise defenses against AI-generated DDoS attacks
SECURITY - BY DUNCAN RILEY . 4 HOURS AGO
Florida AG sues OpenAI and Sam Altman over claims the technology is dangerous and exploits its users
AI - BY JAMES FARRELL . 10 HOURS AGO
HPE posts huge earnings beat thanks to AI servers, sending its stock skyward
INFRA - BY MIKE WHEATLEY . 11 HOURS AGO
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":6613,"paragraph_count":39,"sentence_count":41,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Archestra Inc., a U.K.-based startup whose open-source platform brokers access between artificial intelligence agents and sensitive enterprise ... / query=open-source AI agent GitHub enterprise adoption / intent=find_customer_case / path=capital_startup

2. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   UPDATED 08:00 EDT / JUNE 02 2026 AI Archestra raises $10M to broker AI agent access to corporate data by Duncan Riley SHARE Archestra Inc.

3. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   -based startup whose open-source platform brokers access between artificial intelligence agents and sensitive enterprise data, today announced that it has raised $10 million in new funding to expand deployments inside large enterprises and grow its open-source ecosystem.

4. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The platform is in production at four Fortune 500 companies, where agents are working across legal, procurement, management and operations.

5. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   Archestra says enterprise AI teams can wire agents to internal data in days rather than months and without the data exfiltration and prompt-injection risks that have stalled earlier pilots.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Archestra acts as a middle layer between the agent and the data.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Google, Microsoft, GitHub, Salesforce
- products: agent, agents, Claude, ChatGPT, Gemini, MCP, Copilot
- people: 暂无公开信息
...
- numbers: $10M, 08, 00, 02, 2026, $10 million, 500, 95
- quotes: Until now, AI teams had to choose between harshly restricting AI agents and building truly agentic systems, thereby exposing the business to enormous risks,

## evidence_seed

- company_actions: UPDATED 08:00 EDT / JUNE 02 2026 AI Archestra raises $10M to broker AI agent access to corporate data by Duncan Riley SHARE Archestra Inc. / -based startup whose open-source platform brokers access between artificial intelligence agents and sensitive enterprise data, today announced that it has raised $10 million in new funding to expand deployments inside large enterprises and grow its open-source ecosystem. / Archestra acts as a middle layer between the agent and the data.
- case_details: Archestra Inc., a U.K.-based startup whose open-source platform brokers access between artificial intelligence agents and sensitive enterprise ... / query=open-source AI agent GitHub enterprise adoption / intent=find_customer_case / path=capital_startup
- workflow_changes: The platform is in production at four Fortune 500 companies, where agents are working across legal, procurement, management and operations.
...
- risks_or_constraints: Archestra says enterprise AI teams can wire agents to internal data in days rather than months and without the data exfiltration and prompt-injection risks that have stalled earlier pilots.
