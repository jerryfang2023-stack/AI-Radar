...
title_zh: "Anthropic 如何保障AI原生软件开发生命周期的安全"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://claude.com/blog/how-anthropic-secures-its-ai-native-software-development-lifecycle"
canonical_url: "https://claude.com/blog/how-anthropic-secures-its-ai-native-software-development-lifecycle"
...
collected_at: 2026-07-22T01:55:20.047Z
language: mixed
full_text_hash: b4dbd8db6ea0fcd9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-22/r-032-anthropic-如何保障ai原生软件开发生命周期的安全.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-22/r-032-anthropic-如何保障ai原生软件开发生命周期的安全.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":18059,"paragraph_count":90,"sentence_count":148,"boilerplate_hits":0,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 18059
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 如何保障AI原生软件开发生命周期的安全","discovery_summary":"Anthropic副首席信息安全官Jason Clinton披露，其软件工程师每季度交付的代码量是2021-2025年平均水平的8倍，Claude编写了约80%合并入库的代码。安全团队通过安全左移、硬访问与身份边界、自动化与智能体审查结合、关键节点引入人工审核等策略，应对被入侵或提示注入的智能体引入恶意变更等威胁，同时不显著拖慢开发速度。","source_name":"Claude：Blog（网页）","origin_url":"https://claude.com/blog/how-anthropic-secures-its-ai-native-software-development-lifecycle","discovered_at":"2026-07-22T01:46:55.147Z","rank_on_page":133,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: bd313e7fdc9f5123
content_hash: 1dfcc071ac56f8c0
semantic_hash: f908a8b2af6ee12c
duplicate_of: ""
first_seen_at: "2026-07-20T16:00:00.000Z"
last_seen_at: 2026-07-22T01:55:20.047Z
...
business_elements: {"companies":["Claude","Blog（网页）","Anthropic"],"products":["Claude","agents","Agents","agent","claude","CLAUDE","Agent"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["2021","2025","8倍","80%","8x","0","5","1"],"quotes":["user A can never read user B’s data,","red teams","can we afford to scan everything?","what would we run if scanning were nearly free?"]}
...
fact_extraction_completed_at: 2026-07-22T01:55:20.047Z
...
This article was written by Jason Clinton, Deputy CISO, Anthropic. He’d like to thank Michael Segner
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":18059,"paragraph_count":90,"sentence_count":148,"boilerplate_hits":0,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   At Anthropic, the amount of code and velocity of deployment have scaled exponentially.
...
4. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Our reviews, monitoring, and other security processes needed to scale alongside this increased pace.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Otherwise it becomes a formula for bottlenecks ( Amdahl’s Law ).
...
6. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Our software development processes have changed drastically as well.

## business_elements

- companies: Claude, Blog（网页）, Anthropic
- products: Claude, agents, Agents, agent, claude, CLAUDE, Agent
- people: 暂无公开信息
...
- numbers: 2021, 2025, 8倍, 80%, 8x, 0, 5, 1
- quotes: user A can never read user B’s data, / red teams / can we afford to scan everything? / what would we run if scanning were nearly free?

## evidence_seed

- company_actions: Otherwise it becomes a formula for bottlenecks ( Amdahl’s Law ).
- case_details: At Anthropic, the amount of code and velocity of deployment have scaled exponentially.
- workflow_changes: Our software development processes have changed drastically as well.
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: Our reviews, monitoring, and other security processes needed to scale alongside this increased pace.
