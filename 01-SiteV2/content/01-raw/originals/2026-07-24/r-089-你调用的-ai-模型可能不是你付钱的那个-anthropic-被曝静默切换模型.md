...
raw_id: R-089
title: "你调用的 AI 模型可能不是你付钱的那个--Anthropic 被曝静默切换模型"
title_zh: "你调用的 AI 模型可能不是你付钱的那个--Anthropic 被曝静默切换模型"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.marktechpost.com/2026/07/23/you-didnt-get-the-ai-model-you-paid-for"
canonical_url: "https://marktechpost.com/2026/07/23/you-didnt-get-the-ai-model-you-paid-for"
...
search_path_label: ""
author: ""
published_at: "2026-07-23T18:07:55.000Z"
collected_at: 2026-07-24T01:25:54.471Z
language: mixed
full_text_hash: 0f746fea9f904bf3
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-24/r-089-你调用的-ai-模型可能不是你付钱的那个-anthropic-被曝静默切换模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-24/r-089-你调用的-ai-模型可能不是你付钱的那个-anthropic-被曝静默切换模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":10434,"paragraph_count":51,"sentence_count":92,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 10434
fetch_error: ""
...
discovery_record: {"discovery_title":"你调用的 AI 模型可能不是你付钱的那个--Anthropic 被曝静默切换模型","discovery_summary":"调用 API 时指定 `model： \"claude-fable-5\"`，返回的响应中 `model` 字段却显示 `\"claude-opus-4-8\"`。Anthropic 在生成开始前对请求进行分类，匹配到敏感类别后静默切换至另一组权重，且不报错、不重试。用户实际获得的模型与付费指定的模型不一致。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/23/you-didnt-get-the-ai-model-you-paid-for","discovered_at":"2026-07-24T01:15:58.843Z","rank_on_page":125,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 48bffc7e6f81e100
content_hash: 0f746fea9f904bf3
semantic_hash: c7b1f035d83f912f
duplicate_of: ""
first_seen_at: "2026-07-23T18:07:55.000Z"
last_seen_at: 2026-07-24T01:25:54.471Z
...
business_elements: {"companies":["MarkTechPost（RSS）","Anthropic","Cursor"],"products":["claude","Cursor","cursor","Claude"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["5","4","8","5 b","1","4.8","600","000"],"quotes":["claude-fable-5","claude-opus-4-8","claude-fable-5","claude-opus-4-8","frontier quality"]}
...
fact_extraction_completed_at: 2026-07-24T01:25:54.471Z
theme: developer-ecosystem-signal
keyword_group: developer-ecosystem-signal
copyright_note: local research archive only
---

# 你调用的 AI 模型可能不是你付钱的那个--Anthropic 被曝静默切换模型
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":10434,"paragraph_count":51,"sentence_count":92,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   调用 API 时指定 `model： "claude-fable-5"`，返回的响应中 `model` 字段却显示 `"claude-opus-4-8"`。Anthropic 在生成开始前对请求进行分类，匹配到敏感类别后静默切换至另一组权重，且不报错、不重试。用户实际获得的模型与付费指定的模型不一致。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Technology AI Shorts Artificial Intelligence Applications Editors Pick Guest Post Language Model Large Language Model Machine Learning Tech News The line in the response object You call the API.

3. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   You pass model: “claude-fable-5”.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Anthropic documented this when it brought Fable 5 back on July 1: blocked requests are sent to Opus 4.

## business_elements

- companies: MarkTechPost（RSS）, Anthropic, Cursor
- products: claude, Cursor, cursor, Claude
- people: 暂无公开信息
...
- numbers: 5, 4, 8, 5 b, 1, 4.8, 600, 000
- quotes: claude-fable-5 / claude-opus-4-8 / claude-fable-5 / claude-opus-4-8 / frontier quality

## evidence_seed

- company_actions: Technology AI Shorts Artificial Intelligence Applications Editors Pick Guest Post Language Model Large Language Model Machine Learning Tech News The line in the response object You call the API. / The request was classified before generation began, matched a sensitive category, and was handed to a different set of weights entirely. / Anthropic documented this when it brought Fable 5 back on July 1: blocked requests are sent to Opus 4.
- case_details: 暂无公开信息
