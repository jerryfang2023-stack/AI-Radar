...
raw_id: R-007
title: "Anthropic 发布 Claude Security 插件 Beta 版：面向 Claude Code 的多智能体漏洞扫描器"
title_zh: "Anthropic 发布 Claude Security 插件 Beta 版：面向 Claude Code 的多智能体漏洞扫描器"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.marktechpost.com/2026/07/22/anthropic-releases-claude-security-plugin-for-claude-code-in-beta-a-multi-agent-vulnerability-scanner-that-runs-in-your-terminal"
canonical_url: "https://marktechpost.com/2026/07/22/anthropic-releases-claude-security-plugin-for-claude-code-in-beta-a-multi-agent-vulnerability-scanner-that-runs-in-your-terminal"
...
search_path_label: ""
author: ""
published_at: "2026-07-23T06:12:05.000Z"
collected_at: 2026-07-24T01:25:15.121Z
language: mixed
full_text_hash: 0e761dbedebf3da8
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-24/r-007-anthropic-发布-claude-security-插件-beta-版-面向-claude-code-的多智能体漏洞扫描器.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-24/r-007-anthropic-发布-claude-security-插件-beta-版-面向-claude-code-的多智能体漏洞扫描器.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":10034,"paragraph_count":63,"sentence_count":62,"boilerplate_hits":1,"symbol_ratio":0.001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 10034
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 发布 Claude Security 插件 Beta 版：面向 Claude Code 的多智能体漏洞扫描器","discovery_summary":"Anthropic 为 Claude Code 推出 Claude Security 插件 Beta 版。该插件可在现有 Claude Code 会话中对仓库执行多智能体漏洞扫描，并将选中的发现转化为补丁文件供用户审查和应用。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/22/anthropic-releases-claude-security-plugin-for-claude-code-in-beta-a-multi-agent-vulnerability-scanner-that-runs-in-your-terminal","discovered_at":"2026-07-24T01:15:58.888Z","rank_on_page":314,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 2e717c0b2aabe778
content_hash: 0e761dbedebf3da8
semantic_hash: 3d5b23a1d370ee95
duplicate_of: ""
first_seen_at: "2026-07-23T06:12:05.000Z"
last_seen_at: 2026-07-24T01:25:15.121Z
...
business_elements: {"companies":["MarkTechPost（RSS）","Anthropic","Meta","Cursor"],"products":["Claude","agent","claude","agents","CLAUDE","Cursor","Agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["0.10","0","12","24","1","2","3","2.1"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-24T01:25:15.121Z
...
1. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Anthropic 为 Claude Code 推出 Claude Security 插件 Beta 版。该插件可在现有 Claude Code 会话中对仓库执行多智能体漏洞扫描，并将选中的发现转化为补丁文件供用户审查和应用。

2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Editors Pick Agentic AI Artificial Intelligence Applications Technology New Releases Security Software Engineering Staff Tech News Anthropic has released the Claude Security plugin for Claude Code in beta.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The plugin runs a multi-agent vulnerability scan of a repository from inside an existing Claude Code session, then turns the findings you select into patch files that you review and apply yourself.

4. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Anthropic emphasized the tool’s versatility upon announcement, highlighting its capability to either run a comprehensive scan across the full codebase or inspect changes from the terminal right before a commit.

5. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   What plugin adds The plugin adds a single command, /claude-security, which opens a menu of three jobs, per the official documentation : Scan codebase — the whole repository or a scoped subset of it Scan changes — a branch’s diff, a pull request’s diff, or a single commit Suggest patches — turn a report’s findings into .

6. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   patch files Installation is two commands from the official Anthropic marketplace : Copy Code Copied Use a different Browser /plugin install claude-security@claude-plugins-official /reload-plugins If the marketplace is not found, run /plugin marketplace add anthropics/claude-plugins-official first.

## business_elements

- companies: MarkTechPost（RSS）, Anthropic, Meta, Cursor
- products: Claude, agent, claude, agents, CLAUDE, Cursor, Agent
- people: 暂无公开信息
...
- numbers: 0.10, 0, 12, 24, 1, 2, 3, 2.1
- quotes: 暂无公开信息

## evidence_seed

- company_actions: The plugin runs a multi-agent vulnerability scan of a repository from inside an existing Claude Code session, then turns the findings you select into patch files that you review and apply yourself. / Anthropic emphasized the tool’s versatility upon announcement, highlighting its capability to either run a comprehensive scan across the full codebase or inspect changes from the terminal right before a commit.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: Anthropic 为 Claude Code 推出 Claude Security 插件 Beta 版。该插件可在现有 Claude Code 会话中对仓库执行多智能体漏洞扫描，并将选中的发现转化为补丁文件供用户审查和应用。 / Editors Pick Agentic AI Artificial Intelligence Applications Technology New Releases Security Software Engineering Staff Tech News Anthropic has released the Claude Security plugin for Claude Code in beta. / What plugin adds The plugin adds a single command, /claude-security, which opens a menu of three jobs, per the official documentation : Scan codebase — the whole repository or a scoped subset of it Scan changes — a branch’s diff, a pull request’s diff, or a single commit Suggest patches — turn a report’s findings into .
