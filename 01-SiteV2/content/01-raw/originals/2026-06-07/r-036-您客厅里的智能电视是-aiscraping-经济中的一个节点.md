...
raw_id: R-036
title: "您客厅里的智能电视是 AIScraping 经济中的一个节点"
original_url: "https://blog.includesecurity.com/2026/06/the-smart-tv-in-your-livingroom-is-a-node-in-the-aiscraping-economy"
canonical_url: "https://blog.includesecurity.com/2026/06/the-smart-tv-in-your-livingroom-is-a-node-in-the-aiscraping-economy"
...
search_path_label: ""
author: ""
published_at: "2026-06-06T13:47:16.804Z"
collected_at: 2026-06-07T05:57:12.562Z
language: mixed
full_text_hash: 82a689cc8176b773
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-07/r-036-您客厅里的智能电视是-aiscraping-经济中的一个节点.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-07/r-036-您客厅里的智能电视是-aiscraping-经济中的一个节点.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":18091,"paragraph_count":122,"sentence_count":115,"boilerplate_hits":2,"symbol_ratio":0.0077,"method":"main"}
has_full_text: true
content_length: 18091
fetch_error: ""
...
discovery_record: {"discovery_title":"您客厅里的智能电视是 AIScraping 经济中的一个节点","discovery_summary":"智能电视被描述为 AI 抓取经济中的节点，客厅设备可能被用于大规模数据采集网络。该观点来自一篇安全博客，揭示了家庭联网设备在 AI 训练数据供应链中的潜在角色。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://blog.includesecurity.com/2026/06/the-smart-tv-in-your-livingroom-is-a-node-in-the-aiscraping-economy","discovered_at":"2026-06-07T05:47:56.754Z","rank_on_page":137,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 974b693d421350d4
content_hash: a0b3496bacdd05bf
semantic_hash: ceae3d67b7edd643
duplicate_of: ""
first_seen_at: "2026-06-06T13:47:16.804Z"
last_seen_at: 2026-06-07T05:57:12.562Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Google","AWS","Apple"],"products":["agent"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["400M","2025","2019","150M","24","7","1%","200"],"quotes":["a glut of proxies from Aisuru and other sources is fueling large-scale data harvesting efforts tied to various AI projects.","150M+ IPs","occasionally.","ipc_call","ipc_post"]}
...
Three data sources:
Thirty days of TLS-inspecting proxy captures from iOS device running consent-installed partner apps (including XYO COIN, which embeds the Bright SDK).
Static analysis of the SDK binary (brdsdk.framework, version 1.532.120, iOS arm64).
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":18091,"paragraph_count":122,"sentence_count":115,"boilerplate_hits":2,"symbol_ratio":0.0077,"method":"main"}
...
6. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   Bright Data is a data-collection company that sells access to what it markets as the world’s largest residential proxy network of 400M+ home IP addresses that its customers route web-scraping traffic through.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）, Google, AWS, Apple
- products: agent
- people: 暂无公开信息
...
- numbers: 400M, 2025, 2019, 150M, 24, 7, 1%, 200
- quotes: a glut of proxies from Aisuru and other sources is fueling large-scale data harvesting efforts tied to various AI projects. / 150M+ IPs / occasionally. / ipc_call / ipc_post

## evidence_seed

- company_actions: We’re all aware of the community-level opposition happening against datacenters, aimed at improving AI capabilities, being built recently. / What you might not be aware of are the distributed efforts to train AI that could be using the devices inside your home. / In this post, we’re going to explore how the company Bright Data facilitates modern AI models scraping training data from the Internet using its residential proxy network.
- case_details: Bright Data is a data-collection company that sells access to what it markets as the world’s largest residential proxy network of 400M+ home IP addresses that its customers route web-scraping traffic through.
...
- risks_or_constraints: 智能电视被描述为 AI 抓取经济中的节点，客厅设备可能被用于大规模数据采集网络。该观点来自一篇安全博客，揭示了家庭联网设备在 AI 训练数据供应链中的潜在角色。 / The work at Include Security has us working with AI day in and day out (hacking it, using it, training it, etc).
