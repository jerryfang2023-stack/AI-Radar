...
collected_at: 2026-07-16T02:39:33.546Z
language: mixed
full_text_hash: 2d2ca8e2cdf1d254
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-16/r-023-orthogonal-raises-4-3m-to-build-the-api-layer-for-ai-agents-the-silico.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-16/r-023-orthogonal-raises-4-3m-to-build-the-api-layer-for-ai-agents-the-silico.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":83,"text_length":3135,"paragraph_count":14,"sentence_count":23,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 3135
fetch_error: ""
...
url_hash: 53d20e34c67874a8
content_hash: 2d2ca8e2cdf1d254
semantic_hash: d8b1eeff515739e5
duplicate_of: ""
first_seen_at: "2026-06-23T00:00:00.000Z"
last_seen_at: 2026-07-16T02:39:33.546Z
...
business_elements: {"companies":["keyword search","Anysearch","Google","Amazon","Cursor"],"products":["Agents","agents","agent","MCP","Claude","Cursor"],"people":[],"industries":["开发者工具"],"roles":["开发者 / 工程团队","销售 / 客服"],"workflows":["计费 / 预算管理"],"business_actions":["合作 / 联盟","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["$4.3M","26","30","2x","50","23","2026","06"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-16T02:39:33.546Z
...
June 23, 2026
Company:
Orthogonal ( www.orthogonal.com )
Founders:
Christian Pickett (Co-founder), Bera Sogut (Co-founder)
Funding History
Seed: $4.3M
2026-06
Led by Pantera Capital
Pantera Capital , Y Combinator , Pioneer Fund , Decasonic, Outbound Capital, Rice Capital, Surreal by Premise
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":83,"text_length":3135,"paragraph_count":14,"sentence_count":23,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   Orthogonal Raises $4.3M to Build the API Layer for AI Agents - The Silicon Valley Post # Orthogonal Raises $4.3M to Build the API Layer for AI Agents Orthogonal(orthogonal.com), a YC W26 startup building a unified API and payments layer for AI agents, has raised $4.3M in seed funding from Pantera ..... / query=Y Combinator AI startup agent infra / intent=find_startups / path=capital_startup
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   3M to Build the API Layer for AI Agents Orthogonal ( orthogonal.
...
4. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   com ), a YC W26 startup building a unified API and payments layer for AI agents, has raised $4.
...
5. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   3M in seed funding from Pantera Capital, Pioneer Fund , Y Combinator, Decasonic, Outbound Capital, Rice Capital, Surreal by Premise, and others, as first reported by The Street .
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The entire API economy was built for humans.

## business_elements

- companies: keyword search, Anysearch, Google, Amazon, Cursor
- products: Agents, agents, agent, MCP, Claude, Cursor
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: $4.3M, 26, 30, 2x, 50, 23, 2026, 06
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Orthogonal Raises $4.3M to Build the API Layer for AI Agents - The Silicon Valley Post # Orthogonal Raises $4.3M to Build the API Layer for AI Agents Orthogonal(orthogonal.com), a YC W26 startup building a unified API and payments layer for AI agents, has raised $4.3M in seed funding from Pantera ..... / query=Y Combinator AI startup agent infra / intent=find_startups / path=capital_startup / Orthogonal Raises $4. / 3M to Build the API Layer for AI Agents Orthogonal ( orthogonal.
- case_details: 暂无公开信息
