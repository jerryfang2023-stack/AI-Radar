...
collected_at: 2026-07-16T02:39:34.021Z
language: mixed
full_text_hash: 424c741023c37e1c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-16/r-107-deepseek-ipo-plans-kalshi-compute-markets-bonsai-phone-model.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-16/r-107-deepseek-ipo-plans-kalshi-compute-markets-bonsai-phone-model.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":82,"text_length":4908,"paragraph_count":30,"sentence_count":34,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
has_full_text: true
content_length: 4908
fetch_error: ""
...
url_hash: 8dddbe2ec4c4e97d
content_hash: 424c741023c37e1c
semantic_hash: f196c901701d9ec8
duplicate_of: ""
first_seen_at: "2026-07-15T00:00:00.000Z"
last_seen_at: 2026-07-16T02:39:34.021Z
...
business_elements: {"companies":["TLDR AI Newsletter","OpenAI","Anthropic","Google","Perplexity"],"products":["Agents","agents","agent"],"people":[],"industries":["金融 / 保险","开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2026","07","15","4","10","2 m","2B","3 m"],"quotes":["There's hope in hard questions,"]}
...
fact_extraction_completed_at: 2026-07-16T02:39:34.021Z
theme: uncategorized
...
DeepSeek IPO plans 📈, Kalshi compute markets ⚡, Bonsai phone model 📱 TLDR
Newsletters
Advertise
Blog
TLDR
...
👉 Launch your site with Framer today
...
Anthropic's newest ad is creeping people out (4 minute read)
...
- fetch_status: fetched-readable-text-body-visible-text
- extraction_quality: high
- diagnostics: {"readability_score":82,"text_length":4908,"paragraph_count":30,"sentence_count":34,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
...
1. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=medium｜confidence=high
   DeepSeek IPO plans 📈, Kalshi compute markets ⚡, Bonsai phone model 📱 TLDR Newsletters Advertise Blog TLDR TLDR AI 2026-07-15 DeepSeek IPO plans 📈, Kalshi compute markets ⚡, Bonsai phone model 📱 Google announces Gemma 4 optimized for the Pixel 10's TPU (2 minute read) Gemma 4 E2B for TPU is designed to run natively on the Pixel 10's TPU.
...
2. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It supports instant, deep offline conversation, image identification, and on-device audio transcription.

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   The model also lets users command core phone functions, like Wi-Fi or maps, using just private voice or text.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Video demonstrations of what the model can do are available in the article.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Kalshi Ramps Up Effort to Build Markets for AI Computing Power (3 minute read) Kalshi has created a tool that plots the future price of computing power so users can develop a sense of where the price to rent GPUs is headed.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   It will use prediction markets to build the forward curve.

## business_elements

- companies: TLDR AI Newsletter, OpenAI, Anthropic, Google, Perplexity
...
- numbers: 2026, 07, 15, 4, 10, 2 m, 2B, 3 m
- quotes: There's hope in hard questions,

## evidence_seed

- company_actions: DeepSeek IPO plans 📈, Kalshi compute markets ⚡, Bonsai phone model 📱 TLDR Newsletters Advertise Blog TLDR TLDR AI 2026-07-15 DeepSeek IPO plans 📈, Kalshi compute markets ⚡, Bonsai phone model 📱 Google announces Gemma 4 optimized for the Pixel 10's TPU (2 minute read) Gemma 4 E2B for TPU is designed to run natively on the Pixel 10's TPU. / The model also lets users command core phone functions, like Wi-Fi or maps, using just private voice or text. / Video demonstrations of what the model can do are available in the article.
- case_details: 暂无公开信息
- workflow_changes: It supports instant, deep offline conversation, image identification, and on-device audio transcription.
