...
raw_id: R-091
title: "在13年前的至强CPU上以5 token/s运行Gemma 4 26B"
title_zh: ""
...
canonical_url: "https://neomindlabs.com/2026/06/08/running-gemma-4-26b-at-5-tokens-sec-on-a-13-year-old-xeon-with-no-gpu"
...
search_path_label: ""
author: ""
published_at: "2026-07-15T18:33:18.927Z"
collected_at: 2026-07-16T02:39:33.897Z
language: mixed
full_text_hash: d8466ea64a7286b2
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-16/r-091-在13年前的至强cpu上以5-token-s运行gemma-4-26b.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-16/r-091-在13年前的至强cpu上以5-token-s运行gemma-4-26b.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":11293,"paragraph_count":42,"sentence_count":106,"boilerplate_hits":0,"symbol_ratio":0.008,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
...
discovery_record: {"discovery_title":"在13年前的至强CPU上以5 token/s运行Gemma 4 26B","discovery_summary":"一台搭载双路Xeon E5-2690 v2（2013年，仅支持AVX1）的无GPU服务器，通过ik_llama.cpp补丁，以约5.2 token/s的速度运行Gemma 4 26B-A4B（Q8_0）。该补丁由Claude诊断并修复了因缺少AVX2/FMA3导致的乱码问题，已提交至ikawrakow/ik_llama.cpp#2138。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://www.neomindlabs.com/2026/06/08/running-gemma-4-26b-at-5-tokens-sec-on-a-13-year-old-xeon-with-no-gpu","discovered_at":"2026-07-16T02:30:38.323Z","rank_on_page":133,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: ac55fb5d46d9763a
content_hash: d8466ea64a7286b2
semantic_hash: 799257f8aa00af0e
duplicate_of: ""
first_seen_at: "2026-07-15T18:33:18.927Z"
last_seen_at: 2026-07-16T02:39:33.897Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Google"],"products":["Claude","agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":[],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["13","5","4","26B","2690","2","2013","1"],"quotes":["Good with AI","pays for a subscription.","A 10 year old Xeon is all you need","I have a Xeon too,","reading speed,"]}
...
fact_extraction_completed_at: 2026-07-16T02:39:33.897Z
theme: outside-core-exploration
keyword_group: outside-core-exploration
copyright_note: local research archive only
---

# 在13年前的至强CPU上以5 token/s运行Gemma 4 26B
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":11293,"paragraph_count":42,"sentence_count":106,"boilerplate_hits":0,"symbol_ratio":0.008,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   一台搭载双路Xeon E5-2690 v2（2013年，仅支持AVX1）的无GPU服务器，通过ik_llama.cpp补丁，以约5.2 token/s的速度运行Gemma 4 26B-A4B（Q8_0）。该补丁由Claude诊断并修复了因缺少AVX2/FMA3导致的乱码问题，已提交至ikawrakow/ik_llama.cpp#2138。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   There’s a server in my basement that has no business running a modern language model.

3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   It’s a repurposed HP StoreVirtual storage box, roughly thirteen years old, two Ivy Bridge Xeons, no GPU.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   It was built to hold disks, not do math.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   As of this week it runs Google’s Gemma 4 , a 26-billion-parameter open-weights mixture-of-experts model, at about five tokens per second.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Hardware Repurposed HP StoreVirtual: dual Xeon E5-2690 v2 (Ivy Bridge, 2013), DDR3, no GPU Instruction sets AVX1 only — no AVX2, no FMA3 Model Gemma 4 26B-A4B (MoE), Q8_0 Decode ~5.
...
- numbers: 13, 5, 4, 26B, 2690, 2, 2013, 1
- quotes: Good with AI / pays for a subscription. / A 10 year old Xeon is all you need / I have a Xeon too, / reading speed,

## evidence_seed

- company_actions: 一台搭载双路Xeon E5-2690 v2（2013年，仅支持AVX1）的无GPU服务器，通过ik_llama.cpp补丁，以约5.2 token/s的速度运行Gemma 4 26B-A4B（Q8_0）。该补丁由Claude诊断并修复了因缺少AVX2/FMA3导致的乱码问题，已提交至ikawrakow/ik_llama.cpp#2138。 / There’s a server in my basement that has no business running a modern language model. / It’s a repurposed HP StoreVirtual storage box, roughly thirteen years old, two Ivy Bridge Xeons, no GPU.
- case_details: 暂无公开信息
