...
raw_id: R-090
title: "HVE Core - All - Visual Studio Marketplace"
original_url: "https://marketplace.visualstudio.com/items?itemName=ise-hve-essentials.hve-core-all"
canonical_url: "https://marketplace.visualstudio.com/items?itemName=ise-hve-essentials.hve-core-all"
...
author: ""
published_at: ""
collected_at: 2026-06-29T05:24:29.077Z
language: mixed
full_text_hash: f81eedb17f113089
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-090-hve-core-all-visual-studio-marketplace.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-090-hve-core-all-visual-studio-marketplace.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":35431,"paragraph_count":407,"sentence_count":45,"boilerplate_hits":1,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 35431
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"f81eedb17f113089","missing":[]}
...
url_hash: b889351c08619e21
content_hash: f8d0e84ae8f82796
semantic_hash: 9af93559aa3a1a74
duplicate_of: ""
first_seen_at: "2026-06-29T05:24:29.077Z"
last_seen_at: 2026-06-29T05:24:29.077Z
...
business_elements: {"companies":["keyword search","Anysearch","Microsoft","GitHub"],"products":["agents","Copilot","Agents","agent","mcp","copilot","MCP"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":[],"affected_departments":["IT / 安全"],"numbers":["9","95","6","1.0","7","1","3","4"],"quotes":[]}
evidence_seed: {"company_actions":["Use this edition when you want access to everything without choosing a focused collection."],"case_details":["HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot. / query=Applied AI architect enterprise customer workflow / intent=find_customer_case / path=developer_ecosystem","HVE Core - All Full bundle of all stable HVE Core agents, prompts, instructions, and skills HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot."],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。","可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":["This edition includes every artifact across all domains: development workflows, architecture, Azure DevOps, GitHub and Jira backlog workflows, data science, design thinking, security, and more.","CAUTION] This collection includes security, responsible AI, and supply chain security agents and prompts that are assistive tools only .","They do not replace professional security tooling (SAST, DAST, SCA, penetration testing, compliance scanners) or qualified human review."]}
missing_information: []
key_excerpts: [{"type":"case_detail","text":"HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot. / query=Applied AI architect enterprise customer workflow / intent=find_customer_case / path=developer_ecosystem","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"case_detail","text":"HVE Core - All Full bundle of all stable HVE Core agents, prompts, instructions, and skills HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot.","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"supporting_context","text":"This edition includes every artifact across all domains: development workflows, architecture, Azure DevOps, GitHub and Jira backlog workflows, data science, design thinking, security, and more.","supports":["daily_observation","heatmap"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"Use this edition when you want access to everything without choosing a focused collection.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"supporting_context","text":"CAUTION] This collection includes security, responsible AI, and supply chain security agents and prompts that are assistive tools only .","supports":["daily_observation","heatmap"],"importance":"medium","confidence":"high"},{"type":"supporting_context","text":"They do not replace professional security tooling (SAST, DAST, SCA, penetration testing, compliance scanners) or qualified human review.","supports":["daily_observation","heatmap"],"importance":"medium","confidence":"high"}]
theme: mature-commercial-signal
keyword_group: mature-commercial-signal
copyright_note: local research archive only
---

# HVE Core - All - Visual Studio Marketplace
...
ISA-95-aligned network planning assistant for secure edge Kubernetes to Azure connectivity, remediation roadmaps, and beginner-friendly guidance
phase-implementor
...
dt-canonical-deck
Unified canonical deck workflow for opt-in offer, snapshot generation/refresh, and optional customer-card PowerPoint build
dt-figma-export
Export Design Thinking artifacts to a collaborative FigJam board or Figma Design file using the official Figma MCP server
...
synth-data-generate
Generate comprehensive synthetic data for any specified subject with realistic patterns and relationships
task-implement
...
design-thinking/dt-canonical-deck
Opt-in canonical deck and customer-card workflow for DT coaching
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot. / query=Applied AI architect enterprise customer workflow / intent=find_customer_case / path=developer_ecosystem

2. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   HVE Core - All Full bundle of all stable HVE Core agents, prompts, instructions, and skills HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot.

3. **supporting_context**｜supports=daily_observation, heatmap｜importance=medium｜confidence=high
   This edition includes every artifact across all domains: development workflows, architecture, Azure DevOps, GitHub and Jira backlog workflows, data science, design thinking, security, and more.
...
5. **supporting_context**｜supports=daily_observation, heatmap｜importance=medium｜confidence=high
   CAUTION] This collection includes security, responsible AI, and supply chain security agents and prompts that are assistive tools only .
...
- products: agents, Copilot, Agents, agent, mcp, copilot, MCP
- people: 暂无公开信息
...
- numbers: 9, 95, 6, 1.0, 7, 1, 3, 4
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Use this edition when you want access to everything without choosing a focused collection.
- case_details: HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot. / query=Applied AI architect enterprise customer workflow / intent=find_customer_case / path=developer_ecosystem / HVE Core - All Full bundle of all stable HVE Core agents, prompts, instructions, and skills HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with GitHub Copilot.
...
- risks_or_constraints: This edition includes every artifact across all domains: development workflows, architecture, Azure DevOps, GitHub and Jira backlog workflows, data science, design thinking, security, and more. / CAUTION] This collection includes security, responsible AI, and supply chain security agents and prompts that are assistive tools only . / They do not replace professional security tooling (SAST, DAST, SCA, penetration testing, compliance scanners) or qualified human review.
