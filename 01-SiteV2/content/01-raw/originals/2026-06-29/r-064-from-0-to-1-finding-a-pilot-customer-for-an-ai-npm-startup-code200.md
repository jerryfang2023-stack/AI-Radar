...
raw_id: R-064
title: "From 0 to 1: Finding a Pilot Customer for an AI NPM Startup - Code200"
original_url: "https://www.code200.io/case-study/first-enterprise-customer-for-ai-startup/"
canonical_url: "https://code200.io/case-study/first-enterprise-customer-for-ai-startup"
...
search_path_label: ""
author: ""
published_at: "2020-08-25T07:19:57.000Z"
collected_at: 2026-06-29T05:41:18.143Z
language: mixed
full_text_hash: 764b292482491251
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-064-from-0-to-1-finding-a-pilot-customer-for-an-ai-npm-startup-code200.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-064-from-0-to-1-finding-a-pilot-customer-for-an-ai-npm-startup-code200.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":15588,"paragraph_count":120,"sentence_count":125,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
...
url_hash: fe40661df98941be
content_hash: 764b292482491251
semantic_hash: 7e365d9ab162b7c0
duplicate_of: ""
first_seen_at: "2020-08-25T07:19:57.000Z"
last_seen_at: 2026-06-29T05:41:18.143Z
...
business_elements: {"companies":["keyword search","Exa","Google","Amazon"],"products":[],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究"],"business_actions":["发布 / 推出","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["0","1","200","5","10","100","25.08","2020"],"quotes":["speak the same language"]}
...
CHALLENGES
The market is saturated with solutions. The main players in the niche have established a reputation and gained trust from numerous customers. SolarWinds MSP has been on the market since 1999 ( source ), Zabbix since 2005 ( source ), and Auvik since 2011 ( source ), to name but three.
There’s also fierce competition between AI tools in the market, tools such as Kentik and Anodot – with total funding of $61.7 million ( source ) and $64.6 million ( source ) respectively.
The target audience has already found an adequate solution and they aren’t aware that there is a superior way to fix the problem; this means they aren’t spending time making direct search requests on Google.
...
Almost everyone we talked to asked about a website.
We were losing the trust of the potential customers. A change in tone was apparent when they discovered we didn’t have a website to direct them to.
Some activities we planned required a landing page with a registration form.
...
First, we needed to verify that the personas we created were correct. Instead of showing hypothetical portraits, we offered the client to look at the profiles of real people.
This list could be used for future outreach campaigns.
It helped us to build the audience for ad targeting.
...
We discovered that the decision process in enterprise contexts was significantly longer and more complicated than we had expected.
NetSequency would likely benefit from being positioned as an auxiliary tool rather than a replacement.
The majority of respondents treated the AI component of the product with skepticism.
...
Yes
Need a hand finding your first customers?
Let's Talk
...
1. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   In this case study, we share how we helped a client find the first enterprise customer to do beta testing of a new machine learning (ML)-based network performance monitoring (NPM) tool. ... Why only one client and not 5, 10, or 100? Implementation and tuning of the tool over such a large network wou

2. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   From 0 to 1: Finding a Pilot Customer for an AI NPM Startup Client NetSequency Services Early-stage marketing Date 25.

3. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   2020 In this case study, we share how we helped a client find the first enterprise customer to do beta testing of a new machine learning (ML)-based network performance monitoring (NPM) tool.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Why only one client and not 5, 10, or 100?

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Implementation and tuning of the tool over such a large network would require far greater resources that were available to our small bootstrapped team, who were doing it for the first time.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   We wanted to get it right; otherwise, what’s the point?

## business_elements

- companies: keyword search, Exa, Google, Amazon
- products: 暂无公开信息
- people: 暂无公开信息
...
- numbers: 0, 1, 200, 5, 10, 100, 25.08, 2020
- quotes: speak the same language

## evidence_seed

- company_actions: Why only one client and not 5, 10, or 100? / Implementation and tuning of the tool over such a large network would require far greater resources that were available to our small bootstrapped team, who were doing it for the first time. / We wanted to get it right; otherwise, what’s the point?
- case_details: In this case study, we share how we helped a client find the first enterprise customer to do beta testing of a new machine learning (ML)-based network performance monitoring (NPM) tool. ... Why only one client and not 5, 10, or 100? Implementation and tuning of the tool over such a large network wou / From 0 to 1: Finding a Pilot Customer for an AI NPM Startup Client NetSequency Services Early-stage marketing Date 25. / 2020 In this case study, we share how we helped a client find the first enterprise customer to do beta testing of a new machine learning (ML)-based network performance monitoring (NPM) tool.
