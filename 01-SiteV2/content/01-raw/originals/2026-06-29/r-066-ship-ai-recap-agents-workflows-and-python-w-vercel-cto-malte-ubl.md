...
raw_id: R-066
title: "⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl"
original_url: "https://www.latent.space/p/ship-ai-recap-agents-workflows-and"
canonical_url: "https://latent.space/p/ship-ai-recap-agents-workflows-and"
...
author: ""
published_at: ""
collected_at: 2026-06-29T05:41:18.156Z
language: mixed
full_text_hash: c18a8bb0f3458fe6
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-066-ship-ai-recap-agents-workflows-and-python-w-vercel-cto-malte-ubl.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-066-ship-ai-recap-agents-workflows-and-python-w-vercel-cto-malte-ubl.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7839,"paragraph_count":51,"sentence_count":42,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 7839
fetch_error: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"c18a8bb0f3458fe6","missing":[]}
...
url_hash: 1ab45cb91c4c19a2
content_hash: c18a8bb0f3458fe6
semantic_hash: 79e06985b0cd77c1
duplicate_of: ""
first_seen_at: "2026-06-29T05:41:18.156Z"
last_seen_at: 2026-06-29T05:41:18.156Z
...
business_elements: {"companies":["Latent Space","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Apple","Mistral"],"products":["Agents","agent","agents","Agent","Gemini"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["0","1","00","42","01","31","2025","6.0"],"quotes":["dogfooding","dogfooding","sweet spot","cannot be trusted.","define once, deploy everywhere"]}
evidence_seed: {"company_actions":[],"case_details":[],"workflow_changes":["Latent Space: The AI Engineer Podcast ⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl 1× 0:00 Current time: 0:00 / Total time: -42:01 -42:01 Audio playback is not supported on your browser.","⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl Oct 31, 2025 Share Transcript In this conversation with Malte Ubl , CTO of Vercel ( http://x.","com/cramforce ), we explore how the company is pioneering the infrastructure for AI-powered development through their comprehensive suite of tools including workflows, AI SDK, and the newly announced agent ecosystem."],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"quote","text":"In this conversation with Malte Ubl, CTO of Vercel (http://x.com/cramforce), we explore how the company is pioneering the infrastructure for AI-powered development through their comprehensive suite of tools including workflows, AI SDK, and the newly announced agent ecosystem. Malte shares insights into Vercel’s philosophy of “dogfooding” - never shipping abstractions they haven’t battle-tested themselves - which led to extracting their AI SDK from v0 and building production agents that handle ev","supports":["signal_card_candidate","relationship_graph_input","viewpoint"],"importance":"medium","confidence":"high"},{"type":"workflow_change","text":"Latent Space: The AI Engineer Podcast ⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl 1× 0:00 Current time: 0:00 / Total time: -42:01 -42:01 Audio playback is not supported on your browser.","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"workflow_change","text":"⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl Oct 31, 2025 Share Transcript In this conversation with Malte Ubl , CTO of Vercel ( http://x.","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"workflow_change","text":"com/cramforce ), we explore how the company is pioneering the infrastructure for AI-powered development through their comprehensive suite of tools including workflows, AI SDK, and the newly announced agent ecosystem.","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"high","confidence":"high"},{"type":"quote","text":"Malte shares insights into Vercel’s philosophy of “dogfooding” - never shipping abstractions they haven’t battle-tested themselves - which led to extracting their AI SDK from v0 and building production agents that handle everything from anomaly detection to lead qualification.","supports":["signal_card_candidate","relationship_graph_input","viewpoint"],"importance":"medium","confidence":"high"},{"type":"workflow_change","text":"The discussion dives deep into Vercel’s new Workflow Development Kit, which brings durable execution patterns to serverless functions, allowing developers to write code that can pause, resume, and wait indefinitely without cost.","supports":["signal_card_candidate","relationship_graph_input","business_change","case","trend_candidate_context"],"importance":"high","confidence":"high"}]
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7839,"paragraph_count":51,"sentence_count":42,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   In this conversation with Malte Ubl, CTO of Vercel (http://x.com/cramforce), we explore how the company is pioneering the infrastructure for AI-powered development through their comprehensive suite of tools including workflows, AI SDK, and the newly announced agent ecosystem. Malte shares insights into Vercel’s philosophy of “dogfooding” - never shipping abstractions they haven’t battle-tested themselves - which led to extracting their AI SDK from v0 and building production agents that handle ev
...
2. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Latent Space: The AI Engineer Podcast ⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl 1× 0:00 Current time: 0:00 / Total time: -42:01 -42:01 Audio playback is not supported on your browser.
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   ⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl Oct 31, 2025 Share Transcript In this conversation with Malte Ubl , CTO of Vercel ( http://x.
...
4. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   com/cramforce ), we explore how the company is pioneering the infrastructure for AI-powered development through their comprehensive suite of tools including workflows, AI SDK, and the newly announced agent ecosystem.

5. **quote**｜supports=signal_card_candidate, relationship_graph_input, viewpoint｜importance=medium｜confidence=high
   Malte shares insights into Vercel’s philosophy of “dogfooding” - never shipping abstractions they haven’t battle-tested themselves - which led to extracting their AI SDK from v0 and building production agents that handle everything from anomaly detection to lead qualification.
...
6. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The discussion dives deep into Vercel’s new Workflow Development Kit, which brings durable execution patterns to serverless functions, allowing developers to write code that can pause, resume, and wait indefinitely without cost.

## business_elements

- companies: Latent Space, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Apple, Mistral
- products: Agents, agent, agents, Agent, Gemini
- people: 暂无公开信息
...
- numbers: 0, 1, 00, 42, 01, 31, 2025, 6.0
- quotes: dogfooding / dogfooding / sweet spot / cannot be trusted. / define once, deploy everywhere

## evidence_seed

- company_actions: 暂无公开信息
- case_details: 暂无公开信息
- workflow_changes: Latent Space: The AI Engineer Podcast ⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl 1× 0:00 Current time: 0:00 / Total time: -42:01 -42:01 Audio playback is not supported on your browser. / ⚡️ Ship AI recap: Agents, Workflows, and Python — w/ Vercel CTO Malte Ubl Oct 31, 2025 Share Transcript In this conversation with Malte Ubl , CTO of Vercel ( http://x. / com/cramforce ), we explore how the company is pioneering the infrastructure for AI-powered development through their comprehensive suite of tools including workflows, AI SDK, and the newly announced agent ecosystem.
