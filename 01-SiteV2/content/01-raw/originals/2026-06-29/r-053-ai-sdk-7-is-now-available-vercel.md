...
original_url: "https://vercel.com/changelog/ai-sdk-7"
canonical_url: "https://vercel.com/changelog/ai-sdk-7"
...
author: ""
published_at: ""
collected_at: 2026-06-29T05:41:18.070Z
language: mixed
full_text_hash: f8c9b1754c80a2f5
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-053-ai-sdk-7-is-now-available-vercel.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-053-ai-sdk-7-is-now-available-vercel.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":22667,"paragraph_count":276,"sentence_count":137,"boilerplate_hits":2,"symbol_ratio":0.0154,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 22667
fetch_error: ""
...
url_hash: 94dec3bcce1aa225
content_hash: d4ed6ff4c043e605
semantic_hash: 84d0767101cdcc99
duplicate_of: ""
first_seen_at: "2026-06-29T05:41:18.070Z"
last_seen_at: 2026-06-29T05:41:18.070Z
...
business_elements: {"companies":["keyword search","Exa","OpenAI","Anthropic","Google"],"products":["agents","agent","Claude","Codex","Agents","MCP","gpt-5","claude","mcp","Agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["7","25","2026","22","7 m","22 m","6","5.5"],"quotes":[]}
...
Link to heading Before You Upgrade
...
Link to heading Run Agents in Production
...
Link to heading Build Beyond Text
...
Link to heading UI, Streams, and Message Handling
...
Link to heading Configure Runtime and Packaging
...
Link to heading Coming Out of Experimental
...
Link to heading Deprecated APIs
...
Link to heading Other Migration Themes
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":22667,"paragraph_count":276,"sentence_count":137,"boilerplate_hits":2,"symbol_ratio":0.0154,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   # AI SDK 7 is now available ... Published: June 25, 2026 | Authors: Gregor Martynus, Lars Grammel, Felix Arntz, Aayush Kapoor, Josh Singh ... AI SDK 7 is a major release for building production agents in TypeScript. The SDK has grown from model calls and chat primitives into a broader agent platform for developing, running, integrating, and observing agents across text, audio, realtime, image, and video. Every major provider is supported out of the box. ... - Upgrade with clearer APIs through the new migration skil
...
3. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=medium｜confidence=high
   The SDK has grown from model calls and chat primitives into a broader agent platform for developing, running, integrating, and observing agents across text, audio, realtime, image, and video.
...
4. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Every major provider is supported out of the box.
...
5. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Link to heading At a Glance Develop agents with reasoning control, tool and runtime context, provider files and skills support, MCP Apps, and a terminal UI.
...
- companies: keyword search, Exa, OpenAI, Anthropic, Google
- products: agents, agent, Claude, Codex, Agents, MCP, gpt-5, claude, mcp, Agent
- people: 暂无公开信息
...
- numbers: 7, 25, 2026, 22, 7 m, 22 m, 6, 5.5
- quotes: 暂无公开信息

## evidence_seed

- company_actions: AI SDK 7 is a major release for building production agents in TypeScript. / The SDK has grown from model calls and chat primitives into a broader agent platform for developing, running, integrating, and observing agents across text, audio, realtime, image, and video.
- case_details: 暂无公开信息
- workflow_changes: # AI SDK 7 is now available ... Published: June 25, 2026 | Authors: Gregor Martynus, Lars Grammel, Felix Arntz, Aayush Kapoor, Josh Singh ... AI SDK 7 is a major release for building production agents in TypeScript. The SDK has grown from model calls and chat primitives into a broader agent platform for developing, running, integrating, and observing agents across text, audio, realtime, image, and video. Every major provider is supported out of the box. ... - Upgrade with clearer APIs through the new migration skil / Every major provider is supported out of the box. / Link to heading At a Glance Develop agents with reasoning control, tool and runtime context, provider files and skills support, MCP Apps, and a terminal UI.
...
# AI SDK 7 is now available ... Published: June 25, 2026 | Authors: Gregor Martynus, Lars Grammel, Felix Arntz, Aayush Kapoor, Josh Singh ... AI SDK 7 is a major release for building production agents in TypeScript. The SDK has grown from model calls and chat primitives into a broader agent platform for developing, running, integrating, and observing agents across text, audio, realtime, image, and video. Every major provider is supported out of the box. ... - Upgrade with clearer APIs through the new migration skill, codemods, and migration paths for ESM, Node.js 22, `instructions`, `telemetry`, `stream`, `finalStep`, `runtimeContext`, and `toolsContext`. ... codemods to automate ... majority of import and rename changes before reviewing semantic migration items manually ... See the full v7 migration guide. ... , app metadata, sandboxed ... rendering, and JSON ... RPC communication for tools, resources, logs, and display updates. ... AI SDK 7 introduces a harness layer for bringing established agents into the AI SDK ecosystem. Wrap harnesses such as Claude Code, Codex, Deep Agents, OpenCode, and Pi behind the same agent interface used by the rest of the SDK. ... - Dedicated OpenTelemetry package: OpenTelemetry support now lives in `@ai-sdk/otel`, with GenAI-semantic convention spans and metrics, supplemental AI SDK attributes, and span-enrichment hooks. To learn more, see the @ai-sdk/otel docs. ... ## Configure Runtime and Packaging ... - Node.js 22 minimum: AI SDK packages require Node.js 22 or later. - ESM imports required: AI SDK 7 requires ESM imports (`import` syntax or `.mjs` files). Update your `package.json` to include `"type": "module"` or migrate individual files to `.mjs`. - Migration skill available: A dedicated migration skill is available that developers can install and ask their agent to use for AI SDK v6-to-v7 upgrades. - Codemods available: The v7 codemods cover the majority of renames and cleanup migrations. ... ## Upgrade Path ... to 22+: ... minimum requirement before upgrading packages. ... -sdk/*` packages ... , and API moves. Review the diff before committing. ... cannot fully decide runtime requirements, ... instruction/message behavior, runtime/tool context separation ... approval policy placement ... stream helper usage, ... step result shapes. ... 📚 More updates: View all changelog entries | Blog / query=AI coding agent API SDK release enterprise product update 2026 / intent=find_original_source / path=official_original
