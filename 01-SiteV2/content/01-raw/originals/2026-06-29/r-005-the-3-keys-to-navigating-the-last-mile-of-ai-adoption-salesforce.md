...
raw_id: R-005
title: "The 3 Keys to Navigating the ‘Last Mile’ of AI Adoption - Salesforce"
original_url: "https://www.salesforce.com/news/stories/mature-agentic-enterprise-deployment/"
canonical_url: "https://salesforce.com/news/stories/mature-agentic-enterprise-deployment"
...
author: ""
published_at: "2026-01-22T18:00:00.000Z"
collected_at: 2026-06-29T05:41:17.733Z
language: mixed
full_text_hash: 4ee47fab13dba8a2
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-005-the-3-keys-to-navigating-the-last-mile-of-ai-adoption-salesforce.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-005-the-3-keys-to-navigating-the-last-mile-of-ai-adoption-salesforce.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":10893,"paragraph_count":44,"sentence_count":104,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 10893
fetch_error: ""
...
url_hash: b46e03ac3127a70b
content_hash: 4ee47fab13dba8a2
semantic_hash: dbab7b90ca042f87
duplicate_of: "merged 2 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-01-22T18:00:00.000Z"
last_seen_at: 2026-06-29T05:41:17.733Z
...
business_elements: {"companies":["keyword search","Exa","Salesforce","Deloitte"],"products":["agent","agents","Agent","Agents"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["3","12 m","1","2","$540 million","18","500","60%"],"quotes":["last mile.","prompt doom loop"," toggle tax .","Okay, I built this agent that is executing a process, but I want to do that for 10,000 employees.","I’ve got an agent that’s creating value for a customer who’s engaging on my website; now I want to do that for 10,000 customers proactively."]}
...
0%
Participants:
Adam Evans: EVP & GM, Salesforce AI Platform
Madhav Thattai: COO, Salesforce AI
Mark Wakelin: EVP, Forward Deployed Engineering
...
Meet Slackbot, your new agentic work OS BFF
In 2025, AI grew up — and learned to play by the rules
Share article
5 min read
4 min read
...
1. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   The conversation around generative AI is no longer about whether the technology can work but how, and how quickly, enterprises can scale it securely and effectively to see true value — how they can span the proverbial last mile. But the road from pilot to production has significant challenges. Too often, the narrative is that AI is easy and seamless, which sets up customers for missed expectations. ... Madhav Thattai: This framework is a direct result of our learnings over the past 12 months. We recognized that ado
...
2. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   0% Participants: Adam Evans: EVP & GM, Salesforce AI Platform Madhav Thattai: COO, Salesforce AI Mark Wakelin: EVP, Forward Deployed Engineering The conversation around generative AI is no longer about whether the technology can work but how, and how quickly, enterprises can scale it securely and effectively to see true value — how they can span the proverbial last mile.

3. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   But the road from pilot to production has significant challenges.

4. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Too often, the narrative is that AI is easy and seamless, which sets up customers for missed expectations.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Q: You’re building the roadmap, helping deploy the agents, and working through the realities of the transformation into being an Agentic Enterprise .

## business_elements

- companies: keyword search, Exa, Salesforce, Deloitte
...
- numbers: 3, 12 m, 1, 2, $540 million, 18, 500, 60%
- quotes: last mile. / prompt doom loop /  toggle tax . / Okay, I built this agent that is executing a process, but I want to do that for 10,000 employees. / I’ve got an agent that’s creating value for a customer who’s engaging on my website; now I want to do that for 10,000 customers proactively.

## evidence_seed

- company_actions: Q: You’re building the roadmap, helping deploy the agents, and working through the realities of the transformation into being an Agentic Enterprise .
- case_details: The conversation around generative AI is no longer about whether the technology can work but how, and how quickly, enterprises can scale it securely and effectively to see true value — how they can span the proverbial last mile. But the road from pilot to production has significant challenges. Too often, the narrative is that AI is easy and seamless, which sets up customers for missed expectations. ... Madhav Thattai: This framework is a direct result of our learnings over the past 12 months. We recognized that ado / But the road from pilot to production has significant challenges. / Too often, the narrative is that AI is easy and seamless, which sets up customers for missed expectations.
- workflow_changes: This conversation with three Salesforce executives helps surface the fuller, more authentic picture.
...
The conversation around generative AI is no longer about whether the technology can work but how, and how quickly, enterprises can scale it securely and effectively to see true value — how they can span the proverbial last mile. But the road from pilot to production has significant challenges. Too often, the narrative is that AI is easy and seamless, which sets up customers for missed expectations. ... Madhav Thattai: This framework is a direct result of our learnings over the past 12 months. We recognized that adoption happens in structured stages. Stage 1: Trust is all about getting the foundation right, ensuring executive buy-in and security. Stage 2: Design is where you actually build the agent, focusing on context and control. Stage 3: Scale is where you move from a successful pilot to full-enterprise implementation. We use this to help our customers navigate the journey, and we use it to inform our product roadmap based on what they are learning. ... customers want multi- ... have enough successful singular agents yet ... Evans: The technical reality of agent-to-agent (A2A) is that the performance is not there yet. The way everyone is doing A2A now is they’re “chatty,” and as soon as you have two or three agents talking, the performance for a live user situation — like a voice interaction — is going to be unacceptable. You need subsecond responses. The solution isn’t to connect up a thousand agents and hope for the best; it’s to focus on context engineering and separating the functionality to be testable. We are investing in roadmap features that allow multiple agents to share memory and execute in a shared memory execution space that’s faster for high-performance situations. ... Customers that have successfully moved past pilots are focused on killer use cases that are driving ROI, rather than having a thousand agents that don’t create value. ... We are seeing the shift happen now. We have approximately $540 million in agentic AI ARR and 18,500 deals in under a year. Customers like Grupo Falabella are seeing Agentforce now resolve 60% of inquiries without human help. Just three weeks after launching their pilot agent in Colombia, they were already seeing support levels on WhatsApp of 70% — a sign that more customers were getting their questions answered without needing to call. ... Wakelin: The challenges might be the pace and scale at which this is happening. But the conversations our forward deployed engineers have had with customers have generated more than 100 product recommendations that are really shaping and driving the roadmap. / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=developer_ecosystem
