...
canonical_url: "https://developers.openai.com/api/docs/changelog"
...
author: ""
published_at: ""
collected_at: 2026-06-29T05:41:18.059Z
language: mixed
full_text_hash: 9fcdbc6dce54a277
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-052-changelog-openai-api.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-29/r-052-changelog-openai-api.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":32334,"paragraph_count":249,"sentence_count":286,"boilerplate_hits":1,"symbol_ratio":0.0013,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 32334
fetch_error: ""
...
url_hash: 49e8d0577a5e1f9d
content_hash: 5f8318fb7b8ea7ac
semantic_hash: c6c1713ae2665cf4
duplicate_of: ""
first_seen_at: "2026-06-29T05:41:18.059Z"
last_seen_at: 2026-06-29T05:41:18.059Z
...
business_elements: {"companies":["keyword search","Exa","OpenAI","Amazon","AWS"],"products":["MCP","ChatGPT","Codex","agents","Agents","GPT-5","gpt-5","codex","agent","Agent"],"people":[],"industries":["医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2026","2","5","5.5","5.2","5.1","4","24"],"quotes":[]}
...
1. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   # Changelog ... ### June, 2026 ... Starting June 2, ... minute with a 5-minute minimum, instead of being ... -minute rate will remain the same. ... You can find current built-in tool pricing in our API pricing docs. ... Released Secure MCP Tunnel for enterprise customers. Secure MCP Tunnel lets supported OpenAI products including ChatGPT web, Codex, Responses API, and AgentKit connect to private or on-prem MCP servers through a customer-hosted`tunnel-client` without exposing those servers to the public internet. ..
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Changelog Upcoming deprecations can be found on the deprecations page .
...
3. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=medium｜confidence=high
   June, 2026 Jun 24 Update chat-latest Updated the chat-latest snapshot, which points to the latest Instant model currently used in ChatGPT.

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   We recommend leveraging GPT-5.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   5 for production API usage, but feel free to use this model to test the latest improvements for chat use cases.
...
- companies: keyword search, Exa, OpenAI, Amazon, AWS
- products: MCP, ChatGPT, Codex, agents, Agents, GPT-5, gpt-5, codex, agent, Agent
- people: 暂无公开信息
...
- numbers: 2026, 2, 5, 5.5, 5.2, 5.1, 4, 24
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Changelog Upcoming deprecations can be found on the deprecations page . / June, 2026 Jun 24 Update chat-latest Updated the chat-latest snapshot, which points to the latest Instant model currently used in ChatGPT. / We recommend leveraging GPT-5.
- case_details: # Changelog ... ### June, 2026 ... Starting June 2, ... minute with a 5-minute minimum, instead of being ... -minute rate will remain the same. ... You can find current built-in tool pricing in our API pricing docs. ... Released Secure MCP Tunnel for enterprise customers. Secure MCP Tunnel lets supported OpenAI products including ChatGPT web, Codex, Responses API, and AgentKit connect to private or on-prem MCP servers through a customer-hosted`tunnel-client` without exposing those servers to the public internet. ..
...
# Changelog ... ### June, 2026 ... Starting June 2, ... minute with a 5-minute minimum, instead of being ... -minute rate will remain the same. ... You can find current built-in tool pricing in our API pricing docs. ... Released Secure MCP Tunnel for enterprise customers. Secure MCP Tunnel lets supported OpenAI products including ChatGPT web, Codex, Responses API, and AgentKit connect to private or on-prem MCP servers through a customer-hosted`tunnel-client` without exposing those servers to the public internet. ... Released the OpenAI Developers plugin for Codex. This helps you build AI applications and agents in Codex with OpenAI Platform access and OpenAI API setup guidance. ... The updated Agents SDK is now available in TypeScript, with support for sandbox agents and an open-source harness built in. Learn more here. ... Admin APIs are now supported in the OpenAI SDKs for Node, Python, Go, Ruby, and Java. See the Admin APIs guide for setup instructions and examples. ... Released GPT-5.5, a new frontier model for complex professional work, to the Chat Completions and Responses API, and released GPT-5.5 Pro for Responses API requests for tougher problems that benefit from more compute. ... Updated the Agents SDK with new capabilities, including: ... Released`gpt-5.2-codex` to the Responses API. GPT-5.2-Codex is a version of GPT-5.2 optimized for agentic coding tasks in Codex or similar environments. Read more here. ... Released`gpt-5.1-codex-max` to the Responses API. GPT-5.1-Codex is our most intelligent coding model optimized for long-horizon, agentic coding tasks. Read more here. ... Released`gpt-5.1-codex` and`gpt-5.1-codex-mini` to the Responses API. GPT-5.1-Codex is a version of GPT-5.1 optimized for agentic coding tasks in Codex or similar environments. Read more here. ... ChatKit, an embeddable chat interface for deploying agents. ... New model snapshots available for gpt-4o-audio-preview and gpt-4o-realtime-preview. Released Agents SDK for TypeScript. ... Released several new models and tools and a new API for agentic workflows: ... - Released the Responses API, a new API for creating and using agents and tools. - Released a set of built-in tools for the Responses API: web search, file search, and computer use. - Released the Agents SDK, an orchestration framework for designing, building, and deploying agents. - Announced new models:`gpt-4o-search-preview`,`gpt-4o-mini-search-preview`,`computer-use-preview`. - Announced plans to bring all Assistants API features to the easier to use Responses API, with an anticipated sunset date for Assistants in 2026 (after achieving full feature parity). / query=AI coding agent API SDK release enterprise product update 2026 / intent=find_original_source / path=official_original
