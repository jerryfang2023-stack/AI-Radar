...
original_url: "https://blogs.nvidia.com/blog/what-is-retrieval-augmented-generation/"
canonical_url: "https://blogs.nvidia.com/blog/what-is-retrieval-augmented-generation"
...
author: ""
published_at: ""
collected_at: 2026-06-15T03:58:54.250Z
language: mixed
full_text_hash: 120f663bc1ebe1da
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-15/r-053-what-is-retrieval-augmented-generation-aka-rag.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-15/r-053-what-is-retrieval-augmented-generation-aka-rag.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":11272,"paragraph_count":63,"sentence_count":83,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 11272
fetch_error: ""
...
url_hash: 56d336d9830d0bfe
content_hash: 120f663bc1ebe1da
semantic_hash: ccf648d3acab7f63
duplicate_of: ""
first_seen_at: "2026-06-15T03:58:54.250Z"
last_seen_at: 2026-06-15T03:58:54.250Z
...
business_elements: {"companies":["NVIDIA AI Blog","Google","Microsoft","Meta","AWS","Nvidia"],"products":["agents"],"people":[],"industries":["法律 / 法务","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["8217","15","2023","8230","2020","200","288","3"],"quotes":["We definitely would have put more thought into the name had we known our work would become so widespread,","We always planned to have a nicer sounding name, but when it came time to write the paper, no one had a better idea,","a general-purpose fine-tuning recipe","had this compelling vision of a trained system that had a retrieval index in the middle of it, so it could learn and generate any text output you wanted,"]}
...
The NVIDIA AI Blueprint for RAG gives developers a foundational starting point for using NVIDIA NeMo Retriever models to build scalable, customizable data extraction and retrieval pipelines that deliver high accuracy and throughput.
The blueprint can be used as is, or combined with other NVIDIA Blueprints for advanced use cases including AI agents for enterprise research and AI assistants for customer service . For example, the AI-Q NVIDIA Blueprint enables developers to connect AI agents to enterprise data and use reasoning and tools to distill in-depth source materials with efficiency and precision.
In addition, developers and IT teams can use an NVIDIA Launchable to experiment with deploying a RAG pipeline. A significant part of this RAG pipeline is NVIDIA NeMo Retriever , which provides leading, large-scale retrieval accuracy, and NVIDIA NIM microservices for simplifying secure, high-performance AI deployment across clouds, data centers and workstations. These are offered as part of the NVIDIA AI Enterprise software platform for accelerating AI development and deployment .
...
There are several environments to get started with RAG. LLMs are debuting on Windows PCs , thanks to NVIDIA software that enables all sorts of applications users can access even on their laptops.
...
This blog provides an example of RAG accelerated by TensorRT-LLM for Windows to get better results fast.
The History of RAG
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":11272,"paragraph_count":63,"sentence_count":83,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Skip to content Editor’s note: This article, originally published on Nov.

3. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   15, 2023, has been updated.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   To understand the latest advancements in generative AI , imagine a courtroom.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Judges hear and decide cases based on their general understanding of the law.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Sometimes a case — like a malpractice suit or a labor dispute — requires special expertise, so judges send court clerks to a law library, looking for precedents and specific cases they can cite.

## business_elements

- companies: NVIDIA AI Blog, Google, Microsoft, Meta, AWS, Nvidia
- products: agents
- people: 暂无公开信息
...
- numbers: 8217, 15, 2023, 8230, 2020, 200, 288, 3
- quotes: We definitely would have put more thought into the name had we known our work would become so widespread, / We always planned to have a nicer sounding name, but when it came time to write the paper, no one had a better idea, / a general-purpose fine-tuning recipe / had this compelling vision of a trained system that had a retrieval index in the middle of it, so it could learn and generate any text output you wanted,

## evidence_seed

- company_actions: Editor&#8217;s note: This article, originally published on Nov. 15, 2023, has been updated. To understand the latest advancements in generative AI, imagine a courtroom. Judges hear and decide cases based on their general understanding of the law. Sometimes a case — like a malpractice suit or a labor dispute — requires special expertise, so judges [&#8230;] / Skip to content Editor’s note: This article, originally published on Nov. / 15, 2023, has been updated.
- case_details: 暂无公开信息
