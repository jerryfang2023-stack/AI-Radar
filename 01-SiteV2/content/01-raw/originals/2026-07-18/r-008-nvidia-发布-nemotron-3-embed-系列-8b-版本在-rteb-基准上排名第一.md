...
title_zh: "NVIDIA 发布 Nemotron 3 Embed 系列，8B 版本在 RTEB 基准上排名第一"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://www.marktechpost.com/2026/07/17/nvidia-ai-releases-nemotron-3-embed-an-open-embedding-collection-whose-8b-checkpoint-ranks-1-on-rteb"
canonical_url: "https://marktechpost.com/2026/07/17/nvidia-ai-releases-nemotron-3-embed-an-open-embedding-collection-whose-8b-checkpoint-ranks-1-on-rteb"
...
collected_at: 2026-07-18T01:54:19.776Z
language: mixed
full_text_hash: e5ac1816eba5360e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-008-nvidia-发布-nemotron-3-embed-系列-8b-版本在-rteb-基准上排名第一.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-008-nvidia-发布-nemotron-3-embed-系列-8b-版本在-rteb-基准上排名第一.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":9015,"paragraph_count":85,"sentence_count":79,"boilerplate_hits":3,"symbol_ratio":0.0087,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 9015
fetch_error: ""
...
discovery_record: {"discovery_title":"NVIDIA 发布 Nemotron 3 Embed 系列，8B 版本在 RTEB 基准上排名第一","discovery_summary":"NVIDIA 发布 Nemotron 3 Embed 系列，包含三个开源 checkpoint，其中 8B-BF16 版本在 RTEB 基准上以 78.46 的平均 NDCG@10 排名第一。1B-NVFP4 版本在 Blackwell 上吞吐量比 BF16 高 2 倍，精度保留 99.5%，所有模型最大序列长度 32，768 tokens。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/17/nvidia-ai-releases-nemotron-3-embed-an-open-embedding-collection-whose-8b-checkpoint-ranks-1-on-rteb","discovered_at":"2026-07-18T01:46:31.843Z","rank_on_page":229,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: ee50606392122394
content_hash: e5ac1816eba5360e
semantic_hash: 894b057a7c3d54ee
duplicate_of: ""
first_seen_at: "2026-07-17T00:00:00.000Z"
last_seen_at: 2026-07-18T01:54:19.776Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","GitHub","Nvidia","Mistral"],"products":["agent","Agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["3","8B","16","78.46","10","1B","4","2 倍"],"quotes":["transformers>=5.2.0","sentence-transformers>=5.4.1","How can someone reduce exposure to pollen during allergy season?","People with pollen allergy can reduce exposure by staying indoors ","on dry, windy days, avoiding early-morning outdoor activity, and "]}
...
fact_extraction_completed_at: 2026-07-18T01:54:19.776Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":88,"text_length":9015,"paragraph_count":85,"sentence_count":79,"boilerplate_hits":3,"symbol_ratio":0.0087,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Technology AI Shorts Artificial Intelligence Applications Editors Pick Language Model Embedding Model Large Language Model Machine Learning New Releases Open Source Staff Tech News Embedding models decide which passages an agent ever sees.

3. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   NVIDIA released Nemotron 3 Embed model to work on that layer.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It targets production-scale RAG, agentic retrieval, code retrieval, and agent memory.
...
- companies: MarkTechPost（RSS）, OpenAI, GitHub, Nvidia, Mistral
...
- numbers: 3, 8B, 16, 78.46, 10, 1B, 4, 2 倍
- quotes: transformers>=5.2.0 / sentence-transformers>=5.4.1 / How can someone reduce exposure to pollen during allergy season? / People with pollen allergy can reduce exposure by staying indoors  / on dry, windy days, avoiding early-morning outdoor activity, and 

## evidence_seed

- company_actions: Technology AI Shorts Artificial Intelligence Applications Editors Pick Language Model Embedding Model Large Language Model Machine Learning New Releases Open Source Staff Tech News Embedding models decide which passages an agent ever sees. / NVIDIA released Nemotron 3 Embed model to work on that layer. / It targets production-scale RAG, agentic retrieval, code retrieval, and agent memory.
- case_details: 暂无公开信息
