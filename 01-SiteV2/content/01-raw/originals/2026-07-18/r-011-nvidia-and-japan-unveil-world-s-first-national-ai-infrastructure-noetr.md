...
collected_at: 2026-07-18T01:54:21.933Z
language: mixed
full_text_hash: 1c2891720b98f974
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-011-nvidia-and-japan-unveil-world-s-first-national-ai-infrastructure-noetr.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-011-nvidia-and-japan-unveil-world-s-first-national-ai-infrastructure-noetr.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":80,"text_length":3612,"paragraph_count":18,"sentence_count":19,"boilerplate_hits":4,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 3612
fetch_error: ""
...
last_seen_at: 2026-07-18T01:54:21.933Z
...
business_elements: {"companies":["keyword search","Anysearch","Google","Nvidia"],"products":[],"people":[],"industries":["法律 / 法务","金融 / 保险","制造 / 工业","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["140M","27","500","140","13","750","72","382"],"quotes":["Japan invented modern manufacturing. Now, it is building the AI factories that will power the next industrial revolution,","as the AI factory expands,","real-world native AI"]}
...
fact_extraction_completed_at: 2026-07-18T01:54:21.933Z
...
Noetra is a new consortium founded by SoftBank Corp., Sony , NEC, and Honda, with investment from 44 companies and organizations, NEC said in a press release also published today. Noetra and the national research institute AIST won a NEDO public tender on June 30 to run the FRONTia project from fiscal 2026 through fiscal 2030, with &yen;387.3 billion (roughly $2.4 billion) in first-year funding and up to &yen;1 trillion (roughly $6.1 billion) over five years, Asia Times reported. Funding beyond the first two years is subject to annual stage-gate reviews, so the full amount isn't guaranteed.
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":80,"text_length":3612,"paragraph_count":18,"sentence_count":19,"boilerplate_hits":4,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Nvidia and Japan unveil world's first national AI infrastructure — Noetra consortium to build a 140MW Rubin AI factory with 27,500 GPUs | Tom's Hardware Nvidia and Japan unveil world's first national AI infrastructure — Noetra consortium to build a 140MW Rubin AI factory with 27,500 GPUs | Tom's Ha.... / query=AI server customer deployment enterprise inference / intent=find_customer_case / path=ai_hardware_original

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   (Image credit: Nvidia) Copy link Facebook Whatsapp Reddit Pinterest Flipboard Email Share this article Join the conversation Follow us Add us as a preferred source on Google Newsletter Subscribe to our newsletter Nvidia today announced that it's working with Japan's Noetra Corp.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   to build a 140-megawatt AI factory packing 27,500 Rubin GPUs and 13,750 Vera CPUs, the compute foundation for FRONTia, the Japanese government's state-funded physical AI program.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The facility will be built from Vera Rubin NVL72 racks on Nvidia's DSX reference platform, connected with Spectrum-X Ethernet, and will train open multimodal foundation models for robotics, digital twins, and industrial automation, with pretrained weights shared broadly with domestic developers.
...
6. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Now, it is building the AI factories that will power the next industrial revolution," said Jensen Huang, founder and CEO of Nvidia, in the announcement.
...
- numbers: 140M, 27, 500, 140, 13, 750, 72, 382
- quotes: Japan invented modern manufacturing. Now, it is building the AI factories that will power the next industrial revolution, / as the AI factory expands, / real-world native AI

## evidence_seed

- company_actions: (Image credit: Nvidia) Copy link Facebook Whatsapp Reddit Pinterest Flipboard Email Share this article Join the conversation Follow us Add us as a preferred source on Google Newsletter Subscribe to our newsletter Nvidia today announced that it's working with Japan's Noetra Corp. / to build a 140-megawatt AI factory packing 27,500 Rubin GPUs and 13,750 Vera CPUs, the compute foundation for FRONTia, the Japanese government's state-funded physical AI program. / The facility will be built from Vera Rubin NVL72 racks on Nvidia's DSX reference platform, connected with Spectrum-X Ethernet, and will train open multimodal foundation models for robotics, digital twins, and industrial automation, with pretrained weights shared broadly with domestic developers.
- case_details: Nvidia and Japan unveil world's first national AI infrastructure — Noetra consortium to build a 140MW Rubin AI factory with 27,500 GPUs | Tom's Hardware Nvidia and Japan unveil world's first national AI infrastructure — Noetra consortium to build a 140MW Rubin AI factory with 27,500 GPUs | Tom's Ha.... / query=AI server customer deployment enterprise inference / intent=find_customer_case / path=ai_hardware_original
