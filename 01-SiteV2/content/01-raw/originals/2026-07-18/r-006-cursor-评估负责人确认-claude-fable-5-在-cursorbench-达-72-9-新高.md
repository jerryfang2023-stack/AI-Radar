...
collected_at: 2026-07-18T01:54:19.765Z
language: mixed
full_text_hash: c19363714bc74e4f
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-006-cursor-评估负责人确认-claude-fable-5-在-cursorbench-达-72-9-新高.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-006-cursor-评估负责人确认-claude-fable-5-在-cursorbench-达-72-9-新高.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":6919,"paragraph_count":29,"sentence_count":57,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 6919
fetch_error: ""
...
discovery_record: {"discovery_title":"Cursor 评估负责人确认 Claude Fable 5 在 CursorBench 达 72.9% 新高","discovery_summary":"Cursor 的模型评估负责人 Nate Schmidt 发现，Claude Fable 5 在其内部基准 CursorBench 上以 Max effort 模式达到 72.9%，创下新高。该模型在模糊的真实编程任务中表现出全局推理能力，例如在航天模拟器中仅凭一句提示自主规划并成功登月，而此前 Claude Opus 运行 12 小时以上仍无结果。","source_name":"Claude：Blog（网页）","origin_url":"https://claude.com/blog/working-at-the-frontier-cursor","discovered_at":"2026-07-18T01:46:31.822Z","rank_on_page":143,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 1029048a4e898aaa
content_hash: c19363714bc74e4f
semantic_hash: 1973533e1aa0746a
duplicate_of: ""
first_seen_at: "2026-07-16T16:00:00.000Z"
last_seen_at: 2026-07-18T01:54:19.765Z
...
business_elements: {"companies":["Claude","Blog（网页）","Cursor"],"products":["Cursor","Claude","agent"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["5","72.9%","12","99","0"],"quotes":["I don't feel like I have to bootstrap Claude Fable 5 to understand the world I exist in and the problem I'm trying to solve,","The model just has a sense of it out-of-the-box."," Schmidt says. ","\nClaude Fable 5 scored so well on these ambiguous tasks, the Cursor team started to feel suspicious.\n","We just kept seeing the model dig out wins that no other model was doing previously,"]}
...
fact_extraction_completed_at: 2026-07-18T01:54:19.765Z
...
Cursor runs all models through CursorBench, their internal benchmark for evaluating models on tasks that simulate real developer work. When to reach for the global optimum
...
Nate Schmidt tests new models across various evaluations, including putting it through the paces in a space-flight simulator. What's next
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":6919,"paragraph_count":29,"sentence_count":57,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Cursor is an AI coding agent for building professional software.
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It supports every major frontier model alongside Cursor's own, which makes the company an unusually neutral judge of how each one actually performs.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Nate Schmidt is the engineer who maintains that scorecard.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   He works on evals and model behavior at Cursor: studying how models succeed, how they fail, and what makes a developer quietly switch away from one mid-task.

6. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   When colleagues and customers want a read on a new release, they come to him.

## business_elements

- companies: Claude, Blog（网页）, Cursor
- products: Cursor, Claude, agent
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 5, 72.9%, 12, 99, 0
- quotes: I don't feel like I have to bootstrap Claude Fable 5 to understand the world I exist in and the problem I'm trying to solve, / The model just has a sense of it out-of-the-box. /  Schmidt says.  / 
Claude Fable 5 scored so well on these ambiguous tasks, the Cursor team started to feel suspicious.
 / We just kept seeing the model dig out wins that no other model was doing previously,

## evidence_seed

- company_actions: Cursor is an AI coding agent for building professional software. / Nate Schmidt is the engineer who maintains that scorecard. / He works on evals and model behavior at Cursor: studying how models succeed, how they fail, and what makes a developer quietly switch away from one mid-task.
- case_details: When colleagues and customers want a read on a new release, they come to him.
- workflow_changes: It supports every major frontier model alongside Cursor's own, which makes the company an unusually neutral judge of how each one actually performs.
