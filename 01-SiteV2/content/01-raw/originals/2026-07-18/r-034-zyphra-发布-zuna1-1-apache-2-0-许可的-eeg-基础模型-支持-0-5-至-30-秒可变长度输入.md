...
search_path_label: ""
author: ""
published_at: "2026-07-17T21:35:27.000Z"
collected_at: 2026-07-18T01:54:43.331Z
language: mixed
full_text_hash: ee2eb8255cda096a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-034-zyphra-发布-zuna1-1-apache-2-0-许可的-eeg-基础模型-支持-0-5-至-30-秒可变长度输入.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-18/r-034-zyphra-发布-zuna1-1-apache-2-0-许可的-eeg-基础模型-支持-0-5-至-30-秒可变长度输入.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":8832,"paragraph_count":64,"sentence_count":92,"boilerplate_hits":2,"symbol_ratio":0.0058,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8832
fetch_error: ""
...
discovery_record: {"discovery_title":"Zyphra 发布 ZUNA1.1：Apache 2.0 许可的 EEG 基础模型，支持 0.5 至 30 秒可变长度输入","discovery_summary":"Zyphra 发布 ZUNA1.1，一个 3.8 亿参数的掩码扩散自编码器，用于头皮 EEG 信号。相比固定 5 秒输入的 ZUNA1，新模型支持 0.5 至 30 秒可变长度输入，并采用 4D 旋转位置编码实现任意通道布局的降噪、重建与上采样。训练数据从约 200 万通道小时扩展至约 350 万通道小时，在重建 NMSE 上持平或优于前代，并在区域电极删除测试中超越经典球面样条插值。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/17/zyphra-releases-zuna1-1-an-apache-2-0-eeg-foundation-model-with-variable-length-inputs-from-0-5-to-30-seconds","discovered_at":"2026-07-18T01:46:31.803Z","rank_on_page":67,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 9894bf929d2d2797
content_hash: ee2eb8255cda096a
semantic_hash: 53d36663da8a47fc
duplicate_of: ""
first_seen_at: "2026-07-17T21:35:27.000Z"
last_seen_at: 2026-07-18T01:54:43.331Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","GitHub","Nvidia"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["1.1","2.0","0.5","30","3.8 亿","5","1","4"],"quotes":[",\noutput_dir=",",\nfigures_dir=",",\ngpu_device=0, # GPU id, or "," for CPU\nsegment_sec=5.0, # window length; default is 5.0, not the full 30 s\nmontage=",", # fallback, used only if the file has no positions\nrepair_channels=["]}
...
fact_extraction_completed_at: 2026-07-18T01:54:43.331Z
...
Check out the Model weight , GitHub Repo and Technical details . Also, feel free to follow us on Twitter and don’t forget to join our 150k+ML SubReddit and Subscribe to our Newsletter . Wait! are you on telegram? now you can join us on telegram as well.
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":8832,"paragraph_count":64,"sentence_count":92,"boilerplate_hits":2,"symbol_ratio":0.0058,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Technology AI Shorts Artificial Intelligence Applications Editors Pick Language Model Large Language Model Machine Learning New Releases Open Source Staff Tech News This week, Zyphra released ZUNA1.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It builds on ZUNA1, the Zyphra’s earlier open EEG foundation model.
...
- numbers: 1.1, 2.0, 0.5, 30, 3.8 亿, 5, 1, 4
- quotes: ,
output_dir= / ,
figures_dir= / ,
gpu_device=0, # GPU id, or  /  for CPU
...
- company_actions: Technology AI Shorts Artificial Intelligence Applications Editors Pick Language Model Large Language Model Machine Learning New Releases Open Source Staff Tech News This week, Zyphra released ZUNA1. / 1 under the Apache 2. / The EEG foundation model reconstructs, denoises, and upsamples data across arbitrary channel layouts.
- case_details: 暂无公开信息
