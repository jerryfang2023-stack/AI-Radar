...
raw_id: R-037
title: "AI Agents: What They Are and Their Business Impact | BCG"
original_url: "https://www.bcg.com/capabilities/artificial-intelligence/ai-agents"
canonical_url: "https://bcg.com/capabilities/artificial-intelligence/ai-agents"
...
author: ""
published_at: ""
collected_at: 2026-06-04T00:38:28.030Z
language: mixed
full_text_hash: 4727aea52017e7b8
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-037-ai-agents-what-they-are-and-their-business-impact-bcg.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-037-ai-agents-what-they-are-and-their-business-impact-bcg.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":72,"text_length":15567,"paragraph_count":123,"sentence_count":106,"boilerplate_hits":11,"symbol_ratio":0,"method":"main"}
has_full_text: true
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"4727aea52017e7b8","missing":[]}
...
url_hash: 2f9f25642b583b3a
content_hash: 4727aea52017e7b8
semantic_hash: f32c1e1d762a7e04
duplicate_of: ""
first_seen_at: "2026-06-04T00:38:28.030Z"
last_seen_at: 2026-06-04T00:38:28.030Z
...
business_elements: {"companies":["keyword search","Anysearch"],"products":["Agents","agents","Agent","agent","copilot"],"people":[],"industries":["金融 / 保险","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2","95%","50x","10x","25%","35%","40%","45%"],"quotes":[]}
evidence_seed: {"company_actions":["AI agents are artificial intelligence that use tools to accomplish goals. AI agents have the ability to remember across tasks and changing states. / query=AI Agent funding enterprise customers / intent=find_startups / path=official_original","Subscribe Tech + Us: Harness the power of technology and AI Tech + Us: Harness the power of technology and AI You are subscribed to BCG's Tech + Us newsletter.","Manage Subscriptions What Are AI Agents?"],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"funding","text":"AI agents are artificial intelligence that use tools to accomplish goals. AI agents have the ability to remember across tasks and changing states. / query=AI Agent funding enterprise customers / intent=find_startups / path=official_original","supports":["daily_observation","heatmap","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Subscribe Tech + Us: Harness the power of technology and AI Tech + Us: Harness the power of technology and AI You are subscribed to BCG's Tech + Us newsletter.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"Manage Subscriptions What Are AI Agents?","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"Put simply, AI agents are artificial intelligence that use tools to accomplish goals.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"AI agents have the ability to remember across tasks and changing states; they can use one or more AI models to complete tasks; and they can decide when to access internal or external systems on a user’s behalf.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"This enables AI agents to make decisions and take actions autonomously with minimal human oversight.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
...
Our Clients' Success with AI Agents
Find more of our AI Agent client work
Client Impact
AI Agents Cut Timelines in the Biopharma Development Process
BCG partnered with one global pharmaceutical company to transform medical writing and drastically cut timelines.
Learn More
Client Impact
AI Agents Reinvent the Consumer Experience
BCG experts reveal how a leading beauty company is using AI to redefine the consumer journey and deliver personalized, precise, empowering experiences.
Learn More
Client Impact
AI Agents Optimize the Industrial Goods Supply Chain
By embedding agentic AI directly into daily workflows, one global industrial goods company unlocked agility, resilience, and a 2 percentage-point EBITDA boost in just two years.
Learn More
...
To view this video content, you must consent to all cookies
Modify Cookie Settings
Video
Deploy GenAI in Everyday Tools
Featured Expert: Julie Bedard
...
Article
November 10, 2025
Agentic AI in Biopharma: Game-changing Efficiency
BCG partnered with one global pharmaceutical company to transform medical writing and accelerate biopharma development.
Learn More
To view this video content, you must consent to all cookies
Modify Cookie Settings
Video
October 23, 2025
Experimenting Your Way to Agentic Success
Workday’s Charles Baker and BCG’s Abheek Chanana discuss how starting small, testing fast, and staying human-centered can accelerate an agentic AI transformation.
Video
October 23, 2025
Experimenting Your Way to Agentic Success
Workday’s Charles Baker and BCG’s Abheek Chanana discuss how starting small, testing fast, and staying human-centered can accelerate an agentic AI transformation.
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":72,"text_length":15567,"paragraph_count":123,"sentence_count":106,"boilerplate_hits":11,"symbol_ratio":0,"method":"main"}
...
1. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   AI agents are artificial intelligence that use tools to accomplish goals. AI agents have the ability to remember across tasks and changing states. / query=AI Agent funding enterprise customers / intent=find_startups / path=official_original

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Subscribe Tech + Us: Harness the power of technology and AI Tech + Us: Harness the power of technology and AI You are subscribed to BCG's Tech + Us newsletter.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Manage Subscriptions What Are AI Agents?
...
- numbers: 2, 95%, 50x, 10x, 25%, 35%, 40%, 45%
- quotes: 暂无公开信息

## evidence_seed

- company_actions: AI agents are artificial intelligence that use tools to accomplish goals. AI agents have the ability to remember across tasks and changing states. / query=AI Agent funding enterprise customers / intent=find_startups / path=official_original / Subscribe Tech + Us: Harness the power of technology and AI Tech + Us: Harness the power of technology and AI You are subscribed to BCG's Tech + Us newsletter. / Manage Subscriptions What Are AI Agents?
- case_details: 暂无公开信息
