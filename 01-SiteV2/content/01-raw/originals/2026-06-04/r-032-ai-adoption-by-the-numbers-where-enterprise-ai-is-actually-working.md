...
original_url: "https://www.linkedin.com/pulse/ai-adoption-numbers-where-enterprise-actually-working-kimberly-tan-mygwf"
canonical_url: "https://linkedin.com/pulse/ai-adoption-numbers-where-enterprise-actually-working-kimberly-tan-mygwf"
...
author: ""
published_at: ""
collected_at: 2026-06-04T04:44:55.998Z
language: mixed
full_text_hash: 4a42c6caa56e74a0
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-032-ai-adoption-by-the-numbers-where-enterprise-ai-is-actually-working.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-032-ai-adoption-by-the-numbers-where-enterprise-ai-is-actually-working.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":21268,"paragraph_count":76,"sentence_count":136,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"main"}
has_full_text: true
content_length: 21268
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"4a42c6caa56e74a0","missing":[]}
...
url_hash: cc56997c1f4b4dc3
content_hash: 8ebf1976138dd3da
semantic_hash: 7e660e25c3216344
duplicate_of: ""
first_seen_at: "2026-06-04T04:44:55.998Z"
last_seen_at: 2026-06-04T04:44:55.998Z
...
Coding: Coding is the dominant use case for AI by nearly an order of magnitude. It’s abundantly clear in the reported explosive growth of companies like
Cursor
, as well as the hyper growth of tools like Claude Code and Codex . These growth rates have outstripped virtually everyone’s even most-optimistic predictions, and by far the majority of Fortune 500 / Global 2000 adoption of AI tooling is in code.
...
Lastly, support is transactional by nature. Customers are indifferent as to who is physically on the other line, meaning support doesn’t require any human relationships that would be difficult for AI to replicate. These characteristics explain why companies like
Decagon
and
Sierra
have grown so quickly, as well as more vertical-specific support players like
Salient
HappyRobot
, etc.
...
AI search is so broad as a category that it’s enabled many independent large startups to emerge. One of the primary pain points many enterprises have internally is enabling employees to simply locate and extract relevant information across a disparate set of their systems.
Glean
has thrived as the primary startup vendor for this use case. Many large industries also operate off of very specific industry information (both internal and external), and companies like
Harvey
(which began in legal search) as well as
OpenEvidence
(which began in medical search) have thrived building a core offering around that.
Industries
Technology: By far the most common industry to adopt AI so far is the tech industry. ChatGPT itself reported that 27 percent of its business users come from tech, and many of the early customers of companies like Cursor, Decagon and Glean were tech companies. This is wholly unsurprising given tech is almost always an early adopter and is the industry that spawned the AI wave.
...
This was because traditional enterprise software provided limited value to lawyers: static workflow tools didn’t accelerate the unstructured, nuanced work that lawyers typically did. But AI has made the value prop of technology to lawyers much clearer. AI is excellent at parsing dense text, reasoning over large amounts of text, and summarizing and drafting responses — all work that lawyers regularly do. AI now acts often as a copilot to improve individual lawyer productivity, but has begun to extend beyond that: in some cases, it can actually be revenue-generating by allowing law firms to process more cases (as in the case of
Eve
, which specializes in plaintiff law).
...
, and
Tennr
have grown tremendously quickly in revenue off the back of discrete use cases like medical scribing, medical search, or back office automation of the byzantine rules governing how healthcare gets delivered and paid for.
...
1mo
Report this comment
Very helpful data point, Kimberly Tan . Narrow scope and measurable outcomes are harder to do beyond coding, support and search as your data revealed, but large enterprises willing to remap their accountability structures and decision hierarchies while building AI-ready data pipelines with context relevant to their competitive advantage stand the best chance of capturing more productivity gains and new growth. If of interest: https://www.linkedin.com/posts/activity-7444381876452016129-hhzT
AI Risk Governance - A Strategic Enabler — Propel Global Advisory LLC | Ichun L.
What does it take to move beyond pilots and deploy AI at scale in regulated financial
Like
Reply
1 Reaction
Andrew Zupko
1mo
Report this comment
Same pattern in every sector. The pilot works, CFO asks for a business case, nobody can define impact. Pilot AI and production AI are almost different products — most companies only budget for the first.
Like
Reply
1 Reaction
Paul Peterson
1mo
Report this comment
This is great Kimberly. I'm really interested to see how this will play out in the accounting industry. Most of the pricing is still archaic and opaque. The industry standards are going to change.
Like
Reply
1 Reaction
Babajide Okusanya
1mo
Report this comment
The part that stuck with me wasn't the 29% headline. It was your note that coding's lead is driven by enterprise adoption, not individual developers.
That matches what I'm seeing after a year of training PMs, salespeople, and ops teams on these tools. The adoption gap for them isn't capability, it's skills and workflow. Excited to see how the need moves by the end of the year.
Like
Reply
1 Reaction
Edwin M.
1mo
Report this comment
The gap between enterprise and small business AI adoption is even more pronounced in legal. While enterprise usage is climbing fast, FirmEdge data shows only 8% of solo law firms have integrated any AI tools — among the lowest rates across professional services.
The reason isn't skepticism. It's that most AI value narratives are built around enterprise-scale ROI. Solo attorneys don't have a Chief AI Officer or a six-month implementation runway. They need tools that work day one, with no overhead.
The firms getting left behind aren't the ones who evaluated AI and said no — they're the ones who said "maybe later." The data suggests later is already now.
Like
Reply
1 Reaction
See more comments
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":21268,"paragraph_count":76,"sentence_count":136,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   There has been a ton of speculation about the extent to which AI has made real inroads into large enterprises, but most existing information consists solely of self-reported AI usage or surveys that capture qualitative buyer sentiment rather than hard data.
...
5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   We have been closely tracking where AI is seeing the most adoption and where ROI has been clear, and have compiled hard data on what’s actually working in enterprise AI.
...
- numbers: 29%, 500, 19%, 2000, 95, 2022, 3, 10
- quotes: 暂无公开信息

## evidence_seed

- company_actions: There has been a ton of speculation about the extent to which AI has made real inroads into large enterprises, but most existing information consists solely of self-reported AI usage or surveys that capture qualitative buyer sentiment rather than hard data. / We have been closely tracking where AI is seeing the most adoption and where ROI has been clear, and have compiled hard data on what’s actually working in enterprise AI.
