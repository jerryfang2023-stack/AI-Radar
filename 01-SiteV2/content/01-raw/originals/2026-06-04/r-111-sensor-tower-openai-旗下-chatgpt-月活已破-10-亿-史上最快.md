...
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-111-sensor-tower-openai-旗下-chatgpt-月活已破-10-亿-史上最快.json"
html_snapshot_path: ""
screenshot_path: ""
...
business_elements: {"companies":["IT之家（RSS）","OpenAI","Anthropic","Google"],"products":["ChatGPT","Claude"],"people":[],"industries":[],"roles":[],"workflows":[],"business_actions":[],"affected_departments":[],"numbers":["10 亿","2025","5","5600 万","640%"],"quotes":[]}
...
- numbers: 10 亿, 2025, 5, 5600 万, 640%
- quotes: 暂无公开信息

## evidence_seed

- company_actions: 数据显示，部分用户已开始在 Claude 与 ChatGPT 间切换使用。 / 在达成用户里程碑之际，Anthropic 已秘密递交 IPO 申请，OpenAI 也计划筹备上市。
- case_details: 暂无公开信息
