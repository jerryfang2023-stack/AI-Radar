...
raw_id: R-013
title: "AWS Marketplace: NVIDIA AI Enterprise - Amazon.com"
original_url: "https://aws.amazon.com/marketplace/pp/prodview-ozgjkov6vq3l6"
canonical_url: "https://aws.amazon.com/marketplace/pp/prodview-ozgjkov6vq3l6"
...
author: ""
published_at: ""
collected_at: 2026-06-04T04:44:55.909Z
language: mixed
full_text_hash: 9a55f49d3fafb7c5
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-013-aws-marketplace-nvidia-ai-enterprise-amazon-com.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-04/r-013-aws-marketplace-nvidia-ai-enterprise-amazon-com.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":34435,"paragraph_count":222,"sentence_count":236,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"main"}
has_full_text: true
content_length: 34435
fetch_error: ""
...
url_hash: 0843cf48e7536945
content_hash: 8a112f941c035e48
semantic_hash: 4bf1ff12b4852dd2
duplicate_of: ""
first_seen_at: "2026-06-04T04:44:55.909Z"
last_seen_at: 2026-06-04T04:44:55.909Z
...
business_elements: {"companies":["keyword search","Anysearch","Amazon","AWS","Nvidia"],"products":["agent"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","制造 / 工业","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","采购负责人"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","采购","销售 / 客服"],"numbers":["4.3","18","3","24.04","8","5","64","86"],"quotes":[]}
...
Version release notes https://docs.nvidia.com/ngc/ngc-deploy-public-cloud/ngc-aws/index.html#ami-overview
Additional details
Usage instructions
Continue to Subscribe and launch the AMI on EC2 GPU instance following the prompts.
Once the instance is launched, SSH into the instance.
Run the identity token generation script: ./ngc-token.sh -g to print out the validation token.
Copy the token and activate your NVIDIA AI Enterprise subscription at https://org.ngc.nvidia.com/activate .
NVIDIA AI containers from the Enterprise Catalog can be pulled once the account is activated.
For more information please follow:
Quick Start Guide: https://docs.nvidia.com/ai-enterprise/deployment-guide-cloud/0.1.0/aws-ai-enterprise-vmi.html#
AMI documentation and release notes: https://docs.nvidia.com/ngc/ngc-deploy-public-cloud/ngc-aws/index.html
Resources
Vendor resources
Links
Videos
NVIDIA AI Enterprise product page
Running NVIDIA AI Enterprise in the Cloud:
NVIDIA-AWS partner page
Support
Vendor support
...
What is our primary use case?
My main use case is building and deploying GenAI applications like RAG pipelines, LLM inference service, and GPU-ac
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":94,"text_length":34435,"paragraph_count":222,"sentence_count":236,"boilerplate_hits":1,"symbol_ratio":0.0001,"method":"main"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   NVIDIA AI Enterprise is an end-to-end, cloud-native software platform that accelerates data science pipelines and streamlines development and deployment of ... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=procurement_marketplace

2. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   NVIDIA AI Enterprise Info Sold by: NVIDIA Deployed on AWS NVIDIA AI Enterprise is an end-to-end, cloud-native software platform that accelerates data science pipelines and streamlines development and deployment of production-grade AI applications, including generative AI.
...
4. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   With NVIDIA AI Enterprise, customers get support and access to the following: NVIDIA NIM and CUDA-X microservices, which provide an optimized runtime and easy to use building blocks to streamline generative AI development.
...
- companies: keyword search, Anysearch, Amazon, AWS, Nvidia
- products: agent
- people: 暂无公开信息
...
- numbers: 4.3, 18, 3, 24.04, 8, 5, 64, 86
- quotes: 暂无公开信息

## evidence_seed

- company_actions: NVIDIA NeMo, an end-to-end framework for organizations to easily customize pretrained NVIDIA AI Foundation models and select community models for domain-specific use cases based on business data. / NVIDIA Riva, a GPU-accelerated multilingual speech and translation AI SDK.
- case_details: NVIDIA AI Enterprise is an end-to-end, cloud-native software platform that accelerates data science pipelines and streamlines development and deployment of ... / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=procurement_marketplace / NVIDIA AI Enterprise Info Sold by: NVIDIA Deployed on AWS NVIDIA AI Enterprise is an end-to-end, cloud-native software platform that accelerates data science pipelines and streamlines development and deployment of production-grade AI applications, including generative AI. / With NVIDIA AI Enterprise, customers get support and access to the following: NVIDIA NIM and CUDA-X microservices, which provide an optimized runtime and easy to use building blocks to streamline generative AI development.
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队, 法务 / 律师, 采购负责人
- risks_or_constraints: 3 (18) View purchase options Overview Features Pricing Legal Usage Resources Support Product comparison New Reviews Overview Try agent mode Create proposal Ask question Product video NVIDIA AI Enterprise includes best-in-class development tools, frameworks, and pre-trained models for AI practitioners, and reliable management and orchestration for IT professionals to ensure performance, high availability, and security.
