...
original_url: "https://vercel.com/blog/ai-sdk-6"
canonical_url: "https://vercel.com/blog/ai-sdk-6"
...
author: ""
published_at: ""
collected_at: 2026-06-01T07:37:54.686Z
language: mixed
full_text_hash: e86a94398db75ff0
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-01/r-061-ai-sdk-6-vercel.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-01/r-061-ai-sdk-6-vercel.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":38511,"paragraph_count":480,"sentence_count":270,"boilerplate_hits":0,"symbol_ratio":0.0157,"method":"main"}
has_full_text: true
content_length: 38511
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"e86a94398db75ff0","missing":[]}
...
url_hash: ea564c061dd4d2f3
content_hash: a1196db3949c3318
semantic_hash: 59142355c39f01c7
duplicate_of: ""
first_seen_at: "2026-06-01T07:37:54.686Z"
last_seen_at: 2026-06-01T07:37:54.686Z
...
guanlan_scores: {"importance_type":"important_product_or_service","importance_score":5,"importance_reason":"new product or service; rubric=5 major/platform/industry-shaping","supporting_signals":["adoption_context"],"novelty":4,"evidence_strength":4,"case_richness":5,"trend_relevance":4,"guanlan_relevance":5,"emerging_signal_score":4}
business_elements: {"companies":["follow","builders cloud fallback","keyword search","Anysearch","Anthropic"],"products":["agents","MCP","Agents","Agent","agent","claude","mcp"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队","法务 / 律师","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":[],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["6","20 million","500","12 m","22","2025","3","2 m"],"quotes":[" ;\n2 import { z } from "," ;\n4 const supportAgent = new ToolLoopAgent ( {\n5 model : "," ,\n6 callOptionsSchema : z . object ( {\n7 userId : z . string ( ) ,\n8 accountType : z . enum ( [ ","enterprise","How do I upgrade my account?"]}
evidence_seed: {"company_actions":["It provides a unified API, allowing you to integrate with any AI provider, and seamlessly integrates with Next.","js, React, Svelte, Vue, and Node.","The AI SDK enables you to build everything from chatbots to complex background agents."],"case_details":[],"workflow_changes":["12 min read Copy URL Dec 22, 2025 Introducing agents, tool execution approval, DevTools, full MCP support, reranking, image editing, and more."],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["开发者 / 工程团队","法务 / 律师","销售 / 客服"],"risks_or_constraints":[]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"number","text":"AI SDK 6 Introducing agents, tool execution approval, DevTools, full MCP support, reranking, image editing, and more. With over 20 million monthly downloads and adoption by teams ranging from startups to Fortune 500 companies, the AI SDK is the leading TypeScript toolkit for building AI applications. It provides a unified API, allowing you to integrate with any AI provider, and seamlessly integrates with Next.js, React, Svelte, Vue, and Node.js. The AI SDK enables you to build everything from chatbots to complex ba","supports":["daily_observation","heatmap","case","trend"],"importance":"high","confidence":"high"},{"type":"workflow_change","text":"12 min read Copy URL Dec 22, 2025 Introducing agents, tool execution approval, DevTools, full MCP support, reranking, image editing, and more.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"number","text":"With over 20 million monthly downloads and adoption by teams ranging from startups to Fortune 500 companies, the AI SDK is the leading TypeScript toolkit for building AI applications.","supports":["daily_observation","heatmap","case","trend"],"importance":"high","confidence":"high"},{"type":"product_update","text":"It provides a unified API, allowing you to integrate with any AI provider, and seamlessly integrates with Next.","supports":["daily_observation","heatmap","change"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"js, React, Svelte, Vue, and Node.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"The AI SDK enables you to build everything from chatbots to complex background agents.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
...
1 import { ToolLoopAgent } from 'ai' ;
2 import { weatherTool } from '@/tools/weather' ;
4 export const weatherAgent = new ToolLoopAgent ( {
...
16 } ) ;
17
18 const result = await supportAgent . generate ( {
...
Link to heading Code Organization & UI Integration
...
2 import { ToolLoopAgent , InferAgentUIMessage } from "ai" ;
3 import { weatherTool } from "@/tools/weather-tool" ;
5 export const weatherAgent = new ToolLoopAgent ( {
6 model : "anthropic/claude-sonnet-4.5" ,
7 instructions : "You are a helpful weather assistant." ,
8 tools : { weather : weatherTool } ,
9 } ) ;
10
11 export type WeatherAgentUIMessage = InferAgentUIMessage < typeof weatherAgent > ;
12
13 // app/api/chat/route.ts
14 import { createAgentUIStreamResponse } from "ai" ;
15 import { weatherAgent } from "@/agents/weather-agent" ;
16
...
3 import type { WeatherAgentUIMessage } from '@/agents/weather-agent' ;
4 import { WeatherToolView } from '@/components/weather-tool-view' ;
...
23 import { UIToolInvocation } from 'ai' ;
24 import { weatherTool } from '@/tools/weather-tool' ;
25
26 export function WeatherToolView ( {
27 invocation ,
28 } : {
...
Link to heading Custom Agent Implementations
...
1 import { getWritable } from 'workflow' ;
2 import { DurableAgent } from '@workflow/ai/agent' ;
3 import { searchFlights , bookFlight , getFlightStatus } from './tools' ;
5 export async function flightBookingWorkflow ( ) {
6 'use workflow' ;
...
Link to heading Tool Improvements
...
Link to heading Tool Execution Approval
...
2 import { z } from 'zod' ;
4 export const runCommand = tool ( {
...
1 import { ChatAddToolApproveResponseFunction } from 'ai' ;
2 import { runCommand } from './tools/command-tool' ;
4 export function CommandToolView ( {
5 invocation ,
...
9 } ) ,
10 } ) ;
Link to heading Input Examples
...
Link to heading Send Custom Tool Output to the Model
...
Link to heading HTTP Transport
...
Link to heading OAuth Authentication
...
1 import { createMCPClient , auth , OAuthClientProvider } from "@ai-sdk/mcp" ;
3 const authProvider : OAuthClientProvider = {
...
14 } ;
15
16 await auth ( authProvider , { serverUrl : new URL ( "https://mcp.example.com" ) } ) ;
17
18 const client = await createMCPClient ( {
19 transport : { type : "http" , url : "https://mcp.example.com" , authProvider } ,
20 } ) ;
Link to heading Resources and Prompts
...
2 const resources = await mcpClient . listResources ( ) ;
3 const resourceData = await mcpClient . readResource ( {
4 uri : "file:///example/document.txt" ,
5 } ) ;
7 // List and get prompts
8 const prompts = await mcpClient . experimental_listPrompts ( ) ;
9 const prompt = await mcpClient . experimental_getPrompt ( {
10 name : "code_review" ,
11 arguments : { code : "function add(a, b) { return a + b; }" } ,
12 } ) ;
Link to heading Elicitation
...
11 arguments : { code : "function add(a, b) { return a + b; }" } ,
12 } ) ;
Link to heading Elicitation Support
...
4 } ) ;
6 mcpClient . onElicitationRequest ( ElicitationRequestSchema , async request => {
...
Link to heading Tool Calling with Structured Output
...
1 import { Output , ToolLoopAgent , tool } from "ai" ;
2 import { z } from "zod" ;
4 const agent = new ToolLoopAgent ( {
5 model : "anthropic/claude-sonnet-4.5" ,
6 tools : {
7 weather : tool ( {
...
Link to heading Setup
To get started, wrap your model with the devToolsMiddleware :
1 import { wrapLanguageModel , gateway } from 'ai' ;
2 import { devToolsMiddleware } from '@ai-sdk/devtools' ;
4 const devToolsEnabledModel = wrapLanguageModel ( {
...
6 } ) ;
Link to heading Inspecting Your Runs
...
1 import { rerank } from 'ai' ;
2 import { cohere } from '@ai-sdk/cohere' ;
4 const documents = [
5 'sunny day at the beach' ,
6 'rainy afternoon in the city' ,
7 'snowy night in the mountains' ,
8 ] ;
10 const { ranking } = await rerank ( {
...
21 // ]
Link to heading Structured Document Reranking
...
11 ] ;
12
13 const { rerankedDocuments } = await rerank ( {
14 model : cohere . reranking ( 'rerank-v3.5' ) ,
15 documents ,
16 query : 'Which pricing did we get from Oracle?' ,
17 topN : 1 ,
18 } ) ;
The rerank function currently supports Cohere, Amazon Bedrock, and Together.ai .
To learn more, check out the Reranking documentation .
Link to heading Standard JSON Schema
...
Link to heading Provider Tools
...
Link to heading Anthropic Provider Tools
...
4 const memory = anthropic . tools . memory_20250818 ( {
...
12 const toolSearchRegex = anthropic . tools . toolSearchRegex_20251119 ( ) ;
13
14 // Tool Search (BM25) - find tools with natural language
15 const toolSearchBm25 = anthropic . tools . toolSearchBm25_20251119 ( ) ;
16
17 // Code Execution Tool - run code in sandbox
18 const codeExecution = anthropic . tools . codeExecution_20250825 ( ) ;
...
Link to heading OpenAI Provider Tools
...
4 const shell = openai . tools . shell ( {
5 execute : async ( { action } ) => {
...
13 const applyPatch = openai . tools . applyPatch ( {
...
Link to heading Google Provider Tools
...
4 const googleMaps = google . tools . googleMaps ( ) ;
6 // Vertex RAG Store Tool - retrieve from RAG corpora
7 const vertexRagStore = google . tools . vertexRagStore ( {
...
13 const fileSearch = google . tools . fileSearch ( {
...
Link to heading xAI Provider Tools
...
1 import { xai } from "@ai-sdk/xai" ;
3 // Web Search Tool - search the web
4 const webSearch = xai . tools . webSearch ( {
5 allowedDomains : [
...
14 const xSearch = xai . tools . xSearch ( {
...
23 const codeExecution = xai . tools . codeExecution ( ) ;
24
25 // View Image Tool - analyze images
26 const viewImage = xai . tools . viewImage ( ) ;
27
28 // View X Video Tool - analyze X videos
29 const viewXVideo = xai . tools . viewXVideo ( ) ;
To learn more, check out the xAI documentation .
Link to heading Image Editing
...
1 import { generateImage } from "ai" ;
2 import { blackForestLabs } from "@ai-sdk/black-forest-labs" ;
4 const { images } = await generateImage ( {
...
1 const { finishReason , rawFinishReason } = await generateText ( {
...
Link to heading Extended Usage Information
Usage reporting now includes detailed breakdowns for both input and output tokens:
1 const { usage } = await generateText ( {
2 model : 'anthropic/claude-sonnet-4.5' ,
3 prompt : 'What is love?' ,
4 } ) ;
6 // Input token details
7 usage . inputTokenDetails . noCacheTokens ; // Non-cached input tokens
8 usage . inputTokenDetails . cacheReadTokens ; // Tokens read from cache
9 usage . inputTokenDetails . cacheWriteTokens ; // Tokens written to cache
10
11 // Output token details
12 usage . outputTokenDetails . textTokens ; // Text generation tokens
13 usage . outputTokenDetails . reasoningTokens ; // Reasoning tokens (where supported)
14
15 // Raw provider usage
16 usage . raw ; // Complete provider-specific usage object
These detailed breakdowns give you the visibility you need to optimize costs and debug token usage across providers.
Link to heading LangChain Adapter Rewrite
...
2 import { createUIMessageStreamResponse } from 'ai' ;
4 const langchainMessages = await toBaseMessages ( messages ) ;
5 const stream = await graph . stream ( { messages : langchainMessages } ) ;
...
Link to heading Migrating to AI SDK 6
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":38511,"paragraph_count":480,"sentence_count":270,"boilerplate_hits":0,"symbol_ratio":0.0157,"method":"main"}
...
1. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   AI SDK 6 Introducing agents, tool execution approval, DevTools, full MCP support, reranking, image editing, and more. With over 20 million monthly downloads and adoption by teams ranging from startups to Fortune 500 companies, the AI SDK is the leading TypeScript toolkit for building AI applications. It provides a unified API, allowing you to integrate with any AI provider, and seamlessly integrates with Next.js, React, Svelte, Vue, and Node.js. The AI SDK enables you to build everything from chatbots to complex ba

2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   12 min read Copy URL Dec 22, 2025 Introducing agents, tool execution approval, DevTools, full MCP support, reranking, image editing, and more.
...
4. **product_update**｜supports=daily_observation, heatmap, change｜importance=medium｜confidence=high
   It provides a unified API, allowing you to integrate with any AI provider, and seamlessly integrates with Next.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   js, React, Svelte, Vue, and Node.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   The AI SDK enables you to build everything from chatbots to complex background agents.

## business_elements

- companies: follow, builders cloud fallback, keyword search, Anysearch, Anthropic
- products: agents, MCP, Agents, Agent, agent, claude, mcp
- people: 暂无公开信息
...
- numbers: 6, 20 million, 500, 12 m, 22, 2025, 3, 2 m
- quotes:  ;
2 import { z } from  /  ;
4 const supportAgent = new ToolLoopAgent ( {
5 model :  /  ,
...
- company_actions: It provides a unified API, allowing you to integrate with any AI provider, and seamlessly integrates with Next. / js, React, Svelte, Vue, and Node. / The AI SDK enables you to build everything from chatbots to complex background agents.
- case_details: 暂无公开信息
- workflow_changes: 12 min read Copy URL Dec 22, 2025 Introducing agents, tool execution approval, DevTools, full MCP support, reranking, image editing, and more.
