...
author: ""
published_at: ""
collected_at: 2026-06-01T07:37:54.775Z
language: mixed
full_text_hash: 2e4ea4b4d98f75c0
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-01/r-117-我花200英镑把一台数据中心级gpu装进了我的游戏电脑.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-01/r-117-我花200英镑把一台数据中心级gpu装进了我的游戏电脑.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"我花200英镑把一台数据中心级GPU装进了我的游戏电脑","discovery_summary":"一名用户以200英镑的价格购入了一块数据中心级GPU，并将其成功安装到自己的游戏电脑中。文章记述了这一非标准硬件改装过程、遇到的技术挑战以及最终实现本地运行大语言模型的体验。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"","discovered_at":"2026-06-01T07:31:32.419Z","rank_on_page":7,"discovery_status":"discovered"}
...
content_hash: 2e4ea4b4d98f75c0
semantic_hash: c973ea3aacfebc5a
duplicate_of: ""
first_seen_at: "2026-06-01T07:37:54.775Z"
last_seen_at: 2026-06-01T07:37:54.775Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）"],"products":[],"people":[],"industries":[],"roles":[],"workflows":[],"business_actions":[],"affected_departments":[],"numbers":["200"],"quotes":[]}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=medium
   文章记述了这一非标准硬件改装过程、遇到的技术挑战以及最终实现本地运行大语言模型的体验。
...
- company_actions: 一名用户以200英镑的价格购入了一块数据中心级GPU，并将其成功安装到自己的游戏电脑中。文章记述了这一非标准硬件改装过程、遇到的技术挑战以及最终实现本地运行大语言模型的体验。 / 一名用户以200英镑的价格购入了一块数据中心级GPU，并将其成功安装到自己的游戏电脑中。 / 文章记述了这一非标准硬件改装过程、遇到的技术挑战以及最终实现本地运行大语言模型的体验。
- case_details: 暂无公开信息
