...
original_url: "https://basedapp.gitbook.io/docs/integrations/mini-apps-platform/13-changelog"
canonical_url: "https://basedapp.gitbook.io/docs/integrations/mini-apps-platform/13-changelog"
...
author: ""
published_at: ""
collected_at: 2026-07-11T04:43:04.281Z
language: mixed
full_text_hash: 434b1c9c1f27554b
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-11/r-030-item.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-11/r-030-item.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":10222,"paragraph_count":77,"sentence_count":104,"boilerplate_hits":1,"symbol_ratio":0.005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
...
url_hash: 66389bbe5b2f7c64
content_hash: 434b1c9c1f27554b
semantic_hash: 5ab3532990899919
duplicate_of: ""
first_seen_at: "2026-07-11T04:43:04.281Z"
last_seen_at: 2026-07-11T04:43:04.281Z
...
business_elements: {"companies":["keyword search","Anysearch","Google"],"products":[],"people":[],"industries":["制造 / 工业","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["13","12","1.0","0","5","03","1.1","1.2"],"quotes":[" is supported by host versions that advertise sdkVersion ≥ ","Open by URL","Open by URL","Open by URL","labels render under the system buttons"]}
...
fact_extraction_completed_at: 2026-07-11T04:43:04.281Z
...
Initial GA. The full surface listed in 03-host-contract.md ships under SDK 1.0.0. From this version on:
targetSdkVersion: "1.0" is supported by host versions that advertise sdkVersion ≥ "1.0.0" .
API additions are minor-version bumps (1.1, 1.2, …); breaking changes are major-version bumps following the deprecation policy in 14-breaking-change-policy.md .
v0.x — Pre-GA
...
0.1.0
2026-Q4 (target)
First partner pilot; full host contract minus nav.openMiniApp and signing.signEvmTypedData .
0.0.x
2026-04 →
Internal pre-pilot series. Phase 2/3 work.
...
Runtime / engine
QuickJS now runs in a dedicated Dart isolate (architecture spec A1, implemented). MiniAppRuntime is a host-side proxy; the engine, the three sendMessage channels ( based-bridge / based-console / based-rerender ), and microtask pumping all live in js_worker.dart . JS no longer blocks the UI isolate. See 05-js-runtime.md .
...
The renderer's case dispatch now covers a substantial post-v1 catalog. Every type below is shipped, doc'd in 07-ui-nodes-and-renderer.md , and exposed via the SDK type declarations:
...
New permission notifications.local . Spec'd in 03-host-contract.md and 15-notifications.md .
...
Full reference in 17-partner-api.md .
...
Previous Open questions Next Breaking change policy
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   This is the partner-facing changelog for based_mini_app_sdk and the based.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   It mirrors the npm-published @based/sdk-types versions.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   The changelog is append-only for resolved entries.
...
- numbers: 13, 12, 1.0, 0, 5, 03, 1.1, 1.2
- quotes:  is supported by host versions that advertise sdkVersion ≥  / Open by URL / Open by URL / Open by URL / labels render under the system buttons

## evidence_seed

- company_actions: For the complete documentation index, see llms. / This page is also available as Markdown . / This is the partner-facing changelog for based_mini_app_sdk and the based.
- case_details: > For the complete documentation index, see [llms.txt](https://basedapp.gitbook.io/docs/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://basedapp.gitbook.io/docs/integrations/mini-apps-platform/13-changelo... / query=AI implementation startup design partner pilot customer / intent=find_startups / path=official_original
