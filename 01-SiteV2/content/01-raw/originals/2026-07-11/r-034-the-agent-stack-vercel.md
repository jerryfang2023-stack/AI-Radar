...
title_zh: "代理堆栈- Vercel"
title_translation_status: translated
title_translation_method: mymemory_title_translation
original_url: "https://vercel.com/blog/agent-stack"
canonical_url: "https://vercel.com/blog/agent-stack"
...
author: ""
published_at: ""
collected_at: 2026-07-11T04:43:05.378Z
language: mixed
full_text_hash: 52bb8c4af6015673
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-11/r-034-the-agent-stack-vercel.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-11/r-034-the-agent-stack-vercel.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":8712,"paragraph_count":71,"sentence_count":78,"boilerplate_hits":0,"symbol_ratio":0.0024,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8712
fetch_error: ""
...
url_hash: d553b7314a3704e5
content_hash: 52bb8c4af6015673
semantic_hash: 47fb2468bcb4cfa6
duplicate_of: ""
first_seen_at: "2026-07-11T04:43:05.378Z"
last_seen_at: 2026-07-11T04:43:05.378Z
...
business_elements: {"companies":["keyword search","Anysearch","Anthropic","GitHub","Salesforce"],"products":["Agent","Agents","agent","agents","claude","Claude","Gemini"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["17","2026","1","2","3 m","4.6","4","5"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-11T04:43:05.378Z
...
Copy link to heading Connect to models
...
4 prompt : 'Summarize the latest deploys.' ,
5 } ) ;
6 console . log ( text ) ;
Switch models by changing one string, not your code.
Copy link to heading AI Gateway
...
“ The last thing we want is to rebuild our infrastructure every time a new model drops. The last thing we want is to rebuild our infrastructure every time a new model drops. ”
Greg Chan CTO
...
Copy link to heading Execute complex workflows
...
Copy link to heading Workflow SDK
...
“ Questions like 'how do we make this durable?' or 'what if the user disconnects mid-generation?' used to eat up our design discussions. Now they're solved, so we can ship as fast as we experiment. Questions like 'how do we make this durable?' or 'what if the user disconnects mid-generation?' used to eat up our design discussions. Now they're solved, so we can ship as fast as we experiment. ”
...
Copy link to heading Vercel Sandbox
...
2 const sandbox = await Sandbox . create ( { runtime : 'python3.13' } ) ;
3 await sandbox . writeFiles ( [
4 { path : 'agent.py' , content : Buffer . from ( agentCode ) } ,
5 ] ) ;
6 const result = await sandbox . runCommand ( 'python' , [ 'agent.py' ] ) ;
7 console . log ( await result . stdout ( ) ) ;
...
Copy link to heading Connect to data and tools
...
Copy link to heading Vercel Connect
...
“ Chat SDK is how one of our agents shows up in fifteen apps without building fifteen integrations. Chat SDK is how one of our agents shows up in fifteen apps without building fifteen integrations. ”
...
Copy link to heading e ve, the agent framework
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":8712,"paragraph_count":71,"sentence_count":78,"boilerplate_hits":0,"symbol_ratio":0.0024,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   # The Agent Stack Published: June 17, 2026 | Authors: Tom Occhino | Category: Company News --- Agents are designed to do almost any kind of work, from answering support tickets to writing code. No matter how complex the workload, how long it runs, or how many turns it takes to complete, every age... / query=AI platform launches agent workflow automation service 2026 / intent=find_original_source / path=official_original
...
2. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Agents are designed to do almost any kind of work, from answering support tickets to writing code.
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   No matter how complex the workload, how long it runs, or how many turns it takes to complete, every agent needs three core capabilities to operate: Agents need to connect to models and route between them Agents need to run workflows across many steps Agents need to connect to the systems that make them useful and the platforms people use to interact with them Implementing these capabilities to build a complete agent forces developers to choose between vendor lock-in with a single provider API, stitching together so

4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   The Agent Stack gives you all the building blocks you need to create and ship production-grade agents.

5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   The Agent Stack gives you every tool you need to build complete, production-ready agents Copy link to heading Connect to models Agents don't run on a single model.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Every task has a different cost, latency, and capability tradeoff, and the right call depends on what the agent is doing.

## business_elements

- companies: keyword search, Anysearch, Anthropic, GitHub, Salesforce
- products: Agent, Agents, agent, agents, claude, Claude, Gemini
- people: 暂无公开信息
...
- numbers: 17, 2026, 1, 2, 3 m, 4.6, 4, 5
- quotes: 暂无公开信息

## evidence_seed

- company_actions: The Agent Stack gives you all the building blocks you need to create and ship production-grade agents. / The Agent Stack gives you every tool you need to build complete, production-ready agents Copy link to heading Connect to models Agents don't run on a single model. / Every task has a different cost, latency, and capability tradeoff, and the right call depends on what the agent is doing.
- case_details: 暂无公开信息
- workflow_changes: # The Agent Stack Published: June 17, 2026 | Authors: Tom Occhino | Category: Company News --- Agents are designed to do almost any kind of work, from answering support tickets to writing code. No matter how complex the workload, how long it runs, or how many turns it takes to complete, every age... / query=AI platform launches agent workflow automation service 2026 / intent=find_original_source / path=official_original / Agents are designed to do almost any kind of work, from answering support tickets to writing code. / No matter how complex the workload, how long it runs, or how many turns it takes to complete, every agent needs three core capabilities to operate: Agents need to connect to models and route between them Agents need to run workflows across many steps Agents need to connect to the systems that make them useful and the platforms people use to interact with them Implementing these capabilities to build a complete agent forces developers to choose between vendor lock-in with a single provider API, stitching together so
