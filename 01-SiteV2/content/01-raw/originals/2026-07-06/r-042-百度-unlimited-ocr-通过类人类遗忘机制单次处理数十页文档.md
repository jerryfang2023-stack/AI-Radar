...
raw_id: R-042
title: "百度 Unlimited OCR：通过类人类遗忘机制单次处理数十页文档"
title_zh: "百度 Unlimited OCR：通过类人类遗忘机制单次处理数十页文档"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://the-decoder.com/baidus-unlimited-ocr-processes-dozens-of-document-pages-in-one-pass-by-treating-memory-like-human-forgetting"
canonical_url: "https://the-decoder.com/baidus-unlimited-ocr-processes-dozens-of-document-pages-in-one-pass-by-treating-memory-like-human-forgetting"
...
search_path_label: ""
author: ""
published_at: "2026-07-05T15:25:07.000Z"
collected_at: 2026-07-06T02:21:26.962Z
language: mixed
full_text_hash: 8739c86c843eed93
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-06/r-042-百度-unlimited-ocr-通过类人类遗忘机制单次处理数十页文档.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-06/r-042-百度-unlimited-ocr-通过类人类遗忘机制单次处理数十页文档.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":16933,"paragraph_count":70,"sentence_count":154,"boilerplate_hits":0,"symbol_ratio":0.0032,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"json-ld"}
has_full_text: true
content_length: 16933
fetch_error: ""
...
discovery_record: {"discovery_title":"百度 Unlimited OCR：通过类人类遗忘机制单次处理数十页文档","discovery_summary":"百度研究人员推出 Unlimited OCR 模型，基于开源 Deepseek OCR，采用 Reference Sliding Window Attention（R-SWA）机制，将 KV cache 固定为 128 token，使单次推理能处理数十页文档，内存与速度不随文本长度增长。模型 3B 参数，推理激活约 500M，支持 Base（多页）和 Gundam（单页动态分辨率）模式。在 OmniDocBench v1.5 上总体得分 93%，比 Deepseek OCR 高 6 个百分点；v1.6 版本达 93.92%，居端到端系统首位。Base 模式生成速度 5，580 tokens/s，较基线提升 12.7%。最长 32，000 token 上下文，代码与权重已开源至 GitHub 和 Hugging Face。","source_name":"The Decoder：AI News（RSS）","origin_url":"https://the-decoder.com/baidus-unlimited-ocr-processes-dozens-of-document-pages-in-one-pass-by-treating-memory-like-human-forgetting","discovered_at":"2026-07-06T02:07:37.965Z","rank_on_page":80,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: 7eee624c29ff5313
content_hash: 8739c86c843eed93
semantic_hash: 1be64c9bcb1dff3a
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-07-05T15:25:07.000Z"
last_seen_at: 2026-07-06T02:21:26.962Z
...
business_elements: {"companies":["The Decoder","AI News（RSS）","Anthropic","GitHub","Nvidia","Mistral"],"products":[],"people":[],"industries":["开发者工具"],"roles":["开发者 / 工程团队"],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["128","3B","500M","1.5","93%","6","1.6","93.92%"],"quotes":["Unlimited OCR","Unlimited OCR","Unlimited OCR","attachment_58101","aligncenter"]}
...
fact_extraction_completed_at: 2026-07-06T02:21:26.962Z
theme: developer-ecosystem-signal
keyword_group: developer-ecosystem-signal
copyright_note: local research archive only
---

# 百度 Unlimited OCR：通过类人类遗忘机制单次处理数十页文档
...
[caption id="attachment_58101" align="aligncenter" width="1800"] Baidu derives its architecture from how humans copy text by hand. The DeepEncoder compresses pages while the MoE decoder processes them with R-SWA, running the KV cache as a fixed-length queue. | Image: Baidu[/caption]
...
[caption id="attachment_58102" align="aligncenter" width="1800"] With R-SWA, each generated token attends to all reference tokens but only the last n output tokens, keeping the KV cache constant throughout decoding. | Image: Baidu[/caption]
...
[caption id="attachment_58100" align="aligncenter" width="1800"] Deepseek OCR's kernel latency climbs with each decoding step, while Unlimited OCR stays flat thanks to R-SWA. | Image: Baidu[/caption]
...
- fetch_status: fetched-readable-text-json-ld
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":16933,"paragraph_count":70,"sentence_count":154,"boilerplate_hits":0,"symbol_ratio":0.0032,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"json-ld"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   百度研究人员推出 Unlimited OCR 模型，基于开源 Deepseek OCR，采用 Reference Sliding Window Attention（R-SWA）机制，将 KV cache 固定为 128 token，使单次推理能处理数十页文档，内存与速度不随文本长度增长。模型 3B 参数，推理激活约 500M，支持 Base（多页）和 Gundam（单页动态分辨率）模式。在 OmniDocBench v1.5 上总体得分 93%，比 Deepseek OCR 高 6 个百分点；v1.6 版本达 93.92%，居端到端系统首位。Base 模式生成速度 5，580 tokens/s，较基线提升 12.7%。最长 32，000 token 上下文，代码与权重已开源至 GitHub 和 Hugging Face。
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   A modified attention mechanism keeps memory use flat no matter how many pages the model processes.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It currently holds the top spot on the most important OCR benchmark.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Baidu's Unlimited OCR reads dozens of document pages in a single pass, where previous systems topped out at about ten.

## business_elements

- companies: The Decoder, AI News（RSS）, Anthropic, GitHub, Nvidia, Mistral
- products: 暂无公开信息
- people: 暂无公开信息
- industries: 开发者工具
- roles: 开发者 / 工程团队
...
- numbers: 128, 3B, 500M, 1.5, 93%, 6, 1.6, 93.92%
- quotes: Unlimited OCR / Unlimited OCR / Unlimited OCR / attachment_58101 / aligncenter

## evidence_seed

- company_actions: It currently holds the top spot on the most important OCR benchmark. / Baidu's Unlimited OCR reads dozens of document pages in a single pass, where previous systems topped out at about ten.
- case_details: 暂无公开信息
- workflow_changes: A modified attention mechanism keeps memory use flat no matter how many pages the model processes.
