...
author: ""
published_at: ""
collected_at: 2026-07-06T02:21:26.809Z
language: mixed
full_text_hash: 8daa1eb4079d9983
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-06/r-020-95-of-ai-projects-fail-the-hidden-cause-the-d-ai-ly-brief.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-06/r-020-95-of-ai-projects-fail-the-hidden-cause-the-d-ai-ly-brief.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":20738,"paragraph_count":123,"sentence_count":146,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 20738
fetch_error: ""
...
url_hash: 8fbc7f05cf23c568
content_hash: 2f788364c87f05e1
semantic_hash: 6af4c492e67fe3e4
duplicate_of: ""
first_seen_at: "2026-07-06T02:21:26.809Z"
last_seen_at: 2026-07-06T02:21:26.809Z
update_detected: false
raw_status: pooled
usable_for: {"viewpoint":false,"case":true,"business_change":false,"relationship_graph_input":false,"trend_candidate_context":false,"signal_card_candidate":false,"emerging_pool":false,"user_feedback_pool":false,"watchlist":false}
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google","Amazon","AWS","Salesforce","ServiceNow","Deloitte"],"products":["agent","agents","Agents","Gemini"],"people":[],"industries":["金融 / 保险","医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队","采购负责人","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","财务 / 预算","采购","销售 / 客服"],"numbers":["95%","6","2026","300","2025","32%","2026 b","100"],"quotes":["build where you want, govern where you must","Forward deployed engineering is how ServiceNow and Accenture turn mutual customers' agentic AI business goals into value-generating production workloads.","This program brings together Accenture's industry depth and implementation reach with ServiceNow's AI Platform to deliver real results, not roadmaps.","real results, not roadmaps","all actions must be logged, traceable, and auditable, with enforcement of policies across environments"]}
...
fact_extraction_completed_at: 2026-07-06T02:21:26.809Z
...
Traditional Big Four Consulting
Internal Build
Workflow complexity (deep platform integration needed)
Best — engineers code inside customer environment
Moderate — usually delivers reference architecture, customer codes
Best if internal AI guild has ServiceNow/AWS/Azure platform depth
Time to production (8-week target)
Best — explicitly designed for production-first delivery
Worst — typical 9-18 month engagement cycle
Variable — depends on internal velocity
Pilot-to-production conversion rate
High — co-staffed pods optimize for live deployment
Low — 70% stop at architecture/POC
Moderate — depends on talent retention
Governance integration (audit, RBAC, lifecycle)
High — agents run on workflow platform inheriting controls
Moderate — bespoke governance framework
Highest if you architect it; lowest if you don't
Cost predictability
Outcome-aligned — paid for production workloads
Time and materials — high overrun risk
Capex + people; predictable but heavy on payroll
Industry expertise
Strong (Accenture provides)
Strongest
Weakest unless hired in
Knowledge transfer
Strong — pods document as they build
Moderate — slides over runbooks
Strongest — your team builds it
Best for
Mid-to-large enterprises with $5M+ agentic AI budget, on ServiceNow or another mature platform
Strategy/transformation work where the question is unclear
Platform-native shops with strong AI engineering bench
...
What to Do About It
For CIOs: Run the decision matr
...
Google Cloud's $750M Partner Fund Is a Direct Shot at Big Consulting
Deloitte + Google Cloud Agentic Practice on Gemini Enterprise
Why 79% of Enterprise AI Programs Fail Despite Million-Dollar Budgets
JPMorgan Reclassifies AI as Core Infrastructure: $19.8B Tech Budget
Sources:
ServiceNow and Accenture Launch FDE Program (Accenture Newsroom, May 6, 2026)
ServiceNow expands AI Control Tower (ServiceNow Newsroom)
Is Your ITSM AI Pilot Stuck? UC Today on the FDE program
McKinsey: State of AI Trust in 2026 — Shifting to the Agentic Era
Bain & Company: Google Cloud Next 2026 — Agentic Enterprise Control Plane
Interview Query: 800% surge in FDE job postings
Second Talent: FDE Rate Card and Compensation Data
CX Today: ServiceNow Q1 2026 AI Platform Results
ServiceNow Customer Story: Accenture Global IT
ServiceNow AI Agents Economic Value Calculator
Pragmatic Engineer: What are Forward Deployed Engineers?
Efficiently Connected: Knowledge 2026 Governance Analysis
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   95% of AI Projects Fail: The Hidden Cause | THE D*AI*LY BRIEF ServiceNow Accenture Forward Deployed Engineering Agentic AI Enterprise AI AI Deployment # 95% of AI Projects Fail: The Hidden Cause 95% of AI Projects Fail: The Hidden Cause Key insights for enterprise AI leaders on what this means an... / query=AI workflow rollout procurement pilot / intent=find_customer_case / path=fde_implementation

2. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   On May 6, 2026, at Knowledge 2026 in Las Vegas, ServiceNow and Accenture launched a Forward Deployed Engineering (FDE) program designed to do the one thing most enterprise AI initiatives still cannot: cross the pilot-to-production chasm.

3. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   The program embeds ServiceNow's AI-native engineers alongside Accenture's industry specialists directly inside mutual customers' operations, building agentic workflows on the ServiceNow AI Platform until they run in production.

4. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Customers get access to 300+ pre-built AI agent skills and ServiceNow's AI Control Tower for governance — wrapped in a delivery model that explicitly walks away from the slide-deck-and-billable-hours playbook that has defined IT consulting for two decades.

5. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   The bet is precise: enterprises do not have a model problem; they have a deployment problem.
...
6. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   MIT Sloan's 2025 research found 95% of GenAI pilots never scale to production.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Anthropic, Google, Amazon, AWS, Salesforce, ServiceNow, Deloitte
- products: agent, agents, Agents, Gemini
- people: 暂无公开信息
...
- numbers: 95%, 6, 2026, 300, 2025, 32%, 2026 b, 100
- quotes: build where you want, govern where you must / Forward deployed engineering is how ServiceNow and Accenture turn mutual customers' agentic AI business goals into value-generating production workloads. / This program brings together Accenture's industry depth and implementation reach with ServiceNow's AI Platform to deliver real results, not roadmaps. / real results, not roadmaps / all actions must be logged, traceable, and auditable, with enforcement of policies across environments

## evidence_seed

- company_actions: 暂无公开信息
- case_details: On May 6, 2026, at Knowledge 2026 in Las Vegas, ServiceNow and Accenture launched a Forward Deployed Engineering (FDE) program designed to do the one thing most enterprise AI initiatives still cannot: cross the pilot-to-production chasm. / The program embeds ServiceNow's AI-native engineers alongside Accenture's industry specialists directly inside mutual customers' operations, building agentic workflows on the ServiceNow AI Platform until they run in production. / Customers get access to 300+ pre-built AI agent skills and ServiceNow's AI Control Tower for governance — wrapped in a delivery model that explicitly walks away from the slide-deck-and-billable-hours playbook that has defined IT consulting for two decades.
