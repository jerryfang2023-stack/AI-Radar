...
search_path_label: ""
author: ""
published_at: "2026-07-05T07:52:17.000Z"
collected_at: 2026-07-06T02:21:26.947Z
language: mixed
full_text_hash: 60210941b5df908f
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-06/r-040-discobench-腾讯混元和清华联合推出的ai搜索智能体模糊查询基准.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-06/r-040-discobench-腾讯混元和清华联合推出的ai搜索智能体模糊查询基准.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":18771,"paragraph_count":72,"sentence_count":152,"boilerplate_hits":0,"symbol_ratio":0.0048,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"json-ld"}
has_full_text: true
content_length: 18771
fetch_error: ""
...
discovery_record: {"discovery_title":"DiscoBench：腾讯混元和清华联合推出的AI搜索智能体模糊查询基准","discovery_summary":"DiscoBench由腾讯混元与清华大学开发，测试AI搜索智能体在模糊查询时是否主动向用户澄清。基准包含211个任务、463个歧义点，涵盖四种歧义类型。测试了11个模型，无提示时端到端最高准确率仅43.1%（豆包Seed 2.0 Pro），Gemini 3.1 Pro为40.8%，Claude Opus 4.7为39.8%。但模型提出有针对性的追问时，成功率升至93.4%。识别模糊性与提问质量是两种独立技能。","source_name":"The Decoder：AI News（RSS）","origin_url":"https://the-decoder.com/ai-search-agents-dont-fail-at-searching-they-fail-at-asking-the-right-questions-when-queries-get-ambiguous","discovered_at":"2026-07-06T02:07:37.975Z","rank_on_page":112,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: e64388a07d2dddf3
content_hash: 15ff105116209978
semantic_hash: ab7a8cc0c357a722
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-07-05T07:52:17.000Z"
last_seen_at: 2026-07-06T02:21:26.947Z
...
business_elements: {"companies":["The Decoder","AI News（RSS）","Anthropic","Perplexity"],"products":["Gemini","Claude","agents","agent"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["211","463","11","43.1%","2.0","3.1","40.8%","4.7"],"quotes":["attachment_58113","aligncenter","attachment_58112","aligncenter","attachment_58111"]}
...
fact_extraction_completed_at: 2026-07-06T02:21:26.947Z
...
[caption id="attachment_58113" align="aligncenter" width="1800"] When a search agent guesses instead of clarifying ambiguities, the error cascades through the entire reasoning chain and produces a wrong final answer. | Image: Cheng et al.[/caption]
...
[caption id="attachment_58112" align="aligncenter" width="1800"] The framework checks whether the search is unambiguous at each checkpoint and evaluates agents across four metric groups, from task success to cost efficiency. | Image: Cheng et al.[/caption]
...
[caption id="attachment_58111" align="aligncenter" width="1800"] The pipeline first builds clean multi-hop questions in phase one, then injects targeted ambiguities and distinguishing clues in phase two. | Image: Cheng et al.[/caption]
...
[caption id="attachment_58110" align="aligncenter" width="1800"] More search calls don't lead to better accuracy. Claude Opus 4.7 searches frequently but still trails Gemini 3.1 Pro and Seed 2.0 Pro. | Image: Cheng et al.[/caption]
...
[caption id="attachment_58109" align="aligncenter" width="1800"] Models detect factual errors most easily, while entity and criteria ambiguities are much harder to spot. | Image: Cheng et al.[/caption]
...
AI agents need better follow-up strategies
Without access to search tools, the tested models collapse. Doubao Seed 2.0 Pro drops from 43.1 to 2.4 percent, Gemini 3.1 Pro from 40.8 to 19.9 percent. DiscoBench can't be solved from stored model knowledge alone. At the same time, models perform much better when ambiguity is removed from the questions, with accuracy jumping by 26.8 to 40.2 points depending on the model. The authors conclude that future search agents need mechanisms that turn search uncertainty into user interaction, on top of their retrieval and reasoning abilities.
Other recent work confirms that current search agents have basic weaknesses in how they research. One study fo
...
- fetch_status: fetched-readable-text-json-ld
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":18771,"paragraph_count":72,"sentence_count":152,"boilerplate_hits":0,"symbol_ratio":0.0048,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"json-ld"}
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   DiscoBench由腾讯混元与清华大学开发，测试AI搜索智能体在模糊查询时是否主动向用户澄清。基准包含211个任务、463个歧义点，涵盖四种歧义类型。测试了11个模型，无提示时端到端最高准确率仅43.1%（豆包Seed 2.0 Pro），Gemini 3.1 Pro为40.8%，Claude Opus 4.7为39.8%。但模型提出有针对性的追问时，成功率升至93.4%。识别模糊性与提问质量是两种独立技能。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   AI search agents don't fail at searching, they fail at asking the right questions when queries get ambiguous AI search agents don't fail at searching, they fail at asking the right questions when queries get ambiguous AI search agents rarely fail at multi-step research because of the search itself.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Their real problem is not asking the user for clarification when queries are ambiguous.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   A new benchmark called DiscoBench shows that models searching repeatedly instead of asking follow-up questions actually perform worse, at 51.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   9 percent, than those that just guess.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Even the best model only hits 43 percent overall accuracy.

## business_elements

- companies: The Decoder, AI News（RSS）, Anthropic, Perplexity
- products: Gemini, Claude, agents, agent
- people: 暂无公开信息
- industries: 开发者工具
- roles: 暂无公开信息
...
- numbers: 211, 463, 11, 43.1%, 2.0, 3.1, 40.8%, 4.7
- quotes: attachment_58113 / aligncenter / attachment_58112 / aligncenter / attachment_58111

## evidence_seed

- company_actions: DiscoBench由腾讯混元与清华大学开发，测试AI搜索智能体在模糊查询时是否主动向用户澄清。基准包含211个任务、463个歧义点，涵盖四种歧义类型。测试了11个模型，无提示时端到端最高准确率仅43.1%（豆包Seed 2.0 Pro），Gemini 3.1 Pro为40.8%，Claude Opus 4.7为39.8%。但模型提出有针对性的追问时，成功率升至93.4%。识别模糊性与提问质量是两种独立技能。 / AI search agents don't fail at searching, they fail at asking the right questions when queries get ambiguous AI search agents don't fail at searching, they fail at asking the right questions when queries get ambiguous AI search agents rarely fail at multi-step research because of the search itself. / Their real problem is not asking the user for clarification when queries are ambiguous.
- case_details: 暂无公开信息
