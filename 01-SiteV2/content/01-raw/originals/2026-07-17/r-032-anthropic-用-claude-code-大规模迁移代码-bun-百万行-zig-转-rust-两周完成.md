...
title_zh: "Anthropic 用 Claude Code 大规模迁移代码：Bun 百万行 Zig 转 Rust，两周完成"
title_translation_status: not_required
title_translation_method: source_title
original_url: "https://claude.com/blog/ai-code-migration"
canonical_url: "https://claude.com/blog/ai-code-migration"
...
collected_at: 2026-07-17T03:06:12.348Z
language: mixed
full_text_hash: b8ee895e2bf20e41
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-032-anthropic-用-claude-code-大规模迁移代码-bun-百万行-zig-转-rust-两周完成.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-032-anthropic-用-claude-code-大规模迁移代码-bun-百万行-zig-转-rust-两周完成.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":19276,"paragraph_count":114,"sentence_count":187,"boilerplate_hits":0,"symbol_ratio":0.0016,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 19276
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 用 Claude Code 大规模迁移代码：Bun 百万行 Zig 转 Rust，两周完成","discovery_summary":"Anthropic 工程师用 Claude Code 在两周内将 Bun 的百万行 Zig 代码迁移至 Rust，100% 现有测试通过，合并后出现 19 个回归问题已全部修复。另一工程师用周末将 Python 代码库迁移至 16.5 万行 TypeScript。迁移消耗约 16.5 万美元 API 成本，但编译时间从八分钟降至两秒，二进制启动快 6 倍。","source_name":"Claude：Blog（网页）","origin_url":"https://claude.com/blog/ai-code-migration","discovered_at":"2026-07-17T02:56:35.421Z","rank_on_page":145,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: ec3d361c5bff29f3
content_hash: b3ce469531e46997
semantic_hash: dd605e1f51c82266
duplicate_of: ""
first_seen_at: "2026-07-15T16:00:00.000Z"
last_seen_at: 2026-07-17T03:06:12.348Z
...
business_elements: {"companies":["Claude","Blog（网页）","Anthropic"],"products":["Claude","agents","Agents","agent","claude"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["100%","19","16.5 万","6 倍","10","5","4.8","165"],"quotes":["writing Bun in 1 year in a cramped Oakland apartment pre-LLM.","shakedown cruise","like a senior Rust engineer,","Fixer agents","fixer agents"]}
...
fact_extraction_completed_at: 2026-07-17T03:06:12.348Z
...
Jarred’s million-line PR. However, the migration case no longer needs to be existential. A year of memory-bug patches in the changelog, or one chronic bottleneck, can now justify it.
...
Front-load the human hours. The ruleb
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":19276,"paragraph_count":114,"sentence_count":187,"boilerplate_hits":0,"symbol_ratio":0.0016,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   In the last month, individual developers at Anthropic migrated 10 code packages consisting of tens to hundreds of thousands of lines of code using Claude Fable 5, Claude Opus 4.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Jarred Sumner, co-founder of Bun and Member of Technical Staff at Anthropic, used Claude Code to migrate Bun from Zig to Rust .

## business_elements

- companies: Claude, Blog（网页）, Anthropic
- products: Claude, agents, Agents, agent, claude
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 100%, 19, 16.5 万, 6 倍, 10, 5, 4.8, 165
- quotes: writing Bun in 1 year in a cramped Oakland apartment pre-LLM. / shakedown cruise / like a senior Rust engineer, / Fixer agents / fixer agents

## evidence_seed

- company_actions: Code migrations, projects that port a production codebase to a new language, were multi-year endeavors until recently. / In the last month, individual developers at Anthropic migrated 10 code packages consisting of tens to hundreds of thousands of lines of code using Claude Fable 5, Claude Opus 4. / In this article we’ll cover two examples along with best practices from these projects.
- case_details: 暂无公开信息
- workflow_changes: 8, and dynamic workflows .
