...
search_path_label: ""
author: ""
published_at: "2026-07-16T19:11:01.192Z"
collected_at: 2026-07-17T01:57:08.626Z
language: mixed
full_text_hash: 9012553ae8a01066
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-031-moonshot-ai-发布-perceptionbench-多模态模型视觉感知能力诊断基准.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-031-moonshot-ai-发布-perceptionbench-多模态模型视觉感知能力诊断基准.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5765,"paragraph_count":62,"sentence_count":35,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 5765
fetch_error: ""
...
discovery_record: {"discovery_title":"Moonshot AI 发布 PerceptionBench：多模态模型视觉感知能力诊断基准","discovery_summary":"Moonshot AI 发布 PerceptionBench，一个从 40 多个现有基准中模型实际失败案例归纳出的视觉感知基准，包含 10 项原子感知能力和 3000 道验证题。所有测试模型准确率均未超过 60%，且大量正确答案在重复提问时无法复现，表明模型更多是猜测而非真正感知。PerceptionBench 旨在精确诊断多模态 AI 的视觉感知断裂点，推动其实现忠实、一致的视觉理解。","source_name":"Moonshot AI：Kimi Blog","origin_url":"https://www.kimi.com/blog/perception-bench","discovered_at":"2026-07-17T01:46:58.950Z","rank_on_page":102,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: ef787933130119d2
content_hash: 9012553ae8a01066
semantic_hash: a7ebec3d57e939ad
duplicate_of: ""
first_seen_at: "2026-07-16T19:11:01.192Z"
last_seen_at: 2026-07-17T01:57:08.626Z
...
business_elements: {"companies":["Moonshot AI","Kimi Blog"],"products":["GPT-5","Claude","Gemini"],"people":[],"industries":[],"roles":["CIO / IT 负责人"],"workflows":["部署 / 集成交付"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["40","10","3000","60%","3","000","5.6","59.7"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-17T01:57:08.626Z
...
Visual Localization Which part of the mug does the purple line connect to?
Answer: side
Visual Localization What is the length of side AC?
Answer: 8
Visual Attribute How many different colors of hats appear?
Answer: 2
Visual Attribute How many red dots are there in the picture?
Answer: 10
Visual Counting How many people are there?
Answer: 8
Visual Counting How many equal subintervals is the u₁ axis divided into?
Answer: 7
Visual Relation How many staff lines does the rightmost note in the figure touch?
Answer: 2
Visual Relation How many double-headed arrows?
Answer: 3
Depth & 3D How many plates are on the table?
Answer: 3
Depth & 3D How many faces of these small cubes are in direct contact with the ground?
Answer: 4
OCR What is the blue number?
Answer: 2
OCR What is the digit in the lower-right box?
Answer: 3
Visual Comparison How many animal silhouettes in the picture are exactly the same?
Answer: 99
Visual Comparison How many arrow orientations?
Answer: 4
Fine-grained Recognition How many black queens are on the chessboard?
Answer: 2
Fine-grained Recognition How many batteries?
Answer: 2
Context Integration How many monkeys have touched the wheel cover?
Answer: 1
Context Integration Cell x lies in the intersection of how many circles?
Answer: 2
Hallucination How many yellow hollow rings appear in the figure?
Answer: 0
Hallucination How many people are inside the truck?
Answer: 0
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5765,"paragraph_count":62,"sentence_count":35,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Introducing PerceptionBench Evaluating Atomic Visual Perception in Multimodal Large Language Models Authors Kimi Team Overview We are releasing PerceptionBench , a benchmark that isolates visual perception and evaluates it as a set of atomic capabilities— discovered from how today's models fail, not defined in advance.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   By attributing frontier-model failures across 40+ benchmarks to their earliest visual cause, we distill 10 perceptual capabilities and 3,000 verified questions, each answerable by looking, with no reasoning or outside knowledge required.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The result is a sharp diagnosis rather than one more score.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   More strikingly, a large share of correct answers fail to survive a repeated ask—evidence that current models often guess rather than perceive.

## business_elements

- companies: Moonshot AI, Kimi Blog
...
- numbers: 40, 10, 3000, 60%, 3, 000, 5.6, 59.7
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Introducing PerceptionBench Evaluating Atomic Visual Perception in Multimodal Large Language Models Authors Kimi Team Overview We are releasing PerceptionBench , a benchmark that isolates visual perception and evaluates it as a set of atomic capabilities— discovered from how today's models fail, not defined in advance. / By attributing frontier-model failures across 40+ benchmarks to their earliest visual cause, we distill 10 perceptual capabilities and 3,000 verified questions, each answerable by looking, with no reasoning or outside knowledge required. / The result is a sharp diagnosis rather than one more score.
- case_details: 暂无公开信息
