...
original_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.212"
...
search_path_label: ""
author: ""
published_at: "2026-07-17T00:26:27.000Z"
collected_at: 2026-07-17T04:40:16.803Z
language: mixed
full_text_hash: ec5cb45e91ddc66f
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-006-claude-code-v2-1-212-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-006-claude-code-v2-1-212-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":7093,"paragraph_count":55,"sentence_count":14,"boilerplate_hits":2,"symbol_ratio":0.0031,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 7093
fetch_error: ""
...
discovery_record: {"discovery_title":"Claude Code v2.1.212 发布","discovery_summary":"Claude Code v2.1.212 新增 `/fork` 命令，可将当前对话复制到新后台会话中独立运行。新增会话级 WebSearch 调用上限（默认 200）和子智能体生成上限（默认 200），防止失控循环。MCP 工具调用超过 2 分钟自动移至后台，并修复了计划模式自动执行文件修改命令等多项问题。","source_name":"Claude Code：GitHub Releases（RSS）","origin_url":"https://github.com/anthropics/claude-code/releases/tag/v2.1.212","discovered_at":"2026-07-17T04:31:45.301Z","rank_on_page":75,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: a3ec5261dfb4f2cd
content_hash: ec5cb45e91ddc66f
semantic_hash: fd79bbb120bf5394
duplicate_of: ""
first_seen_at: "2026-07-17T00:26:27.000Z"
last_seen_at: 2026-07-17T04:40:16.803Z
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）","GitHub"],"products":["Claude","MCP","claude","agents","agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":[],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2.1","212","200","2","22.1","138","17","00"],"quotes":["EUNKNOWN: unknown error, uv_spawn","not a git repository","File has not been read yet","no active EnterWorktree session","ctrl+g to edit in "]}
...
fact_extraction_completed_at: 2026-07-17T04:40:16.803Z
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":7093,"paragraph_count":55,"sentence_count":14,"boilerplate_hits":2,"symbol_ratio":0.0031,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   212 Latest Latest Compare Choose a tag to compare Sorry, something went wrong.
...
- products: Claude, MCP, claude, agents, agent
- people: 暂无公开信息
...
- numbers: 2.1, 212, 200, 2, 22.1, 138, 17, 00
- quotes: EUNKNOWN: unknown error, uv_spawn / not a git repository / File has not been read yet / no active EnterWorktree session / ctrl+g to edit in 

## evidence_seed

- company_actions: Claude Code v2.1.212 新增 `/fork` 命令，可将当前对话复制到新后台会话中独立运行。新增会话级 WebSearch 调用上限（默认 200）和子智能体生成上限（默认 200），防止失控循环。MCP 工具调用超过 2 分钟自动移至后台，并修复了计划模式自动执行文件修改命令等多项问题。 / There was an error while loading. / Please reload this page .
- case_details: 暂无公开信息
