...
raw_id: R-071
title: "Hermes Agent 新增异步子代理，委托工作不再阻塞父聊天"
original_url: "https://www.marktechpost.com/2026/06/16/hermes-agent-adds-asynchronous-subagents-so-delegated-work-no-longer-blocks-the-parent-chat"
canonical_url: "https://marktechpost.com/2026/06/16/hermes-agent-adds-asynchronous-subagents-so-delegated-work-no-longer-blocks-the-parent-chat"
...
search_path_label: ""
author: ""
published_at: "2026-06-16T09:21:12.000Z"
collected_at: 2026-06-17T01:51:13.268Z
language: mixed
full_text_hash: e44ff255ebc29bae
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-17/r-071-hermes-agent-新增异步子代理-委托工作不再阻塞父聊天.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-17/r-071-hermes-agent-新增异步子代理-委托工作不再阻塞父聊天.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":43313,"paragraph_count":379,"sentence_count":89,"boilerplate_hits":0,"symbol_ratio":0.0015,"method":"article"}
has_full_text: true
content_length: 43313
fetch_error: ""
...
discovery_record: {"discovery_title":"Hermes Agent 新增异步子代理，委托工作不再阻塞父聊天","discovery_summary":"Nous Research 为开源个人代理 Hermes Agent 新增异步子代理功能。原先的 delegate_task 工具同步阻塞主聊天，现通过 async_delegation 工具集（issue #5586）实现非阻塞：delegate_task_async 立即返回 task_id，主聊天可继续操作。异步工具涵盖 spawn、check、steer、collect、cancel 和 list 全生命周期。子代理完全隔离，仅向父代理返回最终摘要，继承父代理的 API 密钥和配置。现有用户运行 hermes update 即可启用。该更新由 Nous Research 及联合创始人 Teknium 于 6 月 15 日宣布。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/16/hermes-agent-adds-asynchronous-subagents-so-delegated-work-no-longer-blocks-the-parent-chat","discovered_at":"2026-06-17T01:46:29.104Z","rank_on_page":283,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 4a1521a467d60a16
content_hash: 584a64db10cb7419
semantic_hash: 6b86da3185940d2b
duplicate_of: ""
first_seen_at: "2026-06-16T09:21:12.000Z"
last_seen_at: 2026-06-17T01:51:13.268Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Agent","Agents","agent","agents","Claude","MCP","Cursor","Gemini","Codex","GPT-5"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["5586","6","15","94","2026","4949","3","1"],"quotes":["Research topic A","toolsets","Fix the build","toolsets","terminal"]}
...
&mdash; Teknium 🪽 (@Teknium) June 15, 2026
What are Subagents
...
Michal Sutter
How to Build an Explainable AI Analysis Pipeline Using SHAP-IQ to Understand Feature Importance, Interaction Effects, and M
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":43313,"paragraph_count":379,"sentence_count":89,"boilerplate_hits":0,"symbol_ratio":0.0015,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Editors Pick Agentic AI AI Agents New Releases Software Engineering Staff Tech News Nous Research has shipped a change to Hermes Agent.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Its delegate tool can now run subagents asynchronously.

4. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Per the announcement, delegated work no longer blocks the parent chat.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Hermes Agent is an open-source personal agent from Nous Research.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   A parent agent can spawn child agents, called subagents, to fan out work.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Nvidia, Cursor, Perplexity
- products: Agent, Agents, agent, agents, Claude, MCP, Cursor, Gemini, Codex, GPT-5
- people: 暂无公开信息
...
- numbers: 5586, 6, 15, 94, 2026, 4949, 3, 1
- quotes: Research topic A / toolsets / Fix the build / toolsets / terminal

## evidence_seed

- company_actions: Nous Research 为开源个人代理 Hermes Agent 新增异步子代理功能。原先的 delegate_task 工具同步阻塞主聊天，现通过 async_delegation 工具集（issue #5586）实现非阻塞：delegate_task_async 立即返回 task_id，主聊天可继续操作。异步工具涵盖 spawn、check、steer、collect、cancel 和 list 全生命周期。子代理完全隔离，仅向父代理返回最终摘要，继承父代理的 API 密钥和配置。现有用户运行 hermes update 即可启用。该更新由 Nous Research 及联合创始人 Teknium 于 6 月 15 日宣布。 / Editors Pick Agentic AI AI Agents New Releases Software Engineering Staff Tech News Nous Research has shipped a change to Hermes Agent. / Its delegate tool can now run subagents asynchronously.
- case_details: 暂无公开信息
