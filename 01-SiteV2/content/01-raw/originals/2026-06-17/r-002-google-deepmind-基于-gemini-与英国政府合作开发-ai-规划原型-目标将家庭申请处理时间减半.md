...
original_url: "https://deepmind.google/blog/unlocking-uk-house-building-with-ai-accelerated-planning"
canonical_url: "https://deepmind.google/blog/unlocking-uk-house-building-with-ai-accelerated-planning"
...
search_path_label: ""
author: ""
published_at: "2026-06-16T21:29:50.000Z"
collected_at: 2026-06-17T01:51:13.023Z
language: mixed
full_text_hash: 12bc4b3c324ed9a9
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-17/r-002-google-deepmind-基于-gemini-与英国政府合作开发-ai-规划原型-目标将家庭申请处理时间减半.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-17/r-002-google-deepmind-基于-gemini-与英国政府合作开发-ai-规划原型-目标将家庭申请处理时间减半.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5896,"paragraph_count":36,"sentence_count":31,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
has_full_text: true
content_length: 5896
fetch_error: ""
...
discovery_record: {"discovery_title":"Google DeepMind 基于 Gemini 与英国政府合作开发 AI 规划原型，目标将家庭申请处理时间减半","discovery_summary":"Google DeepMind 与英国政府合作，基于 Gemini 构建 AI 规划原型，旨在将家庭规划申请处理时间减半。该工具可整合数据、识别本地政策、总结公众反馈并起草评估报告，但规划官员保留最终决策权。原型已在 Barnet、Camden 和 Dorset 试点，计划 2027 年向全英议会开放。此前推出的 Extract 工具（同样基于 Gemini）已向英格兰所有议会开放，能将非结构化 PDF 转为可用数据，预计为每个议会每年节省约 255 小时人工。家庭规划申请占每年规划申请的近 70%，AI 工具旨在让官员聚焦更复杂的公共利益申请。","source_name":"Google DeepMind：Blog（RSS）","origin_url":"https://deepmind.google/blog/unlocking-uk-house-building-with-ai-accelerated-planning","discovered_at":"2026-06-17T01:46:29.068Z","rank_on_page":92,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 212a353b8729f563
content_hash: 12bc4b3c324ed9a9
semantic_hash: 4de3d29d6b0e06f2
duplicate_of: ""
first_seen_at: "2026-06-16T21:29:50.000Z"
last_seen_at: 2026-06-17T01:51:13.023Z
...
business_elements: {"companies":["Google DeepMind","Blog（RSS）","Google"],"products":["Gemini"],"people":[],"industries":[],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["2027","255","70%","16","2026","1.5 million","2029","50%"],"quotes":[]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5896,"paragraph_count":36,"sentence_count":31,"boilerplate_hits":0,"symbol_ratio":0,"method":"main"}
...
2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   June 16, 2026 Responsibility & Safety Unlocking UK house-building with AI-accelerated planning Owen Larter and David Thacker Share New UK government AI planning prototype built with Gemini aims to halve the time it takes to process homeowner applications Around the world, Governments are exploring how AI can deliver better public services, faster.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The UK is working to build 1.

4. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   5 million new homes by 2029, but local planning authorities are often slowed down by dense paperwork and administrative backlogs.
...
6. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   Our goal is to help officers cut application decision times by 50%, freeing up time for planners so that more homes can be built.
...
- numbers: 2027, 255, 70%, 16, 2026, 1.5 million, 2029, 50%
- quotes: 暂无公开信息

## evidence_seed

- company_actions: The UK is working to build 1.
- case_details: 暂无公开信息
- workflow_changes: June 16, 2026 Responsibility & Safety Unlocking UK house-building with AI-accelerated planning Owen Larter and David Thacker Share New UK government AI planning prototype built with Gemini aims to halve the time it takes to process homeowner applications Around the world, Governments are exploring how AI can deliver better public services, faster. / To help get Britain building, we’re partnering with the UK government to help radically shorten the time it takes to process householder planning applications.
