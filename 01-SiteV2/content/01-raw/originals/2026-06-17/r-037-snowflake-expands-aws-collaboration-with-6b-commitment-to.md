...
raw_id: R-037
title: "Snowflake Expands AWS Collaboration with $6B Commitment to ..."
original_url: "https://press.aboutamazon.com/2026/5/snowflake-expands-aws-collaboration-with-6b-commitment-to-accelerate-enterprise-agentic-ai-adoption"
canonical_url: "https://press.aboutamazon.com/2026/5/snowflake-expands-aws-collaboration-with-6b-commitment-to-accelerate-enterprise-agentic-ai-adoption"
...
author: ""
published_at: ""
collected_at: 2026-06-17T01:51:13.148Z
language: mixed
full_text_hash: ec9f17c3c0699ebc
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-17/r-037-snowflake-expands-aws-collaboration-with-6b-commitment-to.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-17/r-037-snowflake-expands-aws-collaboration-with-6b-commitment-to.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7739,"paragraph_count":26,"sentence_count":31,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 7739
fetch_error: ""
...
url_hash: 55855b27297b7134
content_hash: ec9f17c3c0699ebc
semantic_hash: 91a3ecab5eda982f
duplicate_of: ""
first_seen_at: "2026-06-17T01:51:13.148Z"
last_seen_at: 2026-06-17T01:51:13.148Z
...
business_elements: {"companies":["keyword search","Anysearch","Amazon","AWS"],"products":["agents","agent"],"people":[],"industries":["企业服务"],"roles":["CIO / IT 负责人","采购负责人","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","采购","销售 / 客服"],"numbers":["$6B","27","2026","$7 billion","$6 billion","2","$2 billion","2025"],"quotes":["AI has generated enormous excitement, but for enterprises, the real challenge and opportunity is turning intelligence into action,","Enterprises are rapidly moving from experimenting with AI to putting intelligent agents to work that drive real business outcomes,","AI is deeply embedded in how Fetch builds and operates every day, and our work with Snowflake and AWS is strengthening that foundation,","Snowflake on AWS is the foundation that many of our customers rely on to move fast with data,","Risk Factors"]}
...
# Snowflake Expands AWS Collaboration with $6B Commitment to ...

## clean_text

Snowflake Expands AWS Collaboration with $6B Commitment to Accelerate Enterprise Agentic AI Adoption - US Press Center
May 27, 2026
Snowflake Expands AWS Collaboration with $6B Commitment to Accelerate Enterprise Agentic AI Adoption
The collaboration brings generative and agentic AI capabilities directly to enterprise data to helpjoint customers build and deploy AI-powered applications faster and more securely
Multi-year strategic agreement expands joint investments in customer success, workload migrations, and go-to-market, asSnowflake surpasses $7 billion in lifetime AWS Marketplace sales
...
Customers like Fetch and Hexare deploying AI applications on governed data with Snowflake on AWS
MENLO PARK, Calif. — May 27, 2026 — Snowflake (NYSE: SNOW), the AI Data Cloud company, today announced that it has signed a multi-year strategic collaboration agreement (SCA) with Amazon Web Services (AWS) to accelerate enterprise agentic AI adoption to help joint customers worldwide build and deploy AI faster and more securely. As part of the expanded collaboration, Snowflake is making a $6 billion multi-year infrastructure commitment to AWS, its largest to date, reflecting the accelerating enterprise demand for AI and data workloads running on AWS.
...
Media Contact
Courtney Sbrocca
Corporate PR Specialist, Snowflake
press@snowflake.com
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7739,"paragraph_count":26,"sentence_count":31,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
1. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Enterprises are rapidly adopting these capabilities to run AI on trusted, governed data without moving it outside their secure perimeter. / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=procurement_marketplace

2. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   Snowflake Expands AWS Collaboration with $6B Commitment to Accelerate Enterprise Agentic AI Adoption - US Press Center May 27, 2026 Snowflake Expands AWS Collaboration with $6B Commitment to Accelerate Enterprise Agentic AI Adoption The collaboration brings generative and agentic AI capabilities directly to enterprise data to helpjoint customers build and deploy AI-powered applications faster and more securely Multi-year strategic agreement expands joint investments in customer success, workload migrations, and go-

3. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   — May 27, 2026 — Snowflake (NYSE: SNOW), the AI Data Cloud company, today announced that it has signed a multi-year strategic collaboration agreement (SCA) with Amazon Web Services (AWS) to accelerate enterprise agentic AI adoption to help joint customers worldwide build and deploy AI faster and more securely.

4. **number**｜supports=daily_observation, heatmap, case, trend｜importance=high｜confidence=high
   As part of the expanded collaboration, Snowflake is making a $6 billion multi-year infrastructure commitment to AWS, its largest to date, reflecting the accelerating enterprise demand for AI and data workloads running on AWS.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Snowflake was founded on AWS eleven years ago, and that foundation has grown into one of enterprise software's broadest and deepest collaborations.

6. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   The majority of Snowflake's customers run on AWS today, with AWS recognizing Snowflake as a leading partner driving global customer adoption.
...
- numbers: $6B, 27, 2026, $7 billion, $6 billion, 2, $2 billion, 2025
- quotes: AI has generated enormous excitement, but for enterprises, the real challenge and opportunity is turning intelligence into action, / Enterprises are rapidly moving from experimenting with AI to putting intelligent agents to work that drive real business outcomes, / AI is deeply embedded in how Fetch builds and operates every day, and our work with Snowflake and AWS is strengthening that foundation, / Snowflake on AWS is the foundation that many of our customers rely on to move fast with data, / Risk Factors

## evidence_seed

- company_actions: Snowflake was founded on AWS eleven years ago, and that foundation has grown into one of enterprise software's broadest and deepest collaborations.
- case_details: — May 27, 2026 — Snowflake (NYSE: SNOW), the AI Data Cloud company, today announced that it has signed a multi-year strategic collaboration agreement (SCA) with Amazon Web Services (AWS) to accelerate enterprise agentic AI adoption to help joint customers worldwide build and deploy AI faster and more securely. / The majority of Snowflake's customers run on AWS today, with AWS recognizing Snowflake as a leading partner driving global customer adoption.
- workflow_changes: Enterprises are rapidly adopting these capabilities to run AI on trusted, governed data without moving it outside their secure perimeter. / query=model release inference cost reduction enterprise adoption / intent=find_original_source / path=procurement_marketplace
