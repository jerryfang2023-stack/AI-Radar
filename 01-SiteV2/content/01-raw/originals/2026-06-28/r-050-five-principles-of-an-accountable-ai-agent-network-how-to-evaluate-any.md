...
original_url: "https://www.tigera.io/blog/five-principles-of-an-accountable-ai-agent-network-how-to-evaluate-any-governance-platform/"
canonical_url: "https://tigera.io/blog/five-principles-of-an-accountable-ai-agent-network-how-to-evaluate-any-governance-platform"
...
author: ""
published_at: ""
collected_at: 2026-06-28T04:05:28.181Z
language: mixed
full_text_hash: 8c856c3218db431e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-050-five-principles-of-an-accountable-ai-agent-network-how-to-evaluate-any.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-050-five-principles-of-an-accountable-ai-agent-network-how-to-evaluate-any.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":10223,"paragraph_count":77,"sentence_count":96,"boilerplate_hits":0,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
...
url_hash: 57cca3f93466f484
content_hash: 8c856c3218db431e
semantic_hash: 136daff257a4f92a
duplicate_of: ""
first_seen_at: "2026-06-28T04:05:28.181Z"
last_seen_at: 2026-06-28T04:05:28.181Z
...
business_elements: {"companies":["Tigera Blog (Calico","AI Security)"],"products":["Agent","agent","MCP","agents","Agents"],"people":[],"industries":["金融 / 保险","开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["8217","2","1","3","10","000","4","5"],"quotes":["Agent-Finance-v2 can call Agent-Compliance-v3, ","Agents with capability=financial-analysis can call agents with capability=compliance-query."]}
...
title_zh: "可问责AI智能体网络的五项原则：如何评估任何治理平台"
...
What it enables
Default-deny
Provenance; every allowed interaction was explicitly authorized
Attribute-based policy
Governance at scale; authorization grows with the network
Zero-trust identity
Trust in audit records; every participant is verified
Audit by design
Traceability and compliance; every decision is recorded
Kubernetes-native
Adoption; the platform integrates with existing infrastructure
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":10223,"paragraph_count":77,"sentence_count":96,"boilerplate_hits":0,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   The first post in this series argued that AI agent governance hasn&#8217;t kept pace with deployment. The second laid out the five pillars of accountability, and what is required. The third walked through why network... The post Five Principles of an Accountable AI Agent Network: How to Evaluate Any Governance Platform appeared first on Tigera – Creator of Calico. ]]>

2. **funding**｜supports=daily_observation, heatmap, trend｜importance=high｜confidence=high
   The first post in this series argued that AI agent governance hasn’t kept pace with deployment.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   The second laid out the five pillars of accountability, and what is required.

4. **supporting_context**｜supports=daily_observation, heatmap｜importance=medium｜confidence=high
   The third walked through why network policies, API gateways, MCP/A2A protocols, DIY security patterns, and Role-based Access Control (RBAC) each leave critical accountability gaps.
...
6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   The five pillars define what AI agent accountability requires.

## business_elements

- companies: Tigera Blog (Calico, AI Security)
- products: Agent, agent, MCP, agents, Agents
- people: 暂无公开信息
...
- numbers: 8217, 2, 1, 3, 10, 000, 4, 5
- quotes: Agent-Finance-v2 can call Agent-Compliance-v3,  / Agents with capability=financial-analysis can call agents with capability=compliance-query.

## evidence_seed

- company_actions: The first post in this series argued that AI agent governance hasn&#8217;t kept pace with deployment. The second laid out the five pillars of accountability, and what is required. The third walked through why network... The post Five Principles of an Accountable AI Agent Network: How to Evaluate Any Governance Platform appeared first on Tigera – Creator of Calico. ]]> / The first post in this series argued that AI agent governance hasn’t kept pace with deployment. / The second laid out the five pillars of accountability, and what is required.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。
- affected_roles: 开发者 / 工程团队
- risks_or_constraints: The third walked through why network policies, API gateways, MCP/A2A protocols, DIY security patterns, and Role-based Access Control (RBAC) each leave critical accountability gaps.
