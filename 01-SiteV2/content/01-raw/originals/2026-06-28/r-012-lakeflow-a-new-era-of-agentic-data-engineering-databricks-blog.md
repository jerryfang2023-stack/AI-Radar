...
raw_id: R-012
title: "Lakeflow: A new era of agentic data engineering | Databricks Blog"
original_url: "https://www.databricks.com/blog/lakeflow-new-era-agentic-data-engineering"
canonical_url: "https://databricks.com/blog/lakeflow-new-era-agentic-data-engineering"
...
author: ""
published_at: ""
collected_at: 2026-06-28T04:05:27.955Z
language: mixed
full_text_hash: cf3270d1a773e450
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-012-lakeflow-a-new-era-of-agentic-data-engineering-databricks-blog.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-012-lakeflow-a-new-era-of-agentic-data-engineering-databricks-blog.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":11434,"paragraph_count":42,"sentence_count":74,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
...
url_hash: 929f065d9f6db768
content_hash: cf3270d1a773e450
semantic_hash: 610ca8cfa841ae5b
duplicate_of: ""
first_seen_at: "2026-06-28T04:05:27.955Z"
last_seen_at: 2026-06-28T04:05:27.955Z
...
business_elements: {"companies":["keyword search","Anysearch","Google","GitHub","Meta"],"products":["agents","agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["100","50%","100 million","5","100M","10","5 m","50"],"quotes":["enterprise memory","We cut our end-to-end pipeline latency to under a minute with Zerobus Ingest and Spark Declarative Pipelines, enabling faster time to value.","With Lakeflow Jobs, we were able to tap into data that legacy technologies could not access, empowering us to generate deeper, more reliable business insights."]}
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":11434,"paragraph_count":42,"sentence_count":74,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   why we set out to ... to transformation and orchestration ... the agentic era, this unified architecture offers significant advantages, enabling agents not only to build ... . Today, at the Data + AI Summit ... Today, we’re announcing that Lakeflow Connect is expanding to support more than 100 nativ... / query=enterprise AI transformation workflow change customer case / intent=find_customer_case / path=official_original

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   All analytics, AI, and applications start with data.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Over the past few decades, data engineering tools have proliferated across a range of use cases and user personas.

4. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   The result is that most enterprises end up with a very complex and fragmented data stack that is hard to integrate, maintain, or govern.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   With AI powering all data and AI practitioners, even more pressure will be placed on these brittle data stacks.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   This is why we set out to build Databricks Lakeflow , a unified platform for all of data engineering from ingestion, to transformation and orchestration.

## business_elements

- companies: keyword search, Anysearch, Google, GitHub, Meta
...
- numbers: 100, 50%, 100 million, 5, 100M, 10, 5 m, 50
- quotes: enterprise memory / We cut our end-to-end pipeline latency to under a minute with Zerobus Ingest and Spark Declarative Pipelines, enabling faster time to value. / With Lakeflow Jobs, we were able to tap into data that legacy technologies could not access, empowering us to generate deeper, more reliable business insights.

## evidence_seed

- company_actions: All analytics, AI, and applications start with data. / Over the past few decades, data engineering tools have proliferated across a range of use cases and user personas. / The result is that most enterprises end up with a very complex and fragmented data stack that is hard to integrate, maintain, or govern.
- case_details: why we set out to ... to transformation and orchestration ... the agentic era, this unified architecture offers significant advantages, enabling agents not only to build ... . Today, at the Data + AI Summit ... Today, we’re announcing that Lakeflow Connect is expanding to support more than 100 nativ... / query=enterprise AI transformation workflow change customer case / intent=find_customer_case / path=official_original
