...
original_url: "https://www.tigera.io/blog/whats-new-in-calico-spring-2026-release/"
canonical_url: "https://tigera.io/blog/whats-new-in-calico-spring-2026-release"
...
author: ""
published_at: ""
collected_at: 2026-06-28T04:05:28.187Z
language: mixed
full_text_hash: 14151439102458c2
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-051-what-8217-s-new-in-calico-spring-2026-release.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-051-what-8217-s-new-in-calico-spring-2026-release.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":82,"text_length":24088,"paragraph_count":125,"sentence_count":158,"boilerplate_hits":5,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 24088
fetch_error: ""
...
url_hash: b276d2a84da3eb86
content_hash: 5821793ce2652337
semantic_hash: 1fb6c435328fcd41
duplicate_of: ""
first_seen_at: "2026-06-28T04:05:28.187Z"
last_seen_at: 2026-06-28T04:05:28.187Z
...
business_elements: {"companies":["Tigera Blog (Calico","AI Security)"],"products":["agents"],"people":[],"industries":["开发者工具","企业服务"],"roles":["开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["8217","2026","2014","2","3.32","7","3.22","1 b"],"quotes":["Last Evaluated"]}
...
Documentation Link
Calico Open Source
Upgrade to Calico v3.32
Calico Open Source release notes
Calico Enterprise
Upgrade to Enterprise v3.23 EP2
Upgrade Calico Enterprise documentation
Calico Cloud
Follow instructions to update connected clusters
Upgrade Calico Cloud instructions
To learn more about these new product capabilities and see them in action, schedule a demo .
Open Source Products Release
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":82,"text_length":24088,"paragraph_count":125,"sentence_count":158,"boilerplate_hits":5,"symbol_ratio":0.0001,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **product_update**｜supports=daily_observation, heatmap, change｜importance=medium｜confidence=high
   Kubernetes has come a long way since its debut in 2014. It’s gone from running a couple of containerized microservices to orchestrating fleets of production workloads spanning everything from AI agents to full scale VMs... The post What&#8217;s new in Calico: Spring 2026 Release appeared first on Tigera – Creator of Calico. ]]>

2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Kubernetes has come a long way since its debut in 2014.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   It’s gone from running a couple of containerized microservices to orchestrating fleets of production workloads spanning everything from AI agents to full scale VMs running in pods.

4. **supporting_context**｜supports=daily_observation, heatmap｜importance=medium｜confidence=high
   As Kubernetes adoption grows, and its use cases stretch to cover more ground, managing its increasingly complex networking and security landscape demands operational maturity and a platform that supports it.

5. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The Spring 2026 release of Calico provides that support in two key areas: Unified operations across Kubernetes pods and VMs KubeVirt Live Migration in Bridge Mode allows you to migrate VM workloads with IPs preserved, minimal packet loss, and fast route convergence.

6. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   VMs can move between nodes for planned maintenance, load balancing and to support high availability without interrupting network connectivity.
...
- numbers: 8217, 2026, 2014, 2, 3.32, 7, 3.22, 1 b
- quotes: Last Evaluated

## evidence_seed

- company_actions: Kubernetes has come a long way since its debut in 2014. It’s gone from running a couple of containerized microservices to orchestrating fleets of production workloads spanning everything from AI agents to full scale VMs... The post What&#8217;s new in Calico: Spring 2026 Release appeared first on Tigera – Creator of Calico. ]]> / Kubernetes has come a long way since its debut in 2014. / It’s gone from running a couple of containerized microservices to orchestrating fleets of production workloads spanning everything from AI agents to full scale VMs running in pods.
- case_details: 暂无公开信息
- workflow_changes: The Spring 2026 release of Calico provides that support in two key areas: Unified operations across Kubernetes pods and VMs KubeVirt Live Migration in Bridge Mode allows you to migrate VM workloads with IPs preserved, minimal packet loss, and fast route convergence. / VMs can move between nodes for planned maintenance, load balancing and to support high availability without interrupting network connectivity.
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: 开发者 / 工程团队
- risks_or_constraints: As Kubernetes adoption grows, and its use cases stretch to cover more ground, managing its increasingly complex networking and security landscape demands operational maturity and a platform that supports it.
