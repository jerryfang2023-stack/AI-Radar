...
original_url: "https://eugeneyan.com//writing/qa-evals/"
canonical_url: "https://eugeneyan.com/writing/qa-evals"
...
author: ""
published_at: ""
collected_at: 2026-06-28T04:05:28.081Z
language: mixed
full_text_hash: 6955b100ca5ed40e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-038-evaluating-long-context-question-amp-answer-systems.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-28/r-038-evaluating-long-context-question-amp-answer-systems.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":40676,"paragraph_count":186,"sentence_count":353,"boilerplate_hits":0,"symbol_ratio":0.0005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 40676
fetch_error: ""
...
url_hash: 3589442d1fb6e5b6
content_hash: 3a4b482adb87b3aa
semantic_hash: 1e9d7bf59d504539
duplicate_of: ""
first_seen_at: "2026-06-28T04:05:28.081Z"
last_seen_at: 2026-06-28T04:05:28.081Z
...
business_elements: {"companies":["Eugene Yan's Blog"],"products":[],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","开发者工具"],"roles":["开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":[],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["35%","2023","4.2","2.1","7","203","2","1"],"quotes":["lost in the middle","AI Evals for Engineers and PMs","I don’t know.","I don’t have that information in the provided text.","What happens if the tenant misses a payment?"]}
...
Reference-based comparison works well when we have high-quality reference answers. The LLM-evaluator compares generated answers against these references to assess relevance, detail, and clarity. However, as models improve, their answers may surpass existing references, making this
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":40676,"paragraph_count":186,"sentence_count":353,"boilerplate_hits":0,"symbol_ratio":0.0005,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   While evaluating Q&A systems is straightforward with short paragraphs, complexity increases as documents grow larger.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   For example, technical documentation, novels and movies, as well as multi-document scenarios.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Although some of these evaluation challenges also appear in shorter contexts, long-context evaluation amplifies issues such as: Information overload: Irrelevant details in large documents obscure relevant facts, making it harder for retrievers and models to locate the right evidence for the answer.
...
- numbers: 35%, 2023, 4.2, 2.1, 7, 203, 2, 1
- quotes: lost in the middle / AI Evals for Engineers and PMs / I don’t know. / I don’t have that information in the provided text. / What happens if the tenant misses a payment?

## evidence_seed

- company_actions: Evaluation metrics, how to build eval datasets, eval methodology, and a review of several benchmarks. / While evaluating Q&A systems is straightforward with short paragraphs, complexity increases as documents grow larger. / For example, technical documentation, novels and movies, as well as multi-document scenarios.
- case_details: 暂无公开信息
