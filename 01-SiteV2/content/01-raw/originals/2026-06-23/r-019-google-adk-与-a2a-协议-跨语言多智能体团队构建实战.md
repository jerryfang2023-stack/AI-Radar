...
original_url: "https://developers.googleblog.com/build-cross-language-multi-agent-team-with-google-agent-development-kit-and-a2a"
canonical_url: "https://developers.googleblog.com/build-cross-language-multi-agent-team-with-google-agent-development-kit-and-a2a"
...
search_path_label: ""
author: ""
published_at: "2026-06-22T17:08:43.358Z"
collected_at: 2026-06-23T02:03:46.484Z
language: mixed
full_text_hash: e8bd4cb60aa6227d
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-019-google-adk-与-a2a-协议-跨语言多智能体团队构建实战.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-019-google-adk-与-a2a-协议-跨语言多智能体团队构建实战.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":13188,"paragraph_count":122,"sentence_count":75,"boilerplate_hits":0,"symbol_ratio":0.0083,"method":"content-container"}
has_full_text: true
content_length: 13188
fetch_error: ""
...
discovery_record: {"discovery_title":"Google ADK 与 A2A 协议：跨语言多智能体团队构建实战","discovery_summary":"一篇技术博客展示了如何用 Google Agent Development Kit （ADK） 与 Agent2Agent （A2A） 协议搭建跨语言多智能体流水线：Python agent 调用 Gemini 解析合同条款，Go agent 用纯确定性逻辑校验合规性。A2A 协议通过 Agent Card 实现能力发现、JSON-RPC 2.0 完成通信、Task 状态机管理任务生命周期；ADK 的 RemoteA2aAgent 抽象可将任意 A2A 兼容服务封装成本地子智能体。文中强调将单体提示词分解为专业化微智能体，以解决上下文退化、故障爆炸半径和不可测试性问题。完整源码已在 GitHub 发布。","source_name":"Google Developers Blog（RSS）","origin_url":"https://developers.googleblog.com/build-cross-language-multi-agent-team-with-google-agent-development-kit-and-a2a","discovered_at":"2026-06-23T01:57:11.606Z","rank_on_page":114,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f1984f4f8867d6a1
content_hash: e8bd4cb60aa6227d
semantic_hash: 295e86b252fa1fcc
duplicate_of: ""
first_seen_at: "2026-06-22T17:08:43.358Z"
last_seen_at: 2026-06-23T02:03:46.484Z
...
business_elements: {"companies":["Google Developers Blog（RSS）","Google","GitHub"],"products":["Agent","agent","Gemini","agents","Agents","gemini"],"people":[],"industries":["法律 / 法务","金融 / 保险","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["2","2.0","22","2026","10","15","50","48"],"quotes":["AGENT_URL"," {\nagentURL = ","\nreturn AgentCard{\nName: ",",\nDescription: ",",\nVersion: "]}
...
title_zh: "Google ADK 与 A2A 协议：跨语言多智能体团队构建实战"
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":13188,"paragraph_count":122,"sentence_count":75,"boilerplate_hits":0,"symbol_ratio":0.0083,"method":"content-container"}
...
2. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   Build Cross-Language Multi-Agent Team with Google’s Agent Development Kit and A2A JUNE 22, 2026 Shubham Saboo Senior AI Product Manager Eric Dong Developer Relations Engineer Share Facebook Twitter LinkedIn Mail How a Python agent and a Go agent collaborate on contract compliance using the Agent2Agent protocol Your contract compliance pipeline has a problem.
...
5. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   The security engineering team built a blazing-fast compliance validator in Go, using all deterministic logic and no LLM.
...
- products: Agent, agent, Gemini, agents, Agents, gemini
- people: 暂无公开信息
...
- numbers: 2, 2.0, 22, 2026, 10, 15, 50, 48
- quotes: AGENT_URL /  {
agentURL =  / 
return AgentCard{
Name:  / ,
...
- company_actions: The data science team wrote a brilliant extraction agent in Python. / It uses Gemini to parse legal contracts and pull out every key term. / Both work perfectly in isolation.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队, 法务 / 律师
- risks_or_constraints: 一篇技术博客展示了如何用 Google Agent Development Kit （ADK） 与 Agent2Agent （A2A） 协议搭建跨语言多智能体流水线：Python agent 调用 Gemini 解析合同条款，Go agent 用纯确定性逻辑校验合规性。A2A 协议通过 Agent Card 实现能力发现、JSON-RPC 2.0 完成通信、Task 状态机管理任务生命周期；ADK 的 RemoteA2aAgent 抽象可将任意 A2A 兼容服务封装成本地子智能体。文中强调将单体提示词分解为专业化微智能体，以解决上下文退化、故障爆炸半径和不可测试性问题。完整源码已在 GitHub 发布。 / Build Cross-Language Multi-Agent Team with Google’s Agent Development Kit and A2A JUNE 22, 2026 Shubham Saboo Senior AI Product Manager Eric Dong Developer Relations Engineer Share Facebook Twitter LinkedIn Mail How a Python agent and a Go agent collaborate on contract compliance using the Agent2Agent protocol Your contract compliance pipeline has a problem. / The security engineering team built a blazing-fast compliance validator in Go, using all deterministic logic and no LLM.
