...
raw_id: R-120
title: "Claude Code创建者Boris Cherny：AI智能体循环（loops）真实且重要"
original_url: "https://techcrunch.com/2026/06/22/the-ai-world-is-getting-loopy"
canonical_url: "https://techcrunch.com/2026/06/22/the-ai-world-is-getting-loopy"
...
search_path_label: ""
author: ""
published_at: "2026-06-22T20:53:11.000Z"
collected_at: 2026-06-23T02:03:46.758Z
language: mixed
full_text_hash: 5e87eeb313922ac5
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-120-claude-code创建者boris-cherny-ai智能体循环-loops-真实且重要.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-120-claude-code创建者boris-cherny-ai智能体循环-loops-真实且重要.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":5372,"paragraph_count":29,"sentence_count":36,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 5372
fetch_error: ""
...
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"5e87eeb313922ac5","missing":[]}
...
discovery_record: {"discovery_title":"Claude Code创建者Boris Cherny：AI智能体循环（loops）真实且重要","discovery_summary":"Claude Code创建者Boris Cherny在Meta @Scale大会上表示，AI智能体循环（loops）是真实且重要的趋势。他描述自己工作中一个agent持续改进代码架构，另一个寻找重复抽象并提交PR，循环永不停歇。这种循环类似递归函数，由子agent决定何时停止；一种实现是Ralph Loop，检查已完成工作是否达成目标。Loops本质是增加test-time compute，通过持续投入计算资源直到任务完成，但token消耗无上限、成本高昂。若设置得当，收益可能远超成本。","source_name":"TechCrunch：AI（RSS）","origin_url":"https://techcrunch.com/2026/06/22/the-ai-world-is-getting-loopy","discovered_at":"2026-06-23T01:57:11.594Z","rank_on_page":68,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: 9f76c835bed222ee
content_hash: 5e87eeb313922ac5
semantic_hash: f1195c3bd2617291
duplicate_of: "merged 1 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-06-22T20:53:11.000Z"
last_seen_at: 2026-06-23T02:03:46.758Z
...
business_elements: {"companies":["TechCrunch","AI（RSS）","OpenAI","Anthropic","Meta","Cursor"],"products":["Claude","agent","agents","Cursor"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["合同审阅 / 法律研究","计费 / 预算管理"],"business_actions":[],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["1","53","22","2026","32","00 m","2012","412"],"quotes":["Are loops the next hype cycle,","or are they for real?","Yes, they’re for real.","As big as the step from source code to agents was, loops are just as important and as big a step.","brand-new team"]}
evidence_seed: {"company_actions":["Image Credits: YouTube (screenshot) AI The AI world is getting ‘loopy’ Russell Brandom 1:53 PM PDT · June 22, 2026 On Friday, Claude Code creator Boris Cherny made an appearance at Meta’s @Scale conference and, surprisingly, the first question from the audience was about loops.","” Cherny’s answer was an emphatic, “Yes, they’re for real.","” “Two years ago, we wrote source code by hand."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":[],"risks_or_constraints":[]}
missing_information: ["证据对象不可用：疑似索引页、目录页、薄文本或非可用证据对象","没有检测到明确动作词；可作为诊断信息，不能单独阻断重要观点、文章或技术趋势","没有具体客户或真实企业案例"]
key_excerpts: [{"type":"opinion","text":"Claude Code创建者Boris Cherny在Meta @Scale大会上表示，AI智能体循环（loops）是真实且重要的趋势。他描述自己工作中一个agent持续改进代码架构，另一个寻找重复抽象并提交PR，循环永不停歇。这种循环类似递归函数，由子agent决定何时停止；一种实现是Ralph Loop，检查已完成工作是否达成目标。Loops本质是增加test-time compute，通过持续投入计算资源直到任务完成，但token消耗无上限、成本高昂。若设置得当，收益可能远超成本。","supports":["daily_observation","heatmap","viewpoint"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"Image Credits: YouTube (screenshot) AI The AI world is getting ‘loopy’ Russell Brandom 1:53 PM PDT · June 22, 2026 On Friday, Claude Code creator Boris Cherny made an appearance at Meta’s @Scale conference and, surprisingly, the first question from the audience was about loops.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"quote","text":"“Are loops the next hype cycle,” the questioner asked, “or are they for real?","supports":["daily_observation","heatmap","viewpoint"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"” Cherny’s answer was an emphatic, “Yes, they’re for real.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"” “Two years ago, we wrote source code by hand.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"We started to transition so agents write the code.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":5372,"paragraph_count":29,"sentence_count":36,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Image Credits: YouTube (screenshot) AI The AI world is getting ‘loopy’ Russell Brandom 1:53 PM PDT · June 22, 2026 On Friday, Claude Code creator Boris Cherny made an appearance at Meta’s @Scale conference and, surprisingly, the first question from the audience was about loops.
...
- companies: TechCrunch, AI（RSS）, OpenAI, Anthropic, Meta, Cursor
- products: Claude, agent, agents, Cursor
- people: 暂无公开信息
- industries: 开发者工具
- roles: 暂无公开信息
...
- numbers: 1, 53, 22, 2026, 32, 00 m, 2012, 412
- quotes: Are loops the next hype cycle, / or are they for real? / Yes, they’re for real. / As big as the step from source code to agents was, loops are just as important and as big a step. / brand-new team

## evidence_seed

- company_actions: Image Credits: YouTube (screenshot) AI The AI world is getting ‘loopy’ Russell Brandom 1:53 PM PDT · June 22, 2026 On Friday, Claude Code creator Boris Cherny made an appearance at Meta’s @Scale conference and, surprisingly, the first question from the audience was about loops. / ” Cherny’s answer was an emphatic, “Yes, they’re for real. / ” “Two years ago, we wrote source code by hand.
- case_details: 暂无公开信息
