...
original_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.186"
canonical_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.186"
...
search_path_label: ""
author: ""
published_at: "2026-06-22T20:37:34.000Z"
collected_at: 2026-06-23T02:03:46.436Z
language: mixed
full_text_hash: 98b19e7d81ee955c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-005-claude-code-v2-1-186-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-005-claude-code-v2-1-186-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":4058,"paragraph_count":39,"sentence_count":9,"boilerplate_hits":2,"symbol_ratio":0.0047,"method":"main"}
has_full_text: true
content_length: 4058
fetch_error: ""
...
discovery_record: {"discovery_title":"Claude Code v2.1.186 发布","discovery_summary":"新增 `claude mcp login/logout` 命令，支持从 CLI 认证 MCP 服务器并完成 SSH 无浏览器重定向。新增 `/workflows` 状态过滤、`/plugin` Skills 部分及 `teammateMode： \"iterm2\"` 设置。`！` bash 命令改为自动触发 Claude 响应，可通过 `respondToBashCommands` 恢复原行为。修复了机器唤醒后流请求失败、子 agent 滚动错位、后台预览闪烁、Chrome 标签组隔离、重复会话摘要、权限提示编号错位等问题。改进了服务器名输入提示和记忆压缩提醒。`CLAUDE_CODE_MAX_RETRIES` 上限改为 15；后台子 agent 权限提示改为主会话显示并支持 Esc 拒绝。","source_name":"Claude Code：GitHub Releases（RSS）","origin_url":"https://github.com/anthropics/claude-code/releases/tag/v2.1.186","discovered_at":"2026-06-23T01:57:11.595Z","rank_on_page":71,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f672838de330e86f
content_hash: 98b19e7d81ee955c
semantic_hash: e4771aba97f5e82b
duplicate_of: ""
first_seen_at: "2026-06-22T20:37:34.000Z"
last_seen_at: 2026-06-23T02:03:46.436Z
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）","AWS"],"products":["Claude","claude","mcp","MCP","agent","agents","Agent"],"people":[],"industries":["开发者工具","企业服务"],"roles":[],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["2.1","186","2","15","21.6","134","22","20"],"quotes":[" section to the /plugin Installed tab\nAdded teammateMode: "," setting with a warning when auto mode cannot find the it2 CLI\nAdded "," option to /login when awsAuthRefresh is configured\n! bash commands now trigger Claude to respond to the output automatically; set ",": false in settings.json to keep the previous context-only behavior\nFixed streaming requests failing with ","MCP server disconnected"]}
...
title_zh: "Claude Code v2.1.186 发布"
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":4058,"paragraph_count":39,"sentence_count":9,"boilerplate_hits":2,"symbol_ratio":0.0047,"method":"main"}
...
3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   186 Latest Latest Compare Choose a tag to compare Sorry, something went wrong.
...
- companies: Claude Code, GitHub Releases（RSS）, AWS
- products: Claude, claude, mcp, MCP, agent, agents, Agent
- people: 暂无公开信息
...
- numbers: 2.1, 186, 2, 15, 21.6, 134, 22, 20
- quotes:  section to the /plugin Installed tab
Added teammateMode:  /  setting with a warning when auto mode cannot find the it2 CLI
Added  /  option to /login when awsAuthRefresh is configured
! bash commands now trigger Claude to respond to the output automatically; set  / : false in settings.json to keep the previous context-only behavior
Fixed streaming requests failing with  / MCP server disconnected
...
- company_actions: anthropics claude-code Public Notifications You must be signed in to change notification settings Fork 21. / 186 Latest Latest Compare Choose a tag to compare Sorry, something went wrong. / Filter Loading Sorry, something went wrong.
- case_details: 暂无公开信息
