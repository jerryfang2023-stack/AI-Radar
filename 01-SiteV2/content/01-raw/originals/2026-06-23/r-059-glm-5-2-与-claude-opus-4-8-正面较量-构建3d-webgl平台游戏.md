...
raw_id: R-059
title: "GLM-5.2 与 Claude Opus 4.8 正面较量：构建3D WebGL平台游戏"
original_url: "https://techstackups.com/comparisons/glm-5.2-vs-opus"
canonical_url: "https://techstackups.com/comparisons/glm-5.2-vs-opus"
...
search_path_label: ""
author: ""
published_at: "2026-06-22T09:16:18.622Z"
collected_at: 2026-06-23T02:03:46.618Z
language: mixed
full_text_hash: ec18c88182a21584
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-059-glm-5-2-与-claude-opus-4-8-正面较量-构建3d-webgl平台游戏.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-059-glm-5-2-与-claude-opus-4-8-正面较量-构建3d-webgl平台游戏.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":17537,"paragraph_count":169,"sentence_count":188,"boilerplate_hits":0,"symbol_ratio":0.0005,"method":"content-container"}
has_full_text: true
content_length: 17537
fetch_error: ""
...
discovery_record: {"discovery_title":"GLM-5.2 与 Claude Opus 4.8 正面较量：构建3D WebGL平台游戏","discovery_summary":"最新开源 GLM-5.2（Z.ai，MIT 许可，1M token 上下文，输出定价 $4.4/百万 token）与 Claude Opus 4.8 在单次提示构建 3D WebGL 平台游戏任务上对比。Opus（Claude Code）用时 33 分 30 秒，成本约 $21.92；GLM-5.2（Pi/OpenRouter）用时 1 小时 10 分 40 秒，成本仅 $5.39。Opus 游戏更干净、能自检视觉输出（GLM-5.2 纯文本），但 GLM-5.2 价格低且开源权重可下载，始终可用。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://techstackups.com/comparisons/glm-5.2-vs-opus","discovered_at":"2026-06-23T01:57:11.629Z","rank_on_page":212,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: cf3c315bbd40b450
content_hash: ec18c88182a21584
semantic_hash: b9cff14c835ac0b3
duplicate_of: ""
first_seen_at: "2026-06-22T09:16:18.622Z"
last_seen_at: 2026-06-23T02:03:46.618Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","Anthropic","GitHub"],"products":["Claude","agent","agents","GPT-5","Gemini","MCP"],"people":[],"industries":["法律 / 法务","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["5.2","4.8","3","1M","$4.4","33","30","$21.92"],"quotes":["analyzed","w/ tools","probably the most powerful text-only open weights LLM","probably the most powerful text-only open weights LLM.","very impressive."]}
...
GLM-5.2, start to finish. Opus, start to finish.
...
What is GLM-5.2 Pricing and access
Our vibe test: a 3D game from scratch Why this task
What each model had to build
How long it took, and what it cost
Playtesting both games
How each model checked its own work
The bugs
What the test showed
The benchmarks What each benchmark measures
What people are saying Simon Willison: "probably the most powerful text-only open weights LLM"
Artificial Analysis: top open model, but token-hungry
Nathan Lambert: the open-closed gap is closing
The verdict
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":17537,"paragraph_count":169,"sentence_count":188,"boilerplate_hits":0,"symbol_ratio":0.0005,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 vs Claude Opus | Tech Stackups Skip to main content GLM-5.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2 just came out, and it's another step forward for what open models can do.
...
5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   So we ran it head-to-head against Claude Opus 4.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   8: same one-shot prompt, build a 3D platformer in raw WebGL from scratch.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）, Anthropic, GitHub
- products: Claude, agent, agents, GPT-5, Gemini, MCP
- people: 暂无公开信息
...
- numbers: 5.2, 4.8, 3, 1M, $4.4, 33, 30, $21.92
- quotes: analyzed / w/ tools / probably the most powerful text-only open weights LLM / probably the most powerful text-only open weights LLM. / very impressive.

## evidence_seed

- company_actions: 2 vs Claude Opus | Tech Stackups Skip to main content GLM-5. / 2 just came out, and it's another step forward for what open models can do. / The internet promptly freaked out, and it's hard to tell what's real and what's hype.
- case_details: 暂无公开信息
