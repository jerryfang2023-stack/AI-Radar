...
original_url: "https://www.marktechpost.com/2026/06/22/xai-launches-goal-in-grok-build-adding-long-running-autonomous-execution-with-built-in-verification-for-multi-step-coding-tasks"
canonical_url: "https://marktechpost.com/2026/06/22/xai-launches-goal-in-grok-build-adding-long-running-autonomous-execution-with-built-in-verification-for-multi-step-coding-tasks"
...
search_path_label: ""
author: ""
published_at: "2026-06-22T20:34:48.000Z"
collected_at: 2026-06-23T02:03:46.415Z
language: mixed
full_text_hash: 1bb0ddd8fb8a37c8
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-001-xai-为-grok-build-推出-goal-模式-支持长周期自主编码与内置验证.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-23/r-001-xai-为-grok-build-推出-goal-模式-支持长周期自主编码与内置验证.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":88,"text_length":44294,"paragraph_count":375,"sentence_count":115,"boilerplate_hits":3,"symbol_ratio":0.0003,"method":"article"}
has_full_text: true
content_length: 44294
fetch_error: ""
...
discovery_record: {"discovery_title":"xAI 为 Grok Build 推出 /goal 模式，支持长周期自主编码与内置验证","discovery_summary":"xAI 在终端编码智能体 Grok Build 中新增 /goal 模式。用户输入一条目标指令后，Grok Build 自动规划步骤、生成进度清单，逐一执行并验证（审查代码、检查网页或运行脚本）直至完成。期间可用 `/goal status`、`/goal pause`、`/goal resume`、`/goal clear` 命令监控与操控运行。该模式面向多文件迁移、重构、依赖升级等长周期任务，需 SuperGrok 或 X Premium Plus 订阅。与 Claude Code、OpenAI Codex CLI、Cursor Agent Mode 相比，/goal 的核心差异在于显式的可操控目标对象和内置验证步骤。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/22/xai-launches-goal-in-grok-build-adding-long-running-autonomous-execution-with-built-in-verification-for-multi-step-coding-tasks","discovered_at":"2026-06-23T01:57:11.595Z","rank_on_page":72,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: b984d396243b5a3e
content_hash: a6a1832a82a58651
semantic_hash: d28d445189f43221
duplicate_of: ""
first_seen_at: "2026-06-22T20:34:48.000Z"
last_seen_at: 2026-06-23T02:03:46.415Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Claude","Codex","Cursor","Agent","agent","AGENTS","MCP","agents","Agents","Gemini"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["150","750","5.2","1M","2026","25","20","21"],"quotes":[]}
...
Michal Sutter
How to Build Progress Monitorin
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":88,"text_length":44294,"paragraph_count":375,"sentence_count":115,"boilerplate_hits":3,"symbol_ratio":0.0003,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Editors Pick Agentic AI New Releases Tech News xAI shipped a new mode called /goal inside Grok Build , its terminal coding agent.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The feature targets long-running, autonomous task execution.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   You hand the agent a larger implementation task, then step back.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Most coding sessions require back-and-forth execution and verification.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   You prompt, the agent acts, and you verify each step.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Nvidia, Cursor, Perplexity
- products: Claude, Codex, Cursor, Agent, agent, AGENTS, MCP, agents, Agents, Gemini
- people: 暂无公开信息
...
- numbers: 150, 750, 5.2, 1M, 2026, 25, 20, 21
- quotes: 暂无公开信息

## evidence_seed

- company_actions: xAI 在终端编码智能体 Grok Build 中新增 /goal 模式。用户输入一条目标指令后，Grok Build 自动规划步骤、生成进度清单，逐一执行并验证（审查代码、检查网页或运行脚本）直至完成。期间可用 `/goal status`、`/goal pause`、`/goal resume`、`/goal clear` 命令监控与操控运行。该模式面向多文件迁移、重构、依赖升级等长周期任务，需 SuperGrok 或 X Premium Plus 订阅。与 Claude Code、OpenAI Codex CLI、Cursor Agent Mode 相比，/goal 的核心差异在于显式的可操控目标对象和内置验证步骤。 / Editors Pick Agentic AI New Releases Tech News xAI shipped a new mode called /goal inside Grok Build , its terminal coding agent. / The feature targets long-running, autonomous task execution.
- case_details: 暂无公开信息
