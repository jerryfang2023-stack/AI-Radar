...
search_path_label: ""
author: ""
published_at: "2026-07-10T00:20:20.110Z"
collected_at: 2026-07-10T01:59:44.111Z
language: mixed
full_text_hash: 468fba44c5915737
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-008-google-research-推出-sensorfm-面向可穿戴健康数据的通用基础模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-008-google-research-推出-sensorfm-面向可穿戴健康数据的通用基础模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":11191,"paragraph_count":47,"sentence_count":58,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 11191
fetch_error: ""
...
discovery_record: {"discovery_title":"Google Research 推出 SensorFM：面向可穿戴健康数据的通用基础模型","discovery_summary":"Google Research 发布 SensorFM，一个在超过 100 万亿分钟多模态传感器数据上预训练的大规模基础模型，数据来自 500 万同意参与者，涵盖 100 多个国家及 20 余款 Fitbit 和 Pixel Watch 设备。SensorFM 学习通用的人体生理表征，可迁移至心血管、代谢、睡眠、心理健康及生活方式等 35 项健康预测任务，支持标签高效适配与数据填充，并可作为个人健康智能体的基础工具。该模型旨在解决传统可穿戴健康模型针对单一终点、难以泛化的问题。","source_name":"Google Research：Blog（网页）","origin_url":"https://research.google/blog/sensorfm-towards-a-general-intelligence-and-interface-for-wearable-health-data","discovered_at":"2026-07-10T01:50:23.460Z","rank_on_page":54,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: fe4b92f86d70ac26
content_hash: 468fba44c5915737
semantic_hash: 61f55c21732c1b56
duplicate_of: ""
first_seen_at: "2026-07-10T00:20:20.110Z"
last_seen_at: 2026-07-10T01:59:44.111Z
...
business_elements: {"companies":["Google Research","Blog（网页）","Google"],"products":["Agent","agents","agent","Gemini"],"people":[],"industries":["医疗","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["100 万","500 万","100","20","35","9","2026\nX","2024"],"quotes":[" Towards a General Intelligence and Interface for Wearable Health Data ","classroom","classroom","classroom"]}
...
fact_extraction_completed_at: 2026-07-10T01:59:44.111Z
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":11191,"paragraph_count":47,"sentence_count":58,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   SensorFM: Towards a general intelligence and interface for wearable health data July 9, 2026 Xin Liu, Senior Research Scientist, and Daniel McDuff, Staff Research Scientist, Google Research We present SensorFM, a foundation model for wearable health pre-trained on more than one trillion minutes of sensor data from five million people.
...
3. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   By co-scaling model size and data, SensorFM learns a general-purpose representation of human physiology that transfers to 35 health prediction tasks, supports label-efficient adaptation and data infilling, and can serve as a grounding tool for a Personal Health Agent.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Quick links Paper Share Copy link Estimates suggest that billions of wearable devices are now in use, precisely tracking heart rate, movement, skin temperature, blood-oxygen levels, and sleep across days, weeks, and months.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   This continuous, longitudinal stream of physiology and behavior provides one of the most promising raw materials for preventive, personalized health .
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Yet turning those low-level signals into meaningful insights remains hard.

## business_elements

- companies: Google Research, Blog（网页）, Google
- products: Agent, agents, agent, Gemini
- people: 暂无公开信息
- industries: 医疗, 开发者工具
...
- numbers: 100 万, 500 万, 100, 20, 35, 9, 2026
X, 2024
- quotes:  Towards a General Intelligence and Interface for Wearable Health Data  / classroom / classroom / classroom

## evidence_seed

- company_actions: Quick links Paper Share Copy link Estimates suggest that billions of wearable devices are now in use, precisely tracking heart rate, movement, skin temperature, blood-oxygen levels, and sleep across days, weeks, and months. / This continuous, longitudinal stream of physiology and behavior provides one of the most promising raw materials for preventive, personalized health . / Yet turning those low-level signals into meaningful insights remains hard.
- case_details: 暂无公开信息
- workflow_changes: By co-scaling model size and data, SensorFM learns a general-purpose representation of human physiology that transfers to 35 health prediction tasks, supports label-efficient adaptation and data infilling, and can serve as a grounding tool for a Personal Health Agent.
