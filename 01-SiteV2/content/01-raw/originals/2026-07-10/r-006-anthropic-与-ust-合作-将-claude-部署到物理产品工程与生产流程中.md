...
search_path_label: ""
author: ""
published_at: "2026-07-10T00:42:28.267Z"
collected_at: 2026-07-10T01:59:44.103Z
language: mixed
full_text_hash: cd29d8fc7efd6f64
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-006-anthropic-与-ust-合作-将-claude-部署到物理产品工程与生产流程中.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-006-anthropic-与-ust-合作-将-claude-部署到物理产品工程与生产流程中.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":94,"text_length":7227,"paragraph_count":26,"sentence_count":45,"boilerplate_hits":1,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 7227
fetch_error: ""
...
discovery_record: {"discovery_title":"Anthropic 与 UST 合作，将 Claude 部署到物理产品工程与生产流程中","discovery_summary":"Anthropic 与技术服务公司 UST 达成合作，将 Claude 部署到芯片、汽车、物联网等物理产品的工程与生产流程中。UST 计划在全球培训 20，000 名工程师、架构师和顾问使用 Claude。在 UST 的 iDEC 平台上，Claude Code 直接读取芯片原理图和引脚图，编写并运行回归测试，将验证周期缩短 50% 至 70%，标准四天周转压缩至 48 小时。Claude 还作为推理层，对比真实设备数据与数字孪生模型，标记固件回归和信号完整性故障。","source_name":"Anthropic：Newsroom（网页）","origin_url":"https://www.anthropic.com/news/ust-claude","discovered_at":"2026-07-10T01:50:23.458Z","rank_on_page":45,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f3780e8517a5249c
content_hash: cd29d8fc7efd6f64
semantic_hash: b21f6dcd22fd89f5
duplicate_of: ""
first_seen_at: "2026-07-10T00:42:28.267Z"
last_seen_at: 2026-07-10T01:59:44.103Z
...
business_elements: {"companies":["Anthropic","Newsroom（网页）"],"products":["Claude","agents"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","制造 / 工业","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["20","000","50%","70%","48","9","2026\nB","50"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-10T01:59:44.103Z
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Anthropic 与技术服务公司 UST 达成合作，将 Claude 部署到芯片、汽车、物联网等物理产品的工程与生产流程中。UST 计划在全球培训 20，000 名工程师、架构师和顾问使用 Claude。在 UST 的 iDEC 平台上，Claude Code 直接读取芯片原理图和引脚图，编写并运行回归测试，将验证周期缩短 50% 至 70%，标准四天周转压缩至 48 小时。Claude 还作为推理层，对比真实设备数据与数字孪生模型，标记固件回归和信号完整性故障。

2. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   UST is bringing Claude to physical AI \ Anthropic Case Study UST is bringing Claude to physical AI Jul 9, 2026 Before a factory commits to manufacturing millions of chips, engineers stress-test the design in the fab.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Before a product ships, a fault on the assembly line has to be caught before it becomes a recall.
...
- numbers: 20, 000, 50%, 70%, 48, 9, 2026
B, 50
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Before a product ships, a fault on the assembly line has to be caught before it becomes a recall. / We’re partnering with UST , a technology and engineering services company that builds and runs the engineering environments its clients depend on to get chips, cars, and connected devices to market. / UST is putting Claude to work inside those environments, and training 20,000 of its engineers, architects, and consultants on Claude worldwide.
- case_details: UST is bringing Claude to physical AI \ Anthropic Case Study UST is bringing Claude to physical AI Jul 9, 2026 Before a factory commits to manufacturing millions of chips, engineers stress-test the design in the fab.
- workflow_changes: When AI does this kind of work, it’s called physical AI: intelligence built into the equipment and engineering processes that produce the things people use.
