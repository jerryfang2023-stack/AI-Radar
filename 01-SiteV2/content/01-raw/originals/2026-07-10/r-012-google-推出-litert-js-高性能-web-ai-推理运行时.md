...
search_path_label: ""
author: ""
published_at: "2026-07-09T21:21:08.292Z"
collected_at: 2026-07-10T01:59:44.134Z
language: mixed
full_text_hash: c472c538d436054c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-012-google-推出-litert-js-高性能-web-ai-推理运行时.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-012-google-推出-litert-js-高性能-web-ai-推理运行时.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Google 推出 LiteRT.js：高性能 Web AI 推理运行时","discovery_summary":"Google 发布 LiteRT.js，这是 LiteRT 跨平台边缘 AI 运行时的最新成员，专为 JavaScript 开发者设计，可直接在浏览器中运行机器学习模型。LiteRT.js 基于 WebGPU 和即将推出的 WebNN 实现 SOTA 推理性能，同时支持回退到 WebAssembly CPU 方案。","source_name":"Google Developers Blog（RSS）","origin_url":"https://developers.googleblog.com/litertjs-googles-high-performance-web-ai-inference","discovered_at":"2026-07-10T01:50:23.484Z","rank_on_page":132,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 6978a8ca70da2526
content_hash: c472c538d436054c
semantic_hash: 275a3b424d68b786
duplicate_of: ""
first_seen_at: "2026-07-09T21:21:08.292Z"
last_seen_at: 2026-07-10T01:59:44.134Z
...
business_elements: {"companies":["Google Developers Blog（RSS）","Google","GitHub","Apple"],"products":["Genkit","Gemini"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["9","2026","1","2","3x","2024","4","5"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-10T01:59:44.134Z
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9393,"paragraph_count":59,"sentence_count":59,"boilerplate_hits":0,"symbol_ratio":0.0014,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   js, Google's high performance Web AI Inference JULY 9, 2026 Ping Yu Software Engineer Marko Ristić Software Engineer Matthew Soulanille Software Engineer Chintan Parikh Product Manager Share Facebook Twitter LinkedIn Mail We are excited to announce LiteRT.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   js , a JavaScript binding of LiteRT for running AI directly inside the web browser.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   By bringing the trusted on-device inference library LiteRT to the web, web developers can now run ML and AI models with maximum performance entirely locally.

5. **supporting_context**｜supports=signal_card_candidate, relationship_graph_input｜importance=high｜confidence=high
   This means enhanced user privacy, zero server costs, and ultra-low latency for real-time experiences.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   For developers with existing .

## business_elements

- companies: Google Developers Blog（RSS）, Google, GitHub, Apple
- products: Genkit, Gemini
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 9, 2026, 1, 2, 3x, 2024, 4, 5
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Google 发布 LiteRT.js，这是 LiteRT 跨平台边缘 AI 运行时的最新成员，专为 JavaScript 开发者设计，可直接在浏览器中运行机器学习模型。LiteRT.js 基于 WebGPU 和即将推出的 WebNN 实现 SOTA 推理性能，同时支持回退到 WebAssembly CPU 方案。 / js, Google's high performance Web AI Inference JULY 9, 2026 Ping Yu Software Engineer Marko Ristić Software Engineer Matthew Soulanille Software Engineer Chintan Parikh Product Manager Share Facebook Twitter LinkedIn Mail We are excited to announce LiteRT. / js , a JavaScript binding of LiteRT for running AI directly inside the web browser.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 部署 / 集成交付 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: This means enhanced user privacy, zero server costs, and ultra-low latency for real-time experiences.
