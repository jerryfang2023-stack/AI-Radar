...
search_path_label: ""
author: ""
published_at: "2026-07-09T21:46:26.100Z"
collected_at: 2026-07-10T01:59:44.147Z
language: mixed
full_text_hash: 56aeb82f46f5fbbe
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-015-meta-发布-muse-spark-1-1-多模态推理模型.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-10/r-015-meta-发布-muse-spark-1-1-多模态推理模型.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":73,"text_length":8102,"paragraph_count":40,"sentence_count":49,"boilerplate_hits":4,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
has_full_text: true
content_length: 8102
fetch_error: ""
...
discovery_record: {"discovery_title":"Meta 发布 Muse Spark 1.1 多模态推理模型","discovery_summary":"Meta Superintelligence Labs 今日推出 Muse Spark 1.1，专为智能体任务设计，在工具使用、计算机使用、编程和多模态理解方面显著提升。模型支持 100 万 token 上下文窗口，提供\"Thinking\"模式，并通过 Meta Model API 公开预览。在智能体任务中可零样本泛化至新工具、MCP 服务器与自定义技能；计算机使用可自动编写脚本或生成批量操作；编程性能在 Meta Internal Coding Bench 上优于前代。多模态能力涵盖视觉到代码生成、图像视频描述。安全性评估显示模型在化学生物、网络安全、失控等风险类别中处于安全边际内。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://ai.meta.com/blog/introducing-muse-spark-meta-model-api","discovered_at":"2026-07-10T01:50:23.478Z","rank_on_page":113,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f8a956094e526a92
content_hash: 56aeb82f46f5fbbe
semantic_hash: 17277e5226869900
duplicate_of: ""
first_seen_at: "2026-07-09T21:46:26.100Z"
last_seen_at: 2026-07-10T01:59:44.147Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","OpenAI","Meta"],"products":["MCP","Agents","agent","agents"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["1.1","100 万","9","2026","10 m","1 million","1.1 b"],"quotes":["Thinking","Thinking","Muse Spark 1.1 is an awesome model for running agents. Fast, powerful, and fun with OpenClaw."]}
...
fact_extraction_completed_at: 2026-07-10T01:59:44.147Z
...
- fetch_status: fetched-readable-text-body-visible-text
- extraction_quality: high
- diagnostics: {"readability_score":73,"text_length":8102,"paragraph_count":40,"sentence_count":49,"boilerplate_hits":4,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"body-visible-text"}
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   1 Products AI Research Resources About Try Meta AI Introducing Muse Spark 1.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   1 July 9, 2026 • 10 minute read Today, we’re excited to introduce Muse Spark 1.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   1, the latest model from Meta Superintelligence Labs and a significant upgrade from Muse Spark.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   1 is a multimodal reasoning model built for agentic tasks, with major gains in tool and computer use, coding, and multimodal understanding.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）, OpenAI, Meta
...
- numbers: 1.1, 100 万, 9, 2026, 10 m, 1 million, 1.1 b
- quotes: Thinking / Thinking / Muse Spark 1.1 is an awesome model for running agents. Fast, powerful, and fun with OpenClaw.

## evidence_seed

- company_actions: Introducing Muse Spark 1. / 1 Products AI Research Resources About Try Meta AI Introducing Muse Spark 1. / 1 July 9, 2026 • 10 minute read Today, we’re excited to introduce Muse Spark 1.
- case_details: 暂无公开信息
