...
raw_id: R-067
title: "Nous Research 发布 Hermes Agent Profile Builder：身份、模型、技能和 MCP 服务器一站式仪表盘流"
original_url: "https://www.marktechpost.com/2026/06/11/nous-research-ships-hermes-agent-profile-builder-identity-model-skills-and-mcp-servers-in-one-dashboard-flow"
canonical_url: "https://marktechpost.com/2026/06/11/nous-research-ships-hermes-agent-profile-builder-identity-model-skills-and-mcp-servers-in-one-dashboard-flow"
...
search_path_label: ""
author: ""
published_at: "2026-06-11T09:53:52.000Z"
collected_at: 2026-06-12T03:53:39.259Z
language: mixed
full_text_hash: 9cd2c28896dac452
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-067-nous-research-发布-hermes-agent-profile-builder-身份-模型-技能和-mcp-服务器一站式仪表盘流.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-067-nous-research-发布-hermes-agent-profile-builder-身份-模型-技能和-mcp-服务器一站式仪表盘流.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":44123,"paragraph_count":388,"sentence_count":123,"boilerplate_hits":2,"symbol_ratio":0.0007,"method":"article"}
has_full_text: true
content_length: 44123
fetch_error: ""
...
discovery_record: {"discovery_title":"Nous Research 发布 Hermes Agent Profile Builder：身份、模型、技能和 MCP 服务器一站式仪表盘流","discovery_summary":"Nous Research 为 Hermes Agent 仪表盘新增 Profile Builder，用户可在单一流程中构建包含身份、模型、技能和 MCP 服务器的完整 Agent 配置文件，替代以往多步 CLI 配置方式。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/11/nous-research-ships-hermes-agent-profile-builder-identity-model-skills-and-mcp-servers-in-one-dashboard-flow","discovered_at":"2026-06-12T03:48:20.903Z","rank_on_page":289,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 907e1c6483073f6c
content_hash: 07e66cd14a6ce332
semantic_hash: b65630c03ee678ec
duplicate_of: ""
first_seen_at: "2026-06-11T09:53:52.000Z"
last_seen_at: 2026-06-12T03:53:39.259Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["Agent","MCP","Agents","agent","agents","mcp","claude","Cursor","Gemini","Claude"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["127.0","0.1","9119","4","8","4\nm","150","20"],"quotes":["Reads source code and external docs, writes findings.","@modelcontextprotocol/server-filesystem","/home/user/projects","https://mcp.example.com/mcp","Bearer ${DOCS_API_KEY}"]}
...
Nous Research &middot; Hermes Agent
The Profile Builder , explained
DEMO simulation, not the live product
Profile name
Becomes a command &rarr; researcher chat
Description
...
Built-in toolsets
Off &rarr; written to agent.disabled_toolsets .
MCP servers
Filesystem
GitHub
HTTP
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":44123,"paragraph_count":388,"sentence_count":123,"boilerplate_hits":2,"symbol_ratio":0.0007,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Editors Pick Agentic AI AI Agents Artificial Intelligence AI Infrastructure Applications Technology Model Context Protocol (MCP) New Releases Software Engineering Staff Tech News Nous Research has shipped a Profile Builder for Hermes Agent.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   It lives inside the project’s local web dashboard.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Standing up a distinct agent used to mean several CLI steps.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   The builder now walks you through one guided flow.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   In that flow you define an agent’s identity.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Nvidia, Cursor, Perplexity
- products: Agent, MCP, Agents, agent, agents, mcp, claude, Cursor, Gemini, Claude
- people: 暂无公开信息
...
- numbers: 127.0, 0.1, 9119, 4, 8, 4
m, 150, 20
- quotes: Reads source code and external docs, writes findings. / @modelcontextprotocol/server-filesystem / /home/user/projects / https://mcp.example.com/mcp / Bearer ${DOCS_API_KEY}

## evidence_seed

- company_actions: Editors Pick Agentic AI AI Agents Artificial Intelligence AI Infrastructure Applications Technology Model Context Protocol (MCP) New Releases Software Engineering Staff Tech News Nous Research has shipped a Profile Builder for Hermes Agent. / It lives inside the project’s local web dashboard. / Standing up a distinct agent used to mean several CLI steps.
- case_details: 暂无公开信息
- workflow_changes: Nous Research 为 Hermes Agent 仪表盘新增 Profile Builder，用户可在单一流程中构建包含身份、模型、技能和 MCP 服务器的完整 Agent 配置文件，替代以往多步 CLI 配置方式。
