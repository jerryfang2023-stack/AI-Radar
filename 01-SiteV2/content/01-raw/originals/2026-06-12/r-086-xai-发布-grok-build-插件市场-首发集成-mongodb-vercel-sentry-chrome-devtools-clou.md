...
raw_id: R-086
title: "xAI 发布 Grok Build 插件市场，首发集成 MongoDB、Vercel、Sentry、Chrome DevTools、Cloudflare 等插件"
original_url: "https://www.marktechpost.com/2026/06/11/xai-ships-grok-build-plugin-marketplace-with-mongodb-vercel-sentry-chrome-devtools-cloudflare-and-superpowers-plugins-at-launch"
canonical_url: "https://marktechpost.com/2026/06/11/xai-ships-grok-build-plugin-marketplace-with-mongodb-vercel-sentry-chrome-devtools-cloudflare-and-superpowers-plugins-at-launch"
...
search_path_label: ""
author: ""
published_at: "2026-06-11T21:30:31.000Z"
collected_at: 2026-06-12T03:53:39.324Z
language: mixed
full_text_hash: 38f8a7a5cabf265e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-086-xai-发布-grok-build-插件市场-首发集成-mongodb-vercel-sentry-chrome-devtools-clou.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-086-xai-发布-grok-build-插件市场-首发集成-mongodb-vercel-sentry-chrome-devtools-clou.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":42829,"paragraph_count":372,"sentence_count":99,"boilerplate_hits":2,"symbol_ratio":0.0004,"method":"article"}
has_full_text: true
content_length: 42829
fetch_error: ""
raw_qc_decision: allow
raw_qc_downstream_use: eligible_after_qc
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"38f8a7a5cabf265e","missing":[]}
...
discovery_record: {"discovery_title":"xAI 发布 Grok Build 插件市场，首发集成 MongoDB、Vercel、Sentry、Chrome DevTools、Cloudflare 等插件","discovery_summary":"xAI 推出 Grok Build 插件市场，这是一个终端内插件平台，支持技能、智能体、钩子和 MCP 服务器。所有远程插件均通过 commit-SHA 验证确保安全。首发插件包括 MongoDB、Vercel、Sentry、Chrome DevTools、Cloudflare 及 Superpowers。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/11/xai-ships-grok-build-plugin-marketplace-with-mongodb-vercel-sentry-chrome-devtools-cloudflare-and-superpowers-plugins-at-launch","discovered_at":"2026-06-12T03:48:20.871Z","rank_on_page":120,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 263051e0b28a1384
content_hash: 6a10b51838138575
semantic_hash: 0f367bc7583f81be
duplicate_of: ""
first_seen_at: "2026-06-11T21:30:31.000Z"
last_seen_at: 2026-06-12T03:53:39.324Z
...
business_elements: {"companies":["MarkTechPost（RSS）","OpenAI","Anthropic","Google","Microsoft","GitHub","Meta","Nvidia","Cursor","Perplexity"],"products":["MCP","Agents","agent","agents","mcp","Claude","Agent","Cursor","Gemini","Codex"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","销售 / 客服"],"numbers":["40","0000000000000000000000000000000000000000","3","11","2026","150","20","21"],"quotes":["my-plugin","description","What the plugin does.","category","development"]}
evidence_seed: {"company_actions":["Editors Pick Agentic AI AI Agents New Releases Software Engineering Staff Tech News Today, xAI shipped the Grok Build Plugin Marketplace.","It is a built-in catalog of plugins for Grok Build, the company’s terminal coding agent.","A plugin bundles skills, slash commands, agents, hooks, MCP servers, and LSPs into one package."],"case_details":[],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。","可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。","可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":["xAI 推出 Grok Build 插件市场，这是一个终端内插件平台，支持技能、智能体、钩子和 MCP 服务器。所有远程插件均通过 commit-SHA 验证确保安全。首发插件包括 MongoDB、Vercel、Sentry、Chrome DevTools、Cloudflare 及 Superpowers。"]}
missing_information: ["没有具体客户或真实企业案例"]
key_excerpts: [{"type":"supporting_context","text":"xAI 推出 Grok Build 插件市场，这是一个终端内插件平台，支持技能、智能体、钩子和 MCP 服务器。所有远程插件均通过 commit-SHA 验证确保安全。首发插件包括 MongoDB、Vercel、Sentry、Chrome DevTools、Cloudflare 及 Superpowers。","supports":["daily_observation","heatmap"],"importance":"medium","confidence":"high"},{"type":"product_update","text":"Editors Pick Agentic AI AI Agents New Releases Software Engineering Staff Tech News Today, xAI shipped the Grok Build Plugin Marketplace.","supports":["daily_observation","heatmap","change"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"It is a built-in catalog of plugins for Grok Build, the company’s terminal coding agent.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"A plugin bundles skills, slash commands, agents, hooks, MCP servers, and LSPs into one package.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"},{"type":"product_update","text":"You browse, install, and update these packages without leaving the terminal.","supports":["daily_observation","heatmap","change"],"importance":"medium","confidence":"high"},{"type":"company_action","text":"Plugin Marketplace Grok Build is xAI’s coding agent and CLI for software engineering work.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"medium","confidence":"high"}]
...
Michal Sutter
Microsoft Research Introduces CORPGEN To Manage Multi Hor
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":42829,"paragraph_count":372,"sentence_count":99,"boilerplate_hits":2,"symbol_ratio":0.0004,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=medium｜confidence=high
   Editors Pick Agentic AI AI Agents New Releases Software Engineering Staff Tech News Today, xAI shipped the Grok Build Plugin Marketplace.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   It is a built-in catalog of plugins for Grok Build, the company’s terminal coding agent.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   A plugin bundles skills, slash commands, agents, hooks, MCP servers, and LSPs into one package.

5. **product_update**｜supports=daily_observation, heatmap, change｜importance=medium｜confidence=high
   You browse, install, and update these packages without leaving the terminal.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   Plugin Marketplace Grok Build is xAI’s coding agent and CLI for software engineering work.

## business_elements

- companies: MarkTechPost（RSS）, OpenAI, Anthropic, Google, Microsoft, GitHub, Meta, Nvidia, Cursor, Perplexity
- products: MCP, Agents, agent, agents, mcp, Claude, Agent, Cursor, Gemini, Codex
- people: 暂无公开信息
...
- numbers: 40, 0000000000000000000000000000000000000000, 3, 11, 2026, 150, 20, 21
- quotes: my-plugin / description / What the plugin does. / category / development

## evidence_seed

- company_actions: Editors Pick Agentic AI AI Agents New Releases Software Engineering Staff Tech News Today, xAI shipped the Grok Build Plugin Marketplace. / It is a built-in catalog of plugins for Grok Build, the company’s terminal coding agent. / A plugin bundles skills, slash commands, agents, hooks, MCP servers, and LSPs into one package.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。 / 可能涉及 计费 / 预算管理 的前后变化，需要二搜补足变化前流程。 / 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: xAI 推出 Grok Build 插件市场，这是一个终端内插件平台，支持技能、智能体、钩子和 MCP 服务器。所有远程插件均通过 commit-SHA 验证确保安全。首发插件包括 MongoDB、Vercel、Sentry、Chrome DevTools、Cloudflare 及 Superpowers。
