...
canonical_url: "https://github.com/huggingface/open-r1"
...
search_path_label: ""
author: ""
published_at: "2026-06-11T17:07:18.181Z"
collected_at: 2026-06-12T03:53:39.210Z
language: mixed
full_text_hash: 4ce6ea4c0aa9d278
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-051-deepseek-r1-的开源实现.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-051-deepseek-r1-的开源实现.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":29220,"paragraph_count":383,"sentence_count":107,"boilerplate_hits":2,"symbol_ratio":0.0249,"method":"main"}
has_full_text: true
content_length: 29220
fetch_error: ""
...
discovery_record: {"discovery_title":"DeepSeek-R1 的开源实现","discovery_summary":"DeepSeek-R1 的开源复现项目已在 GitHub 发布，在 Hacker News 上获得 101 个积分。该项目旨在以开源方式复现 DeepSeek-R1 模型。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://github.com/huggingface/open-r1","discovered_at":"2026-06-12T03:48:20.884Z","rank_on_page":183,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: a17dd37c5dbe461b
content_hash: 55436a71bf761f74
semantic_hash: 1f2335171aa10298
duplicate_of: ""
first_seen_at: "2026-06-11T17:07:18.181Z"
last_seen_at: 2026-06-12T03:53:39.210Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","GitHub","Meta"],"products":["Claude"],"people":[],"industries":["开发者工具"],"roles":[],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["1","101","2.4","26.2","199","1 m","2","3"],"quotes":[" .[dev] ","$(cat llama_chat_template.jinja)","colocate","\nMorph Provider\nTo use Morph, first install the morphcloud package:\npip install morphcloud\nThen add your Morph API token to the .env file:\nMORPH_API_KEY=","language"]}
...
We provide ioi_code_reward and cf_code_reward reward functions for executing problems from IOI and CodeForces , respectively. You can use either piston or Morph (currently IOI only) as your execution provider.
Piston
To use Piston:
...
Example recipes
For IOI:
See the example recipe for how to use the IOI reward function:
...
prompt_template = """ \
You will be given a problem. Please reason step by step, and put your final answer within \b oxed{}:
{{ instruction }}"""
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":29220,"paragraph_count":383,"sentence_count":107,"boilerplate_hits":2,"symbol_ratio":0.0249,"method":"main"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   huggingface open-r1 Public Notifications You must be signed in to change notification settings Fork 2.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   2k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 199 Commits 199 Commits .

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   github assets assets logs logs recipes recipes scripts scripts slurm slurm src/ open_r1 src/ open_r1 tests tests .

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   gitignore LICENSE LICENSE Makefile Makefile README.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   py View all files Repository files navigation Open R1 A fully open reproduction of DeepSeek-R1.

## business_elements

- companies: Hacker News 热门（buzzing.cc 中文翻译）, GitHub, Meta
- products: Claude
- people: 暂无公开信息
- industries: 开发者工具
- roles: 暂无公开信息
...
- numbers: 1, 101, 2.4, 26.2, 199, 1 m, 2, 3
- quotes:  .[dev]  / $(cat llama_chat_template.jinja) / colocate / 
Morph Provider
To use Morph, first install the morphcloud package:
pip install morphcloud
Then add your Morph API token to the .env file:
...
- company_actions: DeepSeek-R1 的开源复现项目已在 GitHub 发布，在 Hacker News 上获得 101 个积分。该项目旨在以开源方式复现 DeepSeek-R1 模型。 / huggingface open-r1 Public Notifications You must be signed in to change notification settings Fork 2. / 2k main Branches Tags Go to file Code Open more actions menu Folders and files Name Name Last commit message Last commit date Latest commit History 199 Commits 199 Commits .
- case_details: 暂无公开信息
