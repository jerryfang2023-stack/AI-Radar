...
raw_id: R-069
title: "Cohere 发布 North Mini Code：30B 参数 MoE 编码模型，3B 活跃参数，单卡 H100 运行，支持 256K 上下文"
original_url: "https://www.marktechpost.com/2026/06/11/meet-north-mini-code-coheres-30b-open-weight-mixture-of-experts-model-with-3b-active-parameters-for-agentic-coding"
canonical_url: "https://marktechpost.com/2026/06/11/meet-north-mini-code-coheres-30b-open-weight-mixture-of-experts-model-with-3b-active-parameters-for-agentic-coding"
...
search_path_label: ""
author: ""
published_at: "2026-06-11T08:33:27.000Z"
collected_at: 2026-06-12T03:53:39.270Z
language: mixed
full_text_hash: 8bdb8e6e9614d83a
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-069-cohere-发布-north-mini-code-30b-参数-moe-编码模型-3b-活跃参数-单卡-h100-运行-支持-256k-上.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-12/r-069-cohere-发布-north-mini-code-30b-参数-moe-编码模型-3b-活跃参数-单卡-h100-运行-支持-256k-上.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":6844,"paragraph_count":65,"sentence_count":77,"boilerplate_hits":2,"symbol_ratio":0.0086,"method":"article"}
has_full_text: true
content_length: 6844
fetch_error: ""
...
degradation_reasons: []
evidence_completeness: {"original_url_status":"present","full_text_status":"present","snapshot_status":"present","hash_status":"present","excerpt_status":"present","markdown_snapshot_status":"will_write","json_snapshot_status":"will_write","evidence_hash":"8bdb8e6e9614d83a","missing":[]}
...
discovery_record: {"discovery_title":"Cohere 发布 North Mini Code：30B 参数 MoE 编码模型，3B 活跃参数，单卡 H100 运行，支持 256K 上下文","discovery_summary":"Cohere 推出首款开发者编码模型 North Mini Code，采用 30B 总参数的混合专家（MoE）架构，每次推理仅激活 3B 参数，可在单块 H100 GPU 上运行，支持 256K token 上下文窗口，专为智能体编码场景设计，模型权重开源。","source_name":"MarkTechPost（RSS）","origin_url":"https://www.marktechpost.com/2026/06/11/meet-north-mini-code-coheres-30b-open-weight-mixture-of-experts-model-with-3b-active-parameters-for-agentic-coding","discovered_at":"2026-06-12T03:48:20.906Z","rank_on_page":303,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 85cd218fc0d2e618
content_hash: 8bdb8e6e9614d83a
semantic_hash: a62d5f764c960008
duplicate_of: ""
first_seen_at: "2026-06-11T08:33:27.000Z"
last_seen_at: 2026-06-12T03:53:39.270Z
...
business_elements: {"companies":["MarkTechPost（RSS）","GitHub"],"products":["agent"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["30B","3B","100","256","64","8","2.0","1.0"],"quotes":["sovereign","git+https://github.com/huggingface/transformers.git","CohereLabs/North-Mini-Code-1.0",")\nprompt = ","\nmessages = [{"]}
evidence_seed: {"company_actions":["Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Technology Machine Learning New Releases Open Source Software Engineering Staff Tech News This week, Cohere AI team shipped its first developer-facing coding model named ‘ North Mini Code ‘.","‘North Mini Code’ is open-weight and focused at software engineers.","It is a mixture-of-experts (MoE) model with 30B total parameters."],"case_details":["Cohere 推出首款开发者编码模型 North Mini Code，采用 30B 总参数的混合专家（MoE）架构，每次推理仅激活 3B 参数，可在单块 H100 GPU 上运行，支持 256K token 上下文窗口，专为智能体编码场景设计，模型权重开源。"],"workflow_changes":[],"before_after_clues":["可能涉及 合同审阅 / 法律研究 的前后变化，需要二搜补足变化前流程。"],"affected_roles":["CIO / IT 负责人","开发者 / 工程团队"],"risks_or_constraints":[]}
missing_information: []
key_excerpts: [{"type":"case_detail","text":"Cohere 推出首款开发者编码模型 North Mini Code，采用 30B 总参数的混合专家（MoE）架构，每次推理仅激活 3B 参数，可在单块 H100 GPU 上运行，支持 256K token 上下文窗口，专为智能体编码场景设计，模型权重开源。","supports":["daily_observation","heatmap","case"],"importance":"high","confidence":"high"},{"type":"product_update","text":"Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Technology Machine Learning New Releases Open Source Software Engineering Staff Tech News This week, Cohere AI team shipped its first developer-facing coding model named ‘ North Mini Code ‘.","supports":["daily_observation","heatmap","change"],"importance":"high","confidence":"high"},{"type":"company_action","text":"‘North Mini Code’ is open-weight and focused at software engineers.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"It is a mixture-of-experts (MoE) model with 30B total parameters.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"company_action","text":"Only 3B of those parameters activate per token.","supports":["daily_observation","heatmap","change","case","trend"],"importance":"high","confidence":"high"},{"type":"quote","text":"The release is positioned around “sovereign” AI.","supports":["daily_observation","heatmap","viewpoint"],"importance":"high","confidence":"high"}]
theme: technical-iteration-signal
keyword_group: technical-iteration-signal
copyright_note: local research archive only
title_zh: "Cohere 发布 North Mini Code：30B 参数 MoE 编码模型，3B 活跃参数，单卡 H100 运行，支持 256K 上下文"
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":6844,"paragraph_count":65,"sentence_count":77,"boilerplate_hits":2,"symbol_ratio":0.0086,"method":"article"}
...
2. **product_update**｜supports=daily_observation, heatmap, change｜importance=high｜confidence=high
   Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Technology Machine Learning New Releases Open Source Software Engineering Staff Tech News This week, Cohere AI team shipped its first developer-facing coding model named ‘ North Mini Code ‘.

3. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   ‘North Mini Code’ is open-weight and focused at software engineers.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   It is a mixture-of-experts (MoE) model with 30B total parameters.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Only 3B of those parameters activate per token.

6. **quote**｜supports=daily_observation, heatmap, viewpoint｜importance=high｜confidence=high
   The release is positioned around “sovereign” AI.
...
- numbers: 30B, 3B, 100, 256, 64, 8, 2.0, 1.0
- quotes: sovereign / git+https://github.com/huggingface/transformers.git / CohereLabs/North-Mini-Code-1.0 / )
prompt =  / 
messages = [{

## evidence_seed

- company_actions: Editors Pick Agentic AI Artificial Intelligence AI Infrastructure Technology Machine Learning New Releases Open Source Software Engineering Staff Tech News This week, Cohere AI team shipped its first developer-facing coding model named ‘ North Mini Code ‘. / ‘North Mini Code’ is open-weight and focused at software engineers. / It is a mixture-of-experts (MoE) model with 30B total parameters.
- case_details: Cohere 推出首款开发者编码模型 North Mini Code，采用 30B 总参数的混合专家（MoE）架构，每次推理仅激活 3B 参数，可在单块 H100 GPU 上运行，支持 256K token 上下文窗口，专为智能体编码场景设计，模型权重开源。
