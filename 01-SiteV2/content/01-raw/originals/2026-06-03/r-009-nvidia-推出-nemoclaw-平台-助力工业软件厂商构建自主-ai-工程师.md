...
original_url: "https://blogs.nvidia.com/blog/industrial-software-leaders-secure-autonomous-ai-engineers-nemoclaw"
canonical_url: "https://blogs.nvidia.com/blog/industrial-software-leaders-secure-autonomous-ai-engineers-nemoclaw"
source_name: "NVIDIA Blog：Agentic AI（网页）"
source_type: product
source_level: S
...
search_path_label: ""
author: ""
published_at: "2026-06-02T22:00:58.000Z"
collected_at: 2026-06-03T03:22:50.228Z
language: mixed
full_text_hash: 9ca689cc4b087eed
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-03/r-009-nvidia-推出-nemoclaw-平台-助力工业软件厂商构建自主-ai-工程师.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-03/r-009-nvidia-推出-nemoclaw-平台-助力工业软件厂商构建自主-ai-工程师.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7168,"paragraph_count":47,"sentence_count":38,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
has_full_text: true
content_length: 7168
fetch_error: ""
...
discovery_record: {"discovery_title":"NVIDIA 推出 NemoClaw 平台，助力工业软件厂商构建自主 AI 工程师","discovery_summary":"在 COMPUTEX 上，NVIDIA 发布了 NemoClaw 平台，这是一个用于构建专业、长时间运行 AI 智能体的开放蓝图。该平台提供安全运行时、前沿模型支持以及多种编排框架集成选项，可通过 DGX Spark、数据中心或云端部署。其核心开源运行时 OpenShell 实施基于策略的安全管控，规范智能体对文件、网络和工具的访问。Cadence、达索系统、西门子、Synopsys 等十多家工业软件厂商正基于 NemoClaw 构建用于 CAE 和 EDA 工作流的自主 AI 工程师，旨在将原本需数周的仿真与设计任务压缩至数小时。","source_name":"NVIDIA Blog：Agentic AI（网页）","origin_url":"https://blogs.nvidia.com/blog/industrial-software-leaders-secure-autonomous-ai-engineers-nemoclaw","discovered_at":"2026-06-03T03:17:07.150Z","rank_on_page":111,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: merged_provider_duplicates
url_hash: 6ff7090ec46dbcf4
content_hash: 9ca689cc4b087eed
semantic_hash: d527f1ddcfc06bcc
duplicate_of: "merged 2 duplicate provider hit(s) before Raw selection"
first_seen_at: "2026-06-02T22:00:58.000Z"
last_seen_at: 2026-06-03T03:22:50.228Z
...
business_elements: {"companies":["NVIDIA Blog","Agentic AI（网页）","Microsoft","Nvidia"],"products":["agents","agent","Agents","Agent"],"people":[],"industries":["法律 / 法务","制造 / 工业","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线"],"affected_departments":["IT / 安全","法务"],"numbers":["3","2026","06","1","4","2","31","27"],"quotes":[]}
...
Neural Concept is deploying an agent for electric motor design. The workflow chains electromagnetic, structural and noise, vibration and harness simulations in a multistep engineering pipeline.
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7168,"paragraph_count":47,"sentence_count":38,"boilerplate_hits":0,"symbol_ratio":0,"method":"content-container"}
...
2. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Skip to content Accelerated computing has revolutionized industrial engineering, compressing simulation times from weeks to hours.
...
- companies: NVIDIA Blog, Agentic AI（网页）, Microsoft, Nvidia
...
- numbers: 3, 2026, 06, 1, 4, 2, 31, 27
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Skip to content Accelerated computing has revolutionized industrial engineering, compressing simulation times from weeks to hours. / These AI engineers are based on NVIDIA NemoClaw , an open blueprint for building specialized, long-running agents with a secure runtime and frontier models. / NemoClaw includes a choice of harness — meaning it can be integrated with various orchestration frameworks enterprises use to deploy and coordinate agents, such as OpenClaw and Hermes — as well as a model router and NVIDIA NeMo libraries for customization.
- case_details: 暂无公开信息
...
- risks_or_constraints: 在 COMPUTEX 上，NVIDIA 发布了 NemoClaw 平台，这是一个用于构建专业、长时间运行 AI 智能体的开放蓝图。该平台提供安全运行时、前沿模型支持以及多种编排框架集成选项，可通过 DGX Spark、数据中心或云端部署。其核心开源运行时 OpenShell 实施基于策略的安全管控，规范智能体对文件、网络和工具的访问。Cadence、达索系统、西门子、Synopsys 等十多家工业软件厂商正基于 NemoClaw 构建用于 CAE 和 EDA 工作流的自主 AI 工程师，旨在将原本需数周的仿真与设计任务压缩至数小时。
