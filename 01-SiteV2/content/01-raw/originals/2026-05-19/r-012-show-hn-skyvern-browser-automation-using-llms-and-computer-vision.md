...
original_url: "https://github.com/Skyvern-AI/skyvern"
canonical_url: "https://github.com/Skyvern-AI/skyvern"
...
search_path_label: ""
author: ""
published_at: "2024-03-14T16:31:34Z"
collected_at: 2026-05-19T05:27:29.841Z
language: mixed
full_text_hash: f934bf96550ecf22
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-19/r-012-show-hn-skyvern-browser-automation-using-llms-and-computer-vision.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-19/r-012-show-hn-skyvern-browser-automation-using-llms-and-computer-vision.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 1ca4fd1db6308d83
content_hash: ffebc77e71591390
semantic_hash: c3f188b8374194f4
duplicate_of: ""
first_seen_at: "2024-03-14T16:31:34Z"
last_seen_at: 2026-05-19T05:27:29.841Z
...
guanlan_scores: {"commercial_value":4,"novelty":3,"evidence_strength":4,"case_richness":5,"trend_relevance":5,"guanlan_relevance":5,"emerging_signal_score":4}
business_elements: {"companies":["Hacker News","Google","GitHub"],"products":["claude","AGENTS","CLAUDE","agent","agents","MCP"],"people":[],"industries":["制造 / 工业","开发者工具"],"roles":["CIO / IT 负责人","采购负责人"],"workflows":["计费 / 预算管理","权限 / 安全治理","采购 / 招投标","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","采购","销售 / 客服"],"numbers":["422","139","2","21.7","4","845","8","2.1"],"quotes":["Click the login button","Check if user is logged in",")\npage.click(prompt=",")\nFill\npage.fill(",")\npage.fill(prompt="]}
...
GitHub - Skyvern-AI/skyvern: Automate browser based workflows with AI · GitHub
Skip to content
Navigation Menu
Toggle navigation
Sign in
...
1. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   422 points / 139 comments / query=AI workflow automation procurement

2. **workflow_change**｜supports=daily_observation, heatmap, change, case, trend｜importance=medium｜confidence=high
   GitHub - Skyvern-AI/skyvern: Automate browser based workflows with AI · GitHub Skip to content Navigation Menu Toggle navigation Sign in Appearance settings Search or jump to.
...
- companies: Hacker News, Google, GitHub
...
- numbers: 422, 139, 2, 21.7, 4, 845, 8, 2.1
- quotes: Click the login button / Check if user is logged in / )
page.click(prompt= / )
Fill
page.fill( / )
page.fill(prompt=
...
- company_actions: Search code, repositories, users, issues, pull requests. / --> Search Clear Search syntax tips Provide feedback --> We read every piece of feedback, and take your input very seriously. / Include my email address so I can be contacted Cancel Submit feedback Saved searches Use saved searches to filter your results more quickly --> Name Query To see all available qualifiers, see our documentation .
- case_details: 暂无公开信息
- workflow_changes: 422 points / 139 comments / query=AI workflow automation procurement / GitHub - Skyvern-AI/skyvern: Automate browser based workflows with AI · GitHub Skip to content Navigation Menu Toggle navigation Sign in Appearance settings Search or jump to.
