...
original_url: "https://github.com/airlockrun/airlock/"
canonical_url: "https://github.com/airlockrun/airlock"
...
search_path_label: ""
author: ""
published_at: "2026-05-07T17:10:24Z"
collected_at: 2026-05-19T05:27:29.814Z
language: mixed
full_text_hash: 45fbc787abd74bdc
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-19/r-007-show-hn-airlock-self-upgrading-compiled-ai-agents.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-05-19/r-007-show-hn-airlock-self-upgrading-compiled-ai-agents.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 580cb824bf4b500b
content_hash: 45fbc787abd74bdc
semantic_hash: bdb690ef6dcce0d0
duplicate_of: ""
first_seen_at: "2026-05-07T17:10:24Z"
last_seen_at: 2026-05-19T05:27:29.814Z
...
guanlan_scores: {"commercial_value":5,"novelty":3,"evidence_strength":4,"case_richness":5,"trend_relevance":4,"guanlan_relevance":5,"emerging_signal_score":4}
business_elements: {"companies":["Hacker News","GitHub","AWS"],"products":["agents","agent","AGENTS","CLAUDE","MCP","Agent","Agents","Claude"],"people":[],"industries":["医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人"],"workflows":["权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["4","2","36","1","3","5","24","80"],"quotes":["Heroku for cyborg agents, but I run it myself","test it before relying on it,","I agree,"]}
...
GitHub - airlockrun/airlock · GitHub
Skip to content
Navigation Menu
Toggle navigation
Sign in
...
agentsdk — Go SDK that user agents import
goai — Go port of vercel/ai
sol — agent runtime / CLI utility
Contributing
...
1. **case_detail**｜supports=daily_observation, heatmap, case｜importance=high｜confidence=high
   4 points / 2 comments / query=AI coding agent enterprise deployment
...
- companies: Hacker News, GitHub, AWS
- products: agents, agent, AGENTS, CLAUDE, MCP, Agent, Agents, Claude
- people: 暂无公开信息
...
- numbers: 4, 2, 36, 1, 3, 5, 24, 80
- quotes: Heroku for cyborg agents, but I run it myself / test it before relying on it, / I agree,

## evidence_seed

- company_actions: GitHub - airlockrun/airlock · GitHub Skip to content Navigation Menu Toggle navigation Sign in Appearance settings Search or jump to. / Search code, repositories, users, issues, pull requests. / --> Search Clear Search syntax tips Provide feedback --> We read every piece of feedback, and take your input very seriously.
- case_details: 4 points / 2 comments / query=AI coding agent enterprise deployment
