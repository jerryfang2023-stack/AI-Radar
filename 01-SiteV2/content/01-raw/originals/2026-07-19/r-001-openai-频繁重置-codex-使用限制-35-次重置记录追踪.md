...
raw_id: R-001
title: "OpenAI 频繁重置 Codex 使用限制：35 次重置记录追踪"
title_zh: "OpenAI 频繁重置 Codex 使用限制：35 次重置记录追踪"
title_translation_status: not_required
title_translation_method: source_title
title_translation_model: not_applicable
original_url: "https://codex-resets.com/"
canonical_url: "https://codex-resets.com"
...
search_path_label: ""
author: ""
published_at: "2026-07-19T03:53:18.442Z"
collected_at: 2026-07-19T05:45:22.171Z
language: mixed
full_text_hash: e3320beed13c5c0e
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-19/r-001-openai-频繁重置-codex-使用限制-35-次重置记录追踪.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-19/r-001-openai-频繁重置-codex-使用限制-35-次重置记录追踪.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":9828,"paragraph_count":70,"sentence_count":113,"boilerplate_hits":0,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 9828
fetch_error: ""
...
discovery_record: {"discovery_title":"OpenAI 频繁重置 Codex 使用限制：35 次重置记录追踪","discovery_summary":"OpenAI 已累计 35 次重置 Codex 及 ChatGPT Work 的付费用户使用限制，平均间隔 8.9 天，最长间隔 67.7 天。最近一次重置于昨日进行，由 OpenAI 成员 @thsottiaux 在 X 平台宣布。重置通常伴随用户里程碑（如 9M 活跃用户）或系统问题修复，部分重置还向用户账户存入额外的一次性重置额度。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://codex-resets.com/","discovered_at":"2026-07-19T05:36:58.919Z","rank_on_page":13,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 1aed456d99162962
content_hash: e3320beed13c5c0e
semantic_hash: 249426dfadb802d7
duplicate_of: ""
first_seen_at: "2026-07-19T03:53:18.442Z"
last_seen_at: 2026-07-19T05:45:22.171Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","OpenAI"],"products":["Codex","ChatGPT","GPT-5","codex","gpt-5"],"people":[],"industries":["金融 / 保险","开发者工具"],"roles":[],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","财务 / 预算"],"numbers":["35 次","8.9","67.7","9M","35","26","100%","8M"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-19T05:45:22.171Z
theme: mature-commercial-signal
keyword_group: mature-commercial-signal
copyright_note: local research archive only
---

# OpenAI 频繁重置 Codex 使用限制：35 次重置记录追踪

## clean_text

Tracking when OpenAI's Codex usage limits get reset, announced (often out of the blue) by
@thsottiaux on X.
Last reset
yesterday
Total resets
...
67.7d
Reset activity
Last 26 weeks, one cell per day (UTC)
Mon Wed Fri
...
Thank you for pushing our systems to the absolute limit, we have never seen traffic increase so quickly. Keep the feedback
View on X &rarr;
&hellip;
&hellip;
...
@_rajanagarwal just joined to work on model research and push on coding capabilities. You can thank him for pressing the button today.
View on X &rarr;
&hellip;
&hellip;
...
We investigated reports that Codex usage was being consumed faster than expected. There wasn't one central issue, but a
View on X &rarr;
&hellip;
&hellip;
...
&hellip;
&hellip;
Codex incident is mitigated, seeing recovery. Lasted about 10 mins, Codex itself helped with the remediation, but ultimately the insight came from a human this time.
...
&hellip;
&hellip;
Codex is back up. We introduced an issue that caused requests to be blocked and rejected as high cyber risk. This was fixed in ~8 mins and we are now back online and fully operational.
...
&hellip;
&hellip;
Didn’t need to do this in a while, but you know the drill. We have reset everyone’s usage limits, enjoy more Codex and apologies for the disruption.
View on X &rarr;
&hellip;
&hellip;
We have reset the usage limits for everyone in Codex, which helps us mitigate the issue the fastest and the team will continue to work on the underlying cause. This should propagate to all users over the next 10 mins, enjoy and apologies for the confusion!
View on X &rarr;
&hellip;
&hellip;
We have reset rate limits for all Codex users to compensate for the unusual high latencies in or near the US in the previous hours. Grateful for the team working hard behind the scenes to keep Codex running 24/7.
I do recommend trying out GPT-5.1-Codex-Max too if you haven’t!
View on X &rarr;
&hellip;
&hellip;
Codex outage resolved.
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":9828,"paragraph_count":70,"sentence_count":113,"boilerplate_hits":0,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
1. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   OpenAI 已累计 35 次重置 Codex 及 ChatGPT Work 的付费用户使用限制，平均间隔 8.9 天，最长间隔 67.7 天。最近一次重置于昨日进行，由 OpenAI 成员 @thsottiaux 在 X 平台宣布。重置通常伴随用户里程碑（如 9M 活跃用户）或系统问题修复，部分重置还向用户账户存入额外的一次性重置额度。

2. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Tracking when OpenAI's Codex usage limits get reset, announced (often out of the blue) by @thsottiaux on X.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Last reset yesterday Total resets 35 Average interval Avg.
...
5. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   7d Reset activity Last 26 weeks, one cell per day (UTC) Mon Wed Fri Jan Feb Mar Apr May Jun Jul Announcement log &hellip; &hellip; Oops.
...
- products: Codex, ChatGPT, GPT-5, codex, gpt-5
- people: 暂无公开信息
...
- numbers: 35 次, 8.9, 67.7, 9M, 35, 26, 100%, 8M
- quotes: 暂无公开信息

## evidence_seed

- company_actions: OpenAI 已累计 35 次重置 Codex 及 ChatGPT Work 的付费用户使用限制，平均间隔 8.9 天，最长间隔 67.7 天。最近一次重置于昨日进行，由 OpenAI 成员 @thsottiaux 在 X 平台宣布。重置通常伴随用户里程碑（如 9M 活跃用户）或系统问题修复，部分重置还向用户账户存入额外的一次性重置额度。 / Tracking when OpenAI's Codex usage limits get reset, announced (often out of the blue) by @thsottiaux on X. / Last reset yesterday Total resets 35 Average interval Avg.
- case_details: 暂无公开信息
