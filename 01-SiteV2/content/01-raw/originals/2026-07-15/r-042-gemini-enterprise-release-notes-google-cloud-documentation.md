...
collected_at: 2026-07-15T04:28:37.822Z
language: mixed
full_text_hash: 6527f0dfe4254a11
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-042-gemini-enterprise-release-notes-google-cloud-documentation.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-042-gemini-enterprise-release-notes-google-cloud-documentation.json"
html_snapshot_path: ""
screenshot_path: ""
...
url_hash: 0abd52ecec451878
content_hash: 525ac2aaa34dea06
semantic_hash: 3f666cbc6cbb90a8
duplicate_of: ""
first_seen_at: "2026-07-14T00:00:00.000Z"
last_seen_at: 2026-07-15T04:28:37.822Z
...
business_elements: {"companies":["keyword search","Anysearch","Google","Microsoft","ServiceNow"],"products":["Gemini","agent","agents","MCP","Agent","gemini"],"people":[],"industries":["开发者工具","企业服务"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理","部署 / 集成交付"],"business_actions":["发布 / 推出","部署 / 上线"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["14","2026","09","07","06","1","2","3.5"],"quotes":["Made by Google"]}
...
fact_extraction_completed_at: 2026-07-15T04:28:37.822Z
...
Note: This documentation set is for the Standard, Plus, and Frontline editions of Gemini Enterprise. For the Business edition documentation, see the Gemini Enterprise - Business edition Help Center .
Home
Documentation
AI and ML
Gemini Enterprise
...
baselines.
For more information, see AlphaEvolve documentation .
July 07, 2026
Feature
...
when adding a data store. For more information, see Configure allowed data sources .
...
to. For more information, see Configure allowed egress FQDNs for data stores .
For an overview of these policies and how they interact, see Overview of managed policy constraints .
July 06, 2026
Feature
...
see Data residency for Gemini Enterprise Standard and Plus Editions .
June 30, 2026
Feature
...
Set up a Microsoft SharePoint data store and Add filters to a Microsoft SharePoint data store
Set up a Microsoft OneDrive data store and Add filters to a Microsoft OneDrive data store
Feature
...
Import agents from Agent Registry and
...
Airtable : Create bases, fields, tables, and
record comments; update tables.
Freshservice : Create tickets; place
service catalog item requests.
Google Stitch : Create and apply design
systems.
Zoho Desk : Create and update calls; send
replies; update tasks.
Zoho Projects : Create projects and
...
features .
Create and manage
skills (You need to be on the allowlist to access the page.)
Feature
...
Metrics : A default-on dashboard displaying session counts, latency, agent invocations, tool call counts, and error rate
...
Users can find comprehensive and relevant answers directly in the
...
May 20, 2026
Deprecated
Google NotebookLM Enterprise: The Podcast API is deprecated
The Podcast API is
...
You can connect Crossbeam data stores to Gemini Enterprise.
...
Manage features on the web app .
Feature
Google NotebookLM Enterprise: Create slide decks and infographics
You can create slide decks and infographics using
Google NotebookLM Enterprise. This feature is generally available (GA).
For more information on the usage limits, see Usage limits .
May 17, 2026
Feature
...
You can connect GitLab data stores to Gemini Enterprise.
...
information, see Connect to Google Sites .
Security
...
Blockscout
Open Targets
Apollo GraphOS MCP Tools
These data stores are in Public Preview. For more information, see
Connect a third-party data source .
April 30, 2026
Announcement
Gemini Enterprise: Access to Gemini 3.1 Pro and 3 Flash in Limited Availability
Gemini Enterprise users have access to 3.1 Pro and 3 Flash in Limited
Availability. This means that Gemini Enterprise app users get the generally
available Service Level Objectives (SLOs) for these models as part of the Gemini
Enterprise Service while the models are in Preview. We are currently monitoring
the model's performance and determining the appropriate, long-term (SLOs) and
plan to offer these SLOs soon. Additionally, we currently support standard Data
Location (Data Residency or "DRZ") commitments in US/EU/global multi-regions.
For more information, see: Using Gemini 3.1 Pro and 3 Flash in Limited Availability .
April 28, 2026
Feature
...
UI (A2UI) to build custom
interfaces and the Agent2Agent (A2A) Protocol for
...
April 20, 2026
Feature
Gemini Enterprise: Register ADK agents hosted on Agent Runtime
You can register ADK agents hosted on Agent Runtime with
Gemini Enterprise. This includes agents running within
Agent Runtime in a different Google Cloud project. This
feature is generally available (GA).
For more information, see:
Register and manage ADK agents hosted on Agent Runtime
Configure cross-project ADK agents
Feature
...
Add and manage A2A agents from Google Cloud Marketplace
April 15, 2026
Feature
...
April 02, 2026
Feature
Google NotebookLM Enterprise: Autocomplete for email addresses and group
...
Gmail
Google Drive
GitHub (Public Preview)
HubSpot (Public Preview)
Monday (Public Preview)
For a list of actions for these data stores, see Supported actions .
Feature
Gemini Enterprise: Connect Salesforce data using data federation
...
Feature
Gemini Enterprise and Google NotebookLM Enterprise: BSI C5:2020 compliance
Gemini Enterprise and Google NotebookLM Enterprise are certified for
...
You can configure filters for your Microsoft SharePoint data stores using
...
Notion (Public Preview)
Shopify (Public Preview)
For a list of actions for these data stores, see Supported actions .
Feature
...
Feature
Gemini Enterprise: Support for new actions
New actions are available for these data stores:
Confluence Data Center (Private Preview)
Jira Data Center (Private Preview)
Notion (Public Preview)
Zendesk (Public Preview)
For a list of actions for these data stores, see Supported actions .
Feature
...
This feature is generally available (GA). For more information, see Manage web app features .
Security
...
February 04, 2026
Feature
Gemini Enterprise and Google NotebookLM Enterprise: Usage audit logs available in Cloud Logging
Gemini Enterprise admins can access user query and response audit logs in
Cloud Logging for both Gemini Enterprise and Google NotebookLM Enterprise.
This feature is generally available (GA). For more information, see:
Configure usage audit logging for Gemini Enterprise
Configure usage audit logging for Google NotebookLM Enterprise
February 02, 2026
Feature
...
This feature is generally available (GA). For more information about mentions, see Add context with mentions .
January 26, 2026
Announcement
...
January 23, 2026
Feature
Gemini Enterprise: New actions in the unified view
...
Microsoft Outlook
Microsoft SharePoint
For a list of actions for these data stores, see
Supported actions .
January 12, 2026
Announcement
...
December 11, 2025
Feature
Gemini Enterprise: Monitor metrics for Google NotebookLM Enterprise
Admins can monitor Google NotebookLM Enterprise metrics in the Agents
tab of the Analytics page.
For more information, see
Metrics definitions .
Feature
Google NotebookLM Enterprise: Gemini model upgrade (Preview)
You can use Gemini 2.5 Flash with Google NotebookLM Enterprise.
This feature is in Public Preview.
December 08, 2025
Feature
...
The Analytics page has been enhanced
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Note: This documentation set is for the Standard, Plus, and Frontline editions of Gemini Enterprise.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   For the Business edition documentation, see the Gemini Enterprise - Business edition Help Center .

4. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   Home Documentation AI and ML Gemini Enterprise Resources Send feedback Gemini Enterprise release notes Stay organized with collections Save and categorize content based on your preferences.
...
- products: Gemini, agent, agents, MCP, Agent, gemini
- people: 暂无公开信息
...
- numbers: 14, 2026, 09, 07, 06, 1, 2, 3.5
- quotes: Made by Google

## evidence_seed

- company_actions: Note: This documentation set is for the Standard, Plus, and Frontline editions of Gemini Enterprise. / For the Business edition documentation, see the Gemini Enterprise - Business edition Help Center . / Home Documentation AI and ML Gemini Enterprise Resources Send feedback Gemini Enterprise release notes Stay organized with collections Save and categorize content based on your preferences.
- case_details: Gemini Enterprise release notes | Google Cloud Documentation # Gemini Enterprise release notes Stay organized with collections Save and categorize content based on your preferences. This page documents production updates to Gemini Enterprise. Check this page for announcements about new or updated ..... / query=enterprise AI transformation production rollout customer deployment / intent=find_original_source / path=official_original
