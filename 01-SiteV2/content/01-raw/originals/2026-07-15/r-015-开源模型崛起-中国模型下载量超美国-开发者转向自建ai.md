...
raw_id: R-015
title: "开源模型崛起：中国模型下载量超美国，开发者转向自建AI"
title_zh: "开源模型崛起：中国模型下载量超美国，开发者转向自建AI"
...
collected_at: 2026-07-15T04:28:37.618Z
language: mixed
full_text_hash: 27f4f82e661385fe
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-015-开源模型崛起-中国模型下载量超美国-开发者转向自建ai.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-015-开源模型崛起-中国模型下载量超美国-开发者转向自建ai.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7664,"paragraph_count":37,"sentence_count":46,"boilerplate_hits":0,"symbol_ratio":0.0003,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 7664
fetch_error: ""
...
discovery_record: {"discovery_title":"开源模型崛起：中国模型下载量超美国，开发者转向自建AI","discovery_summary":"今年春季，中国开源权重模型占Hugging Face下载量的41%，超越美国模型。OpenRouter上最受欢迎的六个模型均来自腾讯、小米、DeepSeek等中国公司，Anthropic的Claude Opus 4.7仅排第七。Vercel数据显示，6月开源模型处理了平台上近三分之一的AI请求。Hugging Face CEO认为企业更倾向拥有自己的AI模型，平台每7秒创建一个新仓库。微软CEO Satya Nadella警告企业应避免单一模型供应商锁定。","source_name":"TechCrunch：AI（RSS）","origin_url":"https://techcrunch.com/2026/07/14/the-real-ai-race-may-no-longer-be-at-the-frontier-open-models-hugging-face","discovered_at":"2026-07-15T04:20:27.127Z","rank_on_page":247,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: db5924ca844d0f68
content_hash: 27f4f82e661385fe
semantic_hash: d08bce3e91f6102b
duplicate_of: ""
first_seen_at: "2026-07-14T00:00:00.000Z"
last_seen_at: 2026-07-15T04:28:37.618Z
...
business_elements: {"companies":["TechCrunch","AI（RSS）","OpenAI","Anthropic","Microsoft","Meta","Apple"],"products":["Claude"],"people":[],"industries":["法律 / 法务","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["计费 / 预算管理","权限 / 安全治理"],"business_actions":["发布 / 推出","部署 / 上线","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["41%","4.7","6","7","24","14","2026","500"],"quotes":["one model to rule them all,","The biggest risk in AI is concentration of power,","The way you make the world safer, in my opinion, is by leveling up the playing fields and creating transparency on these models.","patch the cybersecurity risks that they already know open source models can exploit,","You don’t really make it safe by keeping it behind closed doors for just a few players,"]}
...
fact_extraction_completed_at: 2026-07-15T04:28:37.618Z
theme: developer-ecosystem-signal
keyword_group: developer-ecosystem-signal
copyright_note: local research archive only
---

# 开源模型崛起：中国模型下载量超美国，开发者转向自建AI
...
Topics
AI , Clem Delangue , Enterprise , Hugging Face , open models , open source
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7664,"paragraph_count":37,"sentence_count":46,"boilerplate_hits":0,"symbol_ratio":0.0003,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   今年春季，中国开源权重模型占Hugging Face下载量的41%，超越美国模型。OpenRouter上最受欢迎的六个模型均来自腾讯、小米、DeepSeek等中国公司，Anthropic的Claude Opus 4.7仅排第七。Vercel数据显示，6月开源模型处理了平台上近三分之一的AI请求。Hugging Face CEO认为企业更倾向拥有自己的AI模型，平台每7秒创建一个新仓库。微软CEO Satya Nadella警告企业应避免单一模型供应商锁定。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Image Credits: Idrees Abbas/SOPA Images/LightRocket / Getty Images AI The real AI race may no longer be at the frontier Rebecca Bellan 7:24 AM PDT · July 14, 2026 For several weeks this summer, the AI industry was fixated on Anthropic’s latest frontier models and Washington’s fight to control who was granted access to them.
...
4. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Chinese open-weight models accounted for 41% of downloads on Hugging Face this spring, surpassing U.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   On OpenRouter , the top six most popular models are all open models from Chinese firms, including Tencent, Xiaomi, DeepSeek, MiniMax, and Z.
...
- companies: TechCrunch, AI（RSS）, OpenAI, Anthropic, Microsoft, Meta, Apple
- products: Claude
- people: 暂无公开信息
...
- numbers: 41%, 4.7, 6, 7, 24, 14, 2026, 500
- quotes: one model to rule them all, / The biggest risk in AI is concentration of power, / The way you make the world safer, in my opinion, is by leveling up the playing fields and creating transparency on these models. / patch the cybersecurity risks that they already know open source models can exploit, / You don’t really make it safe by keeping it behind closed doors for just a few players,

## evidence_seed

- company_actions: Image Credits: Idrees Abbas/SOPA Images/LightRocket / Getty Images AI The real AI race may no longer be at the frontier Rebecca Bellan 7:24 AM PDT · July 14, 2026 For several weeks this summer, the AI industry was fixated on Anthropic’s latest frontier models and Washington’s fight to control who was granted access to them. / But while everyone was watching the frontier, developers kept building — and they weren’t waiting around for permission from the Anthropics and OpenAIs of the world. / On OpenRouter , the top six most popular models are all open models from Chinese firms, including Tencent, Xiaomi, DeepSeek, MiniMax, and Z.
- case_details: 暂无公开信息
