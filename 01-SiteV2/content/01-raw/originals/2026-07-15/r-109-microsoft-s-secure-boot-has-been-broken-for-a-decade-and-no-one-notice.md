...
canonical_url: "https://arstechnica.com/security/2026/07/microsoft-secure-boot-has-been-broken-for-most-of-its-existence"
...
search_path_label: ""
author: ""
published_at: "2026-07-14T22:20:48.000Z"
collected_at: 2026-07-15T04:28:38.186Z
language: mixed
full_text_hash: bae4fef48e621377
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-109-microsoft-s-secure-boot-has-been-broken-for-a-decade-and-no-one-notice.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-109-microsoft-s-secure-boot-has-been-broken-for-a-decade-and-no-one-notice.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":91,"text_length":12498,"paragraph_count":46,"sentence_count":104,"boilerplate_hits":2,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 12498
fetch_error: ""
...
url_hash: 1b46eb529064412c
content_hash: bae4fef48e621377
semantic_hash: 5d0348a2566d2e94
duplicate_of: ""
first_seen_at: "2026-07-14T22:20:48.000Z"
last_seen_at: 2026-07-15T04:28:38.186Z
...
business_elements: {"companies":["Ars Technica AI","Microsoft","Apple"],"products":[],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["权限 / 安全治理"],"business_actions":["发布 / 推出","合作 / 联盟"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["13","14","11","2013","2012","2018","2020","2022"],"quotes":["What makes these old shims dangerous is not a novel vulnerability,","In short, where dbx revokes binaries, SBAT and Microsoft’s Secure Boot SVN revoke versions,","This is a solid rebuke of the entire secure boot model,","The whole ecosystem is somewhat broken and needs a reboot.","not vulnerable"]}
...
fact_extraction_completed_at: 2026-07-15T04:28:38.186Z
theme: uncategorized
...
57 Comments
Staff Picks
Unaffected in that no additional steps are required to get your computer to boot a malicious image, yes.
I'm not advocating for or against Secure Boot here, but the lack of it makes you "not vulnerable" in the same way that you could say you're not affected by a defective seat belt because you don't wear one. It's technically true but you're still vulnerable to being launched from the vehicle so...
This issue works around a security mechanism, which you don't have. It doesn't cause any other vulnerability.
Honestly, SB has been security theater from the beginning because it depended on at least three entities the user and/or developers had no control over to certify the chain-of-trust is uncompromised. First, you have the chain of trust in what's called supervisor mode in the CPU itself. That's the Intel ME or AMD PSP for PCs. Both of those have had problems in the past. So that's the first problem. Your firmware image may or may not be compromised before you even get to the operating system boot sequence. Second problem is that the OS level boot sequence depends on Microsoft to keep the CA root of trust sacrosanct which signs all other intermediate level certificates for Windows, Linux distros, *BSD, etc. They've not been entirely trustworthy either. Third is the actual boot shim, which is the primary part I was alluding to in my earlier comment.
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":91,"text_length":12498,"paragraph_count":46,"sentence_count":104,"boilerplate_hits":2,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Skip to content Text settings Story text Size Small Standard Large Width Standard Wide Links Standard Orange * Subscribers only Learn more Minimize to nav An industry-wide standard Microsoft invented to protect Windows, and later Linux, devices from firmware infections has been trivial to bypass for 13 of its 14 years of existence.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   Using a technique simple enough to be performed by novice hackers, these old, forgotten shims can be used to completely circumvent the protection, which is embedded into the UEFI (Unified Extensible Firmware Interface) of the device’s motherboard.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=medium｜confidence=high
   The gaffe is the result of Microsoft, which oversees the signing of shims, failing to revoke the publicly available images once vulnerabilities were found in them.

## business_elements

- companies: Ars Technica AI, Microsoft, Apple
- products: 暂无公开信息
- people: 暂无公开信息
- industries: 开发者工具
...
- numbers: 13, 14, 11, 2013, 2012, 2018, 2020, 2022
- quotes: What makes these old shims dangerous is not a novel vulnerability, / In short, where dbx revokes binaries, SBAT and Microsoft’s Secure Boot SVN revoke versions, / This is a solid rebuke of the entire secure boot model, / The whole ecosystem is somewhat broken and needs a reboot. / not vulnerable

## evidence_seed

- company_actions: Old and forgotten "shims" Microsoft failed to revoke have made Secure Boot bypasses simple. / Skip to content Text settings Story text Size Small Standard Large Width Standard Wide Links Standard Orange * Subscribers only Learn more Minimize to nav An industry-wide standard Microsoft invented to protect Windows, and later Linux, devices from firmware infections has been trivial to bypass for 13 of its 14 years of existence. / The images are known as shims , which were invented to extend Secure Boot to Linux devices and utility software.
- case_details: 暂无公开信息
- workflow_changes: 暂无公开信息
- before_after_clues: 可能涉及 权限 / 安全治理 的前后变化，需要二搜补足变化前流程。
- affected_roles: CIO / IT 负责人, 开发者 / 工程团队
- risks_or_constraints: The discovery was made by researchers at security firm ESET after identifying 11 firmware images, at least one from 2013, that were known to be defective but remained signed by the software company anyway.
