...
raw_id: R-052
title: "xarray-sql：用SQL查询Xarray数据集的实验性项目"
title_zh: ""
...
canonical_url: "https://github.com/xqlsystems/xarray-sql/blob/claude/xarray-sql-mnist-demo/benchmarks/nn.py"
...
search_path_label: ""
author: ""
published_at: "2026-07-14T11:51:30.563Z"
collected_at: 2026-07-15T04:28:37.903Z
language: mixed
full_text_hash: 12f1ca37eb79b7eb
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-052-xarray-sql-用sql查询xarray数据集的实验性项目.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-052-xarray-sql-用sql查询xarray数据集的实验性项目.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":19037,"paragraph_count":320,"sentence_count":176,"boilerplate_hits":0,"symbol_ratio":0.0289,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 19037
fetch_error: ""
...
discovery_record: {"discovery_title":"xarray-sql：用SQL查询Xarray数据集的实验性项目","discovery_summary":"xarray-sql是一个开源实验项目，允许用户通过SQL查询Xarray数据集。该项目托管在GitHub上，旨在将SQL的便捷查询能力与Xarray的多维数组数据处理相结合，降低非Python用户访问科学数据的门槛。项目目前处于早期开发阶段，代码库已公开。","source_name":"Hacker News 热门（buzzing.cc 中文翻译）","origin_url":"https://github.com/xqlsystems/xarray-sql/blob/claude/xarray-sql-mnist-demo/benchmarks/nn.py","discovered_at":"2026-07-15T04:20:27.136Z","rank_on_page":280,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 66ae81ac75abdcb2
content_hash: 9f87465a08b5f252
semantic_hash: bfb10ca04a30bca7
duplicate_of: ""
first_seen_at: "2026-07-14T11:51:30.563Z"
last_seen_at: 2026-07-15T04:28:37.903Z
...
business_elements: {"companies":["Hacker News 热门（buzzing.cc 中文翻译）","GitHub"],"products":["claude"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究"],"business_actions":[],"affected_departments":["IT / 安全"],"numbers":["17","114","488","446","18.8","10","11","12"],"quotes":["\n# dependencies = [\n# ",",\n# ]\n# [tool.uv.sources]\n# xarray_sql = { path = ","\ntry :\nds = xr . open_dataset (\n"," ,\nengine = "," ,\nchunks = None ,\nbackend_kwargs = { "]}
...
fact_extraction_completed_at: 2026-07-15T04:28:37.903Z
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":19037,"paragraph_count":320,"sentence_count":176,"boilerplate_hits":0,"symbol_ratio":0.0289,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   xqlsystems xarray-sql Public Notifications You must be signed in to change notification settings Fork 17 Star 114 Files Expand file tree claude/xarray-sql-mnist-demo / nn.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   py Copy path Blame More file actions Blame More file actions Latest commit History History History 488 lines (446 loc) · 18.
...
6. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   8 KB claude/xarray-sql-mnist-demo / nn.
...
- numbers: 17, 114, 488, 446, 18.8, 10, 11, 12
- quotes:
# dependencies = [
#  / ,
# ]
...
- company_actions: xarray-sql是一个开源实验项目，允许用户通过SQL查询Xarray数据集。该项目托管在GitHub上，旨在将SQL的便捷查询能力与Xarray的多维数组数据处理相结合，降低非Python用户访问科学数据的门槛。项目目前处于早期开发阶段，代码库已公开。 / There was an error while loading. / Please reload this page .
- case_details: 暂无公开信息
