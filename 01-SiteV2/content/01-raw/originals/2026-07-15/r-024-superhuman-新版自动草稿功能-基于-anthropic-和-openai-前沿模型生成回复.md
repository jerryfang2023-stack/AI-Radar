...
collected_at: 2026-07-15T04:28:37.677Z
language: mixed
full_text_hash: 39bfd7d9f8aa1b9c
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-024-superhuman-新版自动草稿功能-基于-anthropic-和-openai-前沿模型生成回复.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-15/r-024-superhuman-新版自动草稿功能-基于-anthropic-和-openai-前沿模型生成回复.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":4694,"paragraph_count":30,"sentence_count":35,"boilerplate_hits":0,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 4694
fetch_error: ""
...
discovery_record: {"discovery_title":"Superhuman 新版自动草稿功能：基于 Anthropic 和 OpenAI 前沿模型生成回复","discovery_summary":"邮件客户端 Superhuman 推出新版自动草稿功能，可识别重要邮件并根据用户过往对话语气生成回复草稿，同时提供另外两个备选版本。测试阶段 40% 的自动生成草稿在一天内被发送，其中 60% 未经任何手动编辑。该功能由 Anthropic 和 OpenAI 的前沿模型混合驱动，取代了此前基于 GPT-3.5 的旧版即时回复功能。用户可在 Settings > Personalization 中添加个人信息和文件链接以个性化邮件。Superhuman 正同步构建跨平台智能助手 Superhuman Go。","source_name":"TechCrunch：AI（RSS）","origin_url":"https://techcrunch.com/2026/07/14/superhumans-new-auto-draft-feature-almost-makes-me-like-ai-replies","discovered_at":"2026-07-15T04:20:27.130Z","rank_on_page":257,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 7f403a4028bc9055
content_hash: 39bfd7d9f8aa1b9c
semantic_hash: 545c52f1438ff619
duplicate_of: ""
first_seen_at: "2026-07-14T00:00:00.000Z"
last_seen_at: 2026-07-15T04:28:37.677Z
...
business_elements: {"companies":["TechCrunch","AI（RSS）","OpenAI","Anthropic","Meta","Apple"],"products":["Claude"],"people":[],"industries":["法律 / 法务"],"roles":["销售 / 客服"],"workflows":["计费 / 预算管理"],"business_actions":["发布 / 推出","定价 / 计费变化","融资 / 投资"],"affected_departments":["IT / 安全","法务","销售 / 客服"],"numbers":["40%","60%","3.5","7","00","14","2026","42"],"quotes":[]}
...
fact_extraction_completed_at: 2026-07-15T04:28:37.677Z
...
Topics
AI , AI assistant , Apps , email , superhuman
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":4694,"paragraph_count":30,"sentence_count":35,"boilerplate_hits":0,"symbol_ratio":0.0002,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   邮件客户端 Superhuman 推出新版自动草稿功能，可识别重要邮件并根据用户过往对话语气生成回复草稿，同时提供另外两个备选版本。测试阶段 40% 的自动生成草稿在一天内被发送，其中 60% 未经任何手动编辑。该功能由 Anthropic 和 OpenAI 的前沿模型混合驱动，取代了此前基于 GPT-3.5 的旧版即时回复功能。用户可在 Settings > Personalization 中添加个人信息和文件链接以个性化邮件。Superhuman 正同步构建跨平台智能助手 Superhuman Go。
...
2. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   Image Credits: Superhuman Apps Superhuman’s new auto-draft feature almost makes me like AI replies Ivan Mehta 7:00 AM PDT · July 14, 2026 Since the large language model (LLM) explosion started, companies have been trying to solve the problem of overflowing inboxes by using AI to categorize emails and draft replies that sound like you.
...
- numbers: 40%, 60%, 3.5, 7, 00, 14, 2026, 42
- quotes: 暂无公开信息

## evidence_seed

- company_actions: Image Credits: Superhuman Apps Superhuman’s new auto-draft feature almost makes me like AI replies Ivan Mehta 7:00 AM PDT · July 14, 2026 Since the large language model (LLM) explosion started, companies have been trying to solve the problem of overflowing inboxes by using AI to categorize emails and draft replies that sound like you. / Email client Superhuman is launching a new version of its auto-draft feature that identifies important emails and creates draft replies that sound less robotic. / Superhuman has attempted this in the past with features like instant replies and follow-up auto-drafts.
- case_details: 暂无公开信息
- workflow_changes: However, a lot of those emails sounded like an overly enthusiastic AI salesperson, and I didn’t use them much.
