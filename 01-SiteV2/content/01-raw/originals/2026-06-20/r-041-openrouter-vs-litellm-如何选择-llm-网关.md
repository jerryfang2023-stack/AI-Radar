...
original_url: "https://openrouter.ai/blog/insights/openrouter-vs-litellm"
canonical_url: "https://openrouter.ai/blog/insights/openrouter-vs-litellm"
...
collected_at: 2026-06-20T05:50:41.986Z
language: mixed
full_text_hash: 7a665d6603948d07
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-20/r-041-openrouter-vs-litellm-如何选择-llm-网关.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-06-20/r-041-openrouter-vs-litellm-如何选择-llm-网关.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":7802,"paragraph_count":60,"sentence_count":69,"boilerplate_hits":0,"symbol_ratio":0.0046,"method":"main"}
has_full_text: true
content_length: 7802
fetch_error: ""
...
discovery_record: {"discovery_title":"OpenRouter vs LiteLLM：如何选择 LLM 网关","discovery_summary":"OpenRouter 是托管在 Cloudflare 边缘的 LLM 网关，无需管理基础设施，收取 5.5% 平台费（前 100 万次请求免费），支持 70+ 提供商和自动故障转移。LiteLLM 是自部署代理（Docker/PostgreSQL/Redis），数据不离开内网，免费开源，但需承担基础设施成本（生产部署约数百美元/月）。当模型月支出超过约 $3，600（基础设施 $200/月）或 $9，100（基础设施 $500/月）时自托管更划算。LiteLLM 提供六种路由策略和自定义 Python 路由；OpenRouter 具备 SOC 2、GDPR 认证和零数据保留选项。两者可串联使用。","source_name":"OpenRouter：Announcements（RSS）","origin_url":"https://openrouter.ai/blog/insights/openrouter-vs-litellm","discovered_at":"2026-06-20T05:46:01.046Z","rank_on_page":119,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 0a136d9d844a9dd7
content_hash: 7a665d6603948d07
semantic_hash: 0bd0b50cee59d201
duplicate_of: ""
first_seen_at: "2026-06-19T15:00:00.000Z"
last_seen_at: 2026-06-20T05:50:41.986Z
...
business_elements: {"companies":["OpenRouter","Announcements（RSS）","OpenAI","Anthropic"],"products":["claude"],"people":[],"industries":["企业服务"],"roles":["开发者 / 工程团队","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["部署 / 上线","定价 / 计费变化"],"affected_departments":["IT / 安全","财务 / 预算","销售 / 客服"],"numbers":["5.5%","100 万","70","$3","600","$200","$9","100"],"quotes":["your-openrouter-key","https://openrouter.ai/api/v1","your-openrouter-key","https://openrouter.ai/api/v1","https://openrouter.ai/api/v1"]}
...
title_zh: "OpenRouter vs LiteLLM：如何选择 LLM 网关"
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":7802,"paragraph_count":60,"sentence_count":69,"boilerplate_hits":0,"symbol_ratio":0.0046,"method":"main"}
...
3. **supporting_context**｜supports=daily_observation, heatmap｜importance=high｜confidence=high
   OpenRouter &middot; 6/19/2026 On this page Decide where the routing layer lives What each gateway costs Compare routing, failover, and latency Match compliance needs to the right gateway Use both, or switch in a few lines Frequently asked questions If you’re choosing between OpenRouter and LiteLLM for a production gateway, the decision comes down to where the routing layer should run.

4. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   Both give you a single OpenAI-compatible API across many providers.

5. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   OpenRouter runs that layer for you, so there’s no infrastructure to operate.

6. **company_action**｜supports=daily_observation, heatmap, change, case, trend｜importance=high｜confidence=high
   LiteLLM runs inside your own infrastructure, so your data stays on your network and you pay no platform fee, in exchange for operating PostgreSQL, Redis, and Docker yourself.

## business_elements

- companies: OpenRouter, Announcements（RSS）, OpenAI, Anthropic
- products: claude
- people: 暂无公开信息
- industries: 企业服务
...
- numbers: 5.5%, 100 万, 70, $3, 600, $200, $9, 100
- quotes: your-openrouter-key / https://openrouter.ai/api/v1 / your-openrouter-key / https://openrouter.ai/api/v1 / https://openrouter.ai/api/v1

## evidence_seed

- company_actions: OpenRouter vs LiteLLM: Which LLM Gateway Fits Your Stack? / Both give you a single OpenAI-compatible API across many providers. / OpenRouter runs that layer for you, so there’s no infrastructure to operate.
- case_details: 暂无公开信息
...
- risks_or_constraints: OpenRouter &middot; 6/19/2026 On this page Decide where the routing layer lives What each gateway costs Compare routing, failover, and latency Match compliance needs to the right gateway Use both, or switch in a few lines Frequently asked questions If you’re choosing between OpenRouter and LiteLLM for a production gateway, the decision comes down to where the routing layer should run.
