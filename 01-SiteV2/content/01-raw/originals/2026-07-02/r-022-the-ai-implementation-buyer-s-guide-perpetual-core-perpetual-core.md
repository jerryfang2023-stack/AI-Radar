...
raw_id: R-022
title: "The AI Implementation Buyer's Guide — Perpetual Core | Perpetual Core"
original_url: "https://perpetualcore.com/guide/ai-implementation-buyers-guide"
canonical_url: "https://perpetualcore.com/guide/ai-implementation-buyers-guide"
...
author: ""
published_at: ""
collected_at: 2026-07-02T02:28:35.235Z
language: mixed
full_text_hash: a8773d89fc386a2d
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-022-the-ai-implementation-buyer-s-guide-perpetual-core-perpetual-core.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-022-the-ai-implementation-buyer-s-guide-perpetual-core-perpetual-core.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":8931,"paragraph_count":57,"sentence_count":114,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
has_full_text: true
content_length: 8931
fetch_error: ""
...
url_hash: cca494d7fa924687
content_hash: a8773d89fc386a2d
semantic_hash: 7c33c08a015f89bd
duplicate_of: ""
first_seen_at: "2026-07-02T02:28:35.235Z"
last_seen_at: 2026-07-02T02:28:35.235Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Anthropic","Google"],"products":["ChatGPT","Claude"],"people":[],"industries":["法律 / 法务","金融 / 保险","医疗","开发者工具"],"roles":["CIO / IT 负责人","开发者 / 工程团队","法务 / 律师","采购负责人","销售 / 客服"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","采购 / 招投标","部署 / 集成交付"],"business_actions":["定价 / 计费变化"],"affected_departments":["IT / 安全","法务","财务 / 预算","采购","销售 / 客服"],"numbers":["$75","$250","1","25","$1","500","$3","$18"],"quotes":["hire us.","two weeks, $5K","Improve productivity","Reduce intake-form processing from 12 min to under 3 min per case","we think it was about an hour."]}
...
# The AI Implementation Buyer's Guide — Perpetual Core | Perpetual Core
...
- fetch_status: fetched-readable-text-article
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":8931,"paragraph_count":57,"sentence_count":114,"boilerplate_hits":0,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"article"}
...
1. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   / query=AI implementation technical scoping production rollout / intent=find_original_source / path=procurement_marketplace
...
2. **number**｜supports=signal_card_candidate, relationship_graph_input, case, trend_candidate_context｜importance=high｜confidence=high
   Executive summary Production AI implementation at an organizational layer costs $75K–$250K in year one, regardless of who you hire.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The variable is who pockets the margin: an SI consultancy, a freelance prompt engineer, an in-house team, or a focused studio like ours.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The install fails not because of bad models or bad prompts — it fails because outcome evaluation gets skipped, and nobody can answer whether it worked.
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   This guide walks operators through what to budget, what to demand from vendors, what to put in the contract, and — most usefully — when to walk away from an AI install entirely.
...
6. **workflow_change**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   It's vendor-agnostic; we wrote it because the conversations we have on our own first sales calls keep repeating the same evaluation gaps, and most of the time the right answer for the buyer is not "hire us.
...
- numbers: $75, $250, 1, 25, $1, 500, $3, $18
- quotes: hire us. / two weeks, $5K / Improve productivity / Reduce intake-form processing from 12 min to under 3 min per case / we think it was about an hour.

## evidence_seed

- company_actions: The variable is who pockets the margin: an SI consultancy, a freelance prompt engineer, an in-house team, or a focused studio like ours. / The install fails not because of bad models or bad prompts — it fails because outcome evaluation gets skipped, and nobody can answer whether it worked. / This guide walks operators through what to budget, what to demand from vendors, what to put in the contract, and — most usefully — when to walk away from an AI install entirely.
- case_details: 暂无公开信息
- workflow_changes: / query=AI implementation technical scoping production rollout / intent=find_original_source / path=procurement_marketplace / It's vendor-agnostic; we wrote it because the conversations we have on our own first sales calls keep repeating the same evaluation gaps, and most of the time the right answer for the buyer is not "hire us.
