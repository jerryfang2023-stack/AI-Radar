...
original_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.198"
canonical_url: "https://github.com/anthropics/claude-code/releases/tag/v2.1.198"
...
search_path_label: ""
author: ""
published_at: "2026-07-01T20:45:36.000Z"
collected_at: 2026-07-02T02:28:35.149Z
language: mixed
full_text_hash: e302541d08bdb7db
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-005-claude-code-v2-1-198-发布.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-005-claude-code-v2-1-198-发布.json"
html_snapshot_path: ""
screenshot_path: ""
...
discovery_record: {"discovery_title":"Claude Code v2.1.198 发布","discovery_summary":"Claude Code v2.1.198 更新。Claude in Chrome 现已全面可用。为 claude agents 新增后台智能体通知（agent_needs_input / agent_completed）。新增 /dataviz 技能，提供图表与仪表盘设计指导及配色验证器。Gateway 增加 AWS 上的 Claude Platform 作为上游提供商。后台智能体在 worktree 中完成代码后自动提交、推送并创建草稿 PR。内置 Explore 智能体现继承主会话模型（上限 opus）。修复网络短暂断开导致响应中断、后台任务卡在\"Running\"状态、智能体团队队友因 API 错误失败等问题。","source_name":"Claude Code：GitHub Releases（RSS）","origin_url":"https://github.com/anthropics/claude-code/releases/tag/v2.1.198","discovered_at":"2026-07-02T02:12:32.498Z","rank_on_page":79,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: 354f1b8cfb3f00d1
content_hash: e302541d08bdb7db
semantic_hash: 3192a9c50dfcc7d1
duplicate_of: ""
first_seen_at: "2026-07-01T20:45:36.000Z"
last_seen_at: 2026-07-02T02:28:35.149Z
...
business_elements: {"companies":["Claude Code","GitHub Releases（RSS）","AWS"],"products":["Claude","claude","agents","agent"],"people":[],"industries":["开发者工具"],"roles":["CIO / IT 负责人"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全"],"numbers":["2.1","198","21.8","135","01","20","45","75709"],"quotes":[" after they finish or after resuming a session\nFixed agent teams: a teammate that dies on an API error now reports ","Please run /login","no route to host","Cannot determine working directory","Reconnecting…"]}
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":4374,"paragraph_count":39,"sentence_count":11,"boilerplate_hits":0,"symbol_ratio":0.0014,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
5. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   198 Latest Latest Compare Choose a tag to compare Sorry, something went wrong.
...
- products: Claude, claude, agents, agent
- people: 暂无公开信息
- industries: 开发者工具
- roles: CIO / IT 负责人
...
- numbers: 2.1, 198, 21.8, 135, 01, 20, 45, 75709
- quotes:  after they finish or after resuming a session
Fixed agent teams: a teammate that dies on an API error now reports  / Please run /login / no route to host / Cannot determine working directory / Reconnecting…
