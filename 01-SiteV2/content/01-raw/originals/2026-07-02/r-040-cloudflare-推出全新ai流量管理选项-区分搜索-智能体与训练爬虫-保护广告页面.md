...
collected_at: 2026-07-02T02:28:35.341Z
language: mixed
full_text_hash: a66f5390c4e945b3
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-040-cloudflare-推出全新ai流量管理选项-区分搜索-智能体与训练爬虫-保护广告页面.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-040-cloudflare-推出全新ai流量管理选项-区分搜索-智能体与训练爬虫-保护广告页面.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":97,"text_length":16704,"paragraph_count":79,"sentence_count":101,"boilerplate_hits":0,"symbol_ratio":0.0007,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
has_full_text: true
content_length: 16704
fetch_error: ""
...
discovery_record: {"discovery_title":"Cloudflare 推出全新AI流量管理选项：区分搜索、智能体与训练爬虫，保护广告页面","discovery_summary":"Cloudflare 为所有网站所有者提供更精细的AI流量管控选项，取代一刀切的屏蔽方式。用户可轻松区分并管理搜索爬虫、AI智能体爬虫和训练爬虫，同时新增保护广告变现页面的能力。","source_name":"Cloudflare Blog","origin_url":"https://blog.cloudflare.com/content-independence-day-ai-options","discovered_at":"2026-07-02T02:12:32.530Z","rank_on_page":191,"discovery_status":"discovered"}
source_role: resolved_original_source
origin_fetch_status: "success"
paywall_status: none
block_status: none
duplicate_status: unique
url_hash: f0a020308d633279
content_hash: a66f5390c4e945b3
semantic_hash: 3e25bf1b67559841
duplicate_of: ""
first_seen_at: "2026-07-01T13:00:00.000Z"
last_seen_at: 2026-07-02T02:28:35.341Z
...
business_elements: {"companies":["Cloudflare Blog","OpenAI","Google"],"products":["agent","Agent","ChatGPT","agents","Gemini","Claude"],"people":[],"industries":["医疗","开发者工具","企业服务"],"roles":["CIO / IT 负责人","开发者 / 工程团队"],"workflows":["合同审阅 / 法律研究","权限 / 安全治理"],"business_actions":["发布 / 推出"],"affected_departments":["IT / 安全","销售 / 客服"],"numbers":["2026","07","01","10 m","30","1","2025","15"],"quotes":["Block AI Bots","block all automation, every time.","Block AI bots","content use.","allow all bots that are used for Search , SEO , and Ads Verification , but only up to the reference use level."]}
...
Content Independence Day AI Bots AI Crawler Hints Bot Management
...
- fetch_status: fetched-readable-text-main
- extraction_quality: high
- diagnostics: {"readability_score":97,"text_length":16704,"paragraph_count":79,"sentence_count":101,"boilerplate_hits":0,"symbol_ratio":0.0007,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"main"}
...
2. **case_detail**｜supports=signal_card_candidate, relationship_graph_input, case｜importance=high｜confidence=high
   Your site, your rules: new AI traffic options for all customers 2026-07-01 Jin-Hee Lee Bryan Becker 10 min read One year ago, we declared the first Content Independence Day , and we gave website owners the means to take back control of their content.
...
3. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   The deal between crawlers and website owners that had held up for 30 years — we crawl you, and you get referrals — was no longer true.
...
4. **company_action**｜supports=signal_card_candidate, relationship_graph_input, business_change, case, trend_candidate_context｜importance=high｜confidence=high
   AI was taking everything and sending back nothing, presenting an existential threat to website owners.
...
- companies: Cloudflare Blog, OpenAI, Google
- products: agent, Agent, ChatGPT, agents, Gemini, Claude
- people: 暂无公开信息
...
- numbers: 2026, 07, 01, 10 m, 30, 1, 2025, 15
- quotes: Block AI Bots / block all automation, every time. / Block AI bots / content use. / allow all bots that are used for Search , SEO , and Ads Verification , but only up to the reference use level.

## evidence_seed

- company_actions: Cloudflare 为所有网站所有者提供更精细的AI流量管控选项，取代一刀切的屏蔽方式。用户可轻松区分并管理搜索爬虫、AI智能体爬虫和训练爬虫，同时新增保护广告变现页面的能力。 / The deal between crawlers and website owners that had held up for 30 years — we crawl you, and you get referrals — was no longer true. / AI was taking everything and sending back nothing, presenting an existential threat to website owners.
- case_details: Your site, your rules: new AI traffic options for all customers 2026-07-01 Jin-Hee Lee Bryan Becker 10 min read One year ago, we declared the first Content Independence Day , and we gave website owners the means to take back control of their content.
