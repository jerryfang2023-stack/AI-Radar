...
original_url: "https://theaiinsider.tech/2026/07/01/engram-launches-with-98m-to-build-ai-that-actually-knows-your-organization/"
canonical_url: "https://theaiinsider.tech/2026/07/01/engram-launches-with-98m-to-build-ai-that-actually-knows-your-organization"
...
author: ""
published_at: ""
collected_at: 2026-07-02T02:28:35.320Z
language: mixed
full_text_hash: f7105d727554bb38
markdown_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-037-engram-launches-with-98m-to-build-ai-that-actually-knows-your-organiza.md"
json_snapshot_path: "01-SiteV2/content/01-raw/originals/2026-07-02/r-037-engram-launches-with-98m-to-build-ai-that-actually-knows-your-organiza.json"
html_snapshot_path: ""
screenshot_path: ""
...
extractor_diagnostics: {"readability_score":79,"text_length":11566,"paragraph_count":58,"sentence_count":60,"boilerplate_hits":6,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
has_full_text: true
content_length: 11566
fetch_error: ""
...
url_hash: 545f2125959036ae
content_hash: f7105d727554bb38
semantic_hash: 04d73e7286024084
duplicate_of: ""
first_seen_at: "2026-07-02T02:28:35.320Z"
last_seen_at: 2026-07-02T02:28:35.320Z
...
business_elements: {"companies":["keyword search","Anysearch","OpenAI","Microsoft","Meta"],"products":["agents","agent"],"people":[],"industries":["法律 / 法务","医疗","制造 / 工业","开发者工具","企业服务"],"roles":["CIO / IT 负责人","法务 / 律师"],"workflows":["合同审阅 / 法律研究","计费 / 预算管理","部署 / 集成交付"],"business_actions":["发布 / 推出","合作 / 联盟","部署 / 上线","融资 / 投资"],"affected_departments":["IT / 安全","法务","财务 / 预算"],"numbers":["$98M","100x","2026","1","7 m","365","70","000"],"quotes":["Whatever the AI knows about you is improvised on the spot — a sticky note about your past, a document pulled mid-conversation,","If we can anticipate your interactions, we can prepare memories ahead of time instead of pasting them on the fly.","We do that studying once, ahead of time, training the model to compress everything it learns into a compact memory it can reuse on every query.","Our customers have built up extraordinary knowledge inside Microsoft 365, and we’ve only begun to tap what it can do for them,","Memory is the missing ingredient in AI,"]}
...
7 min read
Insider Brief
Engram has emerged from stealth with $98M in funding from General Catalyst, Kleiner Perkins, and Sequoia Capital, building a learned memory layer that trains AI models to study an organization’s world in advance, enabling them to match or outperform frontier models while using up to 100x fewer tokens.
Founded by a team of researchers from Stanford, Berkeley, and Cornell, including CEO Dan Biderman and CTO Sabri Eyuboglu, the company’s approach compresses large bodies of organizational knowledge into compact, reusable model memory that improves continuously the longer it is used.
Engram has launched with early commercial partnerships including Microsoft, Notion, and Harvey, with the Microsoftcollaboration focused on testing its memory layer within Microsoft 365, and is backed by notable angels including Andrej Karpathy, co-founder of OpenAI, and Assaf Rappaport, co-founder and CEO of Wiz.
PRESS RELEASE — Engram, the company building the learned memory layer for AI, has emerged from stealth with $98M in funding from General Catalyst, Kleiner Perkins, Sequoia Capital, Factory, Modern, Amplify Partners, Neo and notable angels and advisors including Assaf Rappaport, co-founder and CEO of Wiz, Andrej Karpathy, co-founder of OpenAI, and Pieter Abbeel, AI and robotics pioneer and co-director of the Berkeley AI Research Lab.
...
The numbers are in, and they are striking. Artificial intelligence is no longer a technology category defined by potential. It is a force defined by
James Dargan
July 1, 2026
AI Funding & Investment , AI Research & Advances
AI Chatbots Adopt Human Power Dynamics, Raising Safety Concerns in High-Stakes Deployments
A new study from the University of North Carolina at Chapel Hill has found that large language models mirror human social hierarchies, adjusting their behavior based on
James Dargan
July 1, 2026
AI Funding & Investment
Taktile Secures $110M in Goldman Sachs-Led Series C to Power AI Transformation in Financial Institutions
Insider Brief PRESS RELEASE — Taktile, the leader in AI transformation for financial institutions, has announced its $110 million Series C fundraise. Growth Equity at
James Dargan
July 1, 2026
...
- fetch_status: fetched-readable-text-content-container
- extraction_quality: high
- diagnostics: {"readability_score":79,"text_length":11566,"paragraph_count":58,"sentence_count":60,"boilerplate_hits":6,"symbol_ratio":0,"replacement_count":0,"replacement_ratio":0,"control_count":0,"control_ratio":0,"binary_marker_count":0,"mojibake_marker_count":0,"binary_contaminated":false,"mojibake_contaminated":false,"method":"content-container"}
...
1. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   - Engram has emerged from stealth with $98M in funding from General Catalyst, Kleiner Perkins, and Sequoia Capital, building a learned memory layer that trains AI models to study an organization’s world in advance, enabling them to match or outperform frontier models while using up to 100x fewer tok... / query=vertical AI startup funding enterprise agents announced 2026 / intent=find_startups / path=capital_startup
...
2. **funding**｜supports=signal_card_candidate, relationship_graph_input, trend_candidate_context｜importance=high｜confidence=high
   Skip to content AI Funding & Investment Engram Launches with $98M to Build AI That Actually Knows Your Organization James Dargan July 1, 2026 7 min read Insider Brief Engram has emerged from stealth with $98M in funding from General Catalyst, Kleiner Perkins, and Sequoia Capital, building a learned memory layer that trains AI models to study an organization’s world in advance, enabling them to match or outperform frontier models while using up to 100x fewer tokens.
...
6. **product_update**｜supports=signal_card_candidate, relationship_graph_input, business_change｜importance=high｜confidence=high
   The announcement comes as enterprises are confronting a growing and costly problem: the AI their employees use every day is a brilliant stranger.

## business_elements

- companies: keyword search, Anysearch, OpenAI, Microsoft, Meta
...
- numbers: $98M, 100x, 2026, 1, 7 m, 365, 70, 000
- quotes: Whatever the AI knows about you is improvised on the spot — a sticky note about your past, a document pulled mid-conversation, / If we can anticipate your interactions, we can prepare memories ahead of time instead of pasting them on the fly. / We do that studying once, ahead of time, training the model to compress everything it learns into a compact memory it can reuse on every query. / Our customers have built up extraordinary knowledge inside Microsoft 365, and we’ve only begun to tap what it can do for them, / Memory is the missing ingredient in AI,

## evidence_seed

- company_actions: - Engram has emerged from stealth with $98M in funding from General Catalyst, Kleiner Perkins, and Sequoia Capital, building a learned memory layer that trains AI models to study an organization’s world in advance, enabling them to match or outperform frontier models while using up to 100x fewer tok... / query=vertical AI startup funding enterprise agents announced 2026 / intent=find_startups / path=capital_startup / Skip to content AI Funding & Investment Engram Launches with $98M to Build AI That Actually Knows Your Organization James Dargan July 1, 2026 7 min read Insider Brief Engram has emerged from stealth with $98M in funding from General Catalyst, Kleiner Perkins, and Sequoia Capital, building a learned memory layer that trains AI models to study an organization’s world in advance, enabling them to match or outperform frontier models while using up to 100x fewer tokens. / Founded by a team of researchers from Stanford, Berkeley, and Cornell, including CEO Dan Biderman and CTO Sabri Eyuboglu, the company’s approach compresses large bodies of organizational knowledge into compact, reusable model memory that improves continuously the longer it is used.
- case_details: 暂无公开信息
