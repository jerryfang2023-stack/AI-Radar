window.WaveSightOpsConsole = {
  "portfolio": {
    ...
    "versions": [
      ...
      },
      {
        "key": "OPS",
        "label": "整体运营后台",
        "value": "OPS-V3.6.0-community-lifecycle",
        "category": "运营与规则",
        "source": "context/version-ledger.md",
        "status": "仓库基线",
        "kind": "source",
  ...
  "meta": {
    "version": "OPS-V3.6.0-community-lifecycle",
    "generatedAt": "2026-09-04T05:29:34.853Z",
    "date": "2026-09-04",
    "sources": [
  ...
  "tasks": {
    ...
    "stages": [
      {
        ...
        "counts": {
          "discovered": 290,
          "capture_succeeded": 277,
          "capture_failed": 6,
          "recovered_source_failures": 6,
          "raw_documents": 277
        },
        "evidence": [
          "01-SiteV2/content/11-databases/data-center-v4/2026-09-04/manifest.json",
          "agent-workflow/reports/2026-09-04-guanlan-daily-monitor-log.md",
          "agent-workflow/reports/2026-09-04-guanlan-monitor-quality-gate.md"
        ]
      },
      {
        "id": "fact_build",
        ...
        "evidence": [
          "01-SiteV2/content/11-databases/data-center-v4/2026-09-04/manifest.json",
          "agent-workflow/reports/2026-09-04-data-center-v4-integrity-gate.json"
        ]
      },
      {
        ...
        "evidence": [
          "agent-workflow/reports/2026-09-04-persistent-asset-manifest.json"
        ]
      },
      {
        "id": "publication",
    ...
    "sync": [
      ...
      },
      {
        ...
        "status": "passed",
        "detail": "2026-09-03T09:54:07.422Z"
      },
      {
  ...
  "quality": {
    "telemetry": {
      "meta": {
        ...
        "ops_version": "OPS-V3.6.0-community-lifecycle",
        "data_date": "2026-09-04",
        "generated_at": "2026-09-04T05:25:29.554Z",
        "scope": "OPS",
      ...
      "v4Gate": {
        "status": "passed",
        "manifest_date": "2026-09-04",
        "gate_date": "2026-09-04",
        "failures": [],
        "warnings": [
    ...
    "sourceQuality": {
      "updatedAt": "2026-09-04T05:29:34.843Z",
