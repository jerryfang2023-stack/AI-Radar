window.WaveSightOpsConsole = {
  "meta": {
    ...
    "generatedAt": "2026-07-30T03:19:10.597Z",
    "date": "2026-07-30",
    "sources": [
  ...
  "inbox": {
    ...
    "resolved": [
      ...
      {
        "id": "2026-06-14-skill_ops-monitor-or-gate-failure",
        "date": "2026-06-14",
        "title": "Hermes Repair Request: Skill Ops Governance",
        "status": "resolved",
        "state": "resolved",
        ...
        "category": "monitor_or_gate_failure",
        "failedGate": "skill_ops daily supervision",
        "reportPath": "agent-workflow/reports/2026-06-14-daily-supervision-report.md",
        "dataGenerated": "not_applicable",
        "neededAction": "repair the owning Guanlan skill metadata, evals, examples, registry, or .skill-store mirror",
        "createdAt": "2026-06-14T03:17:19+08:00",
        "updatedAt": "2026-06-14T16:08:07+08:00",
        "resolvedAt": "2026-06-14T16:08:07+08:00",
        "resolver": "codex",
        "fixCommit": "pending-local-change",
        "validation": "npm run audit:skills && npm run check:skill-ops",
        "prevention": "context",
        "sourceFile": "agent-workflow/inbox/hermes-to-codex/2026-06-14-skill_ops-monitor-or-gate-failure.md"
      },
      {
        "id": "2026-06-14-community_intelligence-monitor-or-gate-failure",
        "date": "2026-06-14",
        "title": "Hermes Repair Request: Community Intelligence",
        "status": "resolved",
        "state": "resolved",
        ...
        "neededAction": "send Codex a community_intelligence repair request with log and gate report path",
        "createdAt": "2026-06-14T03:17:19+08:00",
        "updatedAt": "2026-06-14T03:20:11+08:00",
        "resolvedAt": "2026-06-14T03:20:11+08:00",
        "resolver": "codex",
        "fixCommit": "pending-local-change",
        "validation": "npm run supervise:daily -- --date=2026-06-14",
        "prevention": "gate",
        "sourceFile": "agent-workflow/inbox/hermes-to-codex/2026-06-14-community_intelligence-monitor-or-gate-failure.md"
      },
      {
        "id": "2026-06-14-first_line_viewpoints-monitor-or-gate-failure",
        "date": "2026-06-14",
        "title": "Hermes Repair Request: First-Line Viewpoints",
        "status": "resolved",
        "state": "resolved",
        ...
        "reportPath": "agent-workflow/reports/2026-06-14-daily-supervision-report.md",
        "dataGenerated": "no_or_stale",
        "neededAction": "send Codex a first_line_viewpoints repair request with gate report path",
        "createdAt": "2026-06-14T03:17:19+08:00",
        "updatedAt": "2026-06-14T03:20:11+08:00",
        "resolvedAt": "2026-06-14T03:20:11+08:00",
        "resolver": "codex",
        ...
        "validation": "npm run supervise:daily -- --date=2026-06-14",
        "prevention": "gate",
        "sourceFile": "agent-workflow/inbox/hermes-to-codex/2026-06-14-first_line_viewpoints-monitor-or-gate-failure.md"
      }
    ]
  },
  "tasks": {
    ...
    "stages": [
      {
        ...
        "counts": {
          "discovered": 290,
          "capture_succeeded": 179,
          "capture_failed": 1,
          "raw_documents": 179
        },
        "evidence": [
          "01-SiteV2/content/11-databases/data-center-v4/2026-07-30/manifest.json",
          "agent-workflow/reports/2026-07-30-guanlan-daily-monitor-log.md"
        ]
      },
      {
        "id": "fact_build",
        ...
        "evidence": [
          "01-SiteV2/content/11-databases/data-center-v4/2026-07-30/manifest.json",
          "agent-workflow/reports/2026-07-30-data-center-v4-integrity-gate.json"
        ]
      },
      {
        ...
        "evidence": [
          "agent-workflow/reports/2026-07-30-persistent-asset-manifest.json"
        ]
      },
      {
        "id": "publication",
    ...
    "sync": [
      ...
      },
      {
        ...
        "status": "passed",
        "detail": "2026-07-30T03:19:10.553Z"
      },
      {
  ...
  "quality": {
    "telemetry": {
      "meta": {
        ...
        "generated_at": "2026-07-30T03:19:10.493Z",
        "scope": "OPS",
      ...
      "v4Gate": {
        "status": "passed",
        "manifest_date": "2026-07-30",
        "gate_date": "2026-07-30",
        "failures": [],
        "warnings": [
    ...
    "pipelineMeta": {
      "version": "OPS-V2.0.0-v4-telemetry",
      "generatedAt": "2026-07-30T03:19:10.553Z",
      "dateRange": {
        "start": "2026-07-24",
        "end": "2026-07-30"
      },
  ...
  "governance": {
    "versions": [
      ...
      },
      {
        "key": "SKILL",
        "label": "Skill Store",
        "value": "v1.8.0 V4 retirement governance"
      }
    ],
    "principles": [
      "问题先进入问题中心，不在聊天里丢失",
