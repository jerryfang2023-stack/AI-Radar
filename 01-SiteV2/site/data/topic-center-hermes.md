...
|---:|---:|---|---|---|---|---|
| 1 | 97 | 漏钱型 | 一个空调公司用 AI 接住 13个 电话，老板们该醒醒了 | 旺季电话漏接、线索忘跟、预约登记错，都会变成真实订单损失。 | 先算少漏几个客户，再谈 AI 转型；接得住、记得准、转得动，就是收入入口的第一张账。 | 先盘点公司 3 个最容易漏单的入口：电话、表单、私信。 |
...
- community_lead / community_intelligence: 花3个月时间，我把10年设计经验沉淀搭建自己专属的Skills，全方位接管我的虚拟电商和公众号内容（附搭建流程）
  ...
  - local: 01-SiteV2/site/data/community-intelligence-daily/2026-06-14.json#id=6798abf6c699cc
...
- viewpoint_lead / first_line_viewpoint: 敬畏SpaceX及其故事--过去、现在和未来。你可以用10多种不同的方式来思考，并继续在圈子里重新思考。恭喜团队！ 🚀
  ...
  - local: 01-SiteV2/site/data/follow-builders-daily.json#id=2065490793092337691
