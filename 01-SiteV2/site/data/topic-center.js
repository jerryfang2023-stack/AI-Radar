window.WaveSightTopicCenter = {
  "meta": {
    ...
    "date": "2026-06-28",
    "generatedAt": "2026-06-28T06:54:32.466Z",
    ...
    "leadTopicId": "money_leak-面向代理机构的营销-ai-agent-部署手册"
  },
  "sources": [
    {
      "id": "money_leak",
  ...
  "grouped": {
    ...
    "byEngine": {
      ...
      "save_headcount": [
        {
          "id": "save_headcount-github-案例研究-用-ai-增强客户支持",
          "sourceId": "save_headcount",
          "sourceName": "省人型",
          "sourceDesc": "少招人、少返工、少加班",
          "type": "boss_decision_topic",
          ...
          "audience": "企业老板 / 创业者 / 业务负责人",
          "core": "AI 进入企业的第一步，不是替代一个完整的人，而是接住岗位里反复发生、规则清楚、结果可验收的动作。",
          "relevance": "来源材料显示，GitHub case study 的AI 商业动作涉及销售和收入团队流程；原文同时出现 60%、7 m 等数字。；这类信号比“AI 很强”更接近老板的组织账。",
          "bossPain": "人越招越多，流程没有变短，管理成本反而被重复动作拖住。",
          "moneyLine": "少招一个重复岗位，或让一个岗位少返工 30%，老板才会觉得 AI 是投入，不是玩具。",
          "oldFrame": "AI 上线就是裁员。",
          "newFrame": "AI 上线的第一阶段，是把岗位动作拆小，让公司少招重复岗位。",
          "actionHint": "选一个岗位，列出每天重复最多的 5 个动作，先交给 AI 试跑其中 1 个。",
          "evidence": "GitHub 案例研究：用 AI 增强客户支持；世界杯得分策略：阿根廷：将球传给梅西葡萄牙：将球传给罗纳尔多英格兰：将球传给凯恩西班牙：将球传给拉马尔法国：将球传给Mbappé或Dembélé或Olise或Doué或Barcola或Cherki或Thuram；小红书工作室3-4人小团队搭建指南：场地/招聘/培训/SOP和薪资设计经验分享",
          "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
          "sourceInputs": {
            "businessSignals": [
              {
          ...
          "angles": [
            ...
            {
              "title": "给一个当天可做的小动作",
              "note": "用 用 AI 增强客户支持 做例子，把大流程拆成一个可验收动作。"
            }
          ],
          "writingStructure": [
            "开头 3 句内给冲突或数字",
      ...
      "peer_pressure": [
        {
          ...
          "newFrame": "AI 是同行正在重做经营速度的生产系统。",
          "actionHint": "每周只问团队一个问题：同行哪一个动作已经被 AI 缩短了，我们要不要跟？",
          "evidence": "用 Codex + Obsidian，把装修行业经验做成标准化知识库产品，2个月服务18个企业；面向代理机构的营销 AI Agent 部署手册；世界杯得分策略：阿根廷：将球传给梅西葡萄牙：将球传给罗纳尔多英格兰：将球传给凯恩西班牙：将球传给拉马尔法国：将球传给Mbappé或Dembélé或Olise或Doué或Barcola或Cherki或Thuram",
          "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
          "sourceInputs": {
            "businessSignals": [
              {
      ...
      "pitfall": [
        {
          "id": "pitfall-github-案例研究-用-ai-增强客户支持",
          "sourceId": "pitfall",
          "sourceName": "避坑型",
          "sourceDesc": "工具乱买、权限失控、流程没拆",
          "type": "boss_decision_topic",
          ...
          "audience": "企业老板 / 创业者 / 业务负责人",
          "core": "AI 从生成内容走向执行动作后，企业问题从“会不会用”变成“谁审核、谁授权、谁负责”。",
          "relevance": "来源材料显示，GitHub case study 的AI 商业动作涉及销售和收入团队流程；原文同时出现 60%、7 m 等数字。；这类信号适合写给老板看，因为它直接关系到业务风险。",
          "bossPain": "AI 一旦能读文件、写内容、调工具、改数据，错误就不只是内容不好，而可能变成业务事故。",
          "moneyLine": "权限没管住，省下的人力钱可能被一次合规、法务或数据事故吃掉。",
          "oldFrame": "AI 越自主越好。",
          "newFrame": "AI 越自主，越要先设计权限、复核和责任人。",
          ...
          "angles": [
            ...
            {
              "title": "用当天案例推进",
              "note": "用 用 AI 增强客户支持 做钩子，落到企业内部的授权和复核表。"
            }
          ],
          "writingStructure": [
            "开头 3 句内给冲突或数字",
