window.WaveSightTopicCenter = {
  "meta": {
    "version": "V1.2.0",
    "date": "2026-06-05",
    "generatedAt": "2026-06-05T07:22:54.553Z",
  ...
  "topics": [
    ...
    },
    {
      ...
      "evidence": "Hacker News · 382 points · binyu",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 382 points · binyu"
        },
        {
    ...
    },
    {
      ...
      "relevance": "Hacker News 社区高活跃讨论，反映产业焦点和开发者早期反馈。",
      "evidence": "Hacker News · 191 points · jenders",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 191 points · jenders"
        },
        {
    ...
    {
      "id": "industry_chain-hn-48392004-6",
      "sourceId": "industry_chain",
      "sourceName": "产业链分析",
      "sourceDesc": "arXiv / HN / 官方博客",
      "subSource": "Hacker News",
      ...
      "relevance": "Hacker News 社区高活跃讨论，反映产业焦点和开发者早期反馈。",
      "evidence": "Hacker News · 762 points · littlexsparkee",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 762 points · littlexsparkee"
        },
        {
    ...
    },
    {
      ...
      "relevance": "Hacker News 社区高活跃讨论，反映产业焦点和开发者早期反馈。",
      "evidence": "Hacker News · 434 points · meetpateltech",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 434 points · meetpateltech"
        },
        {
    ...
    },
    {
      ...
      "relevance": "Hacker News 社区高活跃讨论，反映产业焦点和开发者早期反馈。",
      "evidence": "Hacker News · 149 points · geoffbp",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 149 points · geoffbp"
        },
        {
