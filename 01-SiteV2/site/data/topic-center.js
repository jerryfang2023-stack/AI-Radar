window.WaveSightTopicCenter = {
  ...
  "topics": [
    ...
    },
    {
      ...
      "evidence": "Hacker News · 408 points · EvanZhouDev",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 408 points · EvanZhouDev"
        },
        {
    ...
    },
    {
      ...
      "relevance": "Hacker News 社区高活跃讨论，反映产业焦点和开发者早期反馈。",
      "evidence": "Hacker News · 120 points · berlianta",
      "source": "Hacker News",
      ...
      "angles": [
        {
          ...
          "note": "切口：先写事件，再判断钱会落在算力、工具、集成、渠道还是客户现场。可用事实：Hacker News · 120 points · berlianta"
        },
        {
