window.WaveSightTopicCenter = {
  "meta": {
    ...
    "date": "2026-06-15",
    "generatedAt": "2026-06-15T07:56:17.792Z",
  ...
  "topics": [
    ...
    },
    {
      ...
      "evidence": "亚马逊等六家公司据报引发政府对 Anthropic Fable 模型的打压；欢迎来到AI治理的AGI时代；我用 AI 搭了条内容流水线，每天省下 3 小时，把时间全花在接单上",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
    ...
    },
    {
      ...
      "evidence": "aws 应用 agentic AI；13岁少年35美元启动，靠AI帮线下诊所月入13万",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
    ...
    },
    {
      ...
      "evidence": "亚马逊等六家公司据报引发政府对 Anthropic Fable 模型的打压；欢迎来到AI治理的AGI时代；AI虚拟电商全链路作战系统：用Obsidian+Claude Code一个人跑通选品、做品、写笔记到出单",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
