window.WaveSightTopicCenter = {
  "meta": {
    ...
    "date": "2026-06-22",
    "generatedAt": "2026-06-22T03:55:07.022Z",
    ...
    "leadTopicId": "money_leak-accenture-case-study-记录企业应用场景-采购下单流程"
  },
  "sources": [
    {
      "id": "money_leak",
  ...
  "topics": [
    {
      "id": "money_leak-accenture-case-study-记录企业应用场景-采购下单流程",
      "sourceId": "money_leak",
      "sourceName": "漏钱型",
      "sourceDesc": "订单入口、转化漏斗、线索流失",
      "type": "boss_decision_topic",
      "title": "Accenture Case Study 记录企业应用场景：采购下单流程",
      "spreadTitle": "Accenture Case Study 记录企业应用场景：采购下单流程",
      "audience": "企业老板 / 创业者 / 业务负责人",
      "core": "流量、搜索、来电、表单和私信，本质上都是订单入口。AI 先改变的不是工具栏，而是客户从看见你到联系你的路径。",
      "relevance": "来源材料显示，Accenture Case Study 的产品或平台动作涉及采购下单流程；原文同时出现 fortune 500 等数字。；社群里也出现了“公众号新人30天变现7000+，我是如何用微信贴图…”这类一线反馈。",
      ...
      "evidence": "Accenture Case Study 记录企业应用场景：采购下单流程；公众号新人30天变现7000+，我是如何用微信贴图来快速起号，靠发公众号文章来扩大收益的复盘",
      ...
      "angles": [
        {
          "title": "开头直接问漏钱",
          "note": "不要先讲 Accenture Case Study 记录企业… 多新，先问老板：这个入口今天带来多少咨询、漏掉多少跟进？"
        },
        {
          "title": "中段拆入口链路",
      ...
      "originalTitle": "Accenture Case Study 记录企业应用场景：采购下单流程"
    },
    {
      "id": "small_role-it-记录企业应用场景-销售和收入团队流程",
      "sourceId": "small_role",
      "sourceName": "小岗位型",
      "sourceDesc": "客服、销售、财务、标书、运营",
      "type": "boss_decision_topic",
      "title": "IT 记录企业应用场景：销售和收入团队流程",
      "spreadTitle": "IT 记录企业应用场景：销售和收入团队流程",
      "audience": "企业老板 / 创业者 / 业务负责人",
      "core": "普通老板和服务商的机会，不在宏大平台，而在一个具体岗位、一个明确动作、一个可验收结果里。",
      "relevance": "来源材料显示，IT 的客户部署或应用案例涉及销售和收入团队流程；原文同时出现 40% 等数字。；这类材料说明岗位级 AI 比大而全平台更容易落地。",
      ...
      "evidence": "IT 记录企业应用场景：销售和收入团队流程；Brazilian 记录企业应用场景：采购下单流程；超级术：这篇产品调研干货：帮你避开90%独立开发者起步坑",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
          ...
          },
          {
            "kind": "business_signal",
            "id": "SIG-20260622-A17",
            "title": "Brazilian 记录企业应用场景：采购下单流程",
      ...
      "forbiddenFrame": "不要写成 AI 功能介绍、工具教程或泛泛趋势分析。",
      "originalTitle": "IT 记录企业应用场景：销售和收入团队流程"
    },
    {
      "id": "counterintuitive-ai-记录企业应用场景-地产开发和建筑设计流程",
      "sourceId": "counterintuitive",
      "sourceName": "反常识型",
      "sourceDesc": "推翻流行说法，形成可传播判断",
      "type": "boss_decision_topic",
      "title": "AI 记录企业应用场景：地产开发和建筑设计流程",
      "spreadTitle": "AI 记录企业应用场景：地产开发和建筑设计流程",
      "audience": "企业老板 / 创业者 / 业务负责人",
      "core": "反常识点在于：AI 越强，越不是所有人都被替代，而是会拆任务、会验收结果的人更值钱。",
      "relevance": "来源材料显示，AI 的客户部署或应用案例涉及地产开发和建筑设计流程。；社群里“全自动化月上百站，单月净赚3700刀：游戏攻略站底…”的讨论也在提醒老板，问题不再只是怎么做。",
      ...
      "evidence": "AI 记录企业应用场景：地产开发和建筑设计流程；sqlite-utils 4.0rc1添加迁移和嵌套事务；全自动化月上百站，单月净赚3700刀：游戏攻略站底层玩法+新手全套SOP",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
      ...
      "forbiddenFrame": "不要写成 AI 功能介绍、工具教程或泛泛趋势分析。",
      "originalTitle": "AI 记录企业应用场景：地产开发和建筑设计流程"
    },
    {
      "id": "big_small_contrast-week-s-10-biggest-funding-rounds-发布-ai-平台能力-面向企业-agent-协作平台",
      "sourceId": "big_small_contrast",
      "sourceName": "大小对照型",
      "sourceDesc": "大融资对照小生意，大模型对照小岗位",
      "type": "boss_decision_topic",
      "title": "Week's 10 Biggest Funding Rounds 发布 AI 平台能力，面向企业 Agent 协作平台",
      "spreadTitle": "Week's 10 Biggest Funding Rounds 发布 AI 平台能力，面向企业 Agent 协作平台",
      "audience": "企业老板 / 创业者 / 业务负责人",
      "core": "大新闻负责告诉你资本往哪里押，小机会负责告诉你老板明天愿意为什么付钱。",
      "relevance": "来源材料显示，Week's 10 Biggest Funding Rounds 的融资或资金流向涉及企业智能体协作流程；原文同时出现 $100 m 等数字。；同时社群里的“这篇产品调研干货：帮你避开90%独立开发者起步坑”说明一线需求还在配置、流程和交付。",
      ...
      "evidence": "Week's 10 Biggest Funding Rounds 发布 AI 平台能力，面向企业 Agent 协作平台；AIAgent的临时Cloudflare帐户；超级术：这篇产品调研干货：帮你避开90%独立开发者起步坑",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
      ...
      "forbiddenFrame": "不要写成 AI 功能介绍、工具教程或泛泛趋势分析。",
      "originalTitle": "Week's 10 Biggest Funding Rounds 发布 AI 平台能力，面向企业 Agent 协作平台"
    },
    {
      ...
      "evidence": "普通人怎么赚到1000万？；AI 记录企业应用场景：地产开发和建筑设计流程；sqlite-utils 4.0rc1添加迁移和嵌套事务",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
    ...
    },
    {
      ...
      "evidence": "公众号新人30天变现7000+，我是如何用微信贴图来快速起号，靠发公众号文章来扩大收益的复盘；Accenture Case Study 记录企业应用场景：采购下单流程；sqlite-utils 4.0rc1添加迁移和嵌套事务",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
    ...
    {
      "id": "save_headcount-brazilian-记录企业应用场景-采购下单流程",
      "sourceId": "save_headcount",
      "sourceName": "省人型",
      "sourceDesc": "少招人、少返工、少加班",
      "type": "boss_decision_topic",
      "title": "Brazilian 记录企业应用场景：采购下单流程",
      "spreadTitle": "Brazilian 记录企业应用场景：采购下单流程",
      "audience": "企业老板 / 创业者 / 业务负责人",
      "core": "AI 进入企业的第一步，不是替代一个完整的人，而是接住岗位里反复发生、规则清楚、结果可验收的动作。",
      "relevance": "来源材料显示，Brazilian 的AI 商业动作涉及采购下单流程；原文同时出现 $120 m 等数字。；这类信号比“AI 很强”更接近老板的组织账。",
      ...
      "evidence": "Brazilian 记录企业应用场景：采购下单流程；AIAgent的临时Cloudflare帐户；全自动化月上百站，单月净赚3700刀：游戏攻略站底层玩法+新手全套SOP",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
      ...
      "angles": [
        ...
        {
          "title": "给一个当天可做的小动作",
          "note": "用 Brazilian 记录企业应用场景：采购下单流程 做例子，把大流程拆成一个可验收动作。"
        }
      ],
      "writingStructure": [
        "开头 3 句内给冲突或数字",
      ...
      "forbiddenFrame": "不要写成 AI 功能介绍、工具教程或泛泛趋势分析。",
      "originalTitle": "Brazilian 记录企业应用场景：采购下单流程"
    },
    {
