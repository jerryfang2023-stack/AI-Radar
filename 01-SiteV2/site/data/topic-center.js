window.WaveSightTopicCenter = {
  "meta": {
    ...
    "date": "2026-06-14",
    "generatedAt": "2026-06-14T08:10:03.961Z",
  ...
  "topics": [
    ...
    },
    {
      ...
      "evidence": "Claude Fable 5 在 FrontierMath 最难题目上超越 GPT-5.5 13 个百分点；techcrunch 融资；花3个月时间，我把10年设计经验沉淀搭建自己专属的Skills，全方位接管我的虚拟电商和公众号内容（附搭建流程）",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
    ...
    },
    {
      ...
      "evidence": "techcrunch 融资；敬畏SpaceX及其故事--过去、现在和未来。你可以用10多种不同的方式来思考，并继续在圈子里重新思考。恭喜团队！ 🚀；帮AI零基础发小搞定AI基建，给老板做服务能年入几十万",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
    ...
    },
    {
      ...
      "evidence": "Anthropic 暂停新模型访问，印度辩论 AI 未来；敬畏SpaceX及其故事--过去、现在和未来。你可以用10多种不同的方式来思考，并继续在圈子里重新思考。恭喜团队！ 🚀；帮AI零基础发小搞定AI基建，给老板做服务能年入几十万",
      "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
      "sourceInputs": {
        "businessSignals": [
          {
