window.WaveSightTopicCenter = {
  "meta": {
    ...
    "date": "2026-06-25",
    "generatedAt": "2026-06-25T03:26:38.418Z",
  ...
  "grouped": {
    ...
    "byEngine": {
      ...
      "save_headcount": [
        {
          "id": "save_headcount-数据推翻-ai-取代论-工程师岗位成科技行业抗风险最强工种",
          "sourceId": "save_headcount",
          "sourceName": "省人型",
          "sourceDesc": "少招人、少返工、少加班",
          "type": "boss_decision_topic",
          ...
          "audience": "企业老板 / 创业者 / 业务负责人",
          "core": "AI 进入企业的第一步，不是替代一个完整的人，而是接住岗位里反复发生、规则清楚、结果可验收的动作。",
          "relevance": "Challenger 数据显示 5 月科技行业裁员创单月新高，AI 是主因。但 SignalFire 追踪 8000 万企业员工轨迹后发布报告称，大型科技企业整体招聘量较 2019 年下降 25%，工程岗位降幅仅 11%；2025 年新入…；这类信号比“AI 很强”更接近老板的组织账。",
          "bossPain": "人越招越多，流程没有变短，管理成本反而被重复动作拖住。",
          "moneyLine": "少招一个重复岗位，或让一个岗位少返工 30%，老板才会觉得 AI 是投入，不是玩具。",
          "oldFrame": "AI 上线就是裁员。",
          "newFrame": "AI 上线的第一阶段，是把岗位动作拆小，让公司少招重复岗位。",
          ...
          "angles": [
            ...
            {
              "title": "给一个当天可做的小动作",
              "note": "用 工程师岗位成科技行业抗风险最强工种 做例子，把大流程拆成一个可验收动作。"
            }
          ],
          "writingStructure": [
            "开头 3 句内给冲突或数字",
      ...
      "peer_pressure": [
        {
          ...
          "newFrame": "AI 是同行正在重做经营速度的生产系统。",
          "actionHint": "每周只问团队一个问题：同行哪一个动作已经被 AI 缩短了，我们要不要跟？",
          "evidence": "用 Codex + Obsidian，把装修行业经验做成标准化知识库产品，2个月服务18个企业；AI研究员持续从Google流向竞争对手；引用Tom MacWright的话",
          "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
          "sourceInputs": {
            "businessSignals": [
              {
      ...
      "big_small_contrast": [
        {
          ...
          "audience": "企业老板 / 创业者 / 业务负责人",
          "core": "大新闻负责告诉你资本往哪里押，小机会负责告诉你老板明天愿意为什么付钱。",
          "relevance": "Hang Ten Systems是一家企业AI服务公司，由前Infosys CEO Vishal Sikka创立，旨在通过AI驱动的开发和自动化帮助企业持续构建、修改和运营软件。公司完成3200万美元种子轮融资，由Mayfield领投，A…；同时社群里的“全自动化月上百站，单月净赚3700刀：游戏攻略站底…”说明一线需求还在配置、流程和交付。",
          "bossPain": "老板看不懂大融资，但能理解谁帮他把一个具体业务动作跑起来。",
          "moneyLine": "大公司赚基础设施的钱，小服务商赚落地第一公里的钱。",
          "oldFrame": "AI 创业只能跟大模型和融资有关。",
          "newFrame": "普通人的 AI 机会在帮老板跨过配置、流程和交付门槛。",
          "actionHint": "把服务产品化：诊断一个流程、配置一套工具、交付一个可复用动作。",
          "evidence": "前Infosys CEO Vishal Sikka创立Hang Ten Systems，挑战IT服务行业；引用Tom MacWright的话；全自动化月上百站，单月净赚3700刀：游戏攻略站底层玩法+新手全套SOP",
          "evidenceBoundary": "商业信号用于事实底座；一线观点和社群情报只作为传播线索与需求线索，写稿前不得把社群结果直接写成行业事实。",
          "sourceInputs": {
            "businessSignals": [
              {
