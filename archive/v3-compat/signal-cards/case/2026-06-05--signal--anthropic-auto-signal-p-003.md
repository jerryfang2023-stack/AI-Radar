...
opportunity_signals:
  ...
  delivery_model: []
  pain_or_constraint: []
  adoption_evidence: ["enterprise_plan", "third_party_report"]
  source_evidence_type: ["funding_news", "business_media"]
  evidence_basis: "raw_source_text"
  source_excerpt: "Anthropic 报告递归式自我改进进展 Anthropic 报告递归式自我改进进展 Anthropic 近日发表文章《当人工智能自我构建：我们在递归式自我改进方面的进展》，报告其在递归式自我改进方面的进展，探讨 AI 系统自我构建的能力。该文章发布在 Hacker News 上。"
...
做了什么：Anthropic 把 AI 用进模型部署和算力调用。

证据是什么：来源为 https://www.anthropic.com/institute/recursive-self-improvement，对应本地证据 R-003，材料已保留全文、哈希和出处。
