...
title: "GitHub 仓库：julianoczkowski/designer-skills"
date: 2026-05-25
status: published
...
opportunity_signals:
  ...
  source_excerpt: "julianoczkowski/designer-skills julianoczkowski/designer-skills Repository: julianoczkowski/designer-skills # Designer Skills for Claude Code & Cursor A collection of agent skills for designers who prototype and build w..."
  missing_fields: ["adoption_evidence", "delivery_model"]

event: "julianoczkowski/designer 发布新的 AI 能力，面向地产开发和建筑设计流程。"
...
signal_owner: "julianoczkowski/designer"
watch_reason: "未来 30 到 90 天观察是否出现客户名单、部署指标、定价变化或二次融资信号。"

frontend:
  displayTitle: "GitHub 仓库：julianoczkowski/designer-skills"
  eventLine: "julianoczkowski/designer 发布新的 AI 能力，面向地产开发和建筑设计流程。"
...
# GitHub 仓库：julianoczkowski/designer-skills

## 信号底稿

谁：julianoczkowski/designer。

做了什么：julianoczkowski/designer 发布新的 AI 能力，面向地产开发和建筑设计流程。

证据是什么：来源为 https://github.com/julianoczkowski/designer-skills，对应本地证据 R-027，材料已保留全文、哈希和出处。

缺什么：目前能确认事件方向；客户规模、留存和效果指标仍需后续材料验证。

## 发生了什么

julianoczkowski/designer 发布新的 AI 能力，面向地产开发和建筑设计流程。
