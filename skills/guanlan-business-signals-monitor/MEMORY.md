...
The 2026-06-09 morning incident happened before the V3.3.3 lane split was recorded. Historical 08:00 schedule failures should now be interpreted through the current 09:07 Asia/Shanghai workflow: use a watchdog/manual dispatch after the current schedule window, not a return to exact-hour cron.
