...
- Current Funding Insights inventory: 251 accepted application cards aggregate to 231 public company-round cards. The `2026-08-04` bundle contains three auto-published cards with no blocked event; all 244 published funding events have reviewed `TAG-V4.1` decisions, and unresolved product/person names remain in the evidence-backed entity review queue.
