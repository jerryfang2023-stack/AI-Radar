...
- The current backend is OPS-V3.8.0-engineering-integration at `https://www.zkdlj.vip/ops/`: one authenticated operations entry for the Data Center, Funding Portal, Mini Program, financing H5 and community membership. The login uses an allowlisted email challenge and an HttpOnly, SameSite=Strict VPS session. Membership & Entitlements owns separate persistent navigation for community application review, community-member lifecycle, Mini Program user operations and activity scheduling; each loads only its protected data when opened. Successful Mini Program member adjustments close the editor and return to the list. GitHub Pages excludes the console and its operational assets.
...
- Current column versions: First-Line Viewpoints `FLV-V1.1.0-history-backfill`, Community Intelligence `CINT-V1.4.2-vi-alignment`, Trend Radar `TRADAR-V1.1.0-tag-v4-1`, Funding Insights `FUNDING-INSIGHT-V1.5.0-china-market`, financing portal `FUNDING-PORTAL-V2.8.4`, report publication `REPORTS-V1.3.0-funding-portal`, Opportunity Map `OMAP-V2.0.0-v4-evidence`.
- Domestic financing discovery runs independently through `china-funding-pr.yml`, dispatched alongside overseas monitoring at 08:10; shared factual and application publication stages use the existing serialization lock. The independent lane shares V4 evidence contracts, never infers company geography from publisher location, and keeps source types descriptive without ranking weights. See `docs/china-funding-monitor.md`.
- Current person review contract: `PERSON-REVIEW-V1.1`; the original 37 person/account candidates yielded 31 public natural people and 6 quarantined accounts, followed by 30 reviewed funding people and 161 reviewed China funding people. Company-scoped identity and exact-source quote replay govern admission; the China review retains 16 person-company candidates pending further evidence.
...
- Current accepted Funding Insights projection for 2026-09-13: 400 cards, including 144 China-market cards and 256 overseas cards. The daily bundle contains five accepted cards, with four net-new company/round groups; prior source disclosures remain retained. Mini Program policy continues to hide robotic-system cards. Website and Mini Program delivery is confirmed by their matching publication receipts, not by this repository count alone. Portal `91ead5d8038c` aligns PC person resource keys with protected content; runtime content updates do not require a new Mini Program upload.
...
- Current Windows automation contract: four tasks (08:10 domestic/overseas financing and other Business Signals production plus conditional Builder RSS, 08:30 Community, 16:10 Follow Builders, 16:45 Final Closure). Daily inspection and repair are operator-owned. Recovery, Closure and Hermes watchdog timers are retired; manual commands remain available. Morning catch-up remains eligible until 16:45. Final Closure owns data-lake refresh and publication sync.
