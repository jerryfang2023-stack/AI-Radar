...
- Current Funding Insights inventory: 300 accepted application cards aggregate to 275 public financing-event cards through 2026-08-25. The 2026-08-25 intake produces a valid empty bundle: the General Intuition disclosure is a fundraising discussion at a `$6 billion` pre-money valuation, not a disclosed round amount, so it remains a Data Center event and cannot publish as a financing card. The projection exposes original and normalized amount, round, financing date, disclosure status, investor roles, cumulative basis, and stable history. It builds 1,314 evidence-backed investor subjects; unresolved product/person names remain in the evidence-backed entity review queue. The PC portal and live Mini Program endpoint publish the same 275-card inventory.
- Current Data Center frontstage inventory: 2,367 events, 210 companies, 341 products, 61 people, 1,314 investors, 358 relationships, 125 FDE records, and 81 hardware records through 2026-08-25.
