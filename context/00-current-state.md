...
- Current Funding Insights accepted projection: 289 financing-event cards through 2026-09-07, including 35 China-market cards. The dated batch adds Atira and deduplicates Wonderful against its existing card, with no blocked or pending generation. Atira's current seed round is $15 million; $17.5 million includes prior financing and is not current-round proceeds. Existing accepted cards and the Articul8 valuation-only withdrawal remain intact. The projection builds 1,363 evidence-backed investor subjects; unresolved product/person names remain in the evidence-backed entity review queue. Live PC, mobile and Mini Program publication must be established by matching full-commit and release-ID receipts, not this inventory snapshot.
...
- The 2026-09-07 daily bundle contains 40 canonical events and 109 Claims from 243 RawDocuments, with no FDE record and two hardware records; accepted-event entity, Claim, and SourceArtifact coverage is 100%. Three financing tutorials/directories were removed from formal events while preserving all Raw evidence. Recovery reused accepted intake and model decisions from run `34076089561`; collection was not repeated. The 09:50 scheduled closure failed before repair; do not erase that historical failure or claim the 16:10/16:45 windows passed before they are due. Source-provider failures remain diagnostics. A green core job is not proof that financing or the Mini Program is live. See `docs/daily-production-recovery.md` and dated external runtime final-closure reports for recovery and publication evidence.
