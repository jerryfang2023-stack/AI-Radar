...
- Membership operations adds passwordless, allowlisted community/application aggregates with independent failures and explicit missing expiry/renewal/claim metrics. Member details and management remain authenticated; source counts and points must not be added across systems.
...
- Current Funding Insights inventory: 309 accepted application cards aggregate to 284 public financing-event cards checked through 2026-09-02, including 34 China-market cards; the latest qualifying financing disclosure is dated 2026-09-01. The 2026-09-02 bundle publishes AIR ($50M) and Aranya ($11M). Speya's unsupported SEK amount, Keling/Kling's amount without an explicit currency, and a contest prize remain excluded rather than normalized into invented financing facts. The projection exposes original and normalized amount, round, financing date, disclosure status, investor roles, cumulative basis, and stable history. It builds 1,345 evidence-backed investor subjects; unresolved product/person names remain in the evidence-backed entity review queue. The PC portal and Mini Program live contract must publish the same 284-card inventory.
- Current Data Center frontstage inventory: 2,575 events, 217 companies, 343 products, 61 people, 1,345 investors, 353 relationships, 136 FDE records, and 95 hardware records through 2026-09-02.
- The 2026-09-02 daily bundle contains 40 canonical events; current-date entity/project coverage is 100%, and relationship, trend, opportunity, FDE, hardware, and funding projections pass their release gates. The release chain asserts current-date projection coverage in both the persistent-asset path and GitHub Pages before deployment.
