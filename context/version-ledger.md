...
| Field | Value |
|---|---|
| Current version | V3.3.2.1-public-frontstage-polish |
| Version name | Public Frontstage Polish |
| Version layer | Patch |
| Release date | 2026-06-09 |
| Product version | V3.3 |
| Git tag | `v3.3.2.1-public-frontstage-polish` |
