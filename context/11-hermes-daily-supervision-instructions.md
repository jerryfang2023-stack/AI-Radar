...
- Current Business Signals column version: `BSIG-V2.1.2-v3-gate-cleanout`.
...
1. Version preflight: confirm only active files agree on `SITE-V3.4.5`, `BSIG-V2.1.2-v3-gate-cleanout`, and `EAI-V1.2.0-raw-card-ingestion-boundary`. Treat ledger history as history.
...
3. Data quality: check the lane-specific public contract, not generic volume alone.
   - Business Signals: unified `BSIG-V2.1.2-v3-gate-cleanout` Cards, separate AI Hardware lens-only items, source-first titles/facts, no Top10/candidate split, no backend-only / low-value items.
