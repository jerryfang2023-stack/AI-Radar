...
| `context/01-product-map.md` | SITE-V3.4.3 product structure and data flow | Product, navigation, data structure changes |
...
| `context/08-v3-3-automation.md` | SITE-V3.4.3 GitHub / site / local Obsidian automation loop | GitHub Actions, site data sync, local sync |
| `context/09-v3-3-current-action-index.md` | SITE-V3.4.3 current action registry | Action dispatch, current automation recovery, replacing historical action lists |
...
- Legacy content-output routes are not SITE-V3.4.3 required outputs.
