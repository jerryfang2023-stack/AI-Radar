...
def create_app(test_config=None, *, pay_client=None, virtual_pay_client=None, community_client=None):
    ...
    app.config.from_mapping(
        ...
        TENCENT_SES_SECRET_ID=os.getenv("TENCENT_SES_SECRET_ID", ""),
        TENCENT_SES_SECRET_KEY=os.getenv("TENCENT_SES_SECRET_KEY", ""),
        TENCENT_SES_REGION=os.getenv("TENCENT_SES_REGION", "ap-guangzhou"),
        TENCENT_SES_FROM=os.getenv("TENCENT_SES_FROM", ""),
        TENCENT_SES_TEMPLATE_ID=os.getenv("TENCENT_SES_TEMPLATE_ID", ""),
        TENCENT_SES_TEMPLATE_CODE_KEY=os.getenv("TENCENT_SES_TEMPLATE_CODE_KEY", "验证码"),
        TENCENT_SES_SUBJECT=os.getenv("TENCENT_SES_SUBJECT", "观澜 AI 登录验证码"),
