...
专业领域表达统一遵守 [专业领域文案规范](professional-copy-guidelines.md)：营销、管理、组织行为、投资、战略、财务、人力资源、经济学等内容必须使用准确的专业术语，配合读者需要的简明解释。非页面内容也适用该规范，沿用所属内容流程。
...
| 页面/模块 | 用户任务 | 最终文案 | 字数/行数约束 | 证据边界 | 专业术语与必要解释 | 禁用语检查 | Build & Release 实现说明 |
|---|---|---|---|---|---|---|---|
|  |  |  |  |  |  |  |  |
```
...
- 专业领域文案术语误用、概念混淆、堆砌黑话或缺少读者理解所必需的解释。
- 文案偏离页面用途：事实页擅自加入判断，或分析内容中的判断没有证据依据。
...
- 禁用语扫描结果。
- 文案自然度自查结果：是否自然、专业且易懂，是否符合目标读者和页面用途；判断仅在契约允许且有依据时表达。
