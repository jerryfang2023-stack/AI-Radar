...
长背景、UI/UE 表、Copy 表、Dev/QA 硬闸门、自动化影响、必跑检查、禁止范围，都必须写在派发单里，不再在聊天提示词中重复展开。
...
12. 如通过，更新 `dispatch-board.md` 为 `accepted`。
13. 必要时更新 `feature_list.json`、`progress.md`、`docs/agent-handoff.md`。
14. 输出下一步建议。
