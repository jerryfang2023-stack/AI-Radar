...
| 工具或方法 | 用途 | 使用角色 | 备注 |
|---|---|---|---|
| frontend-design | 页面风格、排版、组件质量 | UI Agent | 每次改视觉和布局前使用 |
...
| brief-quality-check.mjs | 检查 Daily Brief 是否有观点、证据、行动建议和风险提醒 | M2 开发 |
...
- 本地 skill store：优先使用已经安装的 `frontend-design`、`awesome-design-md`、`copywriting`、`obsidian`、`browser-use` 等。
