...
13. `deepseek_v4_pro_editorial_provenance`
   - Pass when Direction Card titles and editorial fields are generated by `deepseek-v4-pro` from a bounded accepted-Card manifest and provenance is persisted.
