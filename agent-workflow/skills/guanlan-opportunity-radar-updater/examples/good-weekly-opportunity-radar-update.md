...
- A DeepSeek V4 Pro candidate may publish only after review confirms multiple accepted Cards, original-source links, a structural judgment, a counter-signal, concrete unknowns, and a first validation action; tag frequency or model fluency alone is insufficient.
