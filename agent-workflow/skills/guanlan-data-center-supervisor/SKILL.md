...
metadata:
  guanlan:
    ...
    recent_learning: "Entity relationships require explicit event-core participants and a supported action; body co-occurrence and Tag co-occurrence are not edges."
