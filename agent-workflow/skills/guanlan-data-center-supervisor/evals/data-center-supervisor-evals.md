# Data Center Supervisor Evals

1. Pass when the daily V4 chain is source capture -> RawDocument -> Claim/Entity -> CanonicalEvent -> projections -> integrity gate.
2. Fail when importance, value, opportunity, trend judgment, advice, or interview priority enters a V4 canonical object.
3. Fail when historical reprojection restores, retains, or emits legacy Card/trend/page JSON, compatibility mappings, or compatibility interfaces; only current V4-native outputs may be rebuilt.
