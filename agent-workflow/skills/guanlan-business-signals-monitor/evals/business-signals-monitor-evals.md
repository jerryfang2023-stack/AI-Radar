...
22. `enterprise_ai_fde_lens_precision`
    ...
    - Pass when each Enterprise AI / FDE lens item title is the original/source title translated directly into Chinese, using the same source-title boundary as public Cards.
