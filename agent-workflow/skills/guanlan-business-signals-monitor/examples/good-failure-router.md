...
2. Classify the failure before rerunning:
   ...
   - `raw_card_ingestion_fields`: untranslated or placeholder title, or missing Raw/Card title-fact extraction fields;
...
3. Run the pre-rerun checklist before any full-chain repair:
   ...
   - check Raw/Card title-translation and fact-extraction status when active-date Cards exist but public Cards are empty;
...
- Treating missing title translations as a reason to recollect Raw / Pool instead of repairing Raw/Card ingestion fields.
