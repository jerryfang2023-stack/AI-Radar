...
1. Source discipline
   - Pass when the page is generated from a monthly Markdown file under `01-SiteV2/content/12-applications/industry-reports/monthly/`.
...
6. Report-center wiring
   ...
   - Pass when `intelligence-map.html` presents weekly and monthly reports as subcolumns in the Guanlan Research entry.
   ...
   - Pass when the Guanlan Research landing page and monthly detail page use `REPORTS-V1.2.0-research-hub`, and neither page emits the Opportunity Map version.
...
6. Fail if Guanlan Research actions duplicate each other or fight with the time-window selector.
...
11. Fail if a newly published monthly source leaves the Guanlan Research first-screen card on an older month or requires a manual HTML edit.
