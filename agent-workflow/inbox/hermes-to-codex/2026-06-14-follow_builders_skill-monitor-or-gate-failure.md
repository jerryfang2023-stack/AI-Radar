...
- problem: missing follow-builders skill output file: 01-SiteV2/content/07-points/2026-06-14-builders-viewpoints.md
...
- validation: npm run supervise:daily -- --date=2026-06-14
- prevention_added: gate
- notes: Resolved after gating follow-builders skill supervision to the 16:30 watchdog window; rerun no longer reports a same-date failure at 03:19 Asia/Shanghai.
