...
const writeReport = (runs) => {
  ...
  const automationNote =
    mode === "automation"
      ? "\n- 自动化模式检查 V3.3.2 Business Signals / Intelligence Map / First-Line Viewpoints / Community Intelligence / Dashboard 生产线相关脚本语法。"
      : "";
...
- V3.3.2 阶段默认检查 \`01-SiteV2/site/\` 与当前 \`agent-workflow/tools/\` 脚本。
...
- \`automation\` 检查 V3.3.2 Business Signals / Intelligence Map / First-Line Viewpoints / Community Intelligence / Dashboard 生产线相关脚本语法。
