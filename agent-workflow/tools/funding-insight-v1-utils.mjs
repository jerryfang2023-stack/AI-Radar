...
export function normalizeFundingAmount(value = "") {
  ...
  if (implicitCnyApproximate) {
    ...
    return { currency: "CNY", value, min_value: null, max_value: null, unit: "base", status: "approximate", display_zh: fundingAmountDisplay("CNY", value, "approximate") };
  }
...
export function fundingEventCardConsistencyProblems(card = {}, event = {}, claims = [], entities = []) {
  ...
  if (card.company.canonical_entity_consistent !== true) return ["funding_company_identity_unverified"];
