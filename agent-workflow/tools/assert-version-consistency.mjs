...
const expected = {
  ...
  skillStore: "v2.4.0 Astra execution and cross-platform Skill catalog",
...
const ledgerChecks = [
  ...
  ["Data Center Git baseline", expected.dataCenterRelease],
...
expectText(".agents/README.md", "Skill Store version: `v2.4.0`");
expectText("docs/agent-handoff.md", "Current Skill governance: Skill Store `v2.4.0`");
...
const skillVersions = [
  ...
  ["agent-workflow/skills/guanlan-funding-insight-generator/SKILL.md", 'version: "1.6.1"'],
  ["agent-workflow/skills/guanlan-weekly-report-page-generator/SKILL.md", 'version: "1.4.0"'],
  ["agent-workflow/skills/guanlan-monthly-report-page-generator/SKILL.md", 'version: "1.4.0"'],
  ["agent-workflow/skills/guanlan-monthly-business-structure-report/SKILL.md", 'version: "1.1.0"'],
  ...
  ["agent-workflow/skills/guanlan-weekly-business-change-radar/SKILL.md", 'version: "1.4.0"'],
  ["agent-workflow/skills/guanlan-daily-monitor/SKILL.md", 'version: "1.3.1"'],
...
console.log(JSON.stringify({
  ...
  data_center_release: expected.dataCenterRelease,
  data_center_git_tag: expected.dataCenterGitTag,
