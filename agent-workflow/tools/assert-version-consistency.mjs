...
const expected = {
  ...
  skillStore: "v1.9.0 V4 semantic governance",
...
const skillVersions = [
  ...
  ["agent-workflow/skills/follow-builders/SKILL.md", 'version: "2.0.0"'],
  ...
  ["agent-workflow/skills/guanlan-skill-editor/SKILL.md", 'version: "1.1.0"'],
  ...
  ["agent-workflow/skills/guanlan-daily-monitor/SKILL.md", 'version: "1.2.1"'],
