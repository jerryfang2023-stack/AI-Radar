...
function classify(text = "") {
  ...
  if (/relationship graph|relationship edge|Card evidence/iu.test(text)) {
    categories.add("compatibility_contract");
  }
  return [...categories];
}
...
const gates = [
  ...
  runGate("compatibility_contract", "Business Signals compatibility contract", "agent-workflow/tools/assert-business-signals-compatibility-contract.mjs", gateArgs),
