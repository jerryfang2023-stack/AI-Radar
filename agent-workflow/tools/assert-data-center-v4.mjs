...
const reportsDirArg = process.argv.find((value) => value.startsWith("--reports-dir="))?.slice("--reports-dir=".length);
const reportRoot = path.resolve(root, reportsDirArg || path.join("agent-workflow", "reports"));
