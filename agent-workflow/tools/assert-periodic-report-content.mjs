...
function checkWeekly(content, archive, options) {
  ...
  if (fm.status !== "published") failures.push("weekly status must be published");
...
function runFixtures() {
  const weeklyFrontmatter = [
    ...
    "window: 2026-07-06 to 2026-07-12", "content_type: weekly-report", "slug: weekly-2026-w28", "status: published", "---",
  ].join("\n");
  ...
  const monthlyBody = [
    ...
    "window: 2026-06-01 to 2026-06-30", "content_type: monthly-report", "slug: monthly-2026-06", "status: draft", "---",
    ...Array.from({ length: 9 }, (_, index) => `## ${index + 1}. Section ${index + 1}`),
    "\u6570\u636e\u8fb9\u754c \u7ed3\u6784\u5224\u65ad \u8d8b\u52bf\u88c1\u51b3 \u673a\u4f1a\u5730\u56fe \u5173\u952e\u77db\u76fe \u4e0b\u6708\u9a8c\u8bc1",
  ].join("\n");
