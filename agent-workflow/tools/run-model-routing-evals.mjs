...
const cases = [
  ...
  ["weekly-page", "guanlan-weekly-report-page-generator", "weekly-report-page-generator-evals.md", "A weekly page is generated only from an operational report archive, with no canonical content source under 01-SiteV2/content/12-applications/industry-reports.", "fail"]
