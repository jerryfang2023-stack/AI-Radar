# trend-report-writer｜Stopped in V3

This prompt is not an active V3 execution source.
...
- convert one news item into a trend;
- use opinion / follow-builders content as trend evidence;
- run publiccopy, cardcopy, or copy-style gates.
