...
| `01-pool/` | 10-15 条候选池、入池 / 淘汰理由 | 不可见 |
| `02-structured/` | 5-8 条结构化 Signal、6 维拆解、反证、证据缺口 | Admin / Data |
| `03-front-signals/` | 每日 3 条可进入前台的深度 Signal | 公开 / 登录 / 会员分层 |
| `04-deep-dives/` | 0-1 条内参级深挖，证据不足可为空 | 会员 / Opportunity 素材 |
