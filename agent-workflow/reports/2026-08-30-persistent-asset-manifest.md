# 2026-08-30 Data Center V4 Asset Manifest

- generated_at: 2026-08-30T14:00:00+08:00
- workflow_mode: business_signals_pr
- monitor: success
- resumed_from_run: 33285287928
- recovery_mode: accepted_bundle_entity_repair_without_recollection
...
Recovery preserved the 30 canonical events and 84 exact-span Claims from the accepted source run. Added one source-exact product entity/mention for Xenomi and merged Tencent Cloud into the reviewed 腾讯云 catalog identity. All 27 accepted events now have entity references; projection coverage, integrity, entity review, full funding history, public evidence boundary, and pre-commit freshness gates pass. No new funding card was fabricated: the one daily funding event is a duplicate of an existing round.
