...
- date: 2026-06-15
- generated_at: 2026-06-15T11:52:33+08:00
...
5. Build Business Signals frontstage data and immediately run the unified Business frontstage gate.
6. Build operations dashboard and topic-center data only after the Business frontstage gate passes.
7. Confirm same-date downstream assets are no longer stale.
8. Write a persistent asset manifest.
9. Commit generated assets to an automation branch and open or update a PR.
10. Auto-merge the PR after all gates pass, so main triggers GitHub Pages deployment.
