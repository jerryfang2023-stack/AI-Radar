# 2026-09-13 Data Center V4 Asset Manifest

- generated_at: 2026-09-13T09:29:21+08:00
- workflow_mode: business_signals_pr
- monitor: restored
- resumed_from_run: 34727353617
...
## Accepted Batch Reconciliation

The original overseas collection log remains unchanged (228 Raw / 192 eligible).
The accepted China batch adds 69 Raw / 69 eligible. The merged 297 Raw / 261
eligible intake retains all 32 accepted events, 400 public funding cards and 144
China cards. Canonical, projection coverage, source-title, funding and pre-commit
gates passed after rebuilding the composite at 09:57 China time. Deployment is
still pending; this build manifest does not claim a live publication receipt.
