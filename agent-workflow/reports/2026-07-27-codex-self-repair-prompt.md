# WaveSight Codex Self Repair Request - 2026-07-27
...
3. Read `agent-workflow/reports/2026-07-27-daily-self-check.md` and `agent-workflow/reports/2026-07-27-daily-supervision-report.md`.
...
- If edits are needed and the worktree is clean, create or reuse `automation/codex-self-repair-2026-07-27`.
...
Prompt file: agent-workflow/reports/2026-07-27-codex-self-repair-prompt.md
