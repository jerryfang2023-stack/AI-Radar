...
OPS 3.6.3 is now pushed and deployed from `bcdc066bc607868014e4e38cee91e4f5c50a4440`, tagged `ops-v3.6.3-astra-session-isolation`. [CI succeeded](https://github.com/jerryfang2023-stack/AI-Radar/actions/runs/34625986309); all six production asset hashes match the commit, anonymous OPS requests redirect to login, and service health is normal. The previous release remains available. The authenticated production-browser check was unavailable due to the CUA bridge error. Exact evidence: [OPS release receipt](../agent-workflow/reports/2026-09-12-ops-astra-release.json).
