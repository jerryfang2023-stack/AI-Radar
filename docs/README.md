...
This directory keeps only current operator and handoff documentation.
...
Stopped versions, duplicate drafts, process snapshots, and superseded instructions do not remain here. Current rules belong in `context/`, task Skills, or the responsible product source; retired material is recovered from Git history.
