...
- Build evidence: `npm run verify` passed 19 tests and validated 13 pages; WeChat Developer Tools uploaded development version `0.3.4` for production AppID `wx34133741173154d4` (package size 1,881,248 bytes).
...
- 商业主体整合企业库与投资机构库；企业按企业、产品或赛道搜索，机构按机构、已投公司或赛道搜索。
