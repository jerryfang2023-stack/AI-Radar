...
- Home, financing, ecology, observation, and their linked detail pages must be fully readable before registration. Never open a registration overlay merely because a user enters a page or follows an internal detail link. Registration may be offered only after an explicit account action such as 收藏、关注、比较、加入社群 or membership/points redemption; cancelling it must leave browsing available.
