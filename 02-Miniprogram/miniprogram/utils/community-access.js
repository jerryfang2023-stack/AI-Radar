...
function requireCommunityMember(next) {
  ...
  wx.showModal({
    ...
    content: awaitingJoin ? "申请已通过，请联系管理员登记入群日期；登记后即可查看社群内容。个人资料保存不会改变入群状态。" : claimPending ? "管理员确认你的社群身份后，资料、积分与权限会自动同步，无需再次申请。" : pending ? "你的申请正在审核，通过后即可查看社群完整内容。" : "加入社群后，可查看完整分享实录、查看积分榜与成员档案。",
