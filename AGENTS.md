...
- Current dashboard: `01-SiteV2/site/operations-console.html`, `OPS-V3.1.0-membership`; unified operations for Data Center, Funding Portal, Mini Program, H5 and community. Issue/task UI panels are retired; records remain. Membership aggregates are read-only and identity-free; System Settings owns integration/freshness information and device-local preferences.
