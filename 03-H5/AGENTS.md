...
- The H5 preserves the four confirmed bottom-tab labels: 融资、生态、观察、我的. The 生态 page header is 生态图谱.
...
- 好友通过邀请关系完成首次注册后，邀请人获得 300 活跃积分；必须由服务端确认邀请归因后到账，每位新用户只计入一次有效邀请。
